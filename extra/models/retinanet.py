...
class RetinaNet:
  ...
  @TinyJit
  def inner_loop(self, scores_img):
    for scores_level in scores_img
    return scores_level.masked_select(scores_level > 0.05)
