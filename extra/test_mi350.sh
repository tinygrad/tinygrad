...
CNT=1 AMD_LLVM=0 DEBUG=2 FP8E5M2=1 HALF=0 BFLOAT16=0 SHOULD_USE_TC=1 python extra/gemm/simple_matmul.py
...
CNT=1 AMD_LLVM=1 DEBUG=2 FP8E5M2=1 HALF=0 BFLOAT16=0 SHOULD_USE_TC=1 python extra/gemm/simple_matmul.py