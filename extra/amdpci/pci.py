...
# gfx_v11_0_hw_init
print(hex(amdgpu_rreg(0xee82))) # 0xc000001f
print(hex(amdgpu_rreg(0x263e))) # 0x545

# block1
amdgpu_wreg(0xa900, 0x0)
amdgpu_wreg(0x30a4, 0xc00)
amdgpu_wreg(0x30b9, 0x1c000)
amdgpu_wreg(0xa900, 0x1)
amdgpu_wreg(0x30a4, 0xc00)
amdgpu_wreg(0x30b9, 0x1c000)
amdgpu_wreg(0xa900, 0x0)
print(hex(val_0xa803:=(amdgpu_rreg(0xa803)))) # 0x15000000, they have 0x153c0000
amdgpu_wreg(0xa803, val_0xa803)
amdgpu_wreg(0xa803, 0x15300000)
amdgpu_wreg(0xa900, 0x0)
amdgpu_wreg(0x30a5, 0xc00)
amdgpu_wreg(0x30d9, 0x1c000)
amdgpu_wreg(0xa900, 0x1)
amdgpu_wreg(0x30a5, 0xc00)
amdgpu_wreg(0x30d9, 0x1c000)
amdgpu_wreg(0xa900, 0x0)
print(hex(val_0xa803:=(amdgpu_rreg(0xa803))))
amdgpu_wreg(0xa803, val_0xa803)
amdgpu_wreg(0xa803, 0x15300000)
amdgpu_wreg(0xa900, 0x4)
amdgpu_wreg(0xc900, 0xc00)
amdgpu_wreg(0xc938, 0x1c000)
amdgpu_wreg(0xa900, 0x5)
amdgpu_wreg(0xc900, 0xc00)
amdgpu_wreg(0xc938, 0x1c000)
amdgpu_wreg(0xa900, 0x6)
amdgpu_wreg(0xc900, 0xc00)
amdgpu_wreg(0xc938, 0x1c000)
amdgpu_wreg(0xa900, 0x7)
amdgpu_wreg(0xc900, 0xc00)
amdgpu_wreg(0xc938, 0x1c000)
amdgpu_wreg(0xa900, 0x0)
print(hex(val_0xc904:=(amdgpu_rreg(0xc904))))
amdgpu_wreg(0xc904, val_0xc904)
amdgpu_wreg(0xc904, 0x40000000)
