  ...
  def to_asm(self):
    ...
    for i, inst in enumerate(self.instructions):
      ...
      if i in self.branch_targets:
        ...
        # Replace "instr 0" with "instr .LABEL"
        import re
    ...
    lines.extend(['\t.section\t.rodata,"a",@progbits', '\t.p2align\t6, 0x0',
      ...
      '\t\t.amdhsa_private_segment_fixed_size 0', '\t\t.amdhsa_kernarg_size 24',
      '\t\t.amdhsa_user_sgpr_count 14', '\t\t.amdhsa_user_sgpr_kernarg_segment_ptr 1',
      '\t\t.amdhsa_wavefront_size32 1', '\t\t.amdhsa_system_sgpr_workgroup_id_x 1',
      '\t\t.amdhsa_system_sgpr_workgroup_id_y 1', '\t\t.amdhsa_next_free_vgpr 216',
      '\t\t.amdhsa_next_free_sgpr 56', '\t\t.amdhsa_float_denorm_mode_32 3',
      '\t\t.amdhsa_float_denorm_mode_16_64 3', '\t\t.amdhsa_dx10_clamp 1',
      '\t\t.amdhsa_ieee_mode 1', '\t\t.amdhsa_memory_ordered 1', '\t.end_amdhsa_kernel',
