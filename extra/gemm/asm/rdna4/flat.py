...
# --------------------------------------------------------------------
# Register map (semantic aliases; does NOT change allocation)
#
# These names are only for readability in the Python DSL.
# Physical registers stay fixed; this is just a semantic overlay.
# --------------------------------------------------------------------
...
def custom_gemm(N:int, dev:str) -> UOp:
  ...
  *[v_dual_mov_b32(VOPDOp.V_DUAL_MOV_B32, v[i], v[i+1], 0, 0) for i in range(0, 128, 2)],
  s_wait_loadcnt(0x0),
  ds_store_b128(addr=v_lds_A_base, data0=v[222:225], offset1=0),
  ds_store_b128(addr=v_lds_A_base, data0=v[226:229], offset1=8),
  ds_store_b128(addr=v_lds_A_base, data0=v[230:233], offset1=16),
  ds_store_b128(addr=v_lds_A_base, data0=v[234:237], offset1=24),
  ds_store_b128(addr=v_lds_B_base, data0=v[238:241], offset1=0),
  ds_store_b128(addr=v_lds_B_base, data0=v[242:245], offset1=9),
  ds_store_b128(addr=v_lds_B_base, data0=v[246:249], offset1=18),
  ds_store_b128(addr=v_lds_B_base, data0=v[250:253], offset1=27),
  ...
  *[ds_load_b128(v[189+i*4:193+i*4], v_lds_B_rd, offset0=i*64) for i in range(4)],
  ...
  ds_load_b128(v[205:208], v_lds_B_rd, offset0=32),
  ...
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_A_base, data0=v[222:225], offset1=0),
  buffer_load_b128(v[222:225], v[128], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_A_idx),
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_A_base, data0=v[226:229], offset1=8),
  v_wmma_f32_16x16x16_f16(v[112:119], v[201:204], v[148:151], v[112:119]),
  buffer_load_b128(v[226:229], v[129], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_A_idx),
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_A_base, data0=v[230:233], offset1=16),
  buffer_load_b128(v[230:233], v[130], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_A_idx),
  v_wmma_f32_16x16x16_f16(v[120:127], v[201:204], v[152:155], v[120:127]),
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_A_base, data0=v[234:237], offset1=24),
  buffer_load_b128(v[234:237], v[131], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_A_idx),
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_B_base, data0=v[238:241], offset1=0),
  s_wait_dscnt(0x5),
  ...
  buffer_load_b128(v[238:241], v[132], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_B_idx),
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_B_base, data0=v[242:245], offset1=9),
  buffer_load_b128(v[242:245], v[133], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_B_idx),
  ...
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_B_base, data0=v[246:249], offset1=18),
  buffer_load_b128(v[246:249], v[134], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_B_idx),
  s_wait_loadcnt(0x7),
  ds_store_b128(addr=v_lds_B_base, data0=v[250:253], offset1=27),
  ...
  buffer_load_b128(v[250:253], v[135], soffset=NULL, format=1, offen=1, rsrc=s_rsrc_B_idx),
