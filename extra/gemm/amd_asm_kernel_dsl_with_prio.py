...
def build_kernel(arch='gfx1100'):
  ...
  k.emit(v_mul_f32_e32(v[138], s[5], v[124]))
  ...
  k.emit(v_add_nc_u32_e32(v[0], v[118], v[138]))
  k.emit(v_ashrrev_i32_e32(v[1], 31, v[0]))
  k.emit(v_mul_f32_e32(v[131], s[5], v[120]))
  k.emit(v_lshlrev_b64(v[0:1], 2, v[0:1]))
  ...
  k.emit(v_add_nc_u32_e32(v[128], v[1], v[144]))
  ...
  k.emit(v_mul_f32_e32(v[99], s[5], v[92]))
