...
at::Tensor wrap_tensor(py::object &py_obj, c10::ScalarType dtype, c10::DeviceIndex device_index, py::object strides_obj) {
  ...
  // Get strides from Python (computed by backend.py)
  std::vector<int64_t> strides = strides_obj.cast<std::vector<int64_t>>();
