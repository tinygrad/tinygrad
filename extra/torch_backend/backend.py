...
def native_batch_norm_legit_no_training(input, weight, bias, running_mean, running_var, momentum, eps):
  return _native_batch_norm_impl(input, weight, bias, running_mean, running_var, False, momentum, eps)
