...
def imagenet_prepare_val():
  ...
  for co,dir in enumerate(labels):
    ...
    os.replace(Path(__file__).parent.parent / "extra/datasets/imagenet/val" / images[co], Path(__file__).parent.parent / "datasets/imagenet/val" / dir / images[co])
...
def imagenet_prepare_train():
  ...
  for co,tarf in enumerate(images):
    ...
    if Path(Path(__file__).parent.parent / "extra/datasets/imagenet/train" / images[co]).is_file():
      ...
      imagenet_extract(Path(__file__).parent.parent / "extra/datasets/imagenet/train" / tarf, Path(__file__).parent.parent / "datasets/imagenet/train" / images[co], small=True)
