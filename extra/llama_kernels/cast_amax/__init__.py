...
def _custom_fused_bwd_w13(grad_xw13_fp8:UOp, grad_amax_next:UOp,
                          xw13:UOp, grad_x2:UOp, amax_state:UOp, grad_amax_state:UOp,
...
def _custom_fused_cast_amax_w13(fp8_out:UOp, amax_out:UOp, xw13:UOp, amax_state:UOp,
                                grad_amax_state:UOp, next_grad_amax_state:UOp,
                                layer_num:UOp|None=None, dname:str=None) -> UOp:
...
def fused_quantize_fp8_w13(xw13:Tensor, amax_state:Tensor, fp8_dtype, grad_amax_state:Tensor, next_grad_amax_state:Tensor,
                           amax_out:Tensor, layer_num:Tensor|None=None) -> Tensor:
  ...
  fp8_out, amax_out, *_ = Tensor.custom_kernel(
    fp8_out, amax_out, xw13, amax_state, grad_amax_state, next_grad_amax_state,
    *((layer_num,) if layer_num is not None else ()), fxn=fxn, grad_fxn=_fused_quantize_bwd_w13)
  return fp8_out
