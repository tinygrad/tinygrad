...
def fused_quantize_fp8_w13(xw13:Tensor, amax_state:Tensor, fp8_dtype, grad_amax_state:Tensor, store_amax:bool=False) -> tuple[Tensor, Tensor, Tensor]:
  ...
  if store_amax: fp8_out = Tensor(fp8_out.uop.after(amax_state.uop.store(new_amax.uop)), device=fp8_out.device)
