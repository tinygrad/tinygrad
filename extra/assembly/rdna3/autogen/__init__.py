...
from extra.assembly.rdna3.lib import bits, Inst32, Inst64, SGPR, VGPR, TTMP, s, v, SSrc, Src, SImm, Imm
import functools
...
class DS(Inst64):
  ...
  op:DSOp = bits[25:18]
  vdst:VGPR = bits[63:56]
  addr:VGPR = bits[39:32]
  data0:VGPR = bits[47:40]
  data1:VGPR = bits[55:48]
  offset0 = bits[7:0]
  offset1 = bits[15:8]
  gds = bits[17]
...
class FLAT(Inst64):
  ...
  op:FLATOp = bits[24:18]
  vdst:VGPR = bits[63:56]
  addr:VGPR = bits[39:32]
  data:VGPR = bits[47:40]
...
v_cmp_f_f16 = functools.partial(VOP3, VOP3Op.V_CMP_F_F16)
...
v_cmp_t_f16 = functools.partial(VOP3, VOP3Op.V_CMP_T_F16)
v_cmp_f_f32 = functools.partial(VOP3, VOP3Op.V_CMP_F_F32)
...
v_cmp_t_f32 = functools.partial(VOP3, VOP3Op.V_CMP_T_F32)
v_cmp_f_f64 = functools.partial(VOP3, VOP3Op.V_CMP_F_F64)
...
v_cmp_t_f64 = functools.partial(VOP3, VOP3Op.V_CMP_T_F64)
...
v_cmp_f_i32 = functools.partial(VOP3, VOP3Op.V_CMP_F_I32)
...
v_cmp_t_i32 = functools.partial(VOP3, VOP3Op.V_CMP_T_I32)
v_cmp_f_u32 = functools.partial(VOP3, VOP3Op.V_CMP_F_U32)
...
v_cmp_t_u32 = functools.partial(VOP3, VOP3Op.V_CMP_T_U32)
v_cmp_f_i64 = functools.partial(VOP3, VOP3Op.V_CMP_F_I64)
...
v_cmp_t_i64 = functools.partial(VOP3, VOP3Op.V_CMP_T_I64)
v_cmp_f_u64 = functools.partial(VOP3, VOP3Op.V_CMP_F_U64)
...
v_cmp_t_u64 = functools.partial(VOP3, VOP3Op.V_CMP_T_U64)
...
v_cmpx_f_f16 = functools.partial(VOP3, VOP3Op.V_CMPX_F_F16)
...
v_cmpx_t_f16 = functools.partial(VOP3, VOP3Op.V_CMPX_T_F16)
v_cmpx_f_f32 = functools.partial(VOP3, VOP3Op.V_CMPX_F_F32)
...
v_cmpx_t_f32 = functools.partial(VOP3, VOP3Op.V_CMPX_T_F32)
v_cmpx_f_f64 = functools.partial(VOP3, VOP3Op.V_CMPX_F_F64)
...
v_cmpx_t_f64 = functools.partial(VOP3, VOP3Op.V_CMPX_T_F64)
...
v_cmpx_f_i32 = functools.partial(VOP3, VOP3Op.V_CMPX_F_I32)
...
v_cmpx_t_i32 = functools.partial(VOP3, VOP3Op.V_CMPX_T_I32)
v_cmpx_f_u32 = functools.partial(VOP3, VOP3Op.V_CMPX_F_U32)
...
v_cmpx_t_u32 = functools.partial(VOP3, VOP3Op.V_CMPX_T_U32)
v_cmpx_f_i64 = functools.partial(VOP3, VOP3Op.V_CMPX_F_I64)
...
v_cmpx_t_i64 = functools.partial(VOP3, VOP3Op.V_CMPX_T_I64)
v_cmpx_f_u64 = functools.partial(VOP3, VOP3Op.V_CMPX_F_U64)
...
v_cmpx_t_u64 = functools.partial(VOP3, VOP3Op.V_CMPX_T_U64)
...
v_fmac_dx9_zero_f32 = functools.partial(VOP3, VOP3Op.V_FMAC_DX9_ZERO_F32)
...
v_min_f32 = functools.partial(VOP3, VOP3Op.V_MIN_F32)
v_max_f32 = functools.partial(VOP3, VOP3Op.V_MAX_F32)
...
v_max_f16 = functools.partial(VOP3, VOP3Op.V_MAX_F16)
v_min_f16 = functools.partial(VOP3, VOP3Op.V_MIN_F16)
...
v_cmp_t_f16 = functools.partial(VOPC, VOPCOp.V_CMP_T_F16)
...
v_cmp_t_f32 = functools.partial(VOPC, VOPCOp.V_CMP_T_F32)
...
v_cmp_t_f64 = functools.partial(VOPC, VOPCOp.V_CMP_T_F64)
...
v_cmpx_t_f16 = functools.partial(VOPC, VOPCOp.V_CMPX_T_F16)
...
v_cmpx_t_f32 = functools.partial(VOPC, VOPCOp.V_CMPX_T_F32)
...
v_cmpx_t_f64 = functools.partial(VOPC, VOPCOp.V_CMPX_T_F64)
