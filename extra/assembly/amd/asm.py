# RDNA3/RDNA4/CDNA assembler and format detection
from __future__ import annotations
import re
from extra.assembly.amd.dsl import Inst, RawImm, SrcMod, SGPR, VGPR, TTMP, s, v, ttmp, _RegFactory
