...
DOC_NAMES = {"rdna3": "RDNA3.5", "rdna4": "RDNA4", "cdna": "CDNA4"}
PDF_URLS = {
...
def write_enums(enums: dict[str, dict[int, str]], arch: str, path: str):
  ...
  lines = [f"# autogenerated from AMD {DOC_NAMES[arch]} ISA PDF by pdf.py - do not edit", "from enum import IntEnum", ""]
...
def write_ins(formats: dict[str, list[tuple[str, int, int]]], encodings: dict[str, str], enums: dict[str, dict[int, str]], arch: str, path: str):
  ...
  lines = [f"# autogenerated from AMD {DOC_NAMES[arch]} ISA PDF by pdf.py - do not edit", "# ruff: noqa: F401,F403",
