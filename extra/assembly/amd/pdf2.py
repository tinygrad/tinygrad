...
def generate_ins(tables: dict[int, tuple[str, list[list[str]]]], enums: dict[str, dict[int, str]], arch: str, path: str):
  """Parse AMD ISA format tables and write ins.py file."""
  doc_name = {"rdna3": "RDNA3.5", "rdna4": "RDNA4", "cdna": "CDNA4"}[arch]

  # Extract formats and encodings from 'XXX Fields' tables
...
if __name__ == "__main__":
  ...
  for arch, url in PDF_URLS.items():
    ...
    generate_ins(tables, enums, arch, base / "ins.py")
