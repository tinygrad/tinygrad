...
# Usage: python -m extra.assembly.amd.generate [--arch rdna3|rdna4|cdna|all]
import re, functools
...
def _generate_init_py(formats, enums, src_enum, doc_name) -> str:
  ...
  lines = [f"# autogenerated from AMD {doc_name} ISA PDF by generate.py - do not edit", "from enum import IntEnum", "from typing import Annotated",
