...
class LDSDIR(Inst32):
  ...
  op:Annotated[BitField, LDSDIROp] = bits[21:20]
...
class VOP3P(Inst64):
  encoding = bits[31:26] == 0b11001100
...
v_dot2acc_f32_f16 = functools.partial(VOP2, VOP2Op.V_DOT2ACC_F32_F16)
...
v_fmac_dx9_zero_f32 = functools.partial(VOP2, VOP2Op.V_FMAC_DX9_ZERO_F32)
