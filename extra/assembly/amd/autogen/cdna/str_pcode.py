...
VOP3POp_PCODE = {
  ...
  VOP3POp.V_MFMA_F32_16X16X128_F8F6F4: 'A, B: (16*128) elements * 8 bits/element = 16384 bits, divide by 64 lanes * 32 bits/register-lane = 8\nlane = 4 registers',
