...
class VOP3P(Inst64):
  encoding = bits[31:24] == 0b110100111
  encoding = bits[31:24] == 0b110100111
...
v_cvt_rpi_i32_f32 = functools.partial(VOP1, VOP1Op.V_CVT_RPI_I32_F32)
v_cvt_flr_i32_f32 = functools.partial(VOP1, VOP1Op.V_CVT_FLR_I32_F32)
...
v_ffbh_u32 = functools.partial(VOP1, VOP1Op.V_FFBH_U32)
v_ffbl_b32 = functools.partial(VOP1, VOP1Op.V_FFBL_B32)
v_ffbh_i32 = functools.partial(VOP1, VOP1Op.V_FFBH_I32)
...
v_clrexcp = functools.partial(VOP1, VOP1Op.V_CLREXCP)
v_mov_b64 = functools.partial(VOP1, VOP1Op.V_MOV_B64)
...
v_accvgpr_mov_b32 = functools.partial(VOP1, VOP1Op.V_ACCVGPR_MOV_B32)
...
v_prng_b32 = functools.partial(VOP1, VOP1Op.V_PRNG_B32)
v_permlane16_swap_b32 = functools.partial(VOP1, VOP1Op.V_PERMLANE16_SWAP_B32)
v_permlane32_swap_b32 = functools.partial(VOP1, VOP1Op.V_PERMLANE32_SWAP_B32)
v_cvt_f32_bf16 = functools.partial(VOP1, VOP1Op.V_CVT_F32_BF16)
...
v_fmac_f64 = functools.partial(VOP2, VOP2Op.V_FMAC_F64)
...
v_min_f32 = functools.partial(VOP2, VOP2Op.V_MIN_F32)
v_max_f32 = functools.partial(VOP2, VOP2Op.V_MAX_F32)
...
v_dot2c_f32_bf16 = functools.partial(VOP2, VOP2Op.V_DOT2C_F32_BF16)
v_fmamk_f32 = functools.partial(VOP2, VOP2Op.V_FMAMK_F32)
v_fmaak_f32 = functools.partial(VOP2, VOP2Op.V_FMAAK_F32)
v_add_co_u32 = functools.partial(VOP2, VOP2Op.V_ADD_CO_U32)
v_sub_co_u32 = functools.partial(VOP2, VOP2Op.V_SUB_CO_U32)
v_subrev_co_u32 = functools.partial(VOP2, VOP2Op.V_SUBREV_CO_U32)
v_addc_co_u32 = functools.partial(VOP2, VOP2Op.V_ADDC_CO_U32)
v_subb_co_u32 = functools.partial(VOP2, VOP2Op.V_SUBB_CO_U32)
v_subbrev_co_u32 = functools.partial(VOP2, VOP2Op.V_SUBBREV_CO_U32)
...
v_mac_f16 = functools.partial(VOP2, VOP2Op.V_MAC_F16)
v_madmk_f16 = functools.partial(VOP2, VOP2Op.V_MADMK_F16)
v_madak_f16 = functools.partial(VOP2, VOP2Op.V_MADAK_F16)
v_add_u16 = functools.partial(VOP2, VOP2Op.V_ADD_U16)
v_sub_u16 = functools.partial(VOP2, VOP2Op.V_SUB_U16)
v_subrev_u16 = functools.partial(VOP2, VOP2Op.V_SUBREV_U16)
v_mul_lo_u16 = functools.partial(VOP2, VOP2Op.V_MUL_LO_U16)
v_lshlrev_b16 = functools.partial(VOP2, VOP2Op.V_LSHLREV_B16)
v_lshrrev_b16 = functools.partial(VOP2, VOP2Op.V_LSHRREV_B16)
v_ashrrev_i16 = functools.partial(VOP2, VOP2Op.V_ASHRREV_I16)
v_max_f16 = functools.partial(VOP2, VOP2Op.V_MAX_F16)
v_min_f16 = functools.partial(VOP2, VOP2Op.V_MIN_F16)
v_max_u16 = functools.partial(VOP2, VOP2Op.V_MAX_U16)
v_max_i16 = functools.partial(VOP2, VOP2Op.V_MAX_I16)
v_min_u16 = functools.partial(VOP2, VOP2Op.V_MIN_U16)
v_min_i16 = functools.partial(VOP2, VOP2Op.V_MIN_I16)
v_ldexp_f16 = functools.partial(VOP2, VOP2Op.V_LDEXP_F16)
v_add_u32 = functools.partial(VOP2, VOP2Op.V_ADD_U32)
v_sub_u32 = functools.partial(VOP2, VOP2Op.V_SUB_U32)
v_subrev_u32 = functools.partial(VOP2, VOP2Op.V_SUBREV_U32)
v_dot2c_f32_f16 = functools.partial(VOP2, VOP2Op.V_DOT2C_F32_F16)
v_dot2c_i32_i16 = functools.partial(VOP2, VOP2Op.V_DOT2C_I32_I16)
v_dot4c_i32_i8 = functools.partial(VOP2, VOP2Op.V_DOT4C_I32_I8)
v_dot8c_i32_i4 = functools.partial(VOP2, VOP2Op.V_DOT8C_I32_I4)
...
v_cmp_f_f16 = functools.partial(VOPC, VOPCOp.V_CMP_F_F16)
...
v_cmp_tru_f16 = functools.partial(VOPC, VOPCOp.V_CMP_TRU_F16)
v_cmpx_f_f16 = functools.partial(VOPC, VOPCOp.V_CMPX_F_F16)
...
v_cmpx_tru_f16 = functools.partial(VOPC, VOPCOp.V_CMPX_TRU_F16)
v_cmp_f_f32 = functools.partial(VOPC, VOPCOp.V_CMP_F_F32)
...
v_cmp_tru_f32 = functools.partial(VOPC, VOPCOp.V_CMP_TRU_F32)
v_cmpx_f_f32 = functools.partial(VOPC, VOPCOp.V_CMPX_F_F32)
...
v_cmpx_tru_f32 = functools.partial(VOPC, VOPCOp.V_CMPX_TRU_F32)
v_cmp_f_f64 = functools.partial(VOPC, VOPCOp.V_CMP_F_F64)
...
v_cmp_tru_f64 = functools.partial(VOPC, VOPCOp.V_CMP_TRU_F64)
v_cmpx_f_f64 = functools.partial(VOPC, VOPCOp.V_CMPX_F_F64)
...
v_cmpx_tru_f64 = functools.partial(VOPC, VOPCOp.V_CMPX_TRU_F64)
v_cmp_f_i16 = functools.partial(VOPC, VOPCOp.V_CMP_F_I16)
...
v_cmp_t_i16 = functools.partial(VOPC, VOPCOp.V_CMP_T_I16)
v_cmp_f_u16 = functools.partial(VOPC, VOPCOp.V_CMP_F_U16)
...
v_cmp_t_u16 = functools.partial(VOPC, VOPCOp.V_CMP_T_U16)
v_cmpx_f_i16 = functools.partial(VOPC, VOPCOp.V_CMPX_F_I16)
...
v_cmpx_t_i16 = functools.partial(VOPC, VOPCOp.V_CMPX_T_I16)
v_cmpx_f_u16 = functools.partial(VOPC, VOPCOp.V_CMPX_F_U16)
...
v_cmpx_t_u16 = functools.partial(VOPC, VOPCOp.V_CMPX_T_U16)
v_cmp_f_i32 = functools.partial(VOPC, VOPCOp.V_CMP_F_I32)
...
v_cmp_t_i32 = functools.partial(VOPC, VOPCOp.V_CMP_T_I32)
v_cmp_f_u32 = functools.partial(VOPC, VOPCOp.V_CMP_F_U32)
...
v_cmp_t_u32 = functools.partial(VOPC, VOPCOp.V_CMP_T_U32)
v_cmpx_f_i32 = functools.partial(VOPC, VOPCOp.V_CMPX_F_I32)
...
v_cmpx_t_i32 = functools.partial(VOPC, VOPCOp.V_CMPX_T_I32)
v_cmpx_f_u32 = functools.partial(VOPC, VOPCOp.V_CMPX_F_U32)
...
v_cmpx_t_u32 = functools.partial(VOPC, VOPCOp.V_CMPX_T_U32)
v_cmp_f_i64 = functools.partial(VOPC, VOPCOp.V_CMP_F_I64)
...
v_cmp_t_i64 = functools.partial(VOPC, VOPCOp.V_CMP_T_I64)
v_cmp_f_u64 = functools.partial(VOPC, VOPCOp.V_CMP_F_U64)
...
v_cmp_t_u64 = functools.partial(VOPC, VOPCOp.V_CMP_T_U64)
v_cmpx_f_i64 = functools.partial(VOPC, VOPCOp.V_CMPX_F_I64)
...
v_cmpx_t_i64 = functools.partial(VOPC, VOPCOp.V_CMPX_T_I64)
v_cmpx_f_u64 = functools.partial(VOPC, VOPCOp.V_CMPX_F_U64)
...
v_cmpx_t_u64 = functools.partial(VOPC, VOPCOp.V_CMPX_T_U64)