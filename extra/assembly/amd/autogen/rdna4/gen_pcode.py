...
# mypy: ignore-errors
from extra.assembly.amd.autogen.rdna4 import SOP1Op, SOP2Op, SOPCOp, SOPKOp, SOPPOp, VOP1Op, VOP2Op, VOP3POp, VOPCOp, VOP3Op, VOP3SDOp
...
def _SOP1Op_S_BARRIER_SIGNAL(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if !InWorkgroup() then
...
def _SOP1Op_S_BARRIER_SIGNAL_ISFIRST(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if !InWorkgroup() then
  # SCC = 1'0U
  # elsif ((barrierNumber == -2) && !WAVE_STATUS.PRIV) then
  # SCC = 1'0U
...
def _SOP1Op_S_GET_BARRIER_STATE(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP1Op_S_ALLOC_VGPR(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP1Op_S_SLEEP_VAR(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP2Op_S_ADD_CO_U32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP2Op_S_SUB_CO_U32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = S0.u32 - S1.u32;
...
def _SOP2Op_S_ADD_CO_I32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = S0.i32 + S1.i32;
...
def _SOP2Op_S_SUB_CO_I32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = S0.i32 - S1.i32;
  # SCC = ((S0.u32[31] != S1.u32[31]) && (S0.u32[31] != tmp.u32[31]));
  # D0.i32 = tmp.i32
  S0 = Reg(s0)
...
def _SOP2Op_S_ADD_CO_CI_U32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP2Op_S_SUB_CO_CI_U32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP2Op_S_MIN_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP2Op_S_MAX_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f32)) && isNAN(64'F(S1.f32))) then
...
def _SOP2Op_S_MIN_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _SOP2Op_S_MAX_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f16)) && isNAN(64'F(S1.f16))) then
...
def _SOP2Op_S_MINIMUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
...
def _SOP2Op_S_MAXIMUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(64'F(S0.f32)) then
...
def _SOP2Op_S_MINIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
...
def _SOP2Op_S_MAXIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(64'F(S0.f16)) then
...
def _SOP2Op_S_ADD_NC_U64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.u64 = S0.u64 + S1.u64
  S0 = Reg(s0)
  S1 = Reg(s1)
  D0 = Reg(d0)
...
def _SOP2Op_S_SUB_NC_U64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.u64 = S0.u64 - S1.u64
  S0 = Reg(s0)
  S1 = Reg(s1)
  D0 = Reg(d0)
...
def _SOP2Op_S_MUL_U64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.u64 = S0.u64 * S1.u64
  S0 = Reg(s0)
  S1 = Reg(s1)
  D0 = Reg(d0)
...
def _SOPKOp_S_ADDK_CO_I32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = D0.i32;
...
def _SOPPOp_S_BARRIER_WAIT(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP2Op_V_ADD_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP2Op_V_MUL_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f64 = S0.f64 * S1.f64
  S0 = Reg(s0)
  S1 = Reg(s1)
  D0 = Reg(d0)
...
def _VOP2Op_V_MIN_NUM_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP2Op_V_MAX_NUM_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(S0.f64) || isSignalNAN(S1.f64)) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(S0.f64) && isNAN(S1.f64)) then
...
def _VOP2Op_V_MIN_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f32)) && isNAN(64'F(S1.f32))) then
...
def _VOP2Op_V_MAX_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f32)) && isNAN(64'F(S1.f32))) then
...
def _VOP2Op_V_LSHLREV_B64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP2Op_V_MIN_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f16)) && isNAN(64'F(S1.f16))) then
...
def _VOP2Op_V_MAX_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f16)) && isNAN(64'F(S1.f16))) then
...
def _VOP3POp_V_PK_MAX_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # declare tmp : 32'B;
...
def _VOP3POp_V_PK_MINIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # declare tmp : 32'B;
...
def _VOP3POp_V_PK_MAXIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # declare tmp : 32'B;
...
def _VOP3POp_V_DOT4_F32_FP8_BF8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = S2.f32;
...
def _VOP3POp_V_DOT4_F32_BF8_FP8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = S2.f32;
...
def _VOP3POp_V_DOT4_F32_FP8_FP8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = S2.f32;
...
def _VOP3POp_V_DOT4_F32_BF8_BF8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = S2.f32;
...
def _VOP3Op_V_CVT_F32_FP8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if OPSEL[1 : 0].u2 == 2'0U then
  # D0.f32 = fp8_to_f32(VGPR[laneId][SRC0.u32][7 : 0].fp8)
  # elsif OPSEL[1 : 0].u2 == 2'2U then
  # // Byte select bits are reversed
...
def _VOP3Op_V_CVT_F32_BF8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if OPSEL[1 : 0].u2 == 2'0U then
  # D0.f32 = bf8_to_f32(VGPR[laneId][SRC0.u32][7 : 0].bf8)
  # elsif OPSEL[1 : 0].u2 == 2'2U then
  # // Byte select bits are reversed
...
def _VOP3Op_V_CVT_PK_F32_FP8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = OPSEL[0].u1 ? VGPR[laneId][SRC0.u32][31 : 16] : VGPR[laneId][SRC0.u32][15 : 0];
  # D0[31 : 0].f32 = fp8_to_f32(tmp[7 : 0].fp8);
  # D0[63 : 32].f32 = fp8_to_f32(tmp[15 : 8].fp8)
  D0 = Reg(d0)
...
def _VOP3Op_V_CVT_PK_F32_BF8(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # tmp = OPSEL[0].u1 ? VGPR[laneId][SRC0.u32][31 : 16] : VGPR[laneId][SRC0.u32][15 : 0];
  # D0[31 : 0].f32 = bf8_to_f32(tmp[7 : 0].bf8);
  # D0[63 : 32].f32 = bf8_to_f32(tmp[15 : 8].bf8)
  D0 = Reg(d0)
...
def _VOP3Op_V_MIN_NUM_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(S0.f64) || isSignalNAN(S1.f64)) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(S0.f64) && isNAN(S1.f64)) then
...
def _VOP3Op_V_MAX_NUM_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(S0.f64) || isSignalNAN(S1.f64)) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(S0.f64) && isNAN(S1.f64)) then
...
def _VOP3Op_V_MIN_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f32)) && isNAN(64'F(S1.f32))) then
...
def _VOP3Op_V_MAX_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f32)) && isNAN(64'F(S1.f32))) then
...
def _VOP3Op_V_MIN_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f16)) && isNAN(64'F(S1.f16))) then
...
def _VOP3Op_V_MAX_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if (isNAN(64'F(S0.f16)) && isNAN(64'F(S1.f16))) then
...
def _VOP3Op_V_MIN3_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAX3_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MIN3_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAX3_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MINIMUM3_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAXIMUM3_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MINIMUM3_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAXIMUM3_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MED3_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MED3_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAXMIN_NUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MINMAX_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAXMIN_NUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MINIMUMMAXIMUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAXIMUMMINIMUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MINIMUMMAXIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_MAXIMUMMINIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3Op_V_S_EXP_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f32 = pow(2.0F, S0.f32)
  S0 = Reg(s0)
  D0 = Reg(d0)
  # --- compiled pseudocode ---
...
def _VOP3Op_V_S_EXP_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f16 = pow(16'2.0, S0.f16);
  # D0[31 : 16] = 16'0x0
  S0 = Reg(s0)
  D0 = Reg(d0)
...
def _VOP3Op_V_S_LOG_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f32 = log2(S0.f32)
  S0 = Reg(s0)
  D0 = Reg(d0)
  # --- compiled pseudocode ---
...
def _VOP3Op_V_S_LOG_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f16 = log2(S0.f16);
  # D0[31 : 16] = 16'0x0
  S0 = Reg(s0)
  D0 = Reg(d0)
...
def _VOP3Op_V_S_RCP_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f32 = 1.0F / S0.f32
  S0 = Reg(s0)
  D0 = Reg(d0)
  # --- compiled pseudocode ---
...
def _VOP3Op_V_S_RCP_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f16 = 16'1.0 / S0.f16;
  # D0[31 : 16] = 16'0x0
  S0 = Reg(s0)
  D0 = Reg(d0)
...
def _VOP3Op_V_S_RSQ_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f32 = 1.0F / sqrt(S0.f32)
  S0 = Reg(s0)
  D0 = Reg(d0)
  # --- compiled pseudocode ---
...
def _VOP3Op_V_S_RSQ_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f16 = 16'1.0 / sqrt(S0.f16);
  # D0[31 : 16] = 16'0x0
  S0 = Reg(s0)
  D0 = Reg(d0)
...
def _VOP3Op_V_S_SQRT_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f32 = sqrt(S0.f32)
  S0 = Reg(s0)
  D0 = Reg(d0)
  # --- compiled pseudocode ---
...
def _VOP3Op_V_S_SQRT_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # D0.f16 = sqrt(S0.f16);
  # D0[31 : 16] = 16'0x0
  S0 = Reg(s0)
  D0 = Reg(d0)
...
def _VOP3Op_V_MINIMUM_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(S0.f64) || isSignalNAN(S1.f64)) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(S0.f64) then
...
def _VOP3Op_V_MAXIMUM_F64(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(S0.f64) || isSignalNAN(S1.f64)) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(S0.f64) then
...
def _VOP3Op_V_MINIMUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(64'F(S0.f32)) then
...
def _VOP3Op_V_MAXIMUM_F32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f32)) || isSignalNAN(64'F(S1.f32))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(64'F(S0.f32)) then
...
def _VOP3Op_V_MINIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(64'F(S0.f16)) then
...
def _VOP3Op_V_MAXIMUM_F16(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
  # if (isSignalNAN(64'F(S0.f16)) || isSignalNAN(64'F(S1.f16))) then
  # TRAPSTS.INVALID = 1
  # endif;
  # if isSignalNAN(64'F(S0.f16)) then
...
def _VOP3SDOp_V_MAD_CO_U64_U32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
...
def _VOP3SDOp_V_MAD_CO_I64_I32(s0, s1, s2, d0, scc, vcc, lane, exec_mask, literal, VGPR, _vars, src0_idx=0, vdst_idx=0):
