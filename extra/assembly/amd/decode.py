...
def _matches(word: int, cls: type[Inst]) -> bool:
  """Check if word matches all FixedBitFields and op is in allowed."""
  for _, field in cls._fields:
    if isinstance(field, FixedBitField):
      if ((word >> field.lo) & field.mask) != field.default: return False
    if isinstance(field, EnumBitField) and field.allowed is not None:
      try: opcode = field.decode((word >> field.lo) & field.mask)
...
from extra.assembly.amd.autogen.rdna3.ins import (VOP1, VOP1_SDST, VOP2, VOP2_LIT, VOP3, VOP3_SDST, VOP3SD, VOP3P, VOPC, VOPD, VINTERP,
  SOP1, SOP2, SOPC, SOPK, SOPK_LIT, SOPP, SMEM, DS, FLAT, GLOBAL, SCRATCH)
...
from extra.assembly.amd.autogen.cdna.ins import (VOP1 as C_VOP1, VOP2 as C_VOP2, VOP2_LIT as C_VOP2_LIT,
...
_FORMATS = {
  "rdna3": [VOPD, VOP3P, VINTERP, VOP3SD, VOP3_SDST, VOP3, DS, GLOBAL, SCRATCH, FLAT, SMEM,
            SOP1, SOP2, SOPC, SOPK, SOPK_LIT, SOPP, VOPC, VOP1_SDST, VOP1, VOP2, VOP2_LIT],
  ...
  "cdna": [C_VOP3P, C_VOP3SD, C_VOP3_SDST, C_VOP3, C_DS, C_GLOBAL, C_SCRATCH, C_FLAT, C_MUBUF, C_SMEM,
            C_SOP1, C_SOPC, C_SOPP, C_SOPK, C_SOPK_LIT, C_VOPC_SDWA_SDST, C_VOPC, C_VOP1, C_SOP2, C_VOP2, C_VOP2_LIT],
}
