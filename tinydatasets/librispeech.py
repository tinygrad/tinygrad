...
"""
The dataset has to be downloaded manually from https://www.openslr.org/12/ and put in `tinydatasets/librispeech`.
...
Then this [file](https://github.com/mlcommons/inference/blob/master/speech_recognition/rnnt/dev-clean-wav.json) has to also be put in `tinydatasets/librispeech`.
"""
BASEDIR = pathlib.Path(__file__).parent.parent / "tinydatasets/librispeech"
