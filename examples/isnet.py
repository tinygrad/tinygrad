...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(description='Remove background from image', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
  parser.add_argument('--input', type=str, default='', help="Path to image")
  parser.add_argument('--output', type=str, default='', help="Path to output image (removed background)")
