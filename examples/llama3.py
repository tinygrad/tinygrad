...
from tinygrad.nn.state import safe_load, torch_load, load_state_dict, get_parameters, load_gguf
...
if __name__ == "__main__":
  ...
  if args.download_model:
    if args.size == "1B":
      ...
      raise RuntimeError(f"can't download Llama model size {args.size}")
