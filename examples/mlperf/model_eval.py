...
def eval_resnet():
  ...
  from tinydatasets.imagenet import iterate
...
def eval_unet3d():
  ...
  from tinydatasets.kits19 import iterate, sliding_window_inference
...
def eval_retinanet():
  ...
  from tinydatasets.openimages import openimages, iterate
...
def eval_rnnt():
  ...
  from tinydatasets.librispeech import iterate
...
def eval_bert():
  ...
  from tinydatasets.squad import iterate
...
def eval_mrcnn():
  ...
  from tinydatasets.coco import BASEDIR, images, convert_prediction_to_coco_bbox, convert_prediction_to_coco_mask, accumulate_predictions_for_coco, evaluate_predictions_on_coco, iterate
