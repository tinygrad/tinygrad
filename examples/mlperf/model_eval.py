...
def eval_resnet():
  ...
  extra.datasets.imagenet import iterate
...
def eval_unet3d():
  ...
  extra.datasets.kits19 import iterate, sliding_window_inference
...
def eval_retinanet():
  ...
  extra.datasets.openimages import openimages, iterate
...
def eval_rnnt():
  ...
  extra.datasets.librispeech import iterate
...
def eval_bert():
  ...
  extra.datasets.squad import iterate
...
def eval_mrcnn():
  ...
  extra.datasets.coco import BASEDIR, images, convert_prediction_to_coco_bbox, convert_prediction_to_coco_mask, accumulate_predictions_for_coco, evaluate_predictions_on_coco, iterate
