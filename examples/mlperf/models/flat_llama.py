...
class FlatTransformer:
  ...
  def attention(self, x:Tensor, freqs_cis:Tensor, *, attention_norm:Tensor, wqkv:Tensor, wo:Tensor,
                ...
                next_grad_amax_xqkv:Tensor|None, next_grad_amax_xo:Tensor|None, mxfp4_wqkv=None, mxfp4_wo=None):
    ...
    if SPLIT_W13:
      ...
      if FUSED_SILU_W13 and MXFP8:
        ...
        out, *s = matmul(x_w1.silu() * x_w3, kwargs["w2"], amax_x=kwargs["amax_x2"], w_inv_scale=kwargs["s_2"],
                         ...
                         next_amax_x=kwargs["next_amax_x2"], mxfp4_w=kwargs.get("mxfp4_w2"))
      saves.extend([*s, out])
    else:
