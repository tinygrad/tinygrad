...
def quant_dequant_mx(x:Tensor) -> Tensor:
  ...
  return Tensor(UOp.call_with_outputs((fxn.uop,), x.uop, grad_fxn=_quant_dequant_bwd)[0])
...
def dequant_weight(w_q:Tensor, w_scale:Tensor) -> Tensor:
  ...
  return Tensor(UOp.call_with_outputs((fxn.uop,), w_q.uop, w_scale.uop, grad_fxn=_dequant_bwd)[0])
