...
from tinygrad.helpers import getenv, prod, Context, round_up, tqdm, OSX, PARALLEL
...
def batch_load_train_bert(BS:int, seed:int|None=None):
  ...
  cycle_length = min(PARALLEL.value, len(train_files))
