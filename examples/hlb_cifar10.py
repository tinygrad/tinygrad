...
class ConvGroup:
  def __init__(self, channels_in, channels_out):
    ...
    self.norm = [nn.BatchNorm2d(channels_out, track_running_stats=False, eps=1e-3 if HALF else 1e-12, momentum=0.8) for _ in range(2)]
...
class SpeedyResNet:
  def __init__(self):
    ...
    self.net = [
      ...
      nn.BatchNorm2d(BASE_DIM, track_running_stats=False, eps=1e-3 if HALF else 1e-12, momentum=0.8),
