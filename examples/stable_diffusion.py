...
@lru_cache()
def default_bpe():
  return fetch("https://github.com/openai/CLIP/raw/main/clip/bpe_simple_vocab_16e6.txt.gz")
...
if __name__ == "__main__":
  ...
  # load in weights
  ckpt = fetch('https://huggingface.co/CompVis/stable-diffusion-v-1-4-original/resolve/main/sd-v1-4.ckpt')
  load_state_dict(model, torch_load(ckpt)['state_dict'], strict=False)
