...
class Synthesizer:
    ...
    def generate(
        ...
        if pad_length > -1:
            ...
            y_mask = y_mask.pad(((0, 0), (0, 0), (0, pad_length - row_len))).cast(
                z_p.dtype
            )
            ...
            z_p = (
                z_p.squeeze(0)
                .pad(((0, 0), (0, pad_length - z_p.shape[2])), value=1)
                .unsqueeze(0)
            )
        z = self.flow.forward(
...
class TextMapper:  # Based on https://github.com/keithito/tacotron
    ...
    def _expand_dollars(self, m):
        ...
        dollars, cents = int(parts[0]) if parts[0] else 0, (
...
if __name__ == "__main__":
    ...
    audio_tensor = net_g.infer(
        ...
        max_y_length_estimate_scale=(
            Y_LENGTH_ESTIMATE_SCALARS[args.model_to_use]
