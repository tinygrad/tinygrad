...
EOF
  ...
  sed -i "s/import ctypes/import ctypes, ctypes.util, os, gzip, base64, subprocess, tinygrad.helpers as helpers, tinygrad.runtime.support.llvm as llvm_support/" $BASE/mesa.py
