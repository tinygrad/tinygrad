...
generate_cuda() {
  ...
  patch_dlopen $BASE/cuda.py cuda "ctypes.CDLL(ctypes.util.find_library('nvcuda'))"
...
generate_nvrtc() {
  ...
  patch_dlopen $BASE/nvrtc.py nvrtc "ctypes.CDLL(ctypes.util.find_library('nvrtc64_120_0'))"
  ...
  patch_dlopen $BASE/nvrtc.py nvJitLink "ctypes.CDLL(ctypes.util.find_library('nvJitLink_120_0'))"
