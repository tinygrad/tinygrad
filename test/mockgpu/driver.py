...
class VirtFileDesc:
  ...
  def mmap(self, start, sz, prot, flags, fd, offset): raise NotImplementedError()
...
class TextFileDesc(VirtFileDesc):
  ...
  def ioctl(self, fd, request, argp): return 0
...
class VirtDriver:
  ...
  def open(self, name, flags, mode, virtfile): raise NotImplementedError()
