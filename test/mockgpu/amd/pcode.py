...
# parse-time probes need a literal's VALUE, never its width: width is stated where it matters, on a
# mint (_const/.cast) or a .dtype read. so probes evaluate, and never depend on how a literal is spelled
