...
class AMDDriver(VirtDriver):
  ...
  def _prepare_gpu(self, gpu_id):
    ...
    self.tracked_files += [
      ...
      VirtFile(f'/sys/class/drm/renderD{gpu_id}/device/ip_discovery/die/0/{am.GC_HWID}/0/major',
               functools.partial(TextFileDesc, text='12' if MOCKGPU_ARCH == 'rdna4' else '11')),
      ...
      VirtFile(f'/sys/class/drm/renderD{gpu_id}/device/ip_discovery/die/0/{am.NBIF_HWID}/0/major',
               functools.partial(TextFileDesc, text='6' if MOCKGPU_ARCH == 'rdna4' else '4')),
      ...
      VirtFile(f'/sys/class/drm/renderD{gpu_id}/device/ip_discovery/die/0/{am.NBIF_HWID}/0/revision',
               functools.partial(TextFileDesc, text='1' if MOCKGPU_ARCH == 'rdna4' else '0')),
