...
class AMDDriver(VirtDriver):
  ...
  def _prepare_gpu(self, gpu_id):
    ...
    self.tracked_files += [
      ...
      VirtFile(
        f"/sys/class/drm/renderD{gpu_id}/device/ip_discovery/die/0",
      ...
      VirtFile(
        f"/sys/class/drm/renderD{gpu_id}/device/ip_discovery/die/0/{am.GC_HWID}/0/base_addr",
      ...
      VirtFile(
        f"/sys/class/drm/renderD{gpu_id}/device/ip_discovery/die/0/{am.SDMA0_HWID}/0/base_addr",
        functools.partial(TextFileDesc, text="0x00001260\n0x0000A000\n0x0001C000\n0x02402C00"),
      ),
      ...
      VirtFile(
        f"/sys/class/drm/renderD{gpu_id}/device/ip_discovery/die/0/{am.NBIF_HWID}/0/base_addr",
