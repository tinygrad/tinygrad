...
class TestHCQ(unittest.TestCase):
  ...
  def setUpClass(self):
    ...
    TestHCQ.runner = get_runner(get_kernels(Device[TestHCQ.d0.dname].renderer, si.ast)[-1])
  ...
  def test_memory_barrier(self):
    ...
    b = a + 1
    runner = get_runner(get_kernels(Device[TestHCQ.d0.dname].renderer, create_schedule([b.lazydata])[-1].ast)[-1])
