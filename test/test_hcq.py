...
from tinygrad.engine.realize import get_runners, CompiledRunner
...
class TestHCQ(unittest.TestCase):
  ...
  def setUpClass(self):
    ...
    TestHCQ.runner = get_runners(TestHCQ.d0.dname, si.ast)[-1]
  ...
  def test_memory_barrier(self):
    ...
    b = a + 1
    runner = get_runners(TestHCQ.d0.dname, create_schedule([b.lazydata])[-1].ast)[-1]
