...
@unittest.skipUnless(
    issubclass(type(Device[Device.DEFAULT]), HCQCompiled), "HCQ device required to run"
)
class TestHCQ(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        TestHCQ.d0 = Device[Device.DEFAULT]
        TestHCQ.a = Tensor([0.0, 1.0], device=Device.DEFAULT).realize()
        TestHCQ.b = self.a + 1
        ...
        TestHCQ.kernargs_ba_ptr = TestHCQ.runner._prg.fill_kernargs(
            [TestHCQ.b.lazydata.buffer._buf, TestHCQ.a.lazydata.buffer._buf]
        )
        TestHCQ.kernargs_ab_ptr = TestHCQ.runner._prg.fill_kernargs(
            [TestHCQ.a.lazydata.buffer._buf, TestHCQ.b.lazydata.buffer._buf]
        )
    ...
    def test_signal(self):
        for queue_type in [TestHCQ.d0.hw_compute_queue_t, TestHCQ.d0.hw_copy_queue_t]:
            ...
            with self.subTest(name=str(queue_type)):
                queue_type().signal(
                    TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
                ).submit(TestHCQ.d0)
    ...
    def test_signal_update(self):
        for queue_type in [TestHCQ.d0.hw_compute_queue_t, TestHCQ.d0.hw_copy_queue_t]:
            ...
            virt_signal = TestHCQ.d0.signal_t(
                base_addr=Variable("sig_addr", 0, 0xFFFFFFFFFFFFFFFF, dtypes.uint64)
            )
            ...
            with self.subTest(name=str(queue_type)):
                ...
                var_vals = {
                    virt_signal.base_addr: TestHCQ.d0.timeline_signal.base_addr,
                    virt_val: TestHCQ.d0.timeline_value,
                }
    ...
    def test_wait(self):
        for queue_type in [TestHCQ.d0.hw_compute_queue_t, TestHCQ.d0.hw_copy_queue_t]:
            ...
            with self.subTest(name=str(queue_type)):
                ...
                fake_signal.value = 1
                queue_type().wait(fake_signal, 1).signal(
                    TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
                ).submit(TestHCQ.d0)
                TestHCQ.d0.timeline_signal.wait(TestHCQ.d0.timeline_value)
                TestHCQ.d0.timeline_value += 1
        ...
        for queue_type in [TestHCQ.d0.hw_compute_queue_t, TestHCQ.d0.hw_copy_queue_t]:
            ...
            with self.subTest(name=str(queue_type)):
                ...
                with self.assertRaises(RuntimeError):
                    TestHCQ.d0.timeline_signal.wait(
                        TestHCQ.d0.timeline_value, timeout=500
                    )
        ...
        for queue_type in [TestHCQ.d0.hw_compute_queue_t, TestHCQ.d0.hw_copy_queue_t]:
            ...
            with self.subTest(name=str(queue_type)):
                ...
                q.submit(
                    TestHCQ.d0,
                    {
                        virt_signal.base_addr: fake_signal.base_addr,
                        virt_val: fake_signal.value,
                    },
                )
                TestHCQ.d0.timeline_signal.wait(TestHCQ.d0.timeline_value)
                TestHCQ.d0.timeline_value += 1
    ...
    def test_exec_one_kernel(self):
        TestHCQ.d0.hw_compute_queue_t().exec(
            TestHCQ.runner._prg,
            TestHCQ.kernargs_ba_ptr,
            TestHCQ.runner.p.global_size,
            TestHCQ.runner.p.local_size,
        ).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(
            TestHCQ.d0
        )
    ...
    def test_exec_2_kernels_100_times(self):
        ...
        q.wait(TestHCQ.d0.timeline_signal, virt_val - 1).exec(
            TestHCQ.runner._prg,
            TestHCQ.kernargs_ba_ptr,
            TestHCQ.runner.p.global_size,
            TestHCQ.runner.p.local_size,
            ...
            TestHCQ.runner._prg,
            TestHCQ.kernargs_ab_ptr,
            TestHCQ.runner.p.global_size,
            TestHCQ.runner.p.local_size,
        ).signal(
            TestHCQ.d0.timeline_signal, virt_val
        )
    ...
    def test_exec_update(self):
        sint_global = (Variable("sint_global", 0, 0xFFFFFFFF, dtypes.uint32),) + tuple(
            TestHCQ.runner.p.global_size[1:]
        )
        sint_local = (Variable("sint_local", 0, 0xFFFFFFFF, dtypes.uint32),) + tuple(
            TestHCQ.runner.p.local_size[1:]
        )

        q = TestHCQ.d0.hw_compute_queue_t()
        q.exec(
            TestHCQ.runner._prg, TestHCQ.kernargs_ba_ptr, sint_global, sint_local
        ).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value)
    ...
    def test_exec_update_fuzz(self):
        virt_val = Variable("sig_val", 0, 0xFFFFFFFF, dtypes.uint32)
        virt_local = [
            Variable(f"local_{i}", 0, 0xFFFFFFFF, dtypes.uint32) for i in range(3)
        ]
        ...
        for i in range(3):
            k.apply_opt(Opt(op=OptOps.LOCAL, axis=0, arg=3))
        ...
        zb = Buffer(
            ...
            3 * 3 * 3,
            dtypes.int,
            options=BufferSpec(cpu_access=True, nolru=True),
        ).ensure_allocated()
        zt = Buffer(
            Device.DEFAULT,
            3 * 3 * 3,
        ...
        q = TestHCQ.d0.hw_compute_queue_t()
        q.memory_barrier().exec(runner._prg, kernargs, (1, 1, 1), virt_local).signal(
            TestHCQ.d0.timeline_signal, virt_val
        )
    ...
    # Test copy
    def test_copy(self):
        if TestHCQ.d0.hw_copy_queue_t is None:
            self.skipTest("device does not support copy queue")

        TestHCQ.d0.hw_copy_queue_t().wait(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1
        ).copy(
            TestHCQ.b.lazydata.buffer._buf.va_addr,
            TestHCQ.a.lazydata.buffer._buf.va_addr,
            8,
        ).signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
        ).submit(
    ...
    def test_copy_long(self):
        ...
        sz = 64 << 20
        buf1 = Buffer(
            Device.DEFAULT, sz, dtypes.int8, options=BufferSpec(nolru=True)
        ).ensure_allocated()
        buf2 = Buffer(
            Device.DEFAULT, sz, dtypes.int8, options=BufferSpec(host=True, nolru=True)
        ).ensure_allocated()
        ctypes.memset(buf2._buf.va_addr, 1, sz)

        TestHCQ.d0.hw_copy_queue_t().wait(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1
        ).copy(buf1._buf.va_addr, buf2._buf.va_addr, sz).signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
        ).submit(
            TestHCQ.d0
        )
        ...
        for i in range(sz // 8):
            assert (
                mv_buf1[i] == 0x0101010101010101
            ), f"offset {i*8} differs, not all copied, got {hex(mv_buf1[i])}"
    ...
    def test_update_copy(self):
        ...
        virt_dest_addr = Variable(
            "virt_dest_addr", 0, 0xFFFFFFFFFFFFFFFF, dtypes.uint64
        )

        q = (
            TestHCQ.d0.hw_copy_queue_t()
            .wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1)
        ...
        q.submit(
            TestHCQ.d0,
            {
                virt_src_addr: TestHCQ.a.lazydata.buffer._buf.va_addr,
                virt_dest_addr: TestHCQ.b.lazydata.buffer._buf.va_addr,
            },
        )
    ...
    def test_update_copy_long(self):
        ...
        q.submit(
            TestHCQ.d0,
            {virt_src_addr: buf2._buf.va_addr, virt_dest_addr: buf1._buf.va_addr},
        )
    ...
    def test_multidevice_signal_wait(self):
        ...
        try:
            ...
            self.skipTest("no multidevice, test skipped")

        TestHCQ.d0.hw_copy_queue_t().signal(
            sig := TestHCQ.d0.signal_t(value=0), value=0xFFF
        ).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(
            TestHCQ.d0
        )

        d1.hw_copy_queue_t().wait(sig, value=0xFFF).signal(
            d1.timeline_signal, d1.timeline_value
        ).submit(d1)
    ...
    def test_speed_exec_time(self):
        ...
        TestHCQ.d0.hw_compute_queue_t().timestamp(sig_st).exec(
            TestHCQ.runner._prg,
            TestHCQ.kernargs_ba_ptr,
            TestHCQ.runner.p.global_size,
            TestHCQ.runner.p.local_size,
        ).timestamp(sig_en).signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
        ).submit(
            TestHCQ.d0
        )
    ...
    def test_speed_copy_bandwidth(self):
        ...
        SZ = 200_000_000
        a = Buffer(
            Device.DEFAULT, SZ, dtypes.uint8, options=BufferSpec(nolru=True)
        ).allocate()
        b = Buffer(
            Device.DEFAULT, SZ, dtypes.uint8, options=BufferSpec(nolru=True)
        ).allocate()
        ...
        sig_st, sig_en = TestHCQ.d0.signal_t(), TestHCQ.d0.signal_t()
        TestHCQ.d0.hw_copy_queue_t().timestamp(sig_st).copy(
            a._buf.va_addr, b._buf.va_addr, SZ
        ).timestamp(sig_en).signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
        ).submit(
            TestHCQ.d0
    ...
    def test_speed_cross_device_copy_bandwidth(self):
        ...
        SZ = 200_000_000
        b = Buffer(
            f"{Device.DEFAULT}:1", SZ, dtypes.uint8, options=BufferSpec(nolru=True)
        ).allocate()
        a = Buffer(
            Device.DEFAULT, SZ, dtypes.uint8, options=BufferSpec(nolru=True)
        ).allocate()
    ...
    def test_small_copies_from_host_buf(self):
        ...
        buf1 = Buffer(
            Device.DEFAULT, 1, dtypes.int8, options=BufferSpec(nolru=True)
        ).ensure_allocated()
        buf2 = Buffer(
            Device.DEFAULT, 1, dtypes.int8, options=BufferSpec(host=True, nolru=True)
        ).ensure_allocated()
        ...
        for i in range(256):
            ...
            TestHCQ.d0.hw_copy_queue_t().wait(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1
            ).copy(buf1._buf.va_addr, buf2._buf.va_addr, 1).signal(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
            ).submit(
                TestHCQ.d0
            )
    ...
    def test_small_copies_from_host_buf_intercopy(self):
        ...
        for i in range(256):
            ...
            TestHCQ.d0.hw_copy_queue_t().wait(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1
            ).copy(buf1._buf.va_addr, buf3._buf.va_addr, 1).copy(
                buf2._buf.va_addr, buf1._buf.va_addr, 1
            ).signal(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
            ).submit(
                TestHCQ.d0
    ...
    def test_small_copies_from_host_buf_transfer(self):
        ...
        buf2 = Buffer(
            f"{Device.DEFAULT}:1", 1, dtypes.int8, options=BufferSpec(nolru=True)
        ).ensure_allocated()
        buf3 = Buffer(
            Device.DEFAULT, 1, dtypes.int8, options=BufferSpec(host=True, nolru=True)
        ).ensure_allocated()
    ...
    def test_memory_barrier(self):
        ...
        buf1 = Buffer(
            Device.DEFAULT, 2, dtypes.int8, options=BufferSpec(nolru=True)
        ).ensure_allocated()
        buf2 = Buffer(
            Device.DEFAULT,
            2,
        ...
        for i in range(255):
            ...
            TestHCQ.d0.hw_compute_queue_t().wait(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1
            ).memory_barrier().exec(
                runner._prg, kernargs_ptr, runner.p.global_size, runner.p.local_size
            ).signal(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
            ).submit(
                TestHCQ.d0
            ...
            assert buf1.as_buffer()[0] == (
                i + 1
            ), f"has {buf1.as_buffer()[0]}, need {i + 1}"
    ...
    def test_on_device_hang(self):
        if not hasattr(self.d0, "on_device_hang"):
            self.skipTest("device does not have on_device_hang")
