...
from tinygrad.helpers import prod, unwrap, fromimport

IMAGE_SUPPORTED_DEVICES = ("QCOM", "GPU")
REAL_DEV = (Device.DEFAULT if Device.DEFAULT != "CLOUD" else fromimport('tinygrad.runtime.ops_cloud', 'CLOUDDEV'))
...
class TestImageCopy(unittest.TestCase):
  ...
  @unittest.skipIf(sys.version_info < (3, 12), 'fails on pythons < 3.12')
