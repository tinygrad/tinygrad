...
class TestHCQ(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        ctypes.memmove(
            TestHCQ.d0.kernargs_ptr + TestHCQ.kernargs_off,
            TestHCQ.addr,
            len(TestHCQ.addr),
        )
        ctypes.memmove(
            TestHCQ.d0.kernargs_ptr + TestHCQ.kernargs_size + TestHCQ.kernargs_off,
            TestHCQ.addr2,
            len(TestHCQ.addr2),
        )
        ...
        if Device.DEFAULT == "AMD":
            ...
            to_mv(TestHCQ.d0.kernargs_ptr, 0x160).cast("I")[:] = array.array(
                "I", TestHCQ.runner._prg.constbuffer_0
            )
            to_mv(TestHCQ.d0.kernargs_ptr + TestHCQ.kernargs_size, 0x160).cast("I")[
                :
            ] = array.array("I", TestHCQ.runner._prg.constbuffer_0)
    ...
    def test_run_1000_times_one_submit(self):
        ...
        for _ in range(1000):
            ...
            q.exec(
                TestHCQ.runner._prg,
                TestHCQ.d0.kernargs_ptr + TestHCQ.kernargs_size,
                TestHCQ.runner.p.global_size,
                TestHCQ.runner.p.local_size,
            )
            q.signal(temp_signal, temp_value + 1).wait(temp_signal, temp_value + 1)
    ...
    def test_run_to_3(self):
        ...
        q.signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(
            TestHCQ.d0
        )
        TestHCQ.d0._wait_signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value)
        TestHCQ.d0.timeline_value += 1
    ...
    def test_wait_signal(self):
        temp_signal = TestHCQ.d0._alloc_signal(value=0)
        TestHCQ.compute_queue().wait(temp_signal, value=1).signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
        ).submit(TestHCQ.d0)
        with self.assertRaises(RuntimeError):
            TestHCQ.d0._wait_signal(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value, timeout=50
            )
        # clean up
        TestHCQ.d0._set_signal(temp_signal, 1)
        TestHCQ.d0._wait_signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value, timeout=100
        )
        TestHCQ.d0.timeline_value += 1
    ...
    def test_wait_copy_signal(self):
        temp_signal = TestHCQ.d0._alloc_signal(value=0)
        TestHCQ.copy_queue().wait(temp_signal, value=1).signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
        ).submit(TestHCQ.d0)
        with self.assertRaises(RuntimeError):
            TestHCQ.d0._wait_signal(
    ...
    def test_signal_timeout(self):
        with self.assertRaises(RuntimeError):
            ...
            TestHCQ.d0._wait_signal(
                TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value + 122, timeout=50
            )
        TestHCQ.d0._wait_signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1, timeout=50
        )

    def test_signal(self):
        new_timeline_value = TestHCQ.d0.timeline_value + 0xFF
        TestHCQ.compute_queue().signal(
            TestHCQ.d0.timeline_signal, new_timeline_value
        ).submit(TestHCQ.d0)
        TestHCQ.d0._wait_signal(TestHCQ.d0.timeline_signal, new_timeline_value)
        TestHCQ.d0.timeline_value = (
            new_timeline_value + 1
        )  # update to not break runtime

    def test_copy_signal(self):
        new_timeline_value = TestHCQ.d0.timeline_value + 0xFF
        TestHCQ.copy_queue().signal(
            TestHCQ.d0.timeline_signal, new_timeline_value
        ).submit(TestHCQ.d0)
        TestHCQ.d0._wait_signal(TestHCQ.d0.timeline_signal, new_timeline_value)
        TestHCQ.d0.timeline_value = (
    ...
    def test_timeline_signal_rollover(self):
        # NV 64bit, AMD 32bit
        TestHCQ.d0.timeline_value = (
            (1 << 64) - 20 if Device.DEFAULT == "NV" else (1 << 32) - 20
        )  # close value to reset
        TestHCQ.compute_queue().signal(
