...
parser.add_argument(
    "--input_tfrecord", type=str, default="", help="Input tfrecord path"
)
parser.add_argument(
    "--output_tfrecord", type=str, default="", help="Output tfrecord path"
)
parser.add_argument(
    "--num_examples_to_pick", type=int, default=10000, help="Number of examples to pick"
)
parser.add_argument(
    "--max_seq_length",
    type=int,
...
if __name__ == "__main__":
    ...
    toc = time.time()
    logging.info(
        "Picked %d examples out of %d samples in %.2f sec",
        num_examples_picked,
        num_examples,
        toc - tic,
    )
