...
class TestAMD(unittest.TestCase):
  ...
  def setUpClass(self):
    ...
    TestAMD.a = Tensor([0.0, 1.0], device="AMD").realize()
    TestAMD.b = self.a + 1
  ...
  def test_amd_ring_64bit_doorbell(self):
    ...
    for _ in range(2000):
      TestAMD.d0_runner.clprg(
        TestAMD.b.uop.buffer._buf, TestAMD.a.uop.buffer._buf, global_size=TestAMD.d0_runner.global_size, local_size=TestAMD.d0_runner.local_size
      )
      TestAMD.d0_runner.clprg(
        TestAMD.a.uop.buffer._buf, TestAMD.b.uop.buffer._buf, global_size=TestAMD.d0_runner.global_size, local_size=TestAMD.d0_runner.local_size
      )
