...
class TestKernelSpeed(unittest.TestCase):
  ...
  def test_gemv_4096_16384(self): self._test_matmul(4096, 16384, 1, nv_gbs=320, amd_gbs=270)
  def test_gemv_16384_4096(self): self._test_matmul(16384, 4096, 1, nv_gbs=350, amd_gbs=270)
