...
def vision_conv_143():
  c0 = UOp.param(0, dtypes.half, (16, 1024, 4))
  c2 = UOp.range(32, 3)
  c5 = UOp.range(128, 4)
  c8 = UOp.range(16, 2)
  ...
  c34 = UOp.param(1, dtypes.half, (32, 1024, 4))
  c38 = c5//2
  ...
  c49 = UOp.param(2, dtypes.half, (64, 49, 4))
...
def vision_conv_153():
  c0 = UOp.param(0, dtypes.half, (8, 1024, 4))
  c2 = UOp.range(16, 3)
  c5 = UOp.range(256, 4)
  c8 = UOp.range(8, 2)
  c16 = UOp.range(7, 0, AxisType.REDUCE)
...
def dm_conv_172():
  c0 = UOp.param(0, dtypes.half, (1, 240, 4))
  c2 = UOp.range(960, 4)
  c5 = UOp.param(1, dtypes.half, (8, 384, 4))
  ...
  c23 = UOp.param(2, dtypes.half, (240, 128, 4))
