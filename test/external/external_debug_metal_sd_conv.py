    ...
    UOp(
      ...
      src=(
        ...
        UOp(
          ...
          dtypes.void,
          arg=ShapeTracker(
            views=(View(shape=(2, 1, 1280, 8, 8, 1, 1, 1), strides=(81920, 0, 64, 8, 1, 0, 0, 0), offset=0, mask=None, contiguous=True),)
          ),
          src=(),
        ),
        UOp(
                                  ...
                                  src=(
                                    ...
                                    UOp(
                                      ...
                                      arg=ShapeTracker(
                                        views=(
                                          View(
                                            shape=(1, 2, 1, 2560, 4, 10, 4, 10),
                                            strides=(0, 163840, 0, 64, 0, 8, 0, 1),
                                            offset=-9,
                                            mask=((0, 1), (0, 2), (0, 1), (0, 2560), (0, 4), (1, 9), (0, 4), (1, 9)),
                                            contiguous=False,
                                          ),
                                          View(
                                            shape=(2, 1, 1280, 8, 8, 2560, 3, 3),
                                            strides=(4096000, 0, 0, 40, 1, 1600, 440, 11),
                                            offset=0,
                                            mask=None,
                                            contiguous=False,
                                          ),
                ...
                UOp(
                  ...
                  src=(
                    ...
                    x17 := UOp(
                      ...
                      dtypes.void,
                      arg=ShapeTracker(
                        views=(View(shape=(2, 1, 1280, 8, 8, 1, 1, 1), strides=(0, 0, 1, 0, 0, 0, 0, 0), offset=0, mask=None, contiguous=False),)
                      ),
                      src=(),
                    ),
                  ),
...
opts = [
  ...
  Opt(op=OptOps.UNROLL, axis=2, arg=0),
