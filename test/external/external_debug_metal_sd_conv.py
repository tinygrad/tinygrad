...
ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
  UOp(Ops.STORE, dtypes.void, arg=None, src=(
    UOp(Ops.DEFINE_REG, dtypes.half.ptr(), arg=("global", 0), src=()),
    ...
    UOp(Ops.ADD, dtypes.half, arg=None, src=(
      UOp(Ops.ADD, dtypes.half, arg=None, src=(
            ...
            UOp(Ops.CAST, dtypes.float, arg=None, src=(
              UOp(Ops.MUL, dtypes.half, arg=None, src=(
                UOp(Ops.LOAD, dtypes.half, arg=None, src=(
                  UOp(Ops.DEFINE_REG, dtypes.half.ptr(), arg=("global", 1), src=()),
                ...
                UOp(Ops.LOAD, dtypes.half, arg=None, src=(
                  UOp(Ops.DEFINE_REG, dtypes.half.ptr(), arg=("global", 2), src=()),
        ...
        UOp(Ops.LOAD, dtypes.half, arg=None, src=(
          UOp(Ops.DEFINE_REG, dtypes.half.ptr(), arg=("global", 3), src=()),
      ...
      UOp(Ops.LOAD, dtypes.half, arg=None, src=(
        UOp(Ops.DEFINE_REG, dtypes.half.ptr(), arg=("global", 4), src=()),
         x17,)),)),)),))
