...
def create_tf_lars(lr): return LARSOptimizer(lambda: lr)
...
class ExternalTestOptim(unittest.TestCase):
  ...
  def _test_lars(self, steps, opts, atol, rtol): self._test_optim(LARS, create_tf_lars, steps, opts, atol, rtol)
