...
class TestNV(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        TestNV.a = Tensor([0.0, 1.0], device="NV").realize()
        TestNV.b = self.a + 1
        si = self.b.schedule()[-1]
        TestNV.d0_runner = get_runner(TestNV.d0.device, si.ast)
        TestNV.b.lazydata.buffer.allocate()
        TestNV.addr = struct.pack(
            "QQ",
            TestNV.b.lazydata.buffer._buf.va_addr,
            TestNV.a.lazydata.buffer._buf.va_addr,
        )
    ...
    def test_oor_kernels(self):
                        ...
                        LazyOp(
                            ...
                            src=(
                                LazyOp(
                                    ...
                                    arg=(dtypes.float, False),
                                ),
                            ),
                            arg=((0, 3, 4), dtypes.float),
                        ),
                    ),
                    arg=(dtypes.half, False),
                ),
            ),
            arg=MemBuffer(
                idx=0,
                ...
                st=ShapeTracker(
                    views=(
                        View(
                            shape=(1, 1, 512, 1, 1, 512, 3, 3),
                            strides=(0, 0, 4608, 0, 0, 9, 3, 1),
                            offset=0,
                            mask=None,
                            contiguous=True,
                        ),
        ...
        opts = [
            Opt(op=OptOps.TC, axis=6, arg=(-1, 2)),
    ...
    def test_error_on_huge_dims(self):
        ...
        opts = [
            ...
            Opt(op=OptOps.PADTO, axis=1, arg=32),
    ...
    def test_buf4_usage(self):
        ...
        temp_runner(
            [TestNV.b.lazydata.buffer, TestNV.along.lazydata.buffer], var_vals={}
        )
    ...
    def test_kernargs_no_oob_access(self):
        ...
        kernargs = kernargs_start + (
            (2 << 20) - TestNV.d0_runner._prg.kernargs_alloc_size
        )
        to_mv(kernargs, 0x160).cast("I")[:] = array.array(
            "I", TestNV.d0_runner._prg.constbuffer_0
        )
        ctypes.memmove(
            kernargs + TestNV.d0_runner._prg.kernargs_offset,
            TestNV.addr,
            len(TestNV.addr),
        )
        ...
        q = HWQueue()
        q.exec(
            TestNV.d0_runner._prg,
            kernargs,
            TestNV.d0_runner.global_size,
            TestNV.d0_runner.local_size,
        )
