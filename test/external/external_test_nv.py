...
class TestNV(unittest.TestCase):
  ...
  def test_oor_kernels(self):
    ...
    opts = [Opt(op=OptOps.TC, axis=6, amt=-1, arg=2), Opt(op=OptOps.UPCAST, axis=0, amt=4), Opt(op=OptOps.UPCAST, axis=3, amt=0), Opt(op=OptOps.LOCAL, axis=1, amt=4), Opt(op=OptOps.LOCAL, axis=2, amt=3), Opt(op=OptOps.UPCAST, axis=1, amt=2)] # noqa: E501
