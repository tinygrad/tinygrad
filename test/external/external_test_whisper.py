...
from examples.whisper import Whisper, load_model, N_SAMPLES, N_FRAMES

from extra.datasets.librispeech import ci, BASEDIR, load_wav
from examples.mlperf.metrics import word_error_rate

def transcribe_wav(model, fn, logprob_threshold=-1.0, no_speech_threshold=0.6):
  mel = model.prep_audio(load_wav(fn), padding=N_SAMPLES)
  ...
  while seek < content_frames:
    ...
    mel_segment = model.pad_or_trim(mel_segment, N_FRAMES)
