...
if __name__ == "__main__":
  ...
  for i in range(50000):
    ...
    solver = z3.Solver()
    solver.set(timeout=1000)  # some expressions take very long, but its very unlikely they actually return sat
    ...
    if solver.check(z3_simplified_expr != z3_expr) == z3.sat:
      m = solver.model()
...
Reproduce with:
v1=Variable(\"{u1.arg[0]}\", {u1.arg[1]}, {u1.arg[2]})
v2=Variable(\"{u2.arg[0]}\", {u2.arg[1]}, {u2.arg[2]})
v3=Variable(\"{u3.arg[0]}\", {u3.arg[1]}, {u3.arg[2]})
