...
class TestTrainGpt2Kernel(unittest.TestCase):
  def test_1(self):
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        UOp(Ops.DEFINE_REG, dtypes.float.ptr(206045184), arg=("global", 0), src=()),
        ...
        UOp(Ops.MUL, dtypes.float, arg=None, src=(
          ...
          UOp(Ops.DEFINE_REG, dtypes.float.ptr(3145728), arg=("global", 1), src=()),
          ...
          UOp(Ops.LOAD, dtypes.float, arg=None, src=(
          UOp(Ops.DEFINE_REG, dtypes.float.ptr(38633472), arg=("global", 2), src=()),
  ...
  def test_2(self):
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        UOp(Ops.DEFINE_REG, dtypes.float.ptr(3145728), arg=("global", 0), src=()),
        ...
        UOp(Ops.MUL, dtypes.float, arg=None, src=(
          UOp(Ops.LOAD, dtypes.float, arg=None, src=(
          UOp(Ops.DEFINE_REG, dtypes.float.ptr(38633472), arg=("global", 1), src=()),
          UOp(Ops.VIEW, dtypes.void, arg=ShapeTracker(views=(View(shape=(4, 1024, 50304, 768), strides=(0, 0, 768, 1), offset=0, mask=None, contiguous=False),)), src=()),)),
          UOp(Ops.LOAD, dtypes.float, arg=None, src=(
          UOp(Ops.DEFINE_REG, dtypes.float.ptr(205852672), arg=("global", 2), src=()),
