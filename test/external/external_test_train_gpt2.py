...
class TestTrainGpt2Kernel(unittest.TestCase):
    def test_1(self):
                    ...
                    src=(
                        ...
                        UOp(
                            ...
                            arg=ShapeTracker(
                                views=(
                                    View(
                                        shape=(4, 1024, 50304, 1),
                                        strides=(51511296, 50304, 1, 0),
                                        offset=0,
                                        mask=None,
                                        contiguous=True,
                                    ),
        ...
        opts = [
            ...
            Opt(op=OptOps.UPCAST, axis=1, arg=3),
        ...
        ast = UOp(
            ...
            src=(
                UOp(
                    ...
                    src=(
                        UOp(
                            Ops.DEFINE_GLOBAL, dtypes.float.ptr(3145728), arg=0, src=()
                        ),
                        UOp(
                            Ops.VIEW,
                            dtypes.void,
