        ...
        UOp(
          ...
          src=(
            ...
            UOp(
              Ops.VIEW,
              dtypes.void,
              arg=ShapeTracker(views=(View(shape=(4, 1024, 50304, 1), strides=(51511296, 50304, 1, 0), offset=0, mask=None, contiguous=True),)),
              src=(),
            ),
            UOp(
              Ops.REDUCE_AXIS,
                    ...
                    UOp(
                      ...
                      src=(
                        ...
                        UOp(
                          ...
                          dtypes.void,
                          arg=ShapeTracker(
                            views=(View(shape=(4, 1024, 50304, 768), strides=(786432, 768, 0, 1), offset=0, mask=None, contiguous=False),)
                          ),
                          src=(),
                        ),
                      ),
                    ...
                    UOp(
                      ...
                      src=(
                        ...
                        UOp(
                          Ops.VIEW,
                          dtypes.void,
                          arg=ShapeTracker(views=(View(shape=(4, 1024, 50304, 768), strides=(0, 0, 768, 1), offset=0, mask=None, contiguous=False),)),
                          src=(),
                        ),
                      ),
                    ),
        ...
        UOp(
          ...
          src=(
            ...
            UOp(
              Ops.VIEW,
              dtypes.void,
              arg=ShapeTracker(views=(View(shape=(4, 1024, 1, 768), strides=(786432, 768, 0, 1), offset=0, mask=None, contiguous=True),)),
              src=(),
            ),
            UOp(
              Ops.REDUCE_AXIS,
                      ...
                      src=(
                        ...
                        UOp(
                          ...
                          arg=ShapeTracker(
                            views=(
                              View(
                                shape=(4, 1024, 50304, 768),
                                strides=(51463168, 50257, 1, 0),
                                offset=0,
                                mask=((0, 4), (0, 1024), (0, 50257), (0, 768)),
                                contiguous=False,
                              ),
                            )
                          ),
