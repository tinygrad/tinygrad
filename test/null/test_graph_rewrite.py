...
from tinygrad.uop.ops import GroupOp, UOp, Ops, exec_alu, PatternMatcher, TrackedPatternMatcher, UPat, param_variable
...
class TestModuloAndDivisionFolding(unittest.TestCase):
  ...
  def test_full_graph_rewrite_division_with_remainder(self):
    x_var_uop = param_variable('x', 7, 9)
  ...
  def test_full_graph_rewrite_complex_mod_div_expression(self):
    x_var_uop = param_variable('x', 1, 10)
