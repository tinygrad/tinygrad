...
class TestPolyN(unittest.TestCase):
  ...
  def test_uop(self):
    ...
    np.testing.assert_allclose(eval_uop(polyN(UOp.const(1.0, dtypes.float), [1.0, -2.0, 1.0])), 0.0)
    np.testing.assert_allclose(eval_uop(polyN(UOp.const(2.0, dtypes.float), [1.0, -2.0, 1.0])), 1.0)
    np.testing.assert_allclose(eval_uop(polyN(UOp.const(3.0, dtypes.float), [1.0, -2.0, 1.0])), 4.0)
    np.testing.assert_allclose(eval_uop(polyN(UOp.const(4.0, dtypes.float), [1.0, -2.0, 1.0])), 9.0)
