...
class TestImageSimplification(unittest.TestCase):
  ...
  def test_simplify7(self):
    # DEBUG=2 ALLOWED_KERNEL_COUNT=123 ALLOWED_READ_IMAGE=1397 ALLOWED_GATED_READ_IMAGE=94 FLOAT16=1 CL=1 IMAGE=2 python examples/openpilot/compile_onnx.py --onnx https://gitlab.com/commaai/openpilot-lfs.git/gitlab-lfs/objects/cf6376aa9a090f0da26c280ef69eabf9bbdd51d1faac9ed392919c3db69be916 # noqa: E501
    # kernel 143
    gidx0 = Special("gidx0", 32)
  ...
  def test_simplify8(self):
    # from the openpilot compiler, kernel r_4_16_8_16_4_4_3_3n1
  ...
  def test_simplify9(self):
    # from the openpilot compiler, kernel r_32_16_8_4_4_7_7 (image 1x16384)
  ...
  def test_simplify10(self):
    # from the openpilot compiler, kernel r_16_8_4_4_4_4_7_7 (image 1x8192)
