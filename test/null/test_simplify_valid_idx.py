...
class TestImageSimplification(unittest.TestCase):
  ...
  def test_simplify8(self):
    ...
    # valid guarantees A >= 0, so truncdiv correction WHERE is unnecessary and gate should be removed
  ...
  def test_simplify9(self):
    ...
    # TODO: valid guarantees A1 >= 0 and A1 < 512, gate should be removable
    gidx0 = Special("gidx0", 32)
    lidx0 = Special("lidx0", 16)
    lidx1 = Special("lidx1", 8)
    r0 = Range(0, 7)
  ...
  def test_simplify10(self):
    ...
    # TODO: valid guarantees A1 >= 0 and A1 < 128, gate should be removable
    gidx0 = Special("gidx0", 16)
    lidx0 = Special("lidx0", 8)
