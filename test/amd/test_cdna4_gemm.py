...
class TestCDNA4GEMM(unittest.TestCase):
  def test_gemm_16x4x16(self): _matmul_check(16,4,16)
  def test_gemm_32x2x32(self): _matmul_check(32,2,32)
  def test_gemm_16x16x16(self): _matmul_check(16,16,16)
  def test_gemm_32x32x32(self): _matmul_check(32,32,32)
  def test_gemm_17x5x13(self): _matmul_check(17,5,13, atol=1e-3)
  def test_gemm_48x7x33(self): _matmul_check(48,7,33, atol=1e-3)
  def test_gemm_128x64x128(self): _matmul_check(128,64,128, atol=1e-3, rtol=1e-3)
  def test_gemm_256x256x256(self): _matmul_check(256,256,256, atol=1e-3, rtol=1e-3)
  def test_fp16_16x16x16(self): _matmul_check(16,16,16, np.float16, 1e-3, 1e-2)
  def test_fp16_64x64x64(self): _matmul_check(64,64,64, np.float16, 5e-3, 1e-2)
