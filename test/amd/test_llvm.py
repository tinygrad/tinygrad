...
def _make_test(f: str, arch: str, test_type: str):
  def test(self):
    ...
    if test_type == "roundtrip":
      ...
      if arch == "rdna3": import tinygrad.runtime.autogen.amd.rdna3.ins as ins
      elif arch == "rdna4": import tinygrad.runtime.autogen.amd.rdna4.ins as ins
      elif arch == "cdna": import tinygrad.runtime.autogen.amd.cdna.ins as ins
