...
def custom_lds_sync(A:UOp, arch:str) -> UOp:
  ...
  wait_kmcnt = [isa.s_wait_kmcnt(simm16=0)] if arch == "rdna4" else [isa.s_waitcnt(simm16=0xfc07)]
  wait_dscnt = [isa.s_wait_dscnt(simm16=0)] if arch == "rdna4" else [isa.s_waitcnt(simm16=0xfc07)]
