...
class TestView(unittest.TestCase):
    def test_canonicalize_empty_mask(self):
        v = View.create(
            shape=(2, 2, 2), strides=(4, 2, 1), mask=((0, 2), (0, 2), (0, 2))
        )
        self.assertIsNone(v.mask)
        v = View.create(
            shape=(4, 3, 2), strides=(1, 4, 10), mask=((0, 4), (0, 3), (0, 2))
        )
        self.assertIsNone(v.mask)
...
class TestMergeDims(unittest.TestCase):
    ...
    def test_different_1_pad(self):
        ...
        self.assertEqual(
            merge_dims((2, 2, 2), (2, 1, 0), ((0, 2), (0, 2), (0, 1))),
            ((4, 1, 4), (2, 0, 2)),
        )

        # print(f"{ShapeTracker.from_shape((2, 1, 1)).pad(((0, 0), (0, 1), (0, 1))).views[-1]}")
        self.assertEqual(
            merge_dims((2, 2, 2), (1, 0, 0), ((0, 2), (0, 2), (0, 1))),
            ((2, 1, 2), (4, 0, 4)),
        )
...
class TestMergeViews(unittest.TestCase):
    ...
    def test_merges_from_fuzzer2(self):
        ...
        target = View(
            shape=(10, 6, 5, 2, 2),
            strides=(1, 20, 100, 10, 0),
            offset=-20,
            mask=((0, 10), (1, 6), (0, 5), (0, 2), (0, 2)),
            contiguous=False,
        )
        v = v0 + v1
        self.assertIsNotNone(v)
    ...
    def test_view_padded_area1(self):
        ...
        self.assertEqual(
            v,
            View(shape=(1,), strides=(0,), offset=0, mask=((0, 0),), contiguous=False),
        )
    ...
    def test_view_padded_area4(self):
        ...
        v1 = View(
            shape=(1, 1, 1), strides=(0, 0, 0), offset=1, mask=None, contiguous=False
        )
        v = v0 + v1
        self.assertIsNotNone(v)
        self.assertEqual(
    ...
    def test_empty_shape_view1(self):
        ...
        self.assertIsNotNone(v)
        self.assertEqual(
            v, View(shape=(), strides=(), offset=0, mask=None, contiguous=True)
        )
