...
class TestFuzzFailure(unittest.TestCase):
  ...
  def test_fuzz_failure2(self):
    ...
    expr = (
      (
        (
          (((((((((((((((((((((0 * 4) // 5) * 2) * -1) * -2) + -4) * 4) * 2) * 3) * 4) + -4) * 4) + v2) + v2) + v3) // 3) + v2) + v1) // 9) + 3) + 1)
          // 1
        )
        + -4
      )
              ...
              (
                (
                  (
                    (
                      (
                        ((((((((((((((((((0 * -2) + 0) * -1) // 9) // 6) // 8) + v1) * -4) + v2) // 4) // 8) + 4) * 3) + v1) + v3) // 8) // 7) + 4)
                        + v3
                      )
                      * -4
                    )
              ...
              (
                (
                  (
                    (
                      (
                        ((((((((((((((((((0 // 3) + 4) + v1) // 2) + -1) // 1) * 1) * -1) * 4) // 5) + v1) // 6) + v1) * -1) + -4) + v2) + -2) * -3)
                        + v3
                      )
                      + -4
                    )
              ...
              (
                (
                  (
                    (
                      (
                        ((((((((((((((((((0 + v2) * -4) + 0) // 9) + -4) * -2) * 3) * 4) // 9) + v3) + v1) // 4) + v1) + v3) + -1) * 4) // 4) + v2)
                        // 7
                      )
                      // 3
                    )
            ...
            (
              (
                (
                  (
                    (
                      (((((((((((((((((((0 * -2) // 1) + 3) * -2) + -3) * -4) * 1) + v1) + 0) % 2) % 8) % 9) + v2) % 9) + -4) // 4) + -1) * -2) + 0)
                      + v1
                    )
                    + v1
                  )
