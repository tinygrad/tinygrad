  ...
  def test_real_strides_0(self):
    st = ShapeTracker(
      views=(
        ...
        View(shape=(2, (Variable("start_pos", 1, 8) + 1)), strides=((Variable("start_pos", 1, 8) + 1), 1), offset=0, mask=None, contiguous=True),
      )
    )  # noqa: E501
...
class TestSymbolicReshape(unittest.TestCase):
  ...
  def test_symbolic_mask(self):
    ...
    view = View(
      ...
      strides=(0, 0, 64, 1),
      offset=1024,
      mask=((0, 1), (Variable("start_pos", 1, 128).bind(2), (Variable("start_pos", 1, 128).bind(2) + 1)), (0, 16), (0, 64)),
      contiguous=False,
    )  # noqa: E501
    ...
    view = View(
      ...
      offset=131072,
      mask=((1, 2), (0, 1), (0, (Variable("start_pos", 1, 128) + 1)), (0, 16), (0, 64)),
      contiguous=False,
    )  # noqa: E501
