...
def tool_call(name, args): return TOOL_CALL_OPEN + json.dumps({"name": name, "arguments": args}) + TOOL_CALL_CLOSE
...
class TestLLMTools(unittest.TestCase):
  ...
  def test_parse_tool_calls(self):
    calls = parse_tool_calls(tool_call("call", {"filePath": "old.py"}) + tool_call("bash", {"command": "ls"}))
