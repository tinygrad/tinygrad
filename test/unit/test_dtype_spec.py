...
class TestHelpers(unittest.TestCase):
  ...
  def test_truncate_fp8e4m3(self, x):
    ...
    else: np.testing.assert_equal(truncate[dtypes.fp8e4m3](x), torch.float8_e4m3fn(x))
  ...
  def test_truncate_fp8e5m2(self, x):
    ...
    else: np.testing.assert_equal(truncate[dtypes.fp8e5m2](x), torch.float8_e5m2(x))
