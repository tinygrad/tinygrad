...
from tinygrad.engine.realize import get_program as _get_program
from tinygrad.helpers import AMX

def get_program(*args, **kwargs):
  renderer = kwargs.pop("renderer", Device[Device.DEFAULT].renderer)
  return _get_program(*args, renderer=renderer, **kwargs)
