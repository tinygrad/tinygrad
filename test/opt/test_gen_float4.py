...
class TestFloat4(unittest.TestCase):
  ...
  def test_float4_basic(self):
    ...
    program = get_program(realized_ast, device=Device.DEFAULT, opts=opts_to_apply)
  ...
  def test_float4_multidim(self):
    ...
    s = c.schedule()[0]
    uops = get_program(s.ast, device=Device.DEFAULT,
  ...
  def test_float4_multidim_amx(self):
    def kernel_for_shape(size, shift):
      ...
      s = c.schedule()[0]
      return get_program(s.ast, device=Device.DEFAULT,
  ...
  def test_float4_sometimes_unaligned(self):
    ...
    s = c.schedule()[0]
    uops = get_program(s.ast, device=Device.DEFAULT, opts=[Opt(op=OptOps.UNROLL, axis=0, arg=4)]).uops
  ...
  def test_float4_expand(self):
    ...
    s = c.schedule()[0]
    uops = get_program(s.ast, device=Device.DEFAULT, opts=[Opt(op=OptOps.UPCAST, axis=0, arg=4)]).uops
