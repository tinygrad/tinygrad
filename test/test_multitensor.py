...
class TestMultiTensor(unittest.TestCase):
  ...
  def test_matmul_shard_uneven_W_0(self): return self._test_matmul_shard_axis(None, 0, devices_3)
  def test_matmul_shard_uneven_W_1(self): return self._test_matmul_shard_axis(None, 1, devices_3)
