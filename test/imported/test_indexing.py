...
def set_(reference: Tensor, shape, strides, offset):
  ...
  strided = Tensor(LazyBuffer(device=reference.device, st=ShapeTracker((View.create(shape=shape, strides=strides, offset=offset),)), op=None, dtype=reference.dtype, srcs=(), base=reference.lazydata.base))   # noqa: E501
