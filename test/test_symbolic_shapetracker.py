...
class TestSymbolic(unittest.TestCase):
    ...
    def test_real_strides_0(self):
        st = ShapeTracker(
            views=(
                View(
                    shape=(2, (Variable("start_pos", 1, 8) + 1), 1, 1),
                    strides=(8, 1, 0, 0),
                    offset=0,
                    mask=((0, 2), (0, Variable("start_pos", 1, 8)), (0, 1), (0, 1)),
                    contiguous=False,
                ),
                View(
                    shape=(2, (Variable("start_pos", 1, 8) + 1)),
                    strides=((Variable("start_pos", 1, 8) + 1), 1),
                    offset=0,
                    mask=None,
                    contiguous=True,
                ),
    ...
    def test_real_strides_1(self):
        st = ShapeTracker(
            views=(
                View(
                    shape=(3, (Variable("i", 1, 10) + 2)),
                    strides=(Variable("i", 1, 10), 1),
                    offset=0,
                    mask=((0, 3), (0, Variable("i", 1, 10))),
                    contiguous=False,
                ),
            )
        )  # noqa: E501
    ...
    def test_real_strides_2(self):
        st = ShapeTracker(
            views=(
                View(
                    shape=(3, (Variable("i", 1, 10) + Variable("j", 1, 10))),
                    strides=(Variable("i", 1, 10), 1),
                    offset=0,
                    mask=((0, 3), (0, Variable("i", 1, 10))),
                    contiguous=False,
...
class TestSymbolicReshapeFromContiguous(unittest.TestCase):
    ...
    def test_symbolic_mask(self):
        ...
        view = View(
            shape=(1, (Variable("start_pos", 1, 128).bind(2) + 1), 16, 64),
            strides=(0, 0, 64, 1),
            offset=1024,
            mask=(
                (0, 1),
                (
                    ...
                    (Variable("start_pos", 1, 128).bind(2) + 1),
                ),
                (0, 16),
                (0, 64),
            ),
        ...
        view = View(
            shape=(2, 1, (Variable("start_pos", 1, 128) + 1), 16, 64),
            strides=(0, 0, 1024, 64, 1),
            offset=131072,
            mask=(
                (1, 2),
                (0, 1),
                (0, (Variable("start_pos", 1, 128) + 1)),
                (0, 16),
                (0, 64),
            ),
            contiguous=False,
