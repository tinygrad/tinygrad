...
class TestNonFloatUOps(TestUOps):
  ...
  @unittest.skipUnless(dtypes.bool in Device[Device.DEFAULT].renderer.supported_dtypes(), "dtype not supported")
  def test_mul_bool(self): self._test_bop_fxn(Ops.MUL, lambda a,b: bool(a) and bool(b), (dtypes.bool, dtypes.bool))
  @unittest.skipUnless(dtypes.float16 in Device[Device.DEFAULT].renderer.supported_dtypes(),  "dtype not supported")
