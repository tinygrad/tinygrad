...
class TestSymbolicJit(unittest.TestCase):
  ...
  def test_attention(self):
    def f(q, k, v):
      return Tensor.scaled_dot_product_attention(q.transpose(1, 2), k.transpose(1, 2), v.transpose(1, 2)).realize()
  ...
  def test_mean(self):
    def f(a):
      return a.mean().realize()

    def f0(a):
      return a.mean(0).realize()

    def f1(a):
      return a.mean(1).realize()
  ...
  def test_var(self):
    def f(a):
      return a.var().realize()

    def f0(a):
      return a.var(0).realize()

    def f1(a):
      return a.var(1).realize()
