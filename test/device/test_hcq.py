...
class TestHCQ(unittest.TestCase):
  ...
  def setUp(self):
    ...
    TestHCQ.a.uop.buffer.copy_from(Buffer("PYTHON", 2, dtypes.float, opaque=memoryview(struct.pack("ff", 0, 1))))
    TestHCQ.b.uop.buffer.copy_from(Buffer("PYTHON", 2, dtypes.float, opaque=memoryview(struct.pack("ff", 0, 0))))
