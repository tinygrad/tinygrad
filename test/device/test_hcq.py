...
class TestHCQ(unittest.TestCase):
  ...
  def test_wait(self):
    for queue_type in [TestHCQ.d0.hw_compute_queue_t, TestHCQ.d0.hw_copy_queue_t]:
      ...
      with self.subTest(name=str(queue_type)):
        ...
        fake_signal.value = 1
        queue_type().wait(fake_signal, 1).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(TestHCQ.d0)
        TestHCQ.d0.timeline_signal.wait(TestHCQ.d0.timeline_value)
        TestHCQ.d0.timeline_value += 1
  ...
  def test_exec_one_kernel(self):
    TestHCQ.d0.hw_compute_queue_t().exec(
      TestHCQ.runner._prg, TestHCQ.kernargs_ba_ptr, TestHCQ.runner.p.global_size, TestHCQ.runner.p.local_size
  ...
  def test_exec_2_kernels_100_times(self):
    ...
    q.wait(TestHCQ.d0.timeline_signal, virt_val - 1).exec(
      TestHCQ.runner._prg, TestHCQ.kernargs_ba_ptr, TestHCQ.runner.p.global_size, TestHCQ.runner.p.local_size
    ).exec(TestHCQ.runner._prg, TestHCQ.kernargs_ab_ptr, TestHCQ.runner.p.global_size, TestHCQ.runner.p.local_size).signal(
  ...
  def test_exec_update(self):
    ...
    q = TestHCQ.d0.hw_compute_queue_t()
    q.exec(TestHCQ.runner._prg, TestHCQ.kernargs_ba_ptr, sint_global, sint_local).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value)
  ...
  def test_exec_update_fuzz(self):
    ...
    q = TestHCQ.d0.hw_compute_queue_t()
    q.memory_barrier().exec(runner._prg, kernargs, (1, 1, 1), virt_local).signal(TestHCQ.d0.timeline_signal, virt_val)
  ...
  def test_copy(self):
    ...
    TestHCQ.d0.hw_copy_queue_t().wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1).copy(
      TestHCQ.b.uop.buffer._buf.va_addr, TestHCQ.a.uop.buffer._buf.va_addr, 8
    ).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(TestHCQ.d0)
  ...
  def test_copy_long(self):
    ...
    TestHCQ.d0.hw_copy_queue_t().wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1).copy(
      buf1._buf.va_addr, buf2._buf.va_addr, sz
    ).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(TestHCQ.d0)
  ...
  def test_copy_64bit(self):
    ...
    for sz in [(1 << 32) - 1, (1 << 32), (1 << 32) + 1, (5 << 30), (6 << 30) - 0x4642EE1]:
      ...
      for i in range(0, sz // 8, 0x1000):
        for j in range(32):
          buf2_q_view[min(max(i + j - 16, 0), (sz // 8) - 1)] = random.randint(0, 0xFFFFFFFFFFFFFFFF)
  ...
  def test_update_copy_long(self):
    ...
    mv_buf1 = buf1.as_buffer().cast("Q")
    for i in range(sz // 8):
      assert mv_buf1[i] == 0x0101010101010101, f"offset {i * 8} differs, not all copied, got {hex(mv_buf1[i])}"
  ...
  def test_multidevice_signal_wait(self):
    ...
    TestHCQ.d0.hw_copy_queue_t().signal(sig := TestHCQ.d0.new_signal(value=0), value=0xFFF).signal(
      TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
    ).submit(TestHCQ.d0)

    d1.hw_copy_queue_t().wait(sig, value=0xFFF).signal(d1.timeline_signal, d1.timeline_value).submit(d1)
  ...
  def test_speed_exec_time(self):
    ...
    TestHCQ.d0.hw_compute_queue_t().timestamp(sig_st).exec(
      TestHCQ.runner._prg, TestHCQ.kernargs_ba_ptr, TestHCQ.runner.p.global_size, TestHCQ.runner.p.local_size
    ).timestamp(sig_en).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(TestHCQ.d0)
  ...
  def test_speed_copy_bandwidth(self):
    ...
    sig_st, sig_en = TestHCQ.d0.new_signal(), TestHCQ.d0.new_signal()
    TestHCQ.d0.hw_copy_queue_t().timestamp(sig_st).copy(a._buf.va_addr, b._buf.va_addr, SZ).timestamp(sig_en).signal(
      TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
    ).submit(TestHCQ.d0)
  ...
  def test_timeline_signal_rollover(self):
    for queue_type in [TestHCQ.d0.hw_compute_queue_t, TestHCQ.d0.hw_copy_queue_t]:
      ...
      with self.subTest(name=str(queue_type)):
        ...
        for _ in range(40):
          queue_type().wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1).signal(
            TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
          ).submit(TestHCQ.d0)
          TestHCQ.d0.timeline_value += 1
          TestHCQ.d0.synchronize()
  ...
  def test_small_copies_from_host_buf(self):
    ...
    for i in range(256):
      ...
      TestHCQ.d0.hw_copy_queue_t().wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1).copy(
        buf1._buf.va_addr, buf2._buf.va_addr, 1
      ).signal(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value).submit(TestHCQ.d0)
      TestHCQ.d0.timeline_signal.wait(TestHCQ.d0.timeline_value)
      TestHCQ.d0.timeline_value += 1
  ...
  def test_small_copies_from_host_buf_intercopy(self):
    ...
    for i in range(256):
      ...
      TestHCQ.d0.hw_copy_queue_t().wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1).copy(buf1._buf.va_addr, buf3._buf.va_addr, 1).copy(
  ...
  def test_memory_barrier(self):
    ...
    for i in range(255):
      ...
      TestHCQ.d0.hw_compute_queue_t().wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1).memory_barrier().exec(
  ...
  def test_memory_barrier_before_copy(self):
    ...
    for i in range(256):
      ...
      # Need memory_barrier after direct write to vram
      TestHCQ.d0.hw_compute_queue_t().wait(TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value - 1).memory_barrier().signal(
        TestHCQ.d0.timeline_signal, TestHCQ.d0.timeline_value
      ).submit(TestHCQ.d0)
      TestHCQ.d0.timeline_value += 1
  ...
  def test_map_cpu_buffer_to_device(self):
    if Device[Device.DEFAULT].hw_copy_queue_t is None:
      self.skipTest("skip device without copy queue")
    ...
    for devid in range(6):
      if DEBUG >= 2:
        print(f"Testing map to device {Device.DEFAULT}:{devid}")

      try:
        d = Device[f"{Device.DEFAULT}:{devid}"]
      except Exception:
        break
      ...
      d.hw_copy_queue_t().wait(d.timeline_signal, d.timeline_value - 1).copy(local_buf._buf.va_addr, cpu_buffer._buf.va_addr, sz).signal(
        d.timeline_signal, d.timeline_value
      ).submit(d)
  ...
  def test_multidevice(self):
    try:
      ...
      self.skipTest("no AMD device, test skipped")

    try:
      nv_dev = Device["NV"]
    except Exception:
      self.skipTest("no NV device, test skipped")
  ...
  def test_multidevice_p2p(self):
    try:
      amd_dev = Device["AMD"]
      if not issubclass(type(amd_dev.iface), PCIIfaceBase):
        self.skipTest("Not a pci dev")
    except Exception:
      self.skipTest("no AMD device, test skipped")

    try:
      nv_dev = Device["NV"]
      if not issubclass(type(nv_dev.iface), PCIIfaceBase):
        self.skipTest("Not a pci dev")
    except Exception:
      self.skipTest("no NV device, test skipped")
