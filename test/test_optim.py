...
def step(tensor, optim, steps=1, kwargs={}):
  net = TinyNet(tensor)
  grad_clip = None
  if 'gradient_clip' in kwargs and tensor == torch.tensor: grad_clip = kwargs.pop('gradient_clip') 
  optim = optim([net.x, net.W], **kwargs)
  for _ in range(steps):
    out = net.forward()
    optim.zero_grad()
    out.backward()
    if grad_clip is not None: torch.nn.utils.clip_grad_value_([net.x, net.W], grad_clip)
    optim.step()
...
class TestOptim(unittest.TestCase):
  ...
  def test_sgd_grad_clip(self): self._test_sgd(1, {'lr': 0.001, 'gradient_clip': 0.1}, 1e-6, 0)
  def test_sgd_high_lr_grad_clip(self): self._test_sgd(1, {'lr': 10, 'gradient_clip': 0.1}, 1e-6, 1e-5)
  def test_sgd_wd_grad_clip(self): self._test_sgd(1, {'lr': 0.001, 'weight_decay': 0.1, 'gradient_clip': 0.1}, 1e-6, 0)
  def test_sgd_high_lr_wd_grad_clip(self): self._test_sgd(1, {'lr': 10, 'weight_decay': 0.1, 'gradient_clip': 0.1}, 1e-6, 1e-5)
  ...
  def test_multistep_sgd_grad_clip(self): self._test_sgd(10, {'lr': 0.001, 'gradient_clip': 0.1}, 1e-6, 0)
  def test_multistep_sgd_high_lr_grad_clip(self): self._test_sgd(10, {'lr': 10, 'gradient_clip': 0.1}, 1e-6, 3e-4)
  def test_multistep_sgd_wd_grad_clip(self): self._test_sgd(10, {'lr': 0.001, 'weight_decay': 0.1, 'gradient_clip': 0.1}, 1e-6, 0)
  def test_multistep_sgd_high_lr_wd_grad_clip(self): self._test_sgd(10, {'lr': 9, 'weight_decay': 0.1, 'gradient_clip': 0.1}, 1e-6, 3e-4)
  ...
  def test_multistep_sgd_nesterov_momentum_grad_clip(self): self._test_sgd(10, {'lr': 0.001, 'momentum': 0.9, 'nesterov': True, 'gradient_clip': 0.1}, 1e-5, 0)
  def test_multistep_sgd_high_lr_nesterov_momentum_grad_clip(self): self._test_sgd(10, {'lr': 10, 'momentum': 0.9, 'nesterov': True, 'gradient_clip': 0.1}, 1e-5, 3e-4)
  def test_multistep_sgd_nesterov_momentum_wd_grad_clip(self): self._test_sgd(10, {'lr': 0.001, 'momentum': 0.9, 'nesterov': True, 'weight_decay': 0.1, 'gradient_clip': 0.1}, 1e-5, 0)
  def test_multistep_sgd_high_lr_nesterov_momentum_wd_grad_clip(self): self._test_sgd(10, {'lr': 9, 'momentum': 0.9, 'nesterov': True, 'weight_decay': 0.1, 'gradient_clip': 0.1}, 1e-5, 3e-4)
  ...
  def test_adam_grad_clip(self): self._test_adam(1, {'lr': 0.001, 'gradient_clip': 0.1}, 1e-5, 0)
  def test_adam_high_lr_grad_clip(self): self._test_adam(1, {'lr': 10, 'gradient_clip': 0.1}, 1e-5, 1e-5)
  def test_adamw_grad_clip(self): self._test_adamw(1, {'lr': 0.001, 'gradient_clip': 0.1}, 1e-5, 0)
  def test_adamw_high_lr_grad_clip(self): self._test_adamw(1, {'lr': 10, 'gradient_clip': 0.1}, 1e-5, 1e-5)
  ...
  def test_multistep_adam_grad_clip(self): self._test_adam(10, {'lr': 0.001, 'gradient_clip': 0.1}, 1e-5, 0)
  def test_multistep_adam_high_lr_grad_clip(self): self._test_adam(10, {'lr': 10, 'gradient_clip': 0.1}, 1e-5, 3e-4)
  ...
  def test_multistep_adamw_grad_clip(self): self._test_adamw(10, {'lr': 0.001, 'gradient_clip': 0.1}, 1e-5, 0)
  def test_multistep_adamw_high_lr_grad_clip(self): self._test_adamw(10, {'lr': 10, 'gradient_clip': 0.1}, 1e-5, 3e-4)
