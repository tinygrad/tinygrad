...
from tinygrad.helpers import CI, CPU_LVP, getenv
...
# TODO: CI CUDA segfaults on sin, WEBGPU and LVP sines are not precise enough for large numbers
if (getenv("MOCKGPU") and Device.DEFAULT in {"NV", "CUDA"}) or Device.DEFAULT == "WEBGPU" or CPU_LVP:
...
class TestDTypeALU(unittest.TestCase):
  ...
  # Metal and CUDA and HIP and LVP behave differently than numpy in CI for overflows
  skip_overflow = (CI and Device.DEFAULT in {"AMD", "NV", "CUDA"}) or CPU_LVP
