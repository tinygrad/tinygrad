...
def helper_test_lin(lin: Linearizer, opts, failed_platforms):
  for opt in opts:
    try:
      ...
      return Device.DEFAULT not in failed_platforms
  if Device.DEFAULT in failed_platforms:
...
class TestLinearizerFailures(unittest.TestCase):
  def test_failure_1(self):
    ...
    assert helper_test_lin(Linearizer(ast), [], failed_platforms=["CLANG"])
  ...
  def test_failure_2(self):
    ...
    assert helper_test_lin(Linearizer(ast), opts, failed_platforms=["CPU", "TORCH"])
  ...
  def test_failure_3(self):
    ...
    assert helper_test_lin(Linearizer(ast), opts, failed_platforms=["METAL", "GPU", "CUDA"])
  ...
  def test_failure_4(self):
    ...
    assert helper_test_lin(Linearizer(ast), opts, failed_platforms=["METAL"])
  ...
  def test_failure_5(self):
    ...
    assert helper_test_lin(Linearizer(ast), opts, failed_platforms=[])
  ...
  def test_failure_7(self):
    ...
    assert helper_test_lin(Linearizer(ast), opts, failed_platforms=["LLVM"])
  ...
  def test_failure_8(self):
    ...
    assert helper_test_lin(Linearizer(ast), opts, failed_platforms=["CLANG", "METAL"])
