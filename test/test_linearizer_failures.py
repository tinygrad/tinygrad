...
class TestLinearizerFailures(unittest.TestCase):
  ...
  def test_failure_29(self):
    ...
    opts = [Opt(op=OptOps.TC, axis=0, amt=-1, arg=1), Opt(op=OptOps.PADTO, axis=2, amt=32)]
  ...
  def test_failure_32(self):
    ...
    opts = [Opt(op=OptOps.TC, axis=2, amt=-1, arg=2), Opt(op=OptOps.UPCAST, axis=2, amt=7), Opt(op=OptOps.UNROLL, axis=1, amt=0), Opt(op=OptOps.LOCAL, axis=1, amt=16)]
  ...
  def test_failure_34(self, unroll=False):
    ...
    opts = [Opt(op=OptOps.TC, axis=0, amt=-1, arg=2), Opt(op=OptOps.UNROLL, axis=0, amt=0)] if unroll else [Opt(op=OptOps.TC, axis=0, amt=-1, arg=2)]
    helper_test_lin(Kernel(ast), opts=opts, failed_platforms=[])
  ...
  def test_failure_37(self):
    ...
    for axis in [0,1,2,3,4,5]:
      opts = [Opt(op=OptOps.TC, axis=axis, amt=-1, arg=2)]
      helper_test_lin(Kernel(ast), opts=opts, failed_platforms=[])
  ...
  def test_failure_41(self):
    ...
    opts=[Opt(op=OptOps.TC, axis=5, amt=-1, arg=2), Opt(op=OptOps.UNROLL, axis=0, amt=0)]
  ...
  def test_failure_48(self):
    ...
    opts = [Opt(op=OptOps.TC, axis=0, amt=-1, arg=0), Opt(op=OptOps.UPCAST, axis=1, amt=4), Opt(op=OptOps.UPCAST, axis=0, amt=4), Opt(op=OptOps.LOCAL, axis=0, amt=2)]
  ...
  def test_failure_49(self):
    ...
    opts = [Opt(op=OptOps.TC, axis=0, amt=-1, arg=2), Opt(op=OptOps.UPCAST, axis=0, amt=2)]
    helper_test_lin(Kernel(ast, opts=Device[Device.DEFAULT].renderer), opts=opts, failed_platforms=[])
            ...
            UOp(Ops.EXP2, dtypes.half, arg=None, src=(
              UOp(Ops.MUL, dtypes.half, arg=None, src=(
                ...
                UOp(Ops.WHERE, dtypes.half, arg=None, src=(
                  ...
                  x9,)),)),)),)),)),)),))
    opts = [Opt(op=OptOps.TC, axis=0, amt=-1, arg=2)]
    helper_test_lin(Kernel(ast, opts=Device[Device.DEFAULT].renderer), opts=opts, failed_platforms=[])
  ...
  def test_failure_52(self):
    ...
    opts = [Opt(op=OptOps.TC, axis=0, amt=-1, arg=2), Opt(op=OptOps.UPCAST, axis=1, amt=4), Opt(op=OptOps.LOCAL, axis=0, amt=16)]
    helper_test_lin(Kernel(ast, opts=Device[Device.DEFAULT].renderer), opts=opts, failed_platforms=[])
  ...
  def test_failure_54(self):
    ...
    opts = [Opt(op=OptOps.TC, axis=2, amt=-1, arg=2), Opt(op=OptOps.UPCAST, axis=2, amt=7), Opt(op=OptOps.UPCAST, axis=1, amt=2)]
