  ...
  def test_failure_1(self):
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
          UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(BinaryOps.ADD, (0, 2, 4, 6)), src=(
          UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
            x5:=UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
              UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
  ...
  def test_failure_6(self):
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.ADD, dtypes.int, arg=BinaryOps.ADD, src=(
  ...
  def test_failure_8(self):
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.SQRT, dtypes.float, arg=UnaryOps.SQRT, src=(
          UOp(Ops.RECIP, dtypes.float, arg=UnaryOps.RECIP, src=(
            UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
              UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(BinaryOps.ADD, (2,)), src=(
                  UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                    x9:=UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
                      UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                        UOp(Ops.DEFINE_GLOBAL, dtypes.float.ptr(), arg=1, src=()),
  ...
  def test_failure_10(self):
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.ADD, dtypes.half, arg=BinaryOps.ADD, src=(
          UOp(Ops.REDUCE_AXIS, dtypes.half, arg=(BinaryOps.ADD, (3,)), src=(
            UOp(Ops.MUL, dtypes.half, arg=BinaryOps.MUL, src=(
        ...
        UOp(Ops.RECIP, dtypes.float, arg=UnaryOps.RECIP, src=(
          UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(BinaryOps.ADD, (0, 2, 3)), src=(
            UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
              UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
                  UOp(Ops.MAX, dtypes.float, arg=BinaryOps.MAX, src=(
                    UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
                      UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                        UOp(Ops.DEFINE_GLOBAL, dtypes.float.ptr(), arg=1, src=()),
                ...
                UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                  UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
                    ...
                    UOp(Ops.CAST, dtypes.float, arg=None, src=(
                      UOp(Ops.CMPLT, dtypes.bool, arg=BinaryOps.CMPLT, src=(
                        UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
                          UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                            UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                              UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(BinaryOps.ADD, (0, 2, 4, 8)), src=(
          UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
            x5:=UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
              x6:=UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
                  UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                    UOp(Ops.DEFINE_GLOBAL, dtypes.float.ptr(), arg=1, src=()),
                    UOp(Ops.VIEW, dtypes.void, arg=ShapeTracker(views=(View(shape=(2, 1, 4, 1, 3, 4, 2, 6, 1, 3), strides=(0, 0, 0, 0, 0, 18, 0, 3, 0, 1), offset=0, mask=None, contiguous=False),)), src=()),)),
                ...
                UOp(Ops.RECIP, dtypes.float, arg=UnaryOps.RECIP, src=(
                  UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                    ...
                    ast_const(dtypes.float, 2.0, st_src=(
                      UOp(Ops.VIEW, dtypes.void, arg=ShapeTracker(views=(View(shape=(1, 96, 1, 1), strides=(0, 0, 0, 0), offset=0, mask=None, contiguous=False),)), src=()),)),)),)),)),
              x80:=UOp(Ops.RECIP, dtypes.float, arg=UnaryOps.RECIP, src=(
                UOp(Ops.ADD, dtypes.float, arg=BinaryOps.ADD, src=(
                  UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
                    UOp(Ops.LOAD, dtypes.float, arg=None, src=(
  ...
  def test_failure_28(self):
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.WHERE, dtypes.bfloat16, arg=TernaryOps.WHERE, src=(
          UOp(Ops.CMPLT, dtypes.bool, arg=BinaryOps.CMPLT, src=(
            ...
            x9:=ast_const(dtypes.bfloat16, 230.0, st_src=(
              UOp(Ops.VIEW, dtypes.void, arg=ShapeTracker(views=(View(shape=(1,), strides=(0,), offset=0, mask=None, contiguous=True),)), src=()),)),)),
          UOp(Ops.ADD, dtypes.bfloat16, arg=BinaryOps.ADD, src=(
            UOp(Ops.MUL, dtypes.bfloat16, arg=BinaryOps.MUL, src=(
              UOp(Ops.MUL, dtypes.bfloat16, arg=BinaryOps.MUL, src=(
                 x5,
      ...
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(BinaryOps.ADD, (0,)), src=(
          UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
            ...
            UOp(Ops.WHERE, dtypes.float, arg=TernaryOps.WHERE, src=(
              UOp(Ops.CMPNE, dtypes.bool, arg=BinaryOps.CMPNE, src=(
                 x5,
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.CAST, dtypes.uchar, arg=None, src=(
          UOp(Ops.ADD, dtypes.uint, arg=BinaryOps.ADD, src=(
      ...
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(BinaryOps.ADD, (2, 3)), src=(
          UOp(Ops.MUL, dtypes.float, arg=BinaryOps.MUL, src=(
            ...
            UOp(Ops.CAST, dtypes.float, arg=None, src=(
              UOp(Ops.MUL, dtypes.bool, arg=BinaryOps.MUL, src=(
                UOp(Ops.CMPNE, dtypes.bool, arg=BinaryOps.CMPNE, src=(
                  UOp(Ops.CMPNE, dtypes.bool, arg=BinaryOps.CMPNE, src=(
                    UOp(Ops.LOAD, dtypes.int, arg=None, src=(
  ...
  def test_failure_51(self):
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.RECIP, dtypes.half, arg=UnaryOps.RECIP, src=(
          UOp(Ops.ADD, dtypes.half, arg=BinaryOps.ADD, src=(
            UOp(Ops.WHERE, dtypes.half, arg=TernaryOps.WHERE, src=(
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.uchar, arg=(BinaryOps.ADD, (1,)), src=(
          UOp(Ops.MUL, dtypes.uchar, arg=BinaryOps.MUL, src=(
            UOp(Ops.LOAD, dtypes.uchar, arg=None, src=(
              UOp(Ops.DEFINE_GLOBAL, dtypes.uchar.ptr(), arg=1, src=()),
                ...
                UOp(Ops.CMPNE, dtypes.bool, arg=BinaryOps.CMPNE, src=(
                  ...
                  UOp(Ops.ADD, dtypes.int, arg=BinaryOps.ADD, src=(
                    UOp(Ops.REDUCE_AXIS, dtypes.int, arg=(BinaryOps.ADD, (2,)), src=(
                      UOp(Ops.WHERE, dtypes.int, arg=TernaryOps.WHERE, src=(
                    ...
                    UOp(Ops.WHERE, dtypes.int, arg=TernaryOps.WHERE, src=(
                      ...
                      UOp(Ops.CONST, dtypes.int, arg=-1, src=()),
                      x20,)),)),)),
                UOp(Ops.WHERE, dtypes.bool, arg=TernaryOps.WHERE, src=(
                  x22,
