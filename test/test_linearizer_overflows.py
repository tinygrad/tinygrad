...
class TestLinearizerOverflow(unittest.TestCase):
  def test_overflow_1(self):
    ast = UOp(Ops.SINK, None, arg=None, src=(
      UOp(Ops.STORE, None, arg=None, src=(
        UOp(Ops.DEFINE_REG, dtypes.float.ptr(51380224), arg=("global", 0), src=()),
          ...
          UOp(Ops.ADD, dtypes.float, arg=None, src=(
            UOp(Ops.MUL, dtypes.float, arg=None, src=(
              UOp(Ops.MUL, dtypes.float, arg=None, src=(
                  ...
                  UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(Ops.ADD, (7, 6, 5)), src=(
                    UOp(Ops.MUL, dtypes.float, arg=None, src=(
                      UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                        UOp(Ops.DEFINE_REG, dtypes.float.ptr(9633792), arg=("global", 1), src=()),
                      ...
                      UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                        UOp(Ops.DEFINE_REG, dtypes.float.ptr(9408), arg=("global", 2), src=()),
                ...
                UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                  UOp(Ops.DEFINE_REG, dtypes.float.ptr(64), arg=("global", 3), src=()),
                  ...
                  UOp(Ops.RECIP, dtypes.float, arg=None, src=(
                    UOp(Ops.ADD, dtypes.float, arg=None, src=(
                      ...
                      UOp(Ops.CONST, dtypes.float, arg=1e-05, src=(
                         x17,)),)),)),)),)),)),
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(64), arg=("global", 4), src=()),
               x20,)),)),
           x16,)),)),))
    ...
    ast = UOp(Ops.SINK, None, arg=None, src=(
      UOp(Ops.STORE, None, arg=None, src=(
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(Ops.ADD, (7, 6, 5)), src=(
          UOp(Ops.MUL, dtypes.float, arg=None, src=(
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(16777216), arg=("global", 1), src=()),
            ...
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(18432), arg=("global", 2), src=()),
    ...
    ast = UOp(Ops.SINK, None, arg=None, src=(
      UOp(Ops.STORE, None, arg=None, src=(
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(Ops.ADD, (7, 6, 5)), src=(
          UOp(Ops.MUL, dtypes.float, arg=None, src=(
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(33554432), arg=("global", 1), src=()),
            ...
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(147456), arg=("global", 2), src=()),
  ...
  def test_overflow_4(self):
    ast = UOp(Ops.SINK, None, arg=None, src=(
      UOp(Ops.STORE, None, arg=None, src=(
        UOp(Ops.DEFINE_REG, dtypes.float.ptr(8388608), arg=("global", 0), src=()),
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(Ops.ADD, (7, 6, 5)), src=(
          UOp(Ops.MUL, dtypes.float, arg=None, src=(
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(8388608), arg=("global", 1), src=()),
  ...
  def test_overflow_5(self):
    ast = UOp(Ops.SINK, None, arg=None, src=(
      UOp(Ops.STORE, None, arg=None, src=(
        UOp(Ops.DEFINE_REG, dtypes.float.ptr(4194304), arg=("global", 0), src=()),
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(Ops.ADD, (7, 6, 5)), src=(
          UOp(Ops.MUL, dtypes.float, arg=None, src=(
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(4194304), arg=("global", 1), src=()),
  ...
  def test_overflow_6(self):
    ast = UOp(Ops.SINK, None, arg=None, src=(
      UOp(Ops.STORE, None, arg=None, src=(
        UOp(Ops.DEFINE_REG, dtypes.float.ptr(6291456), arg=("global", 0), src=()),
        ...
        UOp(Ops.REDUCE_AXIS, dtypes.float, arg=(Ops.ADD, (7, 6, 5)), src=(
          UOp(Ops.MUL, dtypes.float, arg=None, src=(
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_REG, dtypes.float.ptr(6291456), arg=("global", 1), src=()),
...
class TestLinearizerOverflowAlt(unittest.TestCase):
  def test_overflow_1(self):
    BS = 2
    g0, g1, g2 = [UOp(Ops.DEFINE_REG, dtypes.float.ptr(), arg=("global", i)) for i in range(3)]
