...
class TestOps(unittest.TestCase):
  ...
  def test_std_keepdim(self):
    helper_test_op([(45, 65, 85)], lambda x: torch.std(x, keepdim=True, correction=0), lambda x: Tensor.std(x, keepdim=True))
    helper_test_op([(45, 65, 85)], lambda x: torch.std(x, keepdim=True, correction=1), lambda x: Tensor.std(x, keepdim=True, unbiased=True))
