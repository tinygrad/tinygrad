...
class TestOps(unittest.TestCase):
  ...
  def test_pad_slice(self):
    for value in 0., 3.456:
      ...
      helper_test_op([(2,2,2)], lambda x: torch.nn.functional.pad(x,(0,1,0,0,2,0), value=value)[0].transpose(0,1), lambda x: x.pad(((2,0),(0,0),(0,1)), value=value)[0].transpose(0,1))
      helper_test_op([(2,1,2)], lambda x: torch.nn.functional.pad(x,(0,1,0,0,2,0), value=value)[0].expand(5,-1), lambda x: x.pad(((2,0),(0,0),(0,1)), value=value)[0].expand(5,-1))
      helper_test_op([(2,3,2)], lambda x: torch.flip(torch.nn.functional.pad(x,(0,1,0,0,2,0), value=value)[0],(0,)), lambda x: x.pad(((2,0),(0,0),(0,1)), value=value)[0].flip((0,)))
