...
class TestOps(unittest.TestCase):
  ...
  def test_lerp(self):
    helper_test_op([(45,35), (45,35), (45,35)], lambda x,y,z: x.lerp(y,z), forward_only=True)
    helper_test_op(None, lambda x,y,z: x.lerp(y,z), forward_only=True, vals=[[1.,2.,3.], [4.,5.,6.], 0.5])
