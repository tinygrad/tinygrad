...
class TestOps(unittest.TestCase):
  ...
  def test_narrow(self):
    ...
    helper_test_op([(2,)], lambda x: torch.narrow(x,0,-1,1), lambda x: x.narrow(0,-1,1), forward_only=True)
    ...
    helper_test_op([(1,2)], lambda x: torch.narrow(x,-1,torch.tensor(0),1), lambda x: x.narrow(-1,Tensor(0),1), forward_only=True)
