...
class TestOps(unittest.TestCase):
  ...
  def test_padded_conv_transpose2d(self):
    ...
    with self.assertRaises(ValueError): Tensor.conv_transpose2d(Tensor.randn((2,16,2,2)), Tensor.randn((32,16,3,3)), padding=(1,1,1))
    with self.assertRaises(ValueError): Tensor.conv_transpose2d(Tensor.randn((2,16,2,2)), Tensor.randn((32,16,3,3)), padding=(0,1,0,1))
  ...
  def test_conv2d_errors(self):
    ...
    with self.assertRaises(ValueError): Tensor.conv2d(Tensor.randn((2,16,2,2)), Tensor.randn((32,16,3,3)), padding=(1,1,1))
  ...
  def test_max_pool2d_padding(self):
    ...
    with self.assertRaises(ValueError): Tensor.max_pool2d(Tensor.randn((32,2,110,28)), kernel_size=(2,2), padding=(1,1,1))
    with self.assertRaises(ValueError): Tensor.max_pool2d(Tensor.randn((32,2,110,28)), kernel_size=(2,2), padding=(0,1,0,1))
  ...
  def test_avg_pool2d_padding(self):
    ...
    with self.assertRaises(ValueError): Tensor.avg_pool2d(Tensor.randn((32,2,111,28)), kernel_size=(2,2), padding=(1,1,1))
    with self.assertRaises(ValueError): Tensor.max_pool2d(Tensor.randn((32,2,110,28)), kernel_size=(2,2), padding=(0,1,0,1))
