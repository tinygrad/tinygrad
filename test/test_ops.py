...
class TestOps(unittest.TestCase):
  ...
  def test_narrow(self):
    ...
    helper_test_op([(2,)], lambda x: torch.narrow(x, 0, 0, 1), lambda x: x.narrow(0, 0, 1), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, 0, 0, 2), lambda x: x.narrow(0, 0, 2), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, 0, 1, 0), lambda x: x.narrow(0, 1, 0), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, 0, 2, 0), lambda x: x.narrow(0, 2, 0), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, -1, 0, 0), lambda x: x.narrow(-1, 0, 0), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, -1, 0, 1), lambda x: x.narrow(-1, 0, 1), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, -1, 0, 2), lambda x: x.narrow(-1, 0, 2), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, -1, 1, 0), lambda x: x.narrow(-1, 1, 0), forward_only=True)
    helper_test_op([(2,)], lambda x: torch.narrow(x, -1, 2, 0), lambda x: x.narrow(-1, 2, 0), forward_only=True)

    helper_test_op([(2,1)], lambda x: torch.narrow(x, 0, 0, 0), lambda x: x.narrow(0, 0, 0), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, 0, 0, 1), lambda x: x.narrow(0, 0, 1), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, 0, 0, 2), lambda x: x.narrow(0, 0, 2), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, 0, 1, 0), lambda x: x.narrow(0, 1, 0), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, 0, 2, 0), lambda x: x.narrow(0, 2, 0), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, -1, 0, 0), lambda x: x.narrow(-1, 0, 0), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, -1, 0, 1), lambda x: x.narrow(-1, 0, 1), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, -1, 1, 0), lambda x: x.narrow(-1, 1, 0), forward_only=True)

    helper_test_op([(1,2)], lambda x: torch.narrow(x, 0, 0, 0), lambda x: x.narrow(0, 0, 0), forward_only=True)
    helper_test_op([(1,2)], lambda x: torch.narrow(x, 0, 0, 1), lambda x: x.narrow(0, 0, 1), forward_only=True)
    helper_test_op([(1,2)], lambda x: torch.narrow(x, 0, 1, 0), lambda x: x.narrow(0, 1, 0), forward_only=True)
    helper_test_op([(1,2)], lambda x: torch.narrow(x, -1, 0, 0), lambda x: x.narrow(-1, 0, 0), forward_only=True)
    helper_test_op([(1,2)], lambda x: torch.narrow(x, -1, 0, 1), lambda x: x.narrow(-1, 0, 1), forward_only=True)
    helper_test_op([(1,2)], lambda x: torch.narrow(x, -1, 1, 0), lambda x: x.narrow(-1, 1, 0), forward_only=True)

    helper_test_op([(2,2)], lambda x: torch.narrow(x, 0, 0, 0), lambda x: x.narrow(0, 0, 0), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, 0, 0, 1), lambda x: x.narrow(0, 0, 1), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, 0, 0, 2), lambda x: x.narrow(0, 0, 2), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, 0, 1, 0), lambda x: x.narrow(0, 1, 0), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, 0, 2, 0), lambda x: x.narrow(0, 2, 0), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, -1, 0, 0), lambda x: x.narrow(-1, 0, 0), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, -1, 0, 1), lambda x: x.narrow(-1, 0, 1), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, -1, 0, 2), lambda x: x.narrow(-1, 0, 2), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, -1, 1, 0), lambda x: x.narrow(-1, 1, 0), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, -1, 2, 0), lambda x: x.narrow(-1, 2, 0), forward_only=True)

    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, 0, 0, 0), lambda x: x.narrow(0, 0, 0), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, 0, 0, 1), lambda x: x.narrow(0, 0, 1), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, 0, 0, 2), lambda x: x.narrow(0, 0, 2), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, 0, 1, 0), lambda x: x.narrow(0, 1, 0), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, 0, 2, 0), lambda x: x.narrow(0, 2, 0), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, -1, 0, 0), lambda x: x.narrow(-1, 0, 0), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, -1, 0, 1), lambda x: x.narrow(-1, 0, 1), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, -1, 0, 2), lambda x: x.narrow(-1, 0, 2), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, -1, 1, 0), lambda x: x.narrow(-1, 1, 0), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, -1, 2, 0), lambda x: x.narrow(-1, 2, 0), forward_only=True)

    helper_test_op([(2,)], lambda x: torch.narrow(x, 0, torch.tensor(0), 0), lambda x: x.narrow(0, Tensor(0), 0), forward_only=True)
    helper_test_op([(2,1)], lambda x: torch.narrow(x, 0, torch.tensor(0), 0), lambda x: x.narrow(0, Tensor(0), 0), forward_only=True)
    helper_test_op([(1,2)], lambda x: torch.narrow(x, 0, torch.tensor(0), 0), lambda x: x.narrow(0, Tensor(0), 0), forward_only=True)
    helper_test_op([(2,2)], lambda x: torch.narrow(x, 0, torch.tensor(0), 0), lambda x: x.narrow(0, Tensor(0), 0), forward_only=True)
    helper_test_op([(2,2,2)], lambda x: torch.narrow(x, 0, torch.tensor(0), 0), lambda x: x.narrow(0, Tensor(0), 0), forward_only=True)
