...
class TestOps(unittest.TestCase):
  ...
  def test_binary_crossentropy_pos_weights(self):
    ...
    helper_test_op([(32,10), (32,10)], lambda x,y: torch.nn.functional.binary_cross_entropy_with_logits(x,torch.clip(y,0,1),pos_weight=torch.tensor(pos_weight), reduction='none'),
                                       lambda x,y: x.binary_crossentropy_logits(y.clip(0,1),pos_weight=Tensor(pos_weight), reduction='none'))
