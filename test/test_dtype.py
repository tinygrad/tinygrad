...
def _assert_eq(tensor:Tensor, target_dtype:DType, target):
  ...
  try:
    ...
    np.testing.assert_allclose(tensor.numpy(), target, rtol={dtypes.float16:1e-3, dtypes.bfloat16:1e-2, dtypes.f8e4m3:1e-1, dtypes.f8e5m2: 1e-1}.get(target_dtype, 1e-7))
  except AssertionError as e:
