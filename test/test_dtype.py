...
class TestBitCast(unittest.TestCase):
  def test_shape_expand_bitcast(self):
    _test_bitcast(Tensor([1,2,3], dtype=dtypes.float32), dtypes.uint8, [  0,   0, 128,  63,   0,   0,   0,  64,   0,   0,  64,  64])

  def test_shape_contract_bitcast(self):
    _test_bitcast(Tensor([  0,   0, 128,  63,   0,   0,   0,  64,   0,   0,  64,  64], dtype=dtypes.uint8), dtypes.float32, [1., 2., 3.])

  def test_shape_contract_bitcast_wrong_size(self):
    with self.assertRaises(RuntimeError):
      _test_bitcast(Tensor([  0,   0, 128,  63,   0,   0,   0,  64,   0,   0,  64], dtype=dtypes.uint8), dtypes.float32, [1., 2., 3.])
