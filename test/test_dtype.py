...
def _assert_eq(tensor:Tensor, target_dtype:DType, target, rtol=None):
  ...
  try:
    ...
    np.testing.assert_allclose(tensor.numpy(), target, rtol=rtol or {dtypes.float16:1e-3, dtypes.bfloat16:1e-2, dtypes.f8e4m3:1.5e-1, dtypes.f8e5m2: 1.5e-1}.get(target_dtype, 1e-7))
  except AssertionError as e:
