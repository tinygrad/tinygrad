...
def _assert_eq(tensor:Tensor, target_dtype:DType, target):
  ...
  try:
    ...
    np.testing.assert_allclose(tensor.numpy(), target, rtol={dtypes.double:1e-5, dtypes.float16:1e-3, dtypes.bfloat16:1e-2}.get(target_dtype, 1e-7))
  except AssertionError as e:
...
class TestBitCast(unittest.TestCase):
  def test_shape_change_bitcast(self):
    ...
    _test_bitcast(Tensor([
      ...
      [0, 0, -14336, -16417],
      [0, 0, 30720, 16370]
    ], dtype=dtypes.int16), dtypes.int32,
      [[0, -1074918400],
       [0, -1075799040],
       [0, -1075853312],
       [0, 1072855040]])
