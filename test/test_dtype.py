...
def _assert_eq(tensor:Tensor, target_dtype:DType, target):
  ...
  try:
    ...
    rtol = {dtypes.fp8_e4m3:1e-1, dtypes.fp8_e5m2:1e-1, dtypes.float16:1e-3, dtypes.bfloat16:1e-2}.get(target_dtype, 1e-7)
...
def _test_bitcast(a:Tensor, target_dtype:DType, target=None):
  if target_dtype in (dtypes.fp8_e4m3, dtypes.fp8_e5m2, dtypes.bfloat16): raise unittest.SkipTest("no test for bf16/fp8 bitcast yet")
