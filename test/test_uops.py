...
def _uops_to_prg(uops_list):
    uops = linearize_uop(
        full_graph_rewrite(UOp.sink(*uops_list), opts=Device[Device.DEFAULT].renderer)
    )
...
class TestConstantFolding(unittest.TestCase):
    ...
    def test_bitcast_const(self):
        ...
        assert any(
            uop.op is Ops.BITCAST for uop in ji.prg.p.uops
        ), f"{[uop.op for uop in ji.prg.p.uops]} does not contain bitcast"
