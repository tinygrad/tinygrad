...
class TestAssembly(unittest.TestCase):
  def test_pointer_arithmetics_caching(self):
    ...
    uops = UOpGraph()
    u1 = uops.add(UOps.DEFINE_GLOBAL, PtrDType(dtypes.int), tuple(), arg=(0, 'data0', True))
    u2 = uops.add(UOps.SPECIAL, dtypes.int, tuple(), arg=(0, 'gidx0', 9))
    u3 = uops.add(UOps.CONST, dtypes.int, tuple(), arg=42)
    u4 = uops.add(UOps.ALU, dtypes.int, (u2, u3), arg=BinaryOps.MUL)
    u5 = uops.add(UOps.CONST, dtypes.int, tuple(), arg=0)
    u6 = uops.add(UOps.CONST, dtypes.int, tuple(), arg=1)
    u7 = uops.add(UOps.ALU, dtypes.int, (u4, u5), arg=BinaryOps.ADD)
    u8 = uops.add(UOps.ALU, dtypes.int, (u4, u6), arg=BinaryOps.ADD)
