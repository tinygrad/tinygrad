...
class TestLinearizer(unittest.TestCase):
  ...
  def test_tensor_cores_upcast_wrong_toposort(self):
    ...
    opt = [Opt(op=OptOps.TC, axis=0, amt=2), Opt(op=OptOps.LOCAL, axis=0, amt=4), Opt(op=OptOps.UNROLL, axis=0, amt=4), Opt(op=OptOps.UPCAST, axis=5, amt=0)]
