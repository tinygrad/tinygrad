...
from tinygrad.ops import UOp, Ops, TernaryOps, UnaryOps, GroupOp
...
class TestLinearizer(unittest.TestCase):
  ...
  def test_multireduce_with_parallel(self):
    ...
    first_reduce = UOp(Ops.REDUCE_AXIS, dtypes.float, (first_x,), (Ops.ADD, (2,)))
    first_reduce_p = UOp(Ops.REDUCE_AXIS, dtypes.float, (first_x_p.alu(UnaryOps.EXP2),), (Ops.ADD, (2,)))
  ...
  def test_div_collapse(self):
    def helper(t, msg, max_ops=0):
      ...
      assert sum(u.op in {UnaryOps.RECIP, Ops.FDIV} for u in lin.linearize().uops) == max_ops, msg
