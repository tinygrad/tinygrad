...
class TestBEAM(unittest.TestCase):
  ...
  def test_get_kernel_actions_dedup(self):
    ...
    candidates = [
      ...
      Opt(op=OptOps.LOCAL, axis=0, arg=0),
      Opt(op=OptOps.LOCAL, axis=0, arg=4),
      Opt(op=OptOps.UNROLL, axis=0, arg=0),
      Opt(op=OptOps.UNROLL, axis=0, arg=3),
      Opt(op=OptOps.GROUP, axis=0, arg=0),
      Opt(op=OptOps.GROUP, axis=0, arg=3),
      Opt(op=OptOps.GROUPTOP, axis=0, arg=0),
      Opt(op=OptOps.GROUPTOP, axis=0, arg=3),
    ]
  ...
  def test_search_over_shape(self):
    ...
    if len(multi_shape_dtype_pairs) == 0:
      raise unittest.SkipTest("only one tc available per dtype pair to search over")
        ...
        UOp(
          ...
          src=(
            UOp(
              ...
              arg=ShapeTracker(views=(View(shape=(1, 1, 256), strides=(0, 0, 1), offset=0, mask=None, contiguous=True),)),
              src=(  # noqa: E501
                ...
                UOp(
                  ...
                  src=(
                                      ...
                                      src=(
                                        UOp(
                                          ...
                                          src=(
                                            UOp(
                                              Ops.VIEW,
                                              dtypes.float.ptr(64128),
                                              arg=ShapeTracker(
                                                views=(
                                                  View(shape=(384768,), strides=(1,), offset=0, mask=((0, 64128),), contiguous=False),
                                                  View(shape=(1, 501, 256), strides=(0, 1, 501), offset=256512, mask=None, contiguous=False),
                                                )
                                              ),
                                              src=(  # noqa: E501
                                        ...
                                        UOp(
                                          ...
                                          src=(
                                            UOp(
                                              ...
                                              arg=ShapeTracker(
                                                views=(
                                                  View(shape=(384768,), strides=(1,), offset=-64128, mask=((64128, 128256),), contiguous=False),
                                                  View(shape=(1, 501, 256), strides=(0, 1, 501), offset=256512, mask=None, contiguous=False),
                                                )
                                              ),
                                              src=(  # noqa: E501
                                    ...
                                    UOp(
                                      ...
                                      src=(
                                        UOp(
                                          ...
                                          arg=ShapeTracker(
                                            views=(
                                              View(shape=(384768,), strides=(1,), offset=-128256, mask=((128256, 192384),), contiguous=False),
                                              View(shape=(1, 501, 256), strides=(0, 1, 501), offset=256512, mask=None, contiguous=False),
                                            )
                                          ),
                                          src=(  # noqa: E501
                                ...
                                UOp(
                                  ...
                                  src=(
                                    UOp(
                                      ...
                                      arg=ShapeTracker(
                                        views=(
                                          View(shape=(384768,), strides=(1,), offset=-192384, mask=((192384, 256512),), contiguous=False),
                                          View(shape=(1, 501, 256), strides=(0, 1, 501), offset=256512, mask=None, contiguous=False),
                                        )
                                      ),
                                      src=(  # noqa: E501
                            ...
                            UOp(
                              ...
                              src=(
                                UOp(
                                  ...
                                  arg=ShapeTracker(
                                    views=(
                                      View(shape=(384768,), strides=(1,), offset=-256512, mask=((256512, 320640),), contiguous=False),
                                      View(shape=(1, 501, 256), strides=(0, 1, 501), offset=256512, mask=None, contiguous=False),
                                    )
                                  ),
                                  src=(  # noqa: E501
                        ...
                        UOp(
                          ...
                          src=(
                            UOp(
                              ...
                              arg=ShapeTracker(
                                views=(
                                  View(shape=(384768,), strides=(1,), offset=-320640, mask=((320640, 384768),), contiguous=False),
                                  View(shape=(1, 501, 256), strides=(0, 1, 501), offset=256512, mask=None, contiguous=False),
                                )
                              ),
                              src=(  # noqa: E501
                    ...
                    UOp(
                      Ops.CONST,
                      dtypes.float,
                      arg=1.4285714285714286,
                      src=(
                        UOp(
                          Ops.VIEW,
                          dtypes.void,
                          arg=ShapeTracker(views=(View(shape=(1, 501, 256), strides=(0, 0, 0), offset=0, mask=None, contiguous=False),)),
                          src=(),
                        ),
                      ),
                    ),
