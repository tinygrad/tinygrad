...
CXClientData = ctypes.POINTER(None)
@record
class struct_CXUnsavedFile:
  SIZE = 24
  Filename: Annotated[ctypes.POINTER(ctypes.c_char), 0]
  Contents: Annotated[ctypes.POINTER(ctypes.c_char), 8]
...
class struct_CXVersion:
  SIZE = 12
  Major: Annotated[ctypes.c_int32, 0]
  Minor: Annotated[ctypes.c_int32, 4]
  Subminor: Annotated[ctypes.c_int32, 8]
...
class struct_CXIndexOptions:
  ...
  ThreadBackgroundPriorityForIndexing: Annotated[ctypes.c_ubyte, 4]
  ThreadBackgroundPriorityForEditing: Annotated[ctypes.c_ubyte, 5]
  ExcludeDeclarationsFromPCH: Annotated[ctypes.c_uint32, 6, 1, 0]
  DisplayDiagnostics: Annotated[ctypes.c_uint32, 6, 1, 1]
  StorePreamblesInMemory: Annotated[ctypes.c_uint32, 6, 1, 2]
  PreambleStoragePath: Annotated[ctypes.POINTER(ctypes.c_char), 8]
  InvocationEmissionPath: Annotated[ctypes.POINTER(ctypes.c_char), 16]
...
class CXSourceRangeList:
  ...
  ranges: Annotated[ctypes.POINTER(CXSourceRange), 8]
@record
class CXSourceRange:
  SIZE = 24
  ptr_data: Annotated[Array[ctypes.POINTER(None), Literal[2]], 0]
...
class CXString:
  ...
  private_flags: Annotated[ctypes.c_uint32, 8]
@dll.bind
...
@dll.bind
def clang_createTranslationUnit2(CIdx:CXIndex, ast_filename:ctypes.POINTER(ctypes.c_char), out_TU:ctypes.POINTER(CXTranslationUnit)) -> enum_CXErrorCode: ...
...
@dll.bind
def clang_getTUResourceUsageName(kind:enum_CXTUResourceUsageKind) -> ctypes.POINTER(ctypes.c_char): ...
@record
class struct_CXTUResourceUsageEntry:
  SIZE = 16
  kind: Annotated[enum_CXTUResourceUsageKind, 0]
  amount: Annotated[ctypes.c_uint64, 8]
CXTUResourceUsageEntry = struct_CXTUResourceUsageEntry
@record
class struct_CXTUResourceUsage:
  SIZE = 24
  data: Annotated[ctypes.POINTER(None), 0]
  numEntries: Annotated[ctypes.c_uint32, 8]
  entries: Annotated[ctypes.POINTER(CXTUResourceUsageEntry), 16]
...
class struct_CXPlatformAvailability:
  ...
  Unavailable: Annotated[ctypes.c_int32, 52]
...
CXPrintingPolicy = ctypes.POINTER(None)
...
class CXStringSet:
  SIZE = 16
  Strings: Annotated[ctypes.POINTER(CXString), 0]
...
@dll.bind
def clang_getCompletionParent(completion_string:CXCompletionString, kind:ctypes.POINTER(enum_CXCursorKind)) -> CXString: ...
@dll.bind
...
class CXCodeCompleteResults:
  SIZE = 16
  Results: Annotated[ctypes.POINTER(CXCompletionResult), 0]
  NumResults: Annotated[ctypes.c_uint32, 8]
@dll.bind
...
@dll.bind
def clang_codeCompleteGetContainerKind(Results:ctypes.POINTER(CXCodeCompleteResults), IsIncomplete:ctypes.POINTER(ctypes.c_uint32)) -> enum_CXCursorKind: ...
@dll.bind
...
CXEvalResult = ctypes.POINTER(None)
@dll.bind
...
CXRemapping = ctypes.POINTER(None)
@dll.bind
...
CXIdxClientFile = ctypes.POINTER(None)
CXIdxClientEntity = ctypes.POINTER(None)
CXIdxClientContainer = ctypes.POINTER(None)
CXIdxClientASTFile = ctypes.POINTER(None)
@record
class CXIdxLoc:
  SIZE = 24
  ptr_data: Annotated[Array[ctypes.POINTER(None), Literal[2]], 0]
...
class CXIdxIncludedFileInfo:
  ...
  filename: Annotated[ctypes.POINTER(ctypes.c_char), 24]
  file: Annotated[CXFile, 32]
  isImport: Annotated[ctypes.c_int32, 40]
  isAngled: Annotated[ctypes.c_int32, 44]
  isModuleImport: Annotated[ctypes.c_int32, 48]
@record
class CXIdxImportedASTFileInfo:
  ...
  isImplicit: Annotated[ctypes.c_int32, 40]
...
class CXIdxEntityInfo:
  ...
  USR: Annotated[ctypes.POINTER(ctypes.c_char), 24]
  cursor: Annotated[CXCursor, 32]
  attributes: Annotated[ctypes.POINTER(ctypes.POINTER(CXIdxAttrInfo)), 64]
  numAttributes: Annotated[ctypes.c_uint32, 72]
@record
...
class CXIdxIBOutletCollectionAttrInfo:
  SIZE = 72
  attrInfo: Annotated[ctypes.POINTER(CXIdxAttrInfo), 0]
  objcClass: Annotated[ctypes.POINTER(CXIdxEntityInfo), 8]
...
class CXIdxDeclInfo:
  SIZE = 128
  entityInfo: Annotated[ctypes.POINTER(CXIdxEntityInfo), 0]
  cursor: Annotated[CXCursor, 8]
  loc: Annotated[CXIdxLoc, 40]
  semanticContainer: Annotated[ctypes.POINTER(CXIdxContainerInfo), 64]
  lexicalContainer: Annotated[ctypes.POINTER(CXIdxContainerInfo), 72]
  isRedeclaration: Annotated[ctypes.c_int32, 80]
  isDefinition: Annotated[ctypes.c_int32, 84]
  isContainer: Annotated[ctypes.c_int32, 88]
  declAsContainer: Annotated[ctypes.POINTER(CXIdxContainerInfo), 96]
  isImplicit: Annotated[ctypes.c_int32, 104]
  attributes: Annotated[ctypes.POINTER(ctypes.POINTER(CXIdxAttrInfo)), 112]
  numAttributes: Annotated[ctypes.c_uint32, 120]
  flags: Annotated[ctypes.c_uint32, 124]
...
class CXIdxObjCContainerDeclInfo:
  SIZE = 16
  declInfo: Annotated[ctypes.POINTER(CXIdxDeclInfo), 0]
  kind: Annotated[CXIdxObjCContainerKind, 8]
@record
class CXIdxBaseClassInfo:
  SIZE = 64
  base: Annotated[ctypes.POINTER(CXIdxEntityInfo), 0]
  cursor: Annotated[CXCursor, 8]
  loc: Annotated[CXIdxLoc, 40]
@record
class CXIdxObjCProtocolRefInfo:
  SIZE = 64
  protocol: Annotated[ctypes.POINTER(CXIdxEntityInfo), 0]
  cursor: Annotated[CXCursor, 8]
  loc: Annotated[CXIdxLoc, 40]
@record
class CXIdxObjCProtocolRefListInfo:
  SIZE = 16
  protocols: Annotated[ctypes.POINTER(ctypes.POINTER(CXIdxObjCProtocolRefInfo)), 0]
  numProtocols: Annotated[ctypes.c_uint32, 8]
@record
class CXIdxObjCInterfaceDeclInfo:
  SIZE = 24
  containerInfo: Annotated[ctypes.POINTER(CXIdxObjCContainerDeclInfo), 0]
  superInfo: Annotated[ctypes.POINTER(CXIdxBaseClassInfo), 8]
  protocols: Annotated[ctypes.POINTER(CXIdxObjCProtocolRefListInfo), 16]
@record
class CXIdxObjCCategoryDeclInfo:
  ...
  classCursor: Annotated[CXCursor, 16]
  classLoc: Annotated[CXIdxLoc, 48]
  protocols: Annotated[ctypes.POINTER(CXIdxObjCProtocolRefListInfo), 72]
@record
class CXIdxObjCPropertyDeclInfo:
  SIZE = 24
  declInfo: Annotated[ctypes.POINTER(CXIdxDeclInfo), 0]
  getter: Annotated[ctypes.POINTER(CXIdxEntityInfo), 8]
  setter: Annotated[ctypes.POINTER(CXIdxEntityInfo), 16]
@record
class CXIdxCXXClassDeclInfo:
  SIZE = 24
  declInfo: Annotated[ctypes.POINTER(CXIdxDeclInfo), 0]
  bases: Annotated[ctypes.POINTER(ctypes.POINTER(CXIdxBaseClassInfo)), 8]
  numBases: Annotated[ctypes.c_uint32, 16]
...
class CXIdxEntityRefInfo:
  ...
  cursor: Annotated[CXCursor, 8]
  loc: Annotated[CXIdxLoc, 40]
  referencedEntity: Annotated[ctypes.POINTER(CXIdxEntityInfo), 64]
...
CXIndexAction = ctypes.POINTER(None)
@dll.bind
