...
class enum_CXAvailabilityKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXCursor_ExceptionSpecificationKind(ctypes.c_uint32, c.Enum): pass
...
class CXChoice(ctypes.c_uint32, c.Enum): pass
...
class CXGlobalOptFlags(ctypes.c_uint32, c.Enum): pass
...
class struct_CXIndexOptions(c.Struct):
  ...
  ExcludeDeclarationsFromPCH: 'ctypes.c_uint32'
  DisplayDiagnostics: 'ctypes.c_uint32'
  StorePreamblesInMemory: 'ctypes.c_uint32'
...
@dll.bind
def clang_createTranslationUnitFromSourceFile(CIdx:CXIndex, source_filename:c.POINTER[ctypes.c_char], num_clang_command_line_args:ctypes.c_int32, clang_command_line_args:c.POINTER[c.POINTER[ctypes.c_char]], num_unsaved_files:ctypes.c_uint32, unsaved_files:c.POINTER[struct_CXUnsavedFile]) -> CXTranslationUnit: ...
@dll.bind
def clang_createTranslationUnit(CIdx:CXIndex, ast_filename:c.POINTER[ctypes.c_char]) -> CXTranslationUnit: ...
class enum_CXErrorCode(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_createTranslationUnit2(CIdx:CXIndex, ast_filename:c.POINTER[ctypes.c_char], out_TU:c.POINTER[CXTranslationUnit]) -> enum_CXErrorCode: ...
class enum_CXTranslationUnit_Flags(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_parseTranslationUnit(CIdx:CXIndex, source_filename:c.POINTER[ctypes.c_char], command_line_args:c.POINTER[c.POINTER[ctypes.c_char]], num_command_line_args:ctypes.c_int32, unsaved_files:c.POINTER[struct_CXUnsavedFile], num_unsaved_files:ctypes.c_uint32, options:ctypes.c_uint32) -> CXTranslationUnit: ...
@dll.bind
def clang_parseTranslationUnit2(CIdx:CXIndex, source_filename:c.POINTER[ctypes.c_char], command_line_args:c.POINTER[c.POINTER[ctypes.c_char]], num_command_line_args:ctypes.c_int32, unsaved_files:c.POINTER[struct_CXUnsavedFile], num_unsaved_files:ctypes.c_uint32, options:ctypes.c_uint32, out_TU:c.POINTER[CXTranslationUnit]) -> enum_CXErrorCode: ...
@dll.bind
def clang_parseTranslationUnit2FullArgv(CIdx:CXIndex, source_filename:c.POINTER[ctypes.c_char], command_line_args:c.POINTER[c.POINTER[ctypes.c_char]], num_command_line_args:ctypes.c_int32, unsaved_files:c.POINTER[struct_CXUnsavedFile], num_unsaved_files:ctypes.c_uint32, options:ctypes.c_uint32, out_TU:c.POINTER[CXTranslationUnit]) -> enum_CXErrorCode: ...
class enum_CXSaveTranslationUnit_Flags(ctypes.c_uint32, c.Enum): pass
...
class enum_CXSaveError(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_saveTranslationUnit(TU:CXTranslationUnit, FileName:c.POINTER[ctypes.c_char], options:ctypes.c_uint32) -> ctypes.c_int32: ...
@dll.bind
...
class enum_CXReparse_Flags(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_reparseTranslationUnit(TU:CXTranslationUnit, num_unsaved_files:ctypes.c_uint32, unsaved_files:c.POINTER[struct_CXUnsavedFile], options:ctypes.c_uint32) -> ctypes.c_int32: ...
class enum_CXTUResourceUsageKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_getTUResourceUsageName(kind:enum_CXTUResourceUsageKind) -> c.POINTER[ctypes.c_char]: ...
@c.record
class struct_CXTUResourceUsageEntry(c.Struct):
  SIZE = 16
  kind: 'enum_CXTUResourceUsageKind'
  amount: 'ctypes.c_uint64'
struct_CXTUResourceUsageEntry.register_fields([('kind', enum_CXTUResourceUsageKind, 0), ('amount', ctypes.c_uint64, 8)])
...
class struct_CXTUResourceUsage(c.Struct):
  ...
  entries: 'c.POINTER[CXTUResourceUsageEntry]'
...
class enum_CXCursorKind(ctypes.c_uint32, c.Enum): pass
...
CXCursor.register_fields([('kind', enum_CXCursorKind, 0), ('xdata', ctypes.c_int32, 4), ('data', c.Array[ctypes.c_void_p, Literal[3]], 8)])
@dll.bind
...
@dll.bind
def clang_isDeclaration(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_isInvalidDeclaration(_0:CXCursor) -> ctypes.c_uint32: ...
@dll.bind
def clang_isReference(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_isExpression(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_isStatement(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_isAttribute(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_Cursor_hasAttrs(C:CXCursor) -> ctypes.c_uint32: ...
@dll.bind
def clang_isInvalid(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_isTranslationUnit(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_isPreprocessing(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
@dll.bind
def clang_isUnexposed(_0:enum_CXCursorKind) -> ctypes.c_uint32: ...
class enum_CXLinkageKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXVisibilityKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_getCursorPlatformAvailability(cursor:CXCursor, always_deprecated:c.POINTER[ctypes.c_int32], deprecated_message:c.POINTER[CXString], always_unavailable:c.POINTER[ctypes.c_int32], unavailable_message:c.POINTER[CXString], availability:c.POINTER[CXPlatformAvailability], availability_size:ctypes.c_int32) -> ctypes.c_int32: ...
@dll.bind
...
class enum_CXLanguageKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXTLSKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXTypeKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXCallingConv(ctypes.c_uint32, c.Enum): pass
...
CXType.register_fields([('kind', enum_CXTypeKind, 0), ('data', c.Array[ctypes.c_void_p, Literal[2]], 8)])
@dll.bind
...
class enum_CXTemplateArgumentKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_Cursor_getTemplateArgumentKind(C:CXCursor, I:ctypes.c_uint32) -> enum_CXTemplateArgumentKind: ...
@dll.bind
...
class enum_CXTypeNullabilityKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXTypeLayoutError(ctypes.c_int32, c.Enum): pass
...
@dll.bind
def clang_Type_getOffsetOf(T:CXType, S:c.POINTER[ctypes.c_char]) -> ctypes.c_int64: ...
@dll.bind
...
class enum_CXRefQualifierKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CX_CXXAccessSpecifier(ctypes.c_uint32, c.Enum): pass
...
class enum_CX_StorageClass(ctypes.c_uint32, c.Enum): pass
...
class enum_CX_BinaryOperatorKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXChildVisitResult(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_constructUSR_ObjCMethod(name:c.POINTER[ctypes.c_char], isInstanceMethod:ctypes.c_uint32, classUSR:CXString) -> CXString: ...
@dll.bind
...
class enum_CXPrintingPolicyProperty(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_PrintingPolicy_getProperty(Policy:CXPrintingPolicy, Property:enum_CXPrintingPolicyProperty) -> ctypes.c_uint32: ...
@dll.bind
def clang_PrintingPolicy_setProperty(Policy:CXPrintingPolicy, Property:enum_CXPrintingPolicyProperty, Value:ctypes.c_uint32) -> None: ...
@dll.bind
...
class CXObjCPropertyAttrKind(ctypes.c_uint32, c.Enum): pass
...
class CXObjCDeclQualifierKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_Cursor_isExternalSymbol(C:CXCursor, language:c.POINTER[CXString], definedIn:c.POINTER[CXString], isGenerated:c.POINTER[ctypes.c_uint32]) -> ctypes.c_uint32: ...
@dll.bind
...
class enum_CXNameRefFlags(ctypes.c_uint32, c.Enum): pass
...
class enum_CXTokenKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_annotateTokens(TU:CXTranslationUnit, Tokens:c.POINTER[CXToken], NumTokens:ctypes.c_uint32, Cursors:c.POINTER[CXCursor]) -> None: ...
@dll.bind
def clang_disposeTokens(TU:CXTranslationUnit, Tokens:c.POINTER[CXToken], NumTokens:ctypes.c_uint32) -> None: ...
@dll.bind
...
@dll.bind
def clang_executeOnThread(fn:c.CFUNCTYPE[None, [ctypes.c_void_p]], user_data:ctypes.c_void_p, stack_size:ctypes.c_uint32) -> None: ...
...
CXCompletionResult.register_fields([('CursorKind', enum_CXCursorKind, 0), ('CompletionString', CXCompletionString, 8)])
class enum_CXCompletionChunkKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_getCompletionChunkKind(completion_string:CXCompletionString, chunk_number:ctypes.c_uint32) -> enum_CXCompletionChunkKind: ...
@dll.bind
...
@dll.bind
def clang_getCompletionNumFixIts(results:c.POINTER[CXCodeCompleteResults], completion_index:ctypes.c_uint32) -> ctypes.c_uint32: ...
@dll.bind
def clang_getCompletionFixIt(results:c.POINTER[CXCodeCompleteResults], completion_index:ctypes.c_uint32, fixit_index:ctypes.c_uint32, replacement_range:c.POINTER[CXSourceRange]) -> CXString: ...
class enum_CXCodeComplete_Flags(ctypes.c_uint32, c.Enum): pass
...
class enum_CXCompletionContext(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_codeCompleteAt(TU:CXTranslationUnit, complete_filename:c.POINTER[ctypes.c_char], complete_line:ctypes.c_uint32, complete_column:ctypes.c_uint32, unsaved_files:c.POINTER[struct_CXUnsavedFile], num_unsaved_files:ctypes.c_uint32, options:ctypes.c_uint32) -> c.POINTER[CXCodeCompleteResults]: ...
@dll.bind
def clang_sortCodeCompletionResults(Results:c.POINTER[CXCompletionResult], NumResults:ctypes.c_uint32) -> None: ...
@dll.bind
def clang_disposeCodeCompleteResults(Results:c.POINTER[CXCodeCompleteResults]) -> None: ...
@dll.bind
def clang_codeCompleteGetNumDiagnostics(Results:c.POINTER[CXCodeCompleteResults]) -> ctypes.c_uint32: ...
@dll.bind
def clang_codeCompleteGetDiagnostic(Results:c.POINTER[CXCodeCompleteResults], Index:ctypes.c_uint32) -> CXDiagnostic: ...
@dll.bind
def clang_codeCompleteGetContexts(Results:c.POINTER[CXCodeCompleteResults]) -> ctypes.c_uint64: ...
@dll.bind
def clang_codeCompleteGetContainerKind(Results:c.POINTER[CXCodeCompleteResults], IsIncomplete:c.POINTER[ctypes.c_uint32]) -> enum_CXCursorKind: ...
@dll.bind
...
class CXEvalResultKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_getRemappingsFromFileList(filePaths:c.POINTER[c.POINTER[ctypes.c_char]], numFiles:ctypes.c_uint32) -> CXRemapping: ...
@dll.bind
def clang_remap_getNumFiles(_0:CXRemapping) -> ctypes.c_uint32: ...
@dll.bind
def clang_remap_getFilenames(_0:CXRemapping, index:ctypes.c_uint32, original:c.POINTER[CXString], transformed:c.POINTER[CXString]) -> None: ...
@dll.bind
def clang_remap_dispose(_0:CXRemapping) -> None: ...
class enum_CXVisitorResult(ctypes.c_uint32, c.Enum): pass
...
class struct_CXCursorAndRangeVisitor(c.Struct):
  ...
  visit: 'c.CFUNCTYPE[enum_CXVisitorResult, [ctypes.c_void_p, CXCursor, CXSourceRange]]'
struct_CXCursorAndRangeVisitor.register_fields([('context', ctypes.c_void_p, 0), ('visit', c.CFUNCTYPE[enum_CXVisitorResult, [ctypes.c_void_p, CXCursor, CXSourceRange]], 8)])
CXCursorAndRangeVisitor: TypeAlias = struct_CXCursorAndRangeVisitor
class CXResult(ctypes.c_uint32, c.Enum): pass
...
class CXIdxEntityKind(ctypes.c_uint32, c.Enum): pass
...
class CXIdxEntityLanguage(ctypes.c_uint32, c.Enum): pass
...
class CXIdxEntityCXXTemplateKind(ctypes.c_uint32, c.Enum): pass
...
class CXIdxAttrKind(ctypes.c_uint32, c.Enum): pass
...
class CXIdxAttrInfo(c.Struct):
  ...
  cursor: 'CXCursor'
  loc: 'CXIdxLoc'
CXIdxAttrInfo.register_fields([('kind', CXIdxAttrKind, 0), ('cursor', CXCursor, 8), ('loc', CXIdxLoc, 40)])
@c.record
...
CXIdxEntityInfo.register_fields([('kind', CXIdxEntityKind, 0), ('templateKind', CXIdxEntityCXXTemplateKind, 4), ('lang', CXIdxEntityLanguage, 8), ('name', c.POINTER[ctypes.c_char], 16), ('USR', c.POINTER[ctypes.c_char], 24), ('cursor', CXCursor, 32), ('attributes', c.POINTER[c.POINTER[CXIdxAttrInfo]], 64), ('numAttributes', ctypes.c_uint32, 72)])
@c.record
...
class CXIdxDeclInfoFlags(ctypes.c_uint32, c.Enum): pass
...
class CXIdxObjCContainerKind(ctypes.c_uint32, c.Enum): pass
...
CXIdxObjCContainerDeclInfo.register_fields([('declInfo', c.POINTER[CXIdxDeclInfo], 0), ('kind', CXIdxObjCContainerKind, 8)])
@c.record
...
class CXIdxEntityRefKind(ctypes.c_uint32, c.Enum): pass
...
class CXSymbolRole(ctypes.c_uint32, c.Enum): pass
...
class CXIdxEntityRefInfo(c.Struct):
  ...
  role: 'CXSymbolRole'
CXIdxEntityRefInfo.register_fields([('kind', CXIdxEntityRefKind, 0), ('cursor', CXCursor, 8), ('loc', CXIdxLoc, 40), ('referencedEntity', c.POINTER[CXIdxEntityInfo], 64), ('parentEntity', c.POINTER[CXIdxEntityInfo], 72), ('container', c.POINTER[CXIdxContainerInfo], 80), ('role', CXSymbolRole, 88)])
@c.record
class IndexerCallbacks(c.Struct):
  SIZE = 64
  abortQuery: 'c.CFUNCTYPE[ctypes.c_int32, [CXClientData, ctypes.c_void_p]]'
  diagnostic: 'c.CFUNCTYPE[None, [CXClientData, CXDiagnosticSet, ctypes.c_void_p]]'
  enteredMainFile: 'c.CFUNCTYPE[CXIdxClientFile, [CXClientData, CXFile, ctypes.c_void_p]]'
  ppIncludedFile: 'c.CFUNCTYPE[CXIdxClientFile, [CXClientData, c.POINTER[CXIdxIncludedFileInfo]]]'
  importedASTFile: 'c.CFUNCTYPE[CXIdxClientASTFile, [CXClientData, c.POINTER[CXIdxImportedASTFileInfo]]]'
  startedTranslationUnit: 'c.CFUNCTYPE[CXIdxClientContainer, [CXClientData, ctypes.c_void_p]]'
  indexDeclaration: 'c.CFUNCTYPE[None, [CXClientData, c.POINTER[CXIdxDeclInfo]]]'
  indexEntityReference: 'c.CFUNCTYPE[None, [CXClientData, c.POINTER[CXIdxEntityRefInfo]]]'
...
class CXIndexOptFlags(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_indexSourceFile(_0:CXIndexAction, client_data:CXClientData, index_callbacks:c.POINTER[IndexerCallbacks], index_callbacks_size:ctypes.c_uint32, index_options:ctypes.c_uint32, source_filename:c.POINTER[ctypes.c_char], command_line_args:c.POINTER[c.POINTER[ctypes.c_char]], num_command_line_args:ctypes.c_int32, unsaved_files:c.POINTER[struct_CXUnsavedFile], num_unsaved_files:ctypes.c_uint32, out_TU:c.POINTER[CXTranslationUnit], TU_options:ctypes.c_uint32) -> ctypes.c_int32: ...
@dll.bind
def clang_indexSourceFileFullArgv(_0:CXIndexAction, client_data:CXClientData, index_callbacks:c.POINTER[IndexerCallbacks], index_callbacks_size:ctypes.c_uint32, index_options:ctypes.c_uint32, source_filename:c.POINTER[ctypes.c_char], command_line_args:c.POINTER[c.POINTER[ctypes.c_char]], num_command_line_args:ctypes.c_int32, unsaved_files:c.POINTER[struct_CXUnsavedFile], num_unsaved_files:ctypes.c_uint32, out_TU:c.POINTER[CXTranslationUnit], TU_options:ctypes.c_uint32) -> ctypes.c_int32: ...
@dll.bind
def clang_indexTranslationUnit(_0:CXIndexAction, client_data:CXClientData, index_callbacks:c.POINTER[IndexerCallbacks], index_callbacks_size:ctypes.c_uint32, index_options:ctypes.c_uint32, _5:CXTranslationUnit) -> ctypes.c_int32: ...
@dll.bind
...
class enum_CXBinaryOperatorKind(ctypes.c_uint32, c.Enum): pass
...
class enum_CXUnaryOperatorKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def clang_getFileUniqueID(file:CXFile, outID:c.POINTER[CXFileUniqueID]) -> ctypes.c_int32: ...
@dll.bind
