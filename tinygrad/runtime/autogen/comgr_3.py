...
@dll.bind
def amd_comgr_get_isa_name(index:size_t, isa_name:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_isa_metadata(isa_name:POINTER(Annotated[bytes, ctypes.c_char]), metadata:POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_data(kind:amd_comgr_data_kind_t, data:POINTER(amd_comgr_data_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_release_data(data:amd_comgr_data_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_kind(data:amd_comgr_data_t, kind:POINTER(amd_comgr_data_kind_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_set_data(data:amd_comgr_data_t, size:size_t, bytes:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_set_data_name(data:amd_comgr_data_t, name:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data(data:amd_comgr_data_t, size:POINTER(size_t), bytes:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_name(data:amd_comgr_data_t, size:POINTER(size_t), name:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_isa_name(data:amd_comgr_data_t, size:POINTER(size_t), isa_name:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_symbolizer_info(code_object:amd_comgr_data_t, print_symbol_callback:CFUNCTYPE(None, POINTER(Annotated[bytes, ctypes.c_char]), POINTER(None)), symbolizer_info:POINTER(amd_comgr_symbolizer_info_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_symbolizer_info(symbolizer_info:amd_comgr_symbolizer_info_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_symbolize(symbolizer_info:amd_comgr_symbolizer_info_t, address:uint64_t, is_code:Annotated[bool, ctypes.c_bool], user_data:POINTER(None)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_metadata(data:amd_comgr_data_t, metadata:POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_metadata(metadata:amd_comgr_metadata_node_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_data_set(data_set:POINTER(amd_comgr_data_set_t)) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_action_data_count(data_set:amd_comgr_data_set_t, data_kind:amd_comgr_data_kind_t, count:POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_data_get_data(data_set:amd_comgr_data_set_t, data_kind:amd_comgr_data_kind_t, index:size_t, data:POINTER(amd_comgr_data_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_action_info(action_info:POINTER(amd_comgr_action_info_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_action_info(action_info:amd_comgr_action_info_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_set_isa_name(action_info:amd_comgr_action_info_t, isa_name:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_isa_name(action_info:amd_comgr_action_info_t, size:POINTER(size_t), isa_name:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_action_info_get_language(action_info:amd_comgr_action_info_t, language:POINTER(amd_comgr_language_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_set_option_list(action_info:amd_comgr_action_info_t, options:Array[POINTER(Annotated[bytes, ctypes.c_char]), Literal[0]], count:size_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_option_list_count(action_info:amd_comgr_action_info_t, count:POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_option_list_item(action_info:amd_comgr_action_info_t, index:size_t, size:POINTER(size_t), option:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_set_bundle_entry_ids(action_info:amd_comgr_action_info_t, bundle_entry_ids:Array[POINTER(Annotated[bytes, ctypes.c_char]), Literal[0]], count:size_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_bundle_entry_id_count(action_info:amd_comgr_action_info_t, count:POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_bundle_entry_id(action_info:amd_comgr_action_info_t, index:size_t, size:POINTER(size_t), bundle_entry_id:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_action_info_set_working_directory_path(action_info:amd_comgr_action_info_t, path:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_working_directory_path(action_info:amd_comgr_action_info_t, size:POINTER(size_t), path:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_action_info_get_logging(action_info:amd_comgr_action_info_t, logging:POINTER(Annotated[bool, ctypes.c_bool])) -> amd_comgr_status_t: ...
...
@dll.bind
def amd_comgr_get_metadata_string(metadata:amd_comgr_metadata_node_t, size:POINTER(size_t), string:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_metadata_map_size(metadata:amd_comgr_metadata_node_t, size:POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_iterate_map_metadata(metadata:amd_comgr_metadata_node_t, callback:CFUNCTYPE(amd_comgr_status_t, amd_comgr_metadata_node_t, amd_comgr_metadata_node_t, POINTER(None)), user_data:POINTER(None)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_metadata_lookup(metadata:amd_comgr_metadata_node_t, key:POINTER(Annotated[bytes, ctypes.c_char]), value:POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_metadata_list_size(metadata:amd_comgr_metadata_node_t, size:POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_index_list_metadata(metadata:amd_comgr_metadata_node_t, index:size_t, value:POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_iterate_symbols(data:amd_comgr_data_t, callback:CFUNCTYPE(amd_comgr_status_t, amd_comgr_symbol_t, POINTER(None)), user_data:POINTER(None)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_symbol_lookup(data:amd_comgr_data_t, name:POINTER(Annotated[bytes, ctypes.c_char]), symbol:POINTER(amd_comgr_symbol_t)) -> amd_comgr_status_t: ...
...
@dll.bind
def amd_comgr_create_disassembly_info(isa_name:POINTER(Annotated[bytes, ctypes.c_char]), read_memory_callback:CFUNCTYPE(uint64_t, uint64_t, POINTER(Annotated[bytes, ctypes.c_char]), uint64_t, POINTER(None)), print_instruction_callback:CFUNCTYPE(None, POINTER(Annotated[bytes, ctypes.c_char]), POINTER(None)), print_address_annotation_callback:CFUNCTYPE(None, uint64_t, POINTER(None)), disassembly_info:POINTER(amd_comgr_disassembly_info_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_disassembly_info(disassembly_info:amd_comgr_disassembly_info_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_disassemble_instruction(disassembly_info:amd_comgr_disassembly_info_t, address:uint64_t, user_data:POINTER(None), size:POINTER(uint64_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_demangle_symbol_name(mangled_symbol_name:amd_comgr_data_t, demangled_symbol_name:POINTER(amd_comgr_data_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_populate_mangled_names(data:amd_comgr_data_t, count:POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_mangled_name(data:amd_comgr_data_t, index:size_t, size:POINTER(size_t), mangled_name:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_populate_name_expression_map(data:amd_comgr_data_t, count:POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_map_name_expression_to_symbol_name(data:amd_comgr_data_t, size:POINTER(size_t), name_expression:POINTER(Annotated[bytes, ctypes.c_char]), symbol_name:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@record
...
@dll.bind
def amd_comgr_map_elf_virtual_address_to_code_object_offset(data:amd_comgr_data_t, elf_virtual_address:uint64_t, code_object_offset:POINTER(uint64_t), slice_size:POINTER(uint64_t), nobits:POINTER(Annotated[bool, ctypes.c_bool])) -> amd_comgr_status_t: ...
init_records()
