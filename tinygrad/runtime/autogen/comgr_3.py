...
class amd_comgr_status_s(ctypes.c_uint32, c.Enum): pass
...
class amd_comgr_language_s(ctypes.c_uint32, c.Enum): pass
...
class amd_comgr_data_kind_s(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def amd_comgr_symbolize(symbolizer_info:amd_comgr_symbolizer_info_t, address:uint64_t, is_code:ctypes.c_bool, user_data:ctypes.c_void_p) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_action_info_set_vfs(action_info:amd_comgr_action_info_t, should_use_vfs:ctypes.c_bool) -> amd_comgr_status_t: ...
@dll.bind
...
class amd_comgr_action_kind_s(ctypes.c_uint32, c.Enum): pass
...
class amd_comgr_metadata_kind_s(ctypes.c_uint32, c.Enum): pass
...
class amd_comgr_symbol_type_s(ctypes.c_int32, c.Enum): pass
...
class amd_comgr_symbol_info_s(ctypes.c_uint32, c.Enum): pass
