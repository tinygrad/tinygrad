...
@dll.bind
def amd_comgr_status_string(status:amd_comgr_status_t, status_string:ctypes.POINTER(ctypes.POINTER(ctypes.c_char))) -> amd_comgr_status_t: ...
size_t = ctypes.c_uint64
@dll.bind
def amd_comgr_get_version(major:ctypes.POINTER(size_t), minor:ctypes.POINTER(size_t)) -> None: ...
...
@dll.bind
def amd_comgr_get_isa_count(count:ctypes.POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_isa_name(index:size_t, isa_name:ctypes.POINTER(ctypes.POINTER(ctypes.c_char))) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_isa_metadata(isa_name:ctypes.POINTER(ctypes.c_char), metadata:ctypes.POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_data(kind:amd_comgr_data_kind_t, data:ctypes.POINTER(amd_comgr_data_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_release_data(data:amd_comgr_data_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_kind(data:amd_comgr_data_t, kind:ctypes.POINTER(amd_comgr_data_kind_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_set_data(data:amd_comgr_data_t, size:size_t, bytes:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_set_data_from_file_slice(data:amd_comgr_data_t, file_descriptor:ctypes.c_int32, offset:uint64_t, size:uint64_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_set_data_name(data:amd_comgr_data_t, name:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data(data:amd_comgr_data_t, size:ctypes.POINTER(size_t), bytes:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_name(data:amd_comgr_data_t, size:ctypes.POINTER(size_t), name:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_isa_name(data:amd_comgr_data_t, size:ctypes.POINTER(size_t), isa_name:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_symbolizer_info(code_object:amd_comgr_data_t, print_symbol_callback:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(None)), symbolizer_info:ctypes.POINTER(amd_comgr_symbolizer_info_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_symbolizer_info(symbolizer_info:amd_comgr_symbolizer_info_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_symbolize(symbolizer_info:amd_comgr_symbolizer_info_t, address:uint64_t, is_code:ctypes.c_bool, user_data:ctypes.POINTER(None)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_data_metadata(data:amd_comgr_data_t, metadata:ctypes.POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_metadata(metadata:amd_comgr_metadata_node_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_data_set(data_set:ctypes.POINTER(amd_comgr_data_set_t)) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_action_data_count(data_set:amd_comgr_data_set_t, data_kind:amd_comgr_data_kind_t, count:ctypes.POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_data_get_data(data_set:amd_comgr_data_set_t, data_kind:amd_comgr_data_kind_t, index:size_t, data:ctypes.POINTER(amd_comgr_data_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_action_info(action_info:ctypes.POINTER(amd_comgr_action_info_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_action_info(action_info:amd_comgr_action_info_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_set_isa_name(action_info:amd_comgr_action_info_t, isa_name:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_isa_name(action_info:amd_comgr_action_info_t, size:ctypes.POINTER(size_t), isa_name:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_action_info_get_bundle_entry_id(action_info:amd_comgr_action_info_t, index:size_t, size:ctypes.POINTER(size_t), bundle_entry_id:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_set_device_lib_linking(action_info:amd_comgr_action_info_t, should_link_device_libs:ctypes.c_bool) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_set_working_directory_path(action_info:amd_comgr_action_info_t, path:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_working_directory_path(action_info:amd_comgr_action_info_t, size:ctypes.POINTER(size_t), path:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_set_logging(action_info:amd_comgr_action_info_t, logging:ctypes.c_bool) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_logging(action_info:amd_comgr_action_info_t, logging:ctypes.POINTER(ctypes.c_bool)) -> amd_comgr_status_t: ...
...
@dll.bind
def amd_comgr_get_metadata_kind(metadata:amd_comgr_metadata_node_t, kind:ctypes.POINTER(amd_comgr_metadata_kind_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_metadata_string(metadata:amd_comgr_metadata_node_t, size:ctypes.POINTER(size_t), string:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_metadata_map_size(metadata:amd_comgr_metadata_node_t, size:ctypes.POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_iterate_map_metadata(metadata:amd_comgr_metadata_node_t, callback:ctypes.CFUNCTYPE(amd_comgr_status_t, amd_comgr_metadata_node_t, amd_comgr_metadata_node_t, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_metadata_lookup(metadata:amd_comgr_metadata_node_t, key:ctypes.POINTER(ctypes.c_char), value:ctypes.POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_metadata_list_size(metadata:amd_comgr_metadata_node_t, size:ctypes.POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_index_list_metadata(metadata:amd_comgr_metadata_node_t, index:size_t, value:ctypes.POINTER(amd_comgr_metadata_node_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_iterate_symbols(data:amd_comgr_data_t, callback:ctypes.CFUNCTYPE(amd_comgr_status_t, amd_comgr_symbol_t, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_symbol_lookup(data:amd_comgr_data_t, name:ctypes.POINTER(ctypes.c_char), symbol:ctypes.POINTER(amd_comgr_symbol_t)) -> amd_comgr_status_t: ...
...
@dll.bind
def amd_comgr_symbol_get_info(symbol:amd_comgr_symbol_t, attribute:amd_comgr_symbol_info_t, value:ctypes.POINTER(None)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_create_disassembly_info(isa_name:ctypes.POINTER(ctypes.c_char), read_memory_callback:ctypes.CFUNCTYPE(uint64_t, uint64_t, ctypes.POINTER(ctypes.c_char), uint64_t, ctypes.POINTER(None)), print_instruction_callback:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(None)), print_address_annotation_callback:ctypes.CFUNCTYPE(None, uint64_t, ctypes.POINTER(None)), disassembly_info:ctypes.POINTER(amd_comgr_disassembly_info_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_disassembly_info(disassembly_info:amd_comgr_disassembly_info_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_disassemble_instruction(disassembly_info:amd_comgr_disassembly_info_t, address:uint64_t, user_data:ctypes.POINTER(None), size:ctypes.POINTER(uint64_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_demangle_symbol_name(mangled_symbol_name:amd_comgr_data_t, demangled_symbol_name:ctypes.POINTER(amd_comgr_data_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_populate_mangled_names(data:amd_comgr_data_t, count:ctypes.POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_get_mangled_name(data:amd_comgr_data_t, index:size_t, size:ctypes.POINTER(size_t), mangled_name:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_populate_name_expression_map(data:amd_comgr_data_t, count:ctypes.POINTER(size_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_map_name_expression_to_symbol_name(data:amd_comgr_data_t, size:ctypes.POINTER(size_t), name_expression:ctypes.POINTER(ctypes.c_char), symbol_name:ctypes.POINTER(ctypes.c_char)) -> amd_comgr_status_t: ...
@record
class code_object_info_s:
  SIZE = 24
  isa: Annotated[ctypes.POINTER(ctypes.c_char), 0]
  size: Annotated[size_t, 8]
  offset: Annotated[uint64_t, 16]
amd_comgr_code_object_info_t = code_object_info_s
@dll.bind
def amd_comgr_lookup_code_object(data:amd_comgr_data_t, info_list:ctypes.POINTER(amd_comgr_code_object_info_t), info_list_size:size_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_map_elf_virtual_address_to_code_object_offset(data:amd_comgr_data_t, elf_virtual_address:uint64_t, code_object_offset:ctypes.POINTER(uint64_t), slice_size:ctypes.POINTER(uint64_t), nobits:ctypes.POINTER(ctypes.c_bool)) -> amd_comgr_status_t: ...
init_records()
