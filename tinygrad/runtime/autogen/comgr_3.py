...
@dll.bind
def amd_comgr_create_symbolizer_info(code_object:amd_comgr_data_t, print_symbol_callback:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.c_void_p), symbolizer_info:ctypes.POINTER(amd_comgr_symbolizer_info_t)) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_iterate_map_metadata(metadata:amd_comgr_metadata_node_t, callback:ctypes.CFUNCTYPE(amd_comgr_status_t, amd_comgr_metadata_node_t, amd_comgr_metadata_node_t, ctypes.c_void_p), user_data:ctypes.c_void_p) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_iterate_symbols(data:amd_comgr_data_t, callback:ctypes.CFUNCTYPE(amd_comgr_status_t, amd_comgr_symbol_t, ctypes.c_void_p), user_data:ctypes.c_void_p) -> amd_comgr_status_t: ...
@dll.bind
...
@dll.bind
def amd_comgr_create_disassembly_info(isa_name:ctypes.POINTER(ctypes.c_char), read_memory_callback:ctypes.CFUNCTYPE(uint64_t, uint64_t, ctypes.POINTER(ctypes.c_char), uint64_t, ctypes.c_void_p), print_instruction_callback:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.c_void_p), print_address_annotation_callback:ctypes.CFUNCTYPE(None, uint64_t, ctypes.c_void_p), disassembly_info:ctypes.POINTER(amd_comgr_disassembly_info_t)) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_destroy_disassembly_info(disassembly_info:amd_comgr_disassembly_info_t) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_disassemble_instruction(disassembly_info:amd_comgr_disassembly_info_t, address:uint64_t, user_data:ctypes.c_void_p, size:ctypes.POINTER(uint64_t)) -> amd_comgr_status_t: ...
@dll.bind
