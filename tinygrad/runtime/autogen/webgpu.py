...
WGPUBufferUsage_None = WGPUBufferUsage(0x0000000000000000)
WGPUBufferUsage_MapRead = WGPUBufferUsage(0x0000000000000001)
WGPUBufferUsage_MapWrite = WGPUBufferUsage(0x0000000000000002)
WGPUBufferUsage_CopySrc = WGPUBufferUsage(0x0000000000000004)
WGPUBufferUsage_CopyDst = WGPUBufferUsage(0x0000000000000008)
WGPUBufferUsage_Index = WGPUBufferUsage(0x0000000000000010)
WGPUBufferUsage_Vertex = WGPUBufferUsage(0x0000000000000020)
WGPUBufferUsage_Uniform = WGPUBufferUsage(0x0000000000000040)
WGPUBufferUsage_Storage = WGPUBufferUsage(0x0000000000000080)
WGPUBufferUsage_Indirect = WGPUBufferUsage(0x0000000000000100)
WGPUBufferUsage_QueryResolve = WGPUBufferUsage(0x0000000000000200)
WGPUColorWriteMask_None = WGPUColorWriteMask(0x0000000000000000)
WGPUColorWriteMask_Red = WGPUColorWriteMask(0x0000000000000001)
WGPUColorWriteMask_Green = WGPUColorWriteMask(0x0000000000000002)
WGPUColorWriteMask_Blue = WGPUColorWriteMask(0x0000000000000004)
WGPUColorWriteMask_Alpha = WGPUColorWriteMask(0x0000000000000008)
WGPUColorWriteMask_All = WGPUColorWriteMask(0x000000000000000F)
WGPUHeapProperty_DeviceLocal = WGPUHeapProperty(0x0000000000000001)
WGPUHeapProperty_HostVisible = WGPUHeapProperty(0x0000000000000002)
WGPUHeapProperty_HostCoherent = WGPUHeapProperty(0x0000000000000004)
WGPUHeapProperty_HostUncached = WGPUHeapProperty(0x0000000000000008)
WGPUHeapProperty_HostCached = WGPUHeapProperty(0x0000000000000010)
WGPUMapMode_None = WGPUMapMode(0x0000000000000000)
WGPUMapMode_Read = WGPUMapMode(0x0000000000000001)
WGPUMapMode_Write = WGPUMapMode(0x0000000000000002)
WGPUShaderStage_None = WGPUShaderStage(0x0000000000000000)
WGPUShaderStage_Vertex = WGPUShaderStage(0x0000000000000001)
WGPUShaderStage_Fragment = WGPUShaderStage(0x0000000000000002)
WGPUShaderStage_Compute = WGPUShaderStage(0x0000000000000004)
WGPUTextureUsage_None = WGPUTextureUsage(0x0000000000000000)
WGPUTextureUsage_CopySrc = WGPUTextureUsage(0x0000000000000001)
WGPUTextureUsage_CopyDst = WGPUTextureUsage(0x0000000000000002)
WGPUTextureUsage_TextureBinding = WGPUTextureUsage(0x0000000000000004)
WGPUTextureUsage_StorageBinding = WGPUTextureUsage(0x0000000000000008)
WGPUTextureUsage_RenderAttachment = WGPUTextureUsage(0x0000000000000010)
WGPUTextureUsage_TransientAttachment = WGPUTextureUsage(0x0000000000000020)
WGPUTextureUsage_StorageAttachment = WGPUTextureUsage(0x0000000000000040)