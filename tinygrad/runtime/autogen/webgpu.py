...
class struct_WGPUCopyTextureForBrowserOptions(c.Struct):
  ...
  srcAlphaMode: int
  srcTransferFunctionParameters: ctypes._Pointer[ctypes.c_float]
  conversionMatrix: ctypes._Pointer[ctypes.c_float]
  dstTransferFunctionParameters: ctypes._Pointer[ctypes.c_float]
  dstAlphaMode: int
  internalUsage: int
...
class struct_WGPUDawnWGSLBlocklist(c.Struct):
  ...
  blocklistedFeatures: ctypes._Pointer[ctypes.POINTER(ctypes.c_char)]
...
class struct_WGPUDawnTogglesDescriptor(c.Struct):
  ...
  enabledToggles: ctypes._Pointer[ctypes.POINTER(ctypes.c_char)]
  disabledToggleCount: int
  disabledToggles: ctypes._Pointer[ctypes.POINTER(ctypes.c_char)]
...
class struct_WGPUShaderSourceSPIRV(c.Struct):
  ...
  chain: struct_WGPUChainedStruct
  codeSize: int
  code: ctypes._Pointer[ctypes.c_uint32]
...
class struct_WGPUSharedBufferMemoryBeginAccessDescriptor(c.Struct):
  ...
  initialized: int
  fenceCount: int
  fences: ctypes._Pointer[ctypes.POINTER(struct_WGPUSharedFenceImpl)]
  signaledValues: ctypes._Pointer[ctypes.c_uint64]
...
class struct_WGPUSupportedFeatures(c.Struct):
  SIZE = 16
  featureCount: int
  features: ctypes._Pointer[ctypes.c_uint32]
...
class struct_WGPUSurfaceCapabilities(c.Struct):
  ...
  usages: int
  formatCount: int
  formats: ctypes._Pointer[ctypes.c_uint32]
  presentModeCount: int
  presentModes: ctypes._Pointer[ctypes.c_uint32]
  alphaModeCount: int
  alphaModes: ctypes._Pointer[ctypes.c_uint32]
...
class struct_WGPUSurfaceConfiguration(c.Struct):
  ...
  usage: int
  viewFormatCount: int
  viewFormats: ctypes._Pointer[ctypes.c_uint32]
  alphaMode: int
  width: int
  height: int
  presentMode: int
...
class struct_WGPUExternalTextureDescriptor(c.Struct):
  ...
  yuvToRgbConversionMatrix: ctypes._Pointer[ctypes.c_float]
  srcTransferFunctionParameters: ctypes._Pointer[ctypes.c_float]
  dstTransferFunctionParameters: ctypes._Pointer[ctypes.c_float]
  gamutConversionMatrix: ctypes._Pointer[ctypes.c_float]
  mirrored: int
  rotation: int
...
class struct_WGPUPipelineLayoutDescriptor(c.Struct):
  ...
  bindGroupLayouts: ctypes._Pointer[ctypes.POINTER(struct_WGPUBindGroupLayoutImpl)]
...
class struct_WGPURenderBundleEncoderDescriptor(c.Struct):
  ...
  colorFormats: ctypes._Pointer[ctypes.c_uint32]
...
class struct_WGPUDeviceDescriptor(c.Struct):
  ...
  requiredFeatures: ctypes._Pointer[ctypes.c_uint32]
...
@dll.bind(WGPUInstance, ctypes.POINTER(WGPUInstanceDescriptor))
def wgpuCreateInstance(descriptor:ctypes._Pointer[WGPUInstanceDescriptor]) -> WGPUInstance: ...
@dll.bind(None, WGPUDrmFormatCapabilities)
def wgpuDrmFormatCapabilitiesFreeMembers(value:WGPUDrmFormatCapabilities) -> None: ...
@dll.bind(WGPUStatus, ctypes.POINTER(WGPUInstanceFeatures))
def wgpuGetInstanceFeatures(features:ctypes._Pointer[WGPUInstanceFeatures]) -> WGPUStatus: ...
...
@dll.bind(WGPUDevice, WGPUAdapter, ctypes.POINTER(WGPUDeviceDescriptor))
def wgpuAdapterCreateDevice(adapter:WGPUAdapter, descriptor:ctypes._Pointer[WGPUDeviceDescriptor]) -> WGPUDevice: ...
@dll.bind(None, WGPUAdapter, ctypes.POINTER(WGPUSupportedFeatures))
def wgpuAdapterGetFeatures(adapter:WGPUAdapter, features:ctypes._Pointer[WGPUSupportedFeatures]) -> None: ...
@dll.bind(WGPUStatus, WGPUAdapter, WGPUTextureFormat, ctypes.POINTER(WGPUFormatCapabilities))
def wgpuAdapterGetFormatCapabilities(adapter:WGPUAdapter, format:WGPUTextureFormat, capabilities:ctypes._Pointer[WGPUFormatCapabilities]) -> WGPUStatus: ...
@dll.bind(WGPUStatus, WGPUAdapter, ctypes.POINTER(WGPUAdapterInfo))
def wgpuAdapterGetInfo(adapter:WGPUAdapter, info:ctypes._Pointer[WGPUAdapterInfo]) -> WGPUStatus: ...
@dll.bind(WGPUInstance, WGPUAdapter)
def wgpuAdapterGetInstance(adapter:WGPUAdapter) -> WGPUInstance: ...
@dll.bind(WGPUStatus, WGPUAdapter, ctypes.POINTER(WGPUSupportedLimits))
def wgpuAdapterGetLimits(adapter:WGPUAdapter, limits:ctypes._Pointer[WGPUSupportedLimits]) -> WGPUStatus: ...
...
@dll.bind(None, WGPUAdapter, ctypes.POINTER(WGPUDeviceDescriptor), WGPURequestDeviceCallback, ctypes.c_void_p)
def wgpuAdapterRequestDevice(adapter:WGPUAdapter, descriptor:ctypes._Pointer[WGPUDeviceDescriptor], callback:WGPURequestDeviceCallback, userdata:int|None) -> None: ...
@dll.bind(WGPUFuture, WGPUAdapter, ctypes.POINTER(WGPUDeviceDescriptor), WGPURequestDeviceCallbackInfo2)
def wgpuAdapterRequestDevice2(adapter:WGPUAdapter, options:ctypes._Pointer[WGPUDeviceDescriptor], callbackInfo:WGPURequestDeviceCallbackInfo2) -> WGPUFuture: ...
@dll.bind(WGPUFuture, WGPUAdapter, ctypes.POINTER(WGPUDeviceDescriptor), WGPURequestDeviceCallbackInfo)
def wgpuAdapterRequestDeviceF(adapter:WGPUAdapter, options:ctypes._Pointer[WGPUDeviceDescriptor], callbackInfo:WGPURequestDeviceCallbackInfo) -> WGPUFuture: ...
...
def wgpuBufferGetConstMappedRange(buffer:WGPUBuffer, offset:size_t, size:size_t) -> int|None: ...
@dll.bind(WGPUBufferMapState, WGPUBuffer)
def wgpuBufferGetMapState(buffer:WGPUBuffer) -> WGPUBufferMapState: ...
@dll.bind(ctypes.c_void_p, WGPUBuffer, size_t, size_t)
def wgpuBufferGetMappedRange(buffer:WGPUBuffer, offset:size_t, size:size_t) -> int|None: ...
...
def wgpuBufferMapAsync(buffer:WGPUBuffer, mode:WGPUMapMode, offset:size_t, size:size_t, callback:WGPUBufferMapCallback, userdata:int|None) -> None: ...
...
@dll.bind(WGPUComputePassEncoder, WGPUCommandEncoder, ctypes.POINTER(WGPUComputePassDescriptor))
def wgpuCommandEncoderBeginComputePass(commandEncoder:WGPUCommandEncoder, descriptor:ctypes._Pointer[WGPUComputePassDescriptor]) -> WGPUComputePassEncoder: ...
@dll.bind(WGPURenderPassEncoder, WGPUCommandEncoder, ctypes.POINTER(WGPURenderPassDescriptor))
def wgpuCommandEncoderBeginRenderPass(commandEncoder:WGPUCommandEncoder, descriptor:ctypes._Pointer[WGPURenderPassDescriptor]) -> WGPURenderPassEncoder: ...
...
@dll.bind(None, WGPUCommandEncoder, ctypes.POINTER(WGPUImageCopyBuffer), ctypes.POINTER(WGPUImageCopyTexture), ctypes.POINTER(WGPUExtent3D))
def wgpuCommandEncoderCopyBufferToTexture(commandEncoder:WGPUCommandEncoder, source:ctypes._Pointer[WGPUImageCopyBuffer], destination:ctypes._Pointer[WGPUImageCopyTexture], copySize:ctypes._Pointer[WGPUExtent3D]) -> None: ...
@dll.bind(None, WGPUCommandEncoder, ctypes.POINTER(WGPUImageCopyTexture), ctypes.POINTER(WGPUImageCopyBuffer), ctypes.POINTER(WGPUExtent3D))
def wgpuCommandEncoderCopyTextureToBuffer(commandEncoder:WGPUCommandEncoder, source:ctypes._Pointer[WGPUImageCopyTexture], destination:ctypes._Pointer[WGPUImageCopyBuffer], copySize:ctypes._Pointer[WGPUExtent3D]) -> None: ...
@dll.bind(None, WGPUCommandEncoder, ctypes.POINTER(WGPUImageCopyTexture), ctypes.POINTER(WGPUImageCopyTexture), ctypes.POINTER(WGPUExtent3D))
def wgpuCommandEncoderCopyTextureToTexture(commandEncoder:WGPUCommandEncoder, source:ctypes._Pointer[WGPUImageCopyTexture], destination:ctypes._Pointer[WGPUImageCopyTexture], copySize:ctypes._Pointer[WGPUExtent3D]) -> None: ...
@dll.bind(WGPUCommandBuffer, WGPUCommandEncoder, ctypes.POINTER(WGPUCommandBufferDescriptor))
def wgpuCommandEncoderFinish(commandEncoder:WGPUCommandEncoder, descriptor:ctypes._Pointer[WGPUCommandBufferDescriptor]) -> WGPUCommandBuffer: ...
...
@dll.bind(None, WGPUCommandEncoder, WGPUBuffer, uint64_t, ctypes.POINTER(uint8_t), uint64_t)
def wgpuCommandEncoderWriteBuffer(commandEncoder:WGPUCommandEncoder, buffer:WGPUBuffer, bufferOffset:uint64_t, data:ctypes._Pointer[uint8_t], size:uint64_t) -> None: ...
...
@dll.bind(None, WGPUComputePassEncoder, uint32_t, WGPUBindGroup, size_t, ctypes.POINTER(uint32_t))
def wgpuComputePassEncoderSetBindGroup(computePassEncoder:WGPUComputePassEncoder, groupIndex:uint32_t, group:WGPUBindGroup, dynamicOffsetCount:size_t, dynamicOffsets:ctypes._Pointer[uint32_t]) -> None: ...
@dll.bind(None, WGPUComputePassEncoder, WGPUStringView)
...
@dll.bind(WGPUBindGroup, WGPUDevice, ctypes.POINTER(WGPUBindGroupDescriptor))
def wgpuDeviceCreateBindGroup(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUBindGroupDescriptor]) -> WGPUBindGroup: ...
@dll.bind(WGPUBindGroupLayout, WGPUDevice, ctypes.POINTER(WGPUBindGroupLayoutDescriptor))
def wgpuDeviceCreateBindGroupLayout(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUBindGroupLayoutDescriptor]) -> WGPUBindGroupLayout: ...
@dll.bind(WGPUBuffer, WGPUDevice, ctypes.POINTER(WGPUBufferDescriptor))
def wgpuDeviceCreateBuffer(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUBufferDescriptor]) -> WGPUBuffer: ...
@dll.bind(WGPUCommandEncoder, WGPUDevice, ctypes.POINTER(WGPUCommandEncoderDescriptor))
def wgpuDeviceCreateCommandEncoder(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUCommandEncoderDescriptor]) -> WGPUCommandEncoder: ...
@dll.bind(WGPUComputePipeline, WGPUDevice, ctypes.POINTER(WGPUComputePipelineDescriptor))
def wgpuDeviceCreateComputePipeline(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUComputePipelineDescriptor]) -> WGPUComputePipeline: ...
@dll.bind(None, WGPUDevice, ctypes.POINTER(WGPUComputePipelineDescriptor), WGPUCreateComputePipelineAsyncCallback, ctypes.c_void_p)
def wgpuDeviceCreateComputePipelineAsync(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUComputePipelineDescriptor], callback:WGPUCreateComputePipelineAsyncCallback, userdata:int|None) -> None: ...
@dll.bind(WGPUFuture, WGPUDevice, ctypes.POINTER(WGPUComputePipelineDescriptor), WGPUCreateComputePipelineAsyncCallbackInfo2)
def wgpuDeviceCreateComputePipelineAsync2(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUComputePipelineDescriptor], callbackInfo:WGPUCreateComputePipelineAsyncCallbackInfo2) -> WGPUFuture: ...
@dll.bind(WGPUFuture, WGPUDevice, ctypes.POINTER(WGPUComputePipelineDescriptor), WGPUCreateComputePipelineAsyncCallbackInfo)
def wgpuDeviceCreateComputePipelineAsyncF(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUComputePipelineDescriptor], callbackInfo:WGPUCreateComputePipelineAsyncCallbackInfo) -> WGPUFuture: ...
@dll.bind(WGPUBuffer, WGPUDevice, ctypes.POINTER(WGPUBufferDescriptor))
def wgpuDeviceCreateErrorBuffer(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUBufferDescriptor]) -> WGPUBuffer: ...
@dll.bind(WGPUExternalTexture, WGPUDevice)
def wgpuDeviceCreateErrorExternalTexture(device:WGPUDevice) -> WGPUExternalTexture: ...
@dll.bind(WGPUShaderModule, WGPUDevice, ctypes.POINTER(WGPUShaderModuleDescriptor), WGPUStringView)
def wgpuDeviceCreateErrorShaderModule(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUShaderModuleDescriptor], errorMessage:WGPUStringView) -> WGPUShaderModule: ...
@dll.bind(WGPUTexture, WGPUDevice, ctypes.POINTER(WGPUTextureDescriptor))
def wgpuDeviceCreateErrorTexture(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUTextureDescriptor]) -> WGPUTexture: ...
@dll.bind(WGPUExternalTexture, WGPUDevice, ctypes.POINTER(WGPUExternalTextureDescriptor))
def wgpuDeviceCreateExternalTexture(device:WGPUDevice, externalTextureDescriptor:ctypes._Pointer[WGPUExternalTextureDescriptor]) -> WGPUExternalTexture: ...
@dll.bind(WGPUPipelineLayout, WGPUDevice, ctypes.POINTER(WGPUPipelineLayoutDescriptor))
def wgpuDeviceCreatePipelineLayout(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUPipelineLayoutDescriptor]) -> WGPUPipelineLayout: ...
@dll.bind(WGPUQuerySet, WGPUDevice, ctypes.POINTER(WGPUQuerySetDescriptor))
def wgpuDeviceCreateQuerySet(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUQuerySetDescriptor]) -> WGPUQuerySet: ...
@dll.bind(WGPURenderBundleEncoder, WGPUDevice, ctypes.POINTER(WGPURenderBundleEncoderDescriptor))
def wgpuDeviceCreateRenderBundleEncoder(device:WGPUDevice, descriptor:ctypes._Pointer[WGPURenderBundleEncoderDescriptor]) -> WGPURenderBundleEncoder: ...
@dll.bind(WGPURenderPipeline, WGPUDevice, ctypes.POINTER(WGPURenderPipelineDescriptor))
def wgpuDeviceCreateRenderPipeline(device:WGPUDevice, descriptor:ctypes._Pointer[WGPURenderPipelineDescriptor]) -> WGPURenderPipeline: ...
@dll.bind(None, WGPUDevice, ctypes.POINTER(WGPURenderPipelineDescriptor), WGPUCreateRenderPipelineAsyncCallback, ctypes.c_void_p)
def wgpuDeviceCreateRenderPipelineAsync(device:WGPUDevice, descriptor:ctypes._Pointer[WGPURenderPipelineDescriptor], callback:WGPUCreateRenderPipelineAsyncCallback, userdata:int|None) -> None: ...
@dll.bind(WGPUFuture, WGPUDevice, ctypes.POINTER(WGPURenderPipelineDescriptor), WGPUCreateRenderPipelineAsyncCallbackInfo2)
def wgpuDeviceCreateRenderPipelineAsync2(device:WGPUDevice, descriptor:ctypes._Pointer[WGPURenderPipelineDescriptor], callbackInfo:WGPUCreateRenderPipelineAsyncCallbackInfo2) -> WGPUFuture: ...
@dll.bind(WGPUFuture, WGPUDevice, ctypes.POINTER(WGPURenderPipelineDescriptor), WGPUCreateRenderPipelineAsyncCallbackInfo)
def wgpuDeviceCreateRenderPipelineAsyncF(device:WGPUDevice, descriptor:ctypes._Pointer[WGPURenderPipelineDescriptor], callbackInfo:WGPUCreateRenderPipelineAsyncCallbackInfo) -> WGPUFuture: ...
@dll.bind(WGPUSampler, WGPUDevice, ctypes.POINTER(WGPUSamplerDescriptor))
def wgpuDeviceCreateSampler(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUSamplerDescriptor]) -> WGPUSampler: ...
@dll.bind(WGPUShaderModule, WGPUDevice, ctypes.POINTER(WGPUShaderModuleDescriptor))
def wgpuDeviceCreateShaderModule(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUShaderModuleDescriptor]) -> WGPUShaderModule: ...
@dll.bind(WGPUTexture, WGPUDevice, ctypes.POINTER(WGPUTextureDescriptor))
def wgpuDeviceCreateTexture(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUTextureDescriptor]) -> WGPUTexture: ...
...
@dll.bind(WGPUStatus, WGPUDevice, ctypes.c_void_p, ctypes.POINTER(WGPUAHardwareBufferProperties))
def wgpuDeviceGetAHardwareBufferProperties(device:WGPUDevice, handle:int|None, properties:ctypes._Pointer[WGPUAHardwareBufferProperties]) -> WGPUStatus: ...
@dll.bind(WGPUAdapter, WGPUDevice)
def wgpuDeviceGetAdapter(device:WGPUDevice) -> WGPUAdapter: ...
@dll.bind(WGPUStatus, WGPUDevice, ctypes.POINTER(WGPUAdapterInfo))
def wgpuDeviceGetAdapterInfo(device:WGPUDevice, adapterInfo:ctypes._Pointer[WGPUAdapterInfo]) -> WGPUStatus: ...
@dll.bind(None, WGPUDevice, ctypes.POINTER(WGPUSupportedFeatures))
def wgpuDeviceGetFeatures(device:WGPUDevice, features:ctypes._Pointer[WGPUSupportedFeatures]) -> None: ...
@dll.bind(WGPUStatus, WGPUDevice, ctypes.POINTER(WGPUSupportedLimits))
def wgpuDeviceGetLimits(device:WGPUDevice, limits:ctypes._Pointer[WGPUSupportedLimits]) -> WGPUStatus: ...
...
@dll.bind(WGPUSharedBufferMemory, WGPUDevice, ctypes.POINTER(WGPUSharedBufferMemoryDescriptor))
def wgpuDeviceImportSharedBufferMemory(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUSharedBufferMemoryDescriptor]) -> WGPUSharedBufferMemory: ...
@dll.bind(WGPUSharedFence, WGPUDevice, ctypes.POINTER(WGPUSharedFenceDescriptor))
def wgpuDeviceImportSharedFence(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUSharedFenceDescriptor]) -> WGPUSharedFence: ...
@dll.bind(WGPUSharedTextureMemory, WGPUDevice, ctypes.POINTER(WGPUSharedTextureMemoryDescriptor))
def wgpuDeviceImportSharedTextureMemory(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUSharedTextureMemoryDescriptor]) -> WGPUSharedTextureMemory: ...
...
def wgpuDevicePopErrorScope(device:WGPUDevice, oldCallback:WGPUErrorCallback, userdata:int|None) -> None: ...
...
def wgpuDeviceSetLoggingCallback(device:WGPUDevice, callback:WGPULoggingCallback, userdata:int|None) -> None: ...
@dll.bind(None, WGPUDevice)
def wgpuDeviceTick(device:WGPUDevice) -> None: ...
@dll.bind(None, WGPUDevice, ctypes.POINTER(WGPUTextureDescriptor))
def wgpuDeviceValidateTextureDescriptor(device:WGPUDevice, descriptor:ctypes._Pointer[WGPUTextureDescriptor]) -> None: ...
@dll.bind(None, WGPUDevice)
...
@dll.bind(WGPUSurface, WGPUInstance, ctypes.POINTER(WGPUSurfaceDescriptor))
def wgpuInstanceCreateSurface(instance:WGPUInstance, descriptor:ctypes._Pointer[WGPUSurfaceDescriptor]) -> WGPUSurface: ...
@dll.bind(size_t, WGPUInstance, ctypes.POINTER(WGPUWGSLFeatureName))
def wgpuInstanceEnumerateWGSLLanguageFeatures(instance:WGPUInstance, features:ctypes._Pointer[WGPUWGSLFeatureName]) -> size_t: ...
...
@dll.bind(None, WGPUInstance, ctypes.POINTER(WGPURequestAdapterOptions), WGPURequestAdapterCallback, ctypes.c_void_p)
def wgpuInstanceRequestAdapter(instance:WGPUInstance, options:ctypes._Pointer[WGPURequestAdapterOptions], callback:WGPURequestAdapterCallback, userdata:int|None) -> None: ...
@dll.bind(WGPUFuture, WGPUInstance, ctypes.POINTER(WGPURequestAdapterOptions), WGPURequestAdapterCallbackInfo2)
def wgpuInstanceRequestAdapter2(instance:WGPUInstance, options:ctypes._Pointer[WGPURequestAdapterOptions], callbackInfo:WGPURequestAdapterCallbackInfo2) -> WGPUFuture: ...
@dll.bind(WGPUFuture, WGPUInstance, ctypes.POINTER(WGPURequestAdapterOptions), WGPURequestAdapterCallbackInfo)
def wgpuInstanceRequestAdapterF(instance:WGPUInstance, options:ctypes._Pointer[WGPURequestAdapterOptions], callbackInfo:WGPURequestAdapterCallbackInfo) -> WGPUFuture: ...
@dll.bind(WGPUWaitStatus, WGPUInstance, size_t, ctypes.POINTER(WGPUFutureWaitInfo), uint64_t)
def wgpuInstanceWaitAny(instance:WGPUInstance, futureCount:size_t, futures:ctypes._Pointer[WGPUFutureWaitInfo], timeoutNS:uint64_t) -> WGPUWaitStatus: ...
@dll.bind(None, WGPUInstance)
...
@dll.bind(None, WGPUQueue, ctypes.POINTER(WGPUImageCopyExternalTexture), ctypes.POINTER(WGPUImageCopyTexture), ctypes.POINTER(WGPUExtent3D), ctypes.POINTER(WGPUCopyTextureForBrowserOptions))
def wgpuQueueCopyExternalTextureForBrowser(queue:WGPUQueue, source:ctypes._Pointer[WGPUImageCopyExternalTexture], destination:ctypes._Pointer[WGPUImageCopyTexture], copySize:ctypes._Pointer[WGPUExtent3D], options:ctypes._Pointer[WGPUCopyTextureForBrowserOptions]) -> None: ...
@dll.bind(None, WGPUQueue, ctypes.POINTER(WGPUImageCopyTexture), ctypes.POINTER(WGPUImageCopyTexture), ctypes.POINTER(WGPUExtent3D), ctypes.POINTER(WGPUCopyTextureForBrowserOptions))
def wgpuQueueCopyTextureForBrowser(queue:WGPUQueue, source:ctypes._Pointer[WGPUImageCopyTexture], destination:ctypes._Pointer[WGPUImageCopyTexture], copySize:ctypes._Pointer[WGPUExtent3D], options:ctypes._Pointer[WGPUCopyTextureForBrowserOptions]) -> None: ...
@dll.bind(None, WGPUQueue, WGPUQueueWorkDoneCallback, ctypes.c_void_p)
def wgpuQueueOnSubmittedWorkDone(queue:WGPUQueue, callback:WGPUQueueWorkDoneCallback, userdata:int|None) -> None: ...
...
@dll.bind(None, WGPUQueue, size_t, ctypes.POINTER(WGPUCommandBuffer))
def wgpuQueueSubmit(queue:WGPUQueue, commandCount:size_t, commands:ctypes._Pointer[WGPUCommandBuffer]) -> None: ...
@dll.bind(None, WGPUQueue, WGPUBuffer, uint64_t, ctypes.c_void_p, size_t)
def wgpuQueueWriteBuffer(queue:WGPUQueue, buffer:WGPUBuffer, bufferOffset:uint64_t, data:int|None, size:size_t) -> None: ...
@dll.bind(None, WGPUQueue, ctypes.POINTER(WGPUImageCopyTexture), ctypes.c_void_p, size_t, ctypes.POINTER(WGPUTextureDataLayout), ctypes.POINTER(WGPUExtent3D))
def wgpuQueueWriteTexture(queue:WGPUQueue, destination:ctypes._Pointer[WGPUImageCopyTexture], data:int|None, dataSize:size_t, dataLayout:ctypes._Pointer[WGPUTextureDataLayout], writeSize:ctypes._Pointer[WGPUExtent3D]) -> None: ...
...
@dll.bind(WGPURenderBundle, WGPURenderBundleEncoder, ctypes.POINTER(WGPURenderBundleDescriptor))
def wgpuRenderBundleEncoderFinish(renderBundleEncoder:WGPURenderBundleEncoder, descriptor:ctypes._Pointer[WGPURenderBundleDescriptor]) -> WGPURenderBundle: ...
...
@dll.bind(None, WGPURenderBundleEncoder, uint32_t, WGPUBindGroup, size_t, ctypes.POINTER(uint32_t))
def wgpuRenderBundleEncoderSetBindGroup(renderBundleEncoder:WGPURenderBundleEncoder, groupIndex:uint32_t, group:WGPUBindGroup, dynamicOffsetCount:size_t, dynamicOffsets:ctypes._Pointer[uint32_t]) -> None: ...
...
@dll.bind(None, WGPURenderPassEncoder, size_t, ctypes.POINTER(WGPURenderBundle))
def wgpuRenderPassEncoderExecuteBundles(renderPassEncoder:WGPURenderPassEncoder, bundleCount:size_t, bundles:ctypes._Pointer[WGPURenderBundle]) -> None: ...
...
@dll.bind(None, WGPURenderPassEncoder, uint32_t, WGPUBindGroup, size_t, ctypes.POINTER(uint32_t))
def wgpuRenderPassEncoderSetBindGroup(renderPassEncoder:WGPURenderPassEncoder, groupIndex:uint32_t, group:WGPUBindGroup, dynamicOffsetCount:size_t, dynamicOffsets:ctypes._Pointer[uint32_t]) -> None: ...
@dll.bind(None, WGPURenderPassEncoder, ctypes.POINTER(WGPUColor))
def wgpuRenderPassEncoderSetBlendConstant(renderPassEncoder:WGPURenderPassEncoder, color:ctypes._Pointer[WGPUColor]) -> None: ...
...
def wgpuShaderModuleGetCompilationInfo(shaderModule:WGPUShaderModule, callback:WGPUCompilationInfoCallback, userdata:int|None) -> None: ...
...
@dll.bind(WGPUStatus, WGPUSharedBufferMemory, WGPUBuffer, ctypes.POINTER(WGPUSharedBufferMemoryBeginAccessDescriptor))
def wgpuSharedBufferMemoryBeginAccess(sharedBufferMemory:WGPUSharedBufferMemory, buffer:WGPUBuffer, descriptor:ctypes._Pointer[WGPUSharedBufferMemoryBeginAccessDescriptor]) -> WGPUStatus: ...
@dll.bind(WGPUBuffer, WGPUSharedBufferMemory, ctypes.POINTER(WGPUBufferDescriptor))
def wgpuSharedBufferMemoryCreateBuffer(sharedBufferMemory:WGPUSharedBufferMemory, descriptor:ctypes._Pointer[WGPUBufferDescriptor]) -> WGPUBuffer: ...
@dll.bind(WGPUStatus, WGPUSharedBufferMemory, WGPUBuffer, ctypes.POINTER(WGPUSharedBufferMemoryEndAccessState))
def wgpuSharedBufferMemoryEndAccess(sharedBufferMemory:WGPUSharedBufferMemory, buffer:WGPUBuffer, descriptor:ctypes._Pointer[WGPUSharedBufferMemoryEndAccessState]) -> WGPUStatus: ...
@dll.bind(WGPUStatus, WGPUSharedBufferMemory, ctypes.POINTER(WGPUSharedBufferMemoryProperties))
def wgpuSharedBufferMemoryGetProperties(sharedBufferMemory:WGPUSharedBufferMemory, properties:ctypes._Pointer[WGPUSharedBufferMemoryProperties]) -> WGPUStatus: ...
...
@dll.bind(None, WGPUSharedFence, ctypes.POINTER(WGPUSharedFenceExportInfo))
def wgpuSharedFenceExportInfo(sharedFence:WGPUSharedFence, info:ctypes._Pointer[WGPUSharedFenceExportInfo]) -> None: ...
...
@dll.bind(WGPUStatus, WGPUSharedTextureMemory, WGPUTexture, ctypes.POINTER(WGPUSharedTextureMemoryBeginAccessDescriptor))
def wgpuSharedTextureMemoryBeginAccess(sharedTextureMemory:WGPUSharedTextureMemory, texture:WGPUTexture, descriptor:ctypes._Pointer[WGPUSharedTextureMemoryBeginAccessDescriptor]) -> WGPUStatus: ...
@dll.bind(WGPUTexture, WGPUSharedTextureMemory, ctypes.POINTER(WGPUTextureDescriptor))
def wgpuSharedTextureMemoryCreateTexture(sharedTextureMemory:WGPUSharedTextureMemory, descriptor:ctypes._Pointer[WGPUTextureDescriptor]) -> WGPUTexture: ...
@dll.bind(WGPUStatus, WGPUSharedTextureMemory, WGPUTexture, ctypes.POINTER(WGPUSharedTextureMemoryEndAccessState))
def wgpuSharedTextureMemoryEndAccess(sharedTextureMemory:WGPUSharedTextureMemory, texture:WGPUTexture, descriptor:ctypes._Pointer[WGPUSharedTextureMemoryEndAccessState]) -> WGPUStatus: ...
@dll.bind(WGPUStatus, WGPUSharedTextureMemory, ctypes.POINTER(WGPUSharedTextureMemoryProperties))
def wgpuSharedTextureMemoryGetProperties(sharedTextureMemory:WGPUSharedTextureMemory, properties:ctypes._Pointer[WGPUSharedTextureMemoryProperties]) -> WGPUStatus: ...
...
@dll.bind(None, WGPUSurface, ctypes.POINTER(WGPUSurfaceConfiguration))
def wgpuSurfaceConfigure(surface:WGPUSurface, config:ctypes._Pointer[WGPUSurfaceConfiguration]) -> None: ...
@dll.bind(WGPUStatus, WGPUSurface, WGPUAdapter, ctypes.POINTER(WGPUSurfaceCapabilities))
def wgpuSurfaceGetCapabilities(surface:WGPUSurface, adapter:WGPUAdapter, capabilities:ctypes._Pointer[WGPUSurfaceCapabilities]) -> WGPUStatus: ...
@dll.bind(None, WGPUSurface, ctypes.POINTER(WGPUSurfaceTexture))
def wgpuSurfaceGetCurrentTexture(surface:WGPUSurface, surfaceTexture:ctypes._Pointer[WGPUSurfaceTexture]) -> None: ...
...
@dll.bind(WGPUTextureView, WGPUTexture, ctypes.POINTER(WGPUTextureViewDescriptor))
def wgpuTextureCreateErrorView(texture:WGPUTexture, descriptor:ctypes._Pointer[WGPUTextureViewDescriptor]) -> WGPUTextureView: ...
@dll.bind(WGPUTextureView, WGPUTexture, ctypes.POINTER(WGPUTextureViewDescriptor))
def wgpuTextureCreateView(texture:WGPUTexture, descriptor:ctypes._Pointer[WGPUTextureViewDescriptor]) -> WGPUTextureView: ...
