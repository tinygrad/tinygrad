...
@dll.bind
def strtoimax(__nptr:POINTER(Annotated[bytes, ctypes.c_char]), __endptr:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), __base:Annotated[int, ctypes.c_int32]) -> intmax_t: ...
uintmax_t: TypeAlias = Annotated[int, ctypes.c_uint64]
@dll.bind
def strtoumax(__nptr:POINTER(Annotated[bytes, ctypes.c_char]), __endptr:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), __base:Annotated[int, ctypes.c_int32]) -> uintmax_t: ...
__gwchar_t: TypeAlias = Annotated[int, ctypes.c_int32]
@dll.bind
def wcstoimax(__nptr:POINTER(Annotated[int, ctypes.c_int32]), __endptr:POINTER(POINTER(Annotated[int, ctypes.c_int32])), __base:Annotated[int, ctypes.c_int32]) -> intmax_t: ...
@dll.bind
def wcstoumax(__nptr:POINTER(Annotated[int, ctypes.c_int32]), __endptr:POINTER(POINTER(Annotated[int, ctypes.c_int32])), __base:Annotated[int, ctypes.c_int32]) -> uintmax_t: ...
@record
class fd_set:
  SIZE = 128
  fds_bits: Annotated[Array[Annotated[int, ctypes.c_int64], Literal[16]], 0]
...
@dll.bind
def select(__nfds:Annotated[int, ctypes.c_int32], __readfds:POINTER(fd_set), __writefds:POINTER(fd_set), __exceptfds:POINTER(fd_set), __timeout:POINTER(struct_timeval)) -> Annotated[int, ctypes.c_int32]: ...
@record
...
class __sigset_t:
  SIZE = 128
  __val: Annotated[Array[Annotated[int, ctypes.c_uint64], Literal[16]], 0]
@dll.bind
def pselect(__nfds:Annotated[int, ctypes.c_int32], __readfds:POINTER(fd_set), __writefds:POINTER(fd_set), __exceptfds:POINTER(fd_set), __timeout:POINTER(struct_timespec), __sigmask:POINTER(__sigset_t)) -> Annotated[int, ctypes.c_int32]: ...
...
@dll.bind
def LLVMVerifyModule(M:LLVMModuleRef, Action:LLVMVerifierFailureAction, OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
...
LLVMMemoryBufferRef: TypeAlias = POINTER(struct_LLVMOpaqueMemoryBuffer)
@dll.bind
def LLVMParseBitcode(MemBuf:LLVMMemoryBufferRef, OutModule:POINTER(LLVMModuleRef), OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMParseBitcode2(MemBuf:LLVMMemoryBufferRef, OutModule:POINTER(LLVMModuleRef)) -> LLVMBool: ...
class struct_LLVMOpaqueContext(ctypes.Structure): pass
LLVMContextRef: TypeAlias = POINTER(struct_LLVMOpaqueContext)
@dll.bind
def LLVMParseBitcodeInContext(ContextRef:LLVMContextRef, MemBuf:LLVMMemoryBufferRef, OutModule:POINTER(LLVMModuleRef), OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMParseBitcodeInContext2(ContextRef:LLVMContextRef, MemBuf:LLVMMemoryBufferRef, OutModule:POINTER(LLVMModuleRef)) -> LLVMBool: ...
@dll.bind
def LLVMGetBitcodeModuleInContext(ContextRef:LLVMContextRef, MemBuf:LLVMMemoryBufferRef, OutM:POINTER(LLVMModuleRef), OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMGetBitcodeModuleInContext2(ContextRef:LLVMContextRef, MemBuf:LLVMMemoryBufferRef, OutM:POINTER(LLVMModuleRef)) -> LLVMBool: ...
@dll.bind
def LLVMGetBitcodeModule(MemBuf:LLVMMemoryBufferRef, OutM:POINTER(LLVMModuleRef), OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMGetBitcodeModule2(MemBuf:LLVMMemoryBufferRef, OutM:POINTER(LLVMModuleRef)) -> LLVMBool: ...
@dll.bind
def LLVMWriteBitcodeToFile(M:LLVMModuleRef, Path:POINTER(Annotated[bytes, ctypes.c_char])) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
...
LLVMComdatRef: TypeAlias = POINTER(struct_LLVMComdat)
@dll.bind
def LLVMGetOrInsertComdat(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMComdatRef: ...
@dll.bind
...
LLVMFatalErrorHandler: TypeAlias = CFUNCTYPE(None, POINTER(Annotated[bytes, ctypes.c_char]))
@dll.bind
...
@dll.bind
def LLVMGetVersion(Major:POINTER(Annotated[int, ctypes.c_uint32]), Minor:POINTER(Annotated[int, ctypes.c_uint32]), Patch:POINTER(Annotated[int, ctypes.c_uint32])) -> None: ...
@dll.bind
def LLVMCreateMessage(Message:POINTER(Annotated[bytes, ctypes.c_char])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMDisposeMessage(Message:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
class struct_LLVMOpaqueDiagnosticInfo(ctypes.Structure): pass
LLVMDiagnosticHandler: TypeAlias = CFUNCTYPE(None, POINTER(struct_LLVMOpaqueDiagnosticInfo), POINTER(None))
LLVMYieldCallback: TypeAlias = CFUNCTYPE(None, POINTER(struct_LLVMOpaqueContext), POINTER(None))
@dll.bind
def LLVMContextCreate() -> LLVMContextRef: ...
@dll.bind
def LLVMGetGlobalContext() -> LLVMContextRef: ...
@dll.bind
def LLVMContextSetDiagnosticHandler(C:LLVMContextRef, Handler:LLVMDiagnosticHandler, DiagnosticContext:POINTER(None)) -> None: ...
@dll.bind
def LLVMContextGetDiagnosticHandler(C:LLVMContextRef) -> LLVMDiagnosticHandler: ...
@dll.bind
def LLVMContextGetDiagnosticContext(C:LLVMContextRef) -> POINTER(None): ...
@dll.bind
def LLVMContextSetYieldCallback(C:LLVMContextRef, Callback:LLVMYieldCallback, OpaqueHandle:POINTER(None)) -> None: ...
@dll.bind
...
LLVMDiagnosticInfoRef: TypeAlias = POINTER(struct_LLVMOpaqueDiagnosticInfo)
@dll.bind
def LLVMGetDiagInfoDescription(DI:LLVMDiagnosticInfoRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetDiagInfoSeverity(DI:LLVMDiagnosticInfoRef) -> LLVMDiagnosticSeverity: ...
@dll.bind
def LLVMGetMDKindIDInContext(C:LLVMContextRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), SLen:Annotated[int, ctypes.c_uint32]) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetMDKindID(Name:POINTER(Annotated[bytes, ctypes.c_char]), SLen:Annotated[int, ctypes.c_uint32]) -> Annotated[int, ctypes.c_uint32]: ...
size_t: TypeAlias = Annotated[int, ctypes.c_uint64]
@dll.bind
def LLVMGetSyncScopeID(C:LLVMContextRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), SLen:size_t) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetEnumAttributeKindForName(Name:POINTER(Annotated[bytes, ctypes.c_char]), SLen:size_t) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
...
LLVMAttributeRef: TypeAlias = POINTER(struct_LLVMOpaqueAttributeRef)
@dll.bind
...
@dll.bind
def LLVMCreateConstantRangeAttribute(C:LLVMContextRef, KindID:Annotated[int, ctypes.c_uint32], NumBits:Annotated[int, ctypes.c_uint32], LowerWords:Array[uint64_t, Literal[0]], UpperWords:Array[uint64_t, Literal[0]]) -> LLVMAttributeRef: ...
@dll.bind
def LLVMCreateStringAttribute(C:LLVMContextRef, K:POINTER(Annotated[bytes, ctypes.c_char]), KLength:Annotated[int, ctypes.c_uint32], V:POINTER(Annotated[bytes, ctypes.c_char]), VLength:Annotated[int, ctypes.c_uint32]) -> LLVMAttributeRef: ...
@dll.bind
def LLVMGetStringAttributeKind(A:LLVMAttributeRef, Length:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetStringAttributeValue(A:LLVMAttributeRef, Length:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetTypeByName2(C:LLVMContextRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMTypeRef: ...
@dll.bind
def LLVMModuleCreateWithName(ModuleID:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMModuleRef: ...
@dll.bind
def LLVMModuleCreateWithNameInContext(ModuleID:POINTER(Annotated[bytes, ctypes.c_char]), C:LLVMContextRef) -> LLVMModuleRef: ...
@dll.bind
...
@dll.bind
def LLVMGetModuleIdentifier(M:LLVMModuleRef, Len:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetModuleIdentifier(M:LLVMModuleRef, Ident:POINTER(Annotated[bytes, ctypes.c_char]), Len:size_t) -> None: ...
@dll.bind
def LLVMGetSourceFileName(M:LLVMModuleRef, Len:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetSourceFileName(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), Len:size_t) -> None: ...
@dll.bind
def LLVMGetDataLayoutStr(M:LLVMModuleRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetDataLayout(M:LLVMModuleRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetDataLayout(M:LLVMModuleRef, DataLayoutStr:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def LLVMGetTarget(M:LLVMModuleRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetTarget(M:LLVMModuleRef, Triple:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
...
@dll.bind
def LLVMCopyModuleFlagsMetadata(M:LLVMModuleRef, Len:POINTER(size_t)) -> POINTER(LLVMModuleFlagEntry): ...
@dll.bind
def LLVMDisposeModuleFlagsMetadata(Entries:POINTER(LLVMModuleFlagEntry)) -> None: ...
@dll.bind
def LLVMModuleFlagEntriesGetFlagBehavior(Entries:POINTER(LLVMModuleFlagEntry), Index:Annotated[int, ctypes.c_uint32]) -> LLVMModuleFlagBehavior: ...
@dll.bind
def LLVMModuleFlagEntriesGetKey(Entries:POINTER(LLVMModuleFlagEntry), Index:Annotated[int, ctypes.c_uint32], Len:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
class struct_LLVMOpaqueMetadata(ctypes.Structure): pass
LLVMMetadataRef: TypeAlias = POINTER(struct_LLVMOpaqueMetadata)
@dll.bind
def LLVMModuleFlagEntriesGetMetadata(Entries:POINTER(LLVMModuleFlagEntry), Index:Annotated[int, ctypes.c_uint32]) -> LLVMMetadataRef: ...
@dll.bind
def LLVMGetModuleFlag(M:LLVMModuleRef, Key:POINTER(Annotated[bytes, ctypes.c_char]), KeyLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMAddModuleFlag(M:LLVMModuleRef, Behavior:LLVMModuleFlagBehavior, Key:POINTER(Annotated[bytes, ctypes.c_char]), KeyLen:size_t, Val:LLVMMetadataRef) -> None: ...
@dll.bind
def LLVMDumpModule(M:LLVMModuleRef) -> None: ...
@dll.bind
def LLVMPrintModuleToFile(M:LLVMModuleRef, Filename:POINTER(Annotated[bytes, ctypes.c_char]), ErrorMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMPrintModuleToString(M:LLVMModuleRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetModuleInlineAsm(M:LLVMModuleRef, Len:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetModuleInlineAsm2(M:LLVMModuleRef, Asm:POINTER(Annotated[bytes, ctypes.c_char]), Len:size_t) -> None: ...
@dll.bind
def LLVMAppendModuleInlineAsm(M:LLVMModuleRef, Asm:POINTER(Annotated[bytes, ctypes.c_char]), Len:size_t) -> None: ...
@dll.bind
def LLVMGetInlineAsm(Ty:LLVMTypeRef, AsmString:POINTER(Annotated[bytes, ctypes.c_char]), AsmStringSize:size_t, Constraints:POINTER(Annotated[bytes, ctypes.c_char]), ConstraintsSize:size_t, HasSideEffects:LLVMBool, IsAlignStack:LLVMBool, Dialect:LLVMInlineAsmDialect, CanThrow:LLVMBool) -> LLVMValueRef: ...
@dll.bind
def LLVMGetInlineAsmAsmString(InlineAsmVal:LLVMValueRef, Len:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetInlineAsmConstraintString(InlineAsmVal:LLVMValueRef, Len:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetTypeByName(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMTypeRef: ...
class struct_LLVMOpaqueNamedMDNode(ctypes.Structure): pass
LLVMNamedMDNodeRef: TypeAlias = POINTER(struct_LLVMOpaqueNamedMDNode)
@dll.bind
...
@dll.bind
def LLVMGetNamedMetadata(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> LLVMNamedMDNodeRef: ...
@dll.bind
def LLVMGetOrInsertNamedMetadata(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> LLVMNamedMDNodeRef: ...
@dll.bind
def LLVMGetNamedMetadataName(NamedMD:LLVMNamedMDNodeRef, NameLen:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetNamedMetadataNumOperands(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetNamedMetadataOperands(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), Dest:POINTER(LLVMValueRef)) -> None: ...
@dll.bind
def LLVMAddNamedMetadataOperand(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), Val:LLVMValueRef) -> None: ...
@dll.bind
def LLVMGetDebugLocDirectory(Val:LLVMValueRef, Length:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetDebugLocFilename(Val:LLVMValueRef, Length:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMAddFunction(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), FunctionTy:LLVMTypeRef) -> LLVMValueRef: ...
@dll.bind
def LLVMGetNamedFunction(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMGetNamedFunctionWithLength(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), Length:size_t) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMSetModuleInlineAsm(M:LLVMModuleRef, Asm:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
...
@dll.bind
def LLVMPrintTypeToString(Val:LLVMTypeRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMFunctionType(ReturnType:LLVMTypeRef, ParamTypes:POINTER(LLVMTypeRef), ParamCount:Annotated[int, ctypes.c_uint32], IsVarArg:LLVMBool) -> LLVMTypeRef: ...
@dll.bind
...
@dll.bind
def LLVMGetParamTypes(FunctionTy:LLVMTypeRef, Dest:POINTER(LLVMTypeRef)) -> None: ...
@dll.bind
def LLVMStructTypeInContext(C:LLVMContextRef, ElementTypes:POINTER(LLVMTypeRef), ElementCount:Annotated[int, ctypes.c_uint32], Packed:LLVMBool) -> LLVMTypeRef: ...
@dll.bind
def LLVMStructType(ElementTypes:POINTER(LLVMTypeRef), ElementCount:Annotated[int, ctypes.c_uint32], Packed:LLVMBool) -> LLVMTypeRef: ...
@dll.bind
def LLVMStructCreateNamed(C:LLVMContextRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMTypeRef: ...
@dll.bind
def LLVMGetStructName(Ty:LLVMTypeRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMStructSetBody(StructTy:LLVMTypeRef, ElementTypes:POINTER(LLVMTypeRef), ElementCount:Annotated[int, ctypes.c_uint32], Packed:LLVMBool) -> None: ...
@dll.bind
def LLVMCountStructElementTypes(StructTy:LLVMTypeRef) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetStructElementTypes(StructTy:LLVMTypeRef, Dest:POINTER(LLVMTypeRef)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGetSubtypes(Tp:LLVMTypeRef, Arr:POINTER(LLVMTypeRef)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMTargetExtTypeInContext(C:LLVMContextRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), TypeParams:POINTER(LLVMTypeRef), TypeParamCount:Annotated[int, ctypes.c_uint32], IntParams:POINTER(Annotated[int, ctypes.c_uint32]), IntParamCount:Annotated[int, ctypes.c_uint32]) -> LLVMTypeRef: ...
@dll.bind
def LLVMGetTargetExtTypeName(TargetExtTy:LLVMTypeRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetValueName2(Val:LLVMValueRef, Length:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetValueName2(Val:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> None: ...
@dll.bind
def LLVMDumpValue(Val:LLVMValueRef) -> None: ...
@dll.bind
def LLVMPrintValueToString(Val:LLVMValueRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetValueContext(Val:LLVMValueRef) -> LLVMContextRef: ...
class struct_LLVMOpaqueDbgRecord(ctypes.Structure): pass
LLVMDbgRecordRef: TypeAlias = POINTER(struct_LLVMOpaqueDbgRecord)
@dll.bind
def LLVMPrintDbgRecordToString(Record:LLVMDbgRecordRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetValueName(Val:LLVMValueRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetValueName(Val:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
class struct_LLVMOpaqueUse(ctypes.Structure): pass
LLVMUseRef: TypeAlias = POINTER(struct_LLVMOpaqueUse)
@dll.bind
...
@dll.bind
def LLVMConstIntOfArbitraryPrecision(IntTy:LLVMTypeRef, NumWords:Annotated[int, ctypes.c_uint32], Words:Array[uint64_t, Literal[0]]) -> LLVMValueRef: ...
uint8_t: TypeAlias = Annotated[int, ctypes.c_ubyte]
@dll.bind
def LLVMConstIntOfString(IntTy:LLVMTypeRef, Text:POINTER(Annotated[bytes, ctypes.c_char]), Radix:uint8_t) -> LLVMValueRef: ...
@dll.bind
def LLVMConstIntOfStringAndSize(IntTy:LLVMTypeRef, Text:POINTER(Annotated[bytes, ctypes.c_char]), SLen:Annotated[int, ctypes.c_uint32], Radix:uint8_t) -> LLVMValueRef: ...
@dll.bind
def LLVMConstReal(RealTy:LLVMTypeRef, N:Annotated[float, ctypes.c_double]) -> LLVMValueRef: ...
@dll.bind
def LLVMConstRealOfString(RealTy:LLVMTypeRef, Text:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMConstRealOfStringAndSize(RealTy:LLVMTypeRef, Text:POINTER(Annotated[bytes, ctypes.c_char]), SLen:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMConstRealGetDouble(ConstantVal:LLVMValueRef, losesInfo:POINTER(LLVMBool)) -> Annotated[float, ctypes.c_double]: ...
@dll.bind
def LLVMConstStringInContext(C:LLVMContextRef, Str:POINTER(Annotated[bytes, ctypes.c_char]), Length:Annotated[int, ctypes.c_uint32], DontNullTerminate:LLVMBool) -> LLVMValueRef: ...
@dll.bind
def LLVMConstStringInContext2(C:LLVMContextRef, Str:POINTER(Annotated[bytes, ctypes.c_char]), Length:size_t, DontNullTerminate:LLVMBool) -> LLVMValueRef: ...
@dll.bind
def LLVMConstString(Str:POINTER(Annotated[bytes, ctypes.c_char]), Length:Annotated[int, ctypes.c_uint32], DontNullTerminate:LLVMBool) -> LLVMValueRef: ...
@dll.bind
def LLVMIsConstantString(c:LLVMValueRef) -> LLVMBool: ...
@dll.bind
def LLVMGetAsString(c:LLVMValueRef, Length:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMConstStructInContext(C:LLVMContextRef, ConstantVals:POINTER(LLVMValueRef), Count:Annotated[int, ctypes.c_uint32], Packed:LLVMBool) -> LLVMValueRef: ...
@dll.bind
def LLVMConstStruct(ConstantVals:POINTER(LLVMValueRef), Count:Annotated[int, ctypes.c_uint32], Packed:LLVMBool) -> LLVMValueRef: ...
@dll.bind
def LLVMConstArray(ElementTy:LLVMTypeRef, ConstantVals:POINTER(LLVMValueRef), Length:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
def LLVMConstArray2(ElementTy:LLVMTypeRef, ConstantVals:POINTER(LLVMValueRef), Length:uint64_t) -> LLVMValueRef: ...
@dll.bind
def LLVMConstNamedStruct(StructTy:LLVMTypeRef, ConstantVals:POINTER(LLVMValueRef), Count:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMConstVector(ScalarConstantVals:POINTER(LLVMValueRef), Size:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMConstGEP2(Ty:LLVMTypeRef, ConstantVal:LLVMValueRef, ConstantIndices:POINTER(LLVMValueRef), NumIndices:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
def LLVMConstInBoundsGEP2(Ty:LLVMTypeRef, ConstantVal:LLVMValueRef, ConstantIndices:POINTER(LLVMValueRef), NumIndices:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
def LLVMConstGEPWithNoWrapFlags(Ty:LLVMTypeRef, ConstantVal:LLVMValueRef, ConstantIndices:POINTER(LLVMValueRef), NumIndices:Annotated[int, ctypes.c_uint32], NoWrapFlags:LLVMGEPNoWrapFlags) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMConstInlineAsm(Ty:LLVMTypeRef, AsmString:POINTER(Annotated[bytes, ctypes.c_char]), Constraints:POINTER(Annotated[bytes, ctypes.c_char]), HasSideEffects:LLVMBool, IsAlignStack:LLVMBool) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMGetSection(Global:LLVMValueRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetSection(Global:LLVMValueRef, Section:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGlobalCopyAllMetadata(Value:LLVMValueRef, NumEntries:POINTER(size_t)) -> POINTER(LLVMValueMetadataEntry): ...
@dll.bind
def LLVMDisposeValueMetadataEntries(Entries:POINTER(LLVMValueMetadataEntry)) -> None: ...
@dll.bind
def LLVMValueMetadataEntriesGetKind(Entries:POINTER(LLVMValueMetadataEntry), Index:Annotated[int, ctypes.c_uint32]) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMValueMetadataEntriesGetMetadata(Entries:POINTER(LLVMValueMetadataEntry), Index:Annotated[int, ctypes.c_uint32]) -> LLVMMetadataRef: ...
@dll.bind
def LLVMAddGlobal(M:LLVMModuleRef, Ty:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMAddGlobalInAddressSpace(M:LLVMModuleRef, Ty:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), AddressSpace:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
def LLVMGetNamedGlobal(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMGetNamedGlobalWithLength(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), Length:size_t) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMAddAlias2(M:LLVMModuleRef, ValueTy:LLVMTypeRef, AddrSpace:Annotated[int, ctypes.c_uint32], Aliasee:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMGetNamedGlobalAlias(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMLookupIntrinsicID(Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetIntrinsicID(Fn:LLVMValueRef) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetIntrinsicDeclaration(Mod:LLVMModuleRef, ID:Annotated[int, ctypes.c_uint32], ParamTypes:POINTER(LLVMTypeRef), ParamCount:size_t) -> LLVMValueRef: ...
@dll.bind
def LLVMIntrinsicGetType(Ctx:LLVMContextRef, ID:Annotated[int, ctypes.c_uint32], ParamTypes:POINTER(LLVMTypeRef), ParamCount:size_t) -> LLVMTypeRef: ...
@dll.bind
def LLVMIntrinsicGetName(ID:Annotated[int, ctypes.c_uint32], NameLength:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMIntrinsicCopyOverloadedName(ID:Annotated[int, ctypes.c_uint32], ParamTypes:POINTER(LLVMTypeRef), ParamCount:size_t, NameLength:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMIntrinsicCopyOverloadedName2(Mod:LLVMModuleRef, ID:Annotated[int, ctypes.c_uint32], ParamTypes:POINTER(LLVMTypeRef), ParamCount:size_t, NameLength:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetGC(Fn:LLVMValueRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMSetGC(Fn:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGetAttributesAtIndex(F:LLVMValueRef, Idx:LLVMAttributeIndex, Attrs:POINTER(LLVMAttributeRef)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGetStringAttributeAtIndex(F:LLVMValueRef, Idx:LLVMAttributeIndex, K:POINTER(Annotated[bytes, ctypes.c_char]), KLen:Annotated[int, ctypes.c_uint32]) -> LLVMAttributeRef: ...
@dll.bind
def LLVMRemoveEnumAttributeAtIndex(F:LLVMValueRef, Idx:LLVMAttributeIndex, KindID:Annotated[int, ctypes.c_uint32]) -> None: ...
@dll.bind
def LLVMRemoveStringAttributeAtIndex(F:LLVMValueRef, Idx:LLVMAttributeIndex, K:POINTER(Annotated[bytes, ctypes.c_char]), KLen:Annotated[int, ctypes.c_uint32]) -> None: ...
@dll.bind
def LLVMAddTargetDependentFunctionAttr(Fn:LLVMValueRef, A:POINTER(Annotated[bytes, ctypes.c_char]), V:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def LLVMCountParams(Fn:LLVMValueRef) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetParams(Fn:LLVMValueRef, Params:POINTER(LLVMValueRef)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMAddGlobalIFunc(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Ty:LLVMTypeRef, AddrSpace:Annotated[int, ctypes.c_uint32], Resolver:LLVMValueRef) -> LLVMValueRef: ...
@dll.bind
def LLVMGetNamedGlobalIFunc(M:LLVMModuleRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMMDStringInContext2(C:LLVMContextRef, Str:POINTER(Annotated[bytes, ctypes.c_char]), SLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMMDNodeInContext2(C:LLVMContextRef, MDs:POINTER(LLVMMetadataRef), Count:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMGetMDString(V:LLVMValueRef, Length:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetMDNodeNumOperands(V:LLVMValueRef) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def LLVMGetMDNodeOperands(V:LLVMValueRef, Dest:POINTER(LLVMValueRef)) -> None: ...
@dll.bind
def LLVMReplaceMDNodeOperandWith(V:LLVMValueRef, Index:Annotated[int, ctypes.c_uint32], Replacement:LLVMMetadataRef) -> None: ...
@dll.bind
def LLVMMDStringInContext(C:LLVMContextRef, Str:POINTER(Annotated[bytes, ctypes.c_char]), SLen:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
def LLVMMDString(Str:POINTER(Annotated[bytes, ctypes.c_char]), SLen:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
def LLVMMDNodeInContext(C:LLVMContextRef, Vals:POINTER(LLVMValueRef), Count:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
def LLVMMDNode(Vals:POINTER(LLVMValueRef), Count:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
class struct_LLVMOpaqueOperandBundle(ctypes.Structure): pass
LLVMOperandBundleRef: TypeAlias = POINTER(struct_LLVMOpaqueOperandBundle)
@dll.bind
def LLVMCreateOperandBundle(Tag:POINTER(Annotated[bytes, ctypes.c_char]), TagLen:size_t, Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32]) -> LLVMOperandBundleRef: ...
@dll.bind
def LLVMDisposeOperandBundle(Bundle:LLVMOperandBundleRef) -> None: ...
@dll.bind
def LLVMGetOperandBundleTag(Bundle:LLVMOperandBundleRef, Len:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetBasicBlockName(BB:LLVMBasicBlockRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetBasicBlocks(Fn:LLVMValueRef, BasicBlocks:POINTER(LLVMBasicBlockRef)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMCreateBasicBlockInContext(C:LLVMContextRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMBasicBlockRef: ...
@dll.bind
def LLVMAppendBasicBlockInContext(C:LLVMContextRef, Fn:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMBasicBlockRef: ...
@dll.bind
def LLVMAppendBasicBlock(Fn:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMBasicBlockRef: ...
@dll.bind
def LLVMInsertBasicBlockInContext(C:LLVMContextRef, BB:LLVMBasicBlockRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMBasicBlockRef: ...
@dll.bind
def LLVMInsertBasicBlock(InsertBeforeBB:LLVMBasicBlockRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMBasicBlockRef: ...
@dll.bind
...
@dll.bind
def LLVMInstructionGetAllMetadataOtherThanDebugLoc(Instr:LLVMValueRef, NumEntries:POINTER(size_t)) -> POINTER(LLVMValueMetadataEntry): ...
@dll.bind
...
@dll.bind
def LLVMGetCallSiteAttributes(C:LLVMValueRef, Idx:LLVMAttributeIndex, Attrs:POINTER(LLVMAttributeRef)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGetCallSiteStringAttribute(C:LLVMValueRef, Idx:LLVMAttributeIndex, K:POINTER(Annotated[bytes, ctypes.c_char]), KLen:Annotated[int, ctypes.c_uint32]) -> LLVMAttributeRef: ...
@dll.bind
def LLVMRemoveCallSiteEnumAttribute(C:LLVMValueRef, Idx:LLVMAttributeIndex, KindID:Annotated[int, ctypes.c_uint32]) -> None: ...
@dll.bind
def LLVMRemoveCallSiteStringAttribute(C:LLVMValueRef, Idx:LLVMAttributeIndex, K:POINTER(Annotated[bytes, ctypes.c_char]), KLen:Annotated[int, ctypes.c_uint32]) -> None: ...
@dll.bind
...
@dll.bind
def LLVMAddIncoming(PhiNode:LLVMValueRef, IncomingValues:POINTER(LLVMValueRef), IncomingBlocks:POINTER(LLVMBasicBlockRef), Count:Annotated[int, ctypes.c_uint32]) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGetIndices(Inst:LLVMValueRef) -> POINTER(Annotated[int, ctypes.c_uint32]): ...
@dll.bind
...
@dll.bind
def LLVMInsertIntoBuilderWithName(Builder:LLVMBuilderRef, Instr:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
...
@dll.bind
def LLVMBuildAggregateRet(_0:LLVMBuilderRef, RetVals:POINTER(LLVMValueRef), N:Annotated[int, ctypes.c_uint32]) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildCallBr(B:LLVMBuilderRef, Ty:LLVMTypeRef, Fn:LLVMValueRef, DefaultDest:LLVMBasicBlockRef, IndirectDests:POINTER(LLVMBasicBlockRef), NumIndirectDests:Annotated[int, ctypes.c_uint32], Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32], Bundles:POINTER(LLVMOperandBundleRef), NumBundles:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildInvoke2(_0:LLVMBuilderRef, Ty:LLVMTypeRef, Fn:LLVMValueRef, Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32], Then:LLVMBasicBlockRef, Catch:LLVMBasicBlockRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildInvokeWithOperandBundles(_0:LLVMBuilderRef, Ty:LLVMTypeRef, Fn:LLVMValueRef, Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32], Then:LLVMBasicBlockRef, Catch:LLVMBasicBlockRef, Bundles:POINTER(LLVMOperandBundleRef), NumBundles:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildLandingPad(B:LLVMBuilderRef, Ty:LLVMTypeRef, PersFn:LLVMValueRef, NumClauses:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildCatchPad(B:LLVMBuilderRef, ParentPad:LLVMValueRef, Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildCleanupPad(B:LLVMBuilderRef, ParentPad:LLVMValueRef, Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildCatchSwitch(B:LLVMBuilderRef, ParentPad:LLVMValueRef, UnwindBB:LLVMBasicBlockRef, NumHandlers:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMGetHandlers(CatchSwitch:LLVMValueRef, Handlers:POINTER(LLVMBasicBlockRef)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMBuildAdd(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNSWAdd(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNUWAdd(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFAdd(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildSub(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNSWSub(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNUWSub(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFSub(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildMul(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNSWMul(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNUWMul(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFMul(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildUDiv(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildExactUDiv(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildSDiv(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildExactSDiv(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFDiv(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildURem(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildSRem(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFRem(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildShl(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildLShr(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildAShr(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildAnd(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildOr(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildXor(_0:LLVMBuilderRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildBinOp(B:LLVMBuilderRef, Op:LLVMOpcode, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNeg(_0:LLVMBuilderRef, V:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNSWNeg(B:LLVMBuilderRef, V:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNUWNeg(B:LLVMBuilderRef, V:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFNeg(_0:LLVMBuilderRef, V:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildNot(_0:LLVMBuilderRef, V:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildMalloc(_0:LLVMBuilderRef, Ty:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildArrayMalloc(_0:LLVMBuilderRef, Ty:LLVMTypeRef, Val:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildAlloca(_0:LLVMBuilderRef, Ty:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildArrayAlloca(_0:LLVMBuilderRef, Ty:LLVMTypeRef, Val:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFree(_0:LLVMBuilderRef, PointerVal:LLVMValueRef) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildLoad2(_0:LLVMBuilderRef, Ty:LLVMTypeRef, PointerVal:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildStore(_0:LLVMBuilderRef, Val:LLVMValueRef, Ptr:LLVMValueRef) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildGEP2(B:LLVMBuilderRef, Ty:LLVMTypeRef, Pointer:LLVMValueRef, Indices:POINTER(LLVMValueRef), NumIndices:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildInBoundsGEP2(B:LLVMBuilderRef, Ty:LLVMTypeRef, Pointer:LLVMValueRef, Indices:POINTER(LLVMValueRef), NumIndices:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildGEPWithNoWrapFlags(B:LLVMBuilderRef, Ty:LLVMTypeRef, Pointer:LLVMValueRef, Indices:POINTER(LLVMValueRef), NumIndices:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char]), NoWrapFlags:LLVMGEPNoWrapFlags) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildStructGEP2(B:LLVMBuilderRef, Ty:LLVMTypeRef, Pointer:LLVMValueRef, Idx:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildGlobalString(B:LLVMBuilderRef, Str:POINTER(Annotated[bytes, ctypes.c_char]), Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildGlobalStringPtr(B:LLVMBuilderRef, Str:POINTER(Annotated[bytes, ctypes.c_char]), Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildTrunc(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildZExt(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildSExt(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFPToUI(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFPToSI(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildUIToFP(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildSIToFP(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFPTrunc(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFPExt(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildPtrToInt(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildIntToPtr(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildBitCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildAddrSpaceCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildZExtOrBitCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildSExtOrBitCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildTruncOrBitCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildCast(B:LLVMBuilderRef, Op:LLVMOpcode, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildPointerCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildIntCast2(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, IsSigned:LLVMBool, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFPCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildIntCast(_0:LLVMBuilderRef, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMGetCastOpcode(Src:LLVMValueRef, SrcIsSigned:LLVMBool, DestTy:LLVMTypeRef, DestIsSigned:LLVMBool) -> LLVMOpcode: ...
@dll.bind
def LLVMBuildICmp(_0:LLVMBuilderRef, Op:LLVMIntPredicate, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFCmp(_0:LLVMBuilderRef, Op:LLVMRealPredicate, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildPhi(_0:LLVMBuilderRef, Ty:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildCall2(_0:LLVMBuilderRef, _1:LLVMTypeRef, Fn:LLVMValueRef, Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildCallWithOperandBundles(_0:LLVMBuilderRef, _1:LLVMTypeRef, Fn:LLVMValueRef, Args:POINTER(LLVMValueRef), NumArgs:Annotated[int, ctypes.c_uint32], Bundles:POINTER(LLVMOperandBundleRef), NumBundles:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildSelect(_0:LLVMBuilderRef, If:LLVMValueRef, Then:LLVMValueRef, Else:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildVAArg(_0:LLVMBuilderRef, List:LLVMValueRef, Ty:LLVMTypeRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildExtractElement(_0:LLVMBuilderRef, VecVal:LLVMValueRef, Index:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildInsertElement(_0:LLVMBuilderRef, VecVal:LLVMValueRef, EltVal:LLVMValueRef, Index:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildShuffleVector(_0:LLVMBuilderRef, V1:LLVMValueRef, V2:LLVMValueRef, Mask:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildExtractValue(_0:LLVMBuilderRef, AggVal:LLVMValueRef, Index:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildInsertValue(_0:LLVMBuilderRef, AggVal:LLVMValueRef, EltVal:LLVMValueRef, Index:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFreeze(_0:LLVMBuilderRef, Val:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildIsNull(_0:LLVMBuilderRef, Val:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildIsNotNull(_0:LLVMBuilderRef, Val:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildPtrDiff2(_0:LLVMBuilderRef, ElemTy:LLVMTypeRef, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFence(B:LLVMBuilderRef, ordering:LLVMAtomicOrdering, singleThread:LLVMBool, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFenceSyncScope(B:LLVMBuilderRef, ordering:LLVMAtomicOrdering, SSID:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMValueRef: ...
@dll.bind
...
LLVMModuleProviderRef: TypeAlias = POINTER(struct_LLVMOpaqueModuleProvider)
@dll.bind
...
@dll.bind
def LLVMCreateMemoryBufferWithContentsOfFile(Path:POINTER(Annotated[bytes, ctypes.c_char]), OutMemBuf:POINTER(LLVMMemoryBufferRef), OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMCreateMemoryBufferWithSTDIN(OutMemBuf:POINTER(LLVMMemoryBufferRef), OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMCreateMemoryBufferWithMemoryRange(InputData:POINTER(Annotated[bytes, ctypes.c_char]), InputDataLength:size_t, BufferName:POINTER(Annotated[bytes, ctypes.c_char]), RequiresNullTerminator:LLVMBool) -> LLVMMemoryBufferRef: ...
@dll.bind
def LLVMCreateMemoryBufferWithMemoryRangeCopy(InputData:POINTER(Annotated[bytes, ctypes.c_char]), InputDataLength:size_t, BufferName:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMMemoryBufferRef: ...
@dll.bind
def LLVMGetBufferStart(MemBuf:LLVMMemoryBufferRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
LLVMPassManagerRef: TypeAlias = POINTER(struct_LLVMOpaquePassManager)
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateCompileUnit(Builder:LLVMDIBuilderRef, Lang:LLVMDWARFSourceLanguage, FileRef:LLVMMetadataRef, Producer:POINTER(Annotated[bytes, ctypes.c_char]), ProducerLen:size_t, isOptimized:LLVMBool, Flags:POINTER(Annotated[bytes, ctypes.c_char]), FlagsLen:size_t, RuntimeVer:Annotated[int, ctypes.c_uint32], SplitName:POINTER(Annotated[bytes, ctypes.c_char]), SplitNameLen:size_t, Kind:LLVMDWARFEmissionKind, DWOId:Annotated[int, ctypes.c_uint32], SplitDebugInlining:LLVMBool, DebugInfoForProfiling:LLVMBool, SysRoot:POINTER(Annotated[bytes, ctypes.c_char]), SysRootLen:size_t, SDK:POINTER(Annotated[bytes, ctypes.c_char]), SDKLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateFile(Builder:LLVMDIBuilderRef, Filename:POINTER(Annotated[bytes, ctypes.c_char]), FilenameLen:size_t, Directory:POINTER(Annotated[bytes, ctypes.c_char]), DirectoryLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateModule(Builder:LLVMDIBuilderRef, ParentScope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, ConfigMacros:POINTER(Annotated[bytes, ctypes.c_char]), ConfigMacrosLen:size_t, IncludePath:POINTER(Annotated[bytes, ctypes.c_char]), IncludePathLen:size_t, APINotesFile:POINTER(Annotated[bytes, ctypes.c_char]), APINotesFileLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateNameSpace(Builder:LLVMDIBuilderRef, ParentScope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, ExportSymbols:LLVMBool) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateFunction(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, LinkageName:POINTER(Annotated[bytes, ctypes.c_char]), LinkageNameLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], Ty:LLVMMetadataRef, IsLocalToUnit:LLVMBool, IsDefinition:LLVMBool, ScopeLine:Annotated[int, ctypes.c_uint32], Flags:LLVMDIFlags, IsOptimized:LLVMBool) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateImportedModuleFromAlias(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, ImportedEntity:LLVMMetadataRef, File:LLVMMetadataRef, Line:Annotated[int, ctypes.c_uint32], Elements:POINTER(LLVMMetadataRef), NumElements:Annotated[int, ctypes.c_uint32]) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateImportedModuleFromModule(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, M:LLVMMetadataRef, File:LLVMMetadataRef, Line:Annotated[int, ctypes.c_uint32], Elements:POINTER(LLVMMetadataRef), NumElements:Annotated[int, ctypes.c_uint32]) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateImportedDeclaration(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Decl:LLVMMetadataRef, File:LLVMMetadataRef, Line:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Elements:POINTER(LLVMMetadataRef), NumElements:Annotated[int, ctypes.c_uint32]) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIFileGetDirectory(File:LLVMMetadataRef, Len:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMDIFileGetFilename(File:LLVMMetadataRef, Len:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMDIFileGetSource(File:LLVMMetadataRef, Len:POINTER(Annotated[int, ctypes.c_uint32])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMDIBuilderGetOrCreateTypeArray(Builder:LLVMDIBuilderRef, Data:POINTER(LLVMMetadataRef), NumElements:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateSubroutineType(Builder:LLVMDIBuilderRef, File:LLVMMetadataRef, ParameterTypes:POINTER(LLVMMetadataRef), NumParameterTypes:Annotated[int, ctypes.c_uint32], Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateMacro(Builder:LLVMDIBuilderRef, ParentMacroFile:LLVMMetadataRef, Line:Annotated[int, ctypes.c_uint32], RecordType:LLVMDWARFMacinfoRecordType, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Value:POINTER(Annotated[bytes, ctypes.c_char]), ValueLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateEnumerator(Builder:LLVMDIBuilderRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Value:int64_t, IsUnsigned:LLVMBool) -> LLVMMetadataRef: ...
uint32_t: TypeAlias = Annotated[int, ctypes.c_uint32]
@dll.bind
def LLVMDIBuilderCreateEnumerationType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNumber:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, Elements:POINTER(LLVMMetadataRef), NumElements:Annotated[int, ctypes.c_uint32], ClassTy:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateUnionType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNumber:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, Elements:POINTER(LLVMMetadataRef), NumElements:Annotated[int, ctypes.c_uint32], RunTimeLang:Annotated[int, ctypes.c_uint32], UniqueId:POINTER(Annotated[bytes, ctypes.c_char]), UniqueIdLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateArrayType(Builder:LLVMDIBuilderRef, Size:uint64_t, AlignInBits:uint32_t, Ty:LLVMMetadataRef, Subscripts:POINTER(LLVMMetadataRef), NumSubscripts:Annotated[int, ctypes.c_uint32]) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateVectorType(Builder:LLVMDIBuilderRef, Size:uint64_t, AlignInBits:uint32_t, Ty:LLVMMetadataRef, Subscripts:POINTER(LLVMMetadataRef), NumSubscripts:Annotated[int, ctypes.c_uint32]) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateUnspecifiedType(Builder:LLVMDIBuilderRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateBasicType(Builder:LLVMDIBuilderRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, SizeInBits:uint64_t, Encoding:LLVMDWARFTypeEncoding, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreatePointerType(Builder:LLVMDIBuilderRef, PointeeTy:LLVMMetadataRef, SizeInBits:uint64_t, AlignInBits:uint32_t, AddressSpace:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateStructType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNumber:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, DerivedFrom:LLVMMetadataRef, Elements:POINTER(LLVMMetadataRef), NumElements:Annotated[int, ctypes.c_uint32], RunTimeLang:Annotated[int, ctypes.c_uint32], VTableHolder:LLVMMetadataRef, UniqueId:POINTER(Annotated[bytes, ctypes.c_char]), UniqueIdLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, Ty:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateStaticMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNumber:Annotated[int, ctypes.c_uint32], Type:LLVMMetadataRef, Flags:LLVMDIFlags, ConstantVal:LLVMValueRef, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateObjCIVar(Builder:LLVMDIBuilderRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, Ty:LLVMMetadataRef, PropertyNode:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateObjCProperty(Builder:LLVMDIBuilderRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], GetterName:POINTER(Annotated[bytes, ctypes.c_char]), GetterNameLen:size_t, SetterName:POINTER(Annotated[bytes, ctypes.c_char]), SetterNameLen:size_t, PropertyAttributes:Annotated[int, ctypes.c_uint32], Ty:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateTypedef(Builder:LLVMDIBuilderRef, Type:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], Scope:LLVMMetadataRef, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateForwardDecl(Builder:LLVMDIBuilderRef, Tag:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Scope:LLVMMetadataRef, File:LLVMMetadataRef, Line:Annotated[int, ctypes.c_uint32], RuntimeLang:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, UniqueIdentifier:POINTER(Annotated[bytes, ctypes.c_char]), UniqueIdentifierLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateReplaceableCompositeType(Builder:LLVMDIBuilderRef, Tag:Annotated[int, ctypes.c_uint32], Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Scope:LLVMMetadataRef, File:LLVMMetadataRef, Line:Annotated[int, ctypes.c_uint32], RuntimeLang:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, UniqueIdentifier:POINTER(Annotated[bytes, ctypes.c_char]), UniqueIdentifierLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateBitFieldMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNumber:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, OffsetInBits:uint64_t, StorageOffsetInBits:uint64_t, Flags:LLVMDIFlags, Type:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateClassType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNumber:Annotated[int, ctypes.c_uint32], SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, DerivedFrom:LLVMMetadataRef, Elements:POINTER(LLVMMetadataRef), NumElements:Annotated[int, ctypes.c_uint32], VTableHolder:LLVMMetadataRef, TemplateParamsNode:LLVMMetadataRef, UniqueIdentifier:POINTER(Annotated[bytes, ctypes.c_char]), UniqueIdentifierLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateArtificialType(Builder:LLVMDIBuilderRef, Type:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDITypeGetName(DType:LLVMMetadataRef, Length:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderGetOrCreateArray(Builder:LLVMDIBuilderRef, Data:POINTER(LLVMMetadataRef), NumElements:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateExpression(Builder:LLVMDIBuilderRef, Addr:POINTER(uint64_t), Length:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateConstantValueExpression(Builder:LLVMDIBuilderRef, Value:uint64_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateGlobalVariableExpression(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Linkage:POINTER(Annotated[bytes, ctypes.c_char]), LinkLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], Ty:LLVMMetadataRef, LocalToUnit:LLVMBool, Expr:LLVMMetadataRef, Decl:LLVMMetadataRef, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
...
@dll.bind
def LLVMTemporaryMDNode(Ctx:LLVMContextRef, Data:POINTER(LLVMMetadataRef), NumElements:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateTempGlobalVariableFwdDecl(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, Linkage:POINTER(Annotated[bytes, ctypes.c_char]), LnkLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], Ty:LLVMMetadataRef, LocalToUnit:LLVMBool, Decl:LLVMMetadataRef, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateAutoVariable(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], Ty:LLVMMetadataRef, AlwaysPreserve:LLVMBool, Flags:LLVMDIFlags, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateParameterVariable(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, ArgNo:Annotated[int, ctypes.c_uint32], File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], Ty:LLVMMetadataRef, AlwaysPreserve:LLVMBool, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateLabel(Builder:LLVMDIBuilderRef, Context:LLVMMetadataRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), NameLen:size_t, File:LLVMMetadataRef, LineNo:Annotated[int, ctypes.c_uint32], AlwaysPreserve:LLVMBool) -> LLVMMetadataRef: ...
@dll.bind
...
LLVMOpInfoCallback: TypeAlias = CFUNCTYPE(Annotated[int, ctypes.c_int32], POINTER(None), Annotated[int, ctypes.c_uint64], Annotated[int, ctypes.c_uint64], Annotated[int, ctypes.c_uint64], Annotated[int, ctypes.c_uint64], Annotated[int, ctypes.c_int32], POINTER(None))
LLVMSymbolLookupCallback: TypeAlias = CFUNCTYPE(POINTER(Annotated[bytes, ctypes.c_char]), POINTER(None), Annotated[int, ctypes.c_uint64], POINTER(Annotated[int, ctypes.c_uint64]), Annotated[int, ctypes.c_uint64], POINTER(POINTER(Annotated[bytes, ctypes.c_char])))
LLVMDisasmContextRef: TypeAlias = POINTER(None)
@dll.bind
def LLVMCreateDisasm(TripleName:POINTER(Annotated[bytes, ctypes.c_char]), DisInfo:POINTER(None), TagType:Annotated[int, ctypes.c_int32], GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
def LLVMCreateDisasmCPU(Triple:POINTER(Annotated[bytes, ctypes.c_char]), CPU:POINTER(Annotated[bytes, ctypes.c_char]), DisInfo:POINTER(None), TagType:Annotated[int, ctypes.c_int32], GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
def LLVMCreateDisasmCPUFeatures(Triple:POINTER(Annotated[bytes, ctypes.c_char]), CPU:POINTER(Annotated[bytes, ctypes.c_char]), Features:POINTER(Annotated[bytes, ctypes.c_char]), DisInfo:POINTER(None), TagType:Annotated[int, ctypes.c_int32], GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
...
@dll.bind
def LLVMDisasmInstruction(DC:LLVMDisasmContextRef, Bytes:POINTER(uint8_t), BytesSize:uint64_t, PC:uint64_t, OutString:POINTER(Annotated[bytes, ctypes.c_char]), OutStringSize:size_t) -> size_t: ...
@record
class struct_LLVMOpInfoSymbol1:
  SIZE = 24
  Present: Annotated[uint64_t, 0]
  Name: Annotated[POINTER(Annotated[bytes, ctypes.c_char]), 8]
  Value: Annotated[uint64_t, 16]
@record
class struct_LLVMOpInfo1:
  SIZE = 64
...
LLVMErrorRef: TypeAlias = POINTER(struct_LLVMOpaqueError)
LLVMErrorTypeId: TypeAlias = POINTER(None)
@dll.bind
...
@dll.bind
def LLVMGetErrorMessage(Err:LLVMErrorRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMDisposeErrorMessage(ErrMsg:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def LLVMGetStringErrorTypeId() -> LLVMErrorTypeId: ...
@dll.bind
def LLVMCreateStringError(ErrMsg:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMErrorRef: ...
@dll.bind
...
@dll.bind
def LLVMCreateTargetData(StringRep:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMTargetDataRef: ...
@dll.bind
...
@dll.bind
def LLVMCopyStringRepOfTargetData(TD:LLVMTargetDataRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
...
LLVMTargetRef: TypeAlias = POINTER(struct_LLVMTarget)
@dll.bind
def LLVMGetFirstTarget() -> LLVMTargetRef: ...
@dll.bind
def LLVMGetNextTarget(T:LLVMTargetRef) -> LLVMTargetRef: ...
@dll.bind
def LLVMGetTargetFromName(Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMTargetRef: ...
@dll.bind
def LLVMGetTargetFromTriple(Triple:POINTER(Annotated[bytes, ctypes.c_char]), T:POINTER(LLVMTargetRef), ErrorMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMGetTargetName(T:LLVMTargetRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetTargetDescription(T:LLVMTargetRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
LLVMTargetMachineOptionsRef: TypeAlias = POINTER(struct_LLVMOpaqueTargetMachineOptions)
@dll.bind
...
@dll.bind
def LLVMTargetMachineOptionsSetCPU(Options:LLVMTargetMachineOptionsRef, CPU:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def LLVMTargetMachineOptionsSetFeatures(Options:LLVMTargetMachineOptionsRef, Features:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def LLVMTargetMachineOptionsSetABI(Options:LLVMTargetMachineOptionsRef, ABI:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
...
@dll.bind
def LLVMCreateTargetMachineWithOptions(T:LLVMTargetRef, Triple:POINTER(Annotated[bytes, ctypes.c_char]), Options:LLVMTargetMachineOptionsRef) -> LLVMTargetMachineRef: ...
@dll.bind
def LLVMCreateTargetMachine(T:LLVMTargetRef, Triple:POINTER(Annotated[bytes, ctypes.c_char]), CPU:POINTER(Annotated[bytes, ctypes.c_char]), Features:POINTER(Annotated[bytes, ctypes.c_char]), Level:LLVMCodeGenOptLevel, Reloc:LLVMRelocMode, CodeModel:LLVMCodeModel) -> LLVMTargetMachineRef: ...
@dll.bind
...
@dll.bind
def LLVMGetTargetMachineTriple(T:LLVMTargetMachineRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetTargetMachineCPU(T:LLVMTargetMachineRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetTargetMachineFeatureString(T:LLVMTargetMachineRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMTargetMachineEmitToFile(T:LLVMTargetMachineRef, M:LLVMModuleRef, Filename:POINTER(Annotated[bytes, ctypes.c_char]), codegen:LLVMCodeGenFileType, ErrorMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMTargetMachineEmitToMemoryBuffer(T:LLVMTargetMachineRef, M:LLVMModuleRef, codegen:LLVMCodeGenFileType, ErrorMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), OutMemBuf:POINTER(LLVMMemoryBufferRef)) -> LLVMBool: ...
@dll.bind
def LLVMGetDefaultTargetTriple() -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMNormalizeTargetTriple(triple:POINTER(Annotated[bytes, ctypes.c_char])) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetHostCPUName() -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetHostCPUFeatures() -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
LLVMGenericValueRef: TypeAlias = POINTER(struct_LLVMOpaqueGenericValue)
...
@record
class struct_LLVMMCJITCompilerOptions:
  SIZE = 24
...
@dll.bind
def LLVMCreateGenericValueOfPointer(P:POINTER(None)) -> LLVMGenericValueRef: ...
@dll.bind
...
@dll.bind
def LLVMGenericValueToPointer(GenVal:LLVMGenericValueRef) -> POINTER(None): ...
@dll.bind
...
@dll.bind
def LLVMCreateExecutionEngineForModule(OutEE:POINTER(LLVMExecutionEngineRef), M:LLVMModuleRef, OutError:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMCreateInterpreterForModule(OutInterp:POINTER(LLVMExecutionEngineRef), M:LLVMModuleRef, OutError:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMCreateJITCompilerForModule(OutJIT:POINTER(LLVMExecutionEngineRef), M:LLVMModuleRef, OptLevel:Annotated[int, ctypes.c_uint32], OutError:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMInitializeMCJITCompilerOptions(Options:POINTER(struct_LLVMMCJITCompilerOptions), SizeOfOptions:size_t) -> None: ...
@dll.bind
def LLVMCreateMCJITCompilerForModule(OutJIT:POINTER(LLVMExecutionEngineRef), M:LLVMModuleRef, Options:POINTER(struct_LLVMMCJITCompilerOptions), SizeOfOptions:size_t, OutError:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
...
@dll.bind
def LLVMRunFunctionAsMain(EE:LLVMExecutionEngineRef, F:LLVMValueRef, ArgC:Annotated[int, ctypes.c_uint32], ArgV:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), EnvP:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def LLVMRunFunction(EE:LLVMExecutionEngineRef, F:LLVMValueRef, NumArgs:Annotated[int, ctypes.c_uint32], Args:POINTER(LLVMGenericValueRef)) -> LLVMGenericValueRef: ...
@dll.bind
...
@dll.bind
def LLVMRemoveModule(EE:LLVMExecutionEngineRef, M:LLVMModuleRef, OutMod:POINTER(LLVMModuleRef), OutError:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
@dll.bind
def LLVMFindFunction(EE:LLVMExecutionEngineRef, Name:POINTER(Annotated[bytes, ctypes.c_char]), OutFn:POINTER(LLVMValueRef)) -> LLVMBool: ...
@dll.bind
def LLVMRecompileAndRelinkFunction(EE:LLVMExecutionEngineRef, Fn:LLVMValueRef) -> POINTER(None): ...
@dll.bind
...
@dll.bind
def LLVMAddGlobalMapping(EE:LLVMExecutionEngineRef, Global:LLVMValueRef, Addr:POINTER(None)) -> None: ...
@dll.bind
def LLVMGetPointerToGlobal(EE:LLVMExecutionEngineRef, Global:LLVMValueRef) -> POINTER(None): ...
@dll.bind
def LLVMGetGlobalValueAddress(EE:LLVMExecutionEngineRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> uint64_t: ...
@dll.bind
def LLVMGetFunctionAddress(EE:LLVMExecutionEngineRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> uint64_t: ...
@dll.bind
def LLVMExecutionEngineGetErrMsg(EE:LLVMExecutionEngineRef, OutError:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
LLVMMemoryManagerAllocateCodeSectionCallback: TypeAlias = CFUNCTYPE(POINTER(Annotated[int, ctypes.c_ubyte]), POINTER(None), Annotated[int, ctypes.c_uint64], Annotated[int, ctypes.c_uint32], Annotated[int, ctypes.c_uint32], POINTER(Annotated[bytes, ctypes.c_char]))
LLVMMemoryManagerAllocateDataSectionCallback: TypeAlias = CFUNCTYPE(POINTER(Annotated[int, ctypes.c_ubyte]), POINTER(None), Annotated[int, ctypes.c_uint64], Annotated[int, ctypes.c_uint32], Annotated[int, ctypes.c_uint32], POINTER(Annotated[bytes, ctypes.c_char]), Annotated[int, ctypes.c_int32])
LLVMMemoryManagerFinalizeMemoryCallback: TypeAlias = CFUNCTYPE(Annotated[int, ctypes.c_int32], POINTER(None), POINTER(POINTER(Annotated[bytes, ctypes.c_char])))
LLVMMemoryManagerDestroyCallback: TypeAlias = CFUNCTYPE(None, POINTER(None))
@dll.bind
def LLVMCreateSimpleMCJITMemoryManager(Opaque:POINTER(None), AllocateCodeSection:LLVMMemoryManagerAllocateCodeSectionCallback, AllocateDataSection:LLVMMemoryManagerAllocateDataSectionCallback, FinalizeMemory:LLVMMemoryManagerFinalizeMemoryCallback, Destroy:LLVMMemoryManagerDestroyCallback) -> LLVMMCJITMemoryManagerRef: ...
@dll.bind
...
LLVMJITEventListenerRef: TypeAlias = POINTER(struct_LLVMOpaqueJITEventListener)
@dll.bind
...
@dll.bind
def LLVMParseIRInContext(ContextRef:LLVMContextRef, MemBuf:LLVMMemoryBufferRef, OutM:POINTER(LLVMModuleRef), OutMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBool: ...
class struct_LLVMOrcOpaqueExecutionSession(ctypes.Structure): pass
LLVMOrcExecutionSessionRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueExecutionSession)
LLVMOrcErrorReporterFunction: TypeAlias = CFUNCTYPE(None, POINTER(None), POINTER(struct_LLVMOpaqueError))
@dll.bind
def LLVMOrcExecutionSessionSetErrorReporter(ES:LLVMOrcExecutionSessionRef, ReportError:LLVMOrcErrorReporterFunction, Ctx:POINTER(None)) -> None: ...
class struct_LLVMOrcOpaqueSymbolStringPool(ctypes.Structure): pass
LLVMOrcSymbolStringPoolRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueSymbolStringPool)
@dll.bind
...
LLVMOrcSymbolStringPoolEntryRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueSymbolStringPoolEntry)
@dll.bind
def LLVMOrcExecutionSessionIntern(ES:LLVMOrcExecutionSessionRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMOrcSymbolStringPoolEntryRef: ...
...
LLVMOrcJITDylibRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueJITDylib)
...
LLVMOrcCJITDylibSearchOrder: TypeAlias = POINTER(LLVMOrcCJITDylibSearchOrderElement)
@record
...
LLVMOrcCLookupSet: TypeAlias = POINTER(LLVMOrcCLookupSetElement)
@record
...
LLVMOrcExecutionSessionLookupHandleResultFunction: TypeAlias = CFUNCTYPE(None, POINTER(struct_LLVMOpaqueError), POINTER(LLVMOrcCSymbolMapPair), Annotated[int, ctypes.c_uint64], POINTER(None))
@dll.bind
def LLVMOrcExecutionSessionLookup(ES:LLVMOrcExecutionSessionRef, K:LLVMOrcLookupKind, SearchOrder:LLVMOrcCJITDylibSearchOrder, SearchOrderSize:size_t, Symbols:LLVMOrcCLookupSet, SymbolsSize:size_t, HandleResult:LLVMOrcExecutionSessionLookupHandleResultFunction, Ctx:POINTER(None)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMOrcSymbolStringPoolEntryStr(S:LLVMOrcSymbolStringPoolEntryRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
class struct_LLVMOrcOpaqueResourceTracker(ctypes.Structure): pass
LLVMOrcResourceTrackerRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueResourceTracker)
@dll.bind
...
LLVMOrcDefinitionGeneratorRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueDefinitionGenerator)
@dll.bind
...
LLVMOrcMaterializationUnitRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueMaterializationUnit)
@dll.bind
...
class LLVMOrcCSymbolFlagsMapPair:
  ...
  Name: Annotated[LLVMOrcSymbolStringPoolEntryRef, 0]
  Flags: Annotated[LLVMJITSymbolFlags, 8]
LLVMOrcCSymbolFlagsMapPairs: TypeAlias = POINTER(LLVMOrcCSymbolFlagsMapPair)
class struct_LLVMOrcOpaqueMaterializationResponsibility(ctypes.Structure): pass
LLVMOrcMaterializationUnitMaterializeFunction: TypeAlias = CFUNCTYPE(None, POINTER(None), POINTER(struct_LLVMOrcOpaqueMaterializationResponsibility))
LLVMOrcMaterializationUnitDiscardFunction: TypeAlias = CFUNCTYPE(None, POINTER(None), POINTER(struct_LLVMOrcOpaqueJITDylib), POINTER(struct_LLVMOrcOpaqueSymbolStringPoolEntry))
LLVMOrcMaterializationUnitDestroyFunction: TypeAlias = CFUNCTYPE(None, POINTER(None))
@dll.bind
def LLVMOrcCreateCustomMaterializationUnit(Name:POINTER(Annotated[bytes, ctypes.c_char]), Ctx:POINTER(None), Syms:LLVMOrcCSymbolFlagsMapPairs, NumSyms:size_t, InitSym:LLVMOrcSymbolStringPoolEntryRef, Materialize:LLVMOrcMaterializationUnitMaterializeFunction, Discard:LLVMOrcMaterializationUnitDiscardFunction, Destroy:LLVMOrcMaterializationUnitDestroyFunction) -> LLVMOrcMaterializationUnitRef: ...
LLVMOrcCSymbolMapPairs: TypeAlias = POINTER(LLVMOrcCSymbolMapPair)
@dll.bind
...
LLVMOrcLazyCallThroughManagerRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueLazyCallThroughManager)
class struct_LLVMOrcOpaqueIndirectStubsManager(ctypes.Structure): pass
LLVMOrcIndirectStubsManagerRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueIndirectStubsManager)
@record
...
class LLVMOrcCSymbolAliasMapEntry:
  ...
  Name: Annotated[LLVMOrcSymbolStringPoolEntryRef, 0]
  Flags: Annotated[LLVMJITSymbolFlags, 8]
LLVMOrcCSymbolAliasMapPairs: TypeAlias = POINTER(LLVMOrcCSymbolAliasMapPair)
@dll.bind
...
LLVMOrcMaterializationResponsibilityRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueMaterializationResponsibility)
@dll.bind
...
@dll.bind
def LLVMOrcMaterializationResponsibilityGetSymbols(MR:LLVMOrcMaterializationResponsibilityRef, NumPairs:POINTER(size_t)) -> LLVMOrcCSymbolFlagsMapPairs: ...
@dll.bind
...
@dll.bind
def LLVMOrcMaterializationResponsibilityGetRequestedSymbols(MR:LLVMOrcMaterializationResponsibilityRef, NumSymbols:POINTER(size_t)) -> POINTER(LLVMOrcSymbolStringPoolEntryRef): ...
@dll.bind
def LLVMOrcDisposeSymbols(Symbols:POINTER(LLVMOrcSymbolStringPoolEntryRef)) -> None: ...
@dll.bind
...
class LLVMOrcCSymbolsList:
  SIZE = 16
  Symbols: Annotated[POINTER(LLVMOrcSymbolStringPoolEntryRef), 0]
...
LLVMOrcCDependenceMapPairs: TypeAlias = POINTER(LLVMOrcCDependenceMapPair)
@dll.bind
def LLVMOrcMaterializationResponsibilityNotifyEmitted(MR:LLVMOrcMaterializationResponsibilityRef, SymbolDepGroups:POINTER(LLVMOrcCSymbolDependenceGroup), NumSymbolDepGroups:size_t) -> LLVMErrorRef: ...
@dll.bind
...
@dll.bind
def LLVMOrcMaterializationResponsibilityDelegate(MR:LLVMOrcMaterializationResponsibilityRef, Symbols:POINTER(LLVMOrcSymbolStringPoolEntryRef), NumSymbols:size_t, Result:POINTER(LLVMOrcMaterializationResponsibilityRef)) -> LLVMErrorRef: ...
@dll.bind
def LLVMOrcExecutionSessionCreateBareJITDylib(ES:LLVMOrcExecutionSessionRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMOrcJITDylibRef: ...
@dll.bind
def LLVMOrcExecutionSessionCreateJITDylib(ES:LLVMOrcExecutionSessionRef, Result:POINTER(LLVMOrcJITDylibRef), Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMErrorRef: ...
@dll.bind
def LLVMOrcExecutionSessionGetJITDylibByName(ES:LLVMOrcExecutionSessionRef, Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMOrcJITDylibRef: ...
@dll.bind
...
LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction: TypeAlias = CFUNCTYPE(POINTER(struct_LLVMOpaqueError), POINTER(struct_LLVMOrcOpaqueDefinitionGenerator), POINTER(None), POINTER(POINTER(struct_LLVMOrcOpaqueLookupState)), LLVMOrcLookupKind, POINTER(struct_LLVMOrcOpaqueJITDylib), LLVMOrcJITDylibLookupFlags, POINTER(LLVMOrcCLookupSetElement), Annotated[int, ctypes.c_uint64])
LLVMOrcDisposeCAPIDefinitionGeneratorFunction: TypeAlias = CFUNCTYPE(None, POINTER(None))
@dll.bind
def LLVMOrcCreateCustomCAPIDefinitionGenerator(F:LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction, Ctx:POINTER(None), Dispose:LLVMOrcDisposeCAPIDefinitionGeneratorFunction) -> LLVMOrcDefinitionGeneratorRef: ...
LLVMOrcLookupStateRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueLookupState)
@dll.bind
def LLVMOrcLookupStateContinueLookup(S:LLVMOrcLookupStateRef, Err:LLVMErrorRef) -> None: ...
LLVMOrcSymbolPredicate: TypeAlias = CFUNCTYPE(Annotated[int, ctypes.c_int32], POINTER(None), POINTER(struct_LLVMOrcOpaqueSymbolStringPoolEntry))
@dll.bind
def LLVMOrcCreateDynamicLibrarySearchGeneratorForProcess(Result:POINTER(LLVMOrcDefinitionGeneratorRef), GlobalPrefx:Annotated[bytes, ctypes.c_char], Filter:LLVMOrcSymbolPredicate, FilterCtx:POINTER(None)) -> LLVMErrorRef: ...
@dll.bind
def LLVMOrcCreateDynamicLibrarySearchGeneratorForPath(Result:POINTER(LLVMOrcDefinitionGeneratorRef), FileName:POINTER(Annotated[bytes, ctypes.c_char]), GlobalPrefix:Annotated[bytes, ctypes.c_char], Filter:LLVMOrcSymbolPredicate, FilterCtx:POINTER(None)) -> LLVMErrorRef: ...
class struct_LLVMOrcOpaqueObjectLayer(ctypes.Structure): pass
LLVMOrcObjectLayerRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueObjectLayer)
@dll.bind
def LLVMOrcCreateStaticLibrarySearchGeneratorForPath(Result:POINTER(LLVMOrcDefinitionGeneratorRef), ObjLayer:LLVMOrcObjectLayerRef, FileName:POINTER(Annotated[bytes, ctypes.c_char]), TargetTriple:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMErrorRef: ...
class struct_LLVMOrcOpaqueThreadSafeContext(ctypes.Structure): pass
LLVMOrcThreadSafeContextRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueThreadSafeContext)
@dll.bind
...
LLVMOrcThreadSafeModuleRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueThreadSafeModule)
@dll.bind
...
LLVMOrcGenericIRModuleOperationFunction: TypeAlias = CFUNCTYPE(POINTER(struct_LLVMOpaqueError), POINTER(None), POINTER(struct_LLVMOpaqueModule))
@dll.bind
def LLVMOrcThreadSafeModuleWithModuleDo(TSM:LLVMOrcThreadSafeModuleRef, F:LLVMOrcGenericIRModuleOperationFunction, Ctx:POINTER(None)) -> LLVMErrorRef: ...
class struct_LLVMOrcOpaqueJITTargetMachineBuilder(ctypes.Structure): pass
LLVMOrcJITTargetMachineBuilderRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueJITTargetMachineBuilder)
@dll.bind
def LLVMOrcJITTargetMachineBuilderDetectHost(Result:POINTER(LLVMOrcJITTargetMachineBuilderRef)) -> LLVMErrorRef: ...
@dll.bind
...
@dll.bind
def LLVMOrcJITTargetMachineBuilderGetTargetTriple(JTMB:LLVMOrcJITTargetMachineBuilderRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMOrcJITTargetMachineBuilderSetTargetTriple(JTMB:LLVMOrcJITTargetMachineBuilderRef, TargetTriple:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
...
LLVMOrcIRTransformLayerRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueIRTransformLayer)
@dll.bind
...
LLVMOrcIRTransformLayerTransformFunction: TypeAlias = CFUNCTYPE(POINTER(struct_LLVMOpaqueError), POINTER(None), POINTER(POINTER(struct_LLVMOrcOpaqueThreadSafeModule)), POINTER(struct_LLVMOrcOpaqueMaterializationResponsibility))
@dll.bind
def LLVMOrcIRTransformLayerSetTransform(IRTransformLayer:LLVMOrcIRTransformLayerRef, TransformFunction:LLVMOrcIRTransformLayerTransformFunction, Ctx:POINTER(None)) -> None: ...
class struct_LLVMOrcOpaqueObjectTransformLayer(ctypes.Structure): pass
LLVMOrcObjectTransformLayerRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueObjectTransformLayer)
LLVMOrcObjectTransformLayerTransformFunction: TypeAlias = CFUNCTYPE(POINTER(struct_LLVMOpaqueError), POINTER(None), POINTER(POINTER(struct_LLVMOpaqueMemoryBuffer)))
@dll.bind
def LLVMOrcObjectTransformLayerSetTransform(ObjTransformLayer:LLVMOrcObjectTransformLayerRef, TransformFunction:LLVMOrcObjectTransformLayerTransformFunction, Ctx:POINTER(None)) -> None: ...
@dll.bind
def LLVMOrcCreateLocalIndirectStubsManager(TargetTriple:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMOrcIndirectStubsManagerRef: ...
@dll.bind
...
@dll.bind
def LLVMOrcCreateLocalLazyCallThroughManager(TargetTriple:POINTER(Annotated[bytes, ctypes.c_char]), ES:LLVMOrcExecutionSessionRef, ErrorHandlerAddr:LLVMOrcJITTargetAddress, LCTM:POINTER(LLVMOrcLazyCallThroughManagerRef)) -> LLVMErrorRef: ...
@dll.bind
...
LLVMOrcDumpObjectsRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueDumpObjects)
@dll.bind
def LLVMOrcCreateDumpObjects(DumpDir:POINTER(Annotated[bytes, ctypes.c_char]), IdentifierOverride:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMOrcDumpObjectsRef: ...
@dll.bind
def LLVMOrcDisposeDumpObjects(DumpObjects:LLVMOrcDumpObjectsRef) -> None: ...
@dll.bind
def LLVMOrcDumpObjects_CallOperator(DumpObjects:LLVMOrcDumpObjectsRef, ObjBuffer:POINTER(LLVMMemoryBufferRef)) -> LLVMErrorRef: ...
LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction: TypeAlias = CFUNCTYPE(POINTER(struct_LLVMOrcOpaqueObjectLayer), POINTER(None), POINTER(struct_LLVMOrcOpaqueExecutionSession), POINTER(Annotated[bytes, ctypes.c_char]))
class struct_LLVMOrcOpaqueLLJITBuilder(ctypes.Structure): pass
LLVMOrcLLJITBuilderRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueLLJITBuilder)
class struct_LLVMOrcOpaqueLLJIT(ctypes.Structure): pass
LLVMOrcLLJITRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueLLJIT)
@dll.bind
...
@dll.bind
def LLVMOrcLLJITBuilderSetObjectLinkingLayerCreator(Builder:LLVMOrcLLJITBuilderRef, F:LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction, Ctx:POINTER(None)) -> None: ...
@dll.bind
def LLVMOrcCreateLLJIT(Result:POINTER(LLVMOrcLLJITRef), Builder:LLVMOrcLLJITBuilderRef) -> LLVMErrorRef: ...
@dll.bind
...
@dll.bind
def LLVMOrcLLJITGetTripleString(J:LLVMOrcLLJITRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMOrcLLJITGetGlobalPrefix(J:LLVMOrcLLJITRef) -> Annotated[bytes, ctypes.c_char]: ...
@dll.bind
def LLVMOrcLLJITMangleAndIntern(J:LLVMOrcLLJITRef, UnmangledName:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMOrcSymbolStringPoolEntryRef: ...
@dll.bind
...
@dll.bind
def LLVMOrcLLJITLookup(J:LLVMOrcLLJITRef, Result:POINTER(LLVMOrcExecutorAddress), Name:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMErrorRef: ...
@dll.bind
...
@dll.bind
def LLVMOrcLLJITGetDataLayoutStr(J:LLVMOrcLLJITRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
LLVMSectionIteratorRef: TypeAlias = POINTER(struct_LLVMOpaqueSectionIterator)
class struct_LLVMOpaqueSymbolIterator(ctypes.Structure): pass
LLVMSymbolIteratorRef: TypeAlias = POINTER(struct_LLVMOpaqueSymbolIterator)
class struct_LLVMOpaqueRelocationIterator(ctypes.Structure): pass
LLVMRelocationIteratorRef: TypeAlias = POINTER(struct_LLVMOpaqueRelocationIterator)
...
LLVMBinaryRef: TypeAlias = POINTER(struct_LLVMOpaqueBinary)
@dll.bind
def LLVMCreateBinary(MemBuf:LLVMMemoryBufferRef, Context:LLVMContextRef, ErrorMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBinaryRef: ...
@dll.bind
...
@dll.bind
def LLVMMachOUniversalBinaryCopyObjectForArch(BR:LLVMBinaryRef, Arch:POINTER(Annotated[bytes, ctypes.c_char]), ArchLen:size_t, ErrorMessage:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> LLVMBinaryRef: ...
@dll.bind
...
@dll.bind
def LLVMGetSectionName(SI:LLVMSectionIteratorRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetSectionSize(SI:LLVMSectionIteratorRef) -> uint64_t: ...
@dll.bind
def LLVMGetSectionContents(SI:LLVMSectionIteratorRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetSymbolName(SI:LLVMSymbolIteratorRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def LLVMGetRelocationTypeName(RI:LLVMRelocationIteratorRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMGetRelocationValueString(RI:LLVMRelocationIteratorRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
class struct_LLVMOpaqueObjectFile(ctypes.Structure): pass
LLVMObjectFileRef: TypeAlias = POINTER(struct_LLVMOpaqueObjectFile)
@dll.bind
...
LLVMOrcObjectLinkingLayerRef: TypeAlias = POINTER(struct_LLVMOrcOpaqueObjectLinkingLayer)
LLVMMemoryManagerCreateContextCallback: TypeAlias = CFUNCTYPE(POINTER(None), POINTER(None))
LLVMMemoryManagerNotifyTerminatingCallback: TypeAlias = CFUNCTYPE(None, POINTER(None))
@dll.bind
def LLVMOrcCreateRTDyldObjectLinkingLayerWithSectionMemoryManager(ES:LLVMOrcExecutionSessionRef) -> LLVMOrcObjectLayerRef: ...
@dll.bind
def LLVMOrcCreateRTDyldObjectLinkingLayerWithMCJITMemoryManagerLikeCallbacks(ES:LLVMOrcExecutionSessionRef, CreateContextCtx:POINTER(None), CreateContext:LLVMMemoryManagerCreateContextCallback, NotifyTerminating:LLVMMemoryManagerNotifyTerminatingCallback, AllocateCodeSection:LLVMMemoryManagerAllocateCodeSectionCallback, AllocateDataSection:LLVMMemoryManagerAllocateDataSectionCallback, FinalizeMemory:LLVMMemoryManagerFinalizeMemoryCallback, Destroy:LLVMMemoryManagerDestroyCallback) -> LLVMOrcObjectLayerRef: ...
@dll.bind
...
LLVMRemarkStringRef: TypeAlias = POINTER(struct_LLVMRemarkOpaqueString)
@dll.bind
def LLVMRemarkStringGetData(String:LLVMRemarkStringRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
LLVMRemarkDebugLocRef: TypeAlias = POINTER(struct_LLVMRemarkOpaqueDebugLoc)
@dll.bind
...
LLVMRemarkArgRef: TypeAlias = POINTER(struct_LLVMRemarkOpaqueArg)
@dll.bind
...
LLVMRemarkEntryRef: TypeAlias = POINTER(struct_LLVMRemarkOpaqueEntry)
@dll.bind
...
LLVMRemarkParserRef: TypeAlias = POINTER(struct_LLVMRemarkOpaqueParser)
@dll.bind
def LLVMRemarkParserCreateYAML(Buf:POINTER(None), Size:uint64_t) -> LLVMRemarkParserRef: ...
@dll.bind
def LLVMRemarkParserCreateBitstream(Buf:POINTER(None), Size:uint64_t) -> LLVMRemarkParserRef: ...
@dll.bind
...
@dll.bind
def LLVMRemarkParserGetErrorMessage(Parser:LLVMRemarkParserRef) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def LLVMRemarkParserDispose(Parser:LLVMRemarkParserRef) -> None: ...
@dll.bind
def LLVMRemarkVersion() -> uint32_t: ...
@dll.bind
def LLVMLoadLibraryPermanently(Filename:POINTER(Annotated[bytes, ctypes.c_char])) -> LLVMBool: ...
@dll.bind
def LLVMParseCommandLineOptions(argc:Annotated[int, ctypes.c_int32], argv:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), Overview:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def LLVMSearchForAddressOfSymbol(symbolName:POINTER(Annotated[bytes, ctypes.c_char])) -> POINTER(None): ...
@dll.bind
def LLVMAddSymbol(symbolName:POINTER(Annotated[bytes, ctypes.c_char]), symbolValue:POINTER(None)) -> None: ...
class struct_LLVMOpaquePassBuilderOptions(ctypes.Structure): pass
LLVMPassBuilderOptionsRef: TypeAlias = POINTER(struct_LLVMOpaquePassBuilderOptions)
@dll.bind
def LLVMRunPasses(M:LLVMModuleRef, Passes:POINTER(Annotated[bytes, ctypes.c_char]), TM:LLVMTargetMachineRef, Options:LLVMPassBuilderOptionsRef) -> LLVMErrorRef: ...
@dll.bind
def LLVMRunPassesOnFunction(F:LLVMValueRef, Passes:POINTER(Annotated[bytes, ctypes.c_char]), TM:LLVMTargetMachineRef, Options:LLVMPassBuilderOptionsRef) -> LLVMErrorRef: ...
@dll.bind
...
@dll.bind
def LLVMPassBuilderOptionsSetAAPipeline(Options:LLVMPassBuilderOptionsRef, AAPipeline:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
...
@dll.bind
def llvm_blake3_version() -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def llvm_blake3_hasher_init(self:POINTER(llvm_blake3_hasher)) -> None: ...
@dll.bind
def llvm_blake3_hasher_init_keyed(self:POINTER(llvm_blake3_hasher), key:Array[uint8_t, Literal[32]]) -> None: ...
@dll.bind
def llvm_blake3_hasher_init_derive_key(self:POINTER(llvm_blake3_hasher), context:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def llvm_blake3_hasher_init_derive_key_raw(self:POINTER(llvm_blake3_hasher), context:POINTER(None), context_len:size_t) -> None: ...
@dll.bind
def llvm_blake3_hasher_update(self:POINTER(llvm_blake3_hasher), input:POINTER(None), input_len:size_t) -> None: ...
@dll.bind
def llvm_blake3_hasher_finalize(self:POINTER(llvm_blake3_hasher), out:POINTER(uint8_t), out_len:size_t) -> None: ...
@dll.bind
def llvm_blake3_hasher_finalize_seek(self:POINTER(llvm_blake3_hasher), seek:uint64_t, out:POINTER(uint8_t), out_len:size_t) -> None: ...
@dll.bind
def llvm_blake3_hasher_reset(self:POINTER(llvm_blake3_hasher)) -> None: ...
...
lto_module_t: TypeAlias = POINTER(struct_LLVMOpaqueLTOModule)
class struct_LLVMOpaqueLTOCodeGenerator(ctypes.Structure): pass
lto_code_gen_t: TypeAlias = POINTER(struct_LLVMOpaqueLTOCodeGenerator)
class struct_LLVMOpaqueThinLTOCodeGenerator(ctypes.Structure): pass
thinlto_code_gen_t: TypeAlias = POINTER(struct_LLVMOpaqueThinLTOCodeGenerator)
@dll.bind
def lto_get_version() -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def lto_get_error_message() -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def lto_module_is_object_file(path:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_bool_t: ...
@dll.bind
def lto_module_is_object_file_for_target(path:POINTER(Annotated[bytes, ctypes.c_char]), target_triple_prefix:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_bool_t: ...
@dll.bind
def lto_module_has_objc_category(mem:POINTER(None), length:size_t) -> lto_bool_t: ...
@dll.bind
def lto_module_is_object_file_in_memory(mem:POINTER(None), length:size_t) -> lto_bool_t: ...
@dll.bind
def lto_module_is_object_file_in_memory_for_target(mem:POINTER(None), length:size_t, target_triple_prefix:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_bool_t: ...
@dll.bind
def lto_module_create(path:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_module_t: ...
@dll.bind
def lto_module_create_from_memory(mem:POINTER(None), length:size_t) -> lto_module_t: ...
@dll.bind
def lto_module_create_from_memory_with_path(mem:POINTER(None), length:size_t, path:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_module_t: ...
@dll.bind
def lto_module_create_in_local_context(mem:POINTER(None), length:size_t, path:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_module_t: ...
@dll.bind
def lto_module_create_in_codegen_context(mem:POINTER(None), length:size_t, path:POINTER(Annotated[bytes, ctypes.c_char]), cg:lto_code_gen_t) -> lto_module_t: ...
@dll.bind
def lto_module_create_from_fd(fd:Annotated[int, ctypes.c_int32], path:POINTER(Annotated[bytes, ctypes.c_char]), file_size:size_t) -> lto_module_t: ...
off_t: TypeAlias = Annotated[int, ctypes.c_int64]
@dll.bind
def lto_module_create_from_fd_at_offset(fd:Annotated[int, ctypes.c_int32], path:POINTER(Annotated[bytes, ctypes.c_char]), file_size:size_t, map_size:size_t, offset:off_t) -> lto_module_t: ...
@dll.bind
def lto_module_dispose(mod:lto_module_t) -> None: ...
@dll.bind
def lto_module_get_target_triple(mod:lto_module_t) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def lto_module_set_target_triple(mod:lto_module_t, triple:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def lto_module_get_num_symbols(mod:lto_module_t) -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def lto_module_get_symbol_name(mod:lto_module_t, index:Annotated[int, ctypes.c_uint32]) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def lto_module_get_symbol_attribute(mod:lto_module_t, index:Annotated[int, ctypes.c_uint32]) -> lto_symbol_attributes: ...
@dll.bind
def lto_module_get_linkeropts(mod:lto_module_t) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def lto_module_get_macho_cputype(mod:lto_module_t, out_cputype:POINTER(Annotated[int, ctypes.c_uint32]), out_cpusubtype:POINTER(Annotated[int, ctypes.c_uint32])) -> lto_bool_t: ...
@dll.bind
...
lto_diagnostic_handler_t: TypeAlias = CFUNCTYPE(None, lto_codegen_diagnostic_severity_t, POINTER(Annotated[bytes, ctypes.c_char]), POINTER(None))
@dll.bind
def lto_codegen_set_diagnostic_handler(_0:lto_code_gen_t, _1:lto_diagnostic_handler_t, _2:POINTER(None)) -> None: ...
@dll.bind
...
@dll.bind
def lto_codegen_set_cpu(cg:lto_code_gen_t, cpu:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def lto_codegen_set_assembler_path(cg:lto_code_gen_t, path:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def lto_codegen_set_assembler_args(cg:lto_code_gen_t, args:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), nargs:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def lto_codegen_add_must_preserve_symbol(cg:lto_code_gen_t, symbol:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def lto_codegen_write_merged_modules(cg:lto_code_gen_t, path:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_bool_t: ...
@dll.bind
def lto_codegen_compile(cg:lto_code_gen_t, length:POINTER(size_t)) -> POINTER(None): ...
@dll.bind
def lto_codegen_compile_to_file(cg:lto_code_gen_t, name:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> lto_bool_t: ...
@dll.bind
def lto_codegen_optimize(cg:lto_code_gen_t) -> lto_bool_t: ...
@dll.bind
def lto_codegen_compile_optimized(cg:lto_code_gen_t, length:POINTER(size_t)) -> POINTER(None): ...
@dll.bind
def lto_api_version() -> Annotated[int, ctypes.c_uint32]: ...
@dll.bind
def lto_set_debug_options(options:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), number:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def lto_codegen_debug_options(cg:lto_code_gen_t, _1:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def lto_codegen_debug_options_array(cg:lto_code_gen_t, _1:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), number:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
...
lto_input_t: TypeAlias = POINTER(struct_LLVMOpaqueLTOInput)
@dll.bind
def lto_input_create(buffer:POINTER(None), buffer_size:size_t, path:POINTER(Annotated[bytes, ctypes.c_char])) -> lto_input_t: ...
@dll.bind
...
@dll.bind
def lto_input_get_dependent_library(input:lto_input_t, index:size_t, size:POINTER(size_t)) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def lto_runtime_lib_symbols_list(size:POINTER(size_t)) -> POINTER(POINTER(Annotated[bytes, ctypes.c_char])): ...
@record
class LTOObjectBuffer:
  SIZE = 16
  Buffer: Annotated[POINTER(Annotated[bytes, ctypes.c_char]), 0]
...
@dll.bind
def thinlto_codegen_add_module(cg:thinlto_code_gen_t, identifier:POINTER(Annotated[bytes, ctypes.c_char]), data:POINTER(Annotated[bytes, ctypes.c_char]), length:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
...
@dll.bind
def thinlto_module_get_object_file(cg:thinlto_code_gen_t, index:Annotated[int, ctypes.c_uint32]) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def thinlto_codegen_set_pic_model(cg:thinlto_code_gen_t, _1:lto_codegen_model) -> lto_bool_t: ...
@dll.bind
def thinlto_codegen_set_savetemps_dir(cg:thinlto_code_gen_t, save_temps_dir:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def thinlto_set_generated_objects_dir(cg:thinlto_code_gen_t, save_temps_dir:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
def thinlto_codegen_set_cpu(cg:thinlto_code_gen_t, cpu:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
...
@dll.bind
def thinlto_debug_options(options:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), number:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def lto_module_is_thinlto(mod:lto_module_t) -> lto_bool_t: ...
@dll.bind
def thinlto_codegen_add_must_preserve_symbol(cg:thinlto_code_gen_t, name:POINTER(Annotated[bytes, ctypes.c_char]), length:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def thinlto_codegen_add_cross_referenced_symbol(cg:thinlto_code_gen_t, name:POINTER(Annotated[bytes, ctypes.c_char]), length:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def thinlto_codegen_set_cache_dir(cg:thinlto_code_gen_t, cache_dir:POINTER(Annotated[bytes, ctypes.c_char])) -> None: ...
@dll.bind
