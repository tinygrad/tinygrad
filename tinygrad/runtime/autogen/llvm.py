...
try: (LLVMGetErrorMessage:=dll.LLVMGetErrorMessage).restype,LLVMGetErrorMessage.argtypes = ctypes.c_char_p,[LLVMErrorRef]
except AttributeError: pass

# void LLVMDisposeErrorMessage(char *ErrMsg)
try: (LLVMDisposeErrorMessage:=dll.LLVMDisposeErrorMessage).restype,LLVMDisposeErrorMessage.argtypes = None,[ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMCreateStringError:=dll.LLVMCreateStringError).restype,LLVMCreateStringError.argtypes = LLVMErrorRef,[ctypes.c_char_p]
except AttributeError: pass

enum_LLVMByteOrdering = CEnum(ctypes.c_uint)
...
struct_LLVMOpaqueTargetData._fields_ = []
...
struct_LLVMOpaqueTargetLibraryInfotData._fields_ = []
...
struct_LLVMOpaqueModule._fields_ = []
...
try: (LLVMCreateTargetData:=dll.LLVMCreateTargetData).restype,LLVMCreateTargetData.argtypes = LLVMTargetDataRef,[ctypes.c_char_p]
except AttributeError: pass
...
struct_LLVMOpaquePassManager._fields_ = []
...
try: (LLVMCopyStringRepOfTargetData:=dll.LLVMCopyStringRepOfTargetData).restype,LLVMCopyStringRepOfTargetData.argtypes = ctypes.c_char_p,[LLVMTargetDataRef]
except AttributeError: pass
...
try: (LLVMPointerSize:=dll.LLVMPointerSize).restype,LLVMPointerSize.argtypes = ctypes.c_uint,[LLVMTargetDataRef]
except AttributeError: pass

# unsigned int LLVMPointerSizeForAS(LLVMTargetDataRef TD, unsigned int AS)
try: (LLVMPointerSizeForAS:=dll.LLVMPointerSizeForAS).restype,LLVMPointerSizeForAS.argtypes = ctypes.c_uint,[LLVMTargetDataRef, ctypes.c_uint]
except AttributeError: pass

class struct_LLVMOpaqueType(ctypes.Structure): pass
struct_LLVMOpaqueType._fields_ = []
...
try: (LLVMIntPtrTypeForAS:=dll.LLVMIntPtrTypeForAS).restype,LLVMIntPtrTypeForAS.argtypes = LLVMTypeRef,[LLVMTargetDataRef, ctypes.c_uint]
except AttributeError: pass

class struct_LLVMOpaqueContext(ctypes.Structure): pass
struct_LLVMOpaqueContext._fields_ = []
...
try: (LLVMIntPtrTypeForASInContext:=dll.LLVMIntPtrTypeForASInContext).restype,LLVMIntPtrTypeForASInContext.argtypes = LLVMTypeRef,[LLVMContextRef, LLVMTargetDataRef, ctypes.c_uint]
except AttributeError: pass

# unsigned long long LLVMSizeOfTypeInBits(LLVMTargetDataRef TD, LLVMTypeRef Ty)
try: (LLVMSizeOfTypeInBits:=dll.LLVMSizeOfTypeInBits).restype,LLVMSizeOfTypeInBits.argtypes = ctypes.c_ulonglong,[LLVMTargetDataRef, LLVMTypeRef]
except AttributeError: pass

# unsigned long long LLVMStoreSizeOfType(LLVMTargetDataRef TD, LLVMTypeRef Ty)
try: (LLVMStoreSizeOfType:=dll.LLVMStoreSizeOfType).restype,LLVMStoreSizeOfType.argtypes = ctypes.c_ulonglong,[LLVMTargetDataRef, LLVMTypeRef]
except AttributeError: pass

# unsigned long long LLVMABISizeOfType(LLVMTargetDataRef TD, LLVMTypeRef Ty)
try: (LLVMABISizeOfType:=dll.LLVMABISizeOfType).restype,LLVMABISizeOfType.argtypes = ctypes.c_ulonglong,[LLVMTargetDataRef, LLVMTypeRef]
except AttributeError: pass

# unsigned int LLVMABIAlignmentOfType(LLVMTargetDataRef TD, LLVMTypeRef Ty)
try: (LLVMABIAlignmentOfType:=dll.LLVMABIAlignmentOfType).restype,LLVMABIAlignmentOfType.argtypes = ctypes.c_uint,[LLVMTargetDataRef, LLVMTypeRef]
except AttributeError: pass

# unsigned int LLVMCallFrameAlignmentOfType(LLVMTargetDataRef TD, LLVMTypeRef Ty)
try: (LLVMCallFrameAlignmentOfType:=dll.LLVMCallFrameAlignmentOfType).restype,LLVMCallFrameAlignmentOfType.argtypes = ctypes.c_uint,[LLVMTargetDataRef, LLVMTypeRef]
except AttributeError: pass

# unsigned int LLVMPreferredAlignmentOfType(LLVMTargetDataRef TD, LLVMTypeRef Ty)
try: (LLVMPreferredAlignmentOfType:=dll.LLVMPreferredAlignmentOfType).restype,LLVMPreferredAlignmentOfType.argtypes = ctypes.c_uint,[LLVMTargetDataRef, LLVMTypeRef]
except AttributeError: pass

class struct_LLVMOpaqueValue(ctypes.Structure): pass
struct_LLVMOpaqueValue._fields_ = []
...
try: (LLVMPreferredAlignmentOfGlobal:=dll.LLVMPreferredAlignmentOfGlobal).restype,LLVMPreferredAlignmentOfGlobal.argtypes = ctypes.c_uint,[LLVMTargetDataRef, LLVMValueRef]
except AttributeError: pass

# unsigned int LLVMElementAtOffset(LLVMTargetDataRef TD, LLVMTypeRef StructTy, unsigned long long Offset)
try: (LLVMElementAtOffset:=dll.LLVMElementAtOffset).restype,LLVMElementAtOffset.argtypes = ctypes.c_uint,[LLVMTargetDataRef, LLVMTypeRef, ctypes.c_ulonglong]
except AttributeError: pass

# unsigned long long LLVMOffsetOfElement(LLVMTargetDataRef TD, LLVMTypeRef StructTy, unsigned int Element)
try: (LLVMOffsetOfElement:=dll.LLVMOffsetOfElement).restype,LLVMOffsetOfElement.argtypes = ctypes.c_ulonglong,[LLVMTargetDataRef, LLVMTypeRef, ctypes.c_uint]
except AttributeError: pass

class struct_LLVMOrcOpaqueObjectLayer(ctypes.Structure): pass
struct_LLVMOrcOpaqueObjectLayer._fields_ = []
...
struct_LLVMOrcOpaqueExecutionSession._fields_ = []
...
struct_LLVMOpaqueJITEventListener._fields_ = []
...
LLVMOpInfoCallback = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.c_int, ctypes.c_void_p, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_int, ctypes.c_void_p))
class struct_LLVMOpInfoSymbol1(ctypes.Structure): pass
...
class struct_LLVMOpInfo1(ctypes.Structure): pass
...
LLVMSymbolLookupCallback = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.c_char_p, ctypes.c_void_p, ctypes.c_ulong, ctypes.POINTER(ctypes.c_ulong), ctypes.c_ulong, ctypes.POINTER(ctypes.c_char_p)))
LLVMBool = ctypes.c_int
# LLVMBool LLVMLoadLibraryPermanently(const char *Filename)
try: (LLVMLoadLibraryPermanently:=dll.LLVMLoadLibraryPermanently).restype,LLVMLoadLibraryPermanently.argtypes = LLVMBool,[ctypes.c_char_p]
except AttributeError: pass

# void LLVMParseCommandLineOptions(int argc, const char *const *argv, const char *Overview)
try: (LLVMParseCommandLineOptions:=dll.LLVMParseCommandLineOptions).restype,LLVMParseCommandLineOptions.argtypes = None,[ctypes.c_int, ctypes.POINTER(ctypes.c_char_p), ctypes.c_char_p]
except AttributeError: pass

# void *LLVMSearchForAddressOfSymbol(const char *symbolName)
try: (LLVMSearchForAddressOfSymbol:=dll.LLVMSearchForAddressOfSymbol).restype,LLVMSearchForAddressOfSymbol.argtypes = ctypes.c_void_p,[ctypes.c_char_p]
except AttributeError: pass

# void LLVMAddSymbol(const char *symbolName, void *symbolValue)
try: (LLVMAddSymbol:=dll.LLVMAddSymbol).restype,LLVMAddSymbol.argtypes = None,[ctypes.c_char_p, ctypes.c_void_p]
except AttributeError: pass

LLVMDIFlags = CEnum(ctypes.c_uint)
...
LLVMDWARFSourceLanguage = CEnum(ctypes.c_uint)
...
LLVMDWARFSourceLanguageMips_Assembler = LLVMDWARFSourceLanguage.define('LLVMDWARFSourceLanguageMips_Assembler', 37)
LLVMDWARFSourceLanguageGOOGLE_RenderScript = LLVMDWARFSourceLanguage.define('LLVMDWARFSourceLanguageGOOGLE_RenderScript', 38)
LLVMDWARFSourceLanguageBORLAND_Delphi = LLVMDWARFSourceLanguage.define('LLVMDWARFSourceLanguageBORLAND_Delphi', 39)

LLVMDWARFEmissionKind = CEnum(ctypes.c_uint)
...
LLVMMDStringMetadataKind = _anonenum0.define('LLVMMDStringMetadataKind', 0)
LLVMConstantAsMetadataMetadataKind = _anonenum0.define('LLVMConstantAsMetadataMetadataKind', 1)
LLVMLocalAsMetadataMetadataKind = _anonenum0.define('LLVMLocalAsMetadataMetadataKind', 2)
LLVMDistinctMDOperandPlaceholderMetadataKind = _anonenum0.define('LLVMDistinctMDOperandPlaceholderMetadataKind', 3)
LLVMMDTupleMetadataKind = _anonenum0.define('LLVMMDTupleMetadataKind', 4)
LLVMDILocationMetadataKind = _anonenum0.define('LLVMDILocationMetadataKind', 5)
LLVMDIExpressionMetadataKind = _anonenum0.define('LLVMDIExpressionMetadataKind', 6)
LLVMDIGlobalVariableExpressionMetadataKind = _anonenum0.define('LLVMDIGlobalVariableExpressionMetadataKind', 7)
LLVMGenericDINodeMetadataKind = _anonenum0.define('LLVMGenericDINodeMetadataKind', 8)
LLVMDISubrangeMetadataKind = _anonenum0.define('LLVMDISubrangeMetadataKind', 9)
LLVMDIEnumeratorMetadataKind = _anonenum0.define('LLVMDIEnumeratorMetadataKind', 10)
LLVMDIBasicTypeMetadataKind = _anonenum0.define('LLVMDIBasicTypeMetadataKind', 11)
LLVMDIDerivedTypeMetadataKind = _anonenum0.define('LLVMDIDerivedTypeMetadataKind', 12)
LLVMDICompositeTypeMetadataKind = _anonenum0.define('LLVMDICompositeTypeMetadataKind', 13)
LLVMDISubroutineTypeMetadataKind = _anonenum0.define('LLVMDISubroutineTypeMetadataKind', 14)
LLVMDIFileMetadataKind = _anonenum0.define('LLVMDIFileMetadataKind', 15)
LLVMDICompileUnitMetadataKind = _anonenum0.define('LLVMDICompileUnitMetadataKind', 16)
LLVMDISubprogramMetadataKind = _anonenum0.define('LLVMDISubprogramMetadataKind', 17)
LLVMDILexicalBlockMetadataKind = _anonenum0.define('LLVMDILexicalBlockMetadataKind', 18)
LLVMDILexicalBlockFileMetadataKind = _anonenum0.define('LLVMDILexicalBlockFileMetadataKind', 19)
LLVMDINamespaceMetadataKind = _anonenum0.define('LLVMDINamespaceMetadataKind', 20)
LLVMDIModuleMetadataKind = _anonenum0.define('LLVMDIModuleMetadataKind', 21)
LLVMDITemplateTypeParameterMetadataKind = _anonenum0.define('LLVMDITemplateTypeParameterMetadataKind', 22)
LLVMDITemplateValueParameterMetadataKind = _anonenum0.define('LLVMDITemplateValueParameterMetadataKind', 23)
LLVMDIGlobalVariableMetadataKind = _anonenum0.define('LLVMDIGlobalVariableMetadataKind', 24)
LLVMDILocalVariableMetadataKind = _anonenum0.define('LLVMDILocalVariableMetadataKind', 25)
LLVMDILabelMetadataKind = _anonenum0.define('LLVMDILabelMetadataKind', 26)
LLVMDIObjCPropertyMetadataKind = _anonenum0.define('LLVMDIObjCPropertyMetadataKind', 27)
LLVMDIImportedEntityMetadataKind = _anonenum0.define('LLVMDIImportedEntityMetadataKind', 28)
LLVMDIMacroMetadataKind = _anonenum0.define('LLVMDIMacroMetadataKind', 29)
LLVMDIMacroFileMetadataKind = _anonenum0.define('LLVMDIMacroFileMetadataKind', 30)
LLVMDICommonBlockMetadataKind = _anonenum0.define('LLVMDICommonBlockMetadataKind', 31)
LLVMDIStringTypeMetadataKind = _anonenum0.define('LLVMDIStringTypeMetadataKind', 32)
LLVMDIGenericSubrangeMetadataKind = _anonenum0.define('LLVMDIGenericSubrangeMetadataKind', 33)
LLVMDIArgListMetadataKind = _anonenum0.define('LLVMDIArgListMetadataKind', 34)

LLVMMetadataKind = ctypes.c_uint
LLVMDWARFTypeEncoding = ctypes.c_uint
LLVMDWARFMacinfoRecordType = CEnum(ctypes.c_uint)
...
try: (LLVMDebugMetadataVersion:=dll.LLVMDebugMetadataVersion).restype,LLVMDebugMetadataVersion.argtypes = ctypes.c_uint,[]
except AttributeError: pass

# unsigned int LLVMGetModuleDebugMetadataVersion(LLVMModuleRef Module)
try: (LLVMGetModuleDebugMetadataVersion:=dll.LLVMGetModuleDebugMetadataVersion).restype,LLVMGetModuleDebugMetadataVersion.argtypes = ctypes.c_uint,[LLVMModuleRef]
except AttributeError: pass
...
struct_LLVMOpaqueDIBuilder._fields_ = []
...
struct_LLVMOpaqueMetadata._fields_ = []
...
try: (LLVMDIBuilderCreateCompileUnit:=dll.LLVMDIBuilderCreateCompileUnit).restype,LLVMDIBuilderCreateCompileUnit.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMDWARFSourceLanguage, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMBool, ctypes.c_char_p, size_t, ctypes.c_uint, ctypes.c_char_p, size_t, LLVMDWARFEmissionKind, ctypes.c_uint, LLVMBool, LLVMBool, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateFile:=dll.LLVMDIBuilderCreateFile).restype,LLVMDIBuilderCreateFile.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateModule:=dll.LLVMDIBuilderCreateModule).restype,LLVMDIBuilderCreateModule.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateNameSpace:=dll.LLVMDIBuilderCreateNameSpace).restype,LLVMDIBuilderCreateNameSpace.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMBool]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateFunction:=dll.LLVMDIBuilderCreateFunction).restype,LLVMDIBuilderCreateFunction.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, LLVMMetadataRef, LLVMBool, LLVMBool, ctypes.c_uint, LLVMDIFlags, LLVMBool]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateLexicalBlock:=dll.LLVMDIBuilderCreateLexicalBlock).restype,LLVMDIBuilderCreateLexicalBlock.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateLexicalBlockFile:=dll.LLVMDIBuilderCreateLexicalBlockFile).restype,LLVMDIBuilderCreateLexicalBlockFile.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateImportedModuleFromNamespace:=dll.LLVMDIBuilderCreateImportedModuleFromNamespace).restype,LLVMDIBuilderCreateImportedModuleFromNamespace.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateImportedModuleFromAlias:=dll.LLVMDIBuilderCreateImportedModuleFromAlias).restype,LLVMDIBuilderCreateImportedModuleFromAlias.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint, ctypes.POINTER(LLVMMetadataRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateImportedModuleFromModule:=dll.LLVMDIBuilderCreateImportedModuleFromModule).restype,LLVMDIBuilderCreateImportedModuleFromModule.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint, ctypes.POINTER(LLVMMetadataRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateDebugLocation:=dll.LLVMDIBuilderCreateDebugLocation).restype,LLVMDIBuilderCreateDebugLocation.argtypes = LLVMMetadataRef,[LLVMContextRef, ctypes.c_uint, ctypes.c_uint, LLVMMetadataRef, LLVMMetadataRef]
except AttributeError: pass

# unsigned int LLVMDILocationGetLine(LLVMMetadataRef Location)
try: (LLVMDILocationGetLine:=dll.LLVMDILocationGetLine).restype,LLVMDILocationGetLine.argtypes = ctypes.c_uint,[LLVMMetadataRef]
except AttributeError: pass

# unsigned int LLVMDILocationGetColumn(LLVMMetadataRef Location)
try: (LLVMDILocationGetColumn:=dll.LLVMDILocationGetColumn).restype,LLVMDILocationGetColumn.argtypes = ctypes.c_uint,[LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIFileGetDirectory:=dll.LLVMDIFileGetDirectory).restype,LLVMDIFileGetDirectory.argtypes = ctypes.c_char_p,[LLVMMetadataRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass

# const char *LLVMDIFileGetFilename(LLVMMetadataRef File, unsigned int *Len)
try: (LLVMDIFileGetFilename:=dll.LLVMDIFileGetFilename).restype,LLVMDIFileGetFilename.argtypes = ctypes.c_char_p,[LLVMMetadataRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass

# const char *LLVMDIFileGetSource(LLVMMetadataRef File, unsigned int *Len)
try: (LLVMDIFileGetSource:=dll.LLVMDIFileGetSource).restype,LLVMDIFileGetSource.argtypes = ctypes.c_char_p,[LLVMMetadataRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateSubroutineType:=dll.LLVMDIBuilderCreateSubroutineType).restype,LLVMDIBuilderCreateSubroutineType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.POINTER(LLVMMetadataRef), ctypes.c_uint, LLVMDIFlags]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateMacro:=dll.LLVMDIBuilderCreateMacro).restype,LLVMDIBuilderCreateMacro.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_uint, LLVMDWARFMacinfoRecordType, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateTempMacroFile:=dll.LLVMDIBuilderCreateTempMacroFile).restype,LLVMDIBuilderCreateTempMacroFile.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_uint, LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateEnumerator:=dll.LLVMDIBuilderCreateEnumerator).restype,LLVMDIBuilderCreateEnumerator.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_char_p, size_t, int64_t, LLVMBool]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateArrayType:=dll.LLVMDIBuilderCreateArrayType).restype,LLVMDIBuilderCreateArrayType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, uint64_t, uint32_t, LLVMMetadataRef, ctypes.POINTER(LLVMMetadataRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateVectorType:=dll.LLVMDIBuilderCreateVectorType).restype,LLVMDIBuilderCreateVectorType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, uint64_t, uint32_t, LLVMMetadataRef, ctypes.POINTER(LLVMMetadataRef), ctypes.c_uint]
except AttributeError: pass

# LLVMMetadataRef LLVMDIBuilderCreateUnspecifiedType(LLVMDIBuilderRef Builder, const char *Name, size_t NameLen)
try: (LLVMDIBuilderCreateUnspecifiedType:=dll.LLVMDIBuilderCreateUnspecifiedType).restype,LLVMDIBuilderCreateUnspecifiedType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateBasicType:=dll.LLVMDIBuilderCreateBasicType).restype,LLVMDIBuilderCreateBasicType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_char_p, size_t, uint64_t, LLVMDWARFTypeEncoding, LLVMDIFlags]
except AttributeError: pass
...
try: (LLVMDIBuilderCreatePointerType:=dll.LLVMDIBuilderCreatePointerType).restype,LLVMDIBuilderCreatePointerType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, uint64_t, uint32_t, ctypes.c_uint, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateMemberType:=dll.LLVMDIBuilderCreateMemberType).restype,LLVMDIBuilderCreateMemberType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, uint64_t, uint32_t, uint64_t, LLVMDIFlags, LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateStaticMemberType:=dll.LLVMDIBuilderCreateStaticMemberType).restype,LLVMDIBuilderCreateStaticMemberType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, LLVMMetadataRef, LLVMDIFlags, LLVMValueRef, uint32_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateObjCIVar:=dll.LLVMDIBuilderCreateObjCIVar).restype,LLVMDIBuilderCreateObjCIVar.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, uint64_t, uint32_t, uint64_t, LLVMDIFlags, LLVMMetadataRef, LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateObjCProperty:=dll.LLVMDIBuilderCreateObjCProperty).restype,LLVMDIBuilderCreateObjCProperty.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t, ctypes.c_uint, LLVMMetadataRef]
except AttributeError: pass

# LLVMMetadataRef LLVMDIBuilderCreateObjectPointerType(LLVMDIBuilderRef Builder, LLVMMetadataRef Type)
try: (LLVMDIBuilderCreateObjectPointerType:=dll.LLVMDIBuilderCreateObjectPointerType).restype,LLVMDIBuilderCreateObjectPointerType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef]
except AttributeError: pass

# LLVMMetadataRef LLVMDIBuilderCreateQualifiedType(LLVMDIBuilderRef Builder, unsigned int Tag, LLVMMetadataRef Type)
try: (LLVMDIBuilderCreateQualifiedType:=dll.LLVMDIBuilderCreateQualifiedType).restype,LLVMDIBuilderCreateQualifiedType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_uint, LLVMMetadataRef]
except AttributeError: pass

# LLVMMetadataRef LLVMDIBuilderCreateReferenceType(LLVMDIBuilderRef Builder, unsigned int Tag, LLVMMetadataRef Type)
try: (LLVMDIBuilderCreateReferenceType:=dll.LLVMDIBuilderCreateReferenceType).restype,LLVMDIBuilderCreateReferenceType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_uint, LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateTypedef:=dll.LLVMDIBuilderCreateTypedef).restype,LLVMDIBuilderCreateTypedef.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, LLVMMetadataRef, uint32_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateForwardDecl:=dll.LLVMDIBuilderCreateForwardDecl).restype,LLVMDIBuilderCreateForwardDecl.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, ctypes.c_uint, ctypes.c_char_p, size_t, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint, ctypes.c_uint, uint64_t, uint32_t, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateBitFieldMemberType:=dll.LLVMDIBuilderCreateBitFieldMemberType).restype,LLVMDIBuilderCreateBitFieldMemberType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, uint64_t, uint64_t, uint64_t, LLVMDIFlags, LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateClassType:=dll.LLVMDIBuilderCreateClassType).restype,LLVMDIBuilderCreateClassType.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, uint64_t, uint32_t, uint64_t, LLVMDIFlags, LLVMMetadataRef, ctypes.POINTER(LLVMMetadataRef), ctypes.c_uint, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMDITypeGetName:=dll.LLVMDITypeGetName).restype,LLVMDITypeGetName.argtypes = ctypes.c_char_p,[LLVMMetadataRef, ctypes.POINTER(size_t)]
except AttributeError: pass
...
try: (LLVMDITypeGetLine:=dll.LLVMDITypeGetLine).restype,LLVMDITypeGetLine.argtypes = ctypes.c_uint,[LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIVariableGetLine:=dll.LLVMDIVariableGetLine).restype,LLVMDIVariableGetLine.argtypes = ctypes.c_uint,[LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIBuilderInsertDeclareBefore:=dll.LLVMDIBuilderInsertDeclareBefore).restype,LLVMDIBuilderInsertDeclareBefore.argtypes = LLVMValueRef,[LLVMDIBuilderRef, LLVMValueRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, LLVMValueRef]
except AttributeError: pass

class struct_LLVMOpaqueBasicBlock(ctypes.Structure): pass
struct_LLVMOpaqueBasicBlock._fields_ = []
...
try: (LLVMDIBuilderInsertDeclareAtEnd:=dll.LLVMDIBuilderInsertDeclareAtEnd).restype,LLVMDIBuilderInsertDeclareAtEnd.argtypes = LLVMValueRef,[LLVMDIBuilderRef, LLVMValueRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, LLVMBasicBlockRef]
except AttributeError: pass
...
try: (LLVMDIBuilderInsertDbgValueBefore:=dll.LLVMDIBuilderInsertDbgValueBefore).restype,LLVMDIBuilderInsertDbgValueBefore.argtypes = LLVMValueRef,[LLVMDIBuilderRef, LLVMValueRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMDIBuilderInsertDbgValueAtEnd:=dll.LLVMDIBuilderInsertDbgValueAtEnd).restype,LLVMDIBuilderInsertDbgValueAtEnd.argtypes = LLVMValueRef,[LLVMDIBuilderRef, LLVMValueRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, LLVMBasicBlockRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateAutoVariable:=dll.LLVMDIBuilderCreateAutoVariable).restype,LLVMDIBuilderCreateAutoVariable.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, LLVMMetadataRef, ctypes.c_uint, LLVMMetadataRef, LLVMBool, LLVMDIFlags, uint32_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateParameterVariable:=dll.LLVMDIBuilderCreateParameterVariable).restype,LLVMDIBuilderCreateParameterVariable.argtypes = LLVMMetadataRef,[LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_char_p, size_t, ctypes.c_uint, LLVMMetadataRef, ctypes.c_uint, LLVMMetadataRef, LLVMBool, LLVMDIFlags]
except AttributeError: pass
...
try: (LLVMDISubprogramGetLine:=dll.LLVMDISubprogramGetLine).restype,LLVMDISubprogramGetLine.argtypes = ctypes.c_uint,[LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMWriteBitcodeToFile:=dll.LLVMWriteBitcodeToFile).restype,LLVMWriteBitcodeToFile.argtypes = ctypes.c_int,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass

# int LLVMWriteBitcodeToFD(LLVMModuleRef M, int FD, int ShouldClose, int Unbuffered)
try: (LLVMWriteBitcodeToFD:=dll.LLVMWriteBitcodeToFD).restype,LLVMWriteBitcodeToFD.argtypes = ctypes.c_int,[LLVMModuleRef, ctypes.c_int, ctypes.c_int, ctypes.c_int]
except AttributeError: pass

# int LLVMWriteBitcodeToFileHandle(LLVMModuleRef M, int Handle)
try: (LLVMWriteBitcodeToFileHandle:=dll.LLVMWriteBitcodeToFileHandle).restype,LLVMWriteBitcodeToFileHandle.argtypes = ctypes.c_int,[LLVMModuleRef, ctypes.c_int]
except AttributeError: pass

class struct_LLVMOpaqueMemoryBuffer(ctypes.Structure): pass
struct_LLVMOpaqueMemoryBuffer._fields_ = []
...
try: (LLVMCreateDisasm:=dll.LLVMCreateDisasm).restype,LLVMCreateDisasm.argtypes = LLVMDisasmContextRef,[ctypes.c_char_p, ctypes.c_void_p, ctypes.c_int, LLVMOpInfoCallback, LLVMSymbolLookupCallback]
except AttributeError: pass
...
try: (LLVMCreateDisasmCPU:=dll.LLVMCreateDisasmCPU).restype,LLVMCreateDisasmCPU.argtypes = LLVMDisasmContextRef,[ctypes.c_char_p, ctypes.c_char_p, ctypes.c_void_p, ctypes.c_int, LLVMOpInfoCallback, LLVMSymbolLookupCallback]
except AttributeError: pass
...
try: (LLVMCreateDisasmCPUFeatures:=dll.LLVMCreateDisasmCPUFeatures).restype,LLVMCreateDisasmCPUFeatures.argtypes = LLVMDisasmContextRef,[ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_void_p, ctypes.c_int, LLVMOpInfoCallback, LLVMSymbolLookupCallback]
except AttributeError: pass

# int LLVMSetDisasmOptions(LLVMDisasmContextRef DC, uint64_t Options)
try: (LLVMSetDisasmOptions:=dll.LLVMSetDisasmOptions).restype,LLVMSetDisasmOptions.argtypes = ctypes.c_int,[LLVMDisasmContextRef, uint64_t]
except AttributeError: pass
...
try: (LLVMDisasmInstruction:=dll.LLVMDisasmInstruction).restype,LLVMDisasmInstruction.argtypes = size_t,[LLVMDisasmContextRef, ctypes.POINTER(uint8_t), uint64_t, uint64_t, ctypes.c_char_p, size_t]
except AttributeError: pass

# LLVMBool LLVMParseIRInContext(LLVMContextRef ContextRef, LLVMMemoryBufferRef MemBuf, LLVMModuleRef *OutM, char **OutMessage)
try: (LLVMParseIRInContext:=dll.LLVMParseIRInContext).restype,LLVMParseIRInContext.argtypes = LLVMBool,[LLVMContextRef, LLVMMemoryBufferRef, ctypes.POINTER(LLVMModuleRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
struct_LLVMOpaqueGenericValue._fields_ = []
...
struct_LLVMOpaqueExecutionEngine._fields_ = []
...
struct_LLVMOpaqueMCJITMemoryManager._fields_ = []
LLVMMCJITMemoryManagerRef = ctypes.POINTER(struct_LLVMOpaqueMCJITMemoryManager)
class struct_LLVMMCJITCompilerOptions(ctypes.Structure): pass
LLVMCodeModel = CEnum(ctypes.c_uint)
...
try: (LLVMCreateGenericValueOfInt:=dll.LLVMCreateGenericValueOfInt).restype,LLVMCreateGenericValueOfInt.argtypes = LLVMGenericValueRef,[LLVMTypeRef, ctypes.c_ulonglong, LLVMBool]
except AttributeError: pass
...
try: (LLVMGenericValueIntWidth:=dll.LLVMGenericValueIntWidth).restype,LLVMGenericValueIntWidth.argtypes = ctypes.c_uint,[LLVMGenericValueRef]
except AttributeError: pass

# unsigned long long LLVMGenericValueToInt(LLVMGenericValueRef GenVal, LLVMBool IsSigned)
try: (LLVMGenericValueToInt:=dll.LLVMGenericValueToInt).restype,LLVMGenericValueToInt.argtypes = ctypes.c_ulonglong,[LLVMGenericValueRef, LLVMBool]
except AttributeError: pass
...
try: (LLVMCreateExecutionEngineForModule:=dll.LLVMCreateExecutionEngineForModule).restype,LLVMCreateExecutionEngineForModule.argtypes = LLVMBool,[ctypes.POINTER(LLVMExecutionEngineRef), LLVMModuleRef, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

# LLVMBool LLVMCreateInterpreterForModule(LLVMExecutionEngineRef *OutInterp, LLVMModuleRef M, char **OutError)
try: (LLVMCreateInterpreterForModule:=dll.LLVMCreateInterpreterForModule).restype,LLVMCreateInterpreterForModule.argtypes = LLVMBool,[ctypes.POINTER(LLVMExecutionEngineRef), LLVMModuleRef, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMCreateJITCompilerForModule:=dll.LLVMCreateJITCompilerForModule).restype,LLVMCreateJITCompilerForModule.argtypes = LLVMBool,[ctypes.POINTER(LLVMExecutionEngineRef), LLVMModuleRef, ctypes.c_uint, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMCreateMCJITCompilerForModule:=dll.LLVMCreateMCJITCompilerForModule).restype,LLVMCreateMCJITCompilerForModule.argtypes = LLVMBool,[ctypes.POINTER(LLVMExecutionEngineRef), LLVMModuleRef, ctypes.POINTER(struct_LLVMMCJITCompilerOptions), size_t, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMRunFunctionAsMain:=dll.LLVMRunFunctionAsMain).restype,LLVMRunFunctionAsMain.argtypes = ctypes.c_int,[LLVMExecutionEngineRef, LLVMValueRef, ctypes.c_uint, ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMRunFunction:=dll.LLVMRunFunction).restype,LLVMRunFunction.argtypes = LLVMGenericValueRef,[LLVMExecutionEngineRef, LLVMValueRef, ctypes.c_uint, ctypes.POINTER(LLVMGenericValueRef)]
except AttributeError: pass
...
try: (LLVMRemoveModule:=dll.LLVMRemoveModule).restype,LLVMRemoveModule.argtypes = LLVMBool,[LLVMExecutionEngineRef, LLVMModuleRef, ctypes.POINTER(LLVMModuleRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

# LLVMBool LLVMFindFunction(LLVMExecutionEngineRef EE, const char *Name, LLVMValueRef *OutFn)
try: (LLVMFindFunction:=dll.LLVMFindFunction).restype,LLVMFindFunction.argtypes = LLVMBool,[LLVMExecutionEngineRef, ctypes.c_char_p, ctypes.POINTER(LLVMValueRef)]
except AttributeError: pass
...
struct_LLVMOpaqueTargetMachine._fields_ = []
...
try: (LLVMGetGlobalValueAddress:=dll.LLVMGetGlobalValueAddress).restype,LLVMGetGlobalValueAddress.argtypes = uint64_t,[LLVMExecutionEngineRef, ctypes.c_char_p]
except AttributeError: pass

# uint64_t LLVMGetFunctionAddress(LLVMExecutionEngineRef EE, const char *Name)
try: (LLVMGetFunctionAddress:=dll.LLVMGetFunctionAddress).restype,LLVMGetFunctionAddress.argtypes = uint64_t,[LLVMExecutionEngineRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMBool LLVMExecutionEngineGetErrMsg(LLVMExecutionEngineRef EE, char **OutError)
try: (LLVMExecutionEngineGetErrMsg:=dll.LLVMExecutionEngineGetErrMsg).restype,LLVMExecutionEngineGetErrMsg.argtypes = LLVMBool,[LLVMExecutionEngineRef, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

LLVMMemoryManagerAllocateCodeSectionCallback = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.c_char_p, ctypes.c_void_p, ctypes.c_ulong, ctypes.c_uint, ctypes.c_uint, ctypes.c_char_p))
LLVMMemoryManagerAllocateDataSectionCallback = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.c_char_p, ctypes.c_void_p, ctypes.c_ulong, ctypes.c_uint, ctypes.c_uint, ctypes.c_char_p, ctypes.c_int))
LLVMMemoryManagerFinalizeMemoryCallback = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.c_int, ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)))
LLVMMemoryManagerDestroyCallback = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_void_p))
...
LLVMFatalErrorHandler = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_char_p))
...
enum_LLVMRemarkType = CEnum(ctypes.c_uint)
...
struct_LLVMRemarkOpaqueString._fields_ = []
...
try: (LLVMRemarkStringGetData:=dll.LLVMRemarkStringGetData).restype,LLVMRemarkStringGetData.argtypes = ctypes.c_char_p,[LLVMRemarkStringRef]
except AttributeError: pass
...
struct_LLVMRemarkOpaqueDebugLoc._fields_ = []
...
struct_LLVMRemarkOpaqueArg._fields_ = []
...
struct_LLVMRemarkOpaqueEntry._fields_ = []
...
struct_LLVMRemarkOpaqueParser._fields_ = []
...
try: (LLVMRemarkParserGetErrorMessage:=dll.LLVMRemarkParserGetErrorMessage).restype,LLVMRemarkParserGetErrorMessage.argtypes = ctypes.c_char_p,[LLVMRemarkParserRef]
except AttributeError: pass
...
struct_LLVMTarget._fields_ = []
LLVMTargetRef = ctypes.POINTER(struct_LLVMTarget)
LLVMCodeGenOptLevel = CEnum(ctypes.c_uint)
...
LLVMRelocMode = CEnum(ctypes.c_uint)
...
LLVMCodeGenFileType = CEnum(ctypes.c_uint)
...
try: (LLVMGetTargetFromName:=dll.LLVMGetTargetFromName).restype,LLVMGetTargetFromName.argtypes = LLVMTargetRef,[ctypes.c_char_p]
except AttributeError: pass

# LLVMBool LLVMGetTargetFromTriple(const char *Triple, LLVMTargetRef *T, char **ErrorMessage)
try: (LLVMGetTargetFromTriple:=dll.LLVMGetTargetFromTriple).restype,LLVMGetTargetFromTriple.argtypes = LLVMBool,[ctypes.c_char_p, ctypes.POINTER(LLVMTargetRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

# const char *LLVMGetTargetName(LLVMTargetRef T)
try: (LLVMGetTargetName:=dll.LLVMGetTargetName).restype,LLVMGetTargetName.argtypes = ctypes.c_char_p,[LLVMTargetRef]
except AttributeError: pass

# const char *LLVMGetTargetDescription(LLVMTargetRef T)
try: (LLVMGetTargetDescription:=dll.LLVMGetTargetDescription).restype,LLVMGetTargetDescription.argtypes = ctypes.c_char_p,[LLVMTargetRef]
except AttributeError: pass
...
try: (LLVMCreateTargetMachine:=dll.LLVMCreateTargetMachine).restype,LLVMCreateTargetMachine.argtypes = LLVMTargetMachineRef,[LLVMTargetRef, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, LLVMCodeGenOptLevel, LLVMRelocMode, LLVMCodeModel]
except AttributeError: pass
...
try: (LLVMGetTargetMachineTriple:=dll.LLVMGetTargetMachineTriple).restype,LLVMGetTargetMachineTriple.argtypes = ctypes.c_char_p,[LLVMTargetMachineRef]
except AttributeError: pass

# char *LLVMGetTargetMachineCPU(LLVMTargetMachineRef T)
try: (LLVMGetTargetMachineCPU:=dll.LLVMGetTargetMachineCPU).restype,LLVMGetTargetMachineCPU.argtypes = ctypes.c_char_p,[LLVMTargetMachineRef]
except AttributeError: pass

# char *LLVMGetTargetMachineFeatureString(LLVMTargetMachineRef T)
try: (LLVMGetTargetMachineFeatureString:=dll.LLVMGetTargetMachineFeatureString).restype,LLVMGetTargetMachineFeatureString.argtypes = ctypes.c_char_p,[LLVMTargetMachineRef]
except AttributeError: pass
...
try: (LLVMTargetMachineEmitToFile:=dll.LLVMTargetMachineEmitToFile).restype,LLVMTargetMachineEmitToFile.argtypes = LLVMBool,[LLVMTargetMachineRef, LLVMModuleRef, ctypes.c_char_p, LLVMCodeGenFileType, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

# LLVMBool LLVMTargetMachineEmitToMemoryBuffer(LLVMTargetMachineRef T, LLVMModuleRef M, LLVMCodeGenFileType codegen, char **ErrorMessage, LLVMMemoryBufferRef *OutMemBuf)
try: (LLVMTargetMachineEmitToMemoryBuffer:=dll.LLVMTargetMachineEmitToMemoryBuffer).restype,LLVMTargetMachineEmitToMemoryBuffer.argtypes = LLVMBool,[LLVMTargetMachineRef, LLVMModuleRef, LLVMCodeGenFileType, ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(LLVMMemoryBufferRef)]
except AttributeError: pass

# char *LLVMGetDefaultTargetTriple(void)
try: (LLVMGetDefaultTargetTriple:=dll.LLVMGetDefaultTargetTriple).restype,LLVMGetDefaultTargetTriple.argtypes = ctypes.c_char_p,[]
except AttributeError: pass

# char *LLVMNormalizeTargetTriple(const char *triple)
try: (LLVMNormalizeTargetTriple:=dll.LLVMNormalizeTargetTriple).restype,LLVMNormalizeTargetTriple.argtypes = ctypes.c_char_p,[ctypes.c_char_p]
except AttributeError: pass

# char *LLVMGetHostCPUName(void)
try: (LLVMGetHostCPUName:=dll.LLVMGetHostCPUName).restype,LLVMGetHostCPUName.argtypes = ctypes.c_char_p,[]
except AttributeError: pass

# char *LLVMGetHostCPUFeatures(void)
try: (LLVMGetHostCPUFeatures:=dll.LLVMGetHostCPUFeatures).restype,LLVMGetHostCPUFeatures.argtypes = ctypes.c_char_p,[]
except AttributeError: pass
...
LLVMOrcJITTargetAddress = ctypes.c_ulong
LLVMOrcExecutorAddress = ctypes.c_ulong
LLVMJITSymbolGenericFlags = CEnum(ctypes.c_uint)
...
class LLVMJITSymbolFlags(ctypes.Structure): pass
LLVMJITSymbolFlags._fields_ = [
  ('GenericFlags', uint8_t),
  ('TargetFlags', uint8_t),
]
class LLVMJITEvaluatedSymbol(ctypes.Structure): pass
LLVMJITEvaluatedSymbol._fields_ = [
  ('Address', LLVMOrcExecutorAddress),
  ('Flags', LLVMJITSymbolFlags),
]
LLVMOrcErrorReporterFunction = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_void_p, ctypes.POINTER(struct_LLVMOpaqueError)))
class struct_LLVMOrcOpaqueSymbolStringPool(ctypes.Structure): pass
struct_LLVMOrcOpaqueSymbolStringPool._fields_ = []
...
struct_LLVMOrcOpaqueSymbolStringPoolEntry._fields_ = []
LLVMOrcSymbolStringPoolEntryRef = ctypes.POINTER(struct_LLVMOrcOpaqueSymbolStringPoolEntry)
class LLVMOrcCSymbolFlagsMapPair(ctypes.Structure): pass
...
class LLVMJITCSymbolMapPair(ctypes.Structure): pass
LLVMJITCSymbolMapPair._fields_ = [
  ('Name', LLVMOrcSymbolStringPoolEntryRef),
  ('Sym', LLVMJITEvaluatedSymbol),
]
LLVMOrcCSymbolMapPairs = ctypes.POINTER(LLVMJITCSymbolMapPair)
class LLVMOrcCSymbolAliasMapEntry(ctypes.Structure): pass
LLVMOrcCSymbolAliasMapEntry._fields_ = [
  ('Name', LLVMOrcSymbolStringPoolEntryRef),
  ('Flags', LLVMJITSymbolFlags),
]
class LLVMOrcCSymbolAliasMapPair(ctypes.Structure): pass
...
LLVMOrcLookupKind = CEnum(ctypes.c_uint)
...
LLVMOrcJITDylibLookupFlags = CEnum(ctypes.c_uint)
...
LLVMOrcSymbolLookupFlags = CEnum(ctypes.c_uint)
...
class LLVMOrcCLookupSetElement(ctypes.Structure): pass
...
struct_LLVMOrcOpaqueMaterializationUnit._fields_ = []
...
struct_LLVMOrcOpaqueMaterializationResponsibility._fields_ = []
LLVMOrcMaterializationResponsibilityRef = ctypes.POINTER(struct_LLVMOrcOpaqueMaterializationResponsibility)
LLVMOrcMaterializationUnitMaterializeFunction = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_void_p, ctypes.POINTER(struct_LLVMOrcOpaqueMaterializationResponsibility)))
LLVMOrcMaterializationUnitDiscardFunction = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_void_p, ctypes.POINTER(struct_LLVMOrcOpaqueJITDylib), ctypes.POINTER(struct_LLVMOrcOpaqueSymbolStringPoolEntry)))
LLVMOrcMaterializationUnitDestroyFunction = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_void_p))
class struct_LLVMOrcOpaqueResourceTracker(ctypes.Structure): pass
struct_LLVMOrcOpaqueResourceTracker._fields_ = []
...
struct_LLVMOrcOpaqueDefinitionGenerator._fields_ = []
...
struct_LLVMOrcOpaqueThreadSafeModule._fields_ = []
LLVMOrcThreadSafeModuleRef = ctypes.POINTER(struct_LLVMOrcOpaqueThreadSafeModule)
LLVMOrcGenericIRModuleOperationFunction = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(struct_LLVMOpaqueError), ctypes.c_void_p, ctypes.POINTER(struct_LLVMOpaqueModule)))
class struct_LLVMOrcOpaqueJITTargetMachineBuilder(ctypes.Structure): pass
struct_LLVMOrcOpaqueJITTargetMachineBuilder._fields_ = []
...
struct_LLVMOrcOpaqueObjectLinkingLayer._fields_ = []
...
struct_LLVMOrcOpaqueIRTransformLayer._fields_ = []
LLVMOrcIRTransformLayerRef = ctypes.POINTER(struct_LLVMOrcOpaqueIRTransformLayer)
LLVMOrcIRTransformLayerTransformFunction = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(struct_LLVMOpaqueError), ctypes.c_void_p, ctypes.POINTER(ctypes.POINTER(struct_LLVMOrcOpaqueThreadSafeModule)), ctypes.POINTER(struct_LLVMOrcOpaqueMaterializationResponsibility)))
class struct_LLVMOrcOpaqueObjectTransformLayer(ctypes.Structure): pass
struct_LLVMOrcOpaqueObjectTransformLayer._fields_ = []
LLVMOrcObjectTransformLayerRef = ctypes.POINTER(struct_LLVMOrcOpaqueObjectTransformLayer)
LLVMOrcObjectTransformLayerTransformFunction = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(struct_LLVMOpaqueError), ctypes.c_void_p, ctypes.POINTER(ctypes.POINTER(struct_LLVMOpaqueMemoryBuffer))))
class struct_LLVMOrcOpaqueIndirectStubsManager(ctypes.Structure): pass
struct_LLVMOrcOpaqueIndirectStubsManager._fields_ = []
...
struct_LLVMOrcOpaqueLazyCallThroughManager._fields_ = []
...
struct_LLVMOrcOpaqueDumpObjects._fields_ = []
...
try: (LLVMOrcExecutionSessionIntern:=dll.LLVMOrcExecutionSessionIntern).restype,LLVMOrcExecutionSessionIntern.argtypes = LLVMOrcSymbolStringPoolEntryRef,[LLVMOrcExecutionSessionRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcSymbolStringPoolEntryStr:=dll.LLVMOrcSymbolStringPoolEntryStr).restype,LLVMOrcSymbolStringPoolEntryStr.argtypes = ctypes.c_char_p,[LLVMOrcSymbolStringPoolEntryRef]
except AttributeError: pass
...
try: (LLVMOrcMaterializationResponsibilityNotifyEmitted:=dll.LLVMOrcMaterializationResponsibilityNotifyEmitted).restype,LLVMOrcMaterializationResponsibilityNotifyEmitted.argtypes = LLVMErrorRef,[LLVMOrcMaterializationResponsibilityRef]
except AttributeError: pass
...
try: (LLVMOrcMaterializationResponsibilityAddDependencies:=dll.LLVMOrcMaterializationResponsibilityAddDependencies).restype,LLVMOrcMaterializationResponsibilityAddDependencies.argtypes = None,[LLVMOrcMaterializationResponsibilityRef, LLVMOrcSymbolStringPoolEntryRef, LLVMOrcCDependenceMapPairs, size_t]
except AttributeError: pass
...
try: (LLVMOrcMaterializationResponsibilityAddDependenciesForAll:=dll.LLVMOrcMaterializationResponsibilityAddDependenciesForAll).restype,LLVMOrcMaterializationResponsibilityAddDependenciesForAll.argtypes = None,[LLVMOrcMaterializationResponsibilityRef, LLVMOrcCDependenceMapPairs, size_t]
except AttributeError: pass

# LLVMOrcJITDylibRef LLVMOrcExecutionSessionCreateBareJITDylib(LLVMOrcExecutionSessionRef ES, const char *Name)
try: (LLVMOrcExecutionSessionCreateBareJITDylib:=dll.LLVMOrcExecutionSessionCreateBareJITDylib).restype,LLVMOrcExecutionSessionCreateBareJITDylib.argtypes = LLVMOrcJITDylibRef,[LLVMOrcExecutionSessionRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcExecutionSessionCreateJITDylib:=dll.LLVMOrcExecutionSessionCreateJITDylib).restype,LLVMOrcExecutionSessionCreateJITDylib.argtypes = LLVMErrorRef,[LLVMOrcExecutionSessionRef, ctypes.POINTER(LLVMOrcJITDylibRef), ctypes.c_char_p]
except AttributeError: pass

# LLVMOrcJITDylibRef LLVMOrcExecutionSessionGetJITDylibByName(LLVMOrcExecutionSessionRef ES, const char *Name)
try: (LLVMOrcExecutionSessionGetJITDylibByName:=dll.LLVMOrcExecutionSessionGetJITDylibByName).restype,LLVMOrcExecutionSessionGetJITDylibByName.argtypes = LLVMOrcJITDylibRef,[LLVMOrcExecutionSessionRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcCreateCustomCAPIDefinitionGenerator:=dll.LLVMOrcCreateCustomCAPIDefinitionGenerator).restype,LLVMOrcCreateCustomCAPIDefinitionGenerator.argtypes = LLVMOrcDefinitionGeneratorRef,[LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction, ctypes.c_void_p]
except AttributeError: pass
...
try: (LLVMOrcCreateStaticLibrarySearchGeneratorForPath:=dll.LLVMOrcCreateStaticLibrarySearchGeneratorForPath).restype,LLVMOrcCreateStaticLibrarySearchGeneratorForPath.argtypes = LLVMErrorRef,[ctypes.POINTER(LLVMOrcDefinitionGeneratorRef), LLVMOrcObjectLayerRef, ctypes.c_char_p, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcJITTargetMachineBuilderGetTargetTriple:=dll.LLVMOrcJITTargetMachineBuilderGetTargetTriple).restype,LLVMOrcJITTargetMachineBuilderGetTargetTriple.argtypes = ctypes.c_char_p,[LLVMOrcJITTargetMachineBuilderRef]
except AttributeError: pass

# void LLVMOrcJITTargetMachineBuilderSetTargetTriple(LLVMOrcJITTargetMachineBuilderRef JTMB, const char *TargetTriple)
try: (LLVMOrcJITTargetMachineBuilderSetTargetTriple:=dll.LLVMOrcJITTargetMachineBuilderSetTargetTriple).restype,LLVMOrcJITTargetMachineBuilderSetTargetTriple.argtypes = None,[LLVMOrcJITTargetMachineBuilderRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcCreateLocalIndirectStubsManager:=dll.LLVMOrcCreateLocalIndirectStubsManager).restype,LLVMOrcCreateLocalIndirectStubsManager.argtypes = LLVMOrcIndirectStubsManagerRef,[ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcCreateLocalLazyCallThroughManager:=dll.LLVMOrcCreateLocalLazyCallThroughManager).restype,LLVMOrcCreateLocalLazyCallThroughManager.argtypes = LLVMErrorRef,[ctypes.c_char_p, LLVMOrcExecutionSessionRef, LLVMOrcJITTargetAddress, ctypes.POINTER(LLVMOrcLazyCallThroughManagerRef)]
except AttributeError: pass
...
try: (LLVMOrcCreateDumpObjects:=dll.LLVMOrcCreateDumpObjects).restype,LLVMOrcCreateDumpObjects.argtypes = LLVMOrcDumpObjectsRef,[ctypes.c_char_p, ctypes.c_char_p]
except AttributeError: pass
...
LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction = ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(struct_LLVMOrcOpaqueObjectLayer), ctypes.c_void_p, ctypes.POINTER(struct_LLVMOrcOpaqueExecutionSession), ctypes.c_char_p))
class struct_LLVMOrcOpaqueLLJITBuilder(ctypes.Structure): pass
struct_LLVMOrcOpaqueLLJITBuilder._fields_ = []
...
struct_LLVMOrcOpaqueLLJIT._fields_ = []
...
try: (LLVMOrcLLJITGetTripleString:=dll.LLVMOrcLLJITGetTripleString).restype,LLVMOrcLLJITGetTripleString.argtypes = ctypes.c_char_p,[LLVMOrcLLJITRef]
except AttributeError: pass
...
try: (LLVMOrcLLJITMangleAndIntern:=dll.LLVMOrcLLJITMangleAndIntern).restype,LLVMOrcLLJITMangleAndIntern.argtypes = LLVMOrcSymbolStringPoolEntryRef,[LLVMOrcLLJITRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcLLJITLookup:=dll.LLVMOrcLLJITLookup).restype,LLVMOrcLLJITLookup.argtypes = LLVMErrorRef,[LLVMOrcLLJITRef, ctypes.POINTER(LLVMOrcExecutorAddress), ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMOrcLLJITGetDataLayoutStr:=dll.LLVMOrcLLJITGetDataLayoutStr).restype,LLVMOrcLLJITGetDataLayoutStr.argtypes = ctypes.c_char_p,[LLVMOrcLLJITRef]
except AttributeError: pass

LLVMOpcode = CEnum(ctypes.c_uint)
...
LLVMX86_MMXTypeKind = LLVMTypeKind.define('LLVMX86_MMXTypeKind', 15)
...
LLVMLinkage = CEnum(ctypes.c_uint)
...
LLVMVisibility = CEnum(ctypes.c_uint)
...
LLVMUnnamedAddr = CEnum(ctypes.c_uint)
...
LLVMDLLStorageClass = CEnum(ctypes.c_uint)
...
LLVMCallConv = CEnum(ctypes.c_uint)
...
LLVMWebKitJSCallConv = LLVMCallConv.define('LLVMWebKitJSCallConv', 12)
...
LLVMValueKind = CEnum(ctypes.c_uint)
...
LLVMRealPredicate = CEnum(ctypes.c_uint)
...
LLVMLandingPadClauseTy = CEnum(ctypes.c_uint)
...
LLVMThreadLocalMode = CEnum(ctypes.c_uint)
...
LLVMAtomicOrdering = CEnum(ctypes.c_uint)
...
LLVMDiagnosticSeverity = CEnum(ctypes.c_uint)
...
LLVMInlineAsmDialect = CEnum(ctypes.c_uint)
...
LLVMModuleFlagBehavior = CEnum(ctypes.c_uint)
...
_anonenum1 = CEnum(ctypes.c_int)
LLVMAttributeReturnIndex = _anonenum1.define('LLVMAttributeReturnIndex', 0)
LLVMAttributeFunctionIndex = _anonenum1.define('LLVMAttributeFunctionIndex', -1)

LLVMAttributeIndex = ctypes.c_uint
class struct_LLVMOpaquePassRegistry(ctypes.Structure): pass
struct_LLVMOpaquePassRegistry._fields_ = []
LLVMPassRegistryRef = ctypes.POINTER(struct_LLVMOpaquePassRegistry)
# void LLVMInitializeCore(LLVMPassRegistryRef R)
try: (LLVMInitializeCore:=dll.LLVMInitializeCore).restype,LLVMInitializeCore.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass
...
try: (LLVMCreateMessage:=dll.LLVMCreateMessage).restype,LLVMCreateMessage.argtypes = ctypes.c_char_p,[ctypes.c_char_p]
except AttributeError: pass

# void LLVMDisposeMessage(char *Message)
try: (LLVMDisposeMessage:=dll.LLVMDisposeMessage).restype,LLVMDisposeMessage.argtypes = None,[ctypes.c_char_p]
except AttributeError: pass

class struct_LLVMOpaqueDiagnosticInfo(ctypes.Structure): pass
struct_LLVMOpaqueDiagnosticInfo._fields_ = []
LLVMDiagnosticHandler = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_LLVMOpaqueDiagnosticInfo), ctypes.c_void_p))
LLVMYieldCallback = ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_LLVMOpaqueContext), ctypes.c_void_p))
...
try: (LLVMGetDiagInfoDescription:=dll.LLVMGetDiagInfoDescription).restype,LLVMGetDiagInfoDescription.argtypes = ctypes.c_char_p,[LLVMDiagnosticInfoRef]
except AttributeError: pass
...
try: (LLVMGetMDKindIDInContext:=dll.LLVMGetMDKindIDInContext).restype,LLVMGetMDKindIDInContext.argtypes = ctypes.c_uint,[LLVMContextRef, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetMDKindID(const char *Name, unsigned int SLen)
try: (LLVMGetMDKindID:=dll.LLVMGetMDKindID).restype,LLVMGetMDKindID.argtypes = ctypes.c_uint,[ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetEnumAttributeKindForName(const char *Name, size_t SLen)
try: (LLVMGetEnumAttributeKindForName:=dll.LLVMGetEnumAttributeKindForName).restype,LLVMGetEnumAttributeKindForName.argtypes = ctypes.c_uint,[ctypes.c_char_p, size_t]
except AttributeError: pass

# unsigned int LLVMGetLastEnumAttributeKind(void)
try: (LLVMGetLastEnumAttributeKind:=dll.LLVMGetLastEnumAttributeKind).restype,LLVMGetLastEnumAttributeKind.argtypes = ctypes.c_uint,[]
except AttributeError: pass

class struct_LLVMOpaqueAttributeRef(ctypes.Structure): pass
struct_LLVMOpaqueAttributeRef._fields_ = []
...
try: (LLVMCreateEnumAttribute:=dll.LLVMCreateEnumAttribute).restype,LLVMCreateEnumAttribute.argtypes = LLVMAttributeRef,[LLVMContextRef, ctypes.c_uint, uint64_t]
except AttributeError: pass

# unsigned int LLVMGetEnumAttributeKind(LLVMAttributeRef A)
try: (LLVMGetEnumAttributeKind:=dll.LLVMGetEnumAttributeKind).restype,LLVMGetEnumAttributeKind.argtypes = ctypes.c_uint,[LLVMAttributeRef]
except AttributeError: pass
...
try: (LLVMCreateTypeAttribute:=dll.LLVMCreateTypeAttribute).restype,LLVMCreateTypeAttribute.argtypes = LLVMAttributeRef,[LLVMContextRef, ctypes.c_uint, LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMCreateStringAttribute:=dll.LLVMCreateStringAttribute).restype,LLVMCreateStringAttribute.argtypes = LLVMAttributeRef,[LLVMContextRef, ctypes.c_char_p, ctypes.c_uint, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# const char *LLVMGetStringAttributeKind(LLVMAttributeRef A, unsigned int *Length)
try: (LLVMGetStringAttributeKind:=dll.LLVMGetStringAttributeKind).restype,LLVMGetStringAttributeKind.argtypes = ctypes.c_char_p,[LLVMAttributeRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass

# const char *LLVMGetStringAttributeValue(LLVMAttributeRef A, unsigned int *Length)
try: (LLVMGetStringAttributeValue:=dll.LLVMGetStringAttributeValue).restype,LLVMGetStringAttributeValue.argtypes = ctypes.c_char_p,[LLVMAttributeRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass
...
try: (LLVMGetTypeByName2:=dll.LLVMGetTypeByName2).restype,LLVMGetTypeByName2.argtypes = LLVMTypeRef,[LLVMContextRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMModuleRef LLVMModuleCreateWithName(const char *ModuleID)
try: (LLVMModuleCreateWithName:=dll.LLVMModuleCreateWithName).restype,LLVMModuleCreateWithName.argtypes = LLVMModuleRef,[ctypes.c_char_p]
except AttributeError: pass

# LLVMModuleRef LLVMModuleCreateWithNameInContext(const char *ModuleID, LLVMContextRef C)
try: (LLVMModuleCreateWithNameInContext:=dll.LLVMModuleCreateWithNameInContext).restype,LLVMModuleCreateWithNameInContext.argtypes = LLVMModuleRef,[ctypes.c_char_p, LLVMContextRef]
except AttributeError: pass
...
try: (LLVMGetModuleIdentifier:=dll.LLVMGetModuleIdentifier).restype,LLVMGetModuleIdentifier.argtypes = ctypes.c_char_p,[LLVMModuleRef, ctypes.POINTER(size_t)]
except AttributeError: pass

# void LLVMSetModuleIdentifier(LLVMModuleRef M, const char *Ident, size_t Len)
try: (LLVMSetModuleIdentifier:=dll.LLVMSetModuleIdentifier).restype,LLVMSetModuleIdentifier.argtypes = None,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass

# const char *LLVMGetSourceFileName(LLVMModuleRef M, size_t *Len)
try: (LLVMGetSourceFileName:=dll.LLVMGetSourceFileName).restype,LLVMGetSourceFileName.argtypes = ctypes.c_char_p,[LLVMModuleRef, ctypes.POINTER(size_t)]
except AttributeError: pass

# void LLVMSetSourceFileName(LLVMModuleRef M, const char *Name, size_t Len)
try: (LLVMSetSourceFileName:=dll.LLVMSetSourceFileName).restype,LLVMSetSourceFileName.argtypes = None,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass

# const char *LLVMGetDataLayoutStr(LLVMModuleRef M)
try: (LLVMGetDataLayoutStr:=dll.LLVMGetDataLayoutStr).restype,LLVMGetDataLayoutStr.argtypes = ctypes.c_char_p,[LLVMModuleRef]
except AttributeError: pass

# const char *LLVMGetDataLayout(LLVMModuleRef M)
try: (LLVMGetDataLayout:=dll.LLVMGetDataLayout).restype,LLVMGetDataLayout.argtypes = ctypes.c_char_p,[LLVMModuleRef]
except AttributeError: pass

# void LLVMSetDataLayout(LLVMModuleRef M, const char *DataLayoutStr)
try: (LLVMSetDataLayout:=dll.LLVMSetDataLayout).restype,LLVMSetDataLayout.argtypes = None,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass

# const char *LLVMGetTarget(LLVMModuleRef M)
try: (LLVMGetTarget:=dll.LLVMGetTarget).restype,LLVMGetTarget.argtypes = ctypes.c_char_p,[LLVMModuleRef]
except AttributeError: pass

# void LLVMSetTarget(LLVMModuleRef M, const char *Triple)
try: (LLVMSetTarget:=dll.LLVMSetTarget).restype,LLVMSetTarget.argtypes = None,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass

class struct_LLVMOpaqueModuleFlagEntry(ctypes.Structure): pass
struct_LLVMOpaqueModuleFlagEntry._fields_ = []
...
try: (LLVMModuleFlagEntriesGetFlagBehavior:=dll.LLVMModuleFlagEntriesGetFlagBehavior).restype,LLVMModuleFlagEntriesGetFlagBehavior.argtypes = LLVMModuleFlagBehavior,[ctypes.POINTER(LLVMModuleFlagEntry), ctypes.c_uint]
except AttributeError: pass

# const char *LLVMModuleFlagEntriesGetKey(LLVMModuleFlagEntry *Entries, unsigned int Index, size_t *Len)
try: (LLVMModuleFlagEntriesGetKey:=dll.LLVMModuleFlagEntriesGetKey).restype,LLVMModuleFlagEntriesGetKey.argtypes = ctypes.c_char_p,[ctypes.POINTER(LLVMModuleFlagEntry), ctypes.c_uint, ctypes.POINTER(size_t)]
except AttributeError: pass

# LLVMMetadataRef LLVMModuleFlagEntriesGetMetadata(LLVMModuleFlagEntry *Entries, unsigned int Index)
try: (LLVMModuleFlagEntriesGetMetadata:=dll.LLVMModuleFlagEntriesGetMetadata).restype,LLVMModuleFlagEntriesGetMetadata.argtypes = LLVMMetadataRef,[ctypes.POINTER(LLVMModuleFlagEntry), ctypes.c_uint]
except AttributeError: pass

# LLVMMetadataRef LLVMGetModuleFlag(LLVMModuleRef M, const char *Key, size_t KeyLen)
try: (LLVMGetModuleFlag:=dll.LLVMGetModuleFlag).restype,LLVMGetModuleFlag.argtypes = LLVMMetadataRef,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass

# void LLVMAddModuleFlag(LLVMModuleRef M, LLVMModuleFlagBehavior Behavior, const char *Key, size_t KeyLen, LLVMMetadataRef Val)
try: (LLVMAddModuleFlag:=dll.LLVMAddModuleFlag).restype,LLVMAddModuleFlag.argtypes = None,[LLVMModuleRef, LLVMModuleFlagBehavior, ctypes.c_char_p, size_t, LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMPrintModuleToFile:=dll.LLVMPrintModuleToFile).restype,LLVMPrintModuleToFile.argtypes = LLVMBool,[LLVMModuleRef, ctypes.c_char_p, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

# char *LLVMPrintModuleToString(LLVMModuleRef M)
try: (LLVMPrintModuleToString:=dll.LLVMPrintModuleToString).restype,LLVMPrintModuleToString.argtypes = ctypes.c_char_p,[LLVMModuleRef]
except AttributeError: pass

# const char *LLVMGetModuleInlineAsm(LLVMModuleRef M, size_t *Len)
try: (LLVMGetModuleInlineAsm:=dll.LLVMGetModuleInlineAsm).restype,LLVMGetModuleInlineAsm.argtypes = ctypes.c_char_p,[LLVMModuleRef, ctypes.POINTER(size_t)]
except AttributeError: pass

# void LLVMSetModuleInlineAsm2(LLVMModuleRef M, const char *Asm, size_t Len)
try: (LLVMSetModuleInlineAsm2:=dll.LLVMSetModuleInlineAsm2).restype,LLVMSetModuleInlineAsm2.argtypes = None,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass

# void LLVMAppendModuleInlineAsm(LLVMModuleRef M, const char *Asm, size_t Len)
try: (LLVMAppendModuleInlineAsm:=dll.LLVMAppendModuleInlineAsm).restype,LLVMAppendModuleInlineAsm.argtypes = None,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMGetInlineAsm:=dll.LLVMGetInlineAsm).restype,LLVMGetInlineAsm.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_char_p, size_t, ctypes.c_char_p, size_t, LLVMBool, LLVMBool, LLVMInlineAsmDialect, LLVMBool]
except AttributeError: pass
...
try: (LLVMGetTypeByName:=dll.LLVMGetTypeByName).restype,LLVMGetTypeByName.argtypes = LLVMTypeRef,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass

class struct_LLVMOpaqueNamedMDNode(ctypes.Structure): pass
struct_LLVMOpaqueNamedMDNode._fields_ = []
...
try: (LLVMGetNamedMetadata:=dll.LLVMGetNamedMetadata).restype,LLVMGetNamedMetadata.argtypes = LLVMNamedMDNodeRef,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass

# LLVMNamedMDNodeRef LLVMGetOrInsertNamedMetadata(LLVMModuleRef M, const char *Name, size_t NameLen)
try: (LLVMGetOrInsertNamedMetadata:=dll.LLVMGetOrInsertNamedMetadata).restype,LLVMGetOrInsertNamedMetadata.argtypes = LLVMNamedMDNodeRef,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass

# const char *LLVMGetNamedMetadataName(LLVMNamedMDNodeRef NamedMD, size_t *NameLen)
try: (LLVMGetNamedMetadataName:=dll.LLVMGetNamedMetadataName).restype,LLVMGetNamedMetadataName.argtypes = ctypes.c_char_p,[LLVMNamedMDNodeRef, ctypes.POINTER(size_t)]
except AttributeError: pass

# unsigned int LLVMGetNamedMetadataNumOperands(LLVMModuleRef M, const char *Name)
try: (LLVMGetNamedMetadataNumOperands:=dll.LLVMGetNamedMetadataNumOperands).restype,LLVMGetNamedMetadataNumOperands.argtypes = ctypes.c_uint,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass

# void LLVMGetNamedMetadataOperands(LLVMModuleRef M, const char *Name, LLVMValueRef *Dest)
try: (LLVMGetNamedMetadataOperands:=dll.LLVMGetNamedMetadataOperands).restype,LLVMGetNamedMetadataOperands.argtypes = None,[LLVMModuleRef, ctypes.c_char_p, ctypes.POINTER(LLVMValueRef)]
except AttributeError: pass

# void LLVMAddNamedMetadataOperand(LLVMModuleRef M, const char *Name, LLVMValueRef Val)
try: (LLVMAddNamedMetadataOperand:=dll.LLVMAddNamedMetadataOperand).restype,LLVMAddNamedMetadataOperand.argtypes = None,[LLVMModuleRef, ctypes.c_char_p, LLVMValueRef]
except AttributeError: pass

# const char *LLVMGetDebugLocDirectory(LLVMValueRef Val, unsigned int *Length)
try: (LLVMGetDebugLocDirectory:=dll.LLVMGetDebugLocDirectory).restype,LLVMGetDebugLocDirectory.argtypes = ctypes.c_char_p,[LLVMValueRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass

# const char *LLVMGetDebugLocFilename(LLVMValueRef Val, unsigned int *Length)
try: (LLVMGetDebugLocFilename:=dll.LLVMGetDebugLocFilename).restype,LLVMGetDebugLocFilename.argtypes = ctypes.c_char_p,[LLVMValueRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass

# unsigned int LLVMGetDebugLocLine(LLVMValueRef Val)
try: (LLVMGetDebugLocLine:=dll.LLVMGetDebugLocLine).restype,LLVMGetDebugLocLine.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# unsigned int LLVMGetDebugLocColumn(LLVMValueRef Val)
try: (LLVMGetDebugLocColumn:=dll.LLVMGetDebugLocColumn).restype,LLVMGetDebugLocColumn.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMAddFunction(LLVMModuleRef M, const char *Name, LLVMTypeRef FunctionTy)
try: (LLVMAddFunction:=dll.LLVMAddFunction).restype,LLVMAddFunction.argtypes = LLVMValueRef,[LLVMModuleRef, ctypes.c_char_p, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMGetNamedFunction(LLVMModuleRef M, const char *Name)
try: (LLVMGetNamedFunction:=dll.LLVMGetNamedFunction).restype,LLVMGetNamedFunction.argtypes = LLVMValueRef,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMSetModuleInlineAsm:=dll.LLVMSetModuleInlineAsm).restype,LLVMSetModuleInlineAsm.argtypes = None,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMPrintTypeToString:=dll.LLVMPrintTypeToString).restype,LLVMPrintTypeToString.argtypes = ctypes.c_char_p,[LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMIntTypeInContext:=dll.LLVMIntTypeInContext).restype,LLVMIntTypeInContext.argtypes = LLVMTypeRef,[LLVMContextRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMIntType:=dll.LLVMIntType).restype,LLVMIntType.argtypes = LLVMTypeRef,[ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetIntTypeWidth(LLVMTypeRef IntegerTy)
try: (LLVMGetIntTypeWidth:=dll.LLVMGetIntTypeWidth).restype,LLVMGetIntTypeWidth.argtypes = ctypes.c_uint,[LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMFunctionType:=dll.LLVMFunctionType).restype,LLVMFunctionType.argtypes = LLVMTypeRef,[LLVMTypeRef, ctypes.POINTER(LLVMTypeRef), ctypes.c_uint, LLVMBool]
except AttributeError: pass
...
try: (LLVMCountParamTypes:=dll.LLVMCountParamTypes).restype,LLVMCountParamTypes.argtypes = ctypes.c_uint,[LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMStructTypeInContext:=dll.LLVMStructTypeInContext).restype,LLVMStructTypeInContext.argtypes = LLVMTypeRef,[LLVMContextRef, ctypes.POINTER(LLVMTypeRef), ctypes.c_uint, LLVMBool]
except AttributeError: pass

# LLVMTypeRef LLVMStructType(LLVMTypeRef *ElementTypes, unsigned int ElementCount, LLVMBool Packed)
try: (LLVMStructType:=dll.LLVMStructType).restype,LLVMStructType.argtypes = LLVMTypeRef,[ctypes.POINTER(LLVMTypeRef), ctypes.c_uint, LLVMBool]
except AttributeError: pass

# LLVMTypeRef LLVMStructCreateNamed(LLVMContextRef C, const char *Name)
try: (LLVMStructCreateNamed:=dll.LLVMStructCreateNamed).restype,LLVMStructCreateNamed.argtypes = LLVMTypeRef,[LLVMContextRef, ctypes.c_char_p]
except AttributeError: pass

# const char *LLVMGetStructName(LLVMTypeRef Ty)
try: (LLVMGetStructName:=dll.LLVMGetStructName).restype,LLVMGetStructName.argtypes = ctypes.c_char_p,[LLVMTypeRef]
except AttributeError: pass

# void LLVMStructSetBody(LLVMTypeRef StructTy, LLVMTypeRef *ElementTypes, unsigned int ElementCount, LLVMBool Packed)
try: (LLVMStructSetBody:=dll.LLVMStructSetBody).restype,LLVMStructSetBody.argtypes = None,[LLVMTypeRef, ctypes.POINTER(LLVMTypeRef), ctypes.c_uint, LLVMBool]
except AttributeError: pass

# unsigned int LLVMCountStructElementTypes(LLVMTypeRef StructTy)
try: (LLVMCountStructElementTypes:=dll.LLVMCountStructElementTypes).restype,LLVMCountStructElementTypes.argtypes = ctypes.c_uint,[LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMStructGetTypeAtIndex:=dll.LLVMStructGetTypeAtIndex).restype,LLVMStructGetTypeAtIndex.argtypes = LLVMTypeRef,[LLVMTypeRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMGetNumContainedTypes:=dll.LLVMGetNumContainedTypes).restype,LLVMGetNumContainedTypes.argtypes = ctypes.c_uint,[LLVMTypeRef]
except AttributeError: pass

# LLVMTypeRef LLVMArrayType(LLVMTypeRef ElementType, unsigned int ElementCount)
try: (LLVMArrayType:=dll.LLVMArrayType).restype,LLVMArrayType.argtypes = LLVMTypeRef,[LLVMTypeRef, ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetArrayLength(LLVMTypeRef ArrayTy)
try: (LLVMGetArrayLength:=dll.LLVMGetArrayLength).restype,LLVMGetArrayLength.argtypes = ctypes.c_uint,[LLVMTypeRef]
except AttributeError: pass

# LLVMTypeRef LLVMPointerType(LLVMTypeRef ElementType, unsigned int AddressSpace)
try: (LLVMPointerType:=dll.LLVMPointerType).restype,LLVMPointerType.argtypes = LLVMTypeRef,[LLVMTypeRef, ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetPointerAddressSpace(LLVMTypeRef PointerTy)
try: (LLVMGetPointerAddressSpace:=dll.LLVMGetPointerAddressSpace).restype,LLVMGetPointerAddressSpace.argtypes = ctypes.c_uint,[LLVMTypeRef]
except AttributeError: pass

# LLVMTypeRef LLVMVectorType(LLVMTypeRef ElementType, unsigned int ElementCount)
try: (LLVMVectorType:=dll.LLVMVectorType).restype,LLVMVectorType.argtypes = LLVMTypeRef,[LLVMTypeRef, ctypes.c_uint]
except AttributeError: pass

# LLVMTypeRef LLVMScalableVectorType(LLVMTypeRef ElementType, unsigned int ElementCount)
try: (LLVMScalableVectorType:=dll.LLVMScalableVectorType).restype,LLVMScalableVectorType.argtypes = LLVMTypeRef,[LLVMTypeRef, ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetVectorSize(LLVMTypeRef VectorTy)
try: (LLVMGetVectorSize:=dll.LLVMGetVectorSize).restype,LLVMGetVectorSize.argtypes = ctypes.c_uint,[LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMX86MMXTypeInContext:=dll.LLVMX86MMXTypeInContext).restype,LLVMX86MMXTypeInContext.argtypes = LLVMTypeRef,[LLVMContextRef]
except AttributeError: pass
...
try: (LLVMX86MMXType:=dll.LLVMX86MMXType).restype,LLVMX86MMXType.argtypes = LLVMTypeRef,[]
except AttributeError: pass
...
try: (LLVMGetValueName2:=dll.LLVMGetValueName2).restype,LLVMGetValueName2.argtypes = ctypes.c_char_p,[LLVMValueRef, ctypes.POINTER(size_t)]
except AttributeError: pass

# void LLVMSetValueName2(LLVMValueRef Val, const char *Name, size_t NameLen)
try: (LLVMSetValueName2:=dll.LLVMSetValueName2).restype,LLVMSetValueName2.argtypes = None,[LLVMValueRef, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMPrintValueToString:=dll.LLVMPrintValueToString).restype,LLVMPrintValueToString.argtypes = ctypes.c_char_p,[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMGetValueName:=dll.LLVMGetValueName).restype,LLVMGetValueName.argtypes = ctypes.c_char_p,[LLVMValueRef]
except AttributeError: pass

# void LLVMSetValueName(LLVMValueRef Val, const char *Name)
try: (LLVMSetValueName:=dll.LLVMSetValueName).restype,LLVMSetValueName.argtypes = None,[LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

class struct_LLVMOpaqueUse(ctypes.Structure): pass
struct_LLVMOpaqueUse._fields_ = []
...
try: (LLVMGetOperand:=dll.LLVMGetOperand).restype,LLVMGetOperand.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# LLVMUseRef LLVMGetOperandUse(LLVMValueRef Val, unsigned int Index)
try: (LLVMGetOperandUse:=dll.LLVMGetOperandUse).restype,LLVMGetOperandUse.argtypes = LLVMUseRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMSetOperand(LLVMValueRef User, unsigned int Index, LLVMValueRef Val)
try: (LLVMSetOperand:=dll.LLVMSetOperand).restype,LLVMSetOperand.argtypes = None,[LLVMValueRef, ctypes.c_uint, LLVMValueRef]
except AttributeError: pass

# int LLVMGetNumOperands(LLVMValueRef Val)
try: (LLVMGetNumOperands:=dll.LLVMGetNumOperands).restype,LLVMGetNumOperands.argtypes = ctypes.c_int,[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMConstInt:=dll.LLVMConstInt).restype,LLVMConstInt.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_ulonglong, LLVMBool]
except AttributeError: pass

# LLVMValueRef LLVMConstIntOfArbitraryPrecision(LLVMTypeRef IntTy, unsigned int NumWords, const uint64_t Words[])
try: (LLVMConstIntOfArbitraryPrecision:=dll.LLVMConstIntOfArbitraryPrecision).restype,LLVMConstIntOfArbitraryPrecision.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_uint, (uint64_t * 0)]
except AttributeError: pass

# LLVMValueRef LLVMConstIntOfString(LLVMTypeRef IntTy, const char *Text, uint8_t Radix)
try: (LLVMConstIntOfString:=dll.LLVMConstIntOfString).restype,LLVMConstIntOfString.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_char_p, uint8_t]
except AttributeError: pass

# LLVMValueRef LLVMConstIntOfStringAndSize(LLVMTypeRef IntTy, const char *Text, unsigned int SLen, uint8_t Radix)
try: (LLVMConstIntOfStringAndSize:=dll.LLVMConstIntOfStringAndSize).restype,LLVMConstIntOfStringAndSize.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_char_p, ctypes.c_uint, uint8_t]
except AttributeError: pass
...
try: (LLVMConstRealOfString:=dll.LLVMConstRealOfString).restype,LLVMConstRealOfString.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMConstRealOfStringAndSize(LLVMTypeRef RealTy, const char *Text, unsigned int SLen)
try: (LLVMConstRealOfStringAndSize:=dll.LLVMConstRealOfStringAndSize).restype,LLVMConstRealOfStringAndSize.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# unsigned long long LLVMConstIntGetZExtValue(LLVMValueRef ConstantVal)
try: (LLVMConstIntGetZExtValue:=dll.LLVMConstIntGetZExtValue).restype,LLVMConstIntGetZExtValue.argtypes = ctypes.c_ulonglong,[LLVMValueRef]
except AttributeError: pass

# long long LLVMConstIntGetSExtValue(LLVMValueRef ConstantVal)
try: (LLVMConstIntGetSExtValue:=dll.LLVMConstIntGetSExtValue).restype,LLVMConstIntGetSExtValue.argtypes = ctypes.c_longlong,[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMConstStringInContext:=dll.LLVMConstStringInContext).restype,LLVMConstStringInContext.argtypes = LLVMValueRef,[LLVMContextRef, ctypes.c_char_p, ctypes.c_uint, LLVMBool]
except AttributeError: pass

# LLVMValueRef LLVMConstString(const char *Str, unsigned int Length, LLVMBool DontNullTerminate)
try: (LLVMConstString:=dll.LLVMConstString).restype,LLVMConstString.argtypes = LLVMValueRef,[ctypes.c_char_p, ctypes.c_uint, LLVMBool]
except AttributeError: pass
...
try: (LLVMGetAsString:=dll.LLVMGetAsString).restype,LLVMGetAsString.argtypes = ctypes.c_char_p,[LLVMValueRef, ctypes.POINTER(size_t)]
except AttributeError: pass

# LLVMValueRef LLVMConstStructInContext(LLVMContextRef C, LLVMValueRef *ConstantVals, unsigned int Count, LLVMBool Packed)
try: (LLVMConstStructInContext:=dll.LLVMConstStructInContext).restype,LLVMConstStructInContext.argtypes = LLVMValueRef,[LLVMContextRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, LLVMBool]
except AttributeError: pass

# LLVMValueRef LLVMConstStruct(LLVMValueRef *ConstantVals, unsigned int Count, LLVMBool Packed)
try: (LLVMConstStruct:=dll.LLVMConstStruct).restype,LLVMConstStruct.argtypes = LLVMValueRef,[ctypes.POINTER(LLVMValueRef), ctypes.c_uint, LLVMBool]
except AttributeError: pass

# LLVMValueRef LLVMConstArray(LLVMTypeRef ElementTy, LLVMValueRef *ConstantVals, unsigned int Length)
try: (LLVMConstArray:=dll.LLVMConstArray).restype,LLVMConstArray.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMConstNamedStruct(LLVMTypeRef StructTy, LLVMValueRef *ConstantVals, unsigned int Count)
try: (LLVMConstNamedStruct:=dll.LLVMConstNamedStruct).restype,LLVMConstNamedStruct.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMGetElementAsConstant(LLVMValueRef C, unsigned int idx)
try: (LLVMGetElementAsConstant:=dll.LLVMGetElementAsConstant).restype,LLVMGetElementAsConstant.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMConstVector(LLVMValueRef *ScalarConstantVals, unsigned int Size)
try: (LLVMConstVector:=dll.LLVMConstVector).restype,LLVMConstVector.argtypes = LLVMValueRef,[ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMConstFNeg:=dll.LLVMConstFNeg).restype,LLVMConstFNeg.argtypes = LLVMValueRef,[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMConstFAdd:=dll.LLVMConstFAdd).restype,LLVMConstFAdd.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMConstFSub:=dll.LLVMConstFSub).restype,LLVMConstFSub.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMConstFMul:=dll.LLVMConstFMul).restype,LLVMConstFMul.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstUDiv(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstUDiv:=dll.LLVMConstUDiv).restype,LLVMConstUDiv.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstExactUDiv(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstExactUDiv:=dll.LLVMConstExactUDiv).restype,LLVMConstExactUDiv.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstSDiv(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstSDiv:=dll.LLVMConstSDiv).restype,LLVMConstSDiv.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstExactSDiv(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstExactSDiv:=dll.LLVMConstExactSDiv).restype,LLVMConstExactSDiv.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstFDiv(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstFDiv:=dll.LLVMConstFDiv).restype,LLVMConstFDiv.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstURem(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstURem:=dll.LLVMConstURem).restype,LLVMConstURem.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstSRem(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstSRem:=dll.LLVMConstSRem).restype,LLVMConstSRem.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstFRem(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstFRem:=dll.LLVMConstFRem).restype,LLVMConstFRem.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstAnd(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstAnd:=dll.LLVMConstAnd).restype,LLVMConstAnd.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstOr(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstOr:=dll.LLVMConstOr).restype,LLVMConstOr.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMConstICmp:=dll.LLVMConstICmp).restype,LLVMConstICmp.argtypes = LLVMValueRef,[LLVMIntPredicate, LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstFCmp(LLVMRealPredicate Predicate, LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstFCmp:=dll.LLVMConstFCmp).restype,LLVMConstFCmp.argtypes = LLVMValueRef,[LLVMRealPredicate, LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstShl(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstShl:=dll.LLVMConstShl).restype,LLVMConstShl.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstLShr(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstLShr:=dll.LLVMConstLShr).restype,LLVMConstLShr.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstAShr(LLVMValueRef LHSConstant, LLVMValueRef RHSConstant)
try: (LLVMConstAShr:=dll.LLVMConstAShr).restype,LLVMConstAShr.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMConstGEP(LLVMValueRef ConstantVal, LLVMValueRef *ConstantIndices, unsigned int NumIndices) __attribute__((deprecated("Use LLVMConstGEP2 instead to support opaque pointers")))
try: (LLVMConstGEP:=dll.LLVMConstGEP).restype,LLVMConstGEP.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMConstGEP2(LLVMTypeRef Ty, LLVMValueRef ConstantVal, LLVMValueRef *ConstantIndices, unsigned int NumIndices)
try: (LLVMConstGEP2:=dll.LLVMConstGEP2).restype,LLVMConstGEP2.argtypes = LLVMValueRef,[LLVMTypeRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMConstInBoundsGEP(LLVMValueRef ConstantVal, LLVMValueRef *ConstantIndices, unsigned int NumIndices) __attribute__((deprecated("Use LLVMConstInBoundsGEP2 instead to support opaque pointers")))
try: (LLVMConstInBoundsGEP:=dll.LLVMConstInBoundsGEP).restype,LLVMConstInBoundsGEP.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMConstInBoundsGEP2:=dll.LLVMConstInBoundsGEP2).restype,LLVMConstInBoundsGEP2.argtypes = LLVMValueRef,[LLVMTypeRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMConstSExt:=dll.LLVMConstSExt).restype,LLVMConstSExt.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstZExt(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstZExt:=dll.LLVMConstZExt).restype,LLVMConstZExt.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstFPTrunc(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstFPTrunc:=dll.LLVMConstFPTrunc).restype,LLVMConstFPTrunc.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstFPExt(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstFPExt:=dll.LLVMConstFPExt).restype,LLVMConstFPExt.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstUIToFP(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstUIToFP:=dll.LLVMConstUIToFP).restype,LLVMConstUIToFP.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstSIToFP(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstSIToFP:=dll.LLVMConstSIToFP).restype,LLVMConstSIToFP.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstFPToUI(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstFPToUI:=dll.LLVMConstFPToUI).restype,LLVMConstFPToUI.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstFPToSI(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstFPToSI:=dll.LLVMConstFPToSI).restype,LLVMConstFPToSI.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMConstZExtOrBitCast:=dll.LLVMConstZExtOrBitCast).restype,LLVMConstZExtOrBitCast.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstSExtOrBitCast(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstSExtOrBitCast:=dll.LLVMConstSExtOrBitCast).restype,LLVMConstSExtOrBitCast.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMConstIntCast:=dll.LLVMConstIntCast).restype,LLVMConstIntCast.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef, LLVMBool]
except AttributeError: pass

# LLVMValueRef LLVMConstFPCast(LLVMValueRef ConstantVal, LLVMTypeRef ToType)
try: (LLVMConstFPCast:=dll.LLVMConstFPCast).restype,LLVMConstFPCast.argtypes = LLVMValueRef,[LLVMValueRef, LLVMTypeRef]
except AttributeError: pass

# LLVMValueRef LLVMConstSelect(LLVMValueRef ConstantCondition, LLVMValueRef ConstantIfTrue, LLVMValueRef ConstantIfFalse)
try: (LLVMConstSelect:=dll.LLVMConstSelect).restype,LLVMConstSelect.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMConstExtractValue:=dll.LLVMConstExtractValue).restype,LLVMConstExtractValue.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.POINTER(ctypes.c_uint), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMConstInsertValue:=dll.LLVMConstInsertValue).restype,LLVMConstInsertValue.argtypes = LLVMValueRef,[LLVMValueRef, LLVMValueRef, ctypes.POINTER(ctypes.c_uint), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMConstInlineAsm:=dll.LLVMConstInlineAsm).restype,LLVMConstInlineAsm.argtypes = LLVMValueRef,[LLVMTypeRef, ctypes.c_char_p, ctypes.c_char_p, LLVMBool, LLVMBool]
except AttributeError: pass
...
try: (LLVMGetSection:=dll.LLVMGetSection).restype,LLVMGetSection.argtypes = ctypes.c_char_p,[LLVMValueRef]
except AttributeError: pass

# void LLVMSetSection(LLVMValueRef Global, const char *Section)
try: (LLVMSetSection:=dll.LLVMSetSection).restype,LLVMSetSection.argtypes = None,[LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMGetAlignment:=dll.LLVMGetAlignment).restype,LLVMGetAlignment.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# void LLVMSetAlignment(LLVMValueRef V, unsigned int Bytes)
try: (LLVMSetAlignment:=dll.LLVMSetAlignment).restype,LLVMSetAlignment.argtypes = None,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMGlobalSetMetadata(LLVMValueRef Global, unsigned int Kind, LLVMMetadataRef MD)
try: (LLVMGlobalSetMetadata:=dll.LLVMGlobalSetMetadata).restype,LLVMGlobalSetMetadata.argtypes = None,[LLVMValueRef, ctypes.c_uint, LLVMMetadataRef]
except AttributeError: pass

# void LLVMGlobalEraseMetadata(LLVMValueRef Global, unsigned int Kind)
try: (LLVMGlobalEraseMetadata:=dll.LLVMGlobalEraseMetadata).restype,LLVMGlobalEraseMetadata.argtypes = None,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass
...
struct_LLVMOpaqueValueMetadataEntry._fields_ = []
...
try: (LLVMValueMetadataEntriesGetKind:=dll.LLVMValueMetadataEntriesGetKind).restype,LLVMValueMetadataEntriesGetKind.argtypes = ctypes.c_uint,[ctypes.POINTER(LLVMValueMetadataEntry), ctypes.c_uint]
except AttributeError: pass

# LLVMMetadataRef LLVMValueMetadataEntriesGetMetadata(LLVMValueMetadataEntry *Entries, unsigned int Index)
try: (LLVMValueMetadataEntriesGetMetadata:=dll.LLVMValueMetadataEntriesGetMetadata).restype,LLVMValueMetadataEntriesGetMetadata.argtypes = LLVMMetadataRef,[ctypes.POINTER(LLVMValueMetadataEntry), ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMAddGlobal(LLVMModuleRef M, LLVMTypeRef Ty, const char *Name)
try: (LLVMAddGlobal:=dll.LLVMAddGlobal).restype,LLVMAddGlobal.argtypes = LLVMValueRef,[LLVMModuleRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMAddGlobalInAddressSpace(LLVMModuleRef M, LLVMTypeRef Ty, const char *Name, unsigned int AddressSpace)
try: (LLVMAddGlobalInAddressSpace:=dll.LLVMAddGlobalInAddressSpace).restype,LLVMAddGlobalInAddressSpace.argtypes = LLVMValueRef,[LLVMModuleRef, LLVMTypeRef, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMGetNamedGlobal(LLVMModuleRef M, const char *Name)
try: (LLVMGetNamedGlobal:=dll.LLVMGetNamedGlobal).restype,LLVMGetNamedGlobal.argtypes = LLVMValueRef,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass
...
# LLVMValueRef LLVMAddAlias(LLVMModuleRef M, LLVMTypeRef Ty, LLVMValueRef Aliasee, const char *Name) __attribute__((deprecated("Use LLVMAddAlias2 instead to support opaque pointers")))
try: (LLVMAddAlias:=dll.LLVMAddAlias).restype,LLVMAddAlias.argtypes = LLVMValueRef,[LLVMModuleRef, LLVMTypeRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMAddAlias2:=dll.LLVMAddAlias2).restype,LLVMAddAlias2.argtypes = LLVMValueRef,[LLVMModuleRef, LLVMTypeRef, ctypes.c_uint, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMGetNamedGlobalAlias(LLVMModuleRef M, const char *Name, size_t NameLen)
try: (LLVMGetNamedGlobalAlias:=dll.LLVMGetNamedGlobalAlias).restype,LLVMGetNamedGlobalAlias.argtypes = LLVMValueRef,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMLookupIntrinsicID:=dll.LLVMLookupIntrinsicID).restype,LLVMLookupIntrinsicID.argtypes = ctypes.c_uint,[ctypes.c_char_p, size_t]
except AttributeError: pass

# unsigned int LLVMGetIntrinsicID(LLVMValueRef Fn)
try: (LLVMGetIntrinsicID:=dll.LLVMGetIntrinsicID).restype,LLVMGetIntrinsicID.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMGetIntrinsicDeclaration(LLVMModuleRef Mod, unsigned int ID, LLVMTypeRef *ParamTypes, size_t ParamCount)
try: (LLVMGetIntrinsicDeclaration:=dll.LLVMGetIntrinsicDeclaration).restype,LLVMGetIntrinsicDeclaration.argtypes = LLVMValueRef,[LLVMModuleRef, ctypes.c_uint, ctypes.POINTER(LLVMTypeRef), size_t]
except AttributeError: pass

# LLVMTypeRef LLVMIntrinsicGetType(LLVMContextRef Ctx, unsigned int ID, LLVMTypeRef *ParamTypes, size_t ParamCount)
try: (LLVMIntrinsicGetType:=dll.LLVMIntrinsicGetType).restype,LLVMIntrinsicGetType.argtypes = LLVMTypeRef,[LLVMContextRef, ctypes.c_uint, ctypes.POINTER(LLVMTypeRef), size_t]
except AttributeError: pass

# const char *LLVMIntrinsicGetName(unsigned int ID, size_t *NameLength)
try: (LLVMIntrinsicGetName:=dll.LLVMIntrinsicGetName).restype,LLVMIntrinsicGetName.argtypes = ctypes.c_char_p,[ctypes.c_uint, ctypes.POINTER(size_t)]
except AttributeError: pass

# const char *LLVMIntrinsicCopyOverloadedName(unsigned int ID, LLVMTypeRef *ParamTypes, size_t ParamCount, size_t *NameLength)
try: (LLVMIntrinsicCopyOverloadedName:=dll.LLVMIntrinsicCopyOverloadedName).restype,LLVMIntrinsicCopyOverloadedName.argtypes = ctypes.c_char_p,[ctypes.c_uint, ctypes.POINTER(LLVMTypeRef), size_t, ctypes.POINTER(size_t)]
except AttributeError: pass

# const char *LLVMIntrinsicCopyOverloadedName2(LLVMModuleRef Mod, unsigned int ID, LLVMTypeRef *ParamTypes, size_t ParamCount, size_t *NameLength)
try: (LLVMIntrinsicCopyOverloadedName2:=dll.LLVMIntrinsicCopyOverloadedName2).restype,LLVMIntrinsicCopyOverloadedName2.argtypes = ctypes.c_char_p,[LLVMModuleRef, ctypes.c_uint, ctypes.POINTER(LLVMTypeRef), size_t, ctypes.POINTER(size_t)]
except AttributeError: pass

# LLVMBool LLVMIntrinsicIsOverloaded(unsigned int ID)
try: (LLVMIntrinsicIsOverloaded:=dll.LLVMIntrinsicIsOverloaded).restype,LLVMIntrinsicIsOverloaded.argtypes = LLVMBool,[ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetFunctionCallConv(LLVMValueRef Fn)
try: (LLVMGetFunctionCallConv:=dll.LLVMGetFunctionCallConv).restype,LLVMGetFunctionCallConv.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# void LLVMSetFunctionCallConv(LLVMValueRef Fn, unsigned int CC)
try: (LLVMSetFunctionCallConv:=dll.LLVMSetFunctionCallConv).restype,LLVMSetFunctionCallConv.argtypes = None,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# const char *LLVMGetGC(LLVMValueRef Fn)
try: (LLVMGetGC:=dll.LLVMGetGC).restype,LLVMGetGC.argtypes = ctypes.c_char_p,[LLVMValueRef]
except AttributeError: pass

# void LLVMSetGC(LLVMValueRef Fn, const char *Name)
try: (LLVMSetGC:=dll.LLVMSetGC).restype,LLVMSetGC.argtypes = None,[LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMGetAttributeCountAtIndex:=dll.LLVMGetAttributeCountAtIndex).restype,LLVMGetAttributeCountAtIndex.argtypes = ctypes.c_uint,[LLVMValueRef, LLVMAttributeIndex]
except AttributeError: pass
...
try: (LLVMGetEnumAttributeAtIndex:=dll.LLVMGetEnumAttributeAtIndex).restype,LLVMGetEnumAttributeAtIndex.argtypes = LLVMAttributeRef,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_uint]
except AttributeError: pass

# LLVMAttributeRef LLVMGetStringAttributeAtIndex(LLVMValueRef F, LLVMAttributeIndex Idx, const char *K, unsigned int KLen)
try: (LLVMGetStringAttributeAtIndex:=dll.LLVMGetStringAttributeAtIndex).restype,LLVMGetStringAttributeAtIndex.argtypes = LLVMAttributeRef,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# void LLVMRemoveEnumAttributeAtIndex(LLVMValueRef F, LLVMAttributeIndex Idx, unsigned int KindID)
try: (LLVMRemoveEnumAttributeAtIndex:=dll.LLVMRemoveEnumAttributeAtIndex).restype,LLVMRemoveEnumAttributeAtIndex.argtypes = None,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_uint]
except AttributeError: pass

# void LLVMRemoveStringAttributeAtIndex(LLVMValueRef F, LLVMAttributeIndex Idx, const char *K, unsigned int KLen)
try: (LLVMRemoveStringAttributeAtIndex:=dll.LLVMRemoveStringAttributeAtIndex).restype,LLVMRemoveStringAttributeAtIndex.argtypes = None,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# void LLVMAddTargetDependentFunctionAttr(LLVMValueRef Fn, const char *A, const char *V)
try: (LLVMAddTargetDependentFunctionAttr:=dll.LLVMAddTargetDependentFunctionAttr).restype,LLVMAddTargetDependentFunctionAttr.argtypes = None,[LLVMValueRef, ctypes.c_char_p, ctypes.c_char_p]
except AttributeError: pass

# unsigned int LLVMCountParams(LLVMValueRef Fn)
try: (LLVMCountParams:=dll.LLVMCountParams).restype,LLVMCountParams.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMGetParam:=dll.LLVMGetParam).restype,LLVMGetParam.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMSetParamAlignment:=dll.LLVMSetParamAlignment).restype,LLVMSetParamAlignment.argtypes = None,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMAddGlobalIFunc:=dll.LLVMAddGlobalIFunc).restype,LLVMAddGlobalIFunc.argtypes = LLVMValueRef,[LLVMModuleRef, ctypes.c_char_p, size_t, LLVMTypeRef, ctypes.c_uint, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMGetNamedGlobalIFunc(LLVMModuleRef M, const char *Name, size_t NameLen)
try: (LLVMGetNamedGlobalIFunc:=dll.LLVMGetNamedGlobalIFunc).restype,LLVMGetNamedGlobalIFunc.argtypes = LLVMValueRef,[LLVMModuleRef, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMMDStringInContext2:=dll.LLVMMDStringInContext2).restype,LLVMMDStringInContext2.argtypes = LLVMMetadataRef,[LLVMContextRef, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (LLVMGetMDString:=dll.LLVMGetMDString).restype,LLVMGetMDString.argtypes = ctypes.c_char_p,[LLVMValueRef, ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass

# unsigned int LLVMGetMDNodeNumOperands(LLVMValueRef V)
try: (LLVMGetMDNodeNumOperands:=dll.LLVMGetMDNodeNumOperands).restype,LLVMGetMDNodeNumOperands.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMMDStringInContext:=dll.LLVMMDStringInContext).restype,LLVMMDStringInContext.argtypes = LLVMValueRef,[LLVMContextRef, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMMDString(const char *Str, unsigned int SLen)
try: (LLVMMDString:=dll.LLVMMDString).restype,LLVMMDString.argtypes = LLVMValueRef,[ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMMDNodeInContext(LLVMContextRef C, LLVMValueRef *Vals, unsigned int Count)
try: (LLVMMDNodeInContext:=dll.LLVMMDNodeInContext).restype,LLVMMDNodeInContext.argtypes = LLVMValueRef,[LLVMContextRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMMDNode(LLVMValueRef *Vals, unsigned int Count)
try: (LLVMMDNode:=dll.LLVMMDNode).restype,LLVMMDNode.argtypes = LLVMValueRef,[ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMGetBasicBlockName:=dll.LLVMGetBasicBlockName).restype,LLVMGetBasicBlockName.argtypes = ctypes.c_char_p,[LLVMBasicBlockRef]
except AttributeError: pass
...
try: (LLVMCountBasicBlocks:=dll.LLVMCountBasicBlocks).restype,LLVMCountBasicBlocks.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass
...
struct_LLVMOpaqueBuilder._fields_ = []
...
try: (LLVMCreateBasicBlockInContext:=dll.LLVMCreateBasicBlockInContext).restype,LLVMCreateBasicBlockInContext.argtypes = LLVMBasicBlockRef,[LLVMContextRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMBasicBlockRef LLVMAppendBasicBlockInContext(LLVMContextRef C, LLVMValueRef Fn, const char *Name)
try: (LLVMAppendBasicBlockInContext:=dll.LLVMAppendBasicBlockInContext).restype,LLVMAppendBasicBlockInContext.argtypes = LLVMBasicBlockRef,[LLVMContextRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMBasicBlockRef LLVMAppendBasicBlock(LLVMValueRef Fn, const char *Name)
try: (LLVMAppendBasicBlock:=dll.LLVMAppendBasicBlock).restype,LLVMAppendBasicBlock.argtypes = LLVMBasicBlockRef,[LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMBasicBlockRef LLVMInsertBasicBlockInContext(LLVMContextRef C, LLVMBasicBlockRef BB, const char *Name)
try: (LLVMInsertBasicBlockInContext:=dll.LLVMInsertBasicBlockInContext).restype,LLVMInsertBasicBlockInContext.argtypes = LLVMBasicBlockRef,[LLVMContextRef, LLVMBasicBlockRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMBasicBlockRef LLVMInsertBasicBlock(LLVMBasicBlockRef InsertBeforeBB, const char *Name)
try: (LLVMInsertBasicBlock:=dll.LLVMInsertBasicBlock).restype,LLVMInsertBasicBlock.argtypes = LLVMBasicBlockRef,[LLVMBasicBlockRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMHasMetadata:=dll.LLVMHasMetadata).restype,LLVMHasMetadata.argtypes = ctypes.c_int,[LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMGetMetadata(LLVMValueRef Val, unsigned int KindID)
try: (LLVMGetMetadata:=dll.LLVMGetMetadata).restype,LLVMGetMetadata.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMSetMetadata(LLVMValueRef Val, unsigned int KindID, LLVMValueRef Node)
try: (LLVMSetMetadata:=dll.LLVMSetMetadata).restype,LLVMSetMetadata.argtypes = None,[LLVMValueRef, ctypes.c_uint, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMGetNumArgOperands:=dll.LLVMGetNumArgOperands).restype,LLVMGetNumArgOperands.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# void LLVMSetInstructionCallConv(LLVMValueRef Instr, unsigned int CC)
try: (LLVMSetInstructionCallConv:=dll.LLVMSetInstructionCallConv).restype,LLVMSetInstructionCallConv.argtypes = None,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetInstructionCallConv(LLVMValueRef Instr)
try: (LLVMGetInstructionCallConv:=dll.LLVMGetInstructionCallConv).restype,LLVMGetInstructionCallConv.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# void LLVMSetInstrParamAlignment(LLVMValueRef Instr, LLVMAttributeIndex Idx, unsigned int Align)
try: (LLVMSetInstrParamAlignment:=dll.LLVMSetInstrParamAlignment).restype,LLVMSetInstrParamAlignment.argtypes = None,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMGetCallSiteAttributeCount:=dll.LLVMGetCallSiteAttributeCount).restype,LLVMGetCallSiteAttributeCount.argtypes = ctypes.c_uint,[LLVMValueRef, LLVMAttributeIndex]
except AttributeError: pass
...
try: (LLVMGetCallSiteEnumAttribute:=dll.LLVMGetCallSiteEnumAttribute).restype,LLVMGetCallSiteEnumAttribute.argtypes = LLVMAttributeRef,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_uint]
except AttributeError: pass

# LLVMAttributeRef LLVMGetCallSiteStringAttribute(LLVMValueRef C, LLVMAttributeIndex Idx, const char *K, unsigned int KLen)
try: (LLVMGetCallSiteStringAttribute:=dll.LLVMGetCallSiteStringAttribute).restype,LLVMGetCallSiteStringAttribute.argtypes = LLVMAttributeRef,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass

# void LLVMRemoveCallSiteEnumAttribute(LLVMValueRef C, LLVMAttributeIndex Idx, unsigned int KindID)
try: (LLVMRemoveCallSiteEnumAttribute:=dll.LLVMRemoveCallSiteEnumAttribute).restype,LLVMRemoveCallSiteEnumAttribute.argtypes = None,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_uint]
except AttributeError: pass

# void LLVMRemoveCallSiteStringAttribute(LLVMValueRef C, LLVMAttributeIndex Idx, const char *K, unsigned int KLen)
try: (LLVMRemoveCallSiteStringAttribute:=dll.LLVMRemoveCallSiteStringAttribute).restype,LLVMRemoveCallSiteStringAttribute.argtypes = None,[LLVMValueRef, LLVMAttributeIndex, ctypes.c_char_p, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMGetNumSuccessors:=dll.LLVMGetNumSuccessors).restype,LLVMGetNumSuccessors.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# LLVMBasicBlockRef LLVMGetSuccessor(LLVMValueRef Term, unsigned int i)
try: (LLVMGetSuccessor:=dll.LLVMGetSuccessor).restype,LLVMGetSuccessor.argtypes = LLVMBasicBlockRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMSetSuccessor(LLVMValueRef Term, unsigned int i, LLVMBasicBlockRef block)
try: (LLVMSetSuccessor:=dll.LLVMSetSuccessor).restype,LLVMSetSuccessor.argtypes = None,[LLVMValueRef, ctypes.c_uint, LLVMBasicBlockRef]
except AttributeError: pass
...
try: (LLVMAddIncoming:=dll.LLVMAddIncoming).restype,LLVMAddIncoming.argtypes = None,[LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.POINTER(LLVMBasicBlockRef), ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMCountIncoming(LLVMValueRef PhiNode)
try: (LLVMCountIncoming:=dll.LLVMCountIncoming).restype,LLVMCountIncoming.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMGetIncomingValue(LLVMValueRef PhiNode, unsigned int Index)
try: (LLVMGetIncomingValue:=dll.LLVMGetIncomingValue).restype,LLVMGetIncomingValue.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# LLVMBasicBlockRef LLVMGetIncomingBlock(LLVMValueRef PhiNode, unsigned int Index)
try: (LLVMGetIncomingBlock:=dll.LLVMGetIncomingBlock).restype,LLVMGetIncomingBlock.argtypes = LLVMBasicBlockRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# unsigned int LLVMGetNumIndices(LLVMValueRef Inst)
try: (LLVMGetNumIndices:=dll.LLVMGetNumIndices).restype,LLVMGetNumIndices.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# const unsigned int *LLVMGetIndices(LLVMValueRef Inst)
try: (LLVMGetIndices:=dll.LLVMGetIndices).restype,LLVMGetIndices.argtypes = ctypes.POINTER(ctypes.c_uint),[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMInsertIntoBuilderWithName:=dll.LLVMInsertIntoBuilderWithName).restype,LLVMInsertIntoBuilderWithName.argtypes = None,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildAggregateRet:=dll.LLVMBuildAggregateRet).restype,LLVMBuildAggregateRet.argtypes = LLVMValueRef,[LLVMBuilderRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMBuildSwitch:=dll.LLVMBuildSwitch).restype,LLVMBuildSwitch.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMBasicBlockRef, ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMBuildIndirectBr(LLVMBuilderRef B, LLVMValueRef Addr, unsigned int NumDests)
try: (LLVMBuildIndirectBr:=dll.LLVMBuildIndirectBr).restype,LLVMBuildIndirectBr.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# LLVMValueRef LLVMBuildInvoke(LLVMBuilderRef, LLVMValueRef Fn, LLVMValueRef *Args, unsigned int NumArgs, LLVMBasicBlockRef Then, LLVMBasicBlockRef Catch, const char *Name) __attribute__((deprecated("Use LLVMBuildInvoke2 instead to support opaque pointers")))
try: (LLVMBuildInvoke:=dll.LLVMBuildInvoke).restype,LLVMBuildInvoke.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, LLVMBasicBlockRef, LLVMBasicBlockRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildInvoke2:=dll.LLVMBuildInvoke2).restype,LLVMBuildInvoke2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, LLVMBasicBlockRef, LLVMBasicBlockRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildLandingPad:=dll.LLVMBuildLandingPad).restype,LLVMBuildLandingPad.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildCatchPad:=dll.LLVMBuildCatchPad).restype,LLVMBuildCatchPad.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildCleanupPad:=dll.LLVMBuildCleanupPad).restype,LLVMBuildCleanupPad.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildCatchSwitch:=dll.LLVMBuildCatchSwitch).restype,LLVMBuildCatchSwitch.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMBasicBlockRef, ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMGetNumClauses:=dll.LLVMGetNumClauses).restype,LLVMGetNumClauses.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMGetClause(LLVMValueRef LandingPad, unsigned int Idx)
try: (LLVMGetClause:=dll.LLVMGetClause).restype,LLVMGetClause.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMGetNumHandlers:=dll.LLVMGetNumHandlers).restype,LLVMGetNumHandlers.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass
...
try: (LLVMGetArgOperand:=dll.LLVMGetArgOperand).restype,LLVMGetArgOperand.argtypes = LLVMValueRef,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMSetArgOperand(LLVMValueRef Funclet, unsigned int i, LLVMValueRef value)
try: (LLVMSetArgOperand:=dll.LLVMSetArgOperand).restype,LLVMSetArgOperand.argtypes = None,[LLVMValueRef, ctypes.c_uint, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMBuildAdd:=dll.LLVMBuildAdd).restype,LLVMBuildAdd.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNSWAdd(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildNSWAdd:=dll.LLVMBuildNSWAdd).restype,LLVMBuildNSWAdd.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNUWAdd(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildNUWAdd:=dll.LLVMBuildNUWAdd).restype,LLVMBuildNUWAdd.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFAdd(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildFAdd:=dll.LLVMBuildFAdd).restype,LLVMBuildFAdd.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildSub(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildSub:=dll.LLVMBuildSub).restype,LLVMBuildSub.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNSWSub(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildNSWSub:=dll.LLVMBuildNSWSub).restype,LLVMBuildNSWSub.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNUWSub(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildNUWSub:=dll.LLVMBuildNUWSub).restype,LLVMBuildNUWSub.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFSub(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildFSub:=dll.LLVMBuildFSub).restype,LLVMBuildFSub.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildMul(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildMul:=dll.LLVMBuildMul).restype,LLVMBuildMul.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNSWMul(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildNSWMul:=dll.LLVMBuildNSWMul).restype,LLVMBuildNSWMul.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNUWMul(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildNUWMul:=dll.LLVMBuildNUWMul).restype,LLVMBuildNUWMul.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFMul(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildFMul:=dll.LLVMBuildFMul).restype,LLVMBuildFMul.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildUDiv(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildUDiv:=dll.LLVMBuildUDiv).restype,LLVMBuildUDiv.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildExactUDiv(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildExactUDiv:=dll.LLVMBuildExactUDiv).restype,LLVMBuildExactUDiv.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildSDiv(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildSDiv:=dll.LLVMBuildSDiv).restype,LLVMBuildSDiv.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildExactSDiv(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildExactSDiv:=dll.LLVMBuildExactSDiv).restype,LLVMBuildExactSDiv.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFDiv(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildFDiv:=dll.LLVMBuildFDiv).restype,LLVMBuildFDiv.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildURem(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildURem:=dll.LLVMBuildURem).restype,LLVMBuildURem.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildSRem(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildSRem:=dll.LLVMBuildSRem).restype,LLVMBuildSRem.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFRem(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildFRem:=dll.LLVMBuildFRem).restype,LLVMBuildFRem.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildShl(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildShl:=dll.LLVMBuildShl).restype,LLVMBuildShl.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildLShr(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildLShr:=dll.LLVMBuildLShr).restype,LLVMBuildLShr.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildAShr(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildAShr:=dll.LLVMBuildAShr).restype,LLVMBuildAShr.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildAnd(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildAnd:=dll.LLVMBuildAnd).restype,LLVMBuildAnd.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildOr(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildOr:=dll.LLVMBuildOr).restype,LLVMBuildOr.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildXor(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildXor:=dll.LLVMBuildXor).restype,LLVMBuildXor.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildBinOp(LLVMBuilderRef B, LLVMOpcode Op, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildBinOp:=dll.LLVMBuildBinOp).restype,LLVMBuildBinOp.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMOpcode, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNeg(LLVMBuilderRef, LLVMValueRef V, const char *Name)
try: (LLVMBuildNeg:=dll.LLVMBuildNeg).restype,LLVMBuildNeg.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNSWNeg(LLVMBuilderRef B, LLVMValueRef V, const char *Name)
try: (LLVMBuildNSWNeg:=dll.LLVMBuildNSWNeg).restype,LLVMBuildNSWNeg.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNUWNeg(LLVMBuilderRef B, LLVMValueRef V, const char *Name)
try: (LLVMBuildNUWNeg:=dll.LLVMBuildNUWNeg).restype,LLVMBuildNUWNeg.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFNeg(LLVMBuilderRef, LLVMValueRef V, const char *Name)
try: (LLVMBuildFNeg:=dll.LLVMBuildFNeg).restype,LLVMBuildFNeg.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildNot(LLVMBuilderRef, LLVMValueRef V, const char *Name)
try: (LLVMBuildNot:=dll.LLVMBuildNot).restype,LLVMBuildNot.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildMalloc(LLVMBuilderRef, LLVMTypeRef Ty, const char *Name)
try: (LLVMBuildMalloc:=dll.LLVMBuildMalloc).restype,LLVMBuildMalloc.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildArrayMalloc(LLVMBuilderRef, LLVMTypeRef Ty, LLVMValueRef Val, const char *Name)
try: (LLVMBuildArrayMalloc:=dll.LLVMBuildArrayMalloc).restype,LLVMBuildArrayMalloc.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildMemSet(LLVMBuilderRef B, LLVMValueRef Ptr, LLVMValueRef Val, LLVMValueRef Len, unsigned int Align)
try: (LLVMBuildMemSet:=dll.LLVMBuildMemSet).restype,LLVMBuildMemSet.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, LLVMValueRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMBuildMemCpy:=dll.LLVMBuildMemCpy).restype,LLVMBuildMemCpy.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_uint, LLVMValueRef, ctypes.c_uint, LLVMValueRef]
except AttributeError: pass
...
try: (LLVMBuildMemMove:=dll.LLVMBuildMemMove).restype,LLVMBuildMemMove.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_uint, LLVMValueRef, ctypes.c_uint, LLVMValueRef]
except AttributeError: pass

# LLVMValueRef LLVMBuildAlloca(LLVMBuilderRef, LLVMTypeRef Ty, const char *Name)
try: (LLVMBuildAlloca:=dll.LLVMBuildAlloca).restype,LLVMBuildAlloca.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildArrayAlloca(LLVMBuilderRef, LLVMTypeRef Ty, LLVMValueRef Val, const char *Name)
try: (LLVMBuildArrayAlloca:=dll.LLVMBuildArrayAlloca).restype,LLVMBuildArrayAlloca.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass
...
# LLVMValueRef LLVMBuildLoad(LLVMBuilderRef, LLVMValueRef PointerVal, const char *Name) __attribute__((deprecated("Use LLVMBuildLoad2 instead to support opaque pointers")))
try: (LLVMBuildLoad:=dll.LLVMBuildLoad).restype,LLVMBuildLoad.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildLoad2(LLVMBuilderRef, LLVMTypeRef Ty, LLVMValueRef PointerVal, const char *Name)
try: (LLVMBuildLoad2:=dll.LLVMBuildLoad2).restype,LLVMBuildLoad2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass
...
# LLVMValueRef LLVMBuildGEP(LLVMBuilderRef B, LLVMValueRef Pointer, LLVMValueRef *Indices, unsigned int NumIndices, const char *Name) __attribute__((deprecated("Use LLVMBuildGEP2 instead to support opaque pointers")))
try: (LLVMBuildGEP:=dll.LLVMBuildGEP).restype,LLVMBuildGEP.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildInBoundsGEP(LLVMBuilderRef B, LLVMValueRef Pointer, LLVMValueRef *Indices, unsigned int NumIndices, const char *Name) __attribute__((deprecated("Use LLVMBuildInBoundsGEP2 instead to support opaque pointers")))
try: (LLVMBuildInBoundsGEP:=dll.LLVMBuildInBoundsGEP).restype,LLVMBuildInBoundsGEP.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildStructGEP(LLVMBuilderRef B, LLVMValueRef Pointer, unsigned int Idx, const char *Name) __attribute__((deprecated("Use LLVMBuildStructGEP2 instead to support opaque pointers")))
try: (LLVMBuildStructGEP:=dll.LLVMBuildStructGEP).restype,LLVMBuildStructGEP.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildGEP2:=dll.LLVMBuildGEP2).restype,LLVMBuildGEP2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildInBoundsGEP2:=dll.LLVMBuildInBoundsGEP2).restype,LLVMBuildInBoundsGEP2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildStructGEP2(LLVMBuilderRef B, LLVMTypeRef Ty, LLVMValueRef Pointer, unsigned int Idx, const char *Name)
try: (LLVMBuildStructGEP2:=dll.LLVMBuildStructGEP2).restype,LLVMBuildStructGEP2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildGlobalString(LLVMBuilderRef B, const char *Str, const char *Name)
try: (LLVMBuildGlobalString:=dll.LLVMBuildGlobalString).restype,LLVMBuildGlobalString.argtypes = LLVMValueRef,[LLVMBuilderRef, ctypes.c_char_p, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildGlobalStringPtr(LLVMBuilderRef B, const char *Str, const char *Name)
try: (LLVMBuildGlobalStringPtr:=dll.LLVMBuildGlobalStringPtr).restype,LLVMBuildGlobalStringPtr.argtypes = LLVMValueRef,[LLVMBuilderRef, ctypes.c_char_p, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildTrunc:=dll.LLVMBuildTrunc).restype,LLVMBuildTrunc.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildZExt(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildZExt:=dll.LLVMBuildZExt).restype,LLVMBuildZExt.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildSExt(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildSExt:=dll.LLVMBuildSExt).restype,LLVMBuildSExt.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFPToUI(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildFPToUI:=dll.LLVMBuildFPToUI).restype,LLVMBuildFPToUI.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFPToSI(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildFPToSI:=dll.LLVMBuildFPToSI).restype,LLVMBuildFPToSI.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildUIToFP(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildUIToFP:=dll.LLVMBuildUIToFP).restype,LLVMBuildUIToFP.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildSIToFP(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildSIToFP:=dll.LLVMBuildSIToFP).restype,LLVMBuildSIToFP.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFPTrunc(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildFPTrunc:=dll.LLVMBuildFPTrunc).restype,LLVMBuildFPTrunc.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFPExt(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildFPExt:=dll.LLVMBuildFPExt).restype,LLVMBuildFPExt.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildPtrToInt(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildPtrToInt:=dll.LLVMBuildPtrToInt).restype,LLVMBuildPtrToInt.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildIntToPtr(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildIntToPtr:=dll.LLVMBuildIntToPtr).restype,LLVMBuildIntToPtr.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildBitCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildBitCast:=dll.LLVMBuildBitCast).restype,LLVMBuildBitCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildAddrSpaceCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildAddrSpaceCast:=dll.LLVMBuildAddrSpaceCast).restype,LLVMBuildAddrSpaceCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildZExtOrBitCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildZExtOrBitCast:=dll.LLVMBuildZExtOrBitCast).restype,LLVMBuildZExtOrBitCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildSExtOrBitCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildSExtOrBitCast:=dll.LLVMBuildSExtOrBitCast).restype,LLVMBuildSExtOrBitCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildTruncOrBitCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildTruncOrBitCast:=dll.LLVMBuildTruncOrBitCast).restype,LLVMBuildTruncOrBitCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildCast(LLVMBuilderRef B, LLVMOpcode Op, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildCast:=dll.LLVMBuildCast).restype,LLVMBuildCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMOpcode, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildPointerCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildPointerCast:=dll.LLVMBuildPointerCast).restype,LLVMBuildPointerCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildIntCast2(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, LLVMBool IsSigned, const char *Name)
try: (LLVMBuildIntCast2:=dll.LLVMBuildIntCast2).restype,LLVMBuildIntCast2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, LLVMBool, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFPCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildFPCast:=dll.LLVMBuildFPCast).restype,LLVMBuildFPCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildIntCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char *Name)
try: (LLVMBuildIntCast:=dll.LLVMBuildIntCast).restype,LLVMBuildIntCast.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildICmp(LLVMBuilderRef, LLVMIntPredicate Op, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildICmp:=dll.LLVMBuildICmp).restype,LLVMBuildICmp.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMIntPredicate, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFCmp(LLVMBuilderRef, LLVMRealPredicate Op, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildFCmp:=dll.LLVMBuildFCmp).restype,LLVMBuildFCmp.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMRealPredicate, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildPhi(LLVMBuilderRef, LLVMTypeRef Ty, const char *Name)
try: (LLVMBuildPhi:=dll.LLVMBuildPhi).restype,LLVMBuildPhi.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildCall(LLVMBuilderRef, LLVMValueRef Fn, LLVMValueRef *Args, unsigned int NumArgs, const char *Name) __attribute__((deprecated("Use LLVMBuildCall2 instead to support opaque pointers")))
try: (LLVMBuildCall:=dll.LLVMBuildCall).restype,LLVMBuildCall.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildCall2:=dll.LLVMBuildCall2).restype,LLVMBuildCall2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.POINTER(LLVMValueRef), ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildSelect(LLVMBuilderRef, LLVMValueRef If, LLVMValueRef Then, LLVMValueRef Else, const char *Name)
try: (LLVMBuildSelect:=dll.LLVMBuildSelect).restype,LLVMBuildSelect.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildVAArg(LLVMBuilderRef, LLVMValueRef List, LLVMTypeRef Ty, const char *Name)
try: (LLVMBuildVAArg:=dll.LLVMBuildVAArg).restype,LLVMBuildVAArg.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildExtractElement(LLVMBuilderRef, LLVMValueRef VecVal, LLVMValueRef Index, const char *Name)
try: (LLVMBuildExtractElement:=dll.LLVMBuildExtractElement).restype,LLVMBuildExtractElement.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildInsertElement:=dll.LLVMBuildInsertElement).restype,LLVMBuildInsertElement.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildShuffleVector(LLVMBuilderRef, LLVMValueRef V1, LLVMValueRef V2, LLVMValueRef Mask, const char *Name)
try: (LLVMBuildShuffleVector:=dll.LLVMBuildShuffleVector).restype,LLVMBuildShuffleVector.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildExtractValue(LLVMBuilderRef, LLVMValueRef AggVal, unsigned int Index, const char *Name)
try: (LLVMBuildExtractValue:=dll.LLVMBuildExtractValue).restype,LLVMBuildExtractValue.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMBuildInsertValue:=dll.LLVMBuildInsertValue).restype,LLVMBuildInsertValue.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_uint, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFreeze(LLVMBuilderRef, LLVMValueRef Val, const char *Name)
try: (LLVMBuildFreeze:=dll.LLVMBuildFreeze).restype,LLVMBuildFreeze.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildIsNull(LLVMBuilderRef, LLVMValueRef Val, const char *Name)
try: (LLVMBuildIsNull:=dll.LLVMBuildIsNull).restype,LLVMBuildIsNull.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildIsNotNull(LLVMBuilderRef, LLVMValueRef Val, const char *Name)
try: (LLVMBuildIsNotNull:=dll.LLVMBuildIsNotNull).restype,LLVMBuildIsNotNull.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildPtrDiff(LLVMBuilderRef, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name) __attribute__((deprecated("Use LLVMBuildPtrDiff2 instead to support opaque pointers")))
try: (LLVMBuildPtrDiff:=dll.LLVMBuildPtrDiff).restype,LLVMBuildPtrDiff.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildPtrDiff2(LLVMBuilderRef, LLVMTypeRef ElemTy, LLVMValueRef LHS, LLVMValueRef RHS, const char *Name)
try: (LLVMBuildPtrDiff2:=dll.LLVMBuildPtrDiff2).restype,LLVMBuildPtrDiff2.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, LLVMValueRef, ctypes.c_char_p]
except AttributeError: pass

# LLVMValueRef LLVMBuildFence(LLVMBuilderRef B, LLVMAtomicOrdering ordering, LLVMBool singleThread, const char *Name)
try: (LLVMBuildFence:=dll.LLVMBuildFence).restype,LLVMBuildFence.argtypes = LLVMValueRef,[LLVMBuilderRef, LLVMAtomicOrdering, LLVMBool, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMGetNumMaskElements:=dll.LLVMGetNumMaskElements).restype,LLVMGetNumMaskElements.argtypes = ctypes.c_uint,[LLVMValueRef]
except AttributeError: pass

# int LLVMGetUndefMaskElem(void)
try: (LLVMGetUndefMaskElem:=dll.LLVMGetUndefMaskElem).restype,LLVMGetUndefMaskElem.argtypes = ctypes.c_int,[]
except AttributeError: pass

# int LLVMGetMaskValue(LLVMValueRef ShuffleVectorInst, unsigned int Elt)
try: (LLVMGetMaskValue:=dll.LLVMGetMaskValue).restype,LLVMGetMaskValue.argtypes = ctypes.c_int,[LLVMValueRef, ctypes.c_uint]
except AttributeError: pass
...
struct_LLVMOpaqueModuleProvider._fields_ = []
...
try: (LLVMCreateMemoryBufferWithContentsOfFile:=dll.LLVMCreateMemoryBufferWithContentsOfFile).restype,LLVMCreateMemoryBufferWithContentsOfFile.argtypes = LLVMBool,[ctypes.c_char_p, ctypes.POINTER(LLVMMemoryBufferRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

# LLVMBool LLVMCreateMemoryBufferWithSTDIN(LLVMMemoryBufferRef *OutMemBuf, char **OutMessage)
try: (LLVMCreateMemoryBufferWithSTDIN:=dll.LLVMCreateMemoryBufferWithSTDIN).restype,LLVMCreateMemoryBufferWithSTDIN.argtypes = LLVMBool,[ctypes.POINTER(LLVMMemoryBufferRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass

# LLVMMemoryBufferRef LLVMCreateMemoryBufferWithMemoryRange(const char *InputData, size_t InputDataLength, const char *BufferName, LLVMBool RequiresNullTerminator)
try: (LLVMCreateMemoryBufferWithMemoryRange:=dll.LLVMCreateMemoryBufferWithMemoryRange).restype,LLVMCreateMemoryBufferWithMemoryRange.argtypes = LLVMMemoryBufferRef,[ctypes.c_char_p, size_t, ctypes.c_char_p, LLVMBool]
except AttributeError: pass

# LLVMMemoryBufferRef LLVMCreateMemoryBufferWithMemoryRangeCopy(const char *InputData, size_t InputDataLength, const char *BufferName)
try: (LLVMCreateMemoryBufferWithMemoryRangeCopy:=dll.LLVMCreateMemoryBufferWithMemoryRangeCopy).restype,LLVMCreateMemoryBufferWithMemoryRangeCopy.argtypes = LLVMMemoryBufferRef,[ctypes.c_char_p, size_t, ctypes.c_char_p]
except AttributeError: pass

# const char *LLVMGetBufferStart(LLVMMemoryBufferRef MemBuf)
try: (LLVMGetBufferStart:=dll.LLVMGetBufferStart).restype,LLVMGetBufferStart.argtypes = ctypes.c_char_p,[LLVMMemoryBufferRef]
except AttributeError: pass
...
try: (LLVMGetGlobalPassRegistry:=dll.LLVMGetGlobalPassRegistry).restype,LLVMGetGlobalPassRegistry.argtypes = LLVMPassRegistryRef,[]
except AttributeError: pass
...
try: (LLVMInitializeTransformUtils:=dll.LLVMInitializeTransformUtils).restype,LLVMInitializeTransformUtils.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeScalarOpts(LLVMPassRegistryRef R)
try: (LLVMInitializeScalarOpts:=dll.LLVMInitializeScalarOpts).restype,LLVMInitializeScalarOpts.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeObjCARCOpts(LLVMPassRegistryRef R)
try: (LLVMInitializeObjCARCOpts:=dll.LLVMInitializeObjCARCOpts).restype,LLVMInitializeObjCARCOpts.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeVectorization(LLVMPassRegistryRef R)
try: (LLVMInitializeVectorization:=dll.LLVMInitializeVectorization).restype,LLVMInitializeVectorization.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeInstCombine(LLVMPassRegistryRef R)
try: (LLVMInitializeInstCombine:=dll.LLVMInitializeInstCombine).restype,LLVMInitializeInstCombine.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeAggressiveInstCombiner(LLVMPassRegistryRef R)
try: (LLVMInitializeAggressiveInstCombiner:=dll.LLVMInitializeAggressiveInstCombiner).restype,LLVMInitializeAggressiveInstCombiner.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeIPO(LLVMPassRegistryRef R)
try: (LLVMInitializeIPO:=dll.LLVMInitializeIPO).restype,LLVMInitializeIPO.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeInstrumentation(LLVMPassRegistryRef R)
try: (LLVMInitializeInstrumentation:=dll.LLVMInitializeInstrumentation).restype,LLVMInitializeInstrumentation.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeAnalysis(LLVMPassRegistryRef R)
try: (LLVMInitializeAnalysis:=dll.LLVMInitializeAnalysis).restype,LLVMInitializeAnalysis.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeIPA(LLVMPassRegistryRef R)
try: (LLVMInitializeIPA:=dll.LLVMInitializeIPA).restype,LLVMInitializeIPA.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeCodeGen(LLVMPassRegistryRef R)
try: (LLVMInitializeCodeGen:=dll.LLVMInitializeCodeGen).restype,LLVMInitializeCodeGen.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

# void LLVMInitializeTarget(LLVMPassRegistryRef R)
try: (LLVMInitializeTarget:=dll.LLVMInitializeTarget).restype,LLVMInitializeTarget.argtypes = None,[LLVMPassRegistryRef]
except AttributeError: pass

class struct_LLVMOpaqueSectionIterator(ctypes.Structure): pass
struct_LLVMOpaqueSectionIterator._fields_ = []
...
struct_LLVMOpaqueSymbolIterator._fields_ = []
...
struct_LLVMOpaqueRelocationIterator._fields_ = []
LLVMRelocationIteratorRef = ctypes.POINTER(struct_LLVMOpaqueRelocationIterator)
LLVMBinaryType = CEnum(ctypes.c_uint)
...
struct_LLVMOpaqueBinary._fields_ = []
...
try: (LLVMCreateBinary:=dll.LLVMCreateBinary).restype,LLVMCreateBinary.argtypes = LLVMBinaryRef,[LLVMMemoryBufferRef, LLVMContextRef, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMMachOUniversalBinaryCopyObjectForArch:=dll.LLVMMachOUniversalBinaryCopyObjectForArch).restype,LLVMMachOUniversalBinaryCopyObjectForArch.argtypes = LLVMBinaryRef,[LLVMBinaryRef, ctypes.c_char_p, size_t, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMGetSectionName:=dll.LLVMGetSectionName).restype,LLVMGetSectionName.argtypes = ctypes.c_char_p,[LLVMSectionIteratorRef]
except AttributeError: pass
...
try: (LLVMGetSectionContents:=dll.LLVMGetSectionContents).restype,LLVMGetSectionContents.argtypes = ctypes.c_char_p,[LLVMSectionIteratorRef]
except AttributeError: pass
...
try: (LLVMGetSymbolName:=dll.LLVMGetSymbolName).restype,LLVMGetSymbolName.argtypes = ctypes.c_char_p,[LLVMSymbolIteratorRef]
except AttributeError: pass
...
try: (LLVMGetRelocationTypeName:=dll.LLVMGetRelocationTypeName).restype,LLVMGetRelocationTypeName.argtypes = ctypes.c_char_p,[LLVMRelocationIteratorRef]
except AttributeError: pass

# const char *LLVMGetRelocationValueString(LLVMRelocationIteratorRef RI)
try: (LLVMGetRelocationValueString:=dll.LLVMGetRelocationValueString).restype,LLVMGetRelocationValueString.argtypes = ctypes.c_char_p,[LLVMRelocationIteratorRef]
except AttributeError: pass

class struct_LLVMOpaqueObjectFile(ctypes.Structure): pass
struct_LLVMOpaqueObjectFile._fields_ = []
...
struct_LLVMComdat._fields_ = []
LLVMComdatRef = ctypes.POINTER(struct_LLVMComdat)
LLVMLinkerMode = CEnum(ctypes.c_uint)
...
lto_symbol_attributes = CEnum(ctypes.c_uint)
...
lto_debug_model = CEnum(ctypes.c_uint)
...
lto_codegen_model = CEnum(ctypes.c_uint)
...
struct_LLVMOpaqueThinLTOCodeGenerator._fields_ = []
thinlto_code_gen_t = ctypes.POINTER(struct_LLVMOpaqueThinLTOCodeGenerator)
# extern const char *lto_get_version(void)
try: (lto_get_version:=dll.lto_get_version).restype,lto_get_version.argtypes = ctypes.c_char_p,[]
except AttributeError: pass

# extern const char *lto_get_error_message(void)
try: (lto_get_error_message:=dll.lto_get_error_message).restype,lto_get_error_message.argtypes = ctypes.c_char_p,[]
except AttributeError: pass

# extern lto_bool_t lto_module_is_object_file(const char *path)
try: (lto_module_is_object_file:=dll.lto_module_is_object_file).restype,lto_module_is_object_file.argtypes = lto_bool_t,[ctypes.c_char_p]
except AttributeError: pass

# extern lto_bool_t lto_module_is_object_file_for_target(const char *path, const char *target_triple_prefix)
try: (lto_module_is_object_file_for_target:=dll.lto_module_is_object_file_for_target).restype,lto_module_is_object_file_for_target.argtypes = lto_bool_t,[ctypes.c_char_p, ctypes.c_char_p]
except AttributeError: pass
...
try: (lto_module_is_object_file_in_memory_for_target:=dll.lto_module_is_object_file_in_memory_for_target).restype,lto_module_is_object_file_in_memory_for_target.argtypes = lto_bool_t,[ctypes.c_void_p, size_t, ctypes.c_char_p]
except AttributeError: pass

# extern lto_module_t lto_module_create(const char *path)
try: (lto_module_create:=dll.lto_module_create).restype,lto_module_create.argtypes = lto_module_t,[ctypes.c_char_p]
except AttributeError: pass
...
try: (lto_module_create_from_memory_with_path:=dll.lto_module_create_from_memory_with_path).restype,lto_module_create_from_memory_with_path.argtypes = lto_module_t,[ctypes.c_void_p, size_t, ctypes.c_char_p]
except AttributeError: pass

# extern lto_module_t lto_module_create_in_local_context(const void *mem, size_t length, const char *path)
try: (lto_module_create_in_local_context:=dll.lto_module_create_in_local_context).restype,lto_module_create_in_local_context.argtypes = lto_module_t,[ctypes.c_void_p, size_t, ctypes.c_char_p]
except AttributeError: pass

# extern lto_module_t lto_module_create_in_codegen_context(const void *mem, size_t length, const char *path, lto_code_gen_t cg)
try: (lto_module_create_in_codegen_context:=dll.lto_module_create_in_codegen_context).restype,lto_module_create_in_codegen_context.argtypes = lto_module_t,[ctypes.c_void_p, size_t, ctypes.c_char_p, lto_code_gen_t]
except AttributeError: pass

# extern lto_module_t lto_module_create_from_fd(int fd, const char *path, size_t file_size)
try: (lto_module_create_from_fd:=dll.lto_module_create_from_fd).restype,lto_module_create_from_fd.argtypes = lto_module_t,[ctypes.c_int, ctypes.c_char_p, size_t]
except AttributeError: pass
...
try: (lto_module_create_from_fd_at_offset:=dll.lto_module_create_from_fd_at_offset).restype,lto_module_create_from_fd_at_offset.argtypes = lto_module_t,[ctypes.c_int, ctypes.c_char_p, size_t, size_t, off_t]
except AttributeError: pass
...
try: (lto_module_get_target_triple:=dll.lto_module_get_target_triple).restype,lto_module_get_target_triple.argtypes = ctypes.c_char_p,[lto_module_t]
except AttributeError: pass

# extern void lto_module_set_target_triple(lto_module_t mod, const char *triple)
try: (lto_module_set_target_triple:=dll.lto_module_set_target_triple).restype,lto_module_set_target_triple.argtypes = None,[lto_module_t, ctypes.c_char_p]
except AttributeError: pass

# extern unsigned int lto_module_get_num_symbols(lto_module_t mod)
try: (lto_module_get_num_symbols:=dll.lto_module_get_num_symbols).restype,lto_module_get_num_symbols.argtypes = ctypes.c_uint,[lto_module_t]
except AttributeError: pass

# extern const char *lto_module_get_symbol_name(lto_module_t mod, unsigned int index)
try: (lto_module_get_symbol_name:=dll.lto_module_get_symbol_name).restype,lto_module_get_symbol_name.argtypes = ctypes.c_char_p,[lto_module_t, ctypes.c_uint]
except AttributeError: pass

# extern lto_symbol_attributes lto_module_get_symbol_attribute(lto_module_t mod, unsigned int index)
try: (lto_module_get_symbol_attribute:=dll.lto_module_get_symbol_attribute).restype,lto_module_get_symbol_attribute.argtypes = lto_symbol_attributes,[lto_module_t, ctypes.c_uint]
except AttributeError: pass

# extern const char *lto_module_get_linkeropts(lto_module_t mod)
try: (lto_module_get_linkeropts:=dll.lto_module_get_linkeropts).restype,lto_module_get_linkeropts.argtypes = ctypes.c_char_p,[lto_module_t]
except AttributeError: pass

# extern lto_bool_t lto_module_get_macho_cputype(lto_module_t mod, unsigned int *out_cputype, unsigned int *out_cpusubtype)
try: (lto_module_get_macho_cputype:=dll.lto_module_get_macho_cputype).restype,lto_module_get_macho_cputype.argtypes = lto_bool_t,[lto_module_t, ctypes.POINTER(ctypes.c_uint), ctypes.POINTER(ctypes.c_uint)]
except AttributeError: pass
...
lto_codegen_diagnostic_severity_t = CEnum(ctypes.c_uint)
...
lto_diagnostic_handler_t = ctypes.POINTER(ctypes.CFUNCTYPE(None, lto_codegen_diagnostic_severity_t, ctypes.c_char_p, ctypes.c_void_p))
...
try: (lto_codegen_set_cpu:=dll.lto_codegen_set_cpu).restype,lto_codegen_set_cpu.argtypes = None,[lto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass

# extern void lto_codegen_set_assembler_path(lto_code_gen_t cg, const char *path)
try: (lto_codegen_set_assembler_path:=dll.lto_codegen_set_assembler_path).restype,lto_codegen_set_assembler_path.argtypes = None,[lto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass

# extern void lto_codegen_set_assembler_args(lto_code_gen_t cg, const char **args, int nargs)
try: (lto_codegen_set_assembler_args:=dll.lto_codegen_set_assembler_args).restype,lto_codegen_set_assembler_args.argtypes = None,[lto_code_gen_t, ctypes.POINTER(ctypes.c_char_p), ctypes.c_int]
except AttributeError: pass

# extern void lto_codegen_add_must_preserve_symbol(lto_code_gen_t cg, const char *symbol)
try: (lto_codegen_add_must_preserve_symbol:=dll.lto_codegen_add_must_preserve_symbol).restype,lto_codegen_add_must_preserve_symbol.argtypes = None,[lto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass

# extern lto_bool_t lto_codegen_write_merged_modules(lto_code_gen_t cg, const char *path)
try: (lto_codegen_write_merged_modules:=dll.lto_codegen_write_merged_modules).restype,lto_codegen_write_merged_modules.argtypes = lto_bool_t,[lto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass
...
try: (lto_codegen_compile_to_file:=dll.lto_codegen_compile_to_file).restype,lto_codegen_compile_to_file.argtypes = lto_bool_t,[lto_code_gen_t, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (lto_api_version:=dll.lto_api_version).restype,lto_api_version.argtypes = ctypes.c_uint,[]
except AttributeError: pass

# extern void lto_set_debug_options(const char *const *options, int number)
try: (lto_set_debug_options:=dll.lto_set_debug_options).restype,lto_set_debug_options.argtypes = None,[ctypes.POINTER(ctypes.c_char_p), ctypes.c_int]
except AttributeError: pass

# extern void lto_codegen_debug_options(lto_code_gen_t cg, const char *)
try: (lto_codegen_debug_options:=dll.lto_codegen_debug_options).restype,lto_codegen_debug_options.argtypes = None,[lto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass

# extern void lto_codegen_debug_options_array(lto_code_gen_t cg, const char *const *, int number)
try: (lto_codegen_debug_options_array:=dll.lto_codegen_debug_options_array).restype,lto_codegen_debug_options_array.argtypes = None,[lto_code_gen_t, ctypes.POINTER(ctypes.c_char_p), ctypes.c_int]
except AttributeError: pass
...
struct_LLVMOpaqueLTOInput._fields_ = []
...
try: (lto_input_create:=dll.lto_input_create).restype,lto_input_create.argtypes = lto_input_t,[ctypes.c_void_p, size_t, ctypes.c_char_p]
except AttributeError: pass
...
try: (lto_input_get_num_dependent_libraries:=dll.lto_input_get_num_dependent_libraries).restype,lto_input_get_num_dependent_libraries.argtypes = ctypes.c_uint,[lto_input_t]
except AttributeError: pass

# extern const char *lto_input_get_dependent_library(lto_input_t input, size_t index, size_t *size)
try: (lto_input_get_dependent_library:=dll.lto_input_get_dependent_library).restype,lto_input_get_dependent_library.argtypes = ctypes.c_char_p,[lto_input_t, size_t, ctypes.POINTER(size_t)]
except AttributeError: pass

# extern const char *const *lto_runtime_lib_symbols_list(size_t *size)
try: (lto_runtime_lib_symbols_list:=dll.lto_runtime_lib_symbols_list).restype,lto_runtime_lib_symbols_list.argtypes = ctypes.POINTER(ctypes.c_char_p),[ctypes.POINTER(size_t)]
except AttributeError: pass

class LTOObjectBuffer(ctypes.Structure): pass
...
try: (thinlto_codegen_add_module:=dll.thinlto_codegen_add_module).restype,thinlto_codegen_add_module.argtypes = None,[thinlto_code_gen_t, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int]
except AttributeError: pass
...
try: (thinlto_module_get_num_objects:=dll.thinlto_module_get_num_objects).restype,thinlto_module_get_num_objects.argtypes = ctypes.c_uint,[thinlto_code_gen_t]
except AttributeError: pass

# extern LTOObjectBuffer thinlto_module_get_object(thinlto_code_gen_t cg, unsigned int index)
try: (thinlto_module_get_object:=dll.thinlto_module_get_object).restype,thinlto_module_get_object.argtypes = LTOObjectBuffer,[thinlto_code_gen_t, ctypes.c_uint]
except AttributeError: pass

# unsigned int thinlto_module_get_num_object_files(thinlto_code_gen_t cg)
try: (thinlto_module_get_num_object_files:=dll.thinlto_module_get_num_object_files).restype,thinlto_module_get_num_object_files.argtypes = ctypes.c_uint,[thinlto_code_gen_t]
except AttributeError: pass

# const char *thinlto_module_get_object_file(thinlto_code_gen_t cg, unsigned int index)
try: (thinlto_module_get_object_file:=dll.thinlto_module_get_object_file).restype,thinlto_module_get_object_file.argtypes = ctypes.c_char_p,[thinlto_code_gen_t, ctypes.c_uint]
except AttributeError: pass
...
try: (thinlto_codegen_set_savetemps_dir:=dll.thinlto_codegen_set_savetemps_dir).restype,thinlto_codegen_set_savetemps_dir.argtypes = None,[thinlto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass

# void thinlto_set_generated_objects_dir(thinlto_code_gen_t cg, const char *save_temps_dir)
try: (thinlto_set_generated_objects_dir:=dll.thinlto_set_generated_objects_dir).restype,thinlto_set_generated_objects_dir.argtypes = None,[thinlto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass

# extern void thinlto_codegen_set_cpu(thinlto_code_gen_t cg, const char *cpu)
try: (thinlto_codegen_set_cpu:=dll.thinlto_codegen_set_cpu).restype,thinlto_codegen_set_cpu.argtypes = None,[thinlto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass
...
try: (thinlto_debug_options:=dll.thinlto_debug_options).restype,thinlto_debug_options.argtypes = None,[ctypes.POINTER(ctypes.c_char_p), ctypes.c_int]
except AttributeError: pass
...
try: (thinlto_codegen_add_must_preserve_symbol:=dll.thinlto_codegen_add_must_preserve_symbol).restype,thinlto_codegen_add_must_preserve_symbol.argtypes = None,[thinlto_code_gen_t, ctypes.c_char_p, ctypes.c_int]
except AttributeError: pass

# extern void thinlto_codegen_add_cross_referenced_symbol(thinlto_code_gen_t cg, const char *name, int length)
try: (thinlto_codegen_add_cross_referenced_symbol:=dll.thinlto_codegen_add_cross_referenced_symbol).restype,thinlto_codegen_add_cross_referenced_symbol.argtypes = None,[thinlto_code_gen_t, ctypes.c_char_p, ctypes.c_int]
except AttributeError: pass

# extern void thinlto_codegen_set_cache_dir(thinlto_code_gen_t cg, const char *cache_dir)
try: (thinlto_codegen_set_cache_dir:=dll.thinlto_codegen_set_cache_dir).restype,thinlto_codegen_set_cache_dir.argtypes = None,[thinlto_code_gen_t, ctypes.c_char_p]
except AttributeError: pass

# extern void thinlto_codegen_set_cache_pruning_interval(thinlto_code_gen_t cg, int interval)
try: (thinlto_codegen_set_cache_pruning_interval:=dll.thinlto_codegen_set_cache_pruning_interval).restype,thinlto_codegen_set_cache_pruning_interval.argtypes = None,[thinlto_code_gen_t, ctypes.c_int]
except AttributeError: pass
...
try: (thinlto_codegen_set_final_cache_size_relative_to_available_space:=dll.thinlto_codegen_set_final_cache_size_relative_to_available_space).restype,thinlto_codegen_set_final_cache_size_relative_to_available_space.argtypes = None,[thinlto_code_gen_t, ctypes.c_uint]
except AttributeError: pass

# extern void thinlto_codegen_set_cache_entry_expiration(thinlto_code_gen_t cg, unsigned int expiration)
try: (thinlto_codegen_set_cache_entry_expiration:=dll.thinlto_codegen_set_cache_entry_expiration).restype,thinlto_codegen_set_cache_entry_expiration.argtypes = None,[thinlto_code_gen_t, ctypes.c_uint]
except AttributeError: pass

# extern void thinlto_codegen_set_cache_size_bytes(thinlto_code_gen_t cg, unsigned int max_size_bytes)
try: (thinlto_codegen_set_cache_size_bytes:=dll.thinlto_codegen_set_cache_size_bytes).restype,thinlto_codegen_set_cache_size_bytes.argtypes = None,[thinlto_code_gen_t, ctypes.c_uint]
except AttributeError: pass

# extern void thinlto_codegen_set_cache_size_megabytes(thinlto_code_gen_t cg, unsigned int max_size_megabytes)
try: (thinlto_codegen_set_cache_size_megabytes:=dll.thinlto_codegen_set_cache_size_megabytes).restype,thinlto_codegen_set_cache_size_megabytes.argtypes = None,[thinlto_code_gen_t, ctypes.c_uint]
except AttributeError: pass

# extern void thinlto_codegen_set_cache_size_files(thinlto_code_gen_t cg, unsigned int max_size_files)
try: (thinlto_codegen_set_cache_size_files:=dll.thinlto_codegen_set_cache_size_files).restype,thinlto_codegen_set_cache_size_files.argtypes = None,[thinlto_code_gen_t, ctypes.c_uint]
except AttributeError: pass

LLVMVerifierFailureAction = CEnum(ctypes.c_uint)
...
try: (LLVMVerifyModule:=dll.LLVMVerifyModule).restype,LLVMVerifyModule.argtypes = LLVMBool,[LLVMModuleRef, LLVMVerifierFailureAction, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
LLVMComdatSelectionKind = CEnum(ctypes.c_uint)
...
try: (LLVMGetOrInsertComdat:=dll.LLVMGetOrInsertComdat).restype,LLVMGetOrInsertComdat.argtypes = LLVMComdatRef,[LLVMModuleRef, ctypes.c_char_p]
except AttributeError: pass
...
try: (LLVMParseBitcode:=dll.LLVMParseBitcode).restype,LLVMParseBitcode.argtypes = LLVMBool,[LLVMMemoryBufferRef, ctypes.POINTER(LLVMModuleRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMParseBitcodeInContext:=dll.LLVMParseBitcodeInContext).restype,LLVMParseBitcodeInContext.argtypes = LLVMBool,[LLVMContextRef, LLVMMemoryBufferRef, ctypes.POINTER(LLVMModuleRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMGetBitcodeModuleInContext:=dll.LLVMGetBitcodeModuleInContext).restype,LLVMGetBitcodeModuleInContext.argtypes = LLVMBool,[LLVMContextRef, LLVMMemoryBufferRef, ctypes.POINTER(LLVMModuleRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMGetBitcodeModule:=dll.LLVMGetBitcodeModule).restype,LLVMGetBitcodeModule.argtypes = LLVMBool,[LLVMMemoryBufferRef, ctypes.POINTER(LLVMModuleRef), ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (LLVMAddAggressiveDCEPass:=dll.LLVMAddAggressiveDCEPass).restype,LLVMAddAggressiveDCEPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddDCEPass(LLVMPassManagerRef PM)
try: (LLVMAddDCEPass:=dll.LLVMAddDCEPass).restype,LLVMAddDCEPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddBitTrackingDCEPass(LLVMPassManagerRef PM)
try: (LLVMAddBitTrackingDCEPass:=dll.LLVMAddBitTrackingDCEPass).restype,LLVMAddBitTrackingDCEPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddAlignmentFromAssumptionsPass(LLVMPassManagerRef PM)
try: (LLVMAddAlignmentFromAssumptionsPass:=dll.LLVMAddAlignmentFromAssumptionsPass).restype,LLVMAddAlignmentFromAssumptionsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddCFGSimplificationPass(LLVMPassManagerRef PM)
try: (LLVMAddCFGSimplificationPass:=dll.LLVMAddCFGSimplificationPass).restype,LLVMAddCFGSimplificationPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddDeadStoreEliminationPass(LLVMPassManagerRef PM)
try: (LLVMAddDeadStoreEliminationPass:=dll.LLVMAddDeadStoreEliminationPass).restype,LLVMAddDeadStoreEliminationPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddScalarizerPass(LLVMPassManagerRef PM)
try: (LLVMAddScalarizerPass:=dll.LLVMAddScalarizerPass).restype,LLVMAddScalarizerPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddMergedLoadStoreMotionPass(LLVMPassManagerRef PM)
try: (LLVMAddMergedLoadStoreMotionPass:=dll.LLVMAddMergedLoadStoreMotionPass).restype,LLVMAddMergedLoadStoreMotionPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddGVNPass(LLVMPassManagerRef PM)
try: (LLVMAddGVNPass:=dll.LLVMAddGVNPass).restype,LLVMAddGVNPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddNewGVNPass(LLVMPassManagerRef PM)
try: (LLVMAddNewGVNPass:=dll.LLVMAddNewGVNPass).restype,LLVMAddNewGVNPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddIndVarSimplifyPass(LLVMPassManagerRef PM)
try: (LLVMAddIndVarSimplifyPass:=dll.LLVMAddIndVarSimplifyPass).restype,LLVMAddIndVarSimplifyPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddInstructionCombiningPass(LLVMPassManagerRef PM)
try: (LLVMAddInstructionCombiningPass:=dll.LLVMAddInstructionCombiningPass).restype,LLVMAddInstructionCombiningPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddInstructionSimplifyPass(LLVMPassManagerRef PM)
try: (LLVMAddInstructionSimplifyPass:=dll.LLVMAddInstructionSimplifyPass).restype,LLVMAddInstructionSimplifyPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddJumpThreadingPass(LLVMPassManagerRef PM)
try: (LLVMAddJumpThreadingPass:=dll.LLVMAddJumpThreadingPass).restype,LLVMAddJumpThreadingPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLICMPass(LLVMPassManagerRef PM)
try: (LLVMAddLICMPass:=dll.LLVMAddLICMPass).restype,LLVMAddLICMPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopDeletionPass(LLVMPassManagerRef PM)
try: (LLVMAddLoopDeletionPass:=dll.LLVMAddLoopDeletionPass).restype,LLVMAddLoopDeletionPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopIdiomPass(LLVMPassManagerRef PM)
try: (LLVMAddLoopIdiomPass:=dll.LLVMAddLoopIdiomPass).restype,LLVMAddLoopIdiomPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopRotatePass(LLVMPassManagerRef PM)
try: (LLVMAddLoopRotatePass:=dll.LLVMAddLoopRotatePass).restype,LLVMAddLoopRotatePass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopRerollPass(LLVMPassManagerRef PM)
try: (LLVMAddLoopRerollPass:=dll.LLVMAddLoopRerollPass).restype,LLVMAddLoopRerollPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopUnrollPass(LLVMPassManagerRef PM)
try: (LLVMAddLoopUnrollPass:=dll.LLVMAddLoopUnrollPass).restype,LLVMAddLoopUnrollPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopUnrollAndJamPass(LLVMPassManagerRef PM)
try: (LLVMAddLoopUnrollAndJamPass:=dll.LLVMAddLoopUnrollAndJamPass).restype,LLVMAddLoopUnrollAndJamPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopUnswitchPass(LLVMPassManagerRef PM)
try: (LLVMAddLoopUnswitchPass:=dll.LLVMAddLoopUnswitchPass).restype,LLVMAddLoopUnswitchPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLowerAtomicPass(LLVMPassManagerRef PM)
try: (LLVMAddLowerAtomicPass:=dll.LLVMAddLowerAtomicPass).restype,LLVMAddLowerAtomicPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddMemCpyOptPass(LLVMPassManagerRef PM)
try: (LLVMAddMemCpyOptPass:=dll.LLVMAddMemCpyOptPass).restype,LLVMAddMemCpyOptPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddPartiallyInlineLibCallsPass(LLVMPassManagerRef PM)
try: (LLVMAddPartiallyInlineLibCallsPass:=dll.LLVMAddPartiallyInlineLibCallsPass).restype,LLVMAddPartiallyInlineLibCallsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddReassociatePass(LLVMPassManagerRef PM)
try: (LLVMAddReassociatePass:=dll.LLVMAddReassociatePass).restype,LLVMAddReassociatePass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddSCCPPass(LLVMPassManagerRef PM)
try: (LLVMAddSCCPPass:=dll.LLVMAddSCCPPass).restype,LLVMAddSCCPPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddScalarReplAggregatesPass(LLVMPassManagerRef PM)
try: (LLVMAddScalarReplAggregatesPass:=dll.LLVMAddScalarReplAggregatesPass).restype,LLVMAddScalarReplAggregatesPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddScalarReplAggregatesPassSSA(LLVMPassManagerRef PM)
try: (LLVMAddScalarReplAggregatesPassSSA:=dll.LLVMAddScalarReplAggregatesPassSSA).restype,LLVMAddScalarReplAggregatesPassSSA.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddScalarReplAggregatesPassWithThreshold(LLVMPassManagerRef PM, int Threshold)
try: (LLVMAddScalarReplAggregatesPassWithThreshold:=dll.LLVMAddScalarReplAggregatesPassWithThreshold).restype,LLVMAddScalarReplAggregatesPassWithThreshold.argtypes = None,[LLVMPassManagerRef, ctypes.c_int]
except AttributeError: pass

# void LLVMAddSimplifyLibCallsPass(LLVMPassManagerRef PM)
try: (LLVMAddSimplifyLibCallsPass:=dll.LLVMAddSimplifyLibCallsPass).restype,LLVMAddSimplifyLibCallsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddTailCallEliminationPass(LLVMPassManagerRef PM)
try: (LLVMAddTailCallEliminationPass:=dll.LLVMAddTailCallEliminationPass).restype,LLVMAddTailCallEliminationPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddDemoteMemoryToRegisterPass(LLVMPassManagerRef PM)
try: (LLVMAddDemoteMemoryToRegisterPass:=dll.LLVMAddDemoteMemoryToRegisterPass).restype,LLVMAddDemoteMemoryToRegisterPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddVerifierPass(LLVMPassManagerRef PM)
try: (LLVMAddVerifierPass:=dll.LLVMAddVerifierPass).restype,LLVMAddVerifierPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddCorrelatedValuePropagationPass(LLVMPassManagerRef PM)
try: (LLVMAddCorrelatedValuePropagationPass:=dll.LLVMAddCorrelatedValuePropagationPass).restype,LLVMAddCorrelatedValuePropagationPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddEarlyCSEPass(LLVMPassManagerRef PM)
try: (LLVMAddEarlyCSEPass:=dll.LLVMAddEarlyCSEPass).restype,LLVMAddEarlyCSEPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddEarlyCSEMemSSAPass(LLVMPassManagerRef PM)
try: (LLVMAddEarlyCSEMemSSAPass:=dll.LLVMAddEarlyCSEMemSSAPass).restype,LLVMAddEarlyCSEMemSSAPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLowerExpectIntrinsicPass(LLVMPassManagerRef PM)
try: (LLVMAddLowerExpectIntrinsicPass:=dll.LLVMAddLowerExpectIntrinsicPass).restype,LLVMAddLowerExpectIntrinsicPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLowerConstantIntrinsicsPass(LLVMPassManagerRef PM)
try: (LLVMAddLowerConstantIntrinsicsPass:=dll.LLVMAddLowerConstantIntrinsicsPass).restype,LLVMAddLowerConstantIntrinsicsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddTypeBasedAliasAnalysisPass(LLVMPassManagerRef PM)
try: (LLVMAddTypeBasedAliasAnalysisPass:=dll.LLVMAddTypeBasedAliasAnalysisPass).restype,LLVMAddTypeBasedAliasAnalysisPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddScopedNoAliasAAPass(LLVMPassManagerRef PM)
try: (LLVMAddScopedNoAliasAAPass:=dll.LLVMAddScopedNoAliasAAPass).restype,LLVMAddScopedNoAliasAAPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddBasicAliasAnalysisPass(LLVMPassManagerRef PM)
try: (LLVMAddBasicAliasAnalysisPass:=dll.LLVMAddBasicAliasAnalysisPass).restype,LLVMAddBasicAliasAnalysisPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddUnifyFunctionExitNodesPass(LLVMPassManagerRef PM)
try: (LLVMAddUnifyFunctionExitNodesPass:=dll.LLVMAddUnifyFunctionExitNodesPass).restype,LLVMAddUnifyFunctionExitNodesPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddAggressiveInstCombinerPass(LLVMPassManagerRef PM)
try: (LLVMAddAggressiveInstCombinerPass:=dll.LLVMAddAggressiveInstCombinerPass).restype,LLVMAddAggressiveInstCombinerPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

class struct_LLVMOpaquePassBuilderOptions(ctypes.Structure): pass
struct_LLVMOpaquePassBuilderOptions._fields_ = []
...
try: (LLVMRunPasses:=dll.LLVMRunPasses).restype,LLVMRunPasses.argtypes = LLVMErrorRef,[LLVMModuleRef, ctypes.c_char_p, LLVMTargetMachineRef, LLVMPassBuilderOptionsRef]
except AttributeError: pass
...
try: (LLVMPassBuilderOptionsSetLicmMssaOptCap:=dll.LLVMPassBuilderOptionsSetLicmMssaOptCap).restype,LLVMPassBuilderOptionsSetLicmMssaOptCap.argtypes = None,[LLVMPassBuilderOptionsRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMPassBuilderOptionsSetLicmMssaNoAccForPromotionCap:=dll.LLVMPassBuilderOptionsSetLicmMssaNoAccForPromotionCap).restype,LLVMPassBuilderOptionsSetLicmMssaNoAccForPromotionCap.argtypes = None,[LLVMPassBuilderOptionsRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMAddArgumentPromotionPass:=dll.LLVMAddArgumentPromotionPass).restype,LLVMAddArgumentPromotionPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddConstantMergePass(LLVMPassManagerRef PM)
try: (LLVMAddConstantMergePass:=dll.LLVMAddConstantMergePass).restype,LLVMAddConstantMergePass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddMergeFunctionsPass(LLVMPassManagerRef PM)
try: (LLVMAddMergeFunctionsPass:=dll.LLVMAddMergeFunctionsPass).restype,LLVMAddMergeFunctionsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddCalledValuePropagationPass(LLVMPassManagerRef PM)
try: (LLVMAddCalledValuePropagationPass:=dll.LLVMAddCalledValuePropagationPass).restype,LLVMAddCalledValuePropagationPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddDeadArgEliminationPass(LLVMPassManagerRef PM)
try: (LLVMAddDeadArgEliminationPass:=dll.LLVMAddDeadArgEliminationPass).restype,LLVMAddDeadArgEliminationPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddFunctionAttrsPass(LLVMPassManagerRef PM)
try: (LLVMAddFunctionAttrsPass:=dll.LLVMAddFunctionAttrsPass).restype,LLVMAddFunctionAttrsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddFunctionInliningPass(LLVMPassManagerRef PM)
try: (LLVMAddFunctionInliningPass:=dll.LLVMAddFunctionInliningPass).restype,LLVMAddFunctionInliningPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddAlwaysInlinerPass(LLVMPassManagerRef PM)
try: (LLVMAddAlwaysInlinerPass:=dll.LLVMAddAlwaysInlinerPass).restype,LLVMAddAlwaysInlinerPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddGlobalDCEPass(LLVMPassManagerRef PM)
try: (LLVMAddGlobalDCEPass:=dll.LLVMAddGlobalDCEPass).restype,LLVMAddGlobalDCEPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddGlobalOptimizerPass(LLVMPassManagerRef PM)
try: (LLVMAddGlobalOptimizerPass:=dll.LLVMAddGlobalOptimizerPass).restype,LLVMAddGlobalOptimizerPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddPruneEHPass(LLVMPassManagerRef PM)
try: (LLVMAddPruneEHPass:=dll.LLVMAddPruneEHPass).restype,LLVMAddPruneEHPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddIPSCCPPass(LLVMPassManagerRef PM)
try: (LLVMAddIPSCCPPass:=dll.LLVMAddIPSCCPPass).restype,LLVMAddIPSCCPPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddInternalizePass(LLVMPassManagerRef, unsigned int AllButMain)
try: (LLVMAddInternalizePass:=dll.LLVMAddInternalizePass).restype,LLVMAddInternalizePass.argtypes = None,[LLVMPassManagerRef, ctypes.c_uint]
except AttributeError: pass
...
try: (LLVMAddInternalizePassWithMustPreservePredicate:=dll.LLVMAddInternalizePassWithMustPreservePredicate).restype,LLVMAddInternalizePassWithMustPreservePredicate.argtypes = None,[LLVMPassManagerRef, ctypes.c_void_p, ctypes.POINTER(ctypes.CFUNCTYPE(LLVMBool, LLVMValueRef, ctypes.c_void_p))]
except AttributeError: pass

# void LLVMAddStripDeadPrototypesPass(LLVMPassManagerRef PM)
try: (LLVMAddStripDeadPrototypesPass:=dll.LLVMAddStripDeadPrototypesPass).restype,LLVMAddStripDeadPrototypesPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddStripSymbolsPass(LLVMPassManagerRef PM)
try: (LLVMAddStripSymbolsPass:=dll.LLVMAddStripSymbolsPass).restype,LLVMAddStripSymbolsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLowerSwitchPass(LLVMPassManagerRef PM)
try: (LLVMAddLowerSwitchPass:=dll.LLVMAddLowerSwitchPass).restype,LLVMAddLowerSwitchPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddPromoteMemoryToRegisterPass(LLVMPassManagerRef PM)
try: (LLVMAddPromoteMemoryToRegisterPass:=dll.LLVMAddPromoteMemoryToRegisterPass).restype,LLVMAddPromoteMemoryToRegisterPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddAddDiscriminatorsPass(LLVMPassManagerRef PM)
try: (LLVMAddAddDiscriminatorsPass:=dll.LLVMAddAddDiscriminatorsPass).restype,LLVMAddAddDiscriminatorsPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddLoopVectorizePass(LLVMPassManagerRef PM)
try: (LLVMAddLoopVectorizePass:=dll.LLVMAddLoopVectorizePass).restype,LLVMAddLoopVectorizePass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddSLPVectorizePass(LLVMPassManagerRef PM)
try: (LLVMAddSLPVectorizePass:=dll.LLVMAddSLPVectorizePass).restype,LLVMAddSLPVectorizePass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddCoroEarlyPass(LLVMPassManagerRef PM)
try: (LLVMAddCoroEarlyPass:=dll.LLVMAddCoroEarlyPass).restype,LLVMAddCoroEarlyPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddCoroSplitPass(LLVMPassManagerRef PM)
try: (LLVMAddCoroSplitPass:=dll.LLVMAddCoroSplitPass).restype,LLVMAddCoroSplitPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddCoroElidePass(LLVMPassManagerRef PM)
try: (LLVMAddCoroElidePass:=dll.LLVMAddCoroElidePass).restype,LLVMAddCoroElidePass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

# void LLVMAddCoroCleanupPass(LLVMPassManagerRef PM)
try: (LLVMAddCoroCleanupPass:=dll.LLVMAddCoroCleanupPass).restype,LLVMAddCoroCleanupPass.argtypes = None,[LLVMPassManagerRef]
except AttributeError: pass

class struct_LLVMOpaquePassManagerBuilder(ctypes.Structure): pass
struct_LLVMOpaquePassManagerBuilder._fields_ = []
...
try: (LLVMPassManagerBuilderAddCoroutinePassesToExtensionPoints:=dll.LLVMPassManagerBuilderAddCoroutinePassesToExtensionPoints).restype,LLVMPassManagerBuilderAddCoroutinePassesToExtensionPoints.argtypes = None,[LLVMPassManagerBuilderRef]
except AttributeError: pass

# LLVMPassManagerBuilderRef LLVMPassManagerBuilderCreate(void)
try: (LLVMPassManagerBuilderCreate:=dll.LLVMPassManagerBuilderCreate).restype,LLVMPassManagerBuilderCreate.argtypes = LLVMPassManagerBuilderRef,[]
except AttributeError: pass

# void LLVMPassManagerBuilderDispose(LLVMPassManagerBuilderRef PMB)
try: (LLVMPassManagerBuilderDispose:=dll.LLVMPassManagerBuilderDispose).restype,LLVMPassManagerBuilderDispose.argtypes = None,[LLVMPassManagerBuilderRef]
except AttributeError: pass

# void LLVMPassManagerBuilderSetOptLevel(LLVMPassManagerBuilderRef PMB, unsigned int OptLevel)
try: (LLVMPassManagerBuilderSetOptLevel:=dll.LLVMPassManagerBuilderSetOptLevel).restype,LLVMPassManagerBuilderSetOptLevel.argtypes = None,[LLVMPassManagerBuilderRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMPassManagerBuilderSetSizeLevel(LLVMPassManagerBuilderRef PMB, unsigned int SizeLevel)
try: (LLVMPassManagerBuilderSetSizeLevel:=dll.LLVMPassManagerBuilderSetSizeLevel).restype,LLVMPassManagerBuilderSetSizeLevel.argtypes = None,[LLVMPassManagerBuilderRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMPassManagerBuilderSetDisableUnitAtATime(LLVMPassManagerBuilderRef PMB, LLVMBool Value)
try: (LLVMPassManagerBuilderSetDisableUnitAtATime:=dll.LLVMPassManagerBuilderSetDisableUnitAtATime).restype,LLVMPassManagerBuilderSetDisableUnitAtATime.argtypes = None,[LLVMPassManagerBuilderRef, LLVMBool]
except AttributeError: pass

# void LLVMPassManagerBuilderSetDisableUnrollLoops(LLVMPassManagerBuilderRef PMB, LLVMBool Value)
try: (LLVMPassManagerBuilderSetDisableUnrollLoops:=dll.LLVMPassManagerBuilderSetDisableUnrollLoops).restype,LLVMPassManagerBuilderSetDisableUnrollLoops.argtypes = None,[LLVMPassManagerBuilderRef, LLVMBool]
except AttributeError: pass

# void LLVMPassManagerBuilderSetDisableSimplifyLibCalls(LLVMPassManagerBuilderRef PMB, LLVMBool Value)
try: (LLVMPassManagerBuilderSetDisableSimplifyLibCalls:=dll.LLVMPassManagerBuilderSetDisableSimplifyLibCalls).restype,LLVMPassManagerBuilderSetDisableSimplifyLibCalls.argtypes = None,[LLVMPassManagerBuilderRef, LLVMBool]
except AttributeError: pass

# void LLVMPassManagerBuilderUseInlinerWithThreshold(LLVMPassManagerBuilderRef PMB, unsigned int Threshold)
try: (LLVMPassManagerBuilderUseInlinerWithThreshold:=dll.LLVMPassManagerBuilderUseInlinerWithThreshold).restype,LLVMPassManagerBuilderUseInlinerWithThreshold.argtypes = None,[LLVMPassManagerBuilderRef, ctypes.c_uint]
except AttributeError: pass

# void LLVMPassManagerBuilderPopulateFunctionPassManager(LLVMPassManagerBuilderRef PMB, LLVMPassManagerRef PM)
try: (LLVMPassManagerBuilderPopulateFunctionPassManager:=dll.LLVMPassManagerBuilderPopulateFunctionPassManager).restype,LLVMPassManagerBuilderPopulateFunctionPassManager.argtypes = None,[LLVMPassManagerBuilderRef, LLVMPassManagerRef]
except AttributeError: pass

# void LLVMPassManagerBuilderPopulateModulePassManager(LLVMPassManagerBuilderRef PMB, LLVMPassManagerRef PM)
try: (LLVMPassManagerBuilderPopulateModulePassManager:=dll.LLVMPassManagerBuilderPopulateModulePassManager).restype,LLVMPassManagerBuilderPopulateModulePassManager.argtypes = None,[LLVMPassManagerBuilderRef, LLVMPassManagerRef]
except AttributeError: pass
...
try: (LLVMPassManagerBuilderPopulateLTOPassManager:=dll.LLVMPassManagerBuilderPopulateLTOPassManager).restype,LLVMPassManagerBuilderPopulateLTOPassManager.argtypes = None,[LLVMPassManagerBuilderRef, LLVMPassManagerRef, LLVMBool, LLVMBool]
except AttributeError: pass
