...
try: (strtoimax:=dll.strtoimax).restype, strtoimax.argtypes = intmax_t, [Pointer(ctypes.c_char), Pointer(Pointer(ctypes.c_char)), ctypes.c_int32]
except AttributeError: pass

uintmax_t = ctypes.c_uint64
try: (strtoumax:=dll.strtoumax).restype, strtoumax.argtypes = uintmax_t, [Pointer(ctypes.c_char), Pointer(Pointer(ctypes.c_char)), ctypes.c_int32]
except AttributeError: pass

__gwchar_t = ctypes.c_int32
try: (wcstoimax:=dll.wcstoimax).restype, wcstoimax.argtypes = intmax_t, [Pointer(ctypes.c_int32), Pointer(Pointer(ctypes.c_int32)), ctypes.c_int32]
except AttributeError: pass

try: (wcstoumax:=dll.wcstoumax).restype, wcstoumax.argtypes = uintmax_t, [Pointer(ctypes.c_int32), Pointer(Pointer(ctypes.c_int32)), ctypes.c_int32]
except AttributeError: pass
...
try: (select:=dll.select).restype, select.argtypes = ctypes.c_int32, [ctypes.c_int32, Pointer(fd_set), Pointer(fd_set), Pointer(fd_set), Pointer(struct_timeval)]
except AttributeError: pass
...
try: (pselect:=dll.pselect).restype, pselect.argtypes = ctypes.c_int32, [ctypes.c_int32, Pointer(fd_set), Pointer(fd_set), Pointer(fd_set), Pointer(struct_timespec), Pointer(__sigset_t)]
except AttributeError: pass
...
try: (LLVMVerifyModule:=dll.LLVMVerifyModule).restype, LLVMVerifyModule.argtypes = LLVMBool, [LLVMModuleRef, LLVMVerifierFailureAction, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass
...
try: (LLVMParseBitcode:=dll.LLVMParseBitcode).restype, LLVMParseBitcode.argtypes = LLVMBool, [LLVMMemoryBufferRef, Pointer(LLVMModuleRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMParseBitcode2:=dll.LLVMParseBitcode2).restype, LLVMParseBitcode2.argtypes = LLVMBool, [LLVMMemoryBufferRef, Pointer(LLVMModuleRef)]
except AttributeError: pass

class struct_LLVMOpaqueContext(Struct): pass
LLVMContextRef = Pointer(struct_LLVMOpaqueContext)
try: (LLVMParseBitcodeInContext:=dll.LLVMParseBitcodeInContext).restype, LLVMParseBitcodeInContext.argtypes = LLVMBool, [LLVMContextRef, LLVMMemoryBufferRef, Pointer(LLVMModuleRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMParseBitcodeInContext2:=dll.LLVMParseBitcodeInContext2).restype, LLVMParseBitcodeInContext2.argtypes = LLVMBool, [LLVMContextRef, LLVMMemoryBufferRef, Pointer(LLVMModuleRef)]
except AttributeError: pass

try: (LLVMGetBitcodeModuleInContext:=dll.LLVMGetBitcodeModuleInContext).restype, LLVMGetBitcodeModuleInContext.argtypes = LLVMBool, [LLVMContextRef, LLVMMemoryBufferRef, Pointer(LLVMModuleRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMGetBitcodeModuleInContext2:=dll.LLVMGetBitcodeModuleInContext2).restype, LLVMGetBitcodeModuleInContext2.argtypes = LLVMBool, [LLVMContextRef, LLVMMemoryBufferRef, Pointer(LLVMModuleRef)]
except AttributeError: pass

try: (LLVMGetBitcodeModule:=dll.LLVMGetBitcodeModule).restype, LLVMGetBitcodeModule.argtypes = LLVMBool, [LLVMMemoryBufferRef, Pointer(LLVMModuleRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMGetBitcodeModule2:=dll.LLVMGetBitcodeModule2).restype, LLVMGetBitcodeModule2.argtypes = LLVMBool, [LLVMMemoryBufferRef, Pointer(LLVMModuleRef)]
except AttributeError: pass
...
try: (LLVMWriteBitcodeToFile:=dll.LLVMWriteBitcodeToFile).restype, LLVMWriteBitcodeToFile.argtypes = ctypes.c_int32, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMGetOrInsertComdat:=dll.LLVMGetOrInsertComdat).restype, LLVMGetOrInsertComdat.argtypes = LLVMComdatRef, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMGetVersion:=dll.LLVMGetVersion).restype, LLVMGetVersion.argtypes = None, [Pointer(ctypes.c_uint32), Pointer(ctypes.c_uint32), Pointer(ctypes.c_uint32)]
except AttributeError: pass

try: (LLVMCreateMessage:=dll.LLVMCreateMessage).restype, LLVMCreateMessage.argtypes = Pointer(ctypes.c_char), [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMDisposeMessage:=dll.LLVMDisposeMessage).restype, LLVMDisposeMessage.argtypes = None, [Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMGetDiagInfoDescription:=dll.LLVMGetDiagInfoDescription).restype, LLVMGetDiagInfoDescription.argtypes = Pointer(ctypes.c_char), [LLVMDiagnosticInfoRef]
except AttributeError: pass
...
try: (LLVMGetMDKindIDInContext:=dll.LLVMGetMDKindIDInContext).restype, LLVMGetMDKindIDInContext.argtypes = ctypes.c_uint32, [LLVMContextRef, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMGetMDKindID:=dll.LLVMGetMDKindID).restype, LLVMGetMDKindID.argtypes = ctypes.c_uint32, [Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass

size_t = ctypes.c_uint64
try: (LLVMGetSyncScopeID:=dll.LLVMGetSyncScopeID).restype, LLVMGetSyncScopeID.argtypes = ctypes.c_uint32, [LLVMContextRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMGetEnumAttributeKindForName:=dll.LLVMGetEnumAttributeKindForName).restype, LLVMGetEnumAttributeKindForName.argtypes = ctypes.c_uint32, [Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMCreateConstantRangeAttribute:=dll.LLVMCreateConstantRangeAttribute).restype, LLVMCreateConstantRangeAttribute.argtypes = LLVMAttributeRef, [LLVMContextRef, ctypes.c_uint32, ctypes.c_uint32, Array(uint64_t, 0), Array(uint64_t, 0)]
except AttributeError: pass

try: (LLVMCreateStringAttribute:=dll.LLVMCreateStringAttribute).restype, LLVMCreateStringAttribute.argtypes = LLVMAttributeRef, [LLVMContextRef, Pointer(ctypes.c_char), ctypes.c_uint32, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMGetStringAttributeKind:=dll.LLVMGetStringAttributeKind).restype, LLVMGetStringAttributeKind.argtypes = Pointer(ctypes.c_char), [LLVMAttributeRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass

try: (LLVMGetStringAttributeValue:=dll.LLVMGetStringAttributeValue).restype, LLVMGetStringAttributeValue.argtypes = Pointer(ctypes.c_char), [LLVMAttributeRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass
...
try: (LLVMGetTypeByName2:=dll.LLVMGetTypeByName2).restype, LLVMGetTypeByName2.argtypes = LLVMTypeRef, [LLVMContextRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMModuleCreateWithName:=dll.LLVMModuleCreateWithName).restype, LLVMModuleCreateWithName.argtypes = LLVMModuleRef, [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMModuleCreateWithNameInContext:=dll.LLVMModuleCreateWithNameInContext).restype, LLVMModuleCreateWithNameInContext.argtypes = LLVMModuleRef, [Pointer(ctypes.c_char), LLVMContextRef]
except AttributeError: pass
...
try: (LLVMGetModuleIdentifier:=dll.LLVMGetModuleIdentifier).restype, LLVMGetModuleIdentifier.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMSetModuleIdentifier:=dll.LLVMSetModuleIdentifier).restype, LLVMSetModuleIdentifier.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMGetSourceFileName:=dll.LLVMGetSourceFileName).restype, LLVMGetSourceFileName.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMSetSourceFileName:=dll.LLVMSetSourceFileName).restype, LLVMSetSourceFileName.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMGetDataLayoutStr:=dll.LLVMGetDataLayoutStr).restype, LLVMGetDataLayoutStr.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef]
except AttributeError: pass

try: (LLVMGetDataLayout:=dll.LLVMGetDataLayout).restype, LLVMGetDataLayout.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef]
except AttributeError: pass

try: (LLVMSetDataLayout:=dll.LLVMSetDataLayout).restype, LLVMSetDataLayout.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetTarget:=dll.LLVMGetTarget).restype, LLVMGetTarget.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef]
except AttributeError: pass

try: (LLVMSetTarget:=dll.LLVMSetTarget).restype, LLVMSetTarget.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass

class struct_LLVMOpaqueModuleFlagEntry(Struct): pass
LLVMModuleFlagEntry = struct_LLVMOpaqueModuleFlagEntry
try: (LLVMCopyModuleFlagsMetadata:=dll.LLVMCopyModuleFlagsMetadata).restype, LLVMCopyModuleFlagsMetadata.argtypes = Pointer(LLVMModuleFlagEntry), [LLVMModuleRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMDisposeModuleFlagsMetadata:=dll.LLVMDisposeModuleFlagsMetadata).restype, LLVMDisposeModuleFlagsMetadata.argtypes = None, [Pointer(LLVMModuleFlagEntry)]
except AttributeError: pass

try: (LLVMModuleFlagEntriesGetFlagBehavior:=dll.LLVMModuleFlagEntriesGetFlagBehavior).restype, LLVMModuleFlagEntriesGetFlagBehavior.argtypes = LLVMModuleFlagBehavior, [Pointer(LLVMModuleFlagEntry), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMModuleFlagEntriesGetKey:=dll.LLVMModuleFlagEntriesGetKey).restype, LLVMModuleFlagEntriesGetKey.argtypes = Pointer(ctypes.c_char), [Pointer(LLVMModuleFlagEntry), ctypes.c_uint32, Pointer(size_t)]
except AttributeError: pass

class struct_LLVMOpaqueMetadata(Struct): pass
LLVMMetadataRef = Pointer(struct_LLVMOpaqueMetadata)
try: (LLVMModuleFlagEntriesGetMetadata:=dll.LLVMModuleFlagEntriesGetMetadata).restype, LLVMModuleFlagEntriesGetMetadata.argtypes = LLVMMetadataRef, [Pointer(LLVMModuleFlagEntry), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMGetModuleFlag:=dll.LLVMGetModuleFlag).restype, LLVMGetModuleFlag.argtypes = LLVMMetadataRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMAddModuleFlag:=dll.LLVMAddModuleFlag).restype, LLVMAddModuleFlag.argtypes = None, [LLVMModuleRef, LLVMModuleFlagBehavior, Pointer(ctypes.c_char), size_t, LLVMMetadataRef]
except AttributeError: pass

try: (LLVMDumpModule:=dll.LLVMDumpModule).restype, LLVMDumpModule.argtypes = None, [LLVMModuleRef]
except AttributeError: pass

try: (LLVMPrintModuleToFile:=dll.LLVMPrintModuleToFile).restype, LLVMPrintModuleToFile.argtypes = LLVMBool, [LLVMModuleRef, Pointer(ctypes.c_char), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMPrintModuleToString:=dll.LLVMPrintModuleToString).restype, LLVMPrintModuleToString.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef]
except AttributeError: pass

try: (LLVMGetModuleInlineAsm:=dll.LLVMGetModuleInlineAsm).restype, LLVMGetModuleInlineAsm.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMSetModuleInlineAsm2:=dll.LLVMSetModuleInlineAsm2).restype, LLVMSetModuleInlineAsm2.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMAppendModuleInlineAsm:=dll.LLVMAppendModuleInlineAsm).restype, LLVMAppendModuleInlineAsm.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMGetInlineAsm:=dll.LLVMGetInlineAsm).restype, LLVMGetInlineAsm.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t, LLVMBool, LLVMBool, LLVMInlineAsmDialect, LLVMBool]
except AttributeError: pass

try: (LLVMGetInlineAsmAsmString:=dll.LLVMGetInlineAsmAsmString).restype, LLVMGetInlineAsmAsmString.argtypes = Pointer(ctypes.c_char), [LLVMValueRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMGetInlineAsmConstraintString:=dll.LLVMGetInlineAsmConstraintString).restype, LLVMGetInlineAsmConstraintString.argtypes = Pointer(ctypes.c_char), [LLVMValueRef, Pointer(size_t)]
except AttributeError: pass
...
try: (LLVMGetTypeByName:=dll.LLVMGetTypeByName).restype, LLVMGetTypeByName.argtypes = LLVMTypeRef, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMGetNamedMetadata:=dll.LLVMGetNamedMetadata).restype, LLVMGetNamedMetadata.argtypes = LLVMNamedMDNodeRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMGetOrInsertNamedMetadata:=dll.LLVMGetOrInsertNamedMetadata).restype, LLVMGetOrInsertNamedMetadata.argtypes = LLVMNamedMDNodeRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMGetNamedMetadataName:=dll.LLVMGetNamedMetadataName).restype, LLVMGetNamedMetadataName.argtypes = Pointer(ctypes.c_char), [LLVMNamedMDNodeRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMGetNamedMetadataNumOperands:=dll.LLVMGetNamedMetadataNumOperands).restype, LLVMGetNamedMetadataNumOperands.argtypes = ctypes.c_uint32, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetNamedMetadataOperands:=dll.LLVMGetNamedMetadataOperands).restype, LLVMGetNamedMetadataOperands.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char), Pointer(LLVMValueRef)]
except AttributeError: pass

try: (LLVMAddNamedMetadataOperand:=dll.LLVMAddNamedMetadataOperand).restype, LLVMAddNamedMetadataOperand.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char), LLVMValueRef]
except AttributeError: pass

try: (LLVMGetDebugLocDirectory:=dll.LLVMGetDebugLocDirectory).restype, LLVMGetDebugLocDirectory.argtypes = Pointer(ctypes.c_char), [LLVMValueRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass

try: (LLVMGetDebugLocFilename:=dll.LLVMGetDebugLocFilename).restype, LLVMGetDebugLocFilename.argtypes = Pointer(ctypes.c_char), [LLVMValueRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass
...
try: (LLVMAddFunction:=dll.LLVMAddFunction).restype, LLVMAddFunction.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char), LLVMTypeRef]
except AttributeError: pass

try: (LLVMGetNamedFunction:=dll.LLVMGetNamedFunction).restype, LLVMGetNamedFunction.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetNamedFunctionWithLength:=dll.LLVMGetNamedFunctionWithLength).restype, LLVMGetNamedFunctionWithLength.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMSetModuleInlineAsm:=dll.LLVMSetModuleInlineAsm).restype, LLVMSetModuleInlineAsm.argtypes = None, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMPrintTypeToString:=dll.LLVMPrintTypeToString).restype, LLVMPrintTypeToString.argtypes = Pointer(ctypes.c_char), [LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMFunctionType:=dll.LLVMFunctionType).restype, LLVMFunctionType.argtypes = LLVMTypeRef, [LLVMTypeRef, Pointer(LLVMTypeRef), ctypes.c_uint32, LLVMBool]
except AttributeError: pass
...
try: (LLVMGetParamTypes:=dll.LLVMGetParamTypes).restype, LLVMGetParamTypes.argtypes = None, [LLVMTypeRef, Pointer(LLVMTypeRef)]
except AttributeError: pass

try: (LLVMStructTypeInContext:=dll.LLVMStructTypeInContext).restype, LLVMStructTypeInContext.argtypes = LLVMTypeRef, [LLVMContextRef, Pointer(LLVMTypeRef), ctypes.c_uint32, LLVMBool]
except AttributeError: pass

try: (LLVMStructType:=dll.LLVMStructType).restype, LLVMStructType.argtypes = LLVMTypeRef, [Pointer(LLVMTypeRef), ctypes.c_uint32, LLVMBool]
except AttributeError: pass

try: (LLVMStructCreateNamed:=dll.LLVMStructCreateNamed).restype, LLVMStructCreateNamed.argtypes = LLVMTypeRef, [LLVMContextRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetStructName:=dll.LLVMGetStructName).restype, LLVMGetStructName.argtypes = Pointer(ctypes.c_char), [LLVMTypeRef]
except AttributeError: pass

try: (LLVMStructSetBody:=dll.LLVMStructSetBody).restype, LLVMStructSetBody.argtypes = None, [LLVMTypeRef, Pointer(LLVMTypeRef), ctypes.c_uint32, LLVMBool]
except AttributeError: pass
...
try: (LLVMGetStructElementTypes:=dll.LLVMGetStructElementTypes).restype, LLVMGetStructElementTypes.argtypes = None, [LLVMTypeRef, Pointer(LLVMTypeRef)]
except AttributeError: pass
...
try: (LLVMGetSubtypes:=dll.LLVMGetSubtypes).restype, LLVMGetSubtypes.argtypes = None, [LLVMTypeRef, Pointer(LLVMTypeRef)]
except AttributeError: pass
...
try: (LLVMTargetExtTypeInContext:=dll.LLVMTargetExtTypeInContext).restype, LLVMTargetExtTypeInContext.argtypes = LLVMTypeRef, [LLVMContextRef, Pointer(ctypes.c_char), Pointer(LLVMTypeRef), ctypes.c_uint32, Pointer(ctypes.c_uint32), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMGetTargetExtTypeName:=dll.LLVMGetTargetExtTypeName).restype, LLVMGetTargetExtTypeName.argtypes = Pointer(ctypes.c_char), [LLVMTypeRef]
except AttributeError: pass
...
try: (LLVMGetValueName2:=dll.LLVMGetValueName2).restype, LLVMGetValueName2.argtypes = Pointer(ctypes.c_char), [LLVMValueRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMSetValueName2:=dll.LLVMSetValueName2).restype, LLVMSetValueName2.argtypes = None, [LLVMValueRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDumpValue:=dll.LLVMDumpValue).restype, LLVMDumpValue.argtypes = None, [LLVMValueRef]
except AttributeError: pass

try: (LLVMPrintValueToString:=dll.LLVMPrintValueToString).restype, LLVMPrintValueToString.argtypes = Pointer(ctypes.c_char), [LLVMValueRef]
except AttributeError: pass
...
try: (LLVMPrintDbgRecordToString:=dll.LLVMPrintDbgRecordToString).restype, LLVMPrintDbgRecordToString.argtypes = Pointer(ctypes.c_char), [LLVMDbgRecordRef]
except AttributeError: pass
...
try: (LLVMGetValueName:=dll.LLVMGetValueName).restype, LLVMGetValueName.argtypes = Pointer(ctypes.c_char), [LLVMValueRef]
except AttributeError: pass

try: (LLVMSetValueName:=dll.LLVMSetValueName).restype, LLVMSetValueName.argtypes = None, [LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMConstIntOfArbitraryPrecision:=dll.LLVMConstIntOfArbitraryPrecision).restype, LLVMConstIntOfArbitraryPrecision.argtypes = LLVMValueRef, [LLVMTypeRef, ctypes.c_uint32, Array(uint64_t, 0)]
except AttributeError: pass

uint8_t = ctypes.c_ubyte
try: (LLVMConstIntOfString:=dll.LLVMConstIntOfString).restype, LLVMConstIntOfString.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(ctypes.c_char), uint8_t]
except AttributeError: pass

try: (LLVMConstIntOfStringAndSize:=dll.LLVMConstIntOfStringAndSize).restype, LLVMConstIntOfStringAndSize.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(ctypes.c_char), ctypes.c_uint32, uint8_t]
except AttributeError: pass

try: (LLVMConstReal:=dll.LLVMConstReal).restype, LLVMConstReal.argtypes = LLVMValueRef, [LLVMTypeRef, ctypes.c_double]
except AttributeError: pass

try: (LLVMConstRealOfString:=dll.LLVMConstRealOfString).restype, LLVMConstRealOfString.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMConstRealOfStringAndSize:=dll.LLVMConstRealOfStringAndSize).restype, LLVMConstRealOfStringAndSize.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMConstRealGetDouble:=dll.LLVMConstRealGetDouble).restype, LLVMConstRealGetDouble.argtypes = ctypes.c_double, [LLVMValueRef, Pointer(LLVMBool)]
except AttributeError: pass

try: (LLVMConstStringInContext:=dll.LLVMConstStringInContext).restype, LLVMConstStringInContext.argtypes = LLVMValueRef, [LLVMContextRef, Pointer(ctypes.c_char), ctypes.c_uint32, LLVMBool]
except AttributeError: pass

try: (LLVMConstStringInContext2:=dll.LLVMConstStringInContext2).restype, LLVMConstStringInContext2.argtypes = LLVMValueRef, [LLVMContextRef, Pointer(ctypes.c_char), size_t, LLVMBool]
except AttributeError: pass

try: (LLVMConstString:=dll.LLVMConstString).restype, LLVMConstString.argtypes = LLVMValueRef, [Pointer(ctypes.c_char), ctypes.c_uint32, LLVMBool]
except AttributeError: pass

try: (LLVMIsConstantString:=dll.LLVMIsConstantString).restype, LLVMIsConstantString.argtypes = LLVMBool, [LLVMValueRef]
except AttributeError: pass

try: (LLVMGetAsString:=dll.LLVMGetAsString).restype, LLVMGetAsString.argtypes = Pointer(ctypes.c_char), [LLVMValueRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMConstStructInContext:=dll.LLVMConstStructInContext).restype, LLVMConstStructInContext.argtypes = LLVMValueRef, [LLVMContextRef, Pointer(LLVMValueRef), ctypes.c_uint32, LLVMBool]
except AttributeError: pass

try: (LLVMConstStruct:=dll.LLVMConstStruct).restype, LLVMConstStruct.argtypes = LLVMValueRef, [Pointer(LLVMValueRef), ctypes.c_uint32, LLVMBool]
except AttributeError: pass

try: (LLVMConstArray:=dll.LLVMConstArray).restype, LLVMConstArray.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMConstArray2:=dll.LLVMConstArray2).restype, LLVMConstArray2.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(LLVMValueRef), uint64_t]
except AttributeError: pass

try: (LLVMConstNamedStruct:=dll.LLVMConstNamedStruct).restype, LLVMConstNamedStruct.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMConstVector:=dll.LLVMConstVector).restype, LLVMConstVector.argtypes = LLVMValueRef, [Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMConstGEP2:=dll.LLVMConstGEP2).restype, LLVMConstGEP2.argtypes = LLVMValueRef, [LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMConstInBoundsGEP2:=dll.LLVMConstInBoundsGEP2).restype, LLVMConstInBoundsGEP2.argtypes = LLVMValueRef, [LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMConstGEPWithNoWrapFlags:=dll.LLVMConstGEPWithNoWrapFlags).restype, LLVMConstGEPWithNoWrapFlags.argtypes = LLVMValueRef, [LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, LLVMGEPNoWrapFlags]
except AttributeError: pass
...
try: (LLVMConstInlineAsm:=dll.LLVMConstInlineAsm).restype, LLVMConstInlineAsm.argtypes = LLVMValueRef, [LLVMTypeRef, Pointer(ctypes.c_char), Pointer(ctypes.c_char), LLVMBool, LLVMBool]
except AttributeError: pass
...
try: (LLVMGetSection:=dll.LLVMGetSection).restype, LLVMGetSection.argtypes = Pointer(ctypes.c_char), [LLVMValueRef]
except AttributeError: pass

try: (LLVMSetSection:=dll.LLVMSetSection).restype, LLVMSetSection.argtypes = None, [LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMGlobalCopyAllMetadata:=dll.LLVMGlobalCopyAllMetadata).restype, LLVMGlobalCopyAllMetadata.argtypes = Pointer(LLVMValueMetadataEntry), [LLVMValueRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMDisposeValueMetadataEntries:=dll.LLVMDisposeValueMetadataEntries).restype, LLVMDisposeValueMetadataEntries.argtypes = None, [Pointer(LLVMValueMetadataEntry)]
except AttributeError: pass

try: (LLVMValueMetadataEntriesGetKind:=dll.LLVMValueMetadataEntriesGetKind).restype, LLVMValueMetadataEntriesGetKind.argtypes = ctypes.c_uint32, [Pointer(LLVMValueMetadataEntry), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMValueMetadataEntriesGetMetadata:=dll.LLVMValueMetadataEntriesGetMetadata).restype, LLVMValueMetadataEntriesGetMetadata.argtypes = LLVMMetadataRef, [Pointer(LLVMValueMetadataEntry), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMAddGlobal:=dll.LLVMAddGlobal).restype, LLVMAddGlobal.argtypes = LLVMValueRef, [LLVMModuleRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMAddGlobalInAddressSpace:=dll.LLVMAddGlobalInAddressSpace).restype, LLVMAddGlobalInAddressSpace.argtypes = LLVMValueRef, [LLVMModuleRef, LLVMTypeRef, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMGetNamedGlobal:=dll.LLVMGetNamedGlobal).restype, LLVMGetNamedGlobal.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetNamedGlobalWithLength:=dll.LLVMGetNamedGlobalWithLength).restype, LLVMGetNamedGlobalWithLength.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMAddAlias2:=dll.LLVMAddAlias2).restype, LLVMAddAlias2.argtypes = LLVMValueRef, [LLVMModuleRef, LLVMTypeRef, ctypes.c_uint32, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetNamedGlobalAlias:=dll.LLVMGetNamedGlobalAlias).restype, LLVMGetNamedGlobalAlias.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMLookupIntrinsicID:=dll.LLVMLookupIntrinsicID).restype, LLVMLookupIntrinsicID.argtypes = ctypes.c_uint32, [Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMGetIntrinsicID:=dll.LLVMGetIntrinsicID).restype, LLVMGetIntrinsicID.argtypes = ctypes.c_uint32, [LLVMValueRef]
except AttributeError: pass

try: (LLVMGetIntrinsicDeclaration:=dll.LLVMGetIntrinsicDeclaration).restype, LLVMGetIntrinsicDeclaration.argtypes = LLVMValueRef, [LLVMModuleRef, ctypes.c_uint32, Pointer(LLVMTypeRef), size_t]
except AttributeError: pass

try: (LLVMIntrinsicGetType:=dll.LLVMIntrinsicGetType).restype, LLVMIntrinsicGetType.argtypes = LLVMTypeRef, [LLVMContextRef, ctypes.c_uint32, Pointer(LLVMTypeRef), size_t]
except AttributeError: pass

try: (LLVMIntrinsicGetName:=dll.LLVMIntrinsicGetName).restype, LLVMIntrinsicGetName.argtypes = Pointer(ctypes.c_char), [ctypes.c_uint32, Pointer(size_t)]
except AttributeError: pass

try: (LLVMIntrinsicCopyOverloadedName:=dll.LLVMIntrinsicCopyOverloadedName).restype, LLVMIntrinsicCopyOverloadedName.argtypes = Pointer(ctypes.c_char), [ctypes.c_uint32, Pointer(LLVMTypeRef), size_t, Pointer(size_t)]
except AttributeError: pass

try: (LLVMIntrinsicCopyOverloadedName2:=dll.LLVMIntrinsicCopyOverloadedName2).restype, LLVMIntrinsicCopyOverloadedName2.argtypes = Pointer(ctypes.c_char), [LLVMModuleRef, ctypes.c_uint32, Pointer(LLVMTypeRef), size_t, Pointer(size_t)]
except AttributeError: pass
...
try: (LLVMGetGC:=dll.LLVMGetGC).restype, LLVMGetGC.argtypes = Pointer(ctypes.c_char), [LLVMValueRef]
except AttributeError: pass

try: (LLVMSetGC:=dll.LLVMSetGC).restype, LLVMSetGC.argtypes = None, [LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMGetAttributesAtIndex:=dll.LLVMGetAttributesAtIndex).restype, LLVMGetAttributesAtIndex.argtypes = None, [LLVMValueRef, LLVMAttributeIndex, Pointer(LLVMAttributeRef)]
except AttributeError: pass
...
try: (LLVMGetStringAttributeAtIndex:=dll.LLVMGetStringAttributeAtIndex).restype, LLVMGetStringAttributeAtIndex.argtypes = LLVMAttributeRef, [LLVMValueRef, LLVMAttributeIndex, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMRemoveStringAttributeAtIndex:=dll.LLVMRemoveStringAttributeAtIndex).restype, LLVMRemoveStringAttributeAtIndex.argtypes = None, [LLVMValueRef, LLVMAttributeIndex, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMAddTargetDependentFunctionAttr:=dll.LLVMAddTargetDependentFunctionAttr).restype, LLVMAddTargetDependentFunctionAttr.argtypes = None, [LLVMValueRef, Pointer(ctypes.c_char), Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMCountParams:=dll.LLVMCountParams).restype, LLVMCountParams.argtypes = ctypes.c_uint32, [LLVMValueRef]
except AttributeError: pass

try: (LLVMGetParams:=dll.LLVMGetParams).restype, LLVMGetParams.argtypes = None, [LLVMValueRef, Pointer(LLVMValueRef)]
except AttributeError: pass
...
try: (LLVMAddGlobalIFunc:=dll.LLVMAddGlobalIFunc).restype, LLVMAddGlobalIFunc.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t, LLVMTypeRef, ctypes.c_uint32, LLVMValueRef]
except AttributeError: pass

try: (LLVMGetNamedGlobalIFunc:=dll.LLVMGetNamedGlobalIFunc).restype, LLVMGetNamedGlobalIFunc.argtypes = LLVMValueRef, [LLVMModuleRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMMDStringInContext2:=dll.LLVMMDStringInContext2).restype, LLVMMDStringInContext2.argtypes = LLVMMetadataRef, [LLVMContextRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMMDNodeInContext2:=dll.LLVMMDNodeInContext2).restype, LLVMMDNodeInContext2.argtypes = LLVMMetadataRef, [LLVMContextRef, Pointer(LLVMMetadataRef), size_t]
except AttributeError: pass
...
try: (LLVMGetMDString:=dll.LLVMGetMDString).restype, LLVMGetMDString.argtypes = Pointer(ctypes.c_char), [LLVMValueRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass
...
try: (LLVMGetMDNodeOperands:=dll.LLVMGetMDNodeOperands).restype, LLVMGetMDNodeOperands.argtypes = None, [LLVMValueRef, Pointer(LLVMValueRef)]
except AttributeError: pass
...
try: (LLVMMDStringInContext:=dll.LLVMMDStringInContext).restype, LLVMMDStringInContext.argtypes = LLVMValueRef, [LLVMContextRef, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMMDString:=dll.LLVMMDString).restype, LLVMMDString.argtypes = LLVMValueRef, [Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMMDNodeInContext:=dll.LLVMMDNodeInContext).restype, LLVMMDNodeInContext.argtypes = LLVMValueRef, [LLVMContextRef, Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMMDNode:=dll.LLVMMDNode).restype, LLVMMDNode.argtypes = LLVMValueRef, [Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass

class struct_LLVMOpaqueOperandBundle(Struct): pass
LLVMOperandBundleRef = Pointer(struct_LLVMOpaqueOperandBundle)
try: (LLVMCreateOperandBundle:=dll.LLVMCreateOperandBundle).restype, LLVMCreateOperandBundle.argtypes = LLVMOperandBundleRef, [Pointer(ctypes.c_char), size_t, Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMGetOperandBundleTag:=dll.LLVMGetOperandBundleTag).restype, LLVMGetOperandBundleTag.argtypes = Pointer(ctypes.c_char), [LLVMOperandBundleRef, Pointer(size_t)]
except AttributeError: pass
...
try: (LLVMGetBasicBlockName:=dll.LLVMGetBasicBlockName).restype, LLVMGetBasicBlockName.argtypes = Pointer(ctypes.c_char), [LLVMBasicBlockRef]
except AttributeError: pass
...
try: (LLVMGetBasicBlocks:=dll.LLVMGetBasicBlocks).restype, LLVMGetBasicBlocks.argtypes = None, [LLVMValueRef, Pointer(LLVMBasicBlockRef)]
except AttributeError: pass
...
try: (LLVMCreateBasicBlockInContext:=dll.LLVMCreateBasicBlockInContext).restype, LLVMCreateBasicBlockInContext.argtypes = LLVMBasicBlockRef, [LLVMContextRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMAppendBasicBlockInContext:=dll.LLVMAppendBasicBlockInContext).restype, LLVMAppendBasicBlockInContext.argtypes = LLVMBasicBlockRef, [LLVMContextRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMAppendBasicBlock:=dll.LLVMAppendBasicBlock).restype, LLVMAppendBasicBlock.argtypes = LLVMBasicBlockRef, [LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMInsertBasicBlockInContext:=dll.LLVMInsertBasicBlockInContext).restype, LLVMInsertBasicBlockInContext.argtypes = LLVMBasicBlockRef, [LLVMContextRef, LLVMBasicBlockRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMInsertBasicBlock:=dll.LLVMInsertBasicBlock).restype, LLVMInsertBasicBlock.argtypes = LLVMBasicBlockRef, [LLVMBasicBlockRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMInstructionGetAllMetadataOtherThanDebugLoc:=dll.LLVMInstructionGetAllMetadataOtherThanDebugLoc).restype, LLVMInstructionGetAllMetadataOtherThanDebugLoc.argtypes = Pointer(LLVMValueMetadataEntry), [LLVMValueRef, Pointer(size_t)]
except AttributeError: pass
...
try: (LLVMGetCallSiteAttributes:=dll.LLVMGetCallSiteAttributes).restype, LLVMGetCallSiteAttributes.argtypes = None, [LLVMValueRef, LLVMAttributeIndex, Pointer(LLVMAttributeRef)]
except AttributeError: pass
...
try: (LLVMGetCallSiteStringAttribute:=dll.LLVMGetCallSiteStringAttribute).restype, LLVMGetCallSiteStringAttribute.argtypes = LLVMAttributeRef, [LLVMValueRef, LLVMAttributeIndex, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMRemoveCallSiteStringAttribute:=dll.LLVMRemoveCallSiteStringAttribute).restype, LLVMRemoveCallSiteStringAttribute.argtypes = None, [LLVMValueRef, LLVMAttributeIndex, Pointer(ctypes.c_char), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMAddIncoming:=dll.LLVMAddIncoming).restype, LLVMAddIncoming.argtypes = None, [LLVMValueRef, Pointer(LLVMValueRef), Pointer(LLVMBasicBlockRef), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMGetIndices:=dll.LLVMGetIndices).restype, LLVMGetIndices.argtypes = Pointer(ctypes.c_uint32), [LLVMValueRef]
except AttributeError: pass
...
try: (LLVMInsertIntoBuilderWithName:=dll.LLVMInsertIntoBuilderWithName).restype, LLVMInsertIntoBuilderWithName.argtypes = None, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildAggregateRet:=dll.LLVMBuildAggregateRet).restype, LLVMBuildAggregateRet.argtypes = LLVMValueRef, [LLVMBuilderRef, Pointer(LLVMValueRef), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMBuildCallBr:=dll.LLVMBuildCallBr).restype, LLVMBuildCallBr.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, LLVMBasicBlockRef, Pointer(LLVMBasicBlockRef), ctypes.c_uint32, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(LLVMOperandBundleRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildInvoke2:=dll.LLVMBuildInvoke2).restype, LLVMBuildInvoke2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, LLVMBasicBlockRef, LLVMBasicBlockRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildInvokeWithOperandBundles:=dll.LLVMBuildInvokeWithOperandBundles).restype, LLVMBuildInvokeWithOperandBundles.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, LLVMBasicBlockRef, LLVMBasicBlockRef, Pointer(LLVMOperandBundleRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildLandingPad:=dll.LLVMBuildLandingPad).restype, LLVMBuildLandingPad.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildCatchPad:=dll.LLVMBuildCatchPad).restype, LLVMBuildCatchPad.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildCleanupPad:=dll.LLVMBuildCleanupPad).restype, LLVMBuildCleanupPad.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildCatchSwitch:=dll.LLVMBuildCatchSwitch).restype, LLVMBuildCatchSwitch.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMBasicBlockRef, ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMGetHandlers:=dll.LLVMGetHandlers).restype, LLVMGetHandlers.argtypes = None, [LLVMValueRef, Pointer(LLVMBasicBlockRef)]
except AttributeError: pass
...
try: (LLVMBuildAdd:=dll.LLVMBuildAdd).restype, LLVMBuildAdd.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNSWAdd:=dll.LLVMBuildNSWAdd).restype, LLVMBuildNSWAdd.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNUWAdd:=dll.LLVMBuildNUWAdd).restype, LLVMBuildNUWAdd.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFAdd:=dll.LLVMBuildFAdd).restype, LLVMBuildFAdd.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildSub:=dll.LLVMBuildSub).restype, LLVMBuildSub.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNSWSub:=dll.LLVMBuildNSWSub).restype, LLVMBuildNSWSub.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNUWSub:=dll.LLVMBuildNUWSub).restype, LLVMBuildNUWSub.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFSub:=dll.LLVMBuildFSub).restype, LLVMBuildFSub.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildMul:=dll.LLVMBuildMul).restype, LLVMBuildMul.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNSWMul:=dll.LLVMBuildNSWMul).restype, LLVMBuildNSWMul.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNUWMul:=dll.LLVMBuildNUWMul).restype, LLVMBuildNUWMul.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFMul:=dll.LLVMBuildFMul).restype, LLVMBuildFMul.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildUDiv:=dll.LLVMBuildUDiv).restype, LLVMBuildUDiv.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildExactUDiv:=dll.LLVMBuildExactUDiv).restype, LLVMBuildExactUDiv.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildSDiv:=dll.LLVMBuildSDiv).restype, LLVMBuildSDiv.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildExactSDiv:=dll.LLVMBuildExactSDiv).restype, LLVMBuildExactSDiv.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFDiv:=dll.LLVMBuildFDiv).restype, LLVMBuildFDiv.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildURem:=dll.LLVMBuildURem).restype, LLVMBuildURem.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildSRem:=dll.LLVMBuildSRem).restype, LLVMBuildSRem.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFRem:=dll.LLVMBuildFRem).restype, LLVMBuildFRem.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildShl:=dll.LLVMBuildShl).restype, LLVMBuildShl.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildLShr:=dll.LLVMBuildLShr).restype, LLVMBuildLShr.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildAShr:=dll.LLVMBuildAShr).restype, LLVMBuildAShr.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildAnd:=dll.LLVMBuildAnd).restype, LLVMBuildAnd.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildOr:=dll.LLVMBuildOr).restype, LLVMBuildOr.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildXor:=dll.LLVMBuildXor).restype, LLVMBuildXor.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildBinOp:=dll.LLVMBuildBinOp).restype, LLVMBuildBinOp.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMOpcode, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNeg:=dll.LLVMBuildNeg).restype, LLVMBuildNeg.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNSWNeg:=dll.LLVMBuildNSWNeg).restype, LLVMBuildNSWNeg.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNUWNeg:=dll.LLVMBuildNUWNeg).restype, LLVMBuildNUWNeg.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFNeg:=dll.LLVMBuildFNeg).restype, LLVMBuildFNeg.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildNot:=dll.LLVMBuildNot).restype, LLVMBuildNot.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildMalloc:=dll.LLVMBuildMalloc).restype, LLVMBuildMalloc.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildArrayMalloc:=dll.LLVMBuildArrayMalloc).restype, LLVMBuildArrayMalloc.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildAlloca:=dll.LLVMBuildAlloca).restype, LLVMBuildAlloca.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildArrayAlloca:=dll.LLVMBuildArrayAlloca).restype, LLVMBuildArrayAlloca.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFree:=dll.LLVMBuildFree).restype, LLVMBuildFree.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef]
except AttributeError: pass

try: (LLVMBuildLoad2:=dll.LLVMBuildLoad2).restype, LLVMBuildLoad2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildGEP2:=dll.LLVMBuildGEP2).restype, LLVMBuildGEP2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildInBoundsGEP2:=dll.LLVMBuildInBoundsGEP2).restype, LLVMBuildInBoundsGEP2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildGEPWithNoWrapFlags:=dll.LLVMBuildGEPWithNoWrapFlags).restype, LLVMBuildGEPWithNoWrapFlags.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(ctypes.c_char), LLVMGEPNoWrapFlags]
except AttributeError: pass

try: (LLVMBuildStructGEP2:=dll.LLVMBuildStructGEP2).restype, LLVMBuildStructGEP2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildGlobalString:=dll.LLVMBuildGlobalString).restype, LLVMBuildGlobalString.argtypes = LLVMValueRef, [LLVMBuilderRef, Pointer(ctypes.c_char), Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildGlobalStringPtr:=dll.LLVMBuildGlobalStringPtr).restype, LLVMBuildGlobalStringPtr.argtypes = LLVMValueRef, [LLVMBuilderRef, Pointer(ctypes.c_char), Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildTrunc:=dll.LLVMBuildTrunc).restype, LLVMBuildTrunc.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildZExt:=dll.LLVMBuildZExt).restype, LLVMBuildZExt.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildSExt:=dll.LLVMBuildSExt).restype, LLVMBuildSExt.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFPToUI:=dll.LLVMBuildFPToUI).restype, LLVMBuildFPToUI.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFPToSI:=dll.LLVMBuildFPToSI).restype, LLVMBuildFPToSI.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildUIToFP:=dll.LLVMBuildUIToFP).restype, LLVMBuildUIToFP.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildSIToFP:=dll.LLVMBuildSIToFP).restype, LLVMBuildSIToFP.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFPTrunc:=dll.LLVMBuildFPTrunc).restype, LLVMBuildFPTrunc.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFPExt:=dll.LLVMBuildFPExt).restype, LLVMBuildFPExt.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildPtrToInt:=dll.LLVMBuildPtrToInt).restype, LLVMBuildPtrToInt.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildIntToPtr:=dll.LLVMBuildIntToPtr).restype, LLVMBuildIntToPtr.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildBitCast:=dll.LLVMBuildBitCast).restype, LLVMBuildBitCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildAddrSpaceCast:=dll.LLVMBuildAddrSpaceCast).restype, LLVMBuildAddrSpaceCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildZExtOrBitCast:=dll.LLVMBuildZExtOrBitCast).restype, LLVMBuildZExtOrBitCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildSExtOrBitCast:=dll.LLVMBuildSExtOrBitCast).restype, LLVMBuildSExtOrBitCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildTruncOrBitCast:=dll.LLVMBuildTruncOrBitCast).restype, LLVMBuildTruncOrBitCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildCast:=dll.LLVMBuildCast).restype, LLVMBuildCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMOpcode, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildPointerCast:=dll.LLVMBuildPointerCast).restype, LLVMBuildPointerCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildIntCast2:=dll.LLVMBuildIntCast2).restype, LLVMBuildIntCast2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, LLVMBool, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFPCast:=dll.LLVMBuildFPCast).restype, LLVMBuildFPCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildIntCast:=dll.LLVMBuildIntCast).restype, LLVMBuildIntCast.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMBuildICmp:=dll.LLVMBuildICmp).restype, LLVMBuildICmp.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMIntPredicate, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFCmp:=dll.LLVMBuildFCmp).restype, LLVMBuildFCmp.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMRealPredicate, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildPhi:=dll.LLVMBuildPhi).restype, LLVMBuildPhi.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildCall2:=dll.LLVMBuildCall2).restype, LLVMBuildCall2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildCallWithOperandBundles:=dll.LLVMBuildCallWithOperandBundles).restype, LLVMBuildCallWithOperandBundles.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, Pointer(LLVMValueRef), ctypes.c_uint32, Pointer(LLVMOperandBundleRef), ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildSelect:=dll.LLVMBuildSelect).restype, LLVMBuildSelect.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildVAArg:=dll.LLVMBuildVAArg).restype, LLVMBuildVAArg.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildExtractElement:=dll.LLVMBuildExtractElement).restype, LLVMBuildExtractElement.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildInsertElement:=dll.LLVMBuildInsertElement).restype, LLVMBuildInsertElement.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildShuffleVector:=dll.LLVMBuildShuffleVector).restype, LLVMBuildShuffleVector.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildExtractValue:=dll.LLVMBuildExtractValue).restype, LLVMBuildExtractValue.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildInsertValue:=dll.LLVMBuildInsertValue).restype, LLVMBuildInsertValue.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFreeze:=dll.LLVMBuildFreeze).restype, LLVMBuildFreeze.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildIsNull:=dll.LLVMBuildIsNull).restype, LLVMBuildIsNull.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildIsNotNull:=dll.LLVMBuildIsNotNull).restype, LLVMBuildIsNotNull.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildPtrDiff2:=dll.LLVMBuildPtrDiff2).restype, LLVMBuildPtrDiff2.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, LLVMValueRef, LLVMValueRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFence:=dll.LLVMBuildFence).restype, LLVMBuildFence.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMAtomicOrdering, LLVMBool, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMBuildFenceSyncScope:=dll.LLVMBuildFenceSyncScope).restype, LLVMBuildFenceSyncScope.argtypes = LLVMValueRef, [LLVMBuilderRef, LLVMAtomicOrdering, ctypes.c_uint32, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMCreateMemoryBufferWithContentsOfFile:=dll.LLVMCreateMemoryBufferWithContentsOfFile).restype, LLVMCreateMemoryBufferWithContentsOfFile.argtypes = LLVMBool, [Pointer(ctypes.c_char), Pointer(LLVMMemoryBufferRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMCreateMemoryBufferWithSTDIN:=dll.LLVMCreateMemoryBufferWithSTDIN).restype, LLVMCreateMemoryBufferWithSTDIN.argtypes = LLVMBool, [Pointer(LLVMMemoryBufferRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMCreateMemoryBufferWithMemoryRange:=dll.LLVMCreateMemoryBufferWithMemoryRange).restype, LLVMCreateMemoryBufferWithMemoryRange.argtypes = LLVMMemoryBufferRef, [Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), LLVMBool]
except AttributeError: pass

try: (LLVMCreateMemoryBufferWithMemoryRangeCopy:=dll.LLVMCreateMemoryBufferWithMemoryRangeCopy).restype, LLVMCreateMemoryBufferWithMemoryRangeCopy.argtypes = LLVMMemoryBufferRef, [Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetBufferStart:=dll.LLVMGetBufferStart).restype, LLVMGetBufferStart.argtypes = Pointer(ctypes.c_char), [LLVMMemoryBufferRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateCompileUnit:=dll.LLVMDIBuilderCreateCompileUnit).restype, LLVMDIBuilderCreateCompileUnit.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMDWARFSourceLanguage, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMBool, Pointer(ctypes.c_char), size_t, ctypes.c_uint32, Pointer(ctypes.c_char), size_t, LLVMDWARFEmissionKind, ctypes.c_uint32, LLVMBool, LLVMBool, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateFile:=dll.LLVMDIBuilderCreateFile).restype, LLVMDIBuilderCreateFile.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateModule:=dll.LLVMDIBuilderCreateModule).restype, LLVMDIBuilderCreateModule.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateNameSpace:=dll.LLVMDIBuilderCreateNameSpace).restype, LLVMDIBuilderCreateNameSpace.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMBool]
except AttributeError: pass

try: (LLVMDIBuilderCreateFunction:=dll.LLVMDIBuilderCreateFunction).restype, LLVMDIBuilderCreateFunction.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, LLVMMetadataRef, LLVMBool, LLVMBool, ctypes.c_uint32, LLVMDIFlags, LLVMBool]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateImportedModuleFromAlias:=dll.LLVMDIBuilderCreateImportedModuleFromAlias).restype, LLVMDIBuilderCreateImportedModuleFromAlias.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint32, Pointer(LLVMMetadataRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMDIBuilderCreateImportedModuleFromModule:=dll.LLVMDIBuilderCreateImportedModuleFromModule).restype, LLVMDIBuilderCreateImportedModuleFromModule.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint32, Pointer(LLVMMetadataRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMDIBuilderCreateImportedDeclaration:=dll.LLVMDIBuilderCreateImportedDeclaration).restype, LLVMDIBuilderCreateImportedDeclaration.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint32, Pointer(ctypes.c_char), size_t, Pointer(LLVMMetadataRef), ctypes.c_uint32]
except AttributeError: pass
...
try: (LLVMDIFileGetDirectory:=dll.LLVMDIFileGetDirectory).restype, LLVMDIFileGetDirectory.argtypes = Pointer(ctypes.c_char), [LLVMMetadataRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass

try: (LLVMDIFileGetFilename:=dll.LLVMDIFileGetFilename).restype, LLVMDIFileGetFilename.argtypes = Pointer(ctypes.c_char), [LLVMMetadataRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass

try: (LLVMDIFileGetSource:=dll.LLVMDIFileGetSource).restype, LLVMDIFileGetSource.argtypes = Pointer(ctypes.c_char), [LLVMMetadataRef, Pointer(ctypes.c_uint32)]
except AttributeError: pass

try: (LLVMDIBuilderGetOrCreateTypeArray:=dll.LLVMDIBuilderGetOrCreateTypeArray).restype, LLVMDIBuilderGetOrCreateTypeArray.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(LLVMMetadataRef), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateSubroutineType:=dll.LLVMDIBuilderCreateSubroutineType).restype, LLVMDIBuilderCreateSubroutineType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(LLVMMetadataRef), ctypes.c_uint32, LLVMDIFlags]
except AttributeError: pass

try: (LLVMDIBuilderCreateMacro:=dll.LLVMDIBuilderCreateMacro).restype, LLVMDIBuilderCreateMacro.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, ctypes.c_uint32, LLVMDWARFMacinfoRecordType, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateEnumerator:=dll.LLVMDIBuilderCreateEnumerator).restype, LLVMDIBuilderCreateEnumerator.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(ctypes.c_char), size_t, int64_t, LLVMBool]
except AttributeError: pass

uint32_t = ctypes.c_uint32
try: (LLVMDIBuilderCreateEnumerationType:=dll.LLVMDIBuilderCreateEnumerationType).restype, LLVMDIBuilderCreateEnumerationType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, uint64_t, uint32_t, Pointer(LLVMMetadataRef), ctypes.c_uint32, LLVMMetadataRef]
except AttributeError: pass

try: (LLVMDIBuilderCreateUnionType:=dll.LLVMDIBuilderCreateUnionType).restype, LLVMDIBuilderCreateUnionType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, uint64_t, uint32_t, LLVMDIFlags, Pointer(LLVMMetadataRef), ctypes.c_uint32, ctypes.c_uint32, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateArrayType:=dll.LLVMDIBuilderCreateArrayType).restype, LLVMDIBuilderCreateArrayType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, uint64_t, uint32_t, LLVMMetadataRef, Pointer(LLVMMetadataRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMDIBuilderCreateVectorType:=dll.LLVMDIBuilderCreateVectorType).restype, LLVMDIBuilderCreateVectorType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, uint64_t, uint32_t, LLVMMetadataRef, Pointer(LLVMMetadataRef), ctypes.c_uint32]
except AttributeError: pass

try: (LLVMDIBuilderCreateUnspecifiedType:=dll.LLVMDIBuilderCreateUnspecifiedType).restype, LLVMDIBuilderCreateUnspecifiedType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateBasicType:=dll.LLVMDIBuilderCreateBasicType).restype, LLVMDIBuilderCreateBasicType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(ctypes.c_char), size_t, uint64_t, LLVMDWARFTypeEncoding, LLVMDIFlags]
except AttributeError: pass

try: (LLVMDIBuilderCreatePointerType:=dll.LLVMDIBuilderCreatePointerType).restype, LLVMDIBuilderCreatePointerType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, uint64_t, uint32_t, ctypes.c_uint32, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateStructType:=dll.LLVMDIBuilderCreateStructType).restype, LLVMDIBuilderCreateStructType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, uint64_t, uint32_t, LLVMDIFlags, LLVMMetadataRef, Pointer(LLVMMetadataRef), ctypes.c_uint32, ctypes.c_uint32, LLVMMetadataRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateMemberType:=dll.LLVMDIBuilderCreateMemberType).restype, LLVMDIBuilderCreateMemberType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, uint64_t, uint32_t, uint64_t, LLVMDIFlags, LLVMMetadataRef]
except AttributeError: pass

try: (LLVMDIBuilderCreateStaticMemberType:=dll.LLVMDIBuilderCreateStaticMemberType).restype, LLVMDIBuilderCreateStaticMemberType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, LLVMMetadataRef, LLVMDIFlags, LLVMValueRef, uint32_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateObjCIVar:=dll.LLVMDIBuilderCreateObjCIVar).restype, LLVMDIBuilderCreateObjCIVar.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, uint64_t, uint32_t, uint64_t, LLVMDIFlags, LLVMMetadataRef, LLVMMetadataRef]
except AttributeError: pass

try: (LLVMDIBuilderCreateObjCProperty:=dll.LLVMDIBuilderCreateObjCProperty).restype, LLVMDIBuilderCreateObjCProperty.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, Pointer(ctypes.c_char), size_t, Pointer(ctypes.c_char), size_t, ctypes.c_uint32, LLVMMetadataRef]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateTypedef:=dll.LLVMDIBuilderCreateTypedef).restype, LLVMDIBuilderCreateTypedef.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, LLVMMetadataRef, uint32_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateForwardDecl:=dll.LLVMDIBuilderCreateForwardDecl).restype, LLVMDIBuilderCreateForwardDecl.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, ctypes.c_uint32, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint32, ctypes.c_uint32, uint64_t, uint32_t, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateReplaceableCompositeType:=dll.LLVMDIBuilderCreateReplaceableCompositeType).restype, LLVMDIBuilderCreateReplaceableCompositeType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, ctypes.c_uint32, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, LLVMMetadataRef, ctypes.c_uint32, ctypes.c_uint32, uint64_t, uint32_t, LLVMDIFlags, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateBitFieldMemberType:=dll.LLVMDIBuilderCreateBitFieldMemberType).restype, LLVMDIBuilderCreateBitFieldMemberType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, uint64_t, uint64_t, uint64_t, LLVMDIFlags, LLVMMetadataRef]
except AttributeError: pass

try: (LLVMDIBuilderCreateClassType:=dll.LLVMDIBuilderCreateClassType).restype, LLVMDIBuilderCreateClassType.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, uint64_t, uint32_t, uint64_t, LLVMDIFlags, LLVMMetadataRef, Pointer(LLVMMetadataRef), ctypes.c_uint32, LLVMMetadataRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMDITypeGetName:=dll.LLVMDITypeGetName).restype, LLVMDITypeGetName.argtypes = Pointer(ctypes.c_char), [LLVMMetadataRef, Pointer(size_t)]
except AttributeError: pass
...
try: (LLVMDIBuilderGetOrCreateArray:=dll.LLVMDIBuilderGetOrCreateArray).restype, LLVMDIBuilderGetOrCreateArray.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(LLVMMetadataRef), size_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateExpression:=dll.LLVMDIBuilderCreateExpression).restype, LLVMDIBuilderCreateExpression.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, Pointer(uint64_t), size_t]
except AttributeError: pass
...
try: (LLVMTemporaryMDNode:=dll.LLVMTemporaryMDNode).restype, LLVMTemporaryMDNode.argtypes = LLVMMetadataRef, [LLVMContextRef, Pointer(LLVMMetadataRef), size_t]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateAutoVariable:=dll.LLVMDIBuilderCreateAutoVariable).restype, LLVMDIBuilderCreateAutoVariable.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, LLVMMetadataRef, LLVMBool, LLVMDIFlags, uint32_t]
except AttributeError: pass

try: (LLVMDIBuilderCreateParameterVariable:=dll.LLVMDIBuilderCreateParameterVariable).restype, LLVMDIBuilderCreateParameterVariable.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, ctypes.c_uint32, LLVMMetadataRef, ctypes.c_uint32, LLVMMetadataRef, LLVMBool, LLVMDIFlags]
except AttributeError: pass
...
try: (LLVMDIBuilderCreateLabel:=dll.LLVMDIBuilderCreateLabel).restype, LLVMDIBuilderCreateLabel.argtypes = LLVMMetadataRef, [LLVMDIBuilderRef, LLVMMetadataRef, Pointer(ctypes.c_char), size_t, LLVMMetadataRef, ctypes.c_uint32, LLVMBool]
except AttributeError: pass
...
try: (LLVMCreateDisasm:=dll.LLVMCreateDisasm).restype, LLVMCreateDisasm.argtypes = LLVMDisasmContextRef, [Pointer(ctypes.c_char), ctypes.c_void_p, ctypes.c_int32, LLVMOpInfoCallback, LLVMSymbolLookupCallback]
except AttributeError: pass

try: (LLVMCreateDisasmCPU:=dll.LLVMCreateDisasmCPU).restype, LLVMCreateDisasmCPU.argtypes = LLVMDisasmContextRef, [Pointer(ctypes.c_char), Pointer(ctypes.c_char), ctypes.c_void_p, ctypes.c_int32, LLVMOpInfoCallback, LLVMSymbolLookupCallback]
except AttributeError: pass

try: (LLVMCreateDisasmCPUFeatures:=dll.LLVMCreateDisasmCPUFeatures).restype, LLVMCreateDisasmCPUFeatures.argtypes = LLVMDisasmContextRef, [Pointer(ctypes.c_char), Pointer(ctypes.c_char), Pointer(ctypes.c_char), ctypes.c_void_p, ctypes.c_int32, LLVMOpInfoCallback, LLVMSymbolLookupCallback]
except AttributeError: pass
...
try: (LLVMDisasmInstruction:=dll.LLVMDisasmInstruction).restype, LLVMDisasmInstruction.argtypes = size_t, [LLVMDisasmContextRef, Pointer(uint8_t), uint64_t, uint64_t, Pointer(ctypes.c_char), size_t]
except AttributeError: pass
...
try: (LLVMGetErrorMessage:=dll.LLVMGetErrorMessage).restype, LLVMGetErrorMessage.argtypes = Pointer(ctypes.c_char), [LLVMErrorRef]
except AttributeError: pass

try: (LLVMDisposeErrorMessage:=dll.LLVMDisposeErrorMessage).restype, LLVMDisposeErrorMessage.argtypes = None, [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetStringErrorTypeId:=dll.LLVMGetStringErrorTypeId).restype, LLVMGetStringErrorTypeId.argtypes = LLVMErrorTypeId, []
except AttributeError: pass

try: (LLVMCreateStringError:=dll.LLVMCreateStringError).restype, LLVMCreateStringError.argtypes = LLVMErrorRef, [Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMCreateTargetData:=dll.LLVMCreateTargetData).restype, LLVMCreateTargetData.argtypes = LLVMTargetDataRef, [Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMCopyStringRepOfTargetData:=dll.LLVMCopyStringRepOfTargetData).restype, LLVMCopyStringRepOfTargetData.argtypes = Pointer(ctypes.c_char), [LLVMTargetDataRef]
except AttributeError: pass
...
try: (LLVMGetTargetFromName:=dll.LLVMGetTargetFromName).restype, LLVMGetTargetFromName.argtypes = LLVMTargetRef, [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetTargetFromTriple:=dll.LLVMGetTargetFromTriple).restype, LLVMGetTargetFromTriple.argtypes = LLVMBool, [Pointer(ctypes.c_char), Pointer(LLVMTargetRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMGetTargetName:=dll.LLVMGetTargetName).restype, LLVMGetTargetName.argtypes = Pointer(ctypes.c_char), [LLVMTargetRef]
except AttributeError: pass

try: (LLVMGetTargetDescription:=dll.LLVMGetTargetDescription).restype, LLVMGetTargetDescription.argtypes = Pointer(ctypes.c_char), [LLVMTargetRef]
except AttributeError: pass
...
try: (LLVMTargetMachineOptionsSetCPU:=dll.LLVMTargetMachineOptionsSetCPU).restype, LLVMTargetMachineOptionsSetCPU.argtypes = None, [LLVMTargetMachineOptionsRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMTargetMachineOptionsSetFeatures:=dll.LLVMTargetMachineOptionsSetFeatures).restype, LLVMTargetMachineOptionsSetFeatures.argtypes = None, [LLVMTargetMachineOptionsRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMTargetMachineOptionsSetABI:=dll.LLVMTargetMachineOptionsSetABI).restype, LLVMTargetMachineOptionsSetABI.argtypes = None, [LLVMTargetMachineOptionsRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMCreateTargetMachineWithOptions:=dll.LLVMCreateTargetMachineWithOptions).restype, LLVMCreateTargetMachineWithOptions.argtypes = LLVMTargetMachineRef, [LLVMTargetRef, Pointer(ctypes.c_char), LLVMTargetMachineOptionsRef]
except AttributeError: pass

try: (LLVMCreateTargetMachine:=dll.LLVMCreateTargetMachine).restype, LLVMCreateTargetMachine.argtypes = LLVMTargetMachineRef, [LLVMTargetRef, Pointer(ctypes.c_char), Pointer(ctypes.c_char), Pointer(ctypes.c_char), LLVMCodeGenOptLevel, LLVMRelocMode, LLVMCodeModel]
except AttributeError: pass
...
try: (LLVMGetTargetMachineTriple:=dll.LLVMGetTargetMachineTriple).restype, LLVMGetTargetMachineTriple.argtypes = Pointer(ctypes.c_char), [LLVMTargetMachineRef]
except AttributeError: pass

try: (LLVMGetTargetMachineCPU:=dll.LLVMGetTargetMachineCPU).restype, LLVMGetTargetMachineCPU.argtypes = Pointer(ctypes.c_char), [LLVMTargetMachineRef]
except AttributeError: pass

try: (LLVMGetTargetMachineFeatureString:=dll.LLVMGetTargetMachineFeatureString).restype, LLVMGetTargetMachineFeatureString.argtypes = Pointer(ctypes.c_char), [LLVMTargetMachineRef]
except AttributeError: pass
...
try: (LLVMTargetMachineEmitToFile:=dll.LLVMTargetMachineEmitToFile).restype, LLVMTargetMachineEmitToFile.argtypes = LLVMBool, [LLVMTargetMachineRef, LLVMModuleRef, Pointer(ctypes.c_char), LLVMCodeGenFileType, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMTargetMachineEmitToMemoryBuffer:=dll.LLVMTargetMachineEmitToMemoryBuffer).restype, LLVMTargetMachineEmitToMemoryBuffer.argtypes = LLVMBool, [LLVMTargetMachineRef, LLVMModuleRef, LLVMCodeGenFileType, Pointer(Pointer(ctypes.c_char)), Pointer(LLVMMemoryBufferRef)]
except AttributeError: pass

try: (LLVMGetDefaultTargetTriple:=dll.LLVMGetDefaultTargetTriple).restype, LLVMGetDefaultTargetTriple.argtypes = Pointer(ctypes.c_char), []
except AttributeError: pass

try: (LLVMNormalizeTargetTriple:=dll.LLVMNormalizeTargetTriple).restype, LLVMNormalizeTargetTriple.argtypes = Pointer(ctypes.c_char), [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetHostCPUName:=dll.LLVMGetHostCPUName).restype, LLVMGetHostCPUName.argtypes = Pointer(ctypes.c_char), []
except AttributeError: pass

try: (LLVMGetHostCPUFeatures:=dll.LLVMGetHostCPUFeatures).restype, LLVMGetHostCPUFeatures.argtypes = Pointer(ctypes.c_char), []
except AttributeError: pass
...
try: (LLVMCreateExecutionEngineForModule:=dll.LLVMCreateExecutionEngineForModule).restype, LLVMCreateExecutionEngineForModule.argtypes = LLVMBool, [Pointer(LLVMExecutionEngineRef), LLVMModuleRef, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMCreateInterpreterForModule:=dll.LLVMCreateInterpreterForModule).restype, LLVMCreateInterpreterForModule.argtypes = LLVMBool, [Pointer(LLVMExecutionEngineRef), LLVMModuleRef, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMCreateJITCompilerForModule:=dll.LLVMCreateJITCompilerForModule).restype, LLVMCreateJITCompilerForModule.argtypes = LLVMBool, [Pointer(LLVMExecutionEngineRef), LLVMModuleRef, ctypes.c_uint32, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMInitializeMCJITCompilerOptions:=dll.LLVMInitializeMCJITCompilerOptions).restype, LLVMInitializeMCJITCompilerOptions.argtypes = None, [Pointer(struct_LLVMMCJITCompilerOptions), size_t]
except AttributeError: pass

try: (LLVMCreateMCJITCompilerForModule:=dll.LLVMCreateMCJITCompilerForModule).restype, LLVMCreateMCJITCompilerForModule.argtypes = LLVMBool, [Pointer(LLVMExecutionEngineRef), LLVMModuleRef, Pointer(struct_LLVMMCJITCompilerOptions), size_t, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass
...
try: (LLVMRunFunctionAsMain:=dll.LLVMRunFunctionAsMain).restype, LLVMRunFunctionAsMain.argtypes = ctypes.c_int32, [LLVMExecutionEngineRef, LLVMValueRef, ctypes.c_uint32, Pointer(Pointer(ctypes.c_char)), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMRunFunction:=dll.LLVMRunFunction).restype, LLVMRunFunction.argtypes = LLVMGenericValueRef, [LLVMExecutionEngineRef, LLVMValueRef, ctypes.c_uint32, Pointer(LLVMGenericValueRef)]
except AttributeError: pass
...
try: (LLVMRemoveModule:=dll.LLVMRemoveModule).restype, LLVMRemoveModule.argtypes = LLVMBool, [LLVMExecutionEngineRef, LLVMModuleRef, Pointer(LLVMModuleRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (LLVMFindFunction:=dll.LLVMFindFunction).restype, LLVMFindFunction.argtypes = LLVMBool, [LLVMExecutionEngineRef, Pointer(ctypes.c_char), Pointer(LLVMValueRef)]
except AttributeError: pass
...
try: (LLVMGetGlobalValueAddress:=dll.LLVMGetGlobalValueAddress).restype, LLVMGetGlobalValueAddress.argtypes = uint64_t, [LLVMExecutionEngineRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMGetFunctionAddress:=dll.LLVMGetFunctionAddress).restype, LLVMGetFunctionAddress.argtypes = uint64_t, [LLVMExecutionEngineRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMExecutionEngineGetErrMsg:=dll.LLVMExecutionEngineGetErrMsg).restype, LLVMExecutionEngineGetErrMsg.argtypes = LLVMBool, [LLVMExecutionEngineRef, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass
...
try: (LLVMParseIRInContext:=dll.LLVMParseIRInContext).restype, LLVMParseIRInContext.argtypes = LLVMBool, [LLVMContextRef, LLVMMemoryBufferRef, Pointer(LLVMModuleRef), Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass
...
try: (LLVMOrcExecutionSessionIntern:=dll.LLVMOrcExecutionSessionIntern).restype, LLVMOrcExecutionSessionIntern.argtypes = LLVMOrcSymbolStringPoolEntryRef, [LLVMOrcExecutionSessionRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcSymbolStringPoolEntryStr:=dll.LLVMOrcSymbolStringPoolEntryStr).restype, LLVMOrcSymbolStringPoolEntryStr.argtypes = Pointer(ctypes.c_char), [LLVMOrcSymbolStringPoolEntryRef]
except AttributeError: pass
...
try: (LLVMOrcMaterializationResponsibilityGetSymbols:=dll.LLVMOrcMaterializationResponsibilityGetSymbols).restype, LLVMOrcMaterializationResponsibilityGetSymbols.argtypes = LLVMOrcCSymbolFlagsMapPairs, [LLVMOrcMaterializationResponsibilityRef, Pointer(size_t)]
except AttributeError: pass
...
try: (LLVMOrcMaterializationResponsibilityGetRequestedSymbols:=dll.LLVMOrcMaterializationResponsibilityGetRequestedSymbols).restype, LLVMOrcMaterializationResponsibilityGetRequestedSymbols.argtypes = Pointer(LLVMOrcSymbolStringPoolEntryRef), [LLVMOrcMaterializationResponsibilityRef, Pointer(size_t)]
except AttributeError: pass

try: (LLVMOrcDisposeSymbols:=dll.LLVMOrcDisposeSymbols).restype, LLVMOrcDisposeSymbols.argtypes = None, [Pointer(LLVMOrcSymbolStringPoolEntryRef)]
except AttributeError: pass
...
try: (LLVMOrcMaterializationResponsibilityNotifyEmitted:=dll.LLVMOrcMaterializationResponsibilityNotifyEmitted).restype, LLVMOrcMaterializationResponsibilityNotifyEmitted.argtypes = LLVMErrorRef, [LLVMOrcMaterializationResponsibilityRef, Pointer(LLVMOrcCSymbolDependenceGroup), size_t]
except AttributeError: pass
...
try: (LLVMOrcMaterializationResponsibilityDelegate:=dll.LLVMOrcMaterializationResponsibilityDelegate).restype, LLVMOrcMaterializationResponsibilityDelegate.argtypes = LLVMErrorRef, [LLVMOrcMaterializationResponsibilityRef, Pointer(LLVMOrcSymbolStringPoolEntryRef), size_t, Pointer(LLVMOrcMaterializationResponsibilityRef)]
except AttributeError: pass

try: (LLVMOrcExecutionSessionCreateBareJITDylib:=dll.LLVMOrcExecutionSessionCreateBareJITDylib).restype, LLVMOrcExecutionSessionCreateBareJITDylib.argtypes = LLVMOrcJITDylibRef, [LLVMOrcExecutionSessionRef, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMOrcExecutionSessionCreateJITDylib:=dll.LLVMOrcExecutionSessionCreateJITDylib).restype, LLVMOrcExecutionSessionCreateJITDylib.argtypes = LLVMErrorRef, [LLVMOrcExecutionSessionRef, Pointer(LLVMOrcJITDylibRef), Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMOrcExecutionSessionGetJITDylibByName:=dll.LLVMOrcExecutionSessionGetJITDylibByName).restype, LLVMOrcExecutionSessionGetJITDylibByName.argtypes = LLVMOrcJITDylibRef, [LLVMOrcExecutionSessionRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcCreateDynamicLibrarySearchGeneratorForProcess:=dll.LLVMOrcCreateDynamicLibrarySearchGeneratorForProcess).restype, LLVMOrcCreateDynamicLibrarySearchGeneratorForProcess.argtypes = LLVMErrorRef, [Pointer(LLVMOrcDefinitionGeneratorRef), ctypes.c_char, LLVMOrcSymbolPredicate, ctypes.c_void_p]
except AttributeError: pass

try: (LLVMOrcCreateDynamicLibrarySearchGeneratorForPath:=dll.LLVMOrcCreateDynamicLibrarySearchGeneratorForPath).restype, LLVMOrcCreateDynamicLibrarySearchGeneratorForPath.argtypes = LLVMErrorRef, [Pointer(LLVMOrcDefinitionGeneratorRef), Pointer(ctypes.c_char), ctypes.c_char, LLVMOrcSymbolPredicate, ctypes.c_void_p]
except AttributeError: pass

class struct_LLVMOrcOpaqueObjectLayer(Struct): pass
LLVMOrcObjectLayerRef = Pointer(struct_LLVMOrcOpaqueObjectLayer)
try: (LLVMOrcCreateStaticLibrarySearchGeneratorForPath:=dll.LLVMOrcCreateStaticLibrarySearchGeneratorForPath).restype, LLVMOrcCreateStaticLibrarySearchGeneratorForPath.argtypes = LLVMErrorRef, [Pointer(LLVMOrcDefinitionGeneratorRef), LLVMOrcObjectLayerRef, Pointer(ctypes.c_char), Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcJITTargetMachineBuilderDetectHost:=dll.LLVMOrcJITTargetMachineBuilderDetectHost).restype, LLVMOrcJITTargetMachineBuilderDetectHost.argtypes = LLVMErrorRef, [Pointer(LLVMOrcJITTargetMachineBuilderRef)]
except AttributeError: pass
...
try: (LLVMOrcJITTargetMachineBuilderGetTargetTriple:=dll.LLVMOrcJITTargetMachineBuilderGetTargetTriple).restype, LLVMOrcJITTargetMachineBuilderGetTargetTriple.argtypes = Pointer(ctypes.c_char), [LLVMOrcJITTargetMachineBuilderRef]
except AttributeError: pass

try: (LLVMOrcJITTargetMachineBuilderSetTargetTriple:=dll.LLVMOrcJITTargetMachineBuilderSetTargetTriple).restype, LLVMOrcJITTargetMachineBuilderSetTargetTriple.argtypes = None, [LLVMOrcJITTargetMachineBuilderRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcCreateLocalIndirectStubsManager:=dll.LLVMOrcCreateLocalIndirectStubsManager).restype, LLVMOrcCreateLocalIndirectStubsManager.argtypes = LLVMOrcIndirectStubsManagerRef, [Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcCreateLocalLazyCallThroughManager:=dll.LLVMOrcCreateLocalLazyCallThroughManager).restype, LLVMOrcCreateLocalLazyCallThroughManager.argtypes = LLVMErrorRef, [Pointer(ctypes.c_char), LLVMOrcExecutionSessionRef, LLVMOrcJITTargetAddress, Pointer(LLVMOrcLazyCallThroughManagerRef)]
except AttributeError: pass
...
try: (LLVMOrcCreateDumpObjects:=dll.LLVMOrcCreateDumpObjects).restype, LLVMOrcCreateDumpObjects.argtypes = LLVMOrcDumpObjectsRef, [Pointer(ctypes.c_char), Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcDumpObjects_CallOperator:=dll.LLVMOrcDumpObjects_CallOperator).restype, LLVMOrcDumpObjects_CallOperator.argtypes = LLVMErrorRef, [LLVMOrcDumpObjectsRef, Pointer(LLVMMemoryBufferRef)]
except AttributeError: pass
...
try: (LLVMOrcCreateLLJIT:=dll.LLVMOrcCreateLLJIT).restype, LLVMOrcCreateLLJIT.argtypes = LLVMErrorRef, [Pointer(LLVMOrcLLJITRef), LLVMOrcLLJITBuilderRef]
except AttributeError: pass
...
try: (LLVMOrcLLJITGetTripleString:=dll.LLVMOrcLLJITGetTripleString).restype, LLVMOrcLLJITGetTripleString.argtypes = Pointer(ctypes.c_char), [LLVMOrcLLJITRef]
except AttributeError: pass
...
try: (LLVMOrcLLJITMangleAndIntern:=dll.LLVMOrcLLJITMangleAndIntern).restype, LLVMOrcLLJITMangleAndIntern.argtypes = LLVMOrcSymbolStringPoolEntryRef, [LLVMOrcLLJITRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcLLJITLookup:=dll.LLVMOrcLLJITLookup).restype, LLVMOrcLLJITLookup.argtypes = LLVMErrorRef, [LLVMOrcLLJITRef, Pointer(LLVMOrcExecutorAddress), Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (LLVMOrcLLJITGetDataLayoutStr:=dll.LLVMOrcLLJITGetDataLayoutStr).restype, LLVMOrcLLJITGetDataLayoutStr.argtypes = Pointer(ctypes.c_char), [LLVMOrcLLJITRef]
except AttributeError: pass
...
try: (LLVMCreateBinary:=dll.LLVMCreateBinary).restype, LLVMCreateBinary.argtypes = LLVMBinaryRef, [LLVMMemoryBufferRef, LLVMContextRef, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass
...
try: (LLVMMachOUniversalBinaryCopyObjectForArch:=dll.LLVMMachOUniversalBinaryCopyObjectForArch).restype, LLVMMachOUniversalBinaryCopyObjectForArch.argtypes = LLVMBinaryRef, [LLVMBinaryRef, Pointer(ctypes.c_char), size_t, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass
...
try: (LLVMGetSectionName:=dll.LLVMGetSectionName).restype, LLVMGetSectionName.argtypes = Pointer(ctypes.c_char), [LLVMSectionIteratorRef]
except AttributeError: pass

try: (LLVMGetSectionSize:=dll.LLVMGetSectionSize).restype, LLVMGetSectionSize.argtypes = uint64_t, [LLVMSectionIteratorRef]
except AttributeError: pass

try: (LLVMGetSectionContents:=dll.LLVMGetSectionContents).restype, LLVMGetSectionContents.argtypes = Pointer(ctypes.c_char), [LLVMSectionIteratorRef]
except AttributeError: pass
...
try: (LLVMGetSymbolName:=dll.LLVMGetSymbolName).restype, LLVMGetSymbolName.argtypes = Pointer(ctypes.c_char), [LLVMSymbolIteratorRef]
except AttributeError: pass
...
try: (LLVMGetRelocationTypeName:=dll.LLVMGetRelocationTypeName).restype, LLVMGetRelocationTypeName.argtypes = Pointer(ctypes.c_char), [LLVMRelocationIteratorRef]
except AttributeError: pass

try: (LLVMGetRelocationValueString:=dll.LLVMGetRelocationValueString).restype, LLVMGetRelocationValueString.argtypes = Pointer(ctypes.c_char), [LLVMRelocationIteratorRef]
except AttributeError: pass
...
try: (LLVMRemarkStringGetData:=dll.LLVMRemarkStringGetData).restype, LLVMRemarkStringGetData.argtypes = Pointer(ctypes.c_char), [LLVMRemarkStringRef]
except AttributeError: pass
...
try: (LLVMRemarkParserGetErrorMessage:=dll.LLVMRemarkParserGetErrorMessage).restype, LLVMRemarkParserGetErrorMessage.argtypes = Pointer(ctypes.c_char), [LLVMRemarkParserRef]
except AttributeError: pass
...
try: (LLVMLoadLibraryPermanently:=dll.LLVMLoadLibraryPermanently).restype, LLVMLoadLibraryPermanently.argtypes = LLVMBool, [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMParseCommandLineOptions:=dll.LLVMParseCommandLineOptions).restype, LLVMParseCommandLineOptions.argtypes = None, [ctypes.c_int32, Pointer(Pointer(ctypes.c_char)), Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMSearchForAddressOfSymbol:=dll.LLVMSearchForAddressOfSymbol).restype, LLVMSearchForAddressOfSymbol.argtypes = ctypes.c_void_p, [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (LLVMAddSymbol:=dll.LLVMAddSymbol).restype, LLVMAddSymbol.argtypes = None, [Pointer(ctypes.c_char), ctypes.c_void_p]
except AttributeError: pass
...
try: (LLVMRunPasses:=dll.LLVMRunPasses).restype, LLVMRunPasses.argtypes = LLVMErrorRef, [LLVMModuleRef, Pointer(ctypes.c_char), LLVMTargetMachineRef, LLVMPassBuilderOptionsRef]
except AttributeError: pass

try: (LLVMRunPassesOnFunction:=dll.LLVMRunPassesOnFunction).restype, LLVMRunPassesOnFunction.argtypes = LLVMErrorRef, [LLVMValueRef, Pointer(ctypes.c_char), LLVMTargetMachineRef, LLVMPassBuilderOptionsRef]
except AttributeError: pass
...
try: (LLVMPassBuilderOptionsSetAAPipeline:=dll.LLVMPassBuilderOptionsSetAAPipeline).restype, LLVMPassBuilderOptionsSetAAPipeline.argtypes = None, [LLVMPassBuilderOptionsRef, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (llvm_blake3_version:=dll.llvm_blake3_version).restype, llvm_blake3_version.argtypes = Pointer(ctypes.c_char), []
except AttributeError: pass

try: (llvm_blake3_hasher_init:=dll.llvm_blake3_hasher_init).restype, llvm_blake3_hasher_init.argtypes = None, [Pointer(llvm_blake3_hasher)]
except AttributeError: pass

try: (llvm_blake3_hasher_init_keyed:=dll.llvm_blake3_hasher_init_keyed).restype, llvm_blake3_hasher_init_keyed.argtypes = None, [Pointer(llvm_blake3_hasher), Array(uint8_t, 32)]
except AttributeError: pass

try: (llvm_blake3_hasher_init_derive_key:=dll.llvm_blake3_hasher_init_derive_key).restype, llvm_blake3_hasher_init_derive_key.argtypes = None, [Pointer(llvm_blake3_hasher), Pointer(ctypes.c_char)]
except AttributeError: pass

try: (llvm_blake3_hasher_init_derive_key_raw:=dll.llvm_blake3_hasher_init_derive_key_raw).restype, llvm_blake3_hasher_init_derive_key_raw.argtypes = None, [Pointer(llvm_blake3_hasher), ctypes.c_void_p, size_t]
except AttributeError: pass

try: (llvm_blake3_hasher_update:=dll.llvm_blake3_hasher_update).restype, llvm_blake3_hasher_update.argtypes = None, [Pointer(llvm_blake3_hasher), ctypes.c_void_p, size_t]
except AttributeError: pass

try: (llvm_blake3_hasher_finalize:=dll.llvm_blake3_hasher_finalize).restype, llvm_blake3_hasher_finalize.argtypes = None, [Pointer(llvm_blake3_hasher), Pointer(uint8_t), size_t]
except AttributeError: pass

try: (llvm_blake3_hasher_finalize_seek:=dll.llvm_blake3_hasher_finalize_seek).restype, llvm_blake3_hasher_finalize_seek.argtypes = None, [Pointer(llvm_blake3_hasher), uint64_t, Pointer(uint8_t), size_t]
except AttributeError: pass

try: (llvm_blake3_hasher_reset:=dll.llvm_blake3_hasher_reset).restype, llvm_blake3_hasher_reset.argtypes = None, [Pointer(llvm_blake3_hasher)]
except AttributeError: pass
...
try: (lto_get_version:=dll.lto_get_version).restype, lto_get_version.argtypes = Pointer(ctypes.c_char), []
except AttributeError: pass

try: (lto_get_error_message:=dll.lto_get_error_message).restype, lto_get_error_message.argtypes = Pointer(ctypes.c_char), []
except AttributeError: pass

try: (lto_module_is_object_file:=dll.lto_module_is_object_file).restype, lto_module_is_object_file.argtypes = lto_bool_t, [Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_module_is_object_file_for_target:=dll.lto_module_is_object_file_for_target).restype, lto_module_is_object_file_for_target.argtypes = lto_bool_t, [Pointer(ctypes.c_char), Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (lto_module_is_object_file_in_memory_for_target:=dll.lto_module_is_object_file_in_memory_for_target).restype, lto_module_is_object_file_in_memory_for_target.argtypes = lto_bool_t, [ctypes.c_void_p, size_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_module_create:=dll.lto_module_create).restype, lto_module_create.argtypes = lto_module_t, [Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (lto_module_create_from_memory_with_path:=dll.lto_module_create_from_memory_with_path).restype, lto_module_create_from_memory_with_path.argtypes = lto_module_t, [ctypes.c_void_p, size_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_module_create_in_local_context:=dll.lto_module_create_in_local_context).restype, lto_module_create_in_local_context.argtypes = lto_module_t, [ctypes.c_void_p, size_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_module_create_in_codegen_context:=dll.lto_module_create_in_codegen_context).restype, lto_module_create_in_codegen_context.argtypes = lto_module_t, [ctypes.c_void_p, size_t, Pointer(ctypes.c_char), lto_code_gen_t]
except AttributeError: pass

try: (lto_module_create_from_fd:=dll.lto_module_create_from_fd).restype, lto_module_create_from_fd.argtypes = lto_module_t, [ctypes.c_int32, Pointer(ctypes.c_char), size_t]
except AttributeError: pass

off_t = ctypes.c_int64
try: (lto_module_create_from_fd_at_offset:=dll.lto_module_create_from_fd_at_offset).restype, lto_module_create_from_fd_at_offset.argtypes = lto_module_t, [ctypes.c_int32, Pointer(ctypes.c_char), size_t, size_t, off_t]
except AttributeError: pass

try: (lto_module_dispose:=dll.lto_module_dispose).restype, lto_module_dispose.argtypes = None, [lto_module_t]
except AttributeError: pass

try: (lto_module_get_target_triple:=dll.lto_module_get_target_triple).restype, lto_module_get_target_triple.argtypes = Pointer(ctypes.c_char), [lto_module_t]
except AttributeError: pass

try: (lto_module_set_target_triple:=dll.lto_module_set_target_triple).restype, lto_module_set_target_triple.argtypes = None, [lto_module_t, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (lto_module_get_symbol_name:=dll.lto_module_get_symbol_name).restype, lto_module_get_symbol_name.argtypes = Pointer(ctypes.c_char), [lto_module_t, ctypes.c_uint32]
except AttributeError: pass
...
try: (lto_module_get_linkeropts:=dll.lto_module_get_linkeropts).restype, lto_module_get_linkeropts.argtypes = Pointer(ctypes.c_char), [lto_module_t]
except AttributeError: pass

try: (lto_module_get_macho_cputype:=dll.lto_module_get_macho_cputype).restype, lto_module_get_macho_cputype.argtypes = lto_bool_t, [lto_module_t, Pointer(ctypes.c_uint32), Pointer(ctypes.c_uint32)]
except AttributeError: pass
...
try: (lto_codegen_set_cpu:=dll.lto_codegen_set_cpu).restype, lto_codegen_set_cpu.argtypes = None, [lto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_codegen_set_assembler_path:=dll.lto_codegen_set_assembler_path).restype, lto_codegen_set_assembler_path.argtypes = None, [lto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_codegen_set_assembler_args:=dll.lto_codegen_set_assembler_args).restype, lto_codegen_set_assembler_args.argtypes = None, [lto_code_gen_t, Pointer(Pointer(ctypes.c_char)), ctypes.c_int32]
except AttributeError: pass

try: (lto_codegen_add_must_preserve_symbol:=dll.lto_codegen_add_must_preserve_symbol).restype, lto_codegen_add_must_preserve_symbol.argtypes = None, [lto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_codegen_write_merged_modules:=dll.lto_codegen_write_merged_modules).restype, lto_codegen_write_merged_modules.argtypes = lto_bool_t, [lto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_codegen_compile:=dll.lto_codegen_compile).restype, lto_codegen_compile.argtypes = ctypes.c_void_p, [lto_code_gen_t, Pointer(size_t)]
except AttributeError: pass

try: (lto_codegen_compile_to_file:=dll.lto_codegen_compile_to_file).restype, lto_codegen_compile_to_file.argtypes = lto_bool_t, [lto_code_gen_t, Pointer(Pointer(ctypes.c_char))]
except AttributeError: pass

try: (lto_codegen_optimize:=dll.lto_codegen_optimize).restype, lto_codegen_optimize.argtypes = lto_bool_t, [lto_code_gen_t]
except AttributeError: pass

try: (lto_codegen_compile_optimized:=dll.lto_codegen_compile_optimized).restype, lto_codegen_compile_optimized.argtypes = ctypes.c_void_p, [lto_code_gen_t, Pointer(size_t)]
except AttributeError: pass

try: (lto_api_version:=dll.lto_api_version).restype, lto_api_version.argtypes = ctypes.c_uint32, []
except AttributeError: pass

try: (lto_set_debug_options:=dll.lto_set_debug_options).restype, lto_set_debug_options.argtypes = None, [Pointer(Pointer(ctypes.c_char)), ctypes.c_int32]
except AttributeError: pass

try: (lto_codegen_debug_options:=dll.lto_codegen_debug_options).restype, lto_codegen_debug_options.argtypes = None, [lto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (lto_codegen_debug_options_array:=dll.lto_codegen_debug_options_array).restype, lto_codegen_debug_options_array.argtypes = None, [lto_code_gen_t, Pointer(Pointer(ctypes.c_char)), ctypes.c_int32]
except AttributeError: pass
...
try: (lto_input_create:=dll.lto_input_create).restype, lto_input_create.argtypes = lto_input_t, [ctypes.c_void_p, size_t, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (lto_input_get_dependent_library:=dll.lto_input_get_dependent_library).restype, lto_input_get_dependent_library.argtypes = Pointer(ctypes.c_char), [lto_input_t, size_t, Pointer(size_t)]
except AttributeError: pass

try: (lto_runtime_lib_symbols_list:=dll.lto_runtime_lib_symbols_list).restype, lto_runtime_lib_symbols_list.argtypes = Pointer(Pointer(ctypes.c_char)), [Pointer(size_t)]
except AttributeError: pass
...
try: (thinlto_codegen_add_module:=dll.thinlto_codegen_add_module).restype, thinlto_codegen_add_module.argtypes = None, [thinlto_code_gen_t, Pointer(ctypes.c_char), Pointer(ctypes.c_char), ctypes.c_int32]
except AttributeError: pass
...
try: (thinlto_module_get_object_file:=dll.thinlto_module_get_object_file).restype, thinlto_module_get_object_file.argtypes = Pointer(ctypes.c_char), [thinlto_code_gen_t, ctypes.c_uint32]
except AttributeError: pass
...
try: (thinlto_codegen_set_savetemps_dir:=dll.thinlto_codegen_set_savetemps_dir).restype, thinlto_codegen_set_savetemps_dir.argtypes = None, [thinlto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (thinlto_set_generated_objects_dir:=dll.thinlto_set_generated_objects_dir).restype, thinlto_set_generated_objects_dir.argtypes = None, [thinlto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass

try: (thinlto_codegen_set_cpu:=dll.thinlto_codegen_set_cpu).restype, thinlto_codegen_set_cpu.argtypes = None, [thinlto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass
...
try: (thinlto_debug_options:=dll.thinlto_debug_options).restype, thinlto_debug_options.argtypes = None, [Pointer(Pointer(ctypes.c_char)), ctypes.c_int32]
except AttributeError: pass

try: (lto_module_is_thinlto:=dll.lto_module_is_thinlto).restype, lto_module_is_thinlto.argtypes = lto_bool_t, [lto_module_t]
except AttributeError: pass

try: (thinlto_codegen_add_must_preserve_symbol:=dll.thinlto_codegen_add_must_preserve_symbol).restype, thinlto_codegen_add_must_preserve_symbol.argtypes = None, [thinlto_code_gen_t, Pointer(ctypes.c_char), ctypes.c_int32]
except AttributeError: pass

try: (thinlto_codegen_add_cross_referenced_symbol:=dll.thinlto_codegen_add_cross_referenced_symbol).restype, thinlto_codegen_add_cross_referenced_symbol.argtypes = None, [thinlto_code_gen_t, Pointer(ctypes.c_char), ctypes.c_int32]
except AttributeError: pass

try: (thinlto_codegen_set_cache_dir:=dll.thinlto_codegen_set_cache_dir).restype, thinlto_codegen_set_cache_dir.argtypes = None, [thinlto_code_gen_t, Pointer(ctypes.c_char)]
except AttributeError: pass
