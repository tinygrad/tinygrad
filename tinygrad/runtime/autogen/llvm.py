...
class LLVMVerifierFailureAction(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def LLVMVerifyModule(M:LLVMModuleRef, Action:LLVMVerifierFailureAction, OutMessage:c.POINTER[c.POINTER[ctypes.c_char]]) -> LLVMBool: ...
...
class LLVMComdatSelectionKind(ctypes.c_uint32, c.Enum): pass
...
class LLVMOpcode(ctypes.c_uint32, c.Enum): pass
...
class LLVMLinkage(ctypes.c_uint32, c.Enum): pass
...
class LLVMVisibility(ctypes.c_uint32, c.Enum): pass
...
class LLVMUnnamedAddr(ctypes.c_uint32, c.Enum): pass
...
class LLVMDLLStorageClass(ctypes.c_uint32, c.Enum): pass
...
class LLVMCallConv(ctypes.c_uint32, c.Enum): pass
...
class LLVMValueKind(ctypes.c_uint32, c.Enum): pass
...
class LLVMRealPredicate(ctypes.c_uint32, c.Enum): pass
...
class LLVMLandingPadClauseTy(ctypes.c_uint32, c.Enum): pass
...
class LLVMThreadLocalMode(ctypes.c_uint32, c.Enum): pass
...
class LLVMAtomicOrdering(ctypes.c_uint32, c.Enum): pass
...
class LLVMDiagnosticSeverity(ctypes.c_uint32, c.Enum): pass
...
class LLVMInlineAsmDialect(ctypes.c_uint32, c.Enum): pass
...
class LLVMModuleFlagBehavior(ctypes.c_uint32, c.Enum): pass
...
class _anonenum0(ctypes.c_int32, c.Enum): pass
...
class LLVMTailCallKind(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def LLVMModuleFlagEntriesGetFlagBehavior(Entries:c.POINTER[LLVMModuleFlagEntry], Index:ctypes.c_uint32) -> LLVMModuleFlagBehavior: ...
@dll.bind
...
@dll.bind
def LLVMAddModuleFlag(M:LLVMModuleRef, Behavior:LLVMModuleFlagBehavior, Key:c.POINTER[ctypes.c_char], KeyLen:size_t, Val:LLVMMetadataRef) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGetInlineAsm(Ty:LLVMTypeRef, AsmString:c.POINTER[ctypes.c_char], AsmStringSize:size_t, Constraints:c.POINTER[ctypes.c_char], ConstraintsSize:size_t, HasSideEffects:LLVMBool, IsAlignStack:LLVMBool, Dialect:LLVMInlineAsmDialect, CanThrow:LLVMBool) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildBinOp(B:LLVMBuilderRef, Op:LLVMOpcode, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:c.POINTER[ctypes.c_char]) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildCast(B:LLVMBuilderRef, Op:LLVMOpcode, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:c.POINTER[ctypes.c_char]) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildICmp(_0:LLVMBuilderRef, Op:LLVMIntPredicate, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:c.POINTER[ctypes.c_char]) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFCmp(_0:LLVMBuilderRef, Op:LLVMRealPredicate, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:c.POINTER[ctypes.c_char]) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildFence(B:LLVMBuilderRef, ordering:LLVMAtomicOrdering, singleThread:LLVMBool, Name:c.POINTER[ctypes.c_char]) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFenceSyncScope(B:LLVMBuilderRef, ordering:LLVMAtomicOrdering, SSID:ctypes.c_uint32, Name:c.POINTER[ctypes.c_char]) -> LLVMValueRef: ...
@dll.bind
...
class LLVMDIFlags(ctypes.c_uint32, c.Enum): pass
...
class LLVMDWARFSourceLanguage(ctypes.c_uint32, c.Enum): pass
...
class LLVMDWARFEmissionKind(ctypes.c_uint32, c.Enum): pass
...
class LLVMDWARFMacinfoRecordType(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def LLVMDIBuilderCreateCompileUnit(Builder:LLVMDIBuilderRef, Lang:LLVMDWARFSourceLanguage, FileRef:LLVMMetadataRef, Producer:c.POINTER[ctypes.c_char], ProducerLen:size_t, isOptimized:LLVMBool, Flags:c.POINTER[ctypes.c_char], FlagsLen:size_t, RuntimeVer:ctypes.c_uint32, SplitName:c.POINTER[ctypes.c_char], SplitNameLen:size_t, Kind:LLVMDWARFEmissionKind, DWOId:ctypes.c_uint32, SplitDebugInlining:LLVMBool, DebugInfoForProfiling:LLVMBool, SysRoot:c.POINTER[ctypes.c_char], SysRootLen:size_t, SDK:c.POINTER[ctypes.c_char], SDKLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateFunction(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, LinkageName:c.POINTER[ctypes.c_char], LinkageNameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, Ty:LLVMMetadataRef, IsLocalToUnit:LLVMBool, IsDefinition:LLVMBool, ScopeLine:ctypes.c_uint32, Flags:LLVMDIFlags, IsOptimized:LLVMBool) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateSubroutineType(Builder:LLVMDIBuilderRef, File:LLVMMetadataRef, ParameterTypes:c.POINTER[LLVMMetadataRef], NumParameterTypes:ctypes.c_uint32, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateMacro(Builder:LLVMDIBuilderRef, ParentMacroFile:LLVMMetadataRef, Line:ctypes.c_uint32, RecordType:LLVMDWARFMacinfoRecordType, Name:c.POINTER[ctypes.c_char], NameLen:size_t, Value:c.POINTER[ctypes.c_char], ValueLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateUnionType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, Elements:c.POINTER[LLVMMetadataRef], NumElements:ctypes.c_uint32, RunTimeLang:ctypes.c_uint32, UniqueId:c.POINTER[ctypes.c_char], UniqueIdLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateBasicType(Builder:LLVMDIBuilderRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, SizeInBits:uint64_t, Encoding:LLVMDWARFTypeEncoding, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateStructType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, DerivedFrom:LLVMMetadataRef, Elements:c.POINTER[LLVMMetadataRef], NumElements:ctypes.c_uint32, RunTimeLang:ctypes.c_uint32, VTableHolder:LLVMMetadataRef, UniqueId:c.POINTER[ctypes.c_char], UniqueIdLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, Ty:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateStaticMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, Type:LLVMMetadataRef, Flags:LLVMDIFlags, ConstantVal:LLVMValueRef, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateObjCIVar(Builder:LLVMDIBuilderRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, Ty:LLVMMetadataRef, PropertyNode:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateReplaceableCompositeType(Builder:LLVMDIBuilderRef, Tag:ctypes.c_uint32, Name:c.POINTER[ctypes.c_char], NameLen:size_t, Scope:LLVMMetadataRef, File:LLVMMetadataRef, Line:ctypes.c_uint32, RuntimeLang:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, UniqueIdentifier:c.POINTER[ctypes.c_char], UniqueIdentifierLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateBitFieldMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, OffsetInBits:uint64_t, StorageOffsetInBits:uint64_t, Flags:LLVMDIFlags, Type:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateClassType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, DerivedFrom:LLVMMetadataRef, Elements:c.POINTER[LLVMMetadataRef], NumElements:ctypes.c_uint32, VTableHolder:LLVMMetadataRef, TemplateParamsNode:LLVMMetadataRef, UniqueIdentifier:c.POINTER[ctypes.c_char], UniqueIdentifierLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateAutoVariable(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, Ty:LLVMMetadataRef, AlwaysPreserve:LLVMBool, Flags:LLVMDIFlags, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateParameterVariable(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:c.POINTER[ctypes.c_char], NameLen:size_t, ArgNo:ctypes.c_uint32, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, Ty:LLVMMetadataRef, AlwaysPreserve:LLVMBool, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
...
class enum_LLVMByteOrdering(ctypes.c_uint32, c.Enum): pass
...
class LLVMCodeGenOptLevel(ctypes.c_uint32, c.Enum): pass
...
class LLVMRelocMode(ctypes.c_uint32, c.Enum): pass
...
class LLVMCodeModel(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def LLVMCreateTargetMachine(T:LLVMTargetRef, Triple:c.POINTER[ctypes.c_char], CPU:c.POINTER[ctypes.c_char], Features:c.POINTER[ctypes.c_char], Level:LLVMCodeGenOptLevel, Reloc:LLVMRelocMode, CodeModel:LLVMCodeModel) -> LLVMTargetMachineRef: ...
@dll.bind
...
class LLVMGlobalISelAbortMode(ctypes.c_uint32, c.Enum): pass
...
class LLVMCodeGenFileType(ctypes.c_uint32, c.Enum): pass
LLVMAssemblyFile = LLVMCodeGenFileType.define('LLVMAssemblyFile', 0)
LLVMObjectFile = LLVMCodeGenFileType.define('LLVMObjectFile', 1)

@dll.bind
def LLVMTargetMachineEmitToFile(T:LLVMTargetMachineRef, M:LLVMModuleRef, Filename:c.POINTER[ctypes.c_char], codegen:LLVMCodeGenFileType, ErrorMessage:c.POINTER[c.POINTER[ctypes.c_char]]) -> LLVMBool: ...
@dll.bind
def LLVMTargetMachineEmitToMemoryBuffer(T:LLVMTargetMachineRef, M:LLVMModuleRef, codegen:LLVMCodeGenFileType, ErrorMessage:c.POINTER[c.POINTER[ctypes.c_char]], OutMemBuf:c.POINTER[LLVMMemoryBufferRef]) -> LLVMBool: ...
@dll.bind
...
struct_LLVMMCJITCompilerOptions.register_fields([('OptLevel', ctypes.c_uint32, 0), ('CodeModel', LLVMCodeModel, 4), ('NoFramePointerElim', LLVMBool, 8), ('EnableFastISel', LLVMBool, 12), ('MCJMM', LLVMMCJITMemoryManagerRef, 16)])
@dll.bind
...
class LLVMOrcLookupKind(ctypes.c_uint32, c.Enum): pass
...
class LLVMOrcJITDylibLookupFlags(ctypes.c_uint32, c.Enum): pass
...
LLVMOrcCJITDylibSearchOrderElement.register_fields([('JD', LLVMOrcJITDylibRef, 0), ('JDLookupFlags', LLVMOrcJITDylibLookupFlags, 8)])
...
class LLVMOrcSymbolLookupFlags(ctypes.c_uint32, c.Enum): pass
...
LLVMOrcCLookupSetElement.register_fields([('Name', LLVMOrcSymbolStringPoolEntryRef, 0), ('LookupFlags', LLVMOrcSymbolLookupFlags, 8)])
...
class LLVMLinkerMode(ctypes.c_uint32, c.Enum): pass
...
class LLVMBinaryType(ctypes.c_uint32, c.Enum): pass
...
class LLVMJITSymbolGenericFlags(ctypes.c_uint32, c.Enum): pass
...
class enum_LLVMRemarkType(ctypes.c_uint32, c.Enum): pass
...
class lto_symbol_attributes(ctypes.c_uint32, c.Enum): pass
...
class lto_debug_model(ctypes.c_uint32, c.Enum): pass
...
class lto_codegen_model(ctypes.c_uint32, c.Enum): pass
...
class lto_codegen_diagnostic_severity_t(ctypes.c_uint32, c.Enum): pass
...
lto_diagnostic_handler_t: TypeAlias = c.CFUNCTYPE[None, [lto_codegen_diagnostic_severity_t, c.POINTER[ctypes.c_char], ctypes.c_void_p]]
@dll.bind
