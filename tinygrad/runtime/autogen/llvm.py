...
class imaxdiv_t:
  SIZE = 16
  quot: Annotated[ctypes.c_int64, 0]
  rem: Annotated[ctypes.c_int64, 8]
@dll.bind
...
@dll.bind
def LLVMVerifyModule(M:LLVMModuleRef, Action:LLVMVerifierFailureAction, OutMessage:ctypes.POINTER(ctypes.POINTER(ctypes.c_char))) -> LLVMBool: ...
...
@dll.bind
def LLVMContextSetDiagnosticHandler(C:LLVMContextRef, Handler:LLVMDiagnosticHandler, DiagnosticContext:ctypes.POINTER(None)) -> None: ...
@dll.bind
def LLVMContextGetDiagnosticHandler(C:LLVMContextRef) -> LLVMDiagnosticHandler: ...
@dll.bind
def LLVMContextGetDiagnosticContext(C:LLVMContextRef) -> ctypes.POINTER(None): ...
@dll.bind
def LLVMContextSetYieldCallback(C:LLVMContextRef, Callback:LLVMYieldCallback, OpaqueHandle:ctypes.POINTER(None)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMModuleFlagEntriesGetFlagBehavior(Entries:ctypes.POINTER(LLVMModuleFlagEntry), Index:ctypes.c_uint32) -> LLVMModuleFlagBehavior: ...
@dll.bind
...
@dll.bind
def LLVMAddModuleFlag(M:LLVMModuleRef, Behavior:LLVMModuleFlagBehavior, Key:ctypes.POINTER(ctypes.c_char), KeyLen:size_t, Val:LLVMMetadataRef) -> None: ...
@dll.bind
...
@dll.bind
def LLVMGetInlineAsm(Ty:LLVMTypeRef, AsmString:ctypes.POINTER(ctypes.c_char), AsmStringSize:size_t, Constraints:ctypes.POINTER(ctypes.c_char), ConstraintsSize:size_t, HasSideEffects:LLVMBool, IsAlignStack:LLVMBool, Dialect:LLVMInlineAsmDialect, CanThrow:LLVMBool) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildBinOp(B:LLVMBuilderRef, Op:LLVMOpcode, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:ctypes.POINTER(ctypes.c_char)) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildCast(B:LLVMBuilderRef, Op:LLVMOpcode, Val:LLVMValueRef, DestTy:LLVMTypeRef, Name:ctypes.POINTER(ctypes.c_char)) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildICmp(_0:LLVMBuilderRef, Op:LLVMIntPredicate, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:ctypes.POINTER(ctypes.c_char)) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFCmp(_0:LLVMBuilderRef, Op:LLVMRealPredicate, LHS:LLVMValueRef, RHS:LLVMValueRef, Name:ctypes.POINTER(ctypes.c_char)) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildFence(B:LLVMBuilderRef, ordering:LLVMAtomicOrdering, singleThread:LLVMBool, Name:ctypes.POINTER(ctypes.c_char)) -> LLVMValueRef: ...
@dll.bind
def LLVMBuildFenceSyncScope(B:LLVMBuilderRef, ordering:LLVMAtomicOrdering, SSID:ctypes.c_uint32, Name:ctypes.POINTER(ctypes.c_char)) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildAtomicRMWSyncScope(B:LLVMBuilderRef, op:LLVMAtomicRMWBinOp, PTR:LLVMValueRef, Val:LLVMValueRef, ordering:LLVMAtomicOrdering, SSID:ctypes.c_uint32) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMBuildAtomicCmpXchgSyncScope(B:LLVMBuilderRef, Ptr:LLVMValueRef, Cmp:LLVMValueRef, New:LLVMValueRef, SuccessOrdering:LLVMAtomicOrdering, FailureOrdering:LLVMAtomicOrdering, SSID:ctypes.c_uint32) -> LLVMValueRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateCompileUnit(Builder:LLVMDIBuilderRef, Lang:LLVMDWARFSourceLanguage, FileRef:LLVMMetadataRef, Producer:ctypes.POINTER(ctypes.c_char), ProducerLen:size_t, isOptimized:LLVMBool, Flags:ctypes.POINTER(ctypes.c_char), FlagsLen:size_t, RuntimeVer:ctypes.c_uint32, SplitName:ctypes.POINTER(ctypes.c_char), SplitNameLen:size_t, Kind:LLVMDWARFEmissionKind, DWOId:ctypes.c_uint32, SplitDebugInlining:LLVMBool, DebugInfoForProfiling:LLVMBool, SysRoot:ctypes.POINTER(ctypes.c_char), SysRootLen:size_t, SDK:ctypes.POINTER(ctypes.c_char), SDKLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateFunction(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, LinkageName:ctypes.POINTER(ctypes.c_char), LinkageNameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, Ty:LLVMMetadataRef, IsLocalToUnit:LLVMBool, IsDefinition:LLVMBool, ScopeLine:ctypes.c_uint32, Flags:LLVMDIFlags, IsOptimized:LLVMBool) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateSubroutineType(Builder:LLVMDIBuilderRef, File:LLVMMetadataRef, ParameterTypes:ctypes.POINTER(LLVMMetadataRef), NumParameterTypes:ctypes.c_uint32, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateMacro(Builder:LLVMDIBuilderRef, ParentMacroFile:LLVMMetadataRef, Line:ctypes.c_uint32, RecordType:LLVMDWARFMacinfoRecordType, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, Value:ctypes.POINTER(ctypes.c_char), ValueLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateUnionType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, Elements:ctypes.POINTER(LLVMMetadataRef), NumElements:ctypes.c_uint32, RunTimeLang:ctypes.c_uint32, UniqueId:ctypes.POINTER(ctypes.c_char), UniqueIdLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateBasicType(Builder:LLVMDIBuilderRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, SizeInBits:uint64_t, Encoding:LLVMDWARFTypeEncoding, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateStructType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, DerivedFrom:LLVMMetadataRef, Elements:ctypes.POINTER(LLVMMetadataRef), NumElements:ctypes.c_uint32, RunTimeLang:ctypes.c_uint32, VTableHolder:LLVMMetadataRef, UniqueId:ctypes.POINTER(ctypes.c_char), UniqueIdLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, Ty:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateStaticMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, Type:LLVMMetadataRef, Flags:LLVMDIFlags, ConstantVal:LLVMValueRef, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateObjCIVar(Builder:LLVMDIBuilderRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, Ty:LLVMMetadataRef, PropertyNode:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateReplaceableCompositeType(Builder:LLVMDIBuilderRef, Tag:ctypes.c_uint32, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, Scope:LLVMMetadataRef, File:LLVMMetadataRef, Line:ctypes.c_uint32, RuntimeLang:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, Flags:LLVMDIFlags, UniqueIdentifier:ctypes.POINTER(ctypes.c_char), UniqueIdentifierLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateBitFieldMemberType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, OffsetInBits:uint64_t, StorageOffsetInBits:uint64_t, Flags:LLVMDIFlags, Type:LLVMMetadataRef) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateClassType(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNumber:ctypes.c_uint32, SizeInBits:uint64_t, AlignInBits:uint32_t, OffsetInBits:uint64_t, Flags:LLVMDIFlags, DerivedFrom:LLVMMetadataRef, Elements:ctypes.POINTER(LLVMMetadataRef), NumElements:ctypes.c_uint32, VTableHolder:LLVMMetadataRef, TemplateParamsNode:LLVMMetadataRef, UniqueIdentifier:ctypes.POINTER(ctypes.c_char), UniqueIdentifierLen:size_t) -> LLVMMetadataRef: ...
@dll.bind
...
@dll.bind
def LLVMDIBuilderCreateAutoVariable(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, Ty:LLVMMetadataRef, AlwaysPreserve:LLVMBool, Flags:LLVMDIFlags, AlignInBits:uint32_t) -> LLVMMetadataRef: ...
@dll.bind
def LLVMDIBuilderCreateParameterVariable(Builder:LLVMDIBuilderRef, Scope:LLVMMetadataRef, Name:ctypes.POINTER(ctypes.c_char), NameLen:size_t, ArgNo:ctypes.c_uint32, File:LLVMMetadataRef, LineNo:ctypes.c_uint32, Ty:LLVMMetadataRef, AlwaysPreserve:LLVMBool, Flags:LLVMDIFlags) -> LLVMMetadataRef: ...
@dll.bind
...
LLVMOpInfoCallback = ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(None), ctypes.c_uint64, ctypes.c_uint64, ctypes.c_uint64, ctypes.c_uint64, ctypes.c_int32, ctypes.POINTER(None))
...
@dll.bind
def LLVMCreateDisasm(TripleName:ctypes.POINTER(ctypes.c_char), DisInfo:ctypes.POINTER(None), TagType:ctypes.c_int32, GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
def LLVMCreateDisasmCPU(Triple:ctypes.POINTER(ctypes.c_char), CPU:ctypes.POINTER(ctypes.c_char), DisInfo:ctypes.POINTER(None), TagType:ctypes.c_int32, GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
def LLVMCreateDisasmCPUFeatures(Triple:ctypes.POINTER(ctypes.c_char), CPU:ctypes.POINTER(ctypes.c_char), Features:ctypes.POINTER(ctypes.c_char), DisInfo:ctypes.POINTER(None), TagType:ctypes.c_int32, GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
...
@dll.bind
def LLVMCreateTargetMachine(T:LLVMTargetRef, Triple:ctypes.POINTER(ctypes.c_char), CPU:ctypes.POINTER(ctypes.c_char), Features:ctypes.POINTER(ctypes.c_char), Level:LLVMCodeGenOptLevel, Reloc:LLVMRelocMode, CodeModel:LLVMCodeModel) -> LLVMTargetMachineRef: ...
@dll.bind
...
@dll.bind
def LLVMTargetMachineEmitToFile(T:LLVMTargetMachineRef, M:LLVMModuleRef, Filename:ctypes.POINTER(ctypes.c_char), codegen:LLVMCodeGenFileType, ErrorMessage:ctypes.POINTER(ctypes.POINTER(ctypes.c_char))) -> LLVMBool: ...
@dll.bind
def LLVMTargetMachineEmitToMemoryBuffer(T:LLVMTargetMachineRef, M:LLVMModuleRef, codegen:LLVMCodeGenFileType, ErrorMessage:ctypes.POINTER(ctypes.POINTER(ctypes.c_char)), OutMemBuf:ctypes.POINTER(LLVMMemoryBufferRef)) -> LLVMBool: ...
@dll.bind
...
class struct_LLVMMCJITCompilerOptions:
  SIZE = 24
  OptLevel: Annotated[ctypes.c_uint32, 0]
...
@dll.bind
def LLVMCreateGenericValueOfPointer(P:ctypes.POINTER(None)) -> LLVMGenericValueRef: ...
@dll.bind
...
@dll.bind
def LLVMGenericValueToPointer(GenVal:LLVMGenericValueRef) -> ctypes.POINTER(None): ...
@dll.bind
...
@dll.bind
def LLVMRecompileAndRelinkFunction(EE:LLVMExecutionEngineRef, Fn:LLVMValueRef) -> ctypes.POINTER(None): ...
@dll.bind
...
@dll.bind
def LLVMAddGlobalMapping(EE:LLVMExecutionEngineRef, Global:LLVMValueRef, Addr:ctypes.POINTER(None)) -> None: ...
@dll.bind
def LLVMGetPointerToGlobal(EE:LLVMExecutionEngineRef, Global:LLVMValueRef) -> ctypes.POINTER(None): ...
@dll.bind
...
@dll.bind
def LLVMOrcExecutionSessionSetErrorReporter(ES:LLVMOrcExecutionSessionRef, ReportError:LLVMOrcErrorReporterFunction, Ctx:ctypes.POINTER(None)) -> None: ...
...
LLVMOrcExecutionSessionLookupHandleResultFunction = ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_LLVMOpaqueError), ctypes.POINTER(LLVMOrcCSymbolMapPair), ctypes.c_uint64, ctypes.POINTER(None))
@dll.bind
def LLVMOrcExecutionSessionLookup(ES:LLVMOrcExecutionSessionRef, K:LLVMOrcLookupKind, SearchOrder:LLVMOrcCJITDylibSearchOrder, SearchOrderSize:size_t, Symbols:LLVMOrcCLookupSet, SymbolsSize:size_t, HandleResult:LLVMOrcExecutionSessionLookupHandleResultFunction, Ctx:ctypes.POINTER(None)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMOrcCreateCustomMaterializationUnit(Name:ctypes.POINTER(ctypes.c_char), Ctx:ctypes.POINTER(None), Syms:LLVMOrcCSymbolFlagsMapPairs, NumSyms:size_t, InitSym:LLVMOrcSymbolStringPoolEntryRef, Materialize:LLVMOrcMaterializationUnitMaterializeFunction, Discard:LLVMOrcMaterializationUnitDiscardFunction, Destroy:LLVMOrcMaterializationUnitDestroyFunction) -> LLVMOrcMaterializationUnitRef: ...
...
class LLVMOrcCSymbolsList:
  SIZE = 16
  Symbols: Annotated[ctypes.POINTER(LLVMOrcSymbolStringPoolEntryRef), 0]
...
LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction = ctypes.CFUNCTYPE(ctypes.POINTER(struct_LLVMOpaqueError), ctypes.POINTER(struct_LLVMOrcOpaqueDefinitionGenerator), ctypes.POINTER(None), ctypes.POINTER(ctypes.POINTER(struct_LLVMOrcOpaqueLookupState)), LLVMOrcLookupKind, ctypes.POINTER(struct_LLVMOrcOpaqueJITDylib), LLVMOrcJITDylibLookupFlags, ctypes.POINTER(LLVMOrcCLookupSetElement), ctypes.c_uint64)
LLVMOrcDisposeCAPIDefinitionGeneratorFunction = ctypes.CFUNCTYPE(None, ctypes.POINTER(None))
@dll.bind
def LLVMOrcCreateCustomCAPIDefinitionGenerator(F:LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction, Ctx:ctypes.POINTER(None), Dispose:LLVMOrcDisposeCAPIDefinitionGeneratorFunction) -> LLVMOrcDefinitionGeneratorRef: ...
...
@dll.bind
def LLVMOrcCreateDynamicLibrarySearchGeneratorForProcess(Result:ctypes.POINTER(LLVMOrcDefinitionGeneratorRef), GlobalPrefx:ctypes.c_char, Filter:LLVMOrcSymbolPredicate, FilterCtx:ctypes.POINTER(None)) -> LLVMErrorRef: ...
@dll.bind
def LLVMOrcCreateDynamicLibrarySearchGeneratorForPath(Result:ctypes.POINTER(LLVMOrcDefinitionGeneratorRef), FileName:ctypes.POINTER(ctypes.c_char), GlobalPrefix:ctypes.c_char, Filter:LLVMOrcSymbolPredicate, FilterCtx:ctypes.POINTER(None)) -> LLVMErrorRef: ...
...
@dll.bind
def LLVMOrcThreadSafeModuleWithModuleDo(TSM:LLVMOrcThreadSafeModuleRef, F:LLVMOrcGenericIRModuleOperationFunction, Ctx:ctypes.POINTER(None)) -> LLVMErrorRef: ...
...
@dll.bind
def LLVMOrcIRTransformLayerSetTransform(IRTransformLayer:LLVMOrcIRTransformLayerRef, TransformFunction:LLVMOrcIRTransformLayerTransformFunction, Ctx:ctypes.POINTER(None)) -> None: ...
...
@dll.bind
def LLVMOrcObjectTransformLayerSetTransform(ObjTransformLayer:LLVMOrcObjectTransformLayerRef, TransformFunction:LLVMOrcObjectTransformLayerTransformFunction, Ctx:ctypes.POINTER(None)) -> None: ...
@dll.bind
...
@dll.bind
def LLVMOrcLLJITBuilderSetObjectLinkingLayerCreator(Builder:LLVMOrcLLJITBuilderRef, F:LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction, Ctx:ctypes.POINTER(None)) -> None: ...
@dll.bind
...
LLVMMemoryManagerCreateContextCallback = ctypes.CFUNCTYPE(ctypes.POINTER(None), ctypes.POINTER(None))
LLVMMemoryManagerNotifyTerminatingCallback = ctypes.CFUNCTYPE(None, ctypes.POINTER(None))
@dll.bind
def LLVMOrcCreateRTDyldObjectLinkingLayerWithSectionMemoryManager(ES:LLVMOrcExecutionSessionRef) -> LLVMOrcObjectLayerRef: ...
@dll.bind
def LLVMOrcCreateRTDyldObjectLinkingLayerWithMCJITMemoryManagerLikeCallbacks(ES:LLVMOrcExecutionSessionRef, CreateContextCtx:ctypes.POINTER(None), CreateContext:LLVMMemoryManagerCreateContextCallback, NotifyTerminating:LLVMMemoryManagerNotifyTerminatingCallback, AllocateCodeSection:LLVMMemoryManagerAllocateCodeSectionCallback, AllocateDataSection:LLVMMemoryManagerAllocateDataSectionCallback, FinalizeMemory:LLVMMemoryManagerFinalizeMemoryCallback, Destroy:LLVMMemoryManagerDestroyCallback) -> LLVMOrcObjectLayerRef: ...
@dll.bind
...
@dll.bind
def LLVMRemarkParserCreateYAML(Buf:ctypes.POINTER(None), Size:uint64_t) -> LLVMRemarkParserRef: ...
@dll.bind
def LLVMRemarkParserCreateBitstream(Buf:ctypes.POINTER(None), Size:uint64_t) -> LLVMRemarkParserRef: ...
@dll.bind
...
@dll.bind
def LLVMSearchForAddressOfSymbol(symbolName:ctypes.POINTER(ctypes.c_char)) -> ctypes.POINTER(None): ...
@dll.bind
def LLVMAddSymbol(symbolName:ctypes.POINTER(ctypes.c_char), symbolValue:ctypes.POINTER(None)) -> None: ...
...
@dll.bind
def llvm_blake3_hasher_init_derive_key_raw(self:ctypes.POINTER(llvm_blake3_hasher), context:ctypes.POINTER(None), context_len:size_t) -> None: ...
@dll.bind
def llvm_blake3_hasher_update(self:ctypes.POINTER(llvm_blake3_hasher), input:ctypes.POINTER(None), input_len:size_t) -> None: ...
@dll.bind
...
@dll.bind
def lto_module_has_objc_category(mem:ctypes.POINTER(None), length:size_t) -> lto_bool_t: ...
@dll.bind
def lto_module_is_object_file_in_memory(mem:ctypes.POINTER(None), length:size_t) -> lto_bool_t: ...
@dll.bind
def lto_module_is_object_file_in_memory_for_target(mem:ctypes.POINTER(None), length:size_t, target_triple_prefix:ctypes.POINTER(ctypes.c_char)) -> lto_bool_t: ...
@dll.bind
def lto_module_create(path:ctypes.POINTER(ctypes.c_char)) -> lto_module_t: ...
@dll.bind
def lto_module_create_from_memory(mem:ctypes.POINTER(None), length:size_t) -> lto_module_t: ...
@dll.bind
def lto_module_create_from_memory_with_path(mem:ctypes.POINTER(None), length:size_t, path:ctypes.POINTER(ctypes.c_char)) -> lto_module_t: ...
@dll.bind
def lto_module_create_in_local_context(mem:ctypes.POINTER(None), length:size_t, path:ctypes.POINTER(ctypes.c_char)) -> lto_module_t: ...
@dll.bind
def lto_module_create_in_codegen_context(mem:ctypes.POINTER(None), length:size_t, path:ctypes.POINTER(ctypes.c_char), cg:lto_code_gen_t) -> lto_module_t: ...
@dll.bind
...
@dll.bind
def lto_module_get_symbol_attribute(mod:lto_module_t, index:ctypes.c_uint32) -> lto_symbol_attributes: ...
@dll.bind
...
lto_diagnostic_handler_t = ctypes.CFUNCTYPE(None, lto_codegen_diagnostic_severity_t, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(None))
@dll.bind
def lto_codegen_set_diagnostic_handler(_0:lto_code_gen_t, _1:lto_diagnostic_handler_t, _2:ctypes.POINTER(None)) -> None: ...
@dll.bind
...
@dll.bind
def lto_codegen_compile(cg:lto_code_gen_t, length:ctypes.POINTER(size_t)) -> ctypes.POINTER(None): ...
@dll.bind
...
@dll.bind
def lto_codegen_compile_optimized(cg:lto_code_gen_t, length:ctypes.POINTER(size_t)) -> ctypes.POINTER(None): ...
@dll.bind
...
@dll.bind
def lto_input_create(buffer:ctypes.POINTER(None), buffer_size:size_t, path:ctypes.POINTER(ctypes.c_char)) -> lto_input_t: ...
@dll.bind
...
class LTOObjectBuffer:
  SIZE = 16
  Buffer: Annotated[ctypes.POINTER(ctypes.c_char), 0]
