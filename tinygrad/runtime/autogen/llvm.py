...
@dll.bind
def LLVMContextSetDiagnosticHandler(C:LLVMContextRef, Handler:LLVMDiagnosticHandler, DiagnosticContext:c.POINTER[None]) -> None: ...
@dll.bind
def LLVMContextGetDiagnosticHandler(C:LLVMContextRef) -> LLVMDiagnosticHandler: ...
@dll.bind
def LLVMContextGetDiagnosticContext(C:LLVMContextRef) -> c.POINTER[None]: ...
@dll.bind
def LLVMContextSetYieldCallback(C:LLVMContextRef, Callback:LLVMYieldCallback, OpaqueHandle:c.POINTER[None]) -> None: ...
@dll.bind
...
@dll.bind
def LLVMCreateDisasmCPU(Triple:c.POINTER[Annotated[bytes, ctypes.c_char]], CPU:c.POINTER[Annotated[bytes, ctypes.c_char]], DisInfo:c.POINTER[None], TagType:Annotated[int, ctypes.c_int32], GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
def LLVMCreateDisasmCPUFeatures(Triple:c.POINTER[Annotated[bytes, ctypes.c_char]], CPU:c.POINTER[Annotated[bytes, ctypes.c_char]], Features:c.POINTER[Annotated[bytes, ctypes.c_char]], DisInfo:c.POINTER[None], TagType:Annotated[int, ctypes.c_int32], GetOpInfo:LLVMOpInfoCallback, SymbolLookUp:LLVMSymbolLookupCallback) -> LLVMDisasmContextRef: ...
@dll.bind
...
@dll.bind
def LLVMCreateGenericValueOfPointer(P:c.POINTER[None]) -> LLVMGenericValueRef: ...
@dll.bind
...
@dll.bind
def LLVMGenericValueToPointer(GenVal:LLVMGenericValueRef) -> c.POINTER[None]: ...
@dll.bind
...
@dll.bind
def LLVMRecompileAndRelinkFunction(EE:LLVMExecutionEngineRef, Fn:LLVMValueRef) -> c.POINTER[None]: ...
@dll.bind
...
@dll.bind
def LLVMAddGlobalMapping(EE:LLVMExecutionEngineRef, Global:LLVMValueRef, Addr:c.POINTER[None]) -> None: ...
@dll.bind
def LLVMGetPointerToGlobal(EE:LLVMExecutionEngineRef, Global:LLVMValueRef) -> c.POINTER[None]: ...
@dll.bind
...
@dll.bind
def LLVMOrcLLJITBuilderSetObjectLinkingLayerCreator(Builder:LLVMOrcLLJITBuilderRef, F:LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction, Ctx:c.POINTER[None]) -> None: ...
@dll.bind
...
@dll.bind
def LLVMRemarkParserCreateBitstream(Buf:c.POINTER[None], Size:uint64_t) -> LLVMRemarkParserRef: ...
@dll.bind
...
@dll.bind
def LLVMSearchForAddressOfSymbol(symbolName:c.POINTER[Annotated[bytes, ctypes.c_char]]) -> c.POINTER[None]: ...
@dll.bind
...
@dll.bind
def llvm_blake3_hasher_init_derive_key_raw(self:c.POINTER[llvm_blake3_hasher], context:c.POINTER[None], context_len:size_t) -> None: ...
@dll.bind
def llvm_blake3_hasher_update(self:c.POINTER[llvm_blake3_hasher], input:c.POINTER[None], input_len:size_t) -> None: ...
@dll.bind
...
@dll.bind
def lto_module_has_objc_category(mem:c.POINTER[None], length:size_t) -> lto_bool_t: ...
@dll.bind
def lto_module_is_object_file_in_memory(mem:c.POINTER[None], length:size_t) -> lto_bool_t: ...
@dll.bind
def lto_module_is_object_file_in_memory_for_target(mem:c.POINTER[None], length:size_t, target_triple_prefix:c.POINTER[Annotated[bytes, ctypes.c_char]]) -> lto_bool_t: ...
@dll.bind
def lto_module_create(path:c.POINTER[Annotated[bytes, ctypes.c_char]]) -> lto_module_t: ...
@dll.bind
def lto_module_create_from_memory(mem:c.POINTER[None], length:size_t) -> lto_module_t: ...
@dll.bind
def lto_module_create_from_memory_with_path(mem:c.POINTER[None], length:size_t, path:c.POINTER[Annotated[bytes, ctypes.c_char]]) -> lto_module_t: ...
@dll.bind
def lto_module_create_in_local_context(mem:c.POINTER[None], length:size_t, path:c.POINTER[Annotated[bytes, ctypes.c_char]]) -> lto_module_t: ...
@dll.bind
...
@dll.bind
def lto_codegen_compile(cg:lto_code_gen_t, length:c.POINTER[size_t]) -> c.POINTER[None]: ...
@dll.bind
...
@dll.bind
def lto_codegen_compile_optimized(cg:lto_code_gen_t, length:c.POINTER[size_t]) -> c.POINTER[None]: ...
@dll.bind
