...
VFIO_TYPE = (';')
VFIO_BASE = 100
VFIO_GET_API_VERSION = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 0)
VFIO_CHECK_EXTENSION = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 1)
VFIO_SET_IOMMU = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 2)
VFIO_GROUP_FLAGS_VIABLE = (1 << 0)
VFIO_GROUP_FLAGS_CONTAINER_SET = (1 << 1)
VFIO_GROUP_GET_STATUS = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 3)
VFIO_GROUP_SET_CONTAINER = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 4)
VFIO_GROUP_UNSET_CONTAINER = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 5)
VFIO_GROUP_GET_DEVICE_FD = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 6)
...
VFIO_DEVICE_GET_INFO = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 7)
...
VFIO_DEVICE_GET_REGION_INFO = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 8)
...
VFIO_DEVICE_GET_IRQ_INFO = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 9)
...
VFIO_DEVICE_SET_IRQS = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 10)
...
VFIO_DEVICE_RESET = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 11)
...
VFIO_DEVICE_GET_PCI_HOT_RESET_INFO = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 12)
VFIO_DEVICE_PCI_HOT_RESET = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 13)
VFIO_GFX_PLANE_TYPE_PROBE = (1 << 0)
VFIO_GFX_PLANE_TYPE_DMABUF = (1 << 1)
VFIO_GFX_PLANE_TYPE_REGION = (1 << 2)
VFIO_DEVICE_QUERY_GFX_PLANE = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 14)
VFIO_DEVICE_GET_GFX_DMABUF = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 15)
...
VFIO_DEVICE_IOEVENTFD = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 16)
VFIO_DEVICE_FEATURE_MASK = (0xffff)
VFIO_DEVICE_FEATURE_GET = (1 << 16)
VFIO_DEVICE_FEATURE_SET = (1 << 17)
VFIO_DEVICE_FEATURE_PROBE = (1 << 18)
VFIO_DEVICE_FEATURE = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 17)
VFIO_DEVICE_BIND_IOMMUFD = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 18)
VFIO_DEVICE_ATTACH_IOMMUFD_PT = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 19)
VFIO_DEVICE_DETACH_IOMMUFD_PT = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 20)
...
VFIO_MIG_GET_PRECOPY_INFO = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 21)
...
VFIO_IOMMU_GET_INFO = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 12)
VFIO_DMA_MAP_FLAG_READ = (1 << 0)
VFIO_DMA_MAP_FLAG_WRITE = (1 << 1)
VFIO_DMA_MAP_FLAG_VADDR = (1 << 2)
VFIO_IOMMU_MAP_DMA = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 13)
VFIO_DMA_UNMAP_FLAG_GET_DIRTY_BITMAP = (1 << 0)
VFIO_DMA_UNMAP_FLAG_ALL = (1 << 1)
VFIO_DMA_UNMAP_FLAG_VADDR = (1 << 2)
VFIO_IOMMU_UNMAP_DMA = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 14)
VFIO_IOMMU_ENABLE = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 15)
VFIO_IOMMU_DISABLE = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 16)
VFIO_IOMMU_DIRTY_PAGES_FLAG_START = (1 << 0)
VFIO_IOMMU_DIRTY_PAGES_FLAG_STOP = (1 << 1)
VFIO_IOMMU_DIRTY_PAGES_FLAG_GET_BITMAP = (1 << 2)
VFIO_IOMMU_DIRTY_PAGES = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 17)
VFIO_IOMMU_SPAPR_INFO_DDW = (1 << 0)
VFIO_IOMMU_SPAPR_TCE_GET_INFO = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 12)
...
VFIO_EEH_PE_OP = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 21)
VFIO_IOMMU_SPAPR_REGISTER_MEMORY = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 17)
VFIO_IOMMU_SPAPR_UNREGISTER_MEMORY = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 18)
VFIO_IOMMU_SPAPR_TCE_CREATE = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 19)
VFIO_IOMMU_SPAPR_TCE_REMOVE = _IO_NOSZ(VFIO_TYPE, VFIO_BASE + 20)