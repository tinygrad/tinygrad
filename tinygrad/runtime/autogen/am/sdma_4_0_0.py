...
_anonstruct2._fields_ = [
  ...
  ('reserved_1', ctypes.c_uint,6),
  ('src_swap', ctypes.c_uint,2),
  ('reserved_2', ctypes.c_uint,6),
]
...
_anonstruct10._fields_ = [
  ...
  ('src_offset_y', ctypes.c_uint,14),
  ('reserved_2', ctypes.c_uint,2),
]
...
_anonstruct20._fields_ = [
  ...
  ('sub_op', ctypes.c_uint,8),
  ('sw', ctypes.c_uint,2),
  ('reserved_0', ctypes.c_uint,12),
  ('fillsize', ctypes.c_uint,2),
]
...
_anonstruct25._fields_ = [
  ('op', ctypes.c_uint,8),
  ('sub_op', ctypes.c_uint,8),
  ('mtype', ctypes.c_uint,3),
  ('gcc', ctypes.c_uint,1),
  ('sys', ctypes.c_uint,1),
  ('pad1', ctypes.c_uint,1),
  ('snp', ctypes.c_uint,1),
  ('gpa', ctypes.c_uint,1),
  ('l2_policy', ctypes.c_uint,2),
  ('reserved_0', ctypes.c_uint,6),
]
...
_anonstruct29._fields_ = [
  ...
  ('sub_op', ctypes.c_uint,8),
  ('reserved_0', ctypes.c_uint,10),
  ('hdp_flush', ctypes.c_uint,1),
  ('reserved_1', ctypes.c_uint,1),
  ('func', ctypes.c_uint,3),
  ('mem_poll', ctypes.c_uint,1),
]
...
_anonstruct35._fields_ = [
  ...
  ('sub_op', ctypes.c_uint,8),
  ('l', ctypes.c_uint,1),
  ('reserved_0', ctypes.c_uint,8),
  ('operation', ctypes.c_uint,7),
]
...
class _anonstruct38(ctypes.Structure): pass
_anonstruct38._fields_ = [
  ('src_data_31_0', ctypes.c_uint,32),
]
...
class _anonstruct40(ctypes.Structure): pass
_anonstruct40._fields_ = [
...
class _anonstruct42(ctypes.Structure): pass
_anonstruct42._fields_ = [
...
class _anonstruct43(ctypes.Structure): pass
_anonstruct43._fields_ = [
  ('op', ctypes.c_uint,8),
  ('sub_op', ctypes.c_uint,8),
  ('reserved_0', ctypes.c_uint,16),
]
...
class _anonstruct45(ctypes.Structure): pass
_anonstruct45._fields_ = [
  ('addr_63_32', ctypes.c_uint,32),
]
...
class _anonstruct47(ctypes.Structure): pass
_anonstruct47._fields_ = [
...
class _anonstruct50(ctypes.Structure): pass
_anonstruct50._fields_ = [
  ('BaseVA_HI', ctypes.c_uint,16),
  ('GCR_CONTROL_GLI_INV', ctypes.c_uint,2),
  ('GCR_CONTROL_GL1_RANGE', ctypes.c_uint,2),
  ('GCR_CONTROL_GLM_WB', ctypes.c_uint,1),
  ('GCR_CONTROL_GLM_INV', ctypes.c_uint,1),
  ('GCR_CONTROL_GLK_WB', ctypes.c_uint,1),
  ('GCR_CONTROL_GLK_INV', ctypes.c_uint,1),
  ('GCR_CONTROL_GLV_INV', ctypes.c_uint,1),
  ('GCR_CONTROL_GL1_INV', ctypes.c_uint,1),
  ('GCR_CONTROL_GL2_US', ctypes.c_uint,1),
  ('GCR_CONTROL_GL2_RANGE', ctypes.c_uint,2),
  ('GCR_CONTROL_GL2_DISCARD', ctypes.c_uint,1),
  ('GCR_CONTROL_GL2_INV', ctypes.c_uint,1),
  ('GCR_CONTROL_GL2_WB', ctypes.c_uint,1),
]
...
class _anonstruct51(ctypes.Structure): pass
_anonstruct51._fields_ = [
  ('GCR_CONTROL_RANGE_IS_PA', ctypes.c_uint,1),
  ('GCR_CONTROL_SEQ', ctypes.c_uint,2),
  ('', ctypes.c_uint,4),
  ('LimitVA_LO', ctypes.c_uint,25),
]
...
SDMA_OP_COPY = ctypes.c_uint(1)
SDMA_OP_FENCE = ctypes.c_uint(5)
SDMA_OP_TRAP = ctypes.c_uint(6)
SDMA_OP_POLL_REGMEM = ctypes.c_uint(8)
SDMA_OP_ATOMIC = ctypes.c_uint(10)
SDMA_OP_CONST_FILL = ctypes.c_uint(11)
SDMA_OP_TIMESTAMP = ctypes.c_uint(13)
SDMA_OP_GCR = ctypes.c_uint(17)
SDMA_SUBOP_COPY_LINEAR = ctypes.c_uint(0)
SDMA_SUBOP_COPY_LINEAR_RECT = ctypes.c_uint(4)
SDMA_SUBOP_TIMESTAMP_GET_GLOBAL = ctypes.c_uint(2)
SDMA_SUBOP_USER_GCR = ctypes.c_uint(1)
SDMA_ATOMIC_ADD64 = ctypes.c_uint(47)
SDMA_OP_NOP = 0
SDMA_OP_COPY = 1
SDMA_OP_WRITE = 2
SDMA_OP_INDIRECT = 4
...
SDMA_PKT_HEADER_op_offset = 0
SDMA_PKT_HEADER_op_mask = 0x000000FF
SDMA_PKT_HEADER_op_shift = 0
SDMA_PKT_HEADER_OP = lambda x: (((x) & SDMA_PKT_HEADER_op_mask) << SDMA_PKT_HEADER_op_shift)
SDMA_PKT_HEADER_sub_op_offset = 0
SDMA_PKT_HEADER_sub_op_mask = 0x000000FF
SDMA_PKT_HEADER_sub_op_shift = 8
SDMA_PKT_HEADER_SUB_OP = lambda x: (((x) & SDMA_PKT_HEADER_sub_op_mask) << SDMA_PKT_HEADER_sub_op_shift)
...
SDMA_PKT_COPY_LINEAR_COUNT_count_mask = 0x003FFFFF
...
SDMA_PKT_COPY_DIRTY_PAGE_PARAMETER_dst_sw_shift = 16
...
SDMA_PKT_COPY_PHYSICAL_LINEAR_PARAMETER_dst_sw_shift = 16
...
SDMA_PKT_COPY_BROADCAST_LINEAR_COUNT_count_mask = 0x003FFFFF
...
SDMA_PKT_COPY_LINEAR_SUBWIN_DW_4_src_z_mask = 0x000007FF
...
SDMA_PKT_COPY_LINEAR_SUBWIN_DW_9_dst_z_mask = 0x000007FF
...
SDMA_PKT_COPY_LINEAR_SUBWIN_DW_12_rect_z_mask = 0x000007FF
...
SDMA_PKT_COPY_TILED_HEADER_mip_max_offset = 0
SDMA_PKT_COPY_TILED_HEADER_mip_max_mask = 0x0000000F
SDMA_PKT_COPY_TILED_HEADER_mip_max_shift = 20
SDMA_PKT_COPY_TILED_HEADER_MIP_MAX = lambda x: (((x) & SDMA_PKT_COPY_TILED_HEADER_mip_max_mask) << SDMA_PKT_COPY_TILED_HEADER_mip_max_shift)
...
SDMA_PKT_COPY_TILED_DW_4_depth_mask = 0x000007FF
...
SDMA_PKT_COPY_TILED_DW_5_epitch_offset = 5
SDMA_PKT_COPY_TILED_DW_5_epitch_mask = 0x0000FFFF
SDMA_PKT_COPY_TILED_DW_5_epitch_shift = 16
SDMA_PKT_COPY_TILED_DW_5_EPITCH = lambda x: (((x) & SDMA_PKT_COPY_TILED_DW_5_epitch_mask) << SDMA_PKT_COPY_TILED_DW_5_epitch_shift)
...
SDMA_PKT_COPY_TILED_DW_7_z_mask = 0x000007FF
...
SDMA_PKT_COPY_TILED_COUNT_count_mask = 0x000FFFFF
...
SDMA_PKT_COPY_L2T_BROADCAST_HEADER_mip_max_offset = 0
SDMA_PKT_COPY_L2T_BROADCAST_HEADER_mip_max_mask = 0x0000000F
SDMA_PKT_COPY_L2T_BROADCAST_HEADER_mip_max_shift = 20
SDMA_PKT_COPY_L2T_BROADCAST_HEADER_MIP_MAX = lambda x: (((x) & SDMA_PKT_COPY_L2T_BROADCAST_HEADER_mip_max_mask) << SDMA_PKT_COPY_L2T_BROADCAST_HEADER_mip_max_shift)
...
SDMA_PKT_COPY_L2T_BROADCAST_DW_6_depth_mask = 0x000007FF
...
SDMA_PKT_COPY_L2T_BROADCAST_DW_7_epitch_offset = 7
SDMA_PKT_COPY_L2T_BROADCAST_DW_7_epitch_mask = 0x0000FFFF
SDMA_PKT_COPY_L2T_BROADCAST_DW_7_epitch_shift = 16
SDMA_PKT_COPY_L2T_BROADCAST_DW_7_EPITCH = lambda x: (((x) & SDMA_PKT_COPY_L2T_BROADCAST_DW_7_epitch_mask) << SDMA_PKT_COPY_L2T_BROADCAST_DW_7_epitch_shift)
...
SDMA_PKT_COPY_L2T_BROADCAST_DW_9_z_mask = 0x000007FF
...
SDMA_PKT_COPY_L2T_BROADCAST_COUNT_count_mask = 0x000FFFFF
...
SDMA_PKT_COPY_T2T_HEADER_mip_max_offset = 0
SDMA_PKT_COPY_T2T_HEADER_mip_max_mask = 0x0000000F
SDMA_PKT_COPY_T2T_HEADER_mip_max_shift = 20
SDMA_PKT_COPY_T2T_HEADER_MIP_MAX = lambda x: (((x) & SDMA_PKT_COPY_T2T_HEADER_mip_max_mask) << SDMA_PKT_COPY_T2T_HEADER_mip_max_shift)
...
SDMA_PKT_COPY_T2T_DW_4_src_z_mask = 0x000007FF
...
SDMA_PKT_COPY_T2T_DW_5_src_depth_mask = 0x000007FF
...
SDMA_PKT_COPY_T2T_DW_6_src_epitch_offset = 6
SDMA_PKT_COPY_T2T_DW_6_src_epitch_mask = 0x0000FFFF
SDMA_PKT_COPY_T2T_DW_6_src_epitch_shift = 16
SDMA_PKT_COPY_T2T_DW_6_SRC_EPITCH = lambda x: (((x) & SDMA_PKT_COPY_T2T_DW_6_src_epitch_mask) << SDMA_PKT_COPY_T2T_DW_6_src_epitch_shift)
...
SDMA_PKT_COPY_T2T_DW_10_dst_z_mask = 0x000007FF
...
SDMA_PKT_COPY_T2T_DW_11_dst_depth_mask = 0x000007FF
...
SDMA_PKT_COPY_T2T_DW_12_dst_epitch_offset = 12
SDMA_PKT_COPY_T2T_DW_12_dst_epitch_mask = 0x0000FFFF
SDMA_PKT_COPY_T2T_DW_12_dst_epitch_shift = 16
SDMA_PKT_COPY_T2T_DW_12_DST_EPITCH = lambda x: (((x) & SDMA_PKT_COPY_T2T_DW_12_dst_epitch_mask) << SDMA_PKT_COPY_T2T_DW_12_dst_epitch_shift)
...
SDMA_PKT_COPY_T2T_DW_14_rect_z_mask = 0x000007FF
...
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_max_offset = 0
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_max_mask = 0x0000000F
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_max_shift = 20
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_MIP_MAX = lambda x: (((x) & SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_max_mask) << SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_max_shift)
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_id_offset = 0
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_id_mask = 0x0000000F
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_id_shift = 24
SDMA_PKT_COPY_TILED_SUBWIN_HEADER_MIP_ID = lambda x: (((x) & SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_id_mask) << SDMA_PKT_COPY_TILED_SUBWIN_HEADER_mip_id_shift)
...
SDMA_PKT_COPY_TILED_SUBWIN_DW_4_tiled_z_mask = 0x000007FF
...
SDMA_PKT_COPY_TILED_SUBWIN_DW_5_depth_mask = 0x000007FF
...
SDMA_PKT_COPY_TILED_SUBWIN_DW_6_epitch_offset = 6
SDMA_PKT_COPY_TILED_SUBWIN_DW_6_epitch_mask = 0x0000FFFF
SDMA_PKT_COPY_TILED_SUBWIN_DW_6_epitch_shift = 16
SDMA_PKT_COPY_TILED_SUBWIN_DW_6_EPITCH = lambda x: (((x) & SDMA_PKT_COPY_TILED_SUBWIN_DW_6_epitch_mask) << SDMA_PKT_COPY_TILED_SUBWIN_DW_6_epitch_shift)
...
SDMA_PKT_COPY_TILED_SUBWIN_DW_10_linear_z_mask = 0x000007FF
...
SDMA_PKT_COPY_TILED_SUBWIN_DW_13_rect_z_mask = 0x000007FF
...
SDMA_PKT_WRITE_TILED_HEADER_mip_max_offset = 0
SDMA_PKT_WRITE_TILED_HEADER_mip_max_mask = 0x0000000F
SDMA_PKT_WRITE_TILED_HEADER_mip_max_shift = 20
SDMA_PKT_WRITE_TILED_HEADER_MIP_MAX = lambda x: (((x) & SDMA_PKT_WRITE_TILED_HEADER_mip_max_mask) << SDMA_PKT_WRITE_TILED_HEADER_mip_max_shift)
...
SDMA_PKT_WRITE_TILED_DW_4_depth_mask = 0x000007FF
...
SDMA_PKT_WRITE_TILED_DW_5_epitch_offset = 5
SDMA_PKT_WRITE_TILED_DW_5_epitch_mask = 0x0000FFFF
SDMA_PKT_WRITE_TILED_DW_5_epitch_shift = 16
SDMA_PKT_WRITE_TILED_DW_5_EPITCH = lambda x: (((x) & SDMA_PKT_WRITE_TILED_DW_5_epitch_mask) << SDMA_PKT_WRITE_TILED_DW_5_epitch_shift)
...
SDMA_PKT_WRITE_TILED_DW_7_z_mask = 0x000007FF
...
SDMA_PKT_CONSTANT_FILL_COUNT_count_mask = 0x003FFFFF
...
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_LO_cmp1_end_31_0_offset = 4
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_LO_cmp1_end_31_0_mask = 0xFFFFFFFF
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_LO_cmp1_end_31_0_shift = 0
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_LO_CMP1_END_31_0 = lambda x: (((x) & SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_LO_cmp1_end_31_0_mask) << SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_LO_cmp1_end_31_0_shift)
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_HI_cmp1_end_63_32_offset = 5
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_HI_cmp1_end_63_32_mask = 0xFFFFFFFF
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_HI_cmp1_end_63_32_shift = 0
SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_HI_CMP1_END_63_32 = lambda x: (((x) & SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_HI_cmp1_end_63_32_mask) << SDMA_PKT_POLL_MEM_VERIFY_CMP0_ADDR_END_HI_cmp1_end_63_32_shift)
...
SDMA_AQL_PKT_BARRIER_OR_RESERVED_DW12_reserved_dw12_offset = 12
SDMA_AQL_PKT_BARRIER_OR_RESERVED_DW12_reserved_dw12_mask = 0xFFFFFFFF
SDMA_AQL_PKT_BARRIER_OR_RESERVED_DW12_reserved_dw12_shift = 0
SDMA_AQL_PKT_BARRIER_OR_RESERVED_DW12_RESERVED_DW12 = lambda x: (((x) & SDMA_AQL_PKT_BARRIER_OR_RESERVED_DW12_reserved_dw12_mask) << SDMA_AQL_PKT_BARRIER_OR_RESERVED_DW12_reserved_dw12_shift)
