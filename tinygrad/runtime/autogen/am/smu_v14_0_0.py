...
__SMU_V14_0_0_PPSMC_H__ = True # macro
PPS_PMFW_IF_VER = "1.0" # macro
...
PPSMC_MSG_TestMessage = 0x01 # macro
PPSMC_MSG_GetPmfwVersion = 0x02 # macro
PPSMC_MSG_GetDriverIfVersion = 0x03 # macro
PPSMC_MSG_PowerDownVcn1 = 0x04 # macro
PPSMC_MSG_PowerUpVcn1 = 0x05 # macro
PPSMC_MSG_PowerDownVcn0 = 0x06 # macro
PPSMC_MSG_PowerUpVcn0 = 0x07 # macro
PPSMC_MSG_SetHardMinVcn0 = 0x08 # macro
PPSMC_MSG_SetSoftMinGfxclk = 0x09 # macro
PPSMC_MSG_SetHardMinVcn1 = 0x0A # macro
PPSMC_MSG_SetSoftMinVcn1 = 0x0B # macro
PPSMC_MSG_PrepareMp1ForUnload = 0x0C # macro
PPSMC_MSG_SetDriverDramAddrHigh = 0x0D # macro
PPSMC_MSG_SetDriverDramAddrLow = 0x0E # macro
PPSMC_MSG_TransferTableSmu2Dram = 0x0F # macro
PPSMC_MSG_TransferTableDram2Smu = 0x10 # macro
PPSMC_MSG_GfxDeviceDriverReset = 0x11 # macro
PPSMC_MSG_GetEnabledSmuFeatures = 0x12 # macro
PPSMC_MSG_SetHardMinSocclkByFreq = 0x13 # macro
PPSMC_MSG_SetSoftMinFclk = 0x14 # macro
PPSMC_MSG_SetSoftMinVcn0 = 0x15 # macro
PPSMC_MSG_EnableGfxImu = 0x16 # macro
PPSMC_MSG_spare_0x17 = 0x17 # macro
PPSMC_MSG_spare_0x18 = 0x18 # macro
PPSMC_MSG_AllowGfxOff = 0x19 # macro
PPSMC_MSG_DisallowGfxOff = 0x1A # macro
PPSMC_MSG_SetSoftMaxGfxClk = 0x1B # macro
PPSMC_MSG_SetHardMinGfxClk = 0x1C # macro
PPSMC_MSG_SetSoftMaxSocclkByFreq = 0x1D # macro
PPSMC_MSG_SetSoftMaxFclkByFreq = 0x1E # macro
PPSMC_MSG_SetSoftMaxVcn0 = 0x1F # macro
PPSMC_MSG_spare_0x20 = 0x20 # macro
PPSMC_MSG_PowerDownJpeg0 = 0x21 # macro
PPSMC_MSG_PowerUpJpeg0 = 0x22 # macro
PPSMC_MSG_SetHardMinFclkByFreq = 0x23 # macro
PPSMC_MSG_SetSoftMinSocclkByFreq = 0x24 # macro
PPSMC_MSG_AllowZstates = 0x25 # macro
PPSMC_MSG_PowerDownJpeg1 = 0x26 # macro
PPSMC_MSG_PowerUpJpeg1 = 0x27 # macro
PPSMC_MSG_SetSoftMaxVcn1 = 0x28 # macro
PPSMC_MSG_PowerDownIspByTile = 0x29 # macro
PPSMC_MSG_PowerUpIspByTile = 0x2A # macro
PPSMC_MSG_SetHardMinIspiclkByFreq = 0x2B # macro
PPSMC_MSG_SetHardMinIspxclkByFreq = 0x2C # macro
PPSMC_MSG_PowerDownUmsch = 0x2D # macro
PPSMC_MSG_PowerUpUmsch = 0x2E # macro
PPSMC_Message_IspStutterOn_MmhubPgDis = 0x2F # macro
PPSMC_Message_IspStutterOff_MmhubPgEn = 0x30 # macro
PPSMC_MSG_PowerUpVpe = 0x31 # macro
PPSMC_MSG_PowerDownVpe = 0x32 # macro
PPSMC_MSG_GetVpeDpmTable = 0x33 # macro
PPSMC_MSG_EnableLSdma = 0x34 # macro
PPSMC_MSG_DisableLSdma = 0x35 # macro
PPSMC_MSG_SetSoftMaxVpe = 0x36 # macro
PPSMC_MSG_SetSoftMinVpe = 0x37 # macro
PPSMC_MSG_MALLPowerController = 0x38 # macro
PPSMC_MSG_MALLPowerState = 0x39 # macro
PPSMC_Message_Count = 0x3A # macro

# values for enumeration 'c__EA_Mode_Reset_e'
c__EA_Mode_Reset_e__enumvalues = {
    1: 'MODE1_RESET',
    2: 'MODE2_RESET',
}
MODE1_RESET = 1
MODE2_RESET = 2
c__EA_Mode_Reset_e = ctypes.c_uint32 # enum
Mode_Reset_e = c__EA_Mode_Reset_e
Mode_Reset_e__enumvalues = c__EA_Mode_Reset_e__enumvalues

# values for enumeration 'c__EA_ZStates_e'
c__EA_ZStates_e__enumvalues = {
    0: 'DISALLOW_ZSTATES',
    8: 'ALLOW_ZSTATES_Z8',
    9: 'ALLOW_ZSTATES_Z9',
}
...
ALLOW_ZSTATES_Z8 = 8
ALLOW_ZSTATES_Z9 = 9
c__EA_ZStates_e = ctypes.c_uint32 # enum
ZStates_e = c__EA_ZStates_e
ZStates_e__enumvalues = c__EA_ZStates_e__enumvalues
...
__all__ = \
    ...
    'ALLOW_ZSTATES_Z8', 'ALLOW_ZSTATES_Z9', 'AVFS_D_COUNT',
    'AVFS_D_G', 'AVFS_D_e', 'AVFS_D_e__enumvalues', 'AVFS_TEMP_COLD',
    ...
    'DEBUG_OVERRIDE_NOT_USE', 'DISALLOW_ZSTATES',
    ...
    'DRAM_BIT_WIDTH_X_8', 'DSPCLK_COUNT', 'DSPCLK_DCFCLK',
    'DSPCLK_DISPCLK', 'DSPCLK_PHYCLK', 'DSPCLK_PIXCLK', 'DSPCLK_e',
    'DSPCLK_e__enumvalues', 'DisplayClockTable_t',
    ...
    'MODE1_RESET', 'MODE2_RESET', 'MSR_SEQUENCE', 'MemPstateTable_t',
    'Mode_Reset_e', 'Mode_Reset_e__enumvalues', 'MsgLimits_t',
    ...
    'PPSMC_MSG_AllowGfxOff', 'PPSMC_MSG_AllowZstates',
    'PPSMC_MSG_DisableLSdma', 'PPSMC_MSG_DisallowGfxOff',
    'PPSMC_MSG_EnableGfxImu', 'PPSMC_MSG_EnableLSdma',
    'PPSMC_MSG_GetDriverIfVersion', 'PPSMC_MSG_GetEnabledSmuFeatures',
    'PPSMC_MSG_GetPmfwVersion', 'PPSMC_MSG_GetVpeDpmTable',
    'PPSMC_MSG_GfxDeviceDriverReset', 'PPSMC_MSG_MALLPowerController',
    'PPSMC_MSG_MALLPowerState', 'PPSMC_MSG_PowerDownIspByTile',
    'PPSMC_MSG_PowerDownJpeg0', 'PPSMC_MSG_PowerDownJpeg1',
    'PPSMC_MSG_PowerDownUmsch', 'PPSMC_MSG_PowerDownVcn0',
    'PPSMC_MSG_PowerDownVcn1', 'PPSMC_MSG_PowerDownVpe',
    'PPSMC_MSG_PowerUpIspByTile', 'PPSMC_MSG_PowerUpJpeg0',
    'PPSMC_MSG_PowerUpJpeg1', 'PPSMC_MSG_PowerUpUmsch',
    'PPSMC_MSG_PowerUpVcn0', 'PPSMC_MSG_PowerUpVcn1',
    'PPSMC_MSG_PowerUpVpe', 'PPSMC_MSG_PrepareMp1ForUnload',
    'PPSMC_MSG_SetDriverDramAddrHigh',
    'PPSMC_MSG_SetDriverDramAddrLow',
    'PPSMC_MSG_SetHardMinFclkByFreq', 'PPSMC_MSG_SetHardMinGfxClk',
    'PPSMC_MSG_SetHardMinIspiclkByFreq',
    'PPSMC_MSG_SetHardMinIspxclkByFreq',
    'PPSMC_MSG_SetHardMinSocclkByFreq', 'PPSMC_MSG_SetHardMinVcn0',
    'PPSMC_MSG_SetHardMinVcn1', 'PPSMC_MSG_SetSoftMaxFclkByFreq',
    'PPSMC_MSG_SetSoftMaxGfxClk', 'PPSMC_MSG_SetSoftMaxSocclkByFreq',
    'PPSMC_MSG_SetSoftMaxVcn0', 'PPSMC_MSG_SetSoftMaxVcn1',
    'PPSMC_MSG_SetSoftMaxVpe', 'PPSMC_MSG_SetSoftMinFclk',
    'PPSMC_MSG_SetSoftMinGfxclk', 'PPSMC_MSG_SetSoftMinSocclkByFreq',
    'PPSMC_MSG_SetSoftMinVcn0', 'PPSMC_MSG_SetSoftMinVcn1',
    'PPSMC_MSG_SetSoftMinVpe', 'PPSMC_MSG_TestMessage',
    'PPSMC_MSG_TransferTableDram2Smu',
    'PPSMC_MSG_TransferTableSmu2Dram', 'PPSMC_MSG_spare_0x17',
    'PPSMC_MSG_spare_0x18', 'PPSMC_MSG_spare_0x20',
    'PPSMC_Message_Count', 'PPSMC_Message_IspStutterOff_MmhubPgEn',
    'PPSMC_Message_IspStutterOn_MmhubPgDis',
    'PPSMC_Result_CmdRejectedBusy', 'PPSMC_Result_CmdRejectedPrereq',
    'PPSMC_Result_Failed', 'PPSMC_Result_OK',
    'PPSMC_Result_UnknownCmd', 'PPS_PMFW_IF_VER', 'PPTABLE_VERSION',
    ...
    'SMU_UCLK', 'SMU_VCLK', 'SMU_VCLK1', 'SVI_PLANE_COUNT',
    'SVI_PLANE_VDDCI_MEM', 'SVI_PLANE_VDDIO_MEM', 'SVI_PLANE_VDD_GFX',
    'SVI_PLANE_VDD_SOC', 'SVI_PLANE_e', 'SVI_PLANE_e__enumvalues',
    'SVI_PSI_0', 'SVI_PSI_1', 'SVI_PSI_2', 'SVI_PSI_3', 'SVI_PSI_4',
    'SVI_PSI_5', 'SVI_PSI_6', 'SVI_PSI_7', 'SVI_PSI_e',
    'SVI_PSI_e__enumvalues', 'SkuTable_t', 'SmuMetricsExternal_t',
    'SmuMetrics_t', 'Svi3RegulatorSettings_t', 'SviTelemetryScale_t',
    ...
    'ZStates_e', 'ZStates_e__enumvalues', '__AMDGPU_SMU_H__',
    '__SMU_V14_0_0_PMFW_H__', '__SMU_V14_0_0_PPSMC_H__', 'bool',
    ...
    'c__EA_I2cSpeed_e', 'c__EA_MEM_VENDOR_e', 'c__EA_Mode_Reset_e',
    'c__EA_OD_FAIL_e', 'c__EA_PMFW_VOLT_PLANE_e',
    'c__EA_POWER_SOURCE_e', 'c__EA_PPCLK_e', 'c__EA_PPT_THROTTLER_e',
    ...
    'c__EA_WATERMARKS_FLAGS_e', 'c__EA_WM_CLOCK_e', 'c__EA_ZStates_e',
