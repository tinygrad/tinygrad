...
class FwStatus_t_v14_0_1(c.Struct):
  ...
  IdleMask: Annotated[uint32_t, 20, 32, 0]
class Mode_Reset_e(Annotated[int, ctypes.c_uint32], c.Enum): pass
MODE1_RESET = Mode_Reset_e.define('MODE1_RESET', 1)
MODE2_RESET = Mode_Reset_e.define('MODE2_RESET', 2)

class ZStates_e(Annotated[int, ctypes.c_uint32], c.Enum): pass
DISALLOW_ZSTATES = ZStates_e.define('DISALLOW_ZSTATES', 0)
ALLOW_ZSTATES_Z8 = ZStates_e.define('ALLOW_ZSTATES_Z8', 8)
ALLOW_ZSTATES_Z9 = ZStates_e.define('ALLOW_ZSTATES_Z9', 9)
...
PPS_PMFW_IF_VER = "1.0" # type: ignore
...
PPSMC_MSG_TestMessage = 0x01 # type: ignore
PPSMC_MSG_GetPmfwVersion = 0x02 # type: ignore
PPSMC_MSG_GetDriverIfVersion = 0x03 # type: ignore
PPSMC_MSG_PowerDownVcn1 = 0x04 # type: ignore
PPSMC_MSG_PowerUpVcn1 = 0x05 # type: ignore
PPSMC_MSG_PowerDownVcn0 = 0x06 # type: ignore
PPSMC_MSG_PowerUpVcn0 = 0x07 # type: ignore
PPSMC_MSG_SetHardMinVcn0 = 0x08 # type: ignore
PPSMC_MSG_SetSoftMinGfxclk = 0x09 # type: ignore
PPSMC_MSG_SetHardMinVcn1 = 0x0A # type: ignore
PPSMC_MSG_SetSoftMinVcn1 = 0x0B # type: ignore
PPSMC_MSG_PrepareMp1ForUnload = 0x0C # type: ignore
PPSMC_MSG_SetDriverDramAddrHigh = 0x0D # type: ignore
PPSMC_MSG_SetDriverDramAddrLow = 0x0E # type: ignore
PPSMC_MSG_TransferTableSmu2Dram = 0x0F # type: ignore
PPSMC_MSG_TransferTableDram2Smu = 0x10 # type: ignore
PPSMC_MSG_GfxDeviceDriverReset = 0x11 # type: ignore
PPSMC_MSG_GetEnabledSmuFeatures = 0x12 # type: ignore
PPSMC_MSG_SetHardMinSocclkByFreq = 0x13 # type: ignore
PPSMC_MSG_SetSoftMinFclk = 0x14 # type: ignore
PPSMC_MSG_SetSoftMinVcn0 = 0x15 # type: ignore
PPSMC_MSG_EnableGfxImu = 0x16 # type: ignore
PPSMC_MSG_spare_0x17 = 0x17 # type: ignore
PPSMC_MSG_spare_0x18 = 0x18 # type: ignore
PPSMC_MSG_AllowGfxOff = 0x19 # type: ignore
PPSMC_MSG_DisallowGfxOff = 0x1A # type: ignore
PPSMC_MSG_SetSoftMaxGfxClk = 0x1B # type: ignore
PPSMC_MSG_SetHardMinGfxClk = 0x1C # type: ignore
PPSMC_MSG_SetSoftMaxSocclkByFreq = 0x1D # type: ignore
PPSMC_MSG_SetSoftMaxFclkByFreq = 0x1E # type: ignore
PPSMC_MSG_SetSoftMaxVcn0 = 0x1F # type: ignore
PPSMC_MSG_spare_0x20 = 0x20 # type: ignore
PPSMC_MSG_PowerDownJpeg0 = 0x21 # type: ignore
PPSMC_MSG_PowerUpJpeg0 = 0x22 # type: ignore
PPSMC_MSG_SetHardMinFclkByFreq = 0x23 # type: ignore
PPSMC_MSG_SetSoftMinSocclkByFreq = 0x24 # type: ignore
PPSMC_MSG_AllowZstates = 0x25 # type: ignore
PPSMC_MSG_PowerDownJpeg1 = 0x26 # type: ignore
PPSMC_MSG_PowerUpJpeg1 = 0x27 # type: ignore
PPSMC_MSG_SetSoftMaxVcn1 = 0x28 # type: ignore
PPSMC_MSG_PowerDownIspByTile = 0x29 # type: ignore
PPSMC_MSG_PowerUpIspByTile = 0x2A # type: ignore
PPSMC_MSG_SetHardMinIspiclkByFreq = 0x2B # type: ignore
PPSMC_MSG_SetHardMinIspxclkByFreq = 0x2C # type: ignore
PPSMC_MSG_PowerDownUmsch = 0x2D # type: ignore
PPSMC_MSG_PowerUpUmsch = 0x2E # type: ignore
PPSMC_Message_IspStutterOn_MmhubPgDis = 0x2F # type: ignore
PPSMC_Message_IspStutterOff_MmhubPgEn = 0x30 # type: ignore
PPSMC_MSG_PowerUpVpe = 0x31 # type: ignore
PPSMC_MSG_PowerDownVpe = 0x32 # type: ignore
PPSMC_MSG_GetVpeDpmTable = 0x33 # type: ignore
PPSMC_MSG_EnableLSdma = 0x34 # type: ignore
PPSMC_MSG_DisableLSdma = 0x35 # type: ignore
PPSMC_MSG_SetSoftMaxVpe = 0x36 # type: ignore
PPSMC_MSG_SetSoftMinVpe = 0x37 # type: ignore
PPSMC_MSG_MALLPowerController = 0x38 # type: ignore
PPSMC_MSG_MALLPowerState = 0x39 # type: ignore
PPSMC_Message_Count = 0x3A # type: ignore
