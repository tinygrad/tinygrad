...
class struct_binary_header(c.Struct):
  ...
  binary_checksum: 'int'
  binary_size: 'int'
  table_list: 'list[struct_table_info]'
...
class struct_vcn_info_v1_0(c.Struct):
  ...
  instance_info: 'list[struct_vcn_instance_info_v1_0]'
  reserved: 'list[int]'
...
class struct_nps_info_v1_0(c.Struct):
  ...
  nps_type: 'int'
  count: 'int'
  instance_info: 'list[struct_nps_instance_info_v1_0]'
...
class struct_psp_firmware_header_v2_0(c.Struct):
  ...
  psp_fw_bin: 'list[struct_psp_fw_bin_desc]'
...
class struct_ta_firmware_header_v2_0(c.Struct):
  ...
  header: 'struct_common_firmware_header'
  ta_fw_bin_count: 'int'
  ta_fw_bin: 'list[struct_psp_fw_bin_desc]'
...
class struct_psp_gfx_buf_list(c.Struct):
  ...
  num_desc: 'int'
  total_size: 'int'
  buf_desc: 'list[struct_psp_gfx_buf_desc]'
