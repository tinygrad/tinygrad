...
AMDGPU_PTE_MTYPE_VG10_SHIFT = lambda mtype: ((uint64_t)(mtype) << 57)
AMDGPU_PTE_MTYPE_VG10 = lambda flags,mtype: (((uint64_t)(flags) & (~AMDGPU_PTE_MTYPE_VG10_MASK)) | AMDGPU_PTE_MTYPE_VG10_SHIFT(mtype))
AMDGPU_MTYPE_NC = 0
AMDGPU_MTYPE_CC = 2
AMDGPU_PTE_MTYPE_NV10_SHIFT = lambda mtype: ((uint64_t)(mtype) << 48)
AMDGPU_PTE_MTYPE_NV10 = lambda flags,mtype: (((uint64_t)(flags) & (~AMDGPU_PTE_MTYPE_NV10_MASK)) | AMDGPU_PTE_MTYPE_NV10_SHIFT(mtype))
AMDGPU_PTE_PRT_GFX12 = (1 << 56)
AMDGPU_PTE_MTYPE_GFX12_SHIFT = lambda mtype: ((uint64_t)(mtype) << 54)
AMDGPU_PTE_MTYPE_GFX12 = lambda flags,mtype: (((uint64_t)(flags) & (~AMDGPU_PTE_MTYPE_GFX12_MASK)) | AMDGPU_PTE_MTYPE_GFX12_SHIFT(mtype))
AMDGPU_PTE_IS_PTE = (1 << 63)
AMDGPU_PDE_BFS_GFX12 = lambda a: ((uint64_t)((a) & 0x1f) << 58)
