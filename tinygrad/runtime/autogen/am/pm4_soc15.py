...
class enum_mes_set_resources_queue_type_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_map_queues_queue_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_map_queues_queue_type_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_map_queues_engine_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_map_queues_extended_engine_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_query_status_interrupt_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_query_status_command_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_query_status_engine_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_unmap_queues_action_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_unmap_queues_queue_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_unmap_queues_engine_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mes_unmap_queues_extended_engine_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mec_release_mem_event_index_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mec_release_mem_cache_policy_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mec_release_mem_pq_exe_status_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mec_release_mem_dst_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mec_release_mem_int_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_mec_release_mem_data_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_WRITE_DATA_dst_sel_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_WRITE_DATA_addr_incr_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_WRITE_DATA_wr_confirm_enum(ctypes.c_uint32, c.Enum): pass
...
class enum_WRITE_DATA_cache_policy_enum(ctypes.c_uint32, c.Enum): pass
...
PACKET3_ATOMIC_MEM__ADDR_LO = lambda x: (((unsigned)(x)) << 0) # type: ignore
PACKET3_ATOMIC_MEM__ADDR_HI = lambda x: (((unsigned)(x)) << 0) # type: ignore
PACKET3_ATOMIC_MEM__SRC_DATA_LO = lambda x: (((unsigned)(x)) << 0) # type: ignore
PACKET3_ATOMIC_MEM__SRC_DATA_HI = lambda x: (((unsigned)(x)) << 0) # type: ignore
...
PACKET3_WRITE_DATA__RESUME_VF_MI300 = lambda x: ((((unsigned)(x)) & 0x1) << 19) # type: ignore
...
PACKET3_EVENT_WRITE__OFFLOAD_ENABLE = lambda x: ((((unsigned)(x)) & 0x1) << 31) # type: ignore
