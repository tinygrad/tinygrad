...
FEATURE_BTC_NOP = FEATURE_BTC_e.define('FEATURE_BTC_NOP', 0) # type: ignore
FEATURE_BTC_SAVE = FEATURE_BTC_e.define('FEATURE_BTC_SAVE', 1) # type: ignore
FEATURE_BTC_RESTORE = FEATURE_BTC_e.define('FEATURE_BTC_RESTORE', 2) # type: ignore
FEATURE_BTC_COUNT = FEATURE_BTC_e.define('FEATURE_BTC_COUNT', 3) # type: ignore
...
EPCS_SHORTED_LIMIT = EPCS_STATUS_e.define('EPCS_SHORTED_LIMIT', 0) # type: ignore
EPCS_LOW_POWER_LIMIT = EPCS_STATUS_e.define('EPCS_LOW_POWER_LIMIT', 1) # type: ignore
EPCS_NORMAL_POWER_LIMIT = EPCS_STATUS_e.define('EPCS_NORMAL_POWER_LIMIT', 2) # type: ignore
EPCS_HIGH_POWER_LIMIT = EPCS_STATUS_e.define('EPCS_HIGH_POWER_LIMIT', 3) # type: ignore
EPCS_NOT_CONFIGURED = EPCS_STATUS_e.define('EPCS_NOT_CONFIGURED', 4) # type: ignore
EPCS_STATUS_COUNT = EPCS_STATUS_e.define('EPCS_STATUS_COUNT', 5) # type: ignore
...
PPCLK_DISPCLK = PPCLK_e.define('PPCLK_DISPCLK', 6) # type: ignore
PPCLK_DPPCLK = PPCLK_e.define('PPCLK_DPPCLK', 7) # type: ignore
PPCLK_DPREFCLK = PPCLK_e.define('PPCLK_DPREFCLK', 8) # type: ignore
PPCLK_DCFCLK = PPCLK_e.define('PPCLK_DCFCLK', 9) # type: ignore
PPCLK_DTBCLK = PPCLK_e.define('PPCLK_DTBCLK', 10) # type: ignore
PPCLK_COUNT = PPCLK_e.define('PPCLK_COUNT', 11) # type: ignore
...
AVFS_D_COUNT = AVFS_D_e.define('AVFS_D_COUNT', 1) # type: ignore
...
PWR_CONFIG_TBP_DESKTOP = PwrConfig_e.define('PWR_CONFIG_TBP_DESKTOP', 4) # type: ignore
PWR_CONFIG_TBP_MOBILE = PwrConfig_e.define('PWR_CONFIG_TBP_MOBILE', 5) # type: ignore
...
TEMP_HOTSPOT_GFX = TEMP_e.define('TEMP_HOTSPOT_GFX', 2) # type: ignore
TEMP_HOTSPOT_SOC = TEMP_e.define('TEMP_HOTSPOT_SOC', 3) # type: ignore
TEMP_MEM = TEMP_e.define('TEMP_MEM', 4) # type: ignore
TEMP_VR_GFX = TEMP_e.define('TEMP_VR_GFX', 5) # type: ignore
TEMP_VR_SOC = TEMP_e.define('TEMP_VR_SOC', 6) # type: ignore
TEMP_VR_MEM0 = TEMP_e.define('TEMP_VR_MEM0', 7) # type: ignore
TEMP_VR_MEM1 = TEMP_e.define('TEMP_VR_MEM1', 8) # type: ignore
TEMP_LIQUID0 = TEMP_e.define('TEMP_LIQUID0', 9) # type: ignore
TEMP_LIQUID1 = TEMP_e.define('TEMP_LIQUID1', 10) # type: ignore
TEMP_PLX = TEMP_e.define('TEMP_PLX', 11) # type: ignore
TEMP_COUNT = TEMP_e.define('TEMP_COUNT', 12) # type: ignore
...
TDC_THROTTLER_COUNT = TDC_THROTTLER_e.define('TDC_THROTTLER_COUNT', 2) # type: ignore

SVI_PLANE_e = CEnum(Annotated[int, ctypes.c_uint32])
SVI_PLANE_VDD_GFX = SVI_PLANE_e.define('SVI_PLANE_VDD_GFX', 0) # type: ignore
SVI_PLANE_VDD_SOC = SVI_PLANE_e.define('SVI_PLANE_VDD_SOC', 1) # type: ignore
SVI_PLANE_VDDCI_MEM = SVI_PLANE_e.define('SVI_PLANE_VDDCI_MEM', 2) # type: ignore
SVI_PLANE_VDDIO_MEM = SVI_PLANE_e.define('SVI_PLANE_VDDIO_MEM', 3) # type: ignore
SVI_PLANE_COUNT = SVI_PLANE_e.define('SVI_PLANE_COUNT', 4) # type: ignore
...
PP_OD_POWER_FEATURE_ALWAYS_ENABLED = PP_OD_POWER_FEATURE_e.define('PP_OD_POWER_FEATURE_ALWAYS_ENABLED', 0) # type: ignore
PP_OD_POWER_FEATURE_DISABLED_WHILE_GAMING = PP_OD_POWER_FEATURE_e.define('PP_OD_POWER_FEATURE_DISABLED_WHILE_GAMING', 1) # type: ignore
PP_OD_POWER_FEATURE_ALWAYS_DISABLED = PP_OD_POWER_FEATURE_e.define('PP_OD_POWER_FEATURE_ALWAYS_DISABLED', 2) # type: ignore
...
OD_NO_ERROR = OD_FAIL_e.define('OD_NO_ERROR', 0) # type: ignore
OD_REQUEST_ADVANCED_NOT_SUPPORTED = OD_FAIL_e.define('OD_REQUEST_ADVANCED_NOT_SUPPORTED', 1) # type: ignore
OD_UNSUPPORTED_FEATURE = OD_FAIL_e.define('OD_UNSUPPORTED_FEATURE', 2) # type: ignore
OD_INVALID_FEATURE_COMBO_ERROR = OD_FAIL_e.define('OD_INVALID_FEATURE_COMBO_ERROR', 3) # type: ignore
OD_GFXCLK_VF_CURVE_OFFSET_ERROR = OD_FAIL_e.define('OD_GFXCLK_VF_CURVE_OFFSET_ERROR', 4) # type: ignore
OD_VDD_GFX_VMAX_ERROR = OD_FAIL_e.define('OD_VDD_GFX_VMAX_ERROR', 5) # type: ignore
OD_VDD_SOC_VMAX_ERROR = OD_FAIL_e.define('OD_VDD_SOC_VMAX_ERROR', 6) # type: ignore
OD_PPT_ERROR = OD_FAIL_e.define('OD_PPT_ERROR', 7) # type: ignore
OD_FAN_MIN_PWM_ERROR = OD_FAIL_e.define('OD_FAN_MIN_PWM_ERROR', 8) # type: ignore
OD_FAN_ACOUSTIC_TARGET_ERROR = OD_FAIL_e.define('OD_FAN_ACOUSTIC_TARGET_ERROR', 9) # type: ignore
OD_FAN_ACOUSTIC_LIMIT_ERROR = OD_FAIL_e.define('OD_FAN_ACOUSTIC_LIMIT_ERROR', 10) # type: ignore
OD_FAN_TARGET_TEMP_ERROR = OD_FAIL_e.define('OD_FAN_TARGET_TEMP_ERROR', 11) # type: ignore
OD_FAN_ZERO_RPM_STOP_TEMP_ERROR = OD_FAIL_e.define('OD_FAN_ZERO_RPM_STOP_TEMP_ERROR', 12) # type: ignore
OD_FAN_CURVE_PWM_ERROR = OD_FAIL_e.define('OD_FAN_CURVE_PWM_ERROR', 13) # type: ignore
OD_FAN_CURVE_TEMP_ERROR = OD_FAIL_e.define('OD_FAN_CURVE_TEMP_ERROR', 14) # type: ignore
OD_FULL_CTRL_GFXCLK_ERROR = OD_FAIL_e.define('OD_FULL_CTRL_GFXCLK_ERROR', 15) # type: ignore
OD_FULL_CTRL_UCLK_ERROR = OD_FAIL_e.define('OD_FULL_CTRL_UCLK_ERROR', 16) # type: ignore
OD_FULL_CTRL_FCLK_ERROR = OD_FAIL_e.define('OD_FULL_CTRL_FCLK_ERROR', 17) # type: ignore
OD_FULL_CTRL_VDD_GFX_ERROR = OD_FAIL_e.define('OD_FULL_CTRL_VDD_GFX_ERROR', 18) # type: ignore
OD_FULL_CTRL_VDD_SOC_ERROR = OD_FAIL_e.define('OD_FULL_CTRL_VDD_SOC_ERROR', 19) # type: ignore
OD_TDC_ERROR = OD_FAIL_e.define('OD_TDC_ERROR', 20) # type: ignore
OD_GFXCLK_ERROR = OD_FAIL_e.define('OD_GFXCLK_ERROR', 21) # type: ignore
OD_UCLK_ERROR = OD_FAIL_e.define('OD_UCLK_ERROR', 22) # type: ignore
OD_FCLK_ERROR = OD_FAIL_e.define('OD_FCLK_ERROR', 23) # type: ignore
OD_OP_TEMP_ERROR = OD_FAIL_e.define('OD_OP_TEMP_ERROR', 24) # type: ignore
OD_OP_GFX_EDC_ERROR = OD_FAIL_e.define('OD_OP_GFX_EDC_ERROR', 25) # type: ignore
OD_OP_GFX_PCC_ERROR = OD_FAIL_e.define('OD_OP_GFX_PCC_ERROR', 26) # type: ignore
OD_POWER_FEATURE_CTRL_ERROR = OD_FAIL_e.define('OD_POWER_FEATURE_CTRL_ERROR', 27) # type: ignore
...
MAX_BOARD_DC_GPIO_NUM = BOARD_GPIO_TYPE_e.define('MAX_BOARD_DC_GPIO_NUM', 44) # type: ignore
BOARD_GPIO_LV_EN = BOARD_GPIO_TYPE_e.define('BOARD_GPIO_LV_EN', 45) # type: ignore
