...
class struct_SMU14_Firmware_Footer(ctypes.Structure): pass
...
FEATURE_BTC_e = CEnum(ctypes.c_uint)
...
I2cControllerConfig_t = _anonstruct3
...
SviTelemetryScale_t = _anonstruct13
PP_OD_POWER_FEATURE_e = CEnum(ctypes.c_uint)
