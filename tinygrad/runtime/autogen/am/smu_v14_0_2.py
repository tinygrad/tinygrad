...
class AvfsDebugTable_t:
  ...
  avgPsmVoltage: Annotated[Array[ctypes.c_float, Literal[76]], 456]
  minPsmVoltage: Annotated[Array[ctypes.c_float, Literal[76]], 760]
  maxPsmVoltage: Annotated[Array[ctypes.c_float, Literal[76]], 1064]
@record
