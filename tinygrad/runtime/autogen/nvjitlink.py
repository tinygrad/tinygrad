...
@dll.bind
def nvJitLinkCreate(handle:ctypes.POINTER(nvJitLinkHandle), numOptions:uint32_t, options:ctypes.POINTER(ctypes.POINTER(ctypes.c_char))) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkDestroy(handle:ctypes.POINTER(nvJitLinkHandle)) -> nvJitLinkResult: ...
size_t = ctypes.c_uint64
@dll.bind
def nvJitLinkAddData(handle:nvJitLinkHandle, inputType:nvJitLinkInputType, data:ctypes.POINTER(None), size:size_t, name:ctypes.POINTER(ctypes.c_char)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkAddFile(handle:nvJitLinkHandle, inputType:nvJitLinkInputType, fileName:ctypes.POINTER(ctypes.c_char)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkComplete(handle:nvJitLinkHandle) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetLinkedCubinSize(handle:nvJitLinkHandle, size:ctypes.POINTER(size_t)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetLinkedCubin(handle:nvJitLinkHandle, cubin:ctypes.POINTER(None)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetLinkedPtxSize(handle:nvJitLinkHandle, size:ctypes.POINTER(size_t)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetLinkedPtx(handle:nvJitLinkHandle, ptx:ctypes.POINTER(ctypes.c_char)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetErrorLogSize(handle:nvJitLinkHandle, size:ctypes.POINTER(size_t)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetErrorLog(handle:nvJitLinkHandle, log:ctypes.POINTER(ctypes.c_char)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetInfoLogSize(handle:nvJitLinkHandle, size:ctypes.POINTER(size_t)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkGetInfoLog(handle:nvJitLinkHandle, log:ctypes.POINTER(ctypes.c_char)) -> nvJitLinkResult: ...
@dll.bind
def nvJitLinkVersion(major:ctypes.POINTER(ctypes.c_uint32), minor:ctypes.POINTER(ctypes.c_uint32)) -> nvJitLinkResult: ...
init_records()
