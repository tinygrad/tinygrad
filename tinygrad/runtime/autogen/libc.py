...
def mmap(__addr:int|None, __len:size_t, __prot:int, __flags:int, __fd:int, __offset:ctypes.c_int64) -> int|None: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t)
def munmap(__addr:int|None, __len:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t, ctypes.c_int32)
def mprotect(__addr:int|None, __len:size_t, __prot:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t, ctypes.c_int32)
def msync(__addr:int|None, __len:size_t, __flags:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t, ctypes.c_int32)
def madvise(__addr:int|None, __len:size_t, __advice:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t, ctypes.c_int32)
def posix_madvise(__addr:int|None, __len:size_t, __advice:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t)
def mlock(__addr:int|None, __len:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t)
def munlock(__addr:int|None, __len:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32)
def mlockall(__flags:int) -> int: ...
@dll.bind(ctypes.c_int32)
def munlockall() -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t, ctypes.POINTER(ctypes.c_ubyte))
def mincore(__start:int|None, __len:size_t, __vec:ctypes._Pointer[ctypes.c_ubyte]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int32, mode_t)
def shm_open(__name:ctypes._Pointer[ctypes.c_char], __oflag:int, __mode:mode_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def shm_unlink(__name:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, size_t)
def memcpy(__dest:int|None, __src:int|None, __n:size_t) -> int|None: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, size_t)
def memmove(__dest:int|None, __src:int|None, __n:size_t) -> int|None: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int32, size_t)
def memccpy(__dest:int|None, __src:int|None, __c:int, __n:size_t) -> int|None: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int32, size_t)
def memset(__s:int|None, __c:int, __n:size_t) -> int|None: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, ctypes.c_void_p, size_t)
def memcmp(__s1:int|None, __s2:int|None, __n:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, ctypes.c_void_p, size_t)
def __memcmpeq(__s1:int|None, __s2:int|None, __n:size_t) -> int: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int32, size_t)
def memchr(__s:int|None, __c:int, __n:size_t) -> int|None: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strcpy(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def strncpy(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strcat(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def strncat(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strcmp(__s1:ctypes._Pointer[ctypes.c_char], __s2:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def strncmp(__s1:ctypes._Pointer[ctypes.c_char], __s2:ctypes._Pointer[ctypes.c_char], __n:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strcoll(__s1:ctypes._Pointer[ctypes.c_char], __s2:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_uint64, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def strxfrm(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t) -> int: ...
@c.record
class struct___locale_struct(c.Struct):
  SIZE = 232
  __locales: ctypes.Array[ctypes.POINTER(struct___locale_data)]
  __ctype_b: ctypes._Pointer[ctypes.c_uint16]
  __ctype_tolower: ctypes._Pointer[ctypes.c_int32]
  __ctype_toupper: ctypes._Pointer[ctypes.c_int32]
  __names: ctypes.Array[ctypes.POINTER(ctypes.c_char)]
...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), locale_t)
def strcoll_l(__s1:ctypes._Pointer[ctypes.c_char], __s2:ctypes._Pointer[ctypes.c_char], __l:locale_t) -> int: ...
@dll.bind(size_t, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t, locale_t)
def strxfrm_l(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t, __l:locale_t) -> size_t: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strdup(__s:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def strndup(__string:ctypes._Pointer[ctypes.c_char], __n:size_t) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def strchr(__s:ctypes._Pointer[ctypes.c_char], __c:int) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def strrchr(__s:ctypes._Pointer[ctypes.c_char], __c:int) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def strchrnul(__s:ctypes._Pointer[ctypes.c_char], __c:int) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_uint64, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strcspn(__s:ctypes._Pointer[ctypes.c_char], __reject:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_uint64, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strspn(__s:ctypes._Pointer[ctypes.c_char], __accept:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strpbrk(__s:ctypes._Pointer[ctypes.c_char], __accept:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strstr(__haystack:ctypes._Pointer[ctypes.c_char], __needle:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strtok(__s:ctypes._Pointer[ctypes.c_char], __delim:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.POINTER(ctypes.c_char)))
def __strtok_r(__s:ctypes._Pointer[ctypes.c_char], __delim:ctypes._Pointer[ctypes.c_char], __save_ptr:ctypes._Pointer[ctypes.POINTER(ctypes.c_char)]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.POINTER(ctypes.c_char)))
def strtok_r(__s:ctypes._Pointer[ctypes.c_char], __delim:ctypes._Pointer[ctypes.c_char], __save_ptr:ctypes._Pointer[ctypes.POINTER(ctypes.c_char)]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def strcasestr(__haystack:ctypes._Pointer[ctypes.c_char], __needle:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, size_t, ctypes.c_void_p, size_t)
def memmem(__haystack:int|None, __haystacklen:size_t, __needle:int|None, __needlelen:size_t) -> int|None: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, size_t)
def __mempcpy(__dest:int|None, __src:int|None, __n:size_t) -> int|None: ...
@dll.bind(ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, size_t)
def mempcpy(__dest:int|None, __src:int|None, __n:size_t) -> int|None: ...
@dll.bind(ctypes.c_uint64, ctypes.POINTER(ctypes.c_char))
def strlen(__s:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(size_t, ctypes.POINTER(ctypes.c_char), size_t)
def strnlen(__string:ctypes._Pointer[ctypes.c_char], __maxlen:size_t) -> size_t: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def strerror(__errnum:int) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def strerror_r(__errnum:int, __buf:ctypes._Pointer[ctypes.c_char], __buflen:size_t) -> int: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.c_int32, locale_t)
def strerror_l(__errnum:int, __l:locale_t) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(None, ctypes.c_void_p, size_t)
def explicit_bzero(__s:int|None, __n:size_t) -> None: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.POINTER(ctypes.c_char)), ctypes.POINTER(ctypes.c_char))
def strsep(__stringp:ctypes._Pointer[ctypes.POINTER(ctypes.c_char)], __delim:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def strsignal(__sig:int) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def __stpcpy(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def stpcpy(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def __stpncpy(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def stpncpy(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(size_t, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def strlcpy(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t) -> size_t: ...
@dll.bind(size_t, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def strlcat(__dest:ctypes._Pointer[ctypes.c_char], __src:ctypes._Pointer[ctypes.c_char], __n:size_t) -> size_t: ...
...
class Elf32_Ehdr(c.Struct):
  SIZE = 52
  e_ident: ctypes.Array[ctypes.c_ubyte]
  e_type: int
  e_machine: int
  e_version: int
  e_entry: int
...
class Elf32_RegInfo(c.Struct):
  SIZE = 24
  ri_gprmask: int
  ri_cprmask: ctypes.Array[ctypes.c_uint32]
  ri_gp_value: int
...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def access(__name:ctypes._Pointer[ctypes.c_char], __type:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int32, ctypes.c_int32)
def faccessat(__fd:int, __file:ctypes._Pointer[ctypes.c_char], __type:int, __flag:int) -> int: ...
...
def read(__fd:int, __buf:int|None, __nbytes:size_t) -> ssize_t: ...
@dll.bind(ssize_t, ctypes.c_int32, ctypes.c_void_p, size_t)
def write(__fd:int, __buf:int|None, __n:size_t) -> ssize_t: ...
@dll.bind(ssize_t, ctypes.c_int32, ctypes.c_void_p, size_t, ctypes.c_int64)
def pread(__fd:int, __buf:int|None, __nbytes:size_t, __offset:ctypes.c_int64) -> ssize_t: ...
@dll.bind(ssize_t, ctypes.c_int32, ctypes.c_void_p, size_t, ctypes.c_int64)
def pwrite(__fd:int, __buf:int|None, __n:size_t, __offset:ctypes.c_int64) -> ssize_t: ...
@dll.bind(ctypes.c_int32, (ctypes.c_int32 * 2))
def pipe(__pipedes:ctypes.Array[ctypes.c_int32]) -> int: ...
...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_uint32, ctypes.c_uint32)
def chown(__file:ctypes._Pointer[ctypes.c_char], __owner:ctypes.c_uint32, __group:ctypes.c_uint32) -> int: ...
...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_uint32, ctypes.c_uint32)
def lchown(__file:ctypes._Pointer[ctypes.c_char], __owner:ctypes.c_uint32, __group:ctypes.c_uint32) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_uint32, ctypes.c_uint32, ctypes.c_int32)
def fchownat(__fd:int, __file:ctypes._Pointer[ctypes.c_char], __owner:ctypes.c_uint32, __group:ctypes.c_uint32, __flag:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def chdir(__path:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32)
def fchdir(__fd:int) -> int: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def getcwd(__buf:ctypes._Pointer[ctypes.c_char], __size:size_t) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def getwd(__buf:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32)
...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), (ctypes.POINTER(ctypes.c_char) * 0), (ctypes.POINTER(ctypes.c_char) * 0))
def execve(__path:ctypes._Pointer[ctypes.c_char], __argv:ctypes.Array[ctypes.POINTER(ctypes.c_char)], __envp:ctypes.Array[ctypes.POINTER(ctypes.c_char)]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32, (ctypes.POINTER(ctypes.c_char) * 0), (ctypes.POINTER(ctypes.c_char) * 0))
def fexecve(__fd:int, __argv:ctypes.Array[ctypes.POINTER(ctypes.c_char)], __envp:ctypes.Array[ctypes.POINTER(ctypes.c_char)]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), (ctypes.POINTER(ctypes.c_char) * 0))
def execv(__path:ctypes._Pointer[ctypes.c_char], __argv:ctypes.Array[ctypes.POINTER(ctypes.c_char)]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def execle(__path:ctypes._Pointer[ctypes.c_char], __arg:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def execl(__path:ctypes._Pointer[ctypes.c_char], __arg:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), (ctypes.POINTER(ctypes.c_char) * 0))
def execvp(__file:ctypes._Pointer[ctypes.c_char], __argv:ctypes.Array[ctypes.POINTER(ctypes.c_char)]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def execlp(__file:ctypes._Pointer[ctypes.c_char], __arg:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32)
def nice(__inc:int) -> int: ...
@dll.bind(None, ctypes.c_int32)
def _exit(__status:int) -> None: ...
@dll.bind(ctypes.c_int64, ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def pathconf(__path:ctypes._Pointer[ctypes.c_char], __name:int) -> ctypes.c_int64: ...
@dll.bind(ctypes.c_int64, ctypes.c_int32, ctypes.c_int32)
def fpathconf(__fd:int, __name:int) -> ctypes.c_int64: ...
@dll.bind(ctypes.c_int64, ctypes.c_int32)
def sysconf(__name:int) -> ctypes.c_int64: ...
@dll.bind(size_t, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def confstr(__name:int, __buf:ctypes._Pointer[ctypes.c_char], __len:size_t) -> size_t: ...
...
@dll.bind(ctypes.c_int32, ctypes.c_int32, (ctypes.c_uint32 * 0))
def getgroups(__size:int, __list:ctypes.Array[ctypes.c_uint32]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_uint32)
...
def vfork() -> int: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def ttyname(__fd:int) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def ttyname_r(__fd:int, __buf:ctypes._Pointer[ctypes.c_char], __buflen:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32)
def isatty(__fd:int) -> int: ...
@dll.bind(ctypes.c_int32)
def ttyslot() -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def link(__from:ctypes._Pointer[ctypes.c_char], __to:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def linkat(__fromfd:int, __from:ctypes._Pointer[ctypes.c_char], __tofd:int, __to:ctypes._Pointer[ctypes.c_char], __flags:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def symlink(__from:ctypes._Pointer[ctypes.c_char], __to:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ssize_t, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def readlink(__path:ctypes._Pointer[ctypes.c_char], __buf:ctypes._Pointer[ctypes.c_char], __len:size_t) -> ssize_t: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def symlinkat(__from:ctypes._Pointer[ctypes.c_char], __tofd:int, __to:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ssize_t, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), size_t)
def readlinkat(__fd:int, __path:ctypes._Pointer[ctypes.c_char], __buf:ctypes._Pointer[ctypes.c_char], __len:size_t) -> ssize_t: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def unlink(__name:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int32)
def unlinkat(__fd:int, __name:ctypes._Pointer[ctypes.c_char], __flag:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def rmdir(__path:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32)
...
def getlogin() -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def getlogin_r(__name:ctypes._Pointer[ctypes.c_char], __name_len:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def setlogin(__name:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def gethostname(__name:ctypes._Pointer[ctypes.c_char], __len:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def sethostname(__name:ctypes._Pointer[ctypes.c_char], __len:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.c_int64)
def sethostid(__id:ctypes.c_int64) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def getdomainname(__name:ctypes._Pointer[ctypes.c_char], __len:size_t) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), size_t)
def setdomainname(__name:ctypes._Pointer[ctypes.c_char], __len:size_t) -> int: ...
@dll.bind(ctypes.c_int32)
def vhangup() -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def revoke(__file:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_uint16), size_t, size_t, ctypes.c_uint32)
def profil(__sample_buffer:ctypes._Pointer[ctypes.c_uint16], __size:size_t, __offset:size_t, __scale:int) -> int: ...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def acct(__name:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.POINTER(ctypes.c_char))
def getusershell() -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(None)
...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char))
def chroot(__path:ctypes._Pointer[ctypes.c_char]) -> int: ...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def getpass(__prompt:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_int32, ctypes.c_int32)
...
@dll.bind(ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.c_int64)
def truncate(__file:ctypes._Pointer[ctypes.c_char], __length:ctypes.c_int64) -> int: ...
...
def brk(__addr:int|None) -> int: ...
@dll.bind(ctypes.c_void_p, intptr_t)
def sbrk(__delta:intptr_t) -> int|None: ...
...
@dll.bind(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char))
def crypt(__key:ctypes._Pointer[ctypes.c_char], __salt:ctypes._Pointer[ctypes.c_char]) -> ctypes._Pointer[ctypes.c_char]: ...
@dll.bind(ctypes.c_int32, ctypes.c_void_p, size_t)
def getentropy(__buffer:int|None, __length:size_t) -> int: ...
