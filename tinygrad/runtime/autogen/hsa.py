...
@dll.bind
def hsa_amd_profiling_set_profiler_enabled(queue:c.POINTER[hsa_queue_t], enable:ctypes.c_int32) -> ctypes.c_uint32: ...
@dll.bind
...
@dll.bind
def hsa_amd_memory_lock(host_ptr:ctypes.c_void_p, size:size_t, agents:c.POINTER[hsa_agent_t], num_agent:ctypes.c_int32, agent_ptr:c.POINTER[ctypes.c_void_p]) -> ctypes.c_uint32: ...
@dll.bind
def hsa_amd_memory_lock_to_pool(host_ptr:ctypes.c_void_p, size:size_t, agents:c.POINTER[hsa_agent_t], num_agent:ctypes.c_int32, pool:hsa_amd_memory_pool_t, flags:uint32_t, agent_ptr:c.POINTER[ctypes.c_void_p]) -> ctypes.c_uint32: ...
@dll.bind
...
@dll.bind
def hsa_amd_interop_map_buffer(num_agents:uint32_t, agents:c.POINTER[hsa_agent_t], interop_handle:ctypes.c_int32, flags:uint32_t, size:c.POINTER[size_t], ptr:c.POINTER[ctypes.c_void_p], metadata_size:c.POINTER[size_t], metadata:c.POINTER[ctypes.c_void_p]) -> ctypes.c_uint32: ...
@dll.bind
...
@dll.bind
def hsa_amd_vmem_import_shareable_handle(dmabuf_fd:ctypes.c_int32, handle:c.POINTER[hsa_amd_vmem_alloc_handle_t]) -> ctypes.c_uint32: ...
@dll.bind
...
class struct_hsa_ext_finalizer_1_00_pfn_s(c.Struct):
  SIZE = 48
  hsa_ext_program_create: 'c.CFUNCTYPE[ctypes.c_uint32, [ctypes.c_uint32, ctypes.c_uint32, ctypes.c_uint32, c.POINTER[ctypes.c_char], c.POINTER[hsa_ext_program_t]]]'
  hsa_ext_program_destroy: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_ext_program_t]]'
  hsa_ext_program_add_module: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_ext_program_t, hsa_ext_module_t]]'
  hsa_ext_program_iterate_modules: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_ext_program_t, c.CFUNCTYPE[ctypes.c_uint32, [hsa_ext_program_t, hsa_ext_module_t, ctypes.c_void_p]], ctypes.c_void_p]]'
  hsa_ext_program_get_info: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_ext_program_t, ctypes.c_uint32, ctypes.c_void_p]]'
  hsa_ext_program_finalize: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_ext_program_t, hsa_isa_t, int32_t, hsa_ext_control_directives_t, c.POINTER[ctypes.c_char], ctypes.c_uint32, c.POINTER[hsa_code_object_t]]]'
...
class struct_hsa_ext_images_1_00_pfn_s(c.Struct):
  SIZE = 80
  hsa_ext_image_get_capability: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, ctypes.c_uint32, c.POINTER[hsa_ext_image_format_t], c.POINTER[uint32_t]]]'
  hsa_ext_image_data_get_info: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ext_image_descriptor_t], ctypes.c_uint32, c.POINTER[hsa_ext_image_data_info_t]]]'
  hsa_ext_image_create: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ext_image_descriptor_t], ctypes.c_void_p, ctypes.c_uint32, c.POINTER[hsa_ext_image_t]]]'
  hsa_ext_image_destroy: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, hsa_ext_image_t]]'
  hsa_ext_image_copy: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, hsa_ext_image_t, c.POINTER[hsa_dim3_t], hsa_ext_image_t, c.POINTER[hsa_dim3_t], c.POINTER[hsa_dim3_t]]]'
  hsa_ext_image_import: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, ctypes.c_void_p, size_t, size_t, hsa_ext_image_t, c.POINTER[hsa_ext_image_region_t]]]'
  hsa_ext_image_export: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, hsa_ext_image_t, ctypes.c_void_p, size_t, size_t, c.POINTER[hsa_ext_image_region_t]]]'
  hsa_ext_image_clear: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, hsa_ext_image_t, ctypes.c_void_p, c.POINTER[hsa_ext_image_region_t]]]'
  hsa_ext_sampler_create: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ext_sampler_descriptor_t], c.POINTER[hsa_ext_sampler_t]]]'
  hsa_ext_sampler_destroy: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, hsa_ext_sampler_t]]'
...
class struct_hsa_ext_images_1_pfn_s(c.Struct):
  ...
  hsa_ext_sampler_create: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ext_sampler_descriptor_t], c.POINTER[hsa_ext_sampler_t]]]'
  hsa_ext_sampler_destroy: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, hsa_ext_sampler_t]]'
  hsa_ext_image_get_capability_with_layout: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, ctypes.c_uint32, c.POINTER[hsa_ext_image_format_t], ctypes.c_uint32, c.POINTER[uint32_t]]]'
  hsa_ext_image_data_get_info_with_layout: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ext_image_descriptor_t], ctypes.c_uint32, ctypes.c_uint32, size_t, size_t, c.POINTER[hsa_ext_image_data_info_t]]]'
  hsa_ext_image_create_with_layout: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ext_image_descriptor_t], ctypes.c_void_p, ctypes.c_uint32, ctypes.c_uint32, size_t, size_t, c.POINTER[hsa_ext_image_t]]]'
  hsa_ext_sampler_create_v2: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ext_sampler_descriptor_v2_t], c.POINTER[hsa_ext_sampler_t]]]'
...
class struct_hsa_ven_amd_aqlprofile_1_00_pfn_s(c.Struct):
  ...
  hsa_ven_amd_aqlprofile_validate_event: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, c.POINTER[hsa_ven_amd_aqlprofile_event_t], c.POINTER[ctypes.c_bool]]]'
  ...
  hsa_ven_amd_aqlprofile_iterate_data: 'c.CFUNCTYPE[ctypes.c_uint32, [c.POINTER[hsa_ven_amd_aqlprofile_profile_t], hsa_ven_amd_aqlprofile_data_callback_t, ctypes.c_void_p]]'
  hsa_ven_amd_aqlprofile_iterate_event_ids: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_ven_amd_aqlprofile_eventname_callback_t]]'
  hsa_ven_amd_aqlprofile_iterate_event_coord: 'c.CFUNCTYPE[ctypes.c_uint32, [hsa_agent_t, hsa_ven_amd_aqlprofile_event_t, uint32_t, hsa_ven_amd_aqlprofile_coordinate_callback_t, ctypes.c_void_p]]'
  hsa_ven_amd_aqlprofile_att_marker: 'c.CFUNCTYPE[ctypes.c_uint32, [c.POINTER[hsa_ven_amd_aqlprofile_profile_t], c.POINTER[hsa_ext_amd_aql_pm4_packet_t], uint32_t, ctypes.c_uint32]]'
