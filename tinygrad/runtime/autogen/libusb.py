...
class struct_libusb_endpoint_descriptor:
  ...
  extra: Annotated[POINTER(Annotated[int, ctypes.c_ubyte]), 16]
...
class struct_libusb_interface_association_descriptor_array:
  SIZE = 16
  iad: Annotated[POINTER(struct_libusb_interface_association_descriptor), 0]
...
class struct_libusb_interface_descriptor:
  ...
  endpoint: Annotated[POINTER(struct_libusb_endpoint_descriptor), 16]
  extra: Annotated[POINTER(Annotated[int, ctypes.c_ubyte]), 24]
  extra_length: Annotated[Annotated[int, ctypes.c_int32], 32]
@record
class struct_libusb_interface:
  SIZE = 16
  altsetting: Annotated[POINTER(struct_libusb_interface_descriptor), 0]
...
class struct_libusb_config_descriptor:
  ...
  interface: Annotated[POINTER(struct_libusb_interface), 16]
  extra: Annotated[POINTER(Annotated[int, ctypes.c_ubyte]), 24]
  extra_length: Annotated[Annotated[int, ctypes.c_int32], 32]
@record
...
class struct_libusb_bos_descriptor:
  ...
  dev_capability: Annotated[Array[POINTER(struct_libusb_bos_dev_capability_descriptor), Literal[0]], 8]
@record
...
class struct_libusb_transfer:
  SIZE = 64
  dev_handle: Annotated[POINTER(libusb_device_handle), 0]
  ...
  user_data: Annotated[POINTER(None), 40]
...
@dll.bind
def libusb_init(ctx:POINTER(POINTER(libusb_context))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_init_context(ctx:POINTER(POINTER(libusb_context)), options:Array[struct_libusb_init_option, Literal[0]], num_options:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_exit(ctx:POINTER(libusb_context)) -> None: ...
@dll.bind
def libusb_set_debug(ctx:POINTER(libusb_context), level:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def libusb_set_log_cb(ctx:POINTER(libusb_context), cb:libusb_log_cb, mode:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def libusb_get_version() -> POINTER(struct_libusb_version): ...
@dll.bind
def libusb_has_capability(capability:uint32_t) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_error_name(errcode:Annotated[int, ctypes.c_int32]) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def libusb_free_device_list(list:POINTER(POINTER(libusb_device)), unref_devices:Annotated[int, ctypes.c_int32]) -> None: ...
@dll.bind
def libusb_ref_device(dev:POINTER(libusb_device)) -> POINTER(libusb_device): ...
@dll.bind
def libusb_unref_device(dev:POINTER(libusb_device)) -> None: ...
@dll.bind
def libusb_get_configuration(dev:POINTER(libusb_device_handle), config:POINTER(Annotated[int, ctypes.c_int32])) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_device_descriptor(dev:POINTER(libusb_device), desc:POINTER(struct_libusb_device_descriptor)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_active_config_descriptor(dev:POINTER(libusb_device), config:POINTER(POINTER(struct_libusb_config_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_config_descriptor(dev:POINTER(libusb_device), config_index:uint8_t, config:POINTER(POINTER(struct_libusb_config_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_config_descriptor_by_value(dev:POINTER(libusb_device), bConfigurationValue:uint8_t, config:POINTER(POINTER(struct_libusb_config_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_config_descriptor(config:POINTER(struct_libusb_config_descriptor)) -> None: ...
@dll.bind
def libusb_get_ss_endpoint_companion_descriptor(ctx:POINTER(libusb_context), endpoint:POINTER(struct_libusb_endpoint_descriptor), ep_comp:POINTER(POINTER(struct_libusb_ss_endpoint_companion_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_ss_endpoint_companion_descriptor(ep_comp:POINTER(struct_libusb_ss_endpoint_companion_descriptor)) -> None: ...
@dll.bind
def libusb_get_bos_descriptor(dev_handle:POINTER(libusb_device_handle), bos:POINTER(POINTER(struct_libusb_bos_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_bos_descriptor(bos:POINTER(struct_libusb_bos_descriptor)) -> None: ...
@dll.bind
def libusb_get_usb_2_0_extension_descriptor(ctx:POINTER(libusb_context), dev_cap:POINTER(struct_libusb_bos_dev_capability_descriptor), usb_2_0_extension:POINTER(POINTER(struct_libusb_usb_2_0_extension_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_usb_2_0_extension_descriptor(usb_2_0_extension:POINTER(struct_libusb_usb_2_0_extension_descriptor)) -> None: ...
@dll.bind
def libusb_get_ss_usb_device_capability_descriptor(ctx:POINTER(libusb_context), dev_cap:POINTER(struct_libusb_bos_dev_capability_descriptor), ss_usb_device_cap:POINTER(POINTER(struct_libusb_ss_usb_device_capability_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_ss_usb_device_capability_descriptor(ss_usb_device_cap:POINTER(struct_libusb_ss_usb_device_capability_descriptor)) -> None: ...
@dll.bind
def libusb_get_container_id_descriptor(ctx:POINTER(libusb_context), dev_cap:POINTER(struct_libusb_bos_dev_capability_descriptor), container_id:POINTER(POINTER(struct_libusb_container_id_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_container_id_descriptor(container_id:POINTER(struct_libusb_container_id_descriptor)) -> None: ...
@dll.bind
def libusb_get_platform_descriptor(ctx:POINTER(libusb_context), dev_cap:POINTER(struct_libusb_bos_dev_capability_descriptor), platform_descriptor:POINTER(POINTER(struct_libusb_platform_descriptor))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_platform_descriptor(platform_descriptor:POINTER(struct_libusb_platform_descriptor)) -> None: ...
@dll.bind
def libusb_get_bus_number(dev:POINTER(libusb_device)) -> uint8_t: ...
@dll.bind
def libusb_get_port_number(dev:POINTER(libusb_device)) -> uint8_t: ...
@dll.bind
def libusb_get_port_numbers(dev:POINTER(libusb_device), port_numbers:POINTER(uint8_t), port_numbers_len:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_port_path(ctx:POINTER(libusb_context), dev:POINTER(libusb_device), path:POINTER(uint8_t), path_length:uint8_t) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_parent(dev:POINTER(libusb_device)) -> POINTER(libusb_device): ...
@dll.bind
def libusb_get_device_address(dev:POINTER(libusb_device)) -> uint8_t: ...
@dll.bind
def libusb_get_device_speed(dev:POINTER(libusb_device)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_max_packet_size(dev:POINTER(libusb_device), endpoint:Annotated[int, ctypes.c_ubyte]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_max_iso_packet_size(dev:POINTER(libusb_device), endpoint:Annotated[int, ctypes.c_ubyte]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_max_alt_packet_size(dev:POINTER(libusb_device), interface_number:Annotated[int, ctypes.c_int32], alternate_setting:Annotated[int, ctypes.c_int32], endpoint:Annotated[int, ctypes.c_ubyte]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_interface_association_descriptors(dev:POINTER(libusb_device), config_index:uint8_t, iad_array:POINTER(POINTER(struct_libusb_interface_association_descriptor_array))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
...
@dll.bind
def libusb_open(dev:POINTER(libusb_device), dev_handle:POINTER(POINTER(libusb_device_handle))) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_close(dev_handle:POINTER(libusb_device_handle)) -> None: ...
@dll.bind
def libusb_get_device(dev_handle:POINTER(libusb_device_handle)) -> POINTER(libusb_device): ...
@dll.bind
def libusb_set_configuration(dev_handle:POINTER(libusb_device_handle), configuration:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_claim_interface(dev_handle:POINTER(libusb_device_handle), interface_number:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_release_interface(dev_handle:POINTER(libusb_device_handle), interface_number:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_open_device_with_vid_pid(ctx:POINTER(libusb_context), vendor_id:uint16_t, product_id:uint16_t) -> POINTER(libusb_device_handle): ...
@dll.bind
def libusb_set_interface_alt_setting(dev_handle:POINTER(libusb_device_handle), interface_number:Annotated[int, ctypes.c_int32], alternate_setting:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_clear_halt(dev_handle:POINTER(libusb_device_handle), endpoint:Annotated[int, ctypes.c_ubyte]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_reset_device(dev_handle:POINTER(libusb_device_handle)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
...
@dll.bind
def libusb_dev_mem_free(dev_handle:POINTER(libusb_device_handle), buffer:POINTER(Annotated[int, ctypes.c_ubyte]), length:size_t) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_kernel_driver_active(dev_handle:POINTER(libusb_device_handle), interface_number:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_detach_kernel_driver(dev_handle:POINTER(libusb_device_handle), interface_number:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_attach_kernel_driver(dev_handle:POINTER(libusb_device_handle), interface_number:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_set_auto_detach_kernel_driver(dev_handle:POINTER(libusb_device_handle), enable:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_alloc_transfer(iso_packets:Annotated[int, ctypes.c_int32]) -> POINTER(struct_libusb_transfer): ...
@dll.bind
def libusb_submit_transfer(transfer:POINTER(struct_libusb_transfer)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_cancel_transfer(transfer:POINTER(struct_libusb_transfer)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_free_transfer(transfer:POINTER(struct_libusb_transfer)) -> None: ...
@dll.bind
def libusb_transfer_set_stream_id(transfer:POINTER(struct_libusb_transfer), stream_id:uint32_t) -> None: ...
@dll.bind
def libusb_transfer_get_stream_id(transfer:POINTER(struct_libusb_transfer)) -> uint32_t: ...
@dll.bind
def libusb_control_transfer(dev_handle:POINTER(libusb_device_handle), request_type:uint8_t, bRequest:uint8_t, wValue:uint16_t, wIndex:uint16_t, data:POINTER(Annotated[int, ctypes.c_ubyte]), wLength:uint16_t, timeout:Annotated[int, ctypes.c_uint32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_bulk_transfer(dev_handle:POINTER(libusb_device_handle), endpoint:Annotated[int, ctypes.c_ubyte], data:POINTER(Annotated[int, ctypes.c_ubyte]), length:Annotated[int, ctypes.c_int32], actual_length:POINTER(Annotated[int, ctypes.c_int32]), timeout:Annotated[int, ctypes.c_uint32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_interrupt_transfer(dev_handle:POINTER(libusb_device_handle), endpoint:Annotated[int, ctypes.c_ubyte], data:POINTER(Annotated[int, ctypes.c_ubyte]), length:Annotated[int, ctypes.c_int32], actual_length:POINTER(Annotated[int, ctypes.c_int32]), timeout:Annotated[int, ctypes.c_uint32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_string_descriptor_ascii(dev_handle:POINTER(libusb_device_handle), desc_index:uint8_t, data:POINTER(Annotated[int, ctypes.c_ubyte]), length:Annotated[int, ctypes.c_int32]) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_try_lock_events(ctx:POINTER(libusb_context)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_lock_events(ctx:POINTER(libusb_context)) -> None: ...
@dll.bind
def libusb_unlock_events(ctx:POINTER(libusb_context)) -> None: ...
@dll.bind
def libusb_event_handling_ok(ctx:POINTER(libusb_context)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_event_handler_active(ctx:POINTER(libusb_context)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_interrupt_event_handler(ctx:POINTER(libusb_context)) -> None: ...
@dll.bind
def libusb_lock_event_waiters(ctx:POINTER(libusb_context)) -> None: ...
@dll.bind
def libusb_unlock_event_waiters(ctx:POINTER(libusb_context)) -> None: ...
@record
...
@dll.bind
def libusb_handle_events_timeout(ctx:POINTER(libusb_context), tv:POINTER(struct_timeval)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_handle_events_timeout_completed(ctx:POINTER(libusb_context), tv:POINTER(struct_timeval), completed:POINTER(Annotated[int, ctypes.c_int32])) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_handle_events(ctx:POINTER(libusb_context)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_handle_events_completed(ctx:POINTER(libusb_context), completed:POINTER(Annotated[int, ctypes.c_int32])) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_handle_events_locked(ctx:POINTER(libusb_context), tv:POINTER(struct_timeval)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_pollfds_handle_timeouts(ctx:POINTER(libusb_context)) -> Annotated[int, ctypes.c_int32]: ...
@dll.bind
def libusb_get_next_timeout(ctx:POINTER(libusb_context), tv:POINTER(struct_timeval)) -> Annotated[int, ctypes.c_int32]: ...
@record
...
@dll.bind
def libusb_hotplug_deregister_callback(ctx:POINTER(libusb_context), callback_handle:libusb_hotplug_callback_handle) -> None: ...
@dll.bind
def libusb_hotplug_get_user_data(ctx:POINTER(libusb_context), callback_handle:libusb_hotplug_callback_handle) -> POINTER(None): ...
@dll.bind
def libusb_set_option(ctx:POINTER(libusb_context), option:enum_libusb_option) -> Annotated[int, ctypes.c_int32]: ...
init_records()
