...
@dll.bind
def clGetPlatformInfo(platform:cl_platform_id, param_name:cl_platform_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clGetDeviceInfo(device:cl_device_id, param_name:cl_device_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clCreateContext(properties:ctypes.POINTER(cl_context_properties), num_devices:cl_uint, devices:ctypes.POINTER(cl_device_id), pfn_notify:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.c_void_p, size_t, ctypes.c_void_p), user_data:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_context: ...
@dll.bind
def clCreateContextFromType(properties:ctypes.POINTER(cl_context_properties), device_type:cl_device_type, pfn_notify:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.c_void_p, size_t, ctypes.c_void_p), user_data:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_context: ...
@dll.bind
def clRetainContext(context:cl_context) -> cl_int: ...
@dll.bind
def clReleaseContext(context:cl_context) -> cl_int: ...
@dll.bind
def clGetContextInfo(context:cl_context, param_name:cl_context_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clSetContextDestructorCallback(context:cl_context, pfn_notify:ctypes.CFUNCTYPE(None, cl_context, ctypes.c_void_p), user_data:ctypes.c_void_p) -> cl_int: ...
@dll.bind
...
@dll.bind
def clGetCommandQueueInfo(command_queue:cl_command_queue, param_name:cl_command_queue_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clCreateBuffer(context:cl_context, flags:cl_mem_flags, size:size_t, host_ptr:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_mem: ...
@dll.bind
def clCreateSubBuffer(buffer:cl_mem, flags:cl_mem_flags, buffer_create_type:cl_buffer_create_type, buffer_create_info:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_mem: ...
@dll.bind
def clCreateImage(context:cl_context, flags:cl_mem_flags, image_format:ctypes.POINTER(cl_image_format), image_desc:ctypes.POINTER(cl_image_desc), host_ptr:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_mem: ...
@dll.bind
...
@dll.bind
def clCreateBufferWithProperties(context:cl_context, properties:ctypes.POINTER(cl_mem_properties), flags:cl_mem_flags, size:size_t, host_ptr:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_mem: ...
@dll.bind
def clCreateImageWithProperties(context:cl_context, properties:ctypes.POINTER(cl_mem_properties), flags:cl_mem_flags, image_format:ctypes.POINTER(cl_image_format), image_desc:ctypes.POINTER(cl_image_desc), host_ptr:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_mem: ...
@dll.bind
...
@dll.bind
def clGetMemObjectInfo(memobj:cl_mem, param_name:cl_mem_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clGetImageInfo(image:cl_mem, param_name:cl_image_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clGetPipeInfo(pipe:cl_mem, param_name:cl_pipe_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clSetMemObjectDestructorCallback(memobj:cl_mem, pfn_notify:ctypes.CFUNCTYPE(None, cl_mem, ctypes.c_void_p), user_data:ctypes.c_void_p) -> cl_int: ...
@dll.bind
...
@dll.bind
def clGetSamplerInfo(sampler:cl_sampler, param_name:cl_sampler_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clCreateProgramWithIL(context:cl_context, il:ctypes.c_void_p, length:size_t, errcode_ret:ctypes.POINTER(cl_int)) -> cl_program: ...
@dll.bind
def clRetainProgram(program:cl_program) -> cl_int: ...
@dll.bind
def clReleaseProgram(program:cl_program) -> cl_int: ...
@dll.bind
def clBuildProgram(program:cl_program, num_devices:cl_uint, device_list:ctypes.POINTER(cl_device_id), options:ctypes.POINTER(ctypes.c_char), pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p), user_data:ctypes.c_void_p) -> cl_int: ...
@dll.bind
def clCompileProgram(program:cl_program, num_devices:cl_uint, device_list:ctypes.POINTER(cl_device_id), options:ctypes.POINTER(ctypes.c_char), num_input_headers:cl_uint, input_headers:ctypes.POINTER(cl_program), header_include_names:ctypes.POINTER(ctypes.POINTER(ctypes.c_char)), pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p), user_data:ctypes.c_void_p) -> cl_int: ...
@dll.bind
def clLinkProgram(context:cl_context, num_devices:cl_uint, device_list:ctypes.POINTER(cl_device_id), options:ctypes.POINTER(ctypes.c_char), num_input_programs:cl_uint, input_programs:ctypes.POINTER(cl_program), pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p), user_data:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_program: ...
@dll.bind
def clSetProgramReleaseCallback(program:cl_program, pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p), user_data:ctypes.c_void_p) -> cl_int: ...
@dll.bind
...
@dll.bind
def clGetProgramInfo(program:cl_program, param_name:cl_program_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clGetProgramBuildInfo(program:cl_program, device:cl_device_id, param_name:cl_program_build_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clGetKernelInfo(kernel:cl_kernel, param_name:cl_kernel_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clGetKernelArgInfo(kernel:cl_kernel, arg_indx:cl_uint, param_name:cl_kernel_arg_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clGetKernelWorkGroupInfo(kernel:cl_kernel, device:cl_device_id, param_name:cl_kernel_work_group_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clGetKernelSubGroupInfo(kernel:cl_kernel, device:cl_device_id, param_name:cl_kernel_sub_group_info, input_value_size:size_t, input_value:ctypes.c_void_p, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clWaitForEvents(num_events:cl_uint, event_list:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clGetEventInfo(event:cl_event, param_name:cl_event_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clSetEventCallback(event:cl_event, command_exec_callback_type:cl_int, pfn_notify:ctypes.CFUNCTYPE(None, cl_event, cl_int, ctypes.c_void_p), user_data:ctypes.c_void_p) -> cl_int: ...
@dll.bind
def clGetEventProfilingInfo(event:cl_event, param_name:cl_profiling_info, param_value_size:size_t, param_value:ctypes.c_void_p, param_value_size_ret:ctypes.POINTER(size_t)) -> cl_int: ...
@dll.bind
def clFlush(command_queue:cl_command_queue) -> cl_int: ...
@dll.bind
def clFinish(command_queue:cl_command_queue) -> cl_int: ...
@dll.bind
def clEnqueueReadBuffer(command_queue:cl_command_queue, buffer:cl_mem, blocking_read:cl_bool, offset:size_t, size:size_t, ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueReadBufferRect(command_queue:cl_command_queue, buffer:cl_mem, blocking_read:cl_bool, buffer_origin:ctypes.POINTER(size_t), host_origin:ctypes.POINTER(size_t), region:ctypes.POINTER(size_t), buffer_row_pitch:size_t, buffer_slice_pitch:size_t, host_row_pitch:size_t, host_slice_pitch:size_t, ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueWriteBuffer(command_queue:cl_command_queue, buffer:cl_mem, blocking_write:cl_bool, offset:size_t, size:size_t, ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueWriteBufferRect(command_queue:cl_command_queue, buffer:cl_mem, blocking_write:cl_bool, buffer_origin:ctypes.POINTER(size_t), host_origin:ctypes.POINTER(size_t), region:ctypes.POINTER(size_t), buffer_row_pitch:size_t, buffer_slice_pitch:size_t, host_row_pitch:size_t, host_slice_pitch:size_t, ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueFillBuffer(command_queue:cl_command_queue, buffer:cl_mem, pattern:ctypes.c_void_p, pattern_size:size_t, offset:size_t, size:size_t, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clEnqueueReadImage(command_queue:cl_command_queue, image:cl_mem, blocking_read:cl_bool, origin:ctypes.POINTER(size_t), region:ctypes.POINTER(size_t), row_pitch:size_t, slice_pitch:size_t, ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueWriteImage(command_queue:cl_command_queue, image:cl_mem, blocking_write:cl_bool, origin:ctypes.POINTER(size_t), region:ctypes.POINTER(size_t), input_row_pitch:size_t, input_slice_pitch:size_t, ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueFillImage(command_queue:cl_command_queue, image:cl_mem, fill_color:ctypes.c_void_p, origin:ctypes.POINTER(size_t), region:ctypes.POINTER(size_t), num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clEnqueueMapBuffer(command_queue:cl_command_queue, buffer:cl_mem, blocking_map:cl_bool, map_flags:cl_map_flags, offset:size_t, size:size_t, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event), errcode_ret:ctypes.POINTER(cl_int)) -> ctypes.c_void_p: ...
@dll.bind
def clEnqueueMapImage(command_queue:cl_command_queue, image:cl_mem, blocking_map:cl_bool, map_flags:cl_map_flags, origin:ctypes.POINTER(size_t), region:ctypes.POINTER(size_t), image_row_pitch:ctypes.POINTER(size_t), image_slice_pitch:ctypes.POINTER(size_t), num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event), errcode_ret:ctypes.POINTER(cl_int)) -> ctypes.c_void_p: ...
@dll.bind
def clEnqueueUnmapMemObject(command_queue:cl_command_queue, memobj:cl_mem, mapped_ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clEnqueueNativeKernel(command_queue:cl_command_queue, user_func:ctypes.CFUNCTYPE(None, ctypes.c_void_p), args:ctypes.c_void_p, cb_args:size_t, num_mem_objects:cl_uint, mem_list:ctypes.POINTER(cl_mem), args_mem_loc:ctypes.POINTER(ctypes.c_void_p), num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clEnqueueSVMFree(command_queue:cl_command_queue, num_svm_pointers:cl_uint, svm_pointers:(ctypes.c_void_p * 0), pfn_free_func:ctypes.CFUNCTYPE(None, cl_command_queue, cl_uint, (ctypes.c_void_p * 0), ctypes.c_void_p), user_data:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueSVMMemcpy(command_queue:cl_command_queue, blocking_copy:cl_bool, dst_ptr:ctypes.c_void_p, src_ptr:ctypes.c_void_p, size:size_t, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueSVMMemFill(command_queue:cl_command_queue, svm_ptr:ctypes.c_void_p, pattern:ctypes.c_void_p, pattern_size:size_t, size:size_t, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueSVMMap(command_queue:cl_command_queue, blocking_map:cl_bool, flags:cl_map_flags, svm_ptr:ctypes.c_void_p, size:size_t, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueSVMUnmap(command_queue:cl_command_queue, svm_ptr:ctypes.c_void_p, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clEnqueueSVMMigrateMem(command_queue:cl_command_queue, num_svm_pointers:cl_uint, svm_pointers:ctypes.POINTER(ctypes.c_void_p), sizes:ctypes.POINTER(size_t), flags:cl_mem_migration_flags, num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
def clGetExtensionFunctionAddressForPlatform(platform:cl_platform_id, func_name:ctypes.POINTER(ctypes.c_char)) -> ctypes.c_void_p: ...
@dll.bind
def clCreateImage2D(context:cl_context, flags:cl_mem_flags, image_format:ctypes.POINTER(cl_image_format), image_width:size_t, image_height:size_t, image_row_pitch:size_t, host_ptr:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_mem: ...
@dll.bind
def clCreateImage3D(context:cl_context, flags:cl_mem_flags, image_format:ctypes.POINTER(cl_image_format), image_width:size_t, image_height:size_t, image_depth:size_t, image_row_pitch:size_t, image_slice_pitch:size_t, host_ptr:ctypes.c_void_p, errcode_ret:ctypes.POINTER(cl_int)) -> cl_mem: ...
@dll.bind
...
@dll.bind
def clGetExtensionFunctionAddress(func_name:ctypes.POINTER(ctypes.c_char)) -> ctypes.c_void_p: ...
@dll.bind
