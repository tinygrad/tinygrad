...
cl_properties = ctypes.c_ulong
cl_device_type = ctypes.c_ulong
cl_platform_info = ctypes.c_uint
cl_device_info = ctypes.c_uint
cl_device_fp_config = ctypes.c_ulong
cl_device_mem_cache_type = ctypes.c_uint
cl_device_local_mem_type = ctypes.c_uint
cl_device_exec_capabilities = ctypes.c_ulong
cl_device_svm_capabilities = ctypes.c_ulong
cl_command_queue_properties = ctypes.c_ulong
cl_device_partition_property = ctypes.c_long
cl_device_affinity_domain = ctypes.c_ulong
cl_context_properties = ctypes.c_long
cl_context_info = ctypes.c_uint
cl_queue_properties = ctypes.c_ulong
cl_command_queue_info = ctypes.c_uint
cl_channel_order = ctypes.c_uint
cl_channel_type = ctypes.c_uint
cl_mem_flags = ctypes.c_ulong
cl_svm_mem_flags = ctypes.c_ulong
cl_mem_object_type = ctypes.c_uint
cl_mem_info = ctypes.c_uint
cl_mem_migration_flags = ctypes.c_ulong
cl_image_info = ctypes.c_uint
cl_buffer_create_type = ctypes.c_uint
cl_addressing_mode = ctypes.c_uint
cl_filter_mode = ctypes.c_uint
cl_sampler_info = ctypes.c_uint
cl_map_flags = ctypes.c_ulong
cl_pipe_properties = ctypes.c_long
cl_pipe_info = ctypes.c_uint
cl_program_info = ctypes.c_uint
cl_program_build_info = ctypes.c_uint
cl_program_binary_type = ctypes.c_uint
cl_build_status = ctypes.c_int
cl_kernel_info = ctypes.c_uint
cl_kernel_arg_info = ctypes.c_uint
cl_kernel_arg_address_qualifier = ctypes.c_uint
cl_kernel_arg_access_qualifier = ctypes.c_uint
cl_kernel_arg_type_qualifier = ctypes.c_ulong
cl_kernel_work_group_info = ctypes.c_uint
cl_kernel_sub_group_info = ctypes.c_uint
cl_event_info = ctypes.c_uint
cl_command_type = ctypes.c_uint
cl_profiling_info = ctypes.c_uint
cl_sampler_properties = ctypes.c_ulong
cl_kernel_exec_info = ctypes.c_uint
cl_device_atomic_capabilities = ctypes.c_ulong
cl_device_device_enqueue_capabilities = ctypes.c_ulong
...
try: (clCreateContext:=dll.clCreateContext).restype,clCreateContext.argtypes = cl_context,[ctypes.POINTER(cl_context_properties), cl_uint, ctypes.POINTER(cl_device_id), ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_char_p, ctypes.c_void_p, size_t, ctypes.c_void_p)), ctypes.c_void_p, ctypes.POINTER(cl_int)]
except AttributeError: pass
...
try: (clCreateContextFromType:=dll.clCreateContextFromType).restype,clCreateContextFromType.argtypes = cl_context,[ctypes.POINTER(cl_context_properties), cl_device_type, ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_char_p, ctypes.c_void_p, size_t, ctypes.c_void_p)), ctypes.c_void_p, ctypes.POINTER(cl_int)]
except AttributeError: pass
...
try: (clSetContextDestructorCallback:=dll.clSetContextDestructorCallback).restype,clSetContextDestructorCallback.argtypes = cl_int,[cl_context, ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_context, ctypes.c_void_p)), ctypes.c_void_p]
except AttributeError: pass
...
try: (clSetMemObjectDestructorCallback:=dll.clSetMemObjectDestructorCallback).restype,clSetMemObjectDestructorCallback.argtypes = cl_int,[cl_mem, ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_mem, ctypes.c_void_p)), ctypes.c_void_p]
except AttributeError: pass
...
try: (clCreateProgramWithSource:=dll.clCreateProgramWithSource).restype,clCreateProgramWithSource.argtypes = cl_program,[cl_context, cl_uint, ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(size_t), ctypes.POINTER(cl_int)]
except AttributeError: pass
...
try: (clCreateProgramWithBinary:=dll.clCreateProgramWithBinary).restype,clCreateProgramWithBinary.argtypes = cl_program,[cl_context, cl_uint, ctypes.POINTER(cl_device_id), ctypes.POINTER(size_t), ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(cl_int), ctypes.POINTER(cl_int)]
except AttributeError: pass
...
try: (clCreateProgramWithBuiltInKernels:=dll.clCreateProgramWithBuiltInKernels).restype,clCreateProgramWithBuiltInKernels.argtypes = cl_program,[cl_context, cl_uint, ctypes.POINTER(cl_device_id), ctypes.c_char_p, ctypes.POINTER(cl_int)]
except AttributeError: pass
...
try: (clBuildProgram:=dll.clBuildProgram).restype,clBuildProgram.argtypes = cl_int,[cl_program, cl_uint, ctypes.POINTER(cl_device_id), ctypes.c_char_p, ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p)), ctypes.c_void_p]
except AttributeError: pass
...
try: (clCompileProgram:=dll.clCompileProgram).restype,clCompileProgram.argtypes = cl_int,[cl_program, cl_uint, ctypes.POINTER(cl_device_id), ctypes.c_char_p, cl_uint, ctypes.POINTER(cl_program), ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p)), ctypes.c_void_p]
except AttributeError: pass
...
try: (clLinkProgram:=dll.clLinkProgram).restype,clLinkProgram.argtypes = cl_program,[cl_context, cl_uint, ctypes.POINTER(cl_device_id), ctypes.c_char_p, cl_uint, ctypes.POINTER(cl_program), ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p)), ctypes.c_void_p, ctypes.POINTER(cl_int)]
except AttributeError: pass
...
try: (clSetProgramReleaseCallback:=dll.clSetProgramReleaseCallback).restype,clSetProgramReleaseCallback.argtypes = cl_int,[cl_program, ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_program, ctypes.c_void_p)), ctypes.c_void_p]
except AttributeError: pass
...
try: (clCreateKernel:=dll.clCreateKernel).restype,clCreateKernel.argtypes = cl_kernel,[cl_program, ctypes.c_char_p, ctypes.POINTER(cl_int)]
except AttributeError: pass
...
try: (clSetEventCallback:=dll.clSetEventCallback).restype,clSetEventCallback.argtypes = cl_int,[cl_event, cl_int, ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_event, cl_int, ctypes.c_void_p)), ctypes.c_void_p]
except AttributeError: pass
...
try: (clEnqueueNativeKernel:=dll.clEnqueueNativeKernel).restype,clEnqueueNativeKernel.argtypes = cl_int,[cl_command_queue, ctypes.POINTER(ctypes.CFUNCTYPE(None, ctypes.c_void_p)), ctypes.c_void_p, size_t, cl_uint, ctypes.POINTER(cl_mem), ctypes.POINTER(ctypes.c_void_p), cl_uint, ctypes.POINTER(cl_event), ctypes.POINTER(cl_event)]
except AttributeError: pass
...
try: (clEnqueueSVMFree:=dll.clEnqueueSVMFree).restype,clEnqueueSVMFree.argtypes = cl_int,[cl_command_queue, cl_uint, (ctypes.c_void_p * 0), ctypes.POINTER(ctypes.CFUNCTYPE(None, cl_command_queue, cl_uint, (ctypes.c_void_p * 0), ctypes.c_void_p)), ctypes.c_void_p, cl_uint, ctypes.POINTER(cl_event), ctypes.POINTER(cl_event)]
except AttributeError: pass
...
try: (clGetExtensionFunctionAddressForPlatform:=dll.clGetExtensionFunctionAddressForPlatform).restype,clGetExtensionFunctionAddressForPlatform.argtypes = ctypes.c_void_p,[cl_platform_id, ctypes.c_char_p]
except AttributeError: pass
...
try: (clGetExtensionFunctionAddress:=dll.clGetExtensionFunctionAddress).restype,clGetExtensionFunctionAddress.argtypes = ctypes.c_void_p,[ctypes.c_char_p]
except AttributeError: pass
