...
@dll.bind
def clCreateContext(properties:ctypes.POINTER(cl_context_properties), num_devices:cl_uint, devices:ctypes.POINTER(cl_device_id), pfn_notify:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(None), size_t, ctypes.POINTER(None)), user_data:ctypes.POINTER(None), errcode_ret:ctypes.POINTER(cl_int)) -> cl_context: ...
@dll.bind
def clCreateContextFromType(properties:ctypes.POINTER(cl_context_properties), device_type:cl_device_type, pfn_notify:ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(None), size_t, ctypes.POINTER(None)), user_data:ctypes.POINTER(None), errcode_ret:ctypes.POINTER(cl_int)) -> cl_context: ...
@dll.bind
...
@dll.bind
def clSetContextDestructorCallback(context:cl_context, pfn_notify:ctypes.CFUNCTYPE(None, cl_context, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clSetMemObjectDestructorCallback(memobj:cl_mem, pfn_notify:ctypes.CFUNCTYPE(None, cl_mem, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clBuildProgram(program:cl_program, num_devices:cl_uint, device_list:ctypes.POINTER(cl_device_id), options:ctypes.POINTER(ctypes.c_char), pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> cl_int: ...
@dll.bind
def clCompileProgram(program:cl_program, num_devices:cl_uint, device_list:ctypes.POINTER(cl_device_id), options:ctypes.POINTER(ctypes.c_char), num_input_headers:cl_uint, input_headers:ctypes.POINTER(cl_program), header_include_names:ctypes.POINTER(ctypes.POINTER(ctypes.c_char)), pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> cl_int: ...
@dll.bind
def clLinkProgram(context:cl_context, num_devices:cl_uint, device_list:ctypes.POINTER(cl_device_id), options:ctypes.POINTER(ctypes.c_char), num_input_programs:cl_uint, input_programs:ctypes.POINTER(cl_program), pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.POINTER(None)), user_data:ctypes.POINTER(None), errcode_ret:ctypes.POINTER(cl_int)) -> cl_program: ...
@dll.bind
def clSetProgramReleaseCallback(program:cl_program, pfn_notify:ctypes.CFUNCTYPE(None, cl_program, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clSetEventCallback(event:cl_event, command_exec_callback_type:cl_int, pfn_notify:ctypes.CFUNCTYPE(None, cl_event, cl_int, ctypes.POINTER(None)), user_data:ctypes.POINTER(None)) -> cl_int: ...
@dll.bind
...
@dll.bind
def clEnqueueNativeKernel(command_queue:cl_command_queue, user_func:ctypes.CFUNCTYPE(None, ctypes.POINTER(None)), args:ctypes.POINTER(None), cb_args:size_t, num_mem_objects:cl_uint, mem_list:ctypes.POINTER(cl_mem), args_mem_loc:ctypes.POINTER(ctypes.POINTER(None)), num_events_in_wait_list:cl_uint, event_wait_list:ctypes.POINTER(cl_event), event:ctypes.POINTER(cl_event)) -> cl_int: ...
@dll.bind
