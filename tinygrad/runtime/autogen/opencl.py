...
try:
    ...
    clGetPlatformIDs.argtypes = [
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_platform_id)),
...
try:
    ...
    clGetDeviceIDs.argtypes = [
        ...
        cl_device_type,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_device_id)),
        ctypes.POINTER(ctypes.c_uint32),
    ]
except AttributeError:
    pass
...
try:
    ...
    pass
try:
    clSetDefaultDeviceCommandQueue = _libraries[
        "libOpenCL.so.1"
    ].clSetDefaultDeviceCommandQueue
    clSetDefaultDeviceCommandQueue.restype = cl_int
    clSetDefaultDeviceCommandQueue.argtypes = [
        cl_context,
        cl_device_id,
        cl_command_queue,
    ]
...
try:
    ...
    clGetDeviceAndHostTimer.argtypes = [
        cl_device_id,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(ctypes.c_uint64),
    ]
...
try:
    ...
    clCreateContextFromType.argtypes = [
        ctypes.POINTER(ctypes.c_int64),
        cl_device_type,
        ctypes.CFUNCTYPE(
            None,
...
try:
    ...
    pass
try:
    clSetContextDestructorCallback = _libraries[
        "libOpenCL.so.1"
    ].clSetContextDestructorCallback
    clSetContextDestructorCallback.restype = cl_int
    clSetContextDestructorCallback.argtypes = [
        cl_context,
        ctypes.CFUNCTYPE(
            None, ctypes.POINTER(struct__cl_context), ctypes.POINTER(None)
        ),
        ctypes.POINTER(None),
    ]
except AttributeError:
    pass
try:
    clCreateCommandQueueWithProperties = _libraries[
        "libOpenCL.so.1"
    ].clCreateCommandQueueWithProperties
    clCreateCommandQueueWithProperties.restype = cl_command_queue
    clCreateCommandQueueWithProperties.argtypes = [
        cl_context,
        cl_device_id,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(ctypes.c_int32),
...
try:
    ...
    clGetCommandQueueInfo.argtypes = [
        cl_command_queue,
...
try:
    ...
    clCreateImage.argtypes = [
        cl_context,
        cl_mem_flags,
        ctypes.POINTER(struct__cl_image_format),
        ctypes.POINTER(struct__cl_image_desc),
        ctypes.POINTER(None),
        ctypes.POINTER(ctypes.c_int32),
    ]
except AttributeError:
...
try:
    ...
    pass
try:
    clCreateBufferWithProperties = _libraries[
        "libOpenCL.so.1"
    ].clCreateBufferWithProperties
    clCreateBufferWithProperties.restype = cl_mem
    clCreateBufferWithProperties.argtypes = [
        cl_context,
        ctypes.POINTER(ctypes.c_uint64),
        cl_mem_flags,
        size_t,
    ...
    pass
try:
    clCreateImageWithProperties = _libraries[
        "libOpenCL.so.1"
    ].clCreateImageWithProperties
    clCreateImageWithProperties.restype = cl_mem
    clCreateImageWithProperties.argtypes = [
        cl_context,
        ctypes.POINTER(ctypes.c_uint64),
        cl_mem_flags,
        ctypes.POINTER(struct__cl_image_format),
...
try:
    ...
    clGetSupportedImageFormats.argtypes = [
        cl_context,
        cl_mem_flags,
        cl_mem_object_type,
        cl_uint,
...
try:
    ...
    pass
try:
    clSetMemObjectDestructorCallback = _libraries[
        "libOpenCL.so.1"
    ].clSetMemObjectDestructorCallback
    clSetMemObjectDestructorCallback.restype = cl_int
    clSetMemObjectDestructorCallback.argtypes = [
        cl_mem,
        ctypes.CFUNCTYPE(None, ctypes.POINTER(struct__cl_mem), ctypes.POINTER(None)),
        ctypes.POINTER(None),
    ]
except AttributeError:
    pass
...
try:
    ...
    pass
try:
    clCreateSamplerWithProperties = _libraries[
        "libOpenCL.so.1"
    ].clCreateSamplerWithProperties
    clCreateSamplerWithProperties.restype = cl_sampler
    clCreateSamplerWithProperties.argtypes = [
        cl_context,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(ctypes.c_int32),
    ]
...
try:
    ...
    clCreateProgramWithSource.argtypes = [
        cl_context,
        cl_uint,
...
try:
    ...
    clCreateProgramWithBinary.argtypes = [
        cl_context,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_device_id)),
        ctypes.POINTER(ctypes.c_uint64),
    ...
    pass
try:
    clCreateProgramWithBuiltInKernels = _libraries[
        "libOpenCL.so.1"
    ].clCreateProgramWithBuiltInKernels
    clCreateProgramWithBuiltInKernels.restype = cl_program
    clCreateProgramWithBuiltInKernels.argtypes = [
        cl_context,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_device_id)),
        ctypes.POINTER(ctypes.c_char),
...
try:
    ...
    clCreateProgramWithIL.argtypes = [
        cl_context,
        ctypes.POINTER(None),
        size_t,
        ctypes.POINTER(ctypes.c_int32),
...
try:
    ...
    clBuildProgram.argtypes = [
        cl_program,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_device_id)),
        ctypes.POINTER(ctypes.c_char),
        ctypes.CFUNCTYPE(
            None, ctypes.POINTER(struct__cl_program), ctypes.POINTER(None)
        ),
        ctypes.POINTER(None),
    ]
except AttributeError:
...
try:
    ...
    clCompileProgram.argtypes = [
        cl_program,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_device_id)),
        ctypes.POINTER(ctypes.c_char),
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_program)),
        ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),
        ctypes.CFUNCTYPE(
            None, ctypes.POINTER(struct__cl_program), ctypes.POINTER(None)
        ),
...
try:
    ...
    pass
try:
    clSetProgramReleaseCallback = _libraries[
        "libOpenCL.so.1"
    ].clSetProgramReleaseCallback
    clSetProgramReleaseCallback.restype = cl_int
    clSetProgramReleaseCallback.argtypes = [
        cl_program,
        ctypes.CFUNCTYPE(
            None, ctypes.POINTER(struct__cl_program), ctypes.POINTER(None)
        ),
    ...
    pass
try:
    clSetProgramSpecializationConstant = _libraries[
        "libOpenCL.so.1"
    ].clSetProgramSpecializationConstant
    clSetProgramSpecializationConstant.restype = cl_int
    clSetProgramSpecializationConstant.argtypes = [
        cl_program,
        cl_uint,
        size_t,
        ctypes.POINTER(None),
...
try:
    ...
    clGetProgramBuildInfo.argtypes = [
        cl_program,
        cl_device_id,
...
try:
    ...
    clCreateKernelsInProgram.argtypes = [
        cl_program,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_kernel)),
        ctypes.POINTER(ctypes.c_uint32),
    ]
except AttributeError:
    pass
...
try:
    ...
    clGetKernelWorkGroupInfo.argtypes = [
        cl_kernel,
        cl_device_id,
...
try:
    ...
    clGetKernelSubGroupInfo.argtypes = [
        cl_kernel,
        cl_device_id,
...
try:
    ...
    clWaitForEvents.argtypes = [
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_event)),
    ]
except AttributeError:
    pass
try:
...
try:
    ...
    clSetEventCallback.argtypes = [
        cl_event,
        cl_int,
        ctypes.CFUNCTYPE(
            None, ctypes.POINTER(struct__cl_event), ctypes.c_int32, ctypes.POINTER(None)
        ),
        ctypes.POINTER(None),
    ]
except AttributeError:
...
try:
    ...
    clGetEventProfilingInfo.argtypes = [
        cl_event,
        cl_profiling_info,
        size_t,
        ctypes.POINTER(None),
...
try:
    ...
    clEnqueueReadBufferRect.argtypes = [
        cl_command_queue,
        cl_mem,
        cl_bool,
        ctypes.POINTER(ctypes.c_uint64),
...
try:
    ...
    clEnqueueWriteBufferRect.argtypes = [
        cl_command_queue,
        cl_mem,
        cl_bool,
        ctypes.POINTER(ctypes.c_uint64),
...
try:
    ...
    clEnqueueCopyBufferRect.argtypes = [
        cl_command_queue,
        cl_mem,
        cl_mem,
        ctypes.POINTER(ctypes.c_uint64),
...
try:
    ...
    clEnqueueCopyImageToBuffer.argtypes = [
        cl_command_queue,
        cl_mem,
        cl_mem,
        ctypes.POINTER(ctypes.c_uint64),
...
try:
    ...
    clEnqueueCopyBufferToImage.argtypes = [
        cl_command_queue,
        cl_mem,
        cl_mem,
        size_t,
...
try:
    ...
    clEnqueueUnmapMemObject.argtypes = [
        cl_command_queue,
        cl_mem,
        ctypes.POINTER(None),
        cl_uint,
...
try:
    ...
    clEnqueueMigrateMemObjects.argtypes = [
        cl_command_queue,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_mem)),
...
try:
    ...
    clEnqueueNativeKernel.argtypes = [
        cl_command_queue,
        ctypes.CFUNCTYPE(None, ctypes.POINTER(None)),
        ctypes.POINTER(None),
        size_t,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_mem)),
    ...
    pass
try:
    clEnqueueMarkerWithWaitList = _libraries[
        "libOpenCL.so.1"
    ].clEnqueueMarkerWithWaitList
    clEnqueueMarkerWithWaitList.restype = cl_int
    clEnqueueMarkerWithWaitList.argtypes = [
        cl_command_queue,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_event)),
        ctypes.POINTER(ctypes.POINTER(struct__cl_event)),
    ...
    pass
try:
    clEnqueueBarrierWithWaitList = _libraries[
        "libOpenCL.so.1"
    ].clEnqueueBarrierWithWaitList
    clEnqueueBarrierWithWaitList.restype = cl_int
    clEnqueueBarrierWithWaitList.argtypes = [
        cl_command_queue,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_event)),
        ctypes.POINTER(ctypes.POINTER(struct__cl_event)),
...
try:
    ...
    clEnqueueSVMFree.argtypes = [
        cl_command_queue,
        cl_uint,
        ctypes.POINTER(None) * 0,
        ctypes.CFUNCTYPE(
            None,
            ctypes.POINTER(struct__cl_command_queue),
            ctypes.c_uint32,
            ctypes.POINTER(ctypes.POINTER(None)),
            ctypes.POINTER(None),
        ),
...
try:
    ...
    clEnqueueSVMMigrateMem.argtypes = [
        cl_command_queue,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(ctypes.c_uint64),
    ...
    pass
try:
    clGetExtensionFunctionAddressForPlatform = _libraries[
        "libOpenCL.so.1"
    ].clGetExtensionFunctionAddressForPlatform
    clGetExtensionFunctionAddressForPlatform.restype = ctypes.POINTER(None)
    clGetExtensionFunctionAddressForPlatform.argtypes = [
        cl_platform_id,
        ctypes.POINTER(ctypes.c_char),
    ]
except AttributeError:
...
try:
    ...
    clEnqueueWaitForEvents.argtypes = [
        cl_command_queue,
        cl_uint,
        ctypes.POINTER(ctypes.POINTER(struct__cl_event)),
    ]
...
try:
    ...
    pass
try:
    clGetExtensionFunctionAddress = _libraries[
        "libOpenCL.so.1"
...
__all__ = [
    ...
    "cl_version",
    "size_t",
    "struct__cl_buffer_region",
    "struct__cl_command_queue",
    "struct__cl_context",
    "struct__cl_device_id",
    "struct__cl_event",
    "struct__cl_image_desc",
    "struct__cl_image_format",
    "struct__cl_kernel",
    "struct__cl_mem",
    "struct__cl_name_version",
    "struct__cl_platform_id",
    "struct__cl_program",
    "struct__cl_sampler",
    "union__cl_image_desc_0",
]
