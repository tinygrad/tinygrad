...
class struct_H265RawProfileTierLevel(c.Struct):
  ...
  general_profile_compatibility_flag: ctypes.Array[ctypes.c_ubyte]
  ...
  sub_layer_profile_present_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_level_present_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_profile_space: ctypes.Array[ctypes.c_ubyte]
  sub_layer_tier_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_profile_idc: ctypes.Array[ctypes.c_ubyte]
  sub_layer_profile_compatibility_flag: ctypes.Array[(ctypes.c_ubyte * 32)]
  sub_layer_progressive_source_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_interlaced_source_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_non_packed_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_frame_only_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_max_12bit_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_max_10bit_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_max_8bit_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_max_422chroma_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_max_420chroma_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_max_monochrome_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_intra_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_one_picture_only_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_lower_bit_rate_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_max_14bit_constraint_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_inbld_flag: ctypes.Array[ctypes.c_ubyte]
  sub_layer_level_idc: ctypes.Array[ctypes.c_ubyte]
...
class struct_H265RawSubLayerHRDParameters(c.Struct):
  SIZE = 544
  bit_rate_value_minus1: ctypes.Array[ctypes.c_uint32]
  cpb_size_value_minus1: ctypes.Array[ctypes.c_uint32]
  cpb_size_du_value_minus1: ctypes.Array[ctypes.c_uint32]
  bit_rate_du_value_minus1: ctypes.Array[ctypes.c_uint32]
  cbr_flag: ctypes.Array[ctypes.c_ubyte]
...
class struct_H265RawHRDParameters(c.Struct):
  ...
  fixed_pic_rate_general_flag: ctypes.Array[ctypes.c_ubyte]
  fixed_pic_rate_within_cvs_flag: ctypes.Array[ctypes.c_ubyte]
  elemental_duration_in_tc_minus1: ctypes.Array[ctypes.c_uint16]
  low_delay_hrd_flag: ctypes.Array[ctypes.c_ubyte]
  cpb_cnt_minus1: ctypes.Array[ctypes.c_ubyte]
  nal_sub_layer_hrd_parameters: ctypes.Array[struct_H265RawSubLayerHRDParameters]
  vcl_sub_layer_hrd_parameters: ctypes.Array[struct_H265RawSubLayerHRDParameters]
...
class struct_H265RawSTRefPicSet(c.Struct):
  ...
  used_by_curr_pic_flag: ctypes.Array[ctypes.c_ubyte]
  use_delta_flag: ctypes.Array[ctypes.c_ubyte]
  num_negative_pics: int
  num_positive_pics: int
  delta_poc_s0_minus1: ctypes.Array[ctypes.c_uint16]
  used_by_curr_pic_s0_flag: ctypes.Array[ctypes.c_ubyte]
  delta_poc_s1_minus1: ctypes.Array[ctypes.c_uint16]
  used_by_curr_pic_s1_flag: ctypes.Array[ctypes.c_ubyte]
...
class struct_H265RawScalingList(c.Struct):
  SIZE = 1632
  scaling_list_pred_mode_flag: ctypes.Array[(ctypes.c_ubyte * 6)]
  scaling_list_pred_matrix_id_delta: ctypes.Array[(ctypes.c_ubyte * 6)]
  scaling_list_dc_coef_minus8: ctypes.Array[(ctypes.c_int16 * 6)]
  scaling_list_delta_coeff: ctypes.Array[((ctypes.c_byte * 64) * 6)]
...
class struct_H265RawSliceHeader(c.Struct):
  ...
  slice_reserved_flag: ctypes.Array[ctypes.c_ubyte]
  slice_type: int
  pic_output_flag: int
  colour_plane_id: int
  ...
  lt_idx_sps: ctypes.Array[ctypes.c_ubyte]
  poc_lsb_lt: ctypes.Array[ctypes.c_ubyte]
  used_by_curr_pic_lt_flag: ctypes.Array[ctypes.c_ubyte]
  delta_poc_msb_present_flag: ctypes.Array[ctypes.c_ubyte]
  delta_poc_msb_cycle_lt: ctypes.Array[ctypes.c_uint32]
  ...
  list_entry_l0: ctypes.Array[ctypes.c_ubyte]
  ref_pic_list_modification_flag_l1: int
  list_entry_l1: ctypes.Array[ctypes.c_ubyte]
  ...
  luma_weight_l0_flag: ctypes.Array[ctypes.c_ubyte]
  chroma_weight_l0_flag: ctypes.Array[ctypes.c_ubyte]
  delta_luma_weight_l0: ctypes.Array[ctypes.c_byte]
  luma_offset_l0: ctypes.Array[ctypes.c_int16]
  delta_chroma_weight_l0: ctypes.Array[(ctypes.c_byte * 2)]
  chroma_offset_l0: ctypes.Array[(ctypes.c_int16 * 2)]
  luma_weight_l1_flag: ctypes.Array[ctypes.c_ubyte]
  chroma_weight_l1_flag: ctypes.Array[ctypes.c_ubyte]
  delta_luma_weight_l1: ctypes.Array[ctypes.c_byte]
  luma_offset_l1: ctypes.Array[ctypes.c_int16]
  delta_chroma_weight_l1: ctypes.Array[(ctypes.c_byte * 2)]
  chroma_offset_l1: ctypes.Array[(ctypes.c_int16 * 2)]
  ...
  entry_point_offset_minus1: ctypes.Array[ctypes.c_uint32]
  slice_segment_header_extension_length: int
  slice_segment_header_extension_data_byte: ctypes.Array[ctypes.c_ubyte]
...
class struct_H265RawSEIBufferingPeriod(c.Struct):
  ...
  nal_initial_cpb_removal_delay: ctypes.Array[ctypes.c_uint32]
  nal_initial_cpb_removal_offset: ctypes.Array[ctypes.c_uint32]
  nal_initial_alt_cpb_removal_delay: ctypes.Array[ctypes.c_uint32]
  nal_initial_alt_cpb_removal_offset: ctypes.Array[ctypes.c_uint32]
  vcl_initial_cpb_removal_delay: ctypes.Array[ctypes.c_uint32]
  vcl_initial_cpb_removal_offset: ctypes.Array[ctypes.c_uint32]
  vcl_initial_alt_cpb_removal_delay: ctypes.Array[ctypes.c_uint32]
  vcl_initial_alt_cpb_removal_offset: ctypes.Array[ctypes.c_uint32]
...
class struct_H265RawSEIPicTiming(c.Struct):
  ...
  num_nalus_in_du_minus1: ctypes.Array[ctypes.c_uint16]
  du_cpb_removal_delay_increment_minus1: ctypes.Array[ctypes.c_uint32]
...
class struct_H265RawSEIPanScanRect(c.Struct):
  ...
  pan_scan_rect_left_offset: ctypes.Array[ctypes.c_int32]
  pan_scan_rect_right_offset: ctypes.Array[ctypes.c_int32]
  pan_scan_rect_top_offset: ctypes.Array[ctypes.c_int32]
  pan_scan_rect_bottom_offset: ctypes.Array[ctypes.c_int32]
...
class struct_H265RawFilmGrainCharacteristics(c.Struct):
  ...
  comp_model_present_flag: ctypes.Array[ctypes.c_ubyte]
  num_intensity_intervals_minus1: ctypes.Array[ctypes.c_ubyte]
  num_model_values_minus1: ctypes.Array[ctypes.c_ubyte]
  intensity_interval_lower_bound: ctypes.Array[(ctypes.c_ubyte * 256)]
  intensity_interval_upper_bound: ctypes.Array[(ctypes.c_ubyte * 256)]
  comp_model_value: ctypes.Array[((ctypes.c_int16 * 6) * 256)]
...
class struct_H265RawSEIActiveParameterSets(c.Struct):
  ...
  active_seq_parameter_set_id: ctypes.Array[ctypes.c_ubyte]
  layer_sps_idx: ctypes.Array[ctypes.c_ubyte]
...
class struct_H265RawSEIDecodedPictureHash(c.Struct):
  SIZE = 68
  hash_type: int
  picture_md5: ctypes.Array[(ctypes.c_ubyte * 16)]
  picture_crc: ctypes.Array[ctypes.c_uint16]
  picture_checksum: ctypes.Array[ctypes.c_uint32]
...
class struct_H265RawSEITimeCode(c.Struct):
  SIZE = 60
  num_clock_ts: int
  clock_timestamp_flag: ctypes.Array[ctypes.c_ubyte]
  units_field_based_flag: ctypes.Array[ctypes.c_ubyte]
  counting_type: ctypes.Array[ctypes.c_ubyte]
  full_timestamp_flag: ctypes.Array[ctypes.c_ubyte]
  discontinuity_flag: ctypes.Array[ctypes.c_ubyte]
  cnt_dropped_flag: ctypes.Array[ctypes.c_ubyte]
  n_frames: ctypes.Array[ctypes.c_uint16]
  seconds_value: ctypes.Array[ctypes.c_ubyte]
  minutes_value: ctypes.Array[ctypes.c_ubyte]
  hours_value: ctypes.Array[ctypes.c_ubyte]
  seconds_flag: ctypes.Array[ctypes.c_ubyte]
  minutes_flag: ctypes.Array[ctypes.c_ubyte]
  hours_flag: ctypes.Array[ctypes.c_ubyte]
  time_offset_length: ctypes.Array[ctypes.c_ubyte]
  time_offset_value: ctypes.Array[ctypes.c_int32]
...
class struct_H265RawSEI3DReferenceDisplaysInfo(c.Struct):
  ...
  left_view_id: ctypes.Array[ctypes.c_uint16]
  right_view_id: ctypes.Array[ctypes.c_uint16]
  exponent_ref_display_width: ctypes.Array[ctypes.c_ubyte]
  mantissa_ref_display_width: ctypes.Array[ctypes.c_ubyte]
  exponent_ref_viewing_distance: ctypes.Array[ctypes.c_ubyte]
  mantissa_ref_viewing_distance: ctypes.Array[ctypes.c_ubyte]
  additional_shift_present_flag: ctypes.Array[ctypes.c_ubyte]
  num_sample_shift_plus512: ctypes.Array[ctypes.c_uint16]
...
class struct_SEIRawMessage(c.Struct):
  ...
  extension_data: ctypes._Pointer[ctypes.c_ubyte]
