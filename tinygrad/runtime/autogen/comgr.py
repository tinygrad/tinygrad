...
@dll.bind
def amd_comgr_action_info_set_options(action_info:amd_comgr_action_info_t, options:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
def amd_comgr_action_info_get_options(action_info:amd_comgr_action_info_t, size:POINTER(size_t), options:POINTER(Annotated[bytes, ctypes.c_char])) -> amd_comgr_status_t: ...
@dll.bind
