...
from tinygrad.renderer.isa import IselContext, PreRegAllocContext, Register
...
def insts_for_uop(u:UOp):
    ...
    match u.arg:
      ...
      case AMDOps.RECIPROCAL:
        ...
        # The raw reciprocal is already correct for 0/inf, where the refinement can produce NaN through 0*inf, so select it back.
