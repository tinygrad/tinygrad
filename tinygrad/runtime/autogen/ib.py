...
class enum_ibv_gid_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_node_type(ctypes.c_int32, c.Enum): pass
...
class enum_ibv_transport_type(ctypes.c_int32, c.Enum): pass
...
class enum_ibv_device_cap_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_fork_status(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_atomic_cap(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_dm_mask(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_device.register_fields([('_ops', struct__ibv_device_ops, 0), ('node_type', enum_ibv_node_type, 16), ('transport_type', enum_ibv_transport_type, 20), ('name', c.Array[ctypes.c_char, Literal[64]], 24), ('dev_name', c.Array[ctypes.c_char, Literal[64]], 88), ('dev_path', c.Array[ctypes.c_char, Literal[256]], 152), ('ibdev_path', c.Array[ctypes.c_char, Literal[256]], 408)])
@c.record
class struct_ibv_context_ops(c.Struct):
  ...
  alloc_mw: 'c.CFUNCTYPE[c.POINTER[struct_ibv_mw], [c.POINTER[struct_ibv_pd], enum_ibv_mw_type]]'
...
class enum_ibv_mw_type(ctypes.c_uint32, c.Enum): pass
IBV_MW_TYPE_1 = enum_ibv_mw_type.define('IBV_MW_TYPE_1', 1)
IBV_MW_TYPE_2 = enum_ibv_mw_type.define('IBV_MW_TYPE_2', 2)

struct_ibv_mw.register_fields([('context', c.POINTER[struct_ibv_context], 0), ('pd', c.POINTER[struct_ibv_pd], 8), ('rkey', uint32_t, 16), ('handle', uint32_t, 20), ('type', enum_ibv_mw_type, 24)])
@c.record
...
class enum_ibv_qp_state(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_qp_type(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_qp.register_fields([('context', c.POINTER[struct_ibv_context], 0), ('qp_context', ctypes.c_void_p, 8), ('pd', c.POINTER[struct_ibv_pd], 16), ('send_cq', c.POINTER[struct_ibv_cq], 24), ('recv_cq', c.POINTER[struct_ibv_cq], 32), ('srq', c.POINTER[struct_ibv_srq], 40), ('handle', uint32_t, 48), ('qp_num', uint32_t, 52), ('state', enum_ibv_qp_state, 56), ('qp_type', enum_ibv_qp_type, 60), ('mutex', pthread_mutex_t, 64), ('cond', pthread_cond_t, 104), ('events_completed', uint32_t, 152)])
@c.record
...
class enum_ibv_wc_status(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_wc_opcode(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_wc.register_fields([('wr_id', uint64_t, 0), ('status', enum_ibv_wc_status, 8), ('opcode', enum_ibv_wc_opcode, 12), ('vendor_err', uint32_t, 16), ('byte_len', uint32_t, 20), ('imm_data', ctypes.c_uint32, 24), ('invalidated_rkey', uint32_t, 24), ('qp_num', uint32_t, 28), ('src_qp', uint32_t, 32), ('wc_flags', ctypes.c_uint32, 36), ('pkey_index', uint16_t, 40), ('slid', uint16_t, 42), ('sl', uint8_t, 44), ('dlid_path_bits', uint8_t, 45)])
@c.record
...
class enum_ibv_wr_opcode(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_odp_transport_cap_bits(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_odp_general_caps(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_rx_hash_function_flags(ctypes.c_uint32, c.Enum): pass
IBV_RX_HASH_FUNC_TOEPLITZ = enum_ibv_rx_hash_function_flags.define('IBV_RX_HASH_FUNC_TOEPLITZ', 1)

class enum_ibv_rx_hash_fields(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_raw_packet_caps(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_tm_cap_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_pci_atomic_op_size(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_mtu(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_port_state(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_port_cap_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_port_cap_flags2(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_port_attr.register_fields([('state', enum_ibv_port_state, 0), ('max_mtu', enum_ibv_mtu, 4), ('active_mtu', enum_ibv_mtu, 8), ('gid_tbl_len', ctypes.c_int32, 12), ('port_cap_flags', uint32_t, 16), ('max_msg_sz', uint32_t, 20), ('bad_pkey_cntr', uint32_t, 24), ('qkey_viol_cntr', uint32_t, 28), ('pkey_tbl_len', uint16_t, 32), ('lid', uint16_t, 34), ('sm_lid', uint16_t, 36), ('lmc', uint8_t, 38), ('max_vl_num', uint8_t, 39), ('sm_sl', uint8_t, 40), ('subnet_timeout', uint8_t, 41), ('init_type_reply', uint8_t, 42), ('active_width', uint8_t, 43), ('active_speed', uint8_t, 44), ('phys_state', uint8_t, 45), ('link_layer', uint8_t, 46), ('flags', uint8_t, 47), ('port_cap_flags2', uint16_t, 48), ('active_speed_ex', uint32_t, 52)])
class enum_ibv_event_type(ctypes.c_uint32, c.Enum): pass
...
class struct_ibv_wq(c.Struct):
  ...
  events_completed: 'uint32_t'
  comp_mask: 'uint32_t'
class enum_ibv_wq_state(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_wq_type(ctypes.c_uint32, c.Enum): pass
IBV_WQT_RQ = enum_ibv_wq_type.define('IBV_WQT_RQ', 0)

struct_ibv_wq.register_fields([('context', c.POINTER[struct_ibv_context], 0), ('wq_context', ctypes.c_void_p, 8), ('pd', c.POINTER[struct_ibv_pd], 16), ('cq', c.POINTER[struct_ibv_cq], 24), ('wq_num', uint32_t, 32), ('handle', uint32_t, 36), ('state', enum_ibv_wq_state, 40), ('wq_type', enum_ibv_wq_type, 44), ('post_recv', c.CFUNCTYPE[ctypes.c_int32, [c.POINTER[struct_ibv_wq], c.POINTER[struct_ibv_recv_wr], c.POINTER[c.POINTER[struct_ibv_recv_wr]]]], 48), ('mutex', pthread_mutex_t, 56), ('cond', pthread_cond_t, 96), ('events_completed', uint32_t, 144), ('comp_mask', uint32_t, 148)])
...
struct_ibv_async_event.register_fields([('element', struct_ibv_async_event_element, 0), ('event_type', enum_ibv_event_type, 8)])
@dll.bind
def ibv_wc_status_str(status:enum_ibv_wc_status) -> c.POINTER[ctypes.c_char]: ...
class _anonenum1(ctypes.c_uint32, c.Enum): pass
IBV_WC_IP_CSUM_OK_SHIFT = _anonenum1.define('IBV_WC_IP_CSUM_OK_SHIFT', 2)

class enum_ibv_create_cq_wc_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_wc_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_access_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_xrcd_init_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_rereg_mr_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_rate(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_srq_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_srq_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_srq_init_attr_mask(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_srq_init_attr_ex.register_fields([('srq_context', ctypes.c_void_p, 0), ('attr', struct_ibv_srq_attr, 8), ('comp_mask', uint32_t, 20), ('srq_type', enum_ibv_srq_type, 24), ('pd', c.POINTER[struct_ibv_pd], 32), ('xrcd', c.POINTER[struct_ibv_xrcd], 40), ('cq', c.POINTER[struct_ibv_cq], 48), ('tm_cap', struct_ibv_tm_cap, 56)])
class enum_ibv_wq_init_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_wq_flags(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_wq_init_attr.register_fields([('wq_context', ctypes.c_void_p, 0), ('wq_type', enum_ibv_wq_type, 8), ('max_wr', uint32_t, 12), ('max_sge', uint32_t, 16), ('pd', c.POINTER[struct_ibv_pd], 24), ('cq', c.POINTER[struct_ibv_cq], 32), ('comp_mask', uint32_t, 40), ('create_flags', uint32_t, 44)])
class enum_ibv_wq_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class struct_ibv_wq_attr(c.Struct):
  ...
  flags: 'uint32_t'
  flags_mask: 'uint32_t'
struct_ibv_wq_attr.register_fields([('attr_mask', uint32_t, 0), ('wq_state', enum_ibv_wq_state, 4), ('curr_wq_state', enum_ibv_wq_state, 8), ('flags', uint32_t, 12), ('flags_mask', uint32_t, 16)])
@c.record
...
class enum_ibv_ind_table_init_attr_mask(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_qp_init_attr.register_fields([('qp_context', ctypes.c_void_p, 0), ('send_cq', c.POINTER[struct_ibv_cq], 8), ('recv_cq', c.POINTER[struct_ibv_cq], 16), ('srq', c.POINTER[struct_ibv_srq], 24), ('cap', struct_ibv_qp_cap, 32), ('qp_type', enum_ibv_qp_type, 52), ('sq_sig_all', ctypes.c_int32, 56)])
class enum_ibv_qp_init_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_qp_create_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_qp_create_send_ops_flags(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_qp_init_attr_ex.register_fields([('qp_context', ctypes.c_void_p, 0), ('send_cq', c.POINTER[struct_ibv_cq], 8), ('recv_cq', c.POINTER[struct_ibv_cq], 16), ('srq', c.POINTER[struct_ibv_srq], 24), ('cap', struct_ibv_qp_cap, 32), ('qp_type', enum_ibv_qp_type, 52), ('sq_sig_all', ctypes.c_int32, 56), ('comp_mask', uint32_t, 60), ('pd', c.POINTER[struct_ibv_pd], 64), ('xrcd', c.POINTER[struct_ibv_xrcd], 72), ('create_flags', uint32_t, 80), ('max_tso_header', uint16_t, 84), ('rwq_ind_tbl', c.POINTER[struct_ibv_rwq_ind_table], 88), ('rx_hash_conf', struct_ibv_rx_hash_conf, 96), ('source_qpn', uint32_t, 120), ('send_ops_flags', uint64_t, 128)])
class enum_ibv_qp_open_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class struct_ibv_qp_open_attr(c.Struct):
  ...
  qp_context: 'ctypes.c_void_p'
  qp_type: 'enum_ibv_qp_type'
struct_ibv_qp_open_attr.register_fields([('comp_mask', uint32_t, 0), ('qp_num', uint32_t, 4), ('xrcd', c.POINTER[struct_ibv_xrcd], 8), ('qp_context', ctypes.c_void_p, 16), ('qp_type', enum_ibv_qp_type, 24)])
class enum_ibv_qp_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_query_qp_data_in_order_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_query_qp_data_in_order_caps(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_mig_state(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def ibv_wr_opcode_str(opcode:enum_ibv_wr_opcode) -> c.POINTER[ctypes.c_char]: ...
class enum_ibv_send_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_placement_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_selectivity_level(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_ops_wr_opcode(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_ops_flags(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_ops_wr.register_fields([('wr_id', uint64_t, 0), ('next', c.POINTER[struct_ibv_ops_wr], 8), ('opcode', enum_ibv_ops_wr_opcode, 16), ('flags', ctypes.c_int32, 20), ('tm', struct_ibv_ops_wr_tm, 24)])
@c.record
...
class struct_ibv_cq_ex(c.Struct):
  ...
  read_opcode: 'c.CFUNCTYPE[enum_ibv_wc_opcode, [c.POINTER[struct_ibv_cq_ex]]]'
...
class enum_ibv_flow_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_flow_attr_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_flow_spec_type(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_flow_spec_eth.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_eth_filter, 6), ('mask', struct_ibv_flow_eth_filter, 22)])
@c.record
...
struct_ibv_flow_spec_ipv4.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_ipv4_filter, 8), ('mask', struct_ibv_flow_ipv4_filter, 16)])
@c.record
...
struct_ibv_flow_spec_ipv4_ext.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_ipv4_ext_filter, 8), ('mask', struct_ibv_flow_ipv4_ext_filter, 20)])
@c.record
...
struct_ibv_flow_spec_ipv6.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_ipv6_filter, 8), ('mask', struct_ibv_flow_ipv6_filter, 48)])
@c.record
...
struct_ibv_flow_spec_esp.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_esp_filter, 8), ('mask', struct_ibv_flow_esp_filter, 16)])
@c.record
...
struct_ibv_flow_spec_tcp_udp.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_tcp_udp_filter, 6), ('mask', struct_ibv_flow_tcp_udp_filter, 10)])
@c.record
...
struct_ibv_flow_spec_gre.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_gre_filter, 8), ('mask', struct_ibv_flow_gre_filter, 16)])
@c.record
...
struct_ibv_flow_spec_mpls.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_mpls_filter, 8), ('mask', struct_ibv_flow_mpls_filter, 12)])
@c.record
...
struct_ibv_flow_spec_tunnel.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('val', struct_ibv_flow_tunnel_filter, 8), ('mask', struct_ibv_flow_tunnel_filter, 12)])
@c.record
class struct_ibv_flow_spec_action_tag(c.Struct):
  ...
  size: 'uint16_t'
  tag_id: 'uint32_t'
struct_ibv_flow_spec_action_tag.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('tag_id', uint32_t, 8)])
@c.record
class struct_ibv_flow_spec_action_drop(c.Struct):
  SIZE = 8
  type: 'enum_ibv_flow_spec_type'
  size: 'uint16_t'
struct_ibv_flow_spec_action_drop.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4)])
@c.record
...
struct_ibv_flow_spec_action_handle.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('action', c.POINTER[struct_ibv_flow_action], 8)])
@c.record
...
struct_ibv_flow_spec_counter_action.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4), ('counters', c.POINTER[struct_ibv_counters], 8)])
@c.record
...
class struct_ibv_flow_spec_hdr(c.Struct):
  ...
  type: 'enum_ibv_flow_spec_type'
  size: 'uint16_t'
struct_ibv_flow_spec_hdr.register_fields([('type', enum_ibv_flow_spec_type, 0), ('size', uint16_t, 4)])
...
class struct_ibv_flow_attr(c.Struct):
  ...
  port: 'uint8_t'
  flags: 'uint32_t'
struct_ibv_flow_attr.register_fields([('comp_mask', uint32_t, 0), ('type', enum_ibv_flow_attr_type, 4), ('size', uint16_t, 8), ('priority', uint16_t, 10), ('num_of_specs', uint8_t, 12), ('port', uint8_t, 13), ('flags', uint32_t, 16)])
@c.record
...
class enum_ibv_flow_action_esp_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_flow_action_esp_keymat(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_flow_action_esp_replay(ctypes.c_uint32, c.Enum): pass
...
struct_ibv_flow_action_esp_attr.register_fields([('esp_attr', c.POINTER[struct_ib_uverbs_flow_action_esp], 0), ('keymat_proto', enum_ib_uverbs_flow_action_esp_keymat, 8), ('keymat_len', uint16_t, 12), ('keymat_ptr', ctypes.c_void_p, 16), ('replay_proto', enum_ib_uverbs_flow_action_esp_replay, 24), ('replay_len', uint16_t, 28), ('replay_ptr', ctypes.c_void_p, 32), ('esp_encap', c.POINTER[struct_ib_uverbs_flow_action_esp_encap], 40), ('comp_mask', uint32_t, 48), ('esn', uint32_t, 52)])
...
class enum_ibv_cq_init_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_create_cq_attr_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_parent_domain_init_attr_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_counter_description(ctypes.c_uint32, c.Enum): pass
...
class struct_ibv_counter_attach_attr(c.Struct):
  ...
  index: 'uint32_t'
  comp_mask: 'uint32_t'
struct_ibv_counter_attach_attr.register_fields([('counter_desc', enum_ibv_counter_description, 0), ('index', uint32_t, 4), ('comp_mask', uint32_t, 8)])
class enum_ibv_read_counters_flags(ctypes.c_uint32, c.Enum): pass
IBV_READ_COUNTERS_ATTR_PREFER_CACHED = enum_ibv_read_counters_flags.define('IBV_READ_COUNTERS_ATTR_PREFER_CACHED', 1)

class enum_ibv_values_mask(ctypes.c_uint32, c.Enum): pass
...
class struct_verbs_context(c.Struct):
  ...
  advise_mr: 'c.CFUNCTYPE[ctypes.c_int32, [c.POINTER[struct_ibv_pd], enum_ib_uverbs_advise_mr_advice, uint32_t, c.POINTER[struct_ibv_sge], uint32_t]]'
...
class enum_ib_uverbs_advise_mr_advice(ctypes.c_uint32, c.Enum): pass
...
class enum_ibv_rereg_mr_err_code(ctypes.c_int32, c.Enum): pass
...
@dll.bind
def ibv_query_qp_data_in_order(qp:c.POINTER[struct_ibv_qp], op:enum_ibv_wr_opcode, flags:uint32_t) -> ctypes.c_int32: ...
@dll.bind
...
@dll.bind
def ibv_node_type_str(node_type:enum_ibv_node_type) -> c.POINTER[ctypes.c_char]: ...
@dll.bind
def ibv_port_state_str(port_state:enum_ibv_port_state) -> c.POINTER[ctypes.c_char]: ...
@dll.bind
def ibv_event_type_str(event:enum_ibv_event_type) -> c.POINTER[ctypes.c_char]: ...
@dll.bind
...
class enum_ib_uverbs_core_support(ctypes.c_uint32, c.Enum): pass
IB_UVERBS_CORE_SUPPORT_OPTIONAL_MR_ACCESS = enum_ib_uverbs_core_support.define('IB_UVERBS_CORE_SUPPORT_OPTIONAL_MR_ACCESS', 1)

class enum_ib_uverbs_access_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_srq_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_wq_type(ctypes.c_uint32, c.Enum): pass
IB_UVERBS_WQT_RQ = enum_ib_uverbs_wq_type.define('IB_UVERBS_WQT_RQ', 0)

class enum_ib_uverbs_wq_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_qp_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_qp_create_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_query_port_cap_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_query_port_flags(ctypes.c_uint32, c.Enum): pass
IB_UVERBS_QPF_GRH_REQUIRED = enum_ib_uverbs_query_port_flags.define('IB_UVERBS_QPF_GRH_REQUIRED', 1)

class enum_ib_uverbs_flow_action_esp_keymat_aes_gcm_iv_algo(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_flow_action_esp_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_read_counters_flags(ctypes.c_uint32, c.Enum): pass
IB_UVERBS_READ_COUNTERS_PREFER_CACHED = enum_ib_uverbs_read_counters_flags.define('IB_UVERBS_READ_COUNTERS_PREFER_CACHED', 1)

class enum_ib_uverbs_advise_mr_flag(ctypes.c_uint32, c.Enum): pass
...
class enum_rdma_driver_id(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_gid_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_write_cmds(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_placement_type(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_selectivity_level(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_ex_create_cq_flags(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_wc_opcode(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_create_qp_mask(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_wr_opcode(ctypes.c_uint32, c.Enum): pass
...
class enum_ib_uverbs_device_cap_flags(ctypes.c_uint64, c.Enum): pass
...
class enum_ib_uverbs_raw_packet_caps(ctypes.c_uint32, c.Enum): pass
