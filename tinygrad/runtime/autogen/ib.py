...
class _anonstruct0:
  SIZE = 16
  subnet_prefix: Annotated[ctypes.c_uint64, 0]
  interface_id: Annotated[ctypes.c_uint64, 8]
...
@record
class struct_ibv_alloc_dm_attr:
  SIZE = 16
...
class struct_ibv_device:
  ...
  name: Annotated[Array[ctypes.c_char, Literal[64]], 24]
  dev_name: Annotated[Array[ctypes.c_char, Literal[64]], 88]
  dev_path: Annotated[Array[ctypes.c_char, Literal[256]], 152]
  ibdev_path: Annotated[Array[ctypes.c_char, Literal[256]], 408]
@record
...
class struct_ibv_device_attr:
  SIZE = 232
  fw_ver: Annotated[Array[ctypes.c_char, Literal[64]], 0]
  node_guid: Annotated[ctypes.c_uint64, 64]
  sys_image_guid: Annotated[ctypes.c_uint64, 72]
  ...
  max_qp: Annotated[ctypes.c_int32, 108]
  max_qp_wr: Annotated[ctypes.c_int32, 112]
  device_cap_flags: Annotated[ctypes.c_uint32, 116]
  max_sge: Annotated[ctypes.c_int32, 120]
  max_sge_rd: Annotated[ctypes.c_int32, 124]
  max_cq: Annotated[ctypes.c_int32, 128]
  max_cqe: Annotated[ctypes.c_int32, 132]
  max_mr: Annotated[ctypes.c_int32, 136]
  max_pd: Annotated[ctypes.c_int32, 140]
  max_qp_rd_atom: Annotated[ctypes.c_int32, 144]
  max_ee_rd_atom: Annotated[ctypes.c_int32, 148]
  max_res_rd_atom: Annotated[ctypes.c_int32, 152]
  max_qp_init_rd_atom: Annotated[ctypes.c_int32, 156]
  max_ee_init_rd_atom: Annotated[ctypes.c_int32, 160]
  atomic_cap: Annotated[enum_ibv_atomic_cap, 164]
  max_ee: Annotated[ctypes.c_int32, 168]
  max_rdd: Annotated[ctypes.c_int32, 172]
  max_mw: Annotated[ctypes.c_int32, 176]
  max_raw_ipv6_qp: Annotated[ctypes.c_int32, 180]
  max_raw_ethy_qp: Annotated[ctypes.c_int32, 184]
  max_mcast_grp: Annotated[ctypes.c_int32, 188]
  max_mcast_qp_attach: Annotated[ctypes.c_int32, 192]
  max_total_mcast_qp_attach: Annotated[ctypes.c_int32, 196]
  max_ah: Annotated[ctypes.c_int32, 200]
  max_fmr: Annotated[ctypes.c_int32, 204]
  max_map_per_fmr: Annotated[ctypes.c_int32, 208]
  max_srq: Annotated[ctypes.c_int32, 212]
  max_srq_wr: Annotated[ctypes.c_int32, 216]
  max_srq_sge: Annotated[ctypes.c_int32, 220]
...
class pthread_cond_t:
  ...
  __size: Annotated[Array[ctypes.c_char, Literal[48]], 0]
  __align: Annotated[ctypes.c_int64, 0]
@record
class struct___pthread_cond_s:
  ...
  __g_refs: Annotated[Array[ctypes.c_uint32, Literal[2]], 16]
  __g_size: Annotated[Array[ctypes.c_uint32, Literal[2]], 24]
  __g1_orig_size: Annotated[ctypes.c_uint32, 32]
  __wrefs: Annotated[ctypes.c_uint32, 36]
  __g_signals: Annotated[Array[ctypes.c_uint32, Literal[2]], 40]
@record
...
@record
class struct_ibv_packet_pacing_caps:
  SIZE = 12
...
@record
class struct_ibv_cq_moderation_caps:
  SIZE = 4
...
@record
class struct_ibv_xrcd_init_attr:
  SIZE = 12
  comp_mask: Annotated[uint32_t, 0]
  fd: Annotated[ctypes.c_int32, 4]
  oflags: Annotated[ctypes.c_int32, 8]
@record
class struct_ibv_xrcd:
  SIZE = 8
  context: Annotated[ctypes.POINTER(struct_ibv_context), 0]
...
@record
class struct_ibv_grh:
  SIZE = 40
  version_tclass_flow: Annotated[ctypes.c_uint32, 0]
  paylen: Annotated[ctypes.c_uint16, 4]
...
@dll.bind
def ibv_rate_to_mult(rate:enum_ibv_rate) -> ctypes.c_int32: ...
@dll.bind
def mult_to_ibv_rate(mult:ctypes.c_int32) -> enum_ibv_rate: ...
@dll.bind
def ibv_rate_to_mbps(rate:enum_ibv_rate) -> ctypes.c_int32: ...
@dll.bind
def mbps_to_ibv_rate(mbps:ctypes.c_int32) -> enum_ibv_rate: ...
@record
class struct_ibv_ah_attr:
  SIZE = 32
...
@record
class struct_ibv_srq_attr:
  SIZE = 12
  max_wr: Annotated[uint32_t, 0]
  max_sge: Annotated[uint32_t, 4]
  srq_limit: Annotated[uint32_t, 8]
@record
class struct_ibv_srq_init_attr:
  SIZE = 24
  srq_context: Annotated[ctypes.POINTER(None), 0]
...
@record
class struct_ibv_tm_cap:
  SIZE = 8
  max_num_tags: Annotated[uint32_t, 0]
  max_ops: Annotated[uint32_t, 4]
@record
class struct_ibv_srq_init_attr_ex:
  SIZE = 64
  srq_context: Annotated[ctypes.POINTER(None), 0]
  attr: Annotated[struct_ibv_srq_attr, 8]
  comp_mask: Annotated[uint32_t, 20]
  srq_type: Annotated[enum_ibv_srq_type, 24]
  pd: Annotated[ctypes.POINTER(struct_ibv_pd), 32]
  xrcd: Annotated[ctypes.POINTER(struct_ibv_xrcd), 40]
  cq: Annotated[ctypes.POINTER(struct_ibv_cq), 48]
...
@record
class struct_ibv_wq_init_attr:
  SIZE = 48
  wq_context: Annotated[ctypes.POINTER(None), 0]
  wq_type: Annotated[enum_ibv_wq_type, 8]
  max_wr: Annotated[uint32_t, 12]
  max_sge: Annotated[uint32_t, 16]
  pd: Annotated[ctypes.POINTER(struct_ibv_pd), 24]
  cq: Annotated[ctypes.POINTER(struct_ibv_cq), 32]
...
@record
class struct_ibv_rwq_ind_table:
  SIZE = 24
  context: Annotated[ctypes.POINTER(struct_ibv_context), 0]
  ind_tbl_handle: Annotated[ctypes.c_int32, 8]
  ind_tbl_num: Annotated[ctypes.c_int32, 12]
...
@record
class struct_ibv_rwq_ind_table_init_attr:
  SIZE = 24
  log_ind_tbl_size: Annotated[uint32_t, 0]
  ind_tbl: Annotated[ctypes.POINTER(ctypes.POINTER(struct_ibv_wq)), 8]
  comp_mask: Annotated[uint32_t, 16]
@record
class struct_ibv_qp_cap:
  SIZE = 20
...
@record
class struct_ibv_qp_init_attr:
  SIZE = 64
  qp_context: Annotated[ctypes.POINTER(None), 0]
  send_cq: Annotated[ctypes.POINTER(struct_ibv_cq), 8]
  recv_cq: Annotated[ctypes.POINTER(struct_ibv_cq), 16]
  srq: Annotated[ctypes.POINTER(struct_ibv_srq), 24]
  cap: Annotated[struct_ibv_qp_cap, 32]
  qp_type: Annotated[enum_ibv_qp_type, 52]
  sq_sig_all: Annotated[ctypes.c_int32, 56]
...
@record
class struct_ibv_rx_hash_conf:
  SIZE = 24
  rx_hash_function: Annotated[uint8_t, 0]
  rx_hash_key_len: Annotated[uint8_t, 1]
  rx_hash_key: Annotated[ctypes.POINTER(uint8_t), 8]
  rx_hash_fields_mask: Annotated[uint64_t, 16]
@record
class struct_ibv_qp_init_attr_ex:
  SIZE = 136
  qp_context: Annotated[ctypes.POINTER(None), 0]
  send_cq: Annotated[ctypes.POINTER(struct_ibv_cq), 8]
  recv_cq: Annotated[ctypes.POINTER(struct_ibv_cq), 16]
  ...
  pd: Annotated[ctypes.POINTER(struct_ibv_pd), 64]
  xrcd: Annotated[ctypes.POINTER(struct_ibv_xrcd), 72]
  create_flags: Annotated[uint32_t, 80]
  max_tso_header: Annotated[uint16_t, 84]
  rwq_ind_tbl: Annotated[ctypes.POINTER(struct_ibv_rwq_ind_table), 88]
...
@record
class struct_ibv_qp_open_attr:
  SIZE = 32
  comp_mask: Annotated[uint32_t, 0]
  qp_num: Annotated[uint32_t, 4]
  xrcd: Annotated[ctypes.POINTER(struct_ibv_xrcd), 8]
  qp_context: Annotated[ctypes.POINTER(None), 16]
...
class struct_ibv_qp_attr:
  ...
  qp_access_flags: Annotated[ctypes.c_uint32, 32]
...
@record
class struct_ibv_qp_rate_limit_attr:
  SIZE = 16
...
@record
class struct_ibv_ops_wr:
  SIZE = 72
  wr_id: Annotated[uint64_t, 0]
  next: Annotated[ctypes.POINTER(struct_ibv_ops_wr), 8]
  opcode: Annotated[enum_ibv_ops_wr_opcode, 16]
  flags: Annotated[ctypes.c_int32, 20]
...
class _anonstruct17:
  ...
  sg_list: Annotated[ctypes.POINTER(struct_ibv_sge), 8]
  num_sge: Annotated[ctypes.c_int32, 16]
...
@record
class struct_ibv_moderate_cq:
  SIZE = 4
  cq_count: Annotated[uint16_t, 0]
  cq_period: Annotated[uint16_t, 2]
@record
class struct_ibv_modify_cq_attr:
  SIZE = 8
  attr_mask: Annotated[uint32_t, 0]
...
@record
class struct_ibv_flow_eth_filter:
  SIZE = 16
  dst_mac: Annotated[Array[uint8_t, Literal[6]], 0]
  src_mac: Annotated[Array[uint8_t, Literal[6]], 6]
  ether_type: Annotated[uint16_t, 12]
  vlan_tag: Annotated[uint16_t, 14]
@record
class struct_ibv_flow_spec_eth:
  SIZE = 40
...
@record
class struct_ibv_flow_ipv4_filter:
  SIZE = 8
  src_ip: Annotated[uint32_t, 0]
  dst_ip: Annotated[uint32_t, 4]
@record
class struct_ibv_flow_spec_ipv4:
  SIZE = 24
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
...
@record
class struct_ibv_flow_ipv4_ext_filter:
  SIZE = 12
  src_ip: Annotated[uint32_t, 0]
  dst_ip: Annotated[uint32_t, 4]
...
@record
class struct_ibv_flow_spec_ipv4_ext:
  SIZE = 32
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
...
@record
class struct_ibv_flow_ipv6_filter:
  SIZE = 40
  src_ip: Annotated[Array[uint8_t, Literal[16]], 0]
  dst_ip: Annotated[Array[uint8_t, Literal[16]], 16]
...
@record
class struct_ibv_flow_spec_ipv6:
  SIZE = 88
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
...
@record
class struct_ibv_flow_esp_filter:
  SIZE = 8
  spi: Annotated[uint32_t, 0]
  seq: Annotated[uint32_t, 4]
@record
class struct_ibv_flow_spec_esp:
  SIZE = 24
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
...
@record
class struct_ibv_flow_tcp_udp_filter:
  SIZE = 4
  dst_port: Annotated[uint16_t, 0]
  src_port: Annotated[uint16_t, 2]
@record
class struct_ibv_flow_spec_tcp_udp:
  SIZE = 16
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
...
@record
class struct_ibv_flow_mpls_filter:
  SIZE = 4
  label: Annotated[uint32_t, 0]
@record
class struct_ibv_flow_spec_mpls:
  SIZE = 16
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
...
@record
class struct_ibv_flow_tunnel_filter:
  SIZE = 4
  tunnel_id: Annotated[uint32_t, 0]
@record
class struct_ibv_flow_spec_tunnel:
  SIZE = 16
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
...
@record
class struct_ibv_flow_spec_action_tag:
  SIZE = 12
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
  tag_id: Annotated[uint32_t, 8]
@record
class struct_ibv_flow_spec_action_drop:
  SIZE = 8
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
@record
class struct_ibv_flow_spec_action_handle:
  SIZE = 16
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
  action: Annotated[ctypes.POINTER(struct_ibv_flow_action), 8]
@record
class struct_ibv_flow_action:
  SIZE = 8
  context: Annotated[ctypes.POINTER(struct_ibv_context), 0]
@record
class struct_ibv_flow_spec_counter_action:
  SIZE = 16
  type: Annotated[enum_ibv_flow_spec_type, 0]
  size: Annotated[uint16_t, 4]
  counters: Annotated[ctypes.POINTER(struct_ibv_counters), 8]
@record
class struct_ibv_counters:
  SIZE = 8
  context: Annotated[ctypes.POINTER(struct_ibv_context), 0]
@record
class struct_ibv_flow_spec:
  SIZE = 88
...
@record
class struct_ibv_flow:
  SIZE = 24
  comp_mask: Annotated[uint32_t, 0]
  context: Annotated[ctypes.POINTER(struct_ibv_context), 8]
  handle: Annotated[uint32_t, 16]
...
@record
class struct_ibv_flow_action_esp_attr:
  SIZE = 56
  esp_attr: Annotated[ctypes.POINTER(struct_ib_uverbs_flow_action_esp), 0]
  keymat_proto: Annotated[enum_ib_uverbs_flow_action_esp_keymat, 8]
  keymat_len: Annotated[uint16_t, 12]
  keymat_ptr: Annotated[ctypes.POINTER(None), 16]
  replay_proto: Annotated[enum_ib_uverbs_flow_action_esp_replay, 24]
  replay_len: Annotated[uint16_t, 28]
  replay_ptr: Annotated[ctypes.POINTER(None), 32]
  esp_encap: Annotated[ctypes.POINTER(struct_ib_uverbs_flow_action_esp_encap), 40]
  comp_mask: Annotated[uint32_t, 48]
  esn: Annotated[uint32_t, 52]
@record
class struct_ib_uverbs_flow_action_esp:
  SIZE = 24
  spi: Annotated[ctypes.c_uint32, 0]
  seq: Annotated[ctypes.c_uint32, 4]
  tfc_pad: Annotated[ctypes.c_uint32, 8]
  flags: Annotated[ctypes.c_uint32, 12]
  hard_limit_pkts: Annotated[ctypes.c_uint64, 16]
...
@record
class struct_ib_uverbs_flow_action_esp_encap:
  SIZE = 24
  val_ptr: Annotated[ctypes.POINTER(None), 0]
  val_ptr_data_u64: Annotated[ctypes.c_uint64, 0]
  next_ptr: Annotated[ctypes.POINTER(struct_ib_uverbs_flow_action_esp_encap), 8]
  next_ptr_data_u64: Annotated[ctypes.c_uint64, 8]
  len: Annotated[ctypes.c_uint16, 16]
  type: Annotated[ctypes.c_uint16, 18]
...
@record
class struct_ibv_cq_init_attr_ex:
  SIZE = 56
  cqe: Annotated[uint32_t, 0]
  cq_context: Annotated[ctypes.POINTER(None), 8]
  channel: Annotated[ctypes.POINTER(struct_ibv_comp_channel), 16]
  comp_vector: Annotated[uint32_t, 24]
  wc_flags: Annotated[uint64_t, 32]
  comp_mask: Annotated[uint32_t, 40]
  flags: Annotated[uint32_t, 44]
  parent_domain: Annotated[ctypes.POINTER(struct_ibv_pd), 48]
...
@record
class struct_ibv_counter_attach_attr:
  SIZE = 12
...
@record
class struct_ibv_values_ex:
  SIZE = 24
  comp_mask: Annotated[uint32_t, 0]
  raw_clock: Annotated[struct_timespec, 8]
@record
class struct_timespec:
  SIZE = 16
...
@dll.bind
def ibv_free_device_list(list:ctypes.POINTER(ctypes.POINTER(struct_ibv_device))) -> None: ...
@dll.bind
def ibv_get_device_name(device:ctypes.POINTER(struct_ibv_device)) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
def ibv_get_device_index(device:ctypes.POINTER(struct_ibv_device)) -> ctypes.c_int32: ...
@dll.bind
def ibv_get_device_guid(device:ctypes.POINTER(struct_ibv_device)) -> ctypes.c_uint64: ...
@dll.bind
def ibv_open_device(device:ctypes.POINTER(struct_ibv_device)) -> ctypes.POINTER(struct_ibv_context): ...
@dll.bind
def ibv_close_device(context:ctypes.POINTER(struct_ibv_context)) -> ctypes.c_int32: ...
@dll.bind
def ibv_import_device(cmd_fd:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_context): ...
@dll.bind
def ibv_import_pd(context:ctypes.POINTER(struct_ibv_context), pd_handle:uint32_t) -> ctypes.POINTER(struct_ibv_pd): ...
@dll.bind
def ibv_unimport_pd(pd:ctypes.POINTER(struct_ibv_pd)) -> None: ...
@dll.bind
def ibv_import_mr(pd:ctypes.POINTER(struct_ibv_pd), mr_handle:uint32_t) -> ctypes.POINTER(struct_ibv_mr): ...
@dll.bind
def ibv_unimport_mr(mr:ctypes.POINTER(struct_ibv_mr)) -> None: ...
@dll.bind
def ibv_import_dm(context:ctypes.POINTER(struct_ibv_context), dm_handle:uint32_t) -> ctypes.POINTER(struct_ibv_dm): ...
@dll.bind
def ibv_unimport_dm(dm:ctypes.POINTER(struct_ibv_dm)) -> None: ...
@dll.bind
def ibv_get_async_event(context:ctypes.POINTER(struct_ibv_context), event:ctypes.POINTER(struct_ibv_async_event)) -> ctypes.c_int32: ...
@dll.bind
def ibv_ack_async_event(event:ctypes.POINTER(struct_ibv_async_event)) -> None: ...
@dll.bind
def ibv_query_device(context:ctypes.POINTER(struct_ibv_context), device_attr:ctypes.POINTER(struct_ibv_device_attr)) -> ctypes.c_int32: ...
@dll.bind
def ibv_query_port(context:ctypes.POINTER(struct_ibv_context), port_num:uint8_t, port_attr:ctypes.POINTER(struct__compat_ibv_port_attr)) -> ctypes.c_int32: ...
@dll.bind
def ibv_query_gid(context:ctypes.POINTER(struct_ibv_context), port_num:uint8_t, index:ctypes.c_int32, gid:ctypes.POINTER(union_ibv_gid)) -> ctypes.c_int32: ...
@dll.bind
def _ibv_query_gid_ex(context:ctypes.POINTER(struct_ibv_context), port_num:uint32_t, gid_index:uint32_t, entry:ctypes.POINTER(struct_ibv_gid_entry), flags:uint32_t, entry_size:size_t) -> ctypes.c_int32: ...
ssize_t = ctypes.c_int64
@dll.bind
def _ibv_query_gid_table(context:ctypes.POINTER(struct_ibv_context), entries:ctypes.POINTER(struct_ibv_gid_entry), max_entries:size_t, flags:uint32_t, entry_size:size_t) -> ssize_t: ...
@dll.bind
def ibv_query_pkey(context:ctypes.POINTER(struct_ibv_context), port_num:uint8_t, index:ctypes.c_int32, pkey:ctypes.POINTER(ctypes.c_uint16)) -> ctypes.c_int32: ...
@dll.bind
def ibv_get_pkey_index(context:ctypes.POINTER(struct_ibv_context), port_num:uint8_t, pkey:ctypes.c_uint16) -> ctypes.c_int32: ...
@dll.bind
def ibv_alloc_pd(context:ctypes.POINTER(struct_ibv_context)) -> ctypes.POINTER(struct_ibv_pd): ...
@dll.bind
def ibv_dealloc_pd(pd:ctypes.POINTER(struct_ibv_pd)) -> ctypes.c_int32: ...
@dll.bind
def ibv_reg_mr_iova2(pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.POINTER(None), length:size_t, iova:uint64_t, access:ctypes.c_uint32) -> ctypes.POINTER(struct_ibv_mr): ...
@dll.bind
def ibv_reg_mr(pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.POINTER(None), length:size_t, access:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_mr): ...
@dll.bind
def ibv_reg_mr_iova(pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.POINTER(None), length:size_t, iova:uint64_t, access:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_mr): ...
@dll.bind
def ibv_reg_dmabuf_mr(pd:ctypes.POINTER(struct_ibv_pd), offset:uint64_t, length:size_t, iova:uint64_t, fd:ctypes.c_int32, access:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_mr): ...
...
@dll.bind
def ibv_rereg_mr(mr:ctypes.POINTER(struct_ibv_mr), flags:ctypes.c_int32, pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.POINTER(None), length:size_t, access:ctypes.c_int32) -> ctypes.c_int32: ...
@dll.bind
def ibv_dereg_mr(mr:ctypes.POINTER(struct_ibv_mr)) -> ctypes.c_int32: ...
@dll.bind
def ibv_create_comp_channel(context:ctypes.POINTER(struct_ibv_context)) -> ctypes.POINTER(struct_ibv_comp_channel): ...
@dll.bind
def ibv_destroy_comp_channel(channel:ctypes.POINTER(struct_ibv_comp_channel)) -> ctypes.c_int32: ...
@dll.bind
def ibv_create_cq(context:ctypes.POINTER(struct_ibv_context), cqe:ctypes.c_int32, cq_context:ctypes.POINTER(None), channel:ctypes.POINTER(struct_ibv_comp_channel), comp_vector:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_cq): ...
@dll.bind
def ibv_resize_cq(cq:ctypes.POINTER(struct_ibv_cq), cqe:ctypes.c_int32) -> ctypes.c_int32: ...
@dll.bind
def ibv_destroy_cq(cq:ctypes.POINTER(struct_ibv_cq)) -> ctypes.c_int32: ...
@dll.bind
def ibv_get_cq_event(channel:ctypes.POINTER(struct_ibv_comp_channel), cq:ctypes.POINTER(ctypes.POINTER(struct_ibv_cq)), cq_context:ctypes.POINTER(ctypes.POINTER(None))) -> ctypes.c_int32: ...
@dll.bind
def ibv_ack_cq_events(cq:ctypes.POINTER(struct_ibv_cq), nevents:ctypes.c_uint32) -> None: ...
@dll.bind
def ibv_create_srq(pd:ctypes.POINTER(struct_ibv_pd), srq_init_attr:ctypes.POINTER(struct_ibv_srq_init_attr)) -> ctypes.POINTER(struct_ibv_srq): ...
@dll.bind
def ibv_modify_srq(srq:ctypes.POINTER(struct_ibv_srq), srq_attr:ctypes.POINTER(struct_ibv_srq_attr), srq_attr_mask:ctypes.c_int32) -> ctypes.c_int32: ...
@dll.bind
def ibv_query_srq(srq:ctypes.POINTER(struct_ibv_srq), srq_attr:ctypes.POINTER(struct_ibv_srq_attr)) -> ctypes.c_int32: ...
@dll.bind
def ibv_destroy_srq(srq:ctypes.POINTER(struct_ibv_srq)) -> ctypes.c_int32: ...
@dll.bind
def ibv_create_qp(pd:ctypes.POINTER(struct_ibv_pd), qp_init_attr:ctypes.POINTER(struct_ibv_qp_init_attr)) -> ctypes.POINTER(struct_ibv_qp): ...
@dll.bind
def ibv_modify_qp(qp:ctypes.POINTER(struct_ibv_qp), attr:ctypes.POINTER(struct_ibv_qp_attr), attr_mask:ctypes.c_int32) -> ctypes.c_int32: ...
@dll.bind
def ibv_query_qp_data_in_order(qp:ctypes.POINTER(struct_ibv_qp), op:enum_ibv_wr_opcode, flags:uint32_t) -> ctypes.c_int32: ...
@dll.bind
def ibv_query_qp(qp:ctypes.POINTER(struct_ibv_qp), attr:ctypes.POINTER(struct_ibv_qp_attr), attr_mask:ctypes.c_int32, init_attr:ctypes.POINTER(struct_ibv_qp_init_attr)) -> ctypes.c_int32: ...
@dll.bind
def ibv_destroy_qp(qp:ctypes.POINTER(struct_ibv_qp)) -> ctypes.c_int32: ...
@dll.bind
def ibv_create_ah(pd:ctypes.POINTER(struct_ibv_pd), attr:ctypes.POINTER(struct_ibv_ah_attr)) -> ctypes.POINTER(struct_ibv_ah): ...
@dll.bind
def ibv_init_ah_from_wc(context:ctypes.POINTER(struct_ibv_context), port_num:uint8_t, wc:ctypes.POINTER(struct_ibv_wc), grh:ctypes.POINTER(struct_ibv_grh), ah_attr:ctypes.POINTER(struct_ibv_ah_attr)) -> ctypes.c_int32: ...
@dll.bind
def ibv_create_ah_from_wc(pd:ctypes.POINTER(struct_ibv_pd), wc:ctypes.POINTER(struct_ibv_wc), grh:ctypes.POINTER(struct_ibv_grh), port_num:uint8_t) -> ctypes.POINTER(struct_ibv_ah): ...
@dll.bind
def ibv_destroy_ah(ah:ctypes.POINTER(struct_ibv_ah)) -> ctypes.c_int32: ...
@dll.bind
def ibv_attach_mcast(qp:ctypes.POINTER(struct_ibv_qp), gid:ctypes.POINTER(union_ibv_gid), lid:uint16_t) -> ctypes.c_int32: ...
@dll.bind
def ibv_detach_mcast(qp:ctypes.POINTER(struct_ibv_qp), gid:ctypes.POINTER(union_ibv_gid), lid:uint16_t) -> ctypes.c_int32: ...
@dll.bind
def ibv_fork_init() -> ctypes.c_int32: ...
@dll.bind
def ibv_is_fork_initialized() -> enum_ibv_fork_status: ...
@dll.bind
def ibv_node_type_str(node_type:enum_ibv_node_type) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
def ibv_port_state_str(port_state:enum_ibv_port_state) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
def ibv_event_type_str(event:enum_ibv_event_type) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
def ibv_resolve_eth_l2_from_gid(context:ctypes.POINTER(struct_ibv_context), attr:ctypes.POINTER(struct_ibv_ah_attr), eth_mac:Array[uint8_t, Literal[6]], vid:ctypes.POINTER(uint16_t)) -> ctypes.c_int32: ...
@dll.bind
def ibv_set_ece(qp:ctypes.POINTER(struct_ibv_qp), ece:ctypes.POINTER(struct_ibv_ece)) -> ctypes.c_int32: ...
@dll.bind
def ibv_query_ece(qp:ctypes.POINTER(struct_ibv_qp), ece:ctypes.POINTER(struct_ibv_ece)) -> ctypes.c_int32: ...
...
@record
class struct_ib_uverbs_flow_action_esp_keymat_aes_gcm:
  SIZE = 56
  iv: Annotated[ctypes.c_uint64, 0]
  iv_algo: Annotated[ctypes.c_uint32, 8]
  salt: Annotated[ctypes.c_uint32, 12]
  icv_len: Annotated[ctypes.c_uint32, 16]
  key_len: Annotated[ctypes.c_uint32, 20]
  aes_key: Annotated[Array[ctypes.c_uint32, Literal[8]], 24]
@record
class struct_ib_uverbs_flow_action_esp_replay_bmp:
  SIZE = 4
...
@record
class struct_ib_uverbs_query_port_resp_ex:
  SIZE = 48
  legacy_resp: Annotated[struct_ib_uverbs_query_port_resp, 0]
  port_cap_flags2: Annotated[ctypes.c_uint16, 40]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[2]], 42]
  active_speed_ex: Annotated[ctypes.c_uint32, 44]
@record
class struct_ib_uverbs_query_port_resp:
  SIZE = 40
  port_cap_flags: Annotated[ctypes.c_uint32, 0]
  max_msg_sz: Annotated[ctypes.c_uint32, 4]
  bad_pkey_cntr: Annotated[ctypes.c_uint32, 8]
  qkey_viol_cntr: Annotated[ctypes.c_uint32, 12]
  gid_tbl_len: Annotated[ctypes.c_uint32, 16]
  pkey_tbl_len: Annotated[ctypes.c_uint16, 20]
  lid: Annotated[ctypes.c_uint16, 22]
  sm_lid: Annotated[ctypes.c_uint16, 24]
  state: Annotated[ctypes.c_ubyte, 26]
  max_mtu: Annotated[ctypes.c_ubyte, 27]
  active_mtu: Annotated[ctypes.c_ubyte, 28]
  lmc: Annotated[ctypes.c_ubyte, 29]
  max_vl_num: Annotated[ctypes.c_ubyte, 30]
  sm_sl: Annotated[ctypes.c_ubyte, 31]
  subnet_timeout: Annotated[ctypes.c_ubyte, 32]
  init_type_reply: Annotated[ctypes.c_ubyte, 33]
  active_width: Annotated[ctypes.c_ubyte, 34]
  active_speed: Annotated[ctypes.c_ubyte, 35]
  phys_state: Annotated[ctypes.c_ubyte, 36]
  link_layer: Annotated[ctypes.c_ubyte, 37]
  flags: Annotated[ctypes.c_ubyte, 38]
  reserved: Annotated[ctypes.c_ubyte, 39]
__u8 = ctypes.c_ubyte
@record
class struct_ib_uverbs_qp_cap:
  SIZE = 20
  max_send_wr: Annotated[ctypes.c_uint32, 0]
  max_recv_wr: Annotated[ctypes.c_uint32, 4]
  max_send_sge: Annotated[ctypes.c_uint32, 8]
  max_recv_sge: Annotated[ctypes.c_uint32, 12]
  max_inline_data: Annotated[ctypes.c_uint32, 16]
...
@record
class struct_ib_uverbs_gid_entry:
  SIZE = 32
  gid: Annotated[Array[ctypes.c_uint64, Literal[2]], 0]
  gid_index: Annotated[ctypes.c_uint32, 16]
  port_num: Annotated[ctypes.c_uint32, 20]
  gid_type: Annotated[ctypes.c_uint32, 24]
  netdev_ifindex: Annotated[ctypes.c_uint32, 28]
...
@record
class struct_ib_uverbs_async_event_desc:
  SIZE = 16
  element: Annotated[ctypes.c_uint64, 0]
  event_type: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_comp_event_desc:
  SIZE = 8
  cq_handle: Annotated[ctypes.c_uint64, 0]
@record
class struct_ib_uverbs_cq_moderation_caps:
  SIZE = 8
  max_cq_moderation_count: Annotated[ctypes.c_uint16, 0]
  max_cq_moderation_period: Annotated[ctypes.c_uint16, 2]
  reserved: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_cmd_hdr:
  SIZE = 8
  command: Annotated[ctypes.c_uint32, 0]
  in_words: Annotated[ctypes.c_uint16, 4]
  out_words: Annotated[ctypes.c_uint16, 6]
@record
class struct_ib_uverbs_ex_cmd_hdr:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  provider_in_words: Annotated[ctypes.c_uint16, 8]
  provider_out_words: Annotated[ctypes.c_uint16, 10]
  cmd_hdr_reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_get_context:
  SIZE = 8
  response: Annotated[ctypes.c_uint64, 0]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_get_context_resp:
  SIZE = 8
  async_fd: Annotated[ctypes.c_uint32, 0]
  num_comp_vectors: Annotated[ctypes.c_uint32, 4]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_query_device:
  SIZE = 8
  response: Annotated[ctypes.c_uint64, 0]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_query_device_resp:
  SIZE = 176
  fw_ver: Annotated[ctypes.c_uint64, 0]
  node_guid: Annotated[ctypes.c_uint64, 8]
  sys_image_guid: Annotated[ctypes.c_uint64, 16]
  max_mr_size: Annotated[ctypes.c_uint64, 24]
  page_size_cap: Annotated[ctypes.c_uint64, 32]
  vendor_id: Annotated[ctypes.c_uint32, 40]
  vendor_part_id: Annotated[ctypes.c_uint32, 44]
  hw_ver: Annotated[ctypes.c_uint32, 48]
  max_qp: Annotated[ctypes.c_uint32, 52]
  max_qp_wr: Annotated[ctypes.c_uint32, 56]
  device_cap_flags: Annotated[ctypes.c_uint32, 60]
  max_sge: Annotated[ctypes.c_uint32, 64]
  max_sge_rd: Annotated[ctypes.c_uint32, 68]
  max_cq: Annotated[ctypes.c_uint32, 72]
  max_cqe: Annotated[ctypes.c_uint32, 76]
  max_mr: Annotated[ctypes.c_uint32, 80]
  max_pd: Annotated[ctypes.c_uint32, 84]
  max_qp_rd_atom: Annotated[ctypes.c_uint32, 88]
  max_ee_rd_atom: Annotated[ctypes.c_uint32, 92]
  max_res_rd_atom: Annotated[ctypes.c_uint32, 96]
  max_qp_init_rd_atom: Annotated[ctypes.c_uint32, 100]
  max_ee_init_rd_atom: Annotated[ctypes.c_uint32, 104]
  atomic_cap: Annotated[ctypes.c_uint32, 108]
  max_ee: Annotated[ctypes.c_uint32, 112]
  max_rdd: Annotated[ctypes.c_uint32, 116]
  max_mw: Annotated[ctypes.c_uint32, 120]
  max_raw_ipv6_qp: Annotated[ctypes.c_uint32, 124]
  max_raw_ethy_qp: Annotated[ctypes.c_uint32, 128]
  max_mcast_grp: Annotated[ctypes.c_uint32, 132]
  max_mcast_qp_attach: Annotated[ctypes.c_uint32, 136]
  max_total_mcast_qp_attach: Annotated[ctypes.c_uint32, 140]
  max_ah: Annotated[ctypes.c_uint32, 144]
  max_fmr: Annotated[ctypes.c_uint32, 148]
  max_map_per_fmr: Annotated[ctypes.c_uint32, 152]
  max_srq: Annotated[ctypes.c_uint32, 156]
  max_srq_wr: Annotated[ctypes.c_uint32, 160]
  max_srq_sge: Annotated[ctypes.c_uint32, 164]
  max_pkeys: Annotated[ctypes.c_uint16, 168]
  local_ca_ack_delay: Annotated[ctypes.c_ubyte, 170]
  phys_port_cnt: Annotated[ctypes.c_ubyte, 171]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[4]], 172]
@record
class struct_ib_uverbs_ex_query_device:
  SIZE = 8
  comp_mask: Annotated[ctypes.c_uint32, 0]
  reserved: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_odp_caps:
  SIZE = 24
  general_caps: Annotated[ctypes.c_uint64, 0]
  per_transport_caps: Annotated[_anonstruct21, 8]
  reserved: Annotated[ctypes.c_uint32, 20]
@record
class _anonstruct21:
  SIZE = 12
  rc_odp_caps: Annotated[ctypes.c_uint32, 0]
  uc_odp_caps: Annotated[ctypes.c_uint32, 4]
  ud_odp_caps: Annotated[ctypes.c_uint32, 8]
@record
class struct_ib_uverbs_rss_caps:
  SIZE = 16
  supported_qpts: Annotated[ctypes.c_uint32, 0]
  max_rwq_indirection_tables: Annotated[ctypes.c_uint32, 4]
  max_rwq_indirection_table_size: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_tm_caps:
  SIZE = 24
  max_rndv_hdr_size: Annotated[ctypes.c_uint32, 0]
  max_num_tags: Annotated[ctypes.c_uint32, 4]
  flags: Annotated[ctypes.c_uint32, 8]
  max_ops: Annotated[ctypes.c_uint32, 12]
  max_sge: Annotated[ctypes.c_uint32, 16]
  reserved: Annotated[ctypes.c_uint32, 20]
@record
class struct_ib_uverbs_ex_query_device_resp:
  SIZE = 304
  base: Annotated[struct_ib_uverbs_query_device_resp, 0]
  comp_mask: Annotated[ctypes.c_uint32, 176]
  response_length: Annotated[ctypes.c_uint32, 180]
  odp_caps: Annotated[struct_ib_uverbs_odp_caps, 184]
  timestamp_mask: Annotated[ctypes.c_uint64, 208]
  hca_core_clock: Annotated[ctypes.c_uint64, 216]
  device_cap_flags_ex: Annotated[ctypes.c_uint64, 224]
  rss_caps: Annotated[struct_ib_uverbs_rss_caps, 232]
  max_wq_type_rq: Annotated[ctypes.c_uint32, 248]
  raw_packet_caps: Annotated[ctypes.c_uint32, 252]
  tm_caps: Annotated[struct_ib_uverbs_tm_caps, 256]
  cq_moderation_caps: Annotated[struct_ib_uverbs_cq_moderation_caps, 280]
  max_dm_size: Annotated[ctypes.c_uint64, 288]
  xrc_odp_caps: Annotated[ctypes.c_uint32, 296]
  reserved: Annotated[ctypes.c_uint32, 300]
@record
class struct_ib_uverbs_query_port:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  port_num: Annotated[ctypes.c_ubyte, 8]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[7]], 9]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 16]
@record
class struct_ib_uverbs_alloc_pd:
  SIZE = 8
  response: Annotated[ctypes.c_uint64, 0]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_alloc_pd_resp:
  SIZE = 4
  pd_handle: Annotated[ctypes.c_uint32, 0]
  driver_data: Annotated[Array[ctypes.c_uint32, Literal[0]], 4]
@record
class struct_ib_uverbs_dealloc_pd:
  SIZE = 4
  pd_handle: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_open_xrcd:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  fd: Annotated[ctypes.c_uint32, 8]
  oflags: Annotated[ctypes.c_uint32, 12]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 16]
@record
class struct_ib_uverbs_open_xrcd_resp:
  SIZE = 4
  xrcd_handle: Annotated[ctypes.c_uint32, 0]
  driver_data: Annotated[Array[ctypes.c_uint32, Literal[0]], 4]
@record
class struct_ib_uverbs_close_xrcd:
  SIZE = 4
  xrcd_handle: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_reg_mr:
  SIZE = 40
  response: Annotated[ctypes.c_uint64, 0]
  start: Annotated[ctypes.c_uint64, 8]
  length: Annotated[ctypes.c_uint64, 16]
  hca_va: Annotated[ctypes.c_uint64, 24]
  pd_handle: Annotated[ctypes.c_uint32, 32]
  access_flags: Annotated[ctypes.c_uint32, 36]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 40]
@record
class struct_ib_uverbs_reg_mr_resp:
  SIZE = 12
  mr_handle: Annotated[ctypes.c_uint32, 0]
  lkey: Annotated[ctypes.c_uint32, 4]
  rkey: Annotated[ctypes.c_uint32, 8]
  driver_data: Annotated[Array[ctypes.c_uint32, Literal[0]], 12]
@record
class struct_ib_uverbs_rereg_mr:
  SIZE = 48
  response: Annotated[ctypes.c_uint64, 0]
  mr_handle: Annotated[ctypes.c_uint32, 8]
  flags: Annotated[ctypes.c_uint32, 12]
  start: Annotated[ctypes.c_uint64, 16]
  length: Annotated[ctypes.c_uint64, 24]
  hca_va: Annotated[ctypes.c_uint64, 32]
  pd_handle: Annotated[ctypes.c_uint32, 40]
  access_flags: Annotated[ctypes.c_uint32, 44]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 48]
@record
class struct_ib_uverbs_rereg_mr_resp:
  SIZE = 8
  lkey: Annotated[ctypes.c_uint32, 0]
  rkey: Annotated[ctypes.c_uint32, 4]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_dereg_mr:
  SIZE = 4
  mr_handle: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_alloc_mw:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  pd_handle: Annotated[ctypes.c_uint32, 8]
  mw_type: Annotated[ctypes.c_ubyte, 12]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[3]], 13]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 16]
@record
class struct_ib_uverbs_alloc_mw_resp:
  SIZE = 8
  mw_handle: Annotated[ctypes.c_uint32, 0]
  rkey: Annotated[ctypes.c_uint32, 4]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_dealloc_mw:
  SIZE = 4
  mw_handle: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_create_comp_channel:
  SIZE = 8
  response: Annotated[ctypes.c_uint64, 0]
@record
class struct_ib_uverbs_create_comp_channel_resp:
  SIZE = 4
  fd: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_create_cq:
  SIZE = 32
  response: Annotated[ctypes.c_uint64, 0]
  user_handle: Annotated[ctypes.c_uint64, 8]
  cqe: Annotated[ctypes.c_uint32, 16]
  comp_vector: Annotated[ctypes.c_uint32, 20]
  comp_channel: Annotated[ctypes.c_int32, 24]
  reserved: Annotated[ctypes.c_uint32, 28]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 32]
...
@record
class struct_ib_uverbs_ex_create_cq:
  SIZE = 32
  user_handle: Annotated[ctypes.c_uint64, 0]
  cqe: Annotated[ctypes.c_uint32, 8]
  comp_vector: Annotated[ctypes.c_uint32, 12]
  comp_channel: Annotated[ctypes.c_int32, 16]
  comp_mask: Annotated[ctypes.c_uint32, 20]
  flags: Annotated[ctypes.c_uint32, 24]
  reserved: Annotated[ctypes.c_uint32, 28]
@record
class struct_ib_uverbs_create_cq_resp:
  SIZE = 8
  cq_handle: Annotated[ctypes.c_uint32, 0]
  cqe: Annotated[ctypes.c_uint32, 4]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_ex_create_cq_resp:
  SIZE = 16
  base: Annotated[struct_ib_uverbs_create_cq_resp, 0]
  comp_mask: Annotated[ctypes.c_uint32, 8]
  response_length: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_resize_cq:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  cq_handle: Annotated[ctypes.c_uint32, 8]
  cqe: Annotated[ctypes.c_uint32, 12]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 16]
@record
class struct_ib_uverbs_resize_cq_resp:
  SIZE = 8
  cqe: Annotated[ctypes.c_uint32, 0]
  reserved: Annotated[ctypes.c_uint32, 4]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_poll_cq:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  cq_handle: Annotated[ctypes.c_uint32, 8]
  ne: Annotated[ctypes.c_uint32, 12]
...
@record
class struct_ib_uverbs_wc:
  SIZE = 48
  wr_id: Annotated[ctypes.c_uint64, 0]
  status: Annotated[ctypes.c_uint32, 8]
  opcode: Annotated[ctypes.c_uint32, 12]
  vendor_err: Annotated[ctypes.c_uint32, 16]
  byte_len: Annotated[ctypes.c_uint32, 20]
  ex: Annotated[_anonunion22, 24]
  qp_num: Annotated[ctypes.c_uint32, 28]
  src_qp: Annotated[ctypes.c_uint32, 32]
  wc_flags: Annotated[ctypes.c_uint32, 36]
  pkey_index: Annotated[ctypes.c_uint16, 40]
  slid: Annotated[ctypes.c_uint16, 42]
  sl: Annotated[ctypes.c_ubyte, 44]
  dlid_path_bits: Annotated[ctypes.c_ubyte, 45]
  port_num: Annotated[ctypes.c_ubyte, 46]
  reserved: Annotated[ctypes.c_ubyte, 47]
@record
class _anonunion22:
  SIZE = 4
  imm_data: Annotated[ctypes.c_uint32, 0]
  invalidate_rkey: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_poll_cq_resp:
  SIZE = 8
  count: Annotated[ctypes.c_uint32, 0]
  reserved: Annotated[ctypes.c_uint32, 4]
  wc: Annotated[Array[struct_ib_uverbs_wc, Literal[0]], 8]
@record
class struct_ib_uverbs_req_notify_cq:
  SIZE = 8
  cq_handle: Annotated[ctypes.c_uint32, 0]
  solicited_only: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_destroy_cq:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  cq_handle: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_destroy_cq_resp:
  SIZE = 8
  comp_events_reported: Annotated[ctypes.c_uint32, 0]
  async_events_reported: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_global_route:
  SIZE = 24
  dgid: Annotated[Array[ctypes.c_ubyte, Literal[16]], 0]
  flow_label: Annotated[ctypes.c_uint32, 16]
  sgid_index: Annotated[ctypes.c_ubyte, 20]
  hop_limit: Annotated[ctypes.c_ubyte, 21]
  traffic_class: Annotated[ctypes.c_ubyte, 22]
  reserved: Annotated[ctypes.c_ubyte, 23]
@record
class struct_ib_uverbs_ah_attr:
  SIZE = 32
  grh: Annotated[struct_ib_uverbs_global_route, 0]
  dlid: Annotated[ctypes.c_uint16, 24]
  sl: Annotated[ctypes.c_ubyte, 26]
  src_path_bits: Annotated[ctypes.c_ubyte, 27]
  static_rate: Annotated[ctypes.c_ubyte, 28]
  is_global: Annotated[ctypes.c_ubyte, 29]
  port_num: Annotated[ctypes.c_ubyte, 30]
  reserved: Annotated[ctypes.c_ubyte, 31]
@record
class struct_ib_uverbs_qp_attr:
  SIZE = 144
  qp_attr_mask: Annotated[ctypes.c_uint32, 0]
  qp_state: Annotated[ctypes.c_uint32, 4]
  cur_qp_state: Annotated[ctypes.c_uint32, 8]
  path_mtu: Annotated[ctypes.c_uint32, 12]
  path_mig_state: Annotated[ctypes.c_uint32, 16]
  qkey: Annotated[ctypes.c_uint32, 20]
  rq_psn: Annotated[ctypes.c_uint32, 24]
  sq_psn: Annotated[ctypes.c_uint32, 28]
  dest_qp_num: Annotated[ctypes.c_uint32, 32]
  qp_access_flags: Annotated[ctypes.c_uint32, 36]
  ah_attr: Annotated[struct_ib_uverbs_ah_attr, 40]
  alt_ah_attr: Annotated[struct_ib_uverbs_ah_attr, 72]
  max_send_wr: Annotated[ctypes.c_uint32, 104]
  max_recv_wr: Annotated[ctypes.c_uint32, 108]
  max_send_sge: Annotated[ctypes.c_uint32, 112]
  max_recv_sge: Annotated[ctypes.c_uint32, 116]
  max_inline_data: Annotated[ctypes.c_uint32, 120]
  pkey_index: Annotated[ctypes.c_uint16, 124]
  alt_pkey_index: Annotated[ctypes.c_uint16, 126]
  en_sqd_async_notify: Annotated[ctypes.c_ubyte, 128]
  sq_draining: Annotated[ctypes.c_ubyte, 129]
  max_rd_atomic: Annotated[ctypes.c_ubyte, 130]
  max_dest_rd_atomic: Annotated[ctypes.c_ubyte, 131]
  min_rnr_timer: Annotated[ctypes.c_ubyte, 132]
  port_num: Annotated[ctypes.c_ubyte, 133]
  timeout: Annotated[ctypes.c_ubyte, 134]
  retry_cnt: Annotated[ctypes.c_ubyte, 135]
  rnr_retry: Annotated[ctypes.c_ubyte, 136]
  alt_port_num: Annotated[ctypes.c_ubyte, 137]
  alt_timeout: Annotated[ctypes.c_ubyte, 138]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[5]], 139]
@record
class struct_ib_uverbs_create_qp:
  SIZE = 56
  response: Annotated[ctypes.c_uint64, 0]
  user_handle: Annotated[ctypes.c_uint64, 8]
  pd_handle: Annotated[ctypes.c_uint32, 16]
  send_cq_handle: Annotated[ctypes.c_uint32, 20]
  recv_cq_handle: Annotated[ctypes.c_uint32, 24]
  srq_handle: Annotated[ctypes.c_uint32, 28]
  max_send_wr: Annotated[ctypes.c_uint32, 32]
  max_recv_wr: Annotated[ctypes.c_uint32, 36]
  max_send_sge: Annotated[ctypes.c_uint32, 40]
  max_recv_sge: Annotated[ctypes.c_uint32, 44]
  max_inline_data: Annotated[ctypes.c_uint32, 48]
  sq_sig_all: Annotated[ctypes.c_ubyte, 52]
  qp_type: Annotated[ctypes.c_ubyte, 53]
  is_srq: Annotated[ctypes.c_ubyte, 54]
  reserved: Annotated[ctypes.c_ubyte, 55]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 56]
...
@record
class struct_ib_uverbs_ex_create_qp:
  SIZE = 64
  user_handle: Annotated[ctypes.c_uint64, 0]
  pd_handle: Annotated[ctypes.c_uint32, 8]
  send_cq_handle: Annotated[ctypes.c_uint32, 12]
  recv_cq_handle: Annotated[ctypes.c_uint32, 16]
  srq_handle: Annotated[ctypes.c_uint32, 20]
  max_send_wr: Annotated[ctypes.c_uint32, 24]
  max_recv_wr: Annotated[ctypes.c_uint32, 28]
  max_send_sge: Annotated[ctypes.c_uint32, 32]
  max_recv_sge: Annotated[ctypes.c_uint32, 36]
  max_inline_data: Annotated[ctypes.c_uint32, 40]
  sq_sig_all: Annotated[ctypes.c_ubyte, 44]
  qp_type: Annotated[ctypes.c_ubyte, 45]
  is_srq: Annotated[ctypes.c_ubyte, 46]
  reserved: Annotated[ctypes.c_ubyte, 47]
  comp_mask: Annotated[ctypes.c_uint32, 48]
  create_flags: Annotated[ctypes.c_uint32, 52]
  rwq_ind_tbl_handle: Annotated[ctypes.c_uint32, 56]
  source_qpn: Annotated[ctypes.c_uint32, 60]
@record
class struct_ib_uverbs_open_qp:
  SIZE = 32
  response: Annotated[ctypes.c_uint64, 0]
  user_handle: Annotated[ctypes.c_uint64, 8]
  pd_handle: Annotated[ctypes.c_uint32, 16]
  qpn: Annotated[ctypes.c_uint32, 20]
  qp_type: Annotated[ctypes.c_ubyte, 24]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[7]], 25]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 32]
@record
class struct_ib_uverbs_create_qp_resp:
  SIZE = 32
  qp_handle: Annotated[ctypes.c_uint32, 0]
  qpn: Annotated[ctypes.c_uint32, 4]
  max_send_wr: Annotated[ctypes.c_uint32, 8]
  max_recv_wr: Annotated[ctypes.c_uint32, 12]
  max_send_sge: Annotated[ctypes.c_uint32, 16]
  max_recv_sge: Annotated[ctypes.c_uint32, 20]
  max_inline_data: Annotated[ctypes.c_uint32, 24]
  reserved: Annotated[ctypes.c_uint32, 28]
  driver_data: Annotated[Array[ctypes.c_uint32, Literal[0]], 32]
@record
class struct_ib_uverbs_ex_create_qp_resp:
  SIZE = 40
  base: Annotated[struct_ib_uverbs_create_qp_resp, 0]
  comp_mask: Annotated[ctypes.c_uint32, 32]
  response_length: Annotated[ctypes.c_uint32, 36]
@record
class struct_ib_uverbs_qp_dest:
  SIZE = 32
  dgid: Annotated[Array[ctypes.c_ubyte, Literal[16]], 0]
  flow_label: Annotated[ctypes.c_uint32, 16]
  dlid: Annotated[ctypes.c_uint16, 20]
  reserved: Annotated[ctypes.c_uint16, 22]
  sgid_index: Annotated[ctypes.c_ubyte, 24]
  hop_limit: Annotated[ctypes.c_ubyte, 25]
  traffic_class: Annotated[ctypes.c_ubyte, 26]
  sl: Annotated[ctypes.c_ubyte, 27]
  src_path_bits: Annotated[ctypes.c_ubyte, 28]
  static_rate: Annotated[ctypes.c_ubyte, 29]
  is_global: Annotated[ctypes.c_ubyte, 30]
  port_num: Annotated[ctypes.c_ubyte, 31]
@record
class struct_ib_uverbs_query_qp:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  qp_handle: Annotated[ctypes.c_uint32, 8]
  attr_mask: Annotated[ctypes.c_uint32, 12]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 16]
@record
class struct_ib_uverbs_query_qp_resp:
  SIZE = 128
  dest: Annotated[struct_ib_uverbs_qp_dest, 0]
  alt_dest: Annotated[struct_ib_uverbs_qp_dest, 32]
  max_send_wr: Annotated[ctypes.c_uint32, 64]
  max_recv_wr: Annotated[ctypes.c_uint32, 68]
  max_send_sge: Annotated[ctypes.c_uint32, 72]
  max_recv_sge: Annotated[ctypes.c_uint32, 76]
  max_inline_data: Annotated[ctypes.c_uint32, 80]
  qkey: Annotated[ctypes.c_uint32, 84]
  rq_psn: Annotated[ctypes.c_uint32, 88]
  sq_psn: Annotated[ctypes.c_uint32, 92]
  dest_qp_num: Annotated[ctypes.c_uint32, 96]
  qp_access_flags: Annotated[ctypes.c_uint32, 100]
  pkey_index: Annotated[ctypes.c_uint16, 104]
  alt_pkey_index: Annotated[ctypes.c_uint16, 106]
  qp_state: Annotated[ctypes.c_ubyte, 108]
  cur_qp_state: Annotated[ctypes.c_ubyte, 109]
  path_mtu: Annotated[ctypes.c_ubyte, 110]
  path_mig_state: Annotated[ctypes.c_ubyte, 111]
  sq_draining: Annotated[ctypes.c_ubyte, 112]
  max_rd_atomic: Annotated[ctypes.c_ubyte, 113]
  max_dest_rd_atomic: Annotated[ctypes.c_ubyte, 114]
  min_rnr_timer: Annotated[ctypes.c_ubyte, 115]
  port_num: Annotated[ctypes.c_ubyte, 116]
  timeout: Annotated[ctypes.c_ubyte, 117]
  retry_cnt: Annotated[ctypes.c_ubyte, 118]
  rnr_retry: Annotated[ctypes.c_ubyte, 119]
  alt_port_num: Annotated[ctypes.c_ubyte, 120]
  alt_timeout: Annotated[ctypes.c_ubyte, 121]
  sq_sig_all: Annotated[ctypes.c_ubyte, 122]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[5]], 123]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 128]
@record
class struct_ib_uverbs_modify_qp:
  SIZE = 112
  dest: Annotated[struct_ib_uverbs_qp_dest, 0]
  alt_dest: Annotated[struct_ib_uverbs_qp_dest, 32]
  qp_handle: Annotated[ctypes.c_uint32, 64]
  attr_mask: Annotated[ctypes.c_uint32, 68]
  qkey: Annotated[ctypes.c_uint32, 72]
  rq_psn: Annotated[ctypes.c_uint32, 76]
  sq_psn: Annotated[ctypes.c_uint32, 80]
  dest_qp_num: Annotated[ctypes.c_uint32, 84]
  qp_access_flags: Annotated[ctypes.c_uint32, 88]
  pkey_index: Annotated[ctypes.c_uint16, 92]
  alt_pkey_index: Annotated[ctypes.c_uint16, 94]
  qp_state: Annotated[ctypes.c_ubyte, 96]
  cur_qp_state: Annotated[ctypes.c_ubyte, 97]
  path_mtu: Annotated[ctypes.c_ubyte, 98]
  path_mig_state: Annotated[ctypes.c_ubyte, 99]
  en_sqd_async_notify: Annotated[ctypes.c_ubyte, 100]
  max_rd_atomic: Annotated[ctypes.c_ubyte, 101]
  max_dest_rd_atomic: Annotated[ctypes.c_ubyte, 102]
  min_rnr_timer: Annotated[ctypes.c_ubyte, 103]
  port_num: Annotated[ctypes.c_ubyte, 104]
  timeout: Annotated[ctypes.c_ubyte, 105]
  retry_cnt: Annotated[ctypes.c_ubyte, 106]
  rnr_retry: Annotated[ctypes.c_ubyte, 107]
  alt_port_num: Annotated[ctypes.c_ubyte, 108]
  alt_timeout: Annotated[ctypes.c_ubyte, 109]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[2]], 110]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 112]
@record
class struct_ib_uverbs_ex_modify_qp:
  SIZE = 120
  base: Annotated[struct_ib_uverbs_modify_qp, 0]
  rate_limit: Annotated[ctypes.c_uint32, 112]
  reserved: Annotated[ctypes.c_uint32, 116]
@record
class struct_ib_uverbs_ex_modify_qp_resp:
  SIZE = 8
  comp_mask: Annotated[ctypes.c_uint32, 0]
  response_length: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_destroy_qp:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  qp_handle: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_destroy_qp_resp:
  SIZE = 4
  events_reported: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_sge:
  SIZE = 16
  addr: Annotated[ctypes.c_uint64, 0]
  length: Annotated[ctypes.c_uint32, 8]
  lkey: Annotated[ctypes.c_uint32, 12]
...
@record
class struct_ib_uverbs_send_wr:
  SIZE = 56
  wr_id: Annotated[ctypes.c_uint64, 0]
  num_sge: Annotated[ctypes.c_uint32, 8]
  opcode: Annotated[ctypes.c_uint32, 12]
  send_flags: Annotated[ctypes.c_uint32, 16]
...
class _anonstruct26:
  SIZE = 16
  remote_addr: Annotated[ctypes.c_uint64, 0]
  rkey: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class _anonstruct27:
  SIZE = 32
  remote_addr: Annotated[ctypes.c_uint64, 0]
  compare_add: Annotated[ctypes.c_uint64, 8]
  swap: Annotated[ctypes.c_uint64, 16]
  rkey: Annotated[ctypes.c_uint32, 24]
  reserved: Annotated[ctypes.c_uint32, 28]
@record
class _anonstruct28:
  SIZE = 16
  ah: Annotated[ctypes.c_uint32, 0]
  remote_qpn: Annotated[ctypes.c_uint32, 4]
  remote_qkey: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_post_send:
  SIZE = 24
  response: Annotated[ctypes.c_uint64, 0]
  qp_handle: Annotated[ctypes.c_uint32, 8]
  wr_count: Annotated[ctypes.c_uint32, 12]
  sge_count: Annotated[ctypes.c_uint32, 16]
  wqe_size: Annotated[ctypes.c_uint32, 20]
  send_wr: Annotated[Array[struct_ib_uverbs_send_wr, Literal[0]], 24]
@record
class struct_ib_uverbs_post_send_resp:
  SIZE = 4
  bad_wr: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_recv_wr:
  SIZE = 16
  wr_id: Annotated[ctypes.c_uint64, 0]
  num_sge: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_post_recv:
  SIZE = 24
  response: Annotated[ctypes.c_uint64, 0]
  qp_handle: Annotated[ctypes.c_uint32, 8]
  wr_count: Annotated[ctypes.c_uint32, 12]
  sge_count: Annotated[ctypes.c_uint32, 16]
  wqe_size: Annotated[ctypes.c_uint32, 20]
  recv_wr: Annotated[Array[struct_ib_uverbs_recv_wr, Literal[0]], 24]
@record
class struct_ib_uverbs_post_recv_resp:
  SIZE = 4
  bad_wr: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_post_srq_recv:
  SIZE = 24
  response: Annotated[ctypes.c_uint64, 0]
  srq_handle: Annotated[ctypes.c_uint32, 8]
  wr_count: Annotated[ctypes.c_uint32, 12]
  sge_count: Annotated[ctypes.c_uint32, 16]
  wqe_size: Annotated[ctypes.c_uint32, 20]
  recv: Annotated[Array[struct_ib_uverbs_recv_wr, Literal[0]], 24]
@record
class struct_ib_uverbs_post_srq_recv_resp:
  SIZE = 4
  bad_wr: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_create_ah:
  SIZE = 56
  response: Annotated[ctypes.c_uint64, 0]
  user_handle: Annotated[ctypes.c_uint64, 8]
  pd_handle: Annotated[ctypes.c_uint32, 16]
  ...
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 56]
@record
class struct_ib_uverbs_create_ah_resp:
  SIZE = 4
  ah_handle: Annotated[ctypes.c_uint32, 0]
  driver_data: Annotated[Array[ctypes.c_uint32, Literal[0]], 4]
@record
class struct_ib_uverbs_destroy_ah:
  SIZE = 4
  ah_handle: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_attach_mcast:
  SIZE = 24
  gid: Annotated[Array[ctypes.c_ubyte, Literal[16]], 0]
  qp_handle: Annotated[ctypes.c_uint32, 16]
  mlid: Annotated[ctypes.c_uint16, 20]
  reserved: Annotated[ctypes.c_uint16, 22]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 24]
@record
class struct_ib_uverbs_detach_mcast:
  SIZE = 24
  gid: Annotated[Array[ctypes.c_ubyte, Literal[16]], 0]
  qp_handle: Annotated[ctypes.c_uint32, 16]
  mlid: Annotated[ctypes.c_uint16, 20]
  ...
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 24]
@record
class struct_ib_uverbs_flow_spec_hdr:
  SIZE = 8
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
  reserved: Annotated[ctypes.c_uint16, 6]
  flow_spec_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 8]
@record
class struct_ib_uverbs_flow_eth_filter:
  SIZE = 16
  dst_mac: Annotated[Array[ctypes.c_ubyte, Literal[6]], 0]
  src_mac: Annotated[Array[ctypes.c_ubyte, Literal[6]], 6]
  ether_type: Annotated[ctypes.c_uint16, 12]
  vlan_tag: Annotated[ctypes.c_uint16, 14]
@record
class struct_ib_uverbs_flow_spec_eth:
  SIZE = 40
...
@record
class struct_ib_uverbs_flow_ipv4_filter:
  SIZE = 12
  src_ip: Annotated[ctypes.c_uint32, 0]
  dst_ip: Annotated[ctypes.c_uint32, 4]
  proto: Annotated[ctypes.c_ubyte, 8]
  tos: Annotated[ctypes.c_ubyte, 9]
  ttl: Annotated[ctypes.c_ubyte, 10]
  flags: Annotated[ctypes.c_ubyte, 11]
@record
class struct_ib_uverbs_flow_spec_ipv4:
  SIZE = 32
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
...
@record
class struct_ib_uverbs_flow_tcp_udp_filter:
  SIZE = 4
  dst_port: Annotated[ctypes.c_uint16, 0]
  src_port: Annotated[ctypes.c_uint16, 2]
@record
class struct_ib_uverbs_flow_spec_tcp_udp:
  SIZE = 16
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
...
@record
class struct_ib_uverbs_flow_ipv6_filter:
  SIZE = 40
  src_ip: Annotated[Array[ctypes.c_ubyte, Literal[16]], 0]
  dst_ip: Annotated[Array[ctypes.c_ubyte, Literal[16]], 16]
  flow_label: Annotated[ctypes.c_uint32, 32]
  next_hdr: Annotated[ctypes.c_ubyte, 36]
  traffic_class: Annotated[ctypes.c_ubyte, 37]
  hop_limit: Annotated[ctypes.c_ubyte, 38]
  reserved: Annotated[ctypes.c_ubyte, 39]
@record
class struct_ib_uverbs_flow_spec_ipv6:
  SIZE = 88
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
...
@record
class struct_ib_uverbs_flow_spec_action_tag:
  SIZE = 16
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
  reserved: Annotated[ctypes.c_uint16, 6]
  tag_id: Annotated[ctypes.c_uint32, 8]
  reserved1: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_flow_spec_action_drop:
  SIZE = 8
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
  reserved: Annotated[ctypes.c_uint16, 6]
@record
class struct_ib_uverbs_flow_spec_action_handle:
  SIZE = 16
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
  reserved: Annotated[ctypes.c_uint16, 6]
  handle: Annotated[ctypes.c_uint32, 8]
  reserved1: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_flow_spec_action_count:
  SIZE = 16
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
  ...
  reserved1: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_flow_tunnel_filter:
  SIZE = 4
  tunnel_id: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_flow_spec_tunnel:
  SIZE = 16
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
...
@record
class struct_ib_uverbs_flow_spec_esp_filter:
  SIZE = 8
  spi: Annotated[ctypes.c_uint32, 0]
  seq: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_flow_spec_esp:
  SIZE = 24
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
...
@record
class struct_ib_uverbs_flow_gre_filter:
  SIZE = 8
  c_ks_res0_ver: Annotated[ctypes.c_uint16, 0]
  protocol: Annotated[ctypes.c_uint16, 2]
  key: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_flow_spec_gre:
  SIZE = 24
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
...
@record
class struct_ib_uverbs_flow_mpls_filter:
  SIZE = 4
  label: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_flow_spec_mpls:
  SIZE = 16
  hdr: Annotated[struct_ib_uverbs_flow_spec_hdr, 0]
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
...
@record
class struct_ib_uverbs_flow_attr:
  SIZE = 16
  type: Annotated[ctypes.c_uint32, 0]
  size: Annotated[ctypes.c_uint16, 4]
  priority: Annotated[ctypes.c_uint16, 6]
  num_of_specs: Annotated[ctypes.c_ubyte, 8]
  reserved: Annotated[Array[ctypes.c_ubyte, Literal[2]], 9]
  port: Annotated[ctypes.c_ubyte, 11]
  flags: Annotated[ctypes.c_uint32, 12]
  flow_specs: Annotated[Array[struct_ib_uverbs_flow_spec_hdr, Literal[0]], 16]
@record
class struct_ib_uverbs_create_flow:
  SIZE = 24
  comp_mask: Annotated[ctypes.c_uint32, 0]
  qp_handle: Annotated[ctypes.c_uint32, 4]
  flow_attr: Annotated[struct_ib_uverbs_flow_attr, 8]
@record
class struct_ib_uverbs_create_flow_resp:
  SIZE = 8
  comp_mask: Annotated[ctypes.c_uint32, 0]
  flow_handle: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_destroy_flow:
  SIZE = 8
  comp_mask: Annotated[ctypes.c_uint32, 0]
  flow_handle: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_create_srq:
  SIZE = 32
  response: Annotated[ctypes.c_uint64, 0]
  user_handle: Annotated[ctypes.c_uint64, 8]
  pd_handle: Annotated[ctypes.c_uint32, 16]
  max_wr: Annotated[ctypes.c_uint32, 20]
  max_sge: Annotated[ctypes.c_uint32, 24]
  srq_limit: Annotated[ctypes.c_uint32, 28]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 32]
@record
class struct_ib_uverbs_create_xsrq:
  SIZE = 48
  response: Annotated[ctypes.c_uint64, 0]
  user_handle: Annotated[ctypes.c_uint64, 8]
  srq_type: Annotated[ctypes.c_uint32, 16]
  pd_handle: Annotated[ctypes.c_uint32, 20]
  max_wr: Annotated[ctypes.c_uint32, 24]
  max_sge: Annotated[ctypes.c_uint32, 28]
  srq_limit: Annotated[ctypes.c_uint32, 32]
  max_num_tags: Annotated[ctypes.c_uint32, 36]
  xrcd_handle: Annotated[ctypes.c_uint32, 40]
  cq_handle: Annotated[ctypes.c_uint32, 44]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 48]
@record
class struct_ib_uverbs_create_srq_resp:
  SIZE = 16
  srq_handle: Annotated[ctypes.c_uint32, 0]
  max_wr: Annotated[ctypes.c_uint32, 4]
  max_sge: Annotated[ctypes.c_uint32, 8]
  srqn: Annotated[ctypes.c_uint32, 12]
  driver_data: Annotated[Array[ctypes.c_uint32, Literal[0]], 16]
@record
class struct_ib_uverbs_modify_srq:
  SIZE = 16
  srq_handle: Annotated[ctypes.c_uint32, 0]
  attr_mask: Annotated[ctypes.c_uint32, 4]
  max_wr: Annotated[ctypes.c_uint32, 8]
  srq_limit: Annotated[ctypes.c_uint32, 12]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 16]
@record
class struct_ib_uverbs_query_srq:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  srq_handle: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
  driver_data: Annotated[Array[ctypes.c_uint64, Literal[0]], 16]
@record
class struct_ib_uverbs_query_srq_resp:
  SIZE = 16
  max_wr: Annotated[ctypes.c_uint32, 0]
  max_sge: Annotated[ctypes.c_uint32, 4]
  srq_limit: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_destroy_srq:
  SIZE = 16
  response: Annotated[ctypes.c_uint64, 0]
  srq_handle: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_destroy_srq_resp:
  SIZE = 4
  events_reported: Annotated[ctypes.c_uint32, 0]
@record
class struct_ib_uverbs_ex_create_wq:
  SIZE = 40
  comp_mask: Annotated[ctypes.c_uint32, 0]
  wq_type: Annotated[ctypes.c_uint32, 4]
  user_handle: Annotated[ctypes.c_uint64, 8]
  pd_handle: Annotated[ctypes.c_uint32, 16]
  cq_handle: Annotated[ctypes.c_uint32, 20]
  max_wr: Annotated[ctypes.c_uint32, 24]
  max_sge: Annotated[ctypes.c_uint32, 28]
  create_flags: Annotated[ctypes.c_uint32, 32]
  reserved: Annotated[ctypes.c_uint32, 36]
@record
class struct_ib_uverbs_ex_create_wq_resp:
  SIZE = 24
  comp_mask: Annotated[ctypes.c_uint32, 0]
  response_length: Annotated[ctypes.c_uint32, 4]
  wq_handle: Annotated[ctypes.c_uint32, 8]
  max_wr: Annotated[ctypes.c_uint32, 12]
  max_sge: Annotated[ctypes.c_uint32, 16]
  wqn: Annotated[ctypes.c_uint32, 20]
@record
class struct_ib_uverbs_ex_destroy_wq:
  SIZE = 8
  comp_mask: Annotated[ctypes.c_uint32, 0]
  wq_handle: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_ex_destroy_wq_resp:
  SIZE = 16
  comp_mask: Annotated[ctypes.c_uint32, 0]
  response_length: Annotated[ctypes.c_uint32, 4]
  events_reported: Annotated[ctypes.c_uint32, 8]
  reserved: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_ex_modify_wq:
  SIZE = 24
  attr_mask: Annotated[ctypes.c_uint32, 0]
  wq_handle: Annotated[ctypes.c_uint32, 4]
  wq_state: Annotated[ctypes.c_uint32, 8]
  curr_wq_state: Annotated[ctypes.c_uint32, 12]
  flags: Annotated[ctypes.c_uint32, 16]
  flags_mask: Annotated[ctypes.c_uint32, 20]
@record
class struct_ib_uverbs_ex_create_rwq_ind_table:
  SIZE = 8
  comp_mask: Annotated[ctypes.c_uint32, 0]
  log_ind_tbl_size: Annotated[ctypes.c_uint32, 4]
  wq_handles: Annotated[Array[ctypes.c_uint32, Literal[0]], 8]
@record
class struct_ib_uverbs_ex_create_rwq_ind_table_resp:
  SIZE = 16
  comp_mask: Annotated[ctypes.c_uint32, 0]
  response_length: Annotated[ctypes.c_uint32, 4]
  ind_tbl_handle: Annotated[ctypes.c_uint32, 8]
  ind_tbl_num: Annotated[ctypes.c_uint32, 12]
@record
class struct_ib_uverbs_ex_destroy_rwq_ind_table:
  SIZE = 8
  comp_mask: Annotated[ctypes.c_uint32, 0]
  ind_tbl_handle: Annotated[ctypes.c_uint32, 4]
@record
class struct_ib_uverbs_cq_moderation:
  SIZE = 4
  cq_count: Annotated[ctypes.c_uint16, 0]
  cq_period: Annotated[ctypes.c_uint16, 2]
@record
class struct_ib_uverbs_ex_modify_cq:
  SIZE = 16
  cq_handle: Annotated[ctypes.c_uint32, 0]
  attr_mask: Annotated[ctypes.c_uint32, 4]
