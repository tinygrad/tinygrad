...
# ETHERNET_LL_SIZE = ETH_ALEN # macro
...
try:
    ...
    pass
__all__ = \
    ['IBV_ACCESS_FLUSH_GLOBAL', 'IBV_ACCESS_FLUSH_PERSISTENT',
    'IBV_ACCESS_HUGETLB', 'IBV_ACCESS_LOCAL_WRITE',
    'IBV_ACCESS_MW_BIND', 'IBV_ACCESS_ON_DEMAND',
    'IBV_ACCESS_OPTIONAL_FIRST', 'IBV_ACCESS_OPTIONAL_RANGE',
    ...
    'IB_GRH_FLOWLABEL_MASK', 'IB_ROCE_UDP_ENCAP_VALID_PORT_MAX',
    ...
    'IB_UVERBS_SRQT_TM', 'IB_UVERBS_SRQT_XRC', 'IB_UVERBS_WC_BIND_MW',
    'IB_UVERBS_WC_COMP_SWAP', 'IB_UVERBS_WC_FETCH_ADD',
    'IB_UVERBS_WC_LOCAL_INV', 'IB_UVERBS_WC_RDMA_READ',
    'IB_UVERBS_WC_RDMA_WRITE', 'IB_UVERBS_WC_SEND',
    'IB_UVERBS_WC_TSO', 'IB_UVERBS_WQT_RQ',
    ...
    'IB_UVERBS_WR_ATOMIC_FETCH_AND_ADD', 'IB_UVERBS_WR_BIND_MW',
    ...
    'c__Ea_IB_UVERBS_CREATE_QP_SUP_COMP_MASK',
    'ib_uverbs_access_flags', 'ib_uverbs_advise_mr_advice',
    'ib_uverbs_advise_mr_flag', 'ib_uverbs_core_support',
    'ib_uverbs_create_qp_mask', 'ib_uverbs_ex_create_cq_flags',
    ...
    'ib_uverbs_read_counters_flags', 'ib_uverbs_srq_type',
    'ib_uverbs_wc_opcode', 'ib_uverbs_wq_flags', 'ib_uverbs_wq_type',
    'ib_uverbs_wr_opcode', 'ib_uverbs_write_cmds', 'ibv_access_flags',
    'ibv_ack_async_event', 'ibv_ack_cq_events', 'ibv_advise_mr',
    'ibv_advise_mr_advice', 'ibv_alloc_dm', 'ibv_alloc_mw',
    'ibv_alloc_null_mr', 'ibv_alloc_parent_domain', 'ibv_alloc_pd',
    'ibv_alloc_td', 'ibv_atomic_cap',
    'ibv_attach_counters_point_flow', 'ibv_attach_mcast',
    'ibv_bind_mw', 'ibv_close_device', 'ibv_close_xrcd',
    'ibv_counter_description', 'ibv_cq_attr_mask', 'ibv_cq_ex_to_cq',
    'ibv_cq_init_attr_mask', 'ibv_create_ah', 'ibv_create_ah_from_wc',
    'ibv_create_comp_channel', 'ibv_create_counters', 'ibv_create_cq',
