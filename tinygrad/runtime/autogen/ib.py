...
@dll.bind
def ibv_wc_status_str(status:ctypes.c_uint32) -> ctypes.POINTER(ctypes.c_char): ...
...
class struct_ibv_rwq_ind_table_init_attr(c.Struct):
  ...
  ind_tbl: 'ctypes._Pointer[ctypes._Pointer[struct_ibv_wq]]'
  comp_mask: 'int'
...
class struct_ibv_rx_hash_conf(c.Struct):
  ...
  rx_hash_function: 'int'
  rx_hash_key_len: 'int'
  rx_hash_key: 'ctypes._Pointer[int]'
  rx_hash_fields_mask: 'int'
...
@dll.bind
def ibv_wr_opcode_str(opcode:ctypes.c_uint32) -> ctypes.POINTER(ctypes.c_char): ...
...
@dll.bind
def ibv_reg_mr_iova2(pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.c_void_p, length:size_t, iova:uint64_t, access:ctypes.c_uint32) -> ctypes.POINTER(struct_ibv_mr): ...
@dll.bind
def ibv_reg_mr(pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.c_void_p, length:size_t, access:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_mr): ...
@dll.bind
def ibv_reg_mr_iova(pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.c_void_p, length:size_t, iova:uint64_t, access:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_mr): ...
@dll.bind
...
@dll.bind
def ibv_rereg_mr(mr:ctypes.POINTER(struct_ibv_mr), flags:ctypes.c_int32, pd:ctypes.POINTER(struct_ibv_pd), addr:ctypes.c_void_p, length:size_t, access:ctypes.c_int32) -> ctypes.c_int32: ...
@dll.bind
...
@dll.bind
def ibv_create_cq(context:ctypes.POINTER(struct_ibv_context), cqe:ctypes.c_int32, cq_context:ctypes.c_void_p, channel:ctypes.POINTER(struct_ibv_comp_channel), comp_vector:ctypes.c_int32) -> ctypes.POINTER(struct_ibv_cq): ...
@dll.bind
...
@dll.bind
def ibv_get_cq_event(channel:ctypes.POINTER(struct_ibv_comp_channel), cq:ctypes.POINTER(ctypes.POINTER(struct_ibv_cq)), cq_context:ctypes.POINTER(ctypes.c_void_p)) -> ctypes.c_int32: ...
@dll.bind
...
@dll.bind
def ibv_query_qp_data_in_order(qp:ctypes.POINTER(struct_ibv_qp), op:ctypes.c_uint32, flags:uint32_t) -> ctypes.c_int32: ...
@dll.bind
...
@dll.bind
def ibv_node_type_str(node_type:ctypes.c_int32) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
def ibv_port_state_str(port_state:ctypes.c_uint32) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
def ibv_event_type_str(event:ctypes.c_uint32) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
...
class struct_ib_uverbs_post_send(c.Struct):
  ...
  sge_count: 'int'
  wqe_size: 'int'
  send_wr: 'list[struct_ib_uverbs_send_wr]'
...
class struct_ib_uverbs_post_recv(c.Struct):
  ...
  sge_count: 'int'
  wqe_size: 'int'
  recv_wr: 'list[struct_ib_uverbs_recv_wr]'
...
class struct_ib_uverbs_post_srq_recv(c.Struct):
  ...
  sge_count: 'int'
  wqe_size: 'int'
  recv: 'list[struct_ib_uverbs_recv_wr]'
...
class struct_ib_uverbs_flow_attr(c.Struct):
  ...
  port: 'int'
  flags: 'int'
  flow_specs: 'list[struct_ib_uverbs_flow_spec_hdr]'
