...
union_ibv_gid_global._fields_ = [
  ...
  ('interface_id', ctypes.c_ulonglong),
]
union_ibv_gid._fields_ = [
  ('raw', (uint8_t * 16)),
  ('global', union_ibv_gid_global),
]
enum_ibv_gid_type = CEnum(ctypes.c_uint)
...
enum_ibv_node_type = CEnum(ctypes.c_int)
...
enum_ibv_transport_type = CEnum(ctypes.c_int)
...
enum_ibv_device_cap_flags = CEnum(ctypes.c_uint)
...
enum_ibv_fork_status = CEnum(ctypes.c_uint)
...
enum_ibv_atomic_cap = CEnum(ctypes.c_uint)
...
struct_ibv_device_attr._fields_ = [
  ...
  ('sys_image_guid', ctypes.c_ulonglong),
  ...
  ('hw_ver', uint32_t),
  ('max_qp', ctypes.c_int),
  ('max_qp_wr', ctypes.c_int),
  ('device_cap_flags', ctypes.c_uint),
  ('max_sge', ctypes.c_int),
  ('max_sge_rd', ctypes.c_int),
  ('max_cq', ctypes.c_int),
  ('max_cqe', ctypes.c_int),
  ('max_mr', ctypes.c_int),
  ('max_pd', ctypes.c_int),
  ('max_qp_rd_atom', ctypes.c_int),
  ('max_ee_rd_atom', ctypes.c_int),
  ('max_res_rd_atom', ctypes.c_int),
  ('max_qp_init_rd_atom', ctypes.c_int),
  ('max_ee_init_rd_atom', ctypes.c_int),
  ('atomic_cap', enum_ibv_atomic_cap),
  ('max_ee', ctypes.c_int),
  ('max_rdd', ctypes.c_int),
  ('max_mw', ctypes.c_int),
  ('max_raw_ipv6_qp', ctypes.c_int),
  ('max_raw_ethy_qp', ctypes.c_int),
  ('max_mcast_grp', ctypes.c_int),
  ('max_mcast_qp_attach', ctypes.c_int),
  ('max_total_mcast_qp_attach', ctypes.c_int),
  ('max_ah', ctypes.c_int),
  ('max_fmr', ctypes.c_int),
  ('max_map_per_fmr', ctypes.c_int),
  ('max_srq', ctypes.c_int),
  ('max_srq_wr', ctypes.c_int),
  ('max_srq_sge', ctypes.c_int),
  ('max_pkeys', uint16_t),
...
enum_ibv_mw_type = CEnum(ctypes.c_uint)
...
enum_ibv_qp_state = CEnum(ctypes.c_uint)
...
enum_ibv_qp_type = CEnum(ctypes.c_uint)
...
enum_ibv_wc_opcode = CEnum(ctypes.c_uint)
...
struct_ibv_context._fields_ = [
  ...
  ('cmd_fd', ctypes.c_int),
  ('async_fd', ctypes.c_int),
  ('num_comp_vectors', ctypes.c_int),
  ('mutex', pthread_mutex_t),
...
enum_ibv_odp_transport_cap_bits = CEnum(ctypes.c_uint)
...
enum_ibv_odp_general_caps = CEnum(ctypes.c_uint)
...
enum_ibv_rx_hash_function_flags = CEnum(ctypes.c_uint)
IBV_RX_HASH_FUNC_TOEPLITZ = enum_ibv_rx_hash_function_flags.define('IBV_RX_HASH_FUNC_TOEPLITZ', 1)

enum_ibv_rx_hash_fields = CEnum(ctypes.c_uint)
...
enum_ibv_raw_packet_caps = CEnum(ctypes.c_uint)
...
enum_ibv_pci_atomic_op_size = CEnum(ctypes.c_uint)
...
enum_ibv_mtu = CEnum(ctypes.c_uint)
...
enum_ibv_port_state = CEnum(ctypes.c_uint)
...
enum_ibv_port_cap_flags2 = CEnum(ctypes.c_uint)
...
enum_ibv_event_type = CEnum(ctypes.c_uint)
...
enum_ibv_wq_type = CEnum(ctypes.c_uint)
...
enum_ibv_access_flags = CEnum(ctypes.c_uint)
...
enum_ibv_xrcd_init_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_rereg_mr_flags = CEnum(ctypes.c_uint)
...
struct_ibv_grh._fields_ = [
  ...
  ('paylen', ctypes.c_ushort),
  ('next_hdr', uint8_t),
  ('hop_limit', uint8_t),
  ('sgid', union_ibv_gid),
  ('dgid', union_ibv_gid),
]
enum_ibv_rate = CEnum(ctypes.c_uint)
...
enum_ibv_srq_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_srq_type = CEnum(ctypes.c_uint)
...
enum_ibv_srq_init_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_wq_init_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_wq_flags = CEnum(ctypes.c_uint)
...
enum_ibv_wq_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_qp_init_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_qp_create_flags = CEnum(ctypes.c_uint)
...
enum_ibv_qp_create_send_ops_flags = CEnum(ctypes.c_uint)
...
enum_ibv_qp_open_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_qp_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_query_qp_data_in_order_flags = CEnum(ctypes.c_uint)
...
enum_ibv_query_qp_data_in_order_caps = CEnum(ctypes.c_uint)
...
enum_ibv_mig_state = CEnum(ctypes.c_uint)
...
enum_ibv_placement_type = CEnum(ctypes.c_uint)
...
enum_ibv_selectivity_level = CEnum(ctypes.c_uint)
...
enum_ibv_ops_wr_opcode = CEnum(ctypes.c_uint)
...
enum_ibv_ops_flags = CEnum(ctypes.c_uint)
...
enum_ibv_flow_flags = CEnum(ctypes.c_uint)
...
enum_ibv_flow_attr_type = CEnum(ctypes.c_uint)
...
enum_ibv_flow_spec_type = CEnum(ctypes.c_uint)
...
struct_ib_uverbs_flow_action_esp._fields_ = [
  ('spi', ctypes.c_uint),
  ('seq', ctypes.c_uint),
  ('tfc_pad', ctypes.c_uint),
  ('flags', ctypes.c_uint),
  ('hard_limit_pkts', ctypes.c_ulonglong),
]
enum_ib_uverbs_flow_action_esp_keymat = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_flow_action_esp_replay = CEnum(ctypes.c_uint)
...
enum_ibv_create_cq_attr_flags = CEnum(ctypes.c_uint)
...
enum_ibv_parent_domain_init_attr_mask = CEnum(ctypes.c_uint)
...
enum_ibv_counter_description = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_access_flags = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_srq_type = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_wq_type = CEnum(ctypes.c_uint)
IB_UVERBS_WQT_RQ = enum_ib_uverbs_wq_type.define('IB_UVERBS_WQT_RQ', 0)

enum_ib_uverbs_wq_flags = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_qp_type = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_qp_create_flags = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_query_port_cap_flags = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_query_port_flags = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_flow_action_esp_flags = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_read_counters_flags = CEnum(ctypes.c_uint)
...
struct_ib_uverbs_query_port_resp._fields_ = [
  ...
  ('max_msg_sz', ctypes.c_uint),
  ('bad_pkey_cntr', ctypes.c_uint),
  ('qkey_viol_cntr', ctypes.c_uint),
  ('gid_tbl_len', ctypes.c_uint),
  ('pkey_tbl_len', ctypes.c_ushort),
  ('lid', ctypes.c_ushort),
  ('sm_lid', ctypes.c_ushort),
...
struct_ib_uverbs_query_port_resp_ex._fields_ = [
  ...
  ('port_cap_flags2', ctypes.c_ushort),
...
struct_ib_uverbs_qp_cap._fields_ = [
  ...
  ('max_send_sge', ctypes.c_uint),
  ('max_recv_sge', ctypes.c_uint),
  ('max_inline_data', ctypes.c_uint),
]
enum_rdma_driver_id = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_gid_type = CEnum(ctypes.c_uint)
...
struct_ib_uverbs_gid_entry._fields_ = [
  ...
  ('port_num', ctypes.c_uint),
  ('gid_type', ctypes.c_uint),
  ('netdev_ifindex', ctypes.c_uint),
]
enum_ib_uverbs_write_cmds = CEnum(ctypes.c_uint)
...
enum_ib_selectivity_level = CEnum(ctypes.c_uint)
...
struct_ib_uverbs_query_device_resp._fields_ = [
  ...
  ('node_guid', ctypes.c_ulonglong),
  ('sys_image_guid', ctypes.c_ulonglong),
  ('max_mr_size', ctypes.c_ulonglong),
  ('page_size_cap', ctypes.c_ulonglong),
  ('vendor_id', ctypes.c_uint),
  ('vendor_part_id', ctypes.c_uint),
  ('hw_ver', ctypes.c_uint),
  ('max_qp', ctypes.c_uint),
  ('max_qp_wr', ctypes.c_uint),
  ('device_cap_flags', ctypes.c_uint),
  ('max_sge', ctypes.c_uint),
  ('max_sge_rd', ctypes.c_uint),
  ('max_cq', ctypes.c_uint),
  ('max_cqe', ctypes.c_uint),
  ('max_mr', ctypes.c_uint),
  ('max_pd', ctypes.c_uint),
  ('max_qp_rd_atom', ctypes.c_uint),
  ('max_ee_rd_atom', ctypes.c_uint),
  ('max_res_rd_atom', ctypes.c_uint),
  ('max_qp_init_rd_atom', ctypes.c_uint),
  ('max_ee_init_rd_atom', ctypes.c_uint),
  ('atomic_cap', ctypes.c_uint),
  ('max_ee', ctypes.c_uint),
  ('max_rdd', ctypes.c_uint),
  ('max_mw', ctypes.c_uint),
  ('max_raw_ipv6_qp', ctypes.c_uint),
  ('max_raw_ethy_qp', ctypes.c_uint),
  ('max_mcast_grp', ctypes.c_uint),
  ('max_mcast_qp_attach', ctypes.c_uint),
  ('max_total_mcast_qp_attach', ctypes.c_uint),
  ('max_ah', ctypes.c_uint),
  ('max_fmr', ctypes.c_uint),
  ('max_map_per_fmr', ctypes.c_uint),
  ('max_srq', ctypes.c_uint),
  ('max_srq_wr', ctypes.c_uint),
  ('max_srq_sge', ctypes.c_uint),
  ('max_pkeys', ctypes.c_ushort),
...
struct_ib_uverbs_odp_caps_per_transport_caps._fields_ = [
  ...
  ('ud_odp_caps', ctypes.c_uint),
]
struct_ib_uverbs_odp_caps._fields_ = [
  ('general_caps', ctypes.c_ulonglong),
...
struct_ib_uverbs_ex_query_device_resp._fields_ = [
  ...
  ('timestamp_mask', ctypes.c_ulonglong),
  ('hca_core_clock', ctypes.c_ulonglong),
  ('device_cap_flags_ex', ctypes.c_ulonglong),
  ('rss_caps', struct_ib_uverbs_rss_caps),
  ('max_wq_type_rq', ctypes.c_uint),
  ('raw_packet_caps', ctypes.c_uint),
  ('tm_caps', struct_ib_uverbs_tm_caps),
  ('cq_moderation_caps', struct_ib_uverbs_cq_moderation_caps),
  ('max_dm_size', ctypes.c_ulonglong),
...
struct_ib_uverbs_create_cq._fields_ = [
  ...
  ('cqe', ctypes.c_uint),
  ('comp_vector', ctypes.c_uint),
  ('comp_channel', ctypes.c_int),
  ('reserved', ctypes.c_uint),
  ('driver_data', (ctypes.c_ulonglong * 0)),
]
enum_ib_uverbs_ex_create_cq_flags = CEnum(ctypes.c_uint)
...
enum_ib_uverbs_wc_opcode = CEnum(ctypes.c_uint)
...
struct_ib_uverbs_wc._fields_ = [
  ...
  ('vendor_err', ctypes.c_uint),
  ('byte_len', ctypes.c_uint),
  ('ex', struct_ib_uverbs_wc_ex),
  ('qp_num', ctypes.c_uint),
  ('src_qp', ctypes.c_uint),
  ('wc_flags', ctypes.c_uint),
  ('pkey_index', ctypes.c_ushort),
  ('slid', ctypes.c_ushort),
  ('sl', ctypes.c_ubyte),
...
struct_ib_uverbs_qp_attr._fields_ = [
  ...
  ('cur_qp_state', ctypes.c_uint),
  ('path_mtu', ctypes.c_uint),
  ('path_mig_state', ctypes.c_uint),
  ('qkey', ctypes.c_uint),
  ('rq_psn', ctypes.c_uint),
  ('sq_psn', ctypes.c_uint),
  ('dest_qp_num', ctypes.c_uint),
  ('qp_access_flags', ctypes.c_uint),
  ...
  ('max_inline_data', ctypes.c_uint),
  ('pkey_index', ctypes.c_ushort),
  ('alt_pkey_index', ctypes.c_ushort),
...
struct_ib_uverbs_create_qp._fields_ = [
  ...
  ('user_handle', ctypes.c_ulonglong),
  ('pd_handle', ctypes.c_uint),
  ('send_cq_handle', ctypes.c_uint),
  ('recv_cq_handle', ctypes.c_uint),
...
enum_ib_uverbs_wr_opcode = CEnum(ctypes.c_uint)
...
struct_ib_uverbs_post_send._fields_ = [
  ('response', ctypes.c_ulonglong),
  ('qp_handle', ctypes.c_uint),
  ('wr_count', ctypes.c_uint),
  ('sge_count', ctypes.c_uint),
...
struct_ib_uverbs_ex_modify_wq._fields_ = [
  ('attr_mask', ctypes.c_uint),
  ('wq_handle', ctypes.c_uint),
  ('wq_state', ctypes.c_uint),
  ('curr_wq_state', ctypes.c_uint),
  ('flags', ctypes.c_uint),
...
enum_ib_uverbs_device_cap_flags = CEnum(ctypes.c_ulong)
...
enum_ib_uverbs_raw_packet_caps = CEnum(ctypes.c_uint)
