...
class nvrtcResult(ctypes.c_uint32, c.Enum): pass
...
@dll.bind
def nvrtcGetErrorString(result:nvrtcResult) -> c.POINTER[ctypes.c_char]: ...
@dll.bind
def nvrtcVersion(major:c.POINTER[ctypes.c_int32], minor:c.POINTER[ctypes.c_int32]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetNumSupportedArchs(numArchs:c.POINTER[ctypes.c_int32]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetSupportedArchs(supportedArchs:c.POINTER[ctypes.c_int32]) -> nvrtcResult: ...
class struct__nvrtcProgram(c.Struct): pass
nvrtcProgram: TypeAlias = c.POINTER[struct__nvrtcProgram]
@dll.bind
def nvrtcCreateProgram(prog:c.POINTER[nvrtcProgram], src:c.POINTER[ctypes.c_char], name:c.POINTER[ctypes.c_char], numHeaders:ctypes.c_int32, headers:c.POINTER[c.POINTER[ctypes.c_char]], includeNames:c.POINTER[c.POINTER[ctypes.c_char]]) -> nvrtcResult: ...
@dll.bind
def nvrtcDestroyProgram(prog:c.POINTER[nvrtcProgram]) -> nvrtcResult: ...
@dll.bind
def nvrtcCompileProgram(prog:nvrtcProgram, numOptions:ctypes.c_int32, options:c.POINTER[c.POINTER[ctypes.c_char]]) -> nvrtcResult: ...
size_t: TypeAlias = ctypes.c_uint64
@dll.bind
def nvrtcGetPTXSize(prog:nvrtcProgram, ptxSizeRet:c.POINTER[size_t]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetPTX(prog:nvrtcProgram, ptx:c.POINTER[ctypes.c_char]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetCUBINSize(prog:nvrtcProgram, cubinSizeRet:c.POINTER[size_t]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetCUBIN(prog:nvrtcProgram, cubin:c.POINTER[ctypes.c_char]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetNVVMSize(prog:nvrtcProgram, nvvmSizeRet:c.POINTER[size_t]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetNVVM(prog:nvrtcProgram, nvvm:c.POINTER[ctypes.c_char]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetLTOIRSize(prog:nvrtcProgram, LTOIRSizeRet:c.POINTER[size_t]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetLTOIR(prog:nvrtcProgram, LTOIR:c.POINTER[ctypes.c_char]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetOptiXIRSize(prog:nvrtcProgram, optixirSizeRet:c.POINTER[size_t]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetOptiXIR(prog:nvrtcProgram, optixir:c.POINTER[ctypes.c_char]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetProgramLogSize(prog:nvrtcProgram, logSizeRet:c.POINTER[size_t]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetProgramLog(prog:nvrtcProgram, log:c.POINTER[ctypes.c_char]) -> nvrtcResult: ...
@dll.bind
def nvrtcAddNameExpression(prog:nvrtcProgram, name_expression:c.POINTER[ctypes.c_char]) -> nvrtcResult: ...
@dll.bind
def nvrtcGetLoweredName(prog:nvrtcProgram, name_expression:c.POINTER[ctypes.c_char], lowered_name:c.POINTER[c.POINTER[ctypes.c_char]]) -> nvrtcResult: ...
