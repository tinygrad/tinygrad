...
@dll.bind
def nvrtcCreateProgram(prog:c.POINTER[nvrtcProgram], src:c.POINTER[ctypes.c_char], name:c.POINTER[ctypes.c_char], numHeaders:ctypes.c_int32, headers:c.POINTER[c.POINTER[ctypes.c_char]], includeNames:c.POINTER[c.POINTER[ctypes.c_char]]) -> ctypes.c_uint32: ...
@dll.bind
def nvrtcDestroyProgram(prog:c.POINTER[nvrtcProgram]) -> ctypes.c_uint32: ...
@dll.bind
def nvrtcCompileProgram(prog:nvrtcProgram, numOptions:ctypes.c_int32, options:c.POINTER[c.POINTER[ctypes.c_char]]) -> ctypes.c_uint32: ...
