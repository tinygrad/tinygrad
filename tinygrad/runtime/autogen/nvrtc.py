...
NVRTC_ERROR_TIME_FILE_WRITE_FAILED = nvrtcResult.define('NVRTC_ERROR_TIME_FILE_WRITE_FAILED', 12)

# const char *nvrtcGetErrorString(nvrtcResult result)
try: (nvrtcGetErrorString:=dll.nvrtcGetErrorString).restype,nvrtcGetErrorString.argtypes = ctypes.c_char_p,[nvrtcResult]
...
try: (nvrtcCompileProgram:=dll.nvrtcCompileProgram).restype,nvrtcCompileProgram.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_int, ctypes.POINTER(ctypes.c_char_p)]
except AttributeError: pass
...
try: (nvrtcGetPTX:=dll.nvrtcGetPTX).restype,nvrtcGetPTX.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_char_p]
except AttributeError: pass
...
try: (nvrtcGetCUBIN:=dll.nvrtcGetCUBIN).restype,nvrtcGetCUBIN.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_char_p]
except AttributeError: pass
...
try: (nvrtcGetNVVM:=dll.nvrtcGetNVVM).restype,nvrtcGetNVVM.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_char_p]
except AttributeError: pass
...
try: (nvrtcGetLTOIR:=dll.nvrtcGetLTOIR).restype,nvrtcGetLTOIR.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_char_p]
except AttributeError: pass
...
try: (nvrtcGetOptiXIR:=dll.nvrtcGetOptiXIR).restype,nvrtcGetOptiXIR.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_char_p]
except AttributeError: pass
...
try: (nvrtcGetProgramLog:=dll.nvrtcGetProgramLog).restype,nvrtcGetProgramLog.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_char_p]
except AttributeError: pass

# nvrtcResult nvrtcAddNameExpression(nvrtcProgram prog, const char *const name_expression)
try: (nvrtcAddNameExpression:=dll.nvrtcAddNameExpression).restype,nvrtcAddNameExpression.argtypes = nvrtcResult,[nvrtcProgram, ctypes.c_char_p]
except AttributeError: pass
