...
class struct_sqtt_file_chunk_asic_info(c.Struct):
  ...
  lds_granularity: 'int'
  cu_mask: 'list[list[int]]'
  reserved1: 'list[bytes]'
  active_pixel_packer_mask: 'list[int]'
  reserved2: 'list[bytes]'
  gl1_cache_size: 'int'
...
class struct_sqtt_pso_correlation_record(c.Struct):
  SIZE = 88
  api_pso_hash: 'int'
  pipeline_hash: 'list[int]'
  api_level_obj_name: 'list[bytes]'
