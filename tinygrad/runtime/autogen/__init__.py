...
def __getattr__(nm):
  match nm:
    case "libc":
      return load("libc", ["/usr/include/sys/mman.h", "/usr/include/bits/mman-shared.h", "/usr/include/string.h", "/usr/include/elf.h", "/usr/include/unistd.h", "/usr/include/asm-generic/mman-common.h"],
