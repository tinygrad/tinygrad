...
try:
    ...
    pass
try:
    glsl_apply_signedness_to_base_type = _libraries['FIXME_STUB'].glsl_apply_signedness_to_base_type
...
__all__ = \
    ...
    'PIPE_FORMAT_Z32_UNORM', 'blob_align', 'blob_copy_bytes',
    ...
    'decode_type_from_blob', 'encode_type_to_blob',
    ...
    'glsl_without_array_or_matrix', 'intptr_t', 'mesa_shader_stage',
    ...
    'nir_lower_bit_count64', 'nir_lower_bitfield_extract64',
    'nir_lower_bitfield_reverse64', 'nir_lower_conv64',
    'nir_lower_dceil', 'nir_lower_ddiv', 'nir_lower_dfloor',
    'nir_lower_dfract', 'nir_lower_divmod64', 'nir_lower_dminmax',
    'nir_lower_dmod', 'nir_lower_doubles_options',
    ...
    'nv_device_uuid', 'pipe_format', 'size_t', 'struct_blob',
    'struct_blob_reader', 'struct_glsl_cmat_description',
    'struct_glsl_struct_field', 'struct_glsl_struct_field_0_0',
    'struct_glsl_type', 'struct_nak_compiler', 'struct_nak_fs_key',
