...
class struct_kfd_ioctl_dbg_trap_args_deprecated(Struct): pass
struct_kfd_ioctl_dbg_trap_args_deprecated._fields_ = [
...
class struct_kfd_ioctl_spm_args(Struct): pass
...
class struct_kfd_ioctl_ipc_export_handle_args(Struct): pass
...
class struct_kfd_ioctl_ipc_import_handle_args(Struct): pass
...
class struct_kfd_ioctl_cross_memory_copy_deprecated_args(Struct): pass
struct_kfd_ioctl_cross_memory_copy_deprecated_args._fields_ = [
  ('pid', ctypes.c_uint32),
  ('flags', ctypes.c_uint32),
...
class struct_kfd_pc_sample_info(Struct): pass
struct_kfd_pc_sample_info._fields_ = [
...
class struct_kfd_ioctl_pc_sample_args(Struct): pass
struct_kfd_ioctl_pc_sample_args._fields_ = [
...
class struct_kfd_ioctl_pmc_settings(Struct): pass
struct_kfd_ioctl_pmc_settings._fields_ = [
  ('gpu_id', ctypes.c_uint32),
  ('lock', ctypes.c_uint32),
  ('perfcount_enable', ctypes.c_uint32),
]
class struct_kfd_ioctl_profiler_args(Struct): pass
class struct_kfd_ioctl_profiler_args_0(ctypes.Union): pass
struct_kfd_ioctl_profiler_args_0._fields_ = [
  ('pc_sample', struct_kfd_ioctl_pc_sample_args),
  ('pmc', struct_kfd_ioctl_pmc_settings),
  ('version', ctypes.c_uint32),
]
struct_kfd_ioctl_profiler_args._anonymous_ = ['_0']
struct_kfd_ioctl_profiler_args._fields_ = [
  ('op', ctypes.c_uint32),
  ('_0', struct_kfd_ioctl_profiler_args_0),
]
