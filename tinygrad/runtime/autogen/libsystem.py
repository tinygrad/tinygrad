...
try: (object_getClassName:=dll.object_getClassName).restype, object_getClassName.argtypes = ctypes.POINTER(ctypes.c_char), [objc_id]
except AttributeError: pass
...
try: (object_getIndexedIvars:=dll.object_getIndexedIvars).restype, object_getIndexedIvars.argtypes = ctypes.c_void_p, [objc_id]
except AttributeError: pass
...
try: (objc_retainedObject:=dll.objc_retainedObject).restype, objc_retainedObject.argtypes = objc_id, [objc_objectptr_t]
except AttributeError: pass
...
try: (objc_unretainedObject:=dll.objc_unretainedObject).restype, objc_unretainedObject.argtypes = objc_id, [objc_objectptr_t]
except AttributeError: pass
...
try: (objc_unretainedPointer:=dll.objc_unretainedPointer).restype, objc_unretainedPointer.argtypes = objc_objectptr_t, [objc_id]
except AttributeError: pass
...
try: (os_workgroup_copy_port:=dll.os_workgroup_copy_port).restype, os_workgroup_copy_port.argtypes = ctypes.c_int, [objc_id, ctypes.POINTER(mach_port_t)]
except AttributeError: pass
...
try: (os_workgroup_create_with_port:=dll.os_workgroup_create_with_port).restype, os_workgroup_create_with_port.argtypes = objc_instance, [ctypes.POINTER(ctypes.c_char), mach_port_t]
except AttributeError: pass
...
try: (os_workgroup_create_with_workgroup:=dll.os_workgroup_create_with_workgroup).restype, os_workgroup_create_with_workgroup.argtypes = objc_instance, [ctypes.POINTER(ctypes.c_char), objc_id]
except AttributeError: pass
...
try: (os_workgroup_join:=dll.os_workgroup_join).restype, os_workgroup_join.argtypes = ctypes.c_int, [objc_id, os_workgroup_join_token_t]
except AttributeError: pass
...
try: (os_workgroup_leave:=dll.os_workgroup_leave).restype, os_workgroup_leave.argtypes = None, [objc_id, os_workgroup_join_token_t]
except AttributeError: pass
...
try: (os_workgroup_set_working_arena:=dll.os_workgroup_set_working_arena).restype, os_workgroup_set_working_arena.argtypes = ctypes.c_int, [objc_id, ctypes.c_void_p, uint32_t, os_workgroup_working_arena_destructor_t]
except AttributeError: pass
...
try: (os_workgroup_get_working_arena:=dll.os_workgroup_get_working_arena).restype, os_workgroup_get_working_arena.argtypes = ctypes.c_void_p, [objc_id, ctypes.POINTER(os_workgroup_index)]
except AttributeError: pass

# __attribute__((availability(macos, introduced=11.0))) __attribute__((availability(ios, introduced=14.0))) __attribute__((availability(tvos, introduced=14.0))) __attribute__((availability(watchos, introduced=7.0))) __attribute__((swift_private)) __attribute__((visibility("default"))) extern void os_workgroup_cancel(os_workgroup_t  _Nonnull wg)
try: (os_workgroup_cancel:=dll.os_workgroup_cancel).restype, os_workgroup_cancel.argtypes = None, [objc_id]
except AttributeError: pass

# __attribute__((availability(macos, introduced=11.0))) __attribute__((availability(ios, introduced=14.0))) __attribute__((availability(tvos, introduced=14.0))) __attribute__((availability(watchos, introduced=7.0))) __attribute__((swift_private)) __attribute__((visibility("default"))) extern int os_workgroup_testcancel(os_workgroup_t  _Nonnull wg)
try: (os_workgroup_testcancel:=dll.os_workgroup_testcancel).restype, os_workgroup_testcancel.argtypes = ctypes.c_int, [objc_id]
except AttributeError: pass
...
try: (os_workgroup_max_parallel_threads:=dll.os_workgroup_max_parallel_threads).restype, os_workgroup_max_parallel_threads.argtypes = ctypes.c_int, [objc_id, os_workgroup_mpt_attr_t]
except AttributeError: pass
...
try: (os_workgroup_interval_start:=dll.os_workgroup_interval_start).restype, os_workgroup_interval_start.argtypes = ctypes.c_int, [objc_id, uint64_t, uint64_t, os_workgroup_interval_data_t]
except AttributeError: pass
...
try: (os_workgroup_interval_update:=dll.os_workgroup_interval_update).restype, os_workgroup_interval_update.argtypes = ctypes.c_int, [objc_id, uint64_t, os_workgroup_interval_data_t]
except AttributeError: pass
...
try: (os_workgroup_interval_finish:=dll.os_workgroup_interval_finish).restype, os_workgroup_interval_finish.argtypes = ctypes.c_int, [objc_id, os_workgroup_interval_data_t]
except AttributeError: pass
...
try: (os_workgroup_parallel_create:=dll.os_workgroup_parallel_create).restype, os_workgroup_parallel_create.argtypes = objc_instance, [ctypes.POINTER(ctypes.c_char), os_workgroup_attr_t]
except AttributeError: pass
...
try: (dispatch_retain:=dll.dispatch_retain).restype, dispatch_retain.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_release:=dll.dispatch_release).restype, dispatch_release.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_get_context:=dll.dispatch_get_context).restype, dispatch_get_context.argtypes = ctypes.c_void_p, [objc_id]
except AttributeError: pass
...
try: (dispatch_set_context:=dll.dispatch_set_context).restype, dispatch_set_context.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_set_finalizer_f:=dll.dispatch_set_finalizer_f).restype, dispatch_set_finalizer_f.argtypes = None, [objc_id, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_activate:=dll.dispatch_activate).restype, dispatch_activate.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_suspend:=dll.dispatch_suspend).restype, dispatch_suspend.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_resume:=dll.dispatch_resume).restype, dispatch_resume.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_set_qos_class_floor:=dll.dispatch_set_qos_class_floor).restype, dispatch_set_qos_class_floor.argtypes = None, [objc_id, dispatch_qos_class_t, ctypes.c_int]
except AttributeError: pass
...
try: (dispatch_notify:=dll.dispatch_notify).restype, dispatch_notify.argtypes = None, [ctypes.c_void_p, objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_debug:=dll.dispatch_debug).restype, dispatch_debug.argtypes = None, [objc_id, ctypes.POINTER(ctypes.c_char)]
except AttributeError: pass
...
try: (dispatch_debugv:=dll.dispatch_debugv).restype, dispatch_debugv.argtypes = None, [objc_id, ctypes.POINTER(ctypes.c_char), ctypes.c_int]
except AttributeError: pass
...
try: (dispatch_async:=dll.dispatch_async).restype, dispatch_async.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_async_f:=dll.dispatch_async_f).restype, dispatch_async_f.argtypes = None, [objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass

# __attribute__((availability(macos, introduced=10.6))) __attribute__((availability(ios, introduced=4.0))) __attribute__((visibility("default"))) __attribute__((nonnull)) __attribute__((nothrow)) __attribute__((swift_name("DispatchQueue.sync(self:execute:)"))) extern void dispatch_sync(dispatch_queue_t  _Nonnull queue, __attribute__((noescape)) dispatch_block_t  _Nonnull block)
try: (dispatch_sync:=dll.dispatch_sync).restype, dispatch_sync.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_sync_f:=dll.dispatch_sync_f).restype, dispatch_sync_f.argtypes = None, [objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass

# __attribute__((availability(macos, introduced=10.14))) __attribute__((availability(ios, introduced=12.0))) __attribute__((availability(tvos, introduced=12.0))) __attribute__((availability(watchos, introduced=5.0))) __attribute__((visibility("default"))) __attribute__((nonnull)) __attribute__((nothrow)) __attribute__((swift_name("DispatchQueue.asyncAndWait(self:execute:)"))) extern void dispatch_async_and_wait(dispatch_queue_t  _Nonnull queue, __attribute__((noescape)) dispatch_block_t  _Nonnull block)
try: (dispatch_async_and_wait:=dll.dispatch_async_and_wait).restype, dispatch_async_and_wait.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_async_and_wait_f:=dll.dispatch_async_and_wait_f).restype, dispatch_async_and_wait_f.argtypes = None, [objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_apply_f:=dll.dispatch_apply_f).restype, dispatch_apply_f.argtypes = None, [size_t, objc_id, ctypes.c_void_p, ctypes.CFUNCTYPE(None, ctypes.c_void_p, size_t)]
except AttributeError: pass
...
try: (dispatch_get_current_queue:=dll.dispatch_get_current_queue).restype, dispatch_get_current_queue.argtypes = objc_id, []
except AttributeError: pass
...
try: (dispatch_get_global_queue:=dll.dispatch_get_global_queue).restype, dispatch_get_global_queue.argtypes = objc_id, [intptr_t, uintptr_t]
except AttributeError: pass
...
try: (dispatch_queue_attr_make_initially_inactive:=dll.dispatch_queue_attr_make_initially_inactive).restype, dispatch_queue_attr_make_initially_inactive.argtypes = objc_id, [objc_id]
except AttributeError: pass
...
try: (dispatch_queue_attr_make_with_autorelease_frequency:=dll.dispatch_queue_attr_make_with_autorelease_frequency).restype, dispatch_queue_attr_make_with_autorelease_frequency.argtypes = objc_id, [objc_id, dispatch_autorelease_frequency_t]
except AttributeError: pass
...
try: (dispatch_queue_attr_make_with_qos_class:=dll.dispatch_queue_attr_make_with_qos_class).restype, dispatch_queue_attr_make_with_qos_class.argtypes = objc_id, [objc_id, dispatch_qos_class_t, ctypes.c_int]
except AttributeError: pass
...
try: (dispatch_queue_create_with_target:=dll.dispatch_queue_create_with_target).restype, dispatch_queue_create_with_target.argtypes = objc_instance, [ctypes.POINTER(ctypes.c_char), objc_id, objc_id]
except AttributeError: pass

# __attribute__((availability(macos, introduced=10.6))) __attribute__((availability(ios, introduced=4.0))) __attribute__((visibility("default"))) __attribute__((malloc)) __attribute__((ns_returns_retained)) __attribute__((warn_unused_result(""))) __attribute__((nothrow)) __attribute__((swift_private)) __attribute__((swift_name("DispatchQueue.init(__label:attr:)"))) __attribute__((ns_returns_retained)) extern dispatch_queue_t  _Nonnull dispatch_queue_create(const char * _Nullable label, dispatch_queue_attr_t  _Nullable attr)
try: (dispatch_queue_create:=dll.dispatch_queue_create).restype, dispatch_queue_create.argtypes = objc_instance, [ctypes.POINTER(ctypes.c_char), objc_id]
except AttributeError: pass
...
try: (dispatch_queue_get_label:=dll.dispatch_queue_get_label).restype, dispatch_queue_get_label.argtypes = ctypes.POINTER(ctypes.c_char), [objc_id]
except AttributeError: pass
...
try: (dispatch_queue_get_qos_class:=dll.dispatch_queue_get_qos_class).restype, dispatch_queue_get_qos_class.argtypes = dispatch_qos_class_t, [objc_id, ctypes.POINTER(ctypes.c_int)]
except AttributeError: pass
...
try: (dispatch_set_target_queue:=dll.dispatch_set_target_queue).restype, dispatch_set_target_queue.argtypes = None, [objc_id, objc_id]
except AttributeError: pass
...
try: (dispatch_after:=dll.dispatch_after).restype, dispatch_after.argtypes = None, [dispatch_time_t, objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_after_f:=dll.dispatch_after_f).restype, dispatch_after_f.argtypes = None, [dispatch_time_t, objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_barrier_async:=dll.dispatch_barrier_async).restype, dispatch_barrier_async.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_barrier_async_f:=dll.dispatch_barrier_async_f).restype, dispatch_barrier_async_f.argtypes = None, [objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_barrier_sync:=dll.dispatch_barrier_sync).restype, dispatch_barrier_sync.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_barrier_sync_f:=dll.dispatch_barrier_sync_f).restype, dispatch_barrier_sync_f.argtypes = None, [objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_barrier_async_and_wait:=dll.dispatch_barrier_async_and_wait).restype, dispatch_barrier_async_and_wait.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_barrier_async_and_wait_f:=dll.dispatch_barrier_async_and_wait_f).restype, dispatch_barrier_async_and_wait_f.argtypes = None, [objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_queue_set_specific:=dll.dispatch_queue_set_specific).restype, dispatch_queue_set_specific.argtypes = None, [objc_id, ctypes.c_void_p, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_queue_get_specific:=dll.dispatch_queue_get_specific).restype, dispatch_queue_get_specific.argtypes = ctypes.c_void_p, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_assert_queue:=dll.dispatch_assert_queue).restype, dispatch_assert_queue.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_assert_queue_barrier:=dll.dispatch_assert_queue_barrier).restype, dispatch_assert_queue_barrier.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_assert_queue_not:=dll.dispatch_assert_queue_not).restype, dispatch_assert_queue_not.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_block_notify:=dll.dispatch_block_notify).restype, dispatch_block_notify.argtypes = None, [ctypes.c_void_p, objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_source_create:=dll.dispatch_source_create).restype, dispatch_source_create.argtypes = objc_instance, [dispatch_source_type_t, uintptr_t, uintptr_t, objc_id]
except AttributeError: pass
...
try: (dispatch_source_set_event_handler:=dll.dispatch_source_set_event_handler).restype, dispatch_source_set_event_handler.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_source_set_event_handler_f:=dll.dispatch_source_set_event_handler_f).restype, dispatch_source_set_event_handler_f.argtypes = None, [objc_id, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_source_set_cancel_handler:=dll.dispatch_source_set_cancel_handler).restype, dispatch_source_set_cancel_handler.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_source_set_cancel_handler_f:=dll.dispatch_source_set_cancel_handler_f).restype, dispatch_source_set_cancel_handler_f.argtypes = None, [objc_id, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_source_cancel:=dll.dispatch_source_cancel).restype, dispatch_source_cancel.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_source_testcancel:=dll.dispatch_source_testcancel).restype, dispatch_source_testcancel.argtypes = intptr_t, [objc_id]
except AttributeError: pass
...
try: (dispatch_source_get_handle:=dll.dispatch_source_get_handle).restype, dispatch_source_get_handle.argtypes = uintptr_t, [objc_id]
except AttributeError: pass
...
try: (dispatch_source_get_mask:=dll.dispatch_source_get_mask).restype, dispatch_source_get_mask.argtypes = uintptr_t, [objc_id]
except AttributeError: pass
...
try: (dispatch_source_get_data:=dll.dispatch_source_get_data).restype, dispatch_source_get_data.argtypes = uintptr_t, [objc_id]
except AttributeError: pass
...
try: (dispatch_source_merge_data:=dll.dispatch_source_merge_data).restype, dispatch_source_merge_data.argtypes = None, [objc_id, uintptr_t]
except AttributeError: pass
...
try: (dispatch_source_set_timer:=dll.dispatch_source_set_timer).restype, dispatch_source_set_timer.argtypes = None, [objc_id, dispatch_time_t, uint64_t, uint64_t]
except AttributeError: pass
...
try: (dispatch_source_set_registration_handler:=dll.dispatch_source_set_registration_handler).restype, dispatch_source_set_registration_handler.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_source_set_registration_handler_f:=dll.dispatch_source_set_registration_handler_f).restype, dispatch_source_set_registration_handler_f.argtypes = None, [objc_id, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_group_create:=dll.dispatch_group_create).restype, dispatch_group_create.argtypes = objc_instance, []
except AttributeError: pass
...
try: (dispatch_group_async:=dll.dispatch_group_async).restype, dispatch_group_async.argtypes = None, [objc_id, objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_group_async_f:=dll.dispatch_group_async_f).restype, dispatch_group_async_f.argtypes = None, [objc_id, objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_group_wait:=dll.dispatch_group_wait).restype, dispatch_group_wait.argtypes = intptr_t, [objc_id, dispatch_time_t]
except AttributeError: pass
...
try: (dispatch_group_notify:=dll.dispatch_group_notify).restype, dispatch_group_notify.argtypes = None, [objc_id, objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_group_notify_f:=dll.dispatch_group_notify_f).restype, dispatch_group_notify_f.argtypes = None, [objc_id, objc_id, ctypes.c_void_p, dispatch_function_t]
except AttributeError: pass
...
try: (dispatch_group_enter:=dll.dispatch_group_enter).restype, dispatch_group_enter.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_group_leave:=dll.dispatch_group_leave).restype, dispatch_group_leave.argtypes = None, [objc_id]
except AttributeError: pass
...
try: (dispatch_semaphore_create:=dll.dispatch_semaphore_create).restype, dispatch_semaphore_create.argtypes = objc_instance, [intptr_t]
except AttributeError: pass
...
try: (dispatch_semaphore_wait:=dll.dispatch_semaphore_wait).restype, dispatch_semaphore_wait.argtypes = intptr_t, [objc_id, dispatch_time_t]
except AttributeError: pass
...
try: (dispatch_semaphore_signal:=dll.dispatch_semaphore_signal).restype, dispatch_semaphore_signal.argtypes = intptr_t, [objc_id]
except AttributeError: pass
...
try: (dispatch_data_create:=dll.dispatch_data_create).restype, dispatch_data_create.argtypes = objc_instance, [ctypes.c_void_p, size_t, objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_data_get_size:=dll.dispatch_data_get_size).restype, dispatch_data_get_size.argtypes = size_t, [objc_id]
except AttributeError: pass
...
try: (dispatch_data_create_map:=dll.dispatch_data_create_map).restype, dispatch_data_create_map.argtypes = objc_instance, [objc_id, ctypes.POINTER(ctypes.c_void_p), ctypes.POINTER(size_t)]
except AttributeError: pass
...
try: (dispatch_data_create_concat:=dll.dispatch_data_create_concat).restype, dispatch_data_create_concat.argtypes = objc_instance, [objc_id, objc_id]
except AttributeError: pass
...
try: (dispatch_data_create_subrange:=dll.dispatch_data_create_subrange).restype, dispatch_data_create_subrange.argtypes = objc_instance, [objc_id, size_t, size_t]
except AttributeError: pass
...
try: (dispatch_data_apply:=dll.dispatch_data_apply).restype, dispatch_data_apply.argtypes = ctypes.c_int, [objc_id, ctypes.c_int]
except AttributeError: pass
...
try: (dispatch_data_copy_region:=dll.dispatch_data_copy_region).restype, dispatch_data_copy_region.argtypes = objc_instance, [objc_id, size_t, ctypes.POINTER(size_t)]
except AttributeError: pass
...
try: (dispatch_io_close:=dll.dispatch_io_close).restype, dispatch_io_close.argtypes = None, [objc_id, dispatch_io_close_flags_t]
except AttributeError: pass
...
try: (dispatch_io_barrier:=dll.dispatch_io_barrier).restype, dispatch_io_barrier.argtypes = None, [objc_id, ctypes.c_void_p]
except AttributeError: pass
...
try: (dispatch_io_get_descriptor:=dll.dispatch_io_get_descriptor).restype, dispatch_io_get_descriptor.argtypes = dispatch_fd_t, [objc_id]
except AttributeError: pass
...
try: (dispatch_io_set_high_water:=dll.dispatch_io_set_high_water).restype, dispatch_io_set_high_water.argtypes = None, [objc_id, size_t]
except AttributeError: pass

# __attribute__((availability(macos, introduced=10.7))) __attribute__((availability(ios, introduced=5.0))) __attribute__((visibility("default"))) __attribute__((nonnull(1))) __attribute__((nothrow)) __attribute__((swift_name("DispatchIO.setLimit(self:lowWater:)"))) extern void dispatch_io_set_low_water(dispatch_io_t  _Nonnull channel, size_t low_water)
try: (dispatch_io_set_low_water:=dll.dispatch_io_set_low_water).restype, dispatch_io_set_low_water.argtypes = None, [objc_id, size_t]
except AttributeError: pass
...
try: (dispatch_io_set_interval:=dll.dispatch_io_set_interval).restype, dispatch_io_set_interval.argtypes = None, [objc_id, uint64_t, dispatch_io_interval_flags_t]
except AttributeError: pass
...
try: (dispatch_workloop_create:=dll.dispatch_workloop_create).restype, dispatch_workloop_create.argtypes = objc_instance, [ctypes.POINTER(ctypes.c_char)]
except AttributeError: pass
...
try: (dispatch_workloop_create_inactive:=dll.dispatch_workloop_create_inactive).restype, dispatch_workloop_create_inactive.argtypes = objc_instance, [ctypes.POINTER(ctypes.c_char)]
except AttributeError: pass
...
try: (dispatch_workloop_set_autorelease_frequency:=dll.dispatch_workloop_set_autorelease_frequency).restype, dispatch_workloop_set_autorelease_frequency.argtypes = None, [objc_id, dispatch_autorelease_frequency_t]
except AttributeError: pass
...
try: (dispatch_workloop_set_os_workgroup:=dll.dispatch_workloop_set_os_workgroup).restype, dispatch_workloop_set_os_workgroup.argtypes = None, [objc_id, objc_id]
except AttributeError: pass
