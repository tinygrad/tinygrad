...
# void fd_dev_info_apply_dbg_options(struct fd_dev_info *info)
...
# struct ir3_compiler *ir3_compiler_create(struct fd_device *dev, const struct fd_dev_id *dev_id, const struct fd_dev_info *dev_info, const struct ir3_compiler_options *options)
...
# struct ir3_shader_variant *ir3_retrieve_variant(struct blob_reader *blob, struct ir3_compiler *compiler, void *mem_ctx)
...
# int ir3_compile_shader_nir(struct ir3_compiler *compiler, struct ir3_shader *shader, struct ir3_shader_variant *so)
...
# const char *ir3_shader_debug_as_string(void)
...
# bool ir3_const_ensure_imm_size(struct ir3_shader_variant *v, unsigned int size)
...
# uint16_t ir3_const_imm_index_to_reg(const struct ir3_const_state *const_state, unsigned int i)
...
# struct ir3_shader_variant *ir3_shader_create_variant(struct ir3_shader *shader, const struct ir3_shader_key *key, bool keep_ir)
...
# struct ir3_shader_variant *ir3_shader_get_variant(struct ir3_shader *shader, const struct ir3_shader_key *key, bool binning_pass, bool keep_ir, bool *created)
...
# struct ir3_shader *ir3_shader_from_nir(struct ir3_compiler *compiler, nir_shader *nir, const struct ir3_shader_options *options, struct ir3_stream_output_info *stream_output)
...
# uint32_t ir3_trim_constlen(const struct ir3_shader_variant **variants, const struct ir3_compiler *compiler)
...
# struct ir3_shader *ir3_shader_passthrough_tcs(struct ir3_shader *vs, unsigned int patch_vertices)
...
try: (ir3_glsl_type_size:=dll.ir3_glsl_type_size).restype, ir3_glsl_type_size.argtypes = ctypes.c_int32, [ctypes.POINTER(const_struct_glsl_type), ctypes.c_bool]
except AttributeError: pass

# void ir3_shader_get_subgroup_size(const struct ir3_compiler *compiler, const struct ir3_shader_options *options, gl_shader_stage stage, unsigned int *subgroup_size, unsigned int *max_subgroup_size)
...
# void print_raw(FILE *out, const unsigned int *data, size_t size)
