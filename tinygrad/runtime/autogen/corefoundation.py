...
@dll.bind
def CFStringCreateWithCString(alloc:CFAllocatorRef, cStr:ctypes.POINTER(ctypes.c_char), encoding:CFStringEncoding) -> CFStringRef: ...
UInt8: TypeAlias = ctypes.c_ubyte
CFIndex: TypeAlias = ctypes.c_int64
Boolean: TypeAlias = ctypes.c_ubyte
@dll.bind
def CFStringCreateWithBytes(alloc:CFAllocatorRef, bytes:ctypes.POINTER(UInt8), numBytes:CFIndex, encoding:CFStringEncoding, isExternalRepresentation:Boolean) -> CFStringRef: ...
UniChar: TypeAlias = ctypes.c_uint16
@dll.bind
def CFStringCreateWithCharacters(alloc:CFAllocatorRef, chars:ctypes.POINTER(UniChar), numChars:CFIndex) -> CFStringRef: ...
@dll.bind
...
@dll.bind
def CFStringCreateWithCStringNoCopy(alloc:CFAllocatorRef, cStr:ctypes.POINTER(ctypes.c_char), encoding:CFStringEncoding, contentsDeallocator:CFAllocatorRef) -> CFStringRef: ...
@dll.bind
def CFStringCreateWithBytesNoCopy(alloc:CFAllocatorRef, bytes:ctypes.POINTER(UInt8), numBytes:CFIndex, encoding:CFStringEncoding, isExternalRepresentation:Boolean, contentsDeallocator:CFAllocatorRef) -> CFStringRef: ...
@dll.bind
def CFStringCreateWithCharactersNoCopy(alloc:CFAllocatorRef, chars:ctypes.POINTER(UniChar), numChars:CFIndex, contentsDeallocator:CFAllocatorRef) -> CFStringRef: ...
@c.record
...
@dll.bind
def CFStringCreateStringWithValidatedFormat(alloc:CFAllocatorRef, formatOptions:CFDictionaryRef, validFormatSpecifiers:CFStringRef, format:CFStringRef, errorPtr:ctypes.POINTER(CFErrorRef)) -> CFStringRef: ...
@dll.bind
def CFStringCreateStringWithValidatedFormatAndArguments(alloc:CFAllocatorRef, formatOptions:CFDictionaryRef, validFormatSpecifiers:CFStringRef, format:CFStringRef, arguments:ctypes.c_int32, errorPtr:ctypes.POINTER(CFErrorRef)) -> CFStringRef: ...
...
@dll.bind
def CFStringCreateMutableWithExternalCharactersNoCopy(alloc:CFAllocatorRef, chars:ctypes.POINTER(UniChar), numChars:CFIndex, capacity:CFIndex, externalCharactersAllocator:CFAllocatorRef) -> CFMutableStringRef: ...
@dll.bind
...
@dll.bind
def CFStringGetCharacters(theString:CFStringRef, range:CFRange, buffer:ctypes.POINTER(UniChar)) -> None: ...
...
@dll.bind
def CFStringGetCString(theString:CFStringRef, buffer:ctypes.POINTER(ctypes.c_char), bufferSize:CFIndex, encoding:CFStringEncoding) -> Boolean: ...
...
@dll.bind
def CFStringGetCStringPtr(theString:CFStringRef, encoding:CFStringEncoding) -> ctypes.POINTER(ctypes.c_char): ...
@dll.bind
def CFStringGetCharactersPtr(theString:CFStringRef) -> ctypes.POINTER(UniChar): ...
@dll.bind
def CFStringGetBytes(theString:CFStringRef, range:CFRange, encoding:CFStringEncoding, lossByte:UInt8, isExternalRepresentation:Boolean, buffer:ctypes.POINTER(UInt8), maxBufLen:CFIndex, usedBufLen:ctypes.POINTER(CFIndex)) -> CFIndex: ...
...
@dll.bind
def CFStringGetFileSystemRepresentation(string:CFStringRef, buffer:ctypes.POINTER(ctypes.c_char), maxBufLen:CFIndex) -> Boolean: ...
@dll.bind
def CFStringGetMaximumSizeOfFileSystemRepresentation(string:CFStringRef) -> CFIndex: ...
@dll.bind
def CFStringCreateWithFileSystemRepresentation(alloc:CFAllocatorRef, buffer:ctypes.POINTER(ctypes.c_char)) -> CFStringRef: ...
...
@dll.bind
def CFStringFindWithOptionsAndLocale(theString:CFStringRef, stringToFind:CFStringRef, rangeToSearch:CFRange, searchOptions:CFStringCompareFlags, locale:CFLocaleRef, result:ctypes.POINTER(CFRange)) -> Boolean: ...
@dll.bind
def CFStringFindWithOptions(theString:CFStringRef, stringToFind:CFStringRef, rangeToSearch:CFRange, searchOptions:CFStringCompareFlags, result:ctypes.POINTER(CFRange)) -> Boolean: ...
...
@dll.bind
def CFStringFindCharacterFromSet(theString:CFStringRef, theSet:CFCharacterSetRef, rangeToSearch:CFRange, searchOptions:CFStringCompareFlags, result:ctypes.POINTER(CFRange)) -> Boolean: ...
@dll.bind
def CFStringGetLineBounds(theString:CFStringRef, range:CFRange, lineBeginIndex:ctypes.POINTER(CFIndex), lineEndIndex:ctypes.POINTER(CFIndex), contentsEndIndex:ctypes.POINTER(CFIndex)) -> None: ...
@dll.bind
def CFStringGetParagraphBounds(string:CFStringRef, range:CFRange, parBeginIndex:ctypes.POINTER(CFIndex), parEndIndex:ctypes.POINTER(CFIndex), contentsEndIndex:ctypes.POINTER(CFIndex)) -> None: ...
CFOptionFlags: TypeAlias = ctypes.c_uint64
UTF32Char: TypeAlias = ctypes.c_uint32
@dll.bind
def CFStringGetHyphenationLocationBeforeIndex(string:CFStringRef, location:CFIndex, limitRange:CFRange, options:CFOptionFlags, locale:CFLocaleRef, character:ctypes.POINTER(UTF32Char)) -> CFIndex: ...
@dll.bind
...
@dll.bind
def CFStringAppendCharacters(theString:CFMutableStringRef, chars:ctypes.POINTER(UniChar), numChars:CFIndex) -> None: ...
@dll.bind
def CFStringAppendPascalString(theString:CFMutableStringRef, pStr:ConstStr255Param, encoding:CFStringEncoding) -> None: ...
@dll.bind
def CFStringAppendCString(theString:CFMutableStringRef, cStr:ctypes.POINTER(ctypes.c_char), encoding:CFStringEncoding) -> None: ...
@dll.bind
...
@dll.bind
def CFStringSetExternalCharactersNoCopy(theString:CFMutableStringRef, chars:ctypes.POINTER(UniChar), length:CFIndex, capacity:CFIndex) -> None: ...
@dll.bind
...
@dll.bind
def CFStringTransform(string:CFMutableStringRef, range:ctypes.POINTER(CFRange), transform:CFStringRef, reverse:Boolean) -> Boolean: ...
...
@dll.bind
def CFStringGetListOfAvailableEncodings() -> ctypes.POINTER(CFStringEncoding): ...
@dll.bind
...
class CFStringInlineBuffer(c.Struct):
  ...
  directUniCharBuffer: 'ctypes._Pointer[int]'
  directCStringBuffer: 'ctypes._Pointer[bytes]'
...
@dll.bind
def __CFStringMakeConstantString(cStr:ctypes.POINTER(ctypes.c_char)) -> CFStringRef: ...
CFMutableDataRef: TypeAlias = ctypes.POINTER(struct___CFData)
@dll.bind
def CFDataGetTypeID() -> CFTypeID: ...
@dll.bind
def CFDataCreate(allocator:CFAllocatorRef, bytes:ctypes.POINTER(UInt8), length:CFIndex) -> CFDataRef: ...
@dll.bind
def CFDataCreateWithBytesNoCopy(allocator:CFAllocatorRef, bytes:ctypes.POINTER(UInt8), length:CFIndex, bytesDeallocator:CFAllocatorRef) -> CFDataRef: ...
@dll.bind
...
@dll.bind
def CFDataGetBytePtr(theData:CFDataRef) -> ctypes.POINTER(UInt8): ...
@dll.bind
def CFDataGetMutableBytePtr(theData:CFMutableDataRef) -> ctypes.POINTER(UInt8): ...
@dll.bind
def CFDataGetBytes(theData:CFDataRef, range:CFRange, buffer:ctypes.POINTER(UInt8)) -> None: ...
@dll.bind
...
@dll.bind
def CFDataAppendBytes(theData:CFMutableDataRef, bytes:ctypes.POINTER(UInt8), length:CFIndex) -> None: ...
@dll.bind
def CFDataReplaceBytes(theData:CFMutableDataRef, range:CFRange, newBytes:ctypes.POINTER(UInt8), newLength:CFIndex) -> None: ...
@dll.bind
