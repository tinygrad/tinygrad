...
@dll.bind
def hipExtModuleLaunchKernel(f:hipFunction_t, globalWorkSizeX:uint32_t, globalWorkSizeY:uint32_t, globalWorkSizeZ:uint32_t, localWorkSizeX:uint32_t, localWorkSizeY:uint32_t, localWorkSizeZ:uint32_t, sharedMemBytes:size_t, hStream:hipStream_t, kernelParams:POINTER(POINTER(None)), extra:POINTER(POINTER(None)), startEvent:hipEvent_t, stopEvent:hipEvent_t, flags:uint32_t) -> hipError_t: ...
@dll.bind
def hipHccModuleLaunchKernel(f:hipFunction_t, globalWorkSizeX:uint32_t, globalWorkSizeY:uint32_t, globalWorkSizeZ:uint32_t, localWorkSizeX:uint32_t, localWorkSizeY:uint32_t, localWorkSizeZ:uint32_t, sharedMemBytes:size_t, hStream:hipStream_t, kernelParams:POINTER(POINTER(None)), extra:POINTER(POINTER(None)), startEvent:hipEvent_t, stopEvent:hipEvent_t) -> hipError_t: ...
@record
class dim3:
  SIZE = 12
...
@dll.bind
def hipExtLaunchKernel(function_address:POINTER(None), numBlocks:dim3, dimBlocks:dim3, args:POINTER(POINTER(None)), sharedMemBytes:size_t, stream:hipStream_t, startEvent:hipEvent_t, stopEvent:hipEvent_t, flags:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
...
@dll.bind
def hiprtcCompileProgram(prog:hiprtcProgram, numOptions:Annotated[int, ctypes.c_int32], options:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> hiprtcResult: ...
@dll.bind
def hiprtcCreateProgram(prog:POINTER(hiprtcProgram), src:POINTER(Annotated[bytes, ctypes.c_char]), name:POINTER(Annotated[bytes, ctypes.c_char]), numHeaders:Annotated[int, ctypes.c_int32], headers:POINTER(POINTER(Annotated[bytes, ctypes.c_char])), includeNames:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> hiprtcResult: ...
@dll.bind
def hiprtcDestroyProgram(prog:POINTER(hiprtcProgram)) -> hiprtcResult: ...
@dll.bind
def hiprtcGetLoweredName(prog:hiprtcProgram, name_expression:POINTER(Annotated[bytes, ctypes.c_char]), lowered_name:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> hiprtcResult: ...
@dll.bind
def hiprtcGetProgramLog(prog:hiprtcProgram, log:POINTER(Annotated[bytes, ctypes.c_char])) -> hiprtcResult: ...
@dll.bind
def hiprtcGetProgramLogSize(prog:hiprtcProgram, logSizeRet:POINTER(size_t)) -> hiprtcResult: ...
@dll.bind
def hiprtcGetCode(prog:hiprtcProgram, code:POINTER(Annotated[bytes, ctypes.c_char])) -> hiprtcResult: ...
@dll.bind
def hiprtcGetCodeSize(prog:hiprtcProgram, codeSizeRet:POINTER(size_t)) -> hiprtcResult: ...
@dll.bind
def hiprtcGetBitcode(prog:hiprtcProgram, bitcode:POINTER(Annotated[bytes, ctypes.c_char])) -> hiprtcResult: ...
@dll.bind
def hiprtcGetBitcodeSize(prog:hiprtcProgram, bitcode_size:POINTER(size_t)) -> hiprtcResult: ...
@dll.bind
def hiprtcLinkCreate(num_options:Annotated[int, ctypes.c_uint32], option_ptr:POINTER(hiprtcJIT_option), option_vals_pptr:POINTER(POINTER(None)), hip_link_state_ptr:POINTER(hiprtcLinkState)) -> hiprtcResult: ...
@dll.bind
def hiprtcLinkAddFile(hip_link_state:hiprtcLinkState, input_type:hiprtcJITInputType, file_path:POINTER(Annotated[bytes, ctypes.c_char]), num_options:Annotated[int, ctypes.c_uint32], options_ptr:POINTER(hiprtcJIT_option), option_values:POINTER(POINTER(None))) -> hiprtcResult: ...
@dll.bind
def hiprtcLinkAddData(hip_link_state:hiprtcLinkState, input_type:hiprtcJITInputType, image:POINTER(None), image_size:size_t, name:POINTER(Annotated[bytes, ctypes.c_char]), num_options:Annotated[int, ctypes.c_uint32], options_ptr:POINTER(hiprtcJIT_option), option_values:POINTER(POINTER(None))) -> hiprtcResult: ...
@dll.bind
def hiprtcLinkComplete(hip_link_state:hiprtcLinkState, bin_out:POINTER(POINTER(None)), size_out:POINTER(size_t)) -> hiprtcResult: ...
@dll.bind
...
class hipDeviceProp_tR0600:
  SIZE = 1472
  name: Annotated[Array[Annotated[bytes, ctypes.c_char], Literal[256]], 0]
  uuid: Annotated[hipUUID, 256]
  luid: Annotated[Array[Annotated[bytes, ctypes.c_char], Literal[8]], 272]
  ...
  maxThreadsDim: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 324]
  maxGridSize: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 336]
  ...
  maxTexture2D: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 420]
  maxTexture2DMipmap: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 428]
  maxTexture2DLinear: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 436]
  maxTexture2DGather: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 448]
  maxTexture3D: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 456]
  maxTexture3DAlt: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 468]
  maxTextureCubemap: Annotated[Annotated[int, ctypes.c_int32], 480]
  maxTexture1DLayered: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 484]
  maxTexture2DLayered: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 492]
  maxTextureCubemapLayered: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 504]
  maxSurface1D: Annotated[Annotated[int, ctypes.c_int32], 512]
  maxSurface2D: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 516]
  maxSurface3D: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 524]
  maxSurface1DLayered: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 536]
  maxSurface2DLayered: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 544]
  maxSurfaceCubemap: Annotated[Annotated[int, ctypes.c_int32], 556]
  maxSurfaceCubemapLayered: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[2]], 560]
  ...
  reserved: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[63]], 780]
  hipReserved: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[32]], 1032]
  gcnArchName: Annotated[Array[Annotated[bytes, ctypes.c_char], Literal[256]], 1160]
  ...
  hdpMemFlushCntl: Annotated[POINTER(Annotated[int, ctypes.c_uint32]), 1432]
  hdpRegFlushCntl: Annotated[POINTER(Annotated[int, ctypes.c_uint32]), 1440]
...
class hipPointerAttribute_t:
  ...
  devicePointer: Annotated[POINTER(None), 8]
  hostPointer: Annotated[POINTER(None), 16]
...
class hipMemPoolProps:
  ...
  reserved: Annotated[Array[Annotated[int, ctypes.c_ubyte], Literal[56]], 32]
@record
...
class hipKernelNodeParams:
  ...
  extra: Annotated[POINTER(POINTER(None)), 16]
  func: Annotated[POINTER(None), 24]
...
class hipMemAllocNodeParams:
  ...
  accessDescs: Annotated[POINTER(hipMemAccessDesc), 88]
  accessDescCount: Annotated[size_t, 96]
  bytesize: Annotated[size_t, 104]
  dptr: Annotated[POINTER(None), 112]
...
class hipExternalSemaphoreSignalNodeParams:
  SIZE = 24
  extSemArray: Annotated[POINTER(hipExternalSemaphore_t), 0]
  paramsArray: Annotated[POINTER(hipExternalSemaphoreSignalParams), 8]
...
class hipArrayMapInfo:
  ...
  reserved: Annotated[Array[Annotated[int, ctypes.c_uint32], Literal[2]], 144]
...
class hipMemcpyNodeParams:
  ...
  reserved: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 4]
...
class hipMemFreeNodeParams:
  SIZE = 8
  dptr: Annotated[POINTER(None), 0]
@record
class hipGraphNodeParams:
  SIZE = 256
  type: Annotated[hipGraphNodeType, 0]
  reserved0: Annotated[Array[Annotated[int, ctypes.c_int32], Literal[3]], 4]
  reserved1: Annotated[Array[Annotated[int, ctypes.c_int64], Literal[29]], 16]
...
class hipGraphEdgeData:
  ...
  reserved: Annotated[Array[Annotated[int, ctypes.c_ubyte], Literal[5]], 1]
...
@dll.bind
def hipDriverGetVersion(driverVersion:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
def hipRuntimeGetVersion(runtimeVersion:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
def hipDeviceGet(device:POINTER(hipDevice_t), ordinal:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipDeviceComputeCapability(major:POINTER(Annotated[int, ctypes.c_int32]), minor:POINTER(Annotated[int, ctypes.c_int32]), device:hipDevice_t) -> hipError_t: ...
@dll.bind
def hipDeviceGetName(name:POINTER(Annotated[bytes, ctypes.c_char]), len:Annotated[int, ctypes.c_int32], device:hipDevice_t) -> hipError_t: ...
@dll.bind
def hipDeviceGetUuid(uuid:POINTER(hipUUID), device:hipDevice_t) -> hipError_t: ...
@dll.bind
def hipDeviceGetP2PAttribute(value:POINTER(Annotated[int, ctypes.c_int32]), attr:hipDeviceP2PAttr, srcDevice:Annotated[int, ctypes.c_int32], dstDevice:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipDeviceGetPCIBusId(pciBusId:POINTER(Annotated[bytes, ctypes.c_char]), len:Annotated[int, ctypes.c_int32], device:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipDeviceGetByPCIBusId(device:POINTER(Annotated[int, ctypes.c_int32]), pciBusId:POINTER(Annotated[bytes, ctypes.c_char])) -> hipError_t: ...
@dll.bind
def hipDeviceTotalMem(bytes:POINTER(size_t), device:hipDevice_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipSetValidDevices(device_arr:POINTER(Annotated[int, ctypes.c_int32]), len:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipGetDevice(deviceId:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
def hipGetDeviceCount(count:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
def hipDeviceGetAttribute(pi:POINTER(Annotated[int, ctypes.c_int32]), attr:hipDeviceAttribute_t, deviceId:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipDeviceGetDefaultMemPool(mem_pool:POINTER(hipMemPool_t), device:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipDeviceSetMemPool(device:Annotated[int, ctypes.c_int32], mem_pool:hipMemPool_t) -> hipError_t: ...
@dll.bind
def hipDeviceGetMemPool(mem_pool:POINTER(hipMemPool_t), device:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipGetDevicePropertiesR0600(prop:POINTER(hipDeviceProp_tR0600), deviceId:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipDeviceSetCacheConfig(cacheConfig:hipFuncCache_t) -> hipError_t: ...
@dll.bind
def hipDeviceGetCacheConfig(cacheConfig:POINTER(hipFuncCache_t)) -> hipError_t: ...
@dll.bind
def hipDeviceGetLimit(pValue:POINTER(size_t), limit:hipLimit_t) -> hipError_t: ...
@dll.bind
def hipDeviceSetLimit(limit:hipLimit_t, value:size_t) -> hipError_t: ...
@dll.bind
def hipDeviceGetSharedMemConfig(pConfig:POINTER(hipSharedMemConfig)) -> hipError_t: ...
@dll.bind
def hipGetDeviceFlags(flags:POINTER(Annotated[int, ctypes.c_uint32])) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipChooseDeviceR0600(device:POINTER(Annotated[int, ctypes.c_int32]), prop:POINTER(hipDeviceProp_tR0600)) -> hipError_t: ...
@dll.bind
def hipExtGetLinkTypeAndHopCount(device1:Annotated[int, ctypes.c_int32], device2:Annotated[int, ctypes.c_int32], linktype:POINTER(uint32_t), hopcount:POINTER(uint32_t)) -> hipError_t: ...
@dll.bind
def hipIpcGetMemHandle(handle:POINTER(hipIpcMemHandle_t), devPtr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipIpcOpenMemHandle(devPtr:POINTER(POINTER(None)), handle:hipIpcMemHandle_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipIpcCloseMemHandle(devPtr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipIpcGetEventHandle(handle:POINTER(hipIpcEventHandle_t), event:hipEvent_t) -> hipError_t: ...
@dll.bind
def hipIpcOpenEventHandle(event:POINTER(hipEvent_t), handle:hipIpcEventHandle_t) -> hipError_t: ...
@dll.bind
def hipFuncSetAttribute(func:POINTER(None), attr:hipFuncAttribute, value:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipFuncSetCacheConfig(func:POINTER(None), config:hipFuncCache_t) -> hipError_t: ...
@dll.bind
def hipFuncSetSharedMemConfig(func:POINTER(None), config:hipSharedMemConfig) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGetErrorName(hip_error:hipError_t) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def hipGetErrorString(hipError:hipError_t) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def hipDrvGetErrorName(hipError:hipError_t, errorString:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> hipError_t: ...
@dll.bind
def hipDrvGetErrorString(hipError:hipError_t, errorString:POINTER(POINTER(Annotated[bytes, ctypes.c_char]))) -> hipError_t: ...
@dll.bind
def hipStreamCreate(stream:POINTER(hipStream_t)) -> hipError_t: ...
@dll.bind
def hipStreamCreateWithFlags(stream:POINTER(hipStream_t), flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipStreamCreateWithPriority(stream:POINTER(hipStream_t), flags:Annotated[int, ctypes.c_uint32], priority:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipDeviceGetStreamPriorityRange(leastPriority:POINTER(Annotated[int, ctypes.c_int32]), greatestPriority:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipStreamGetFlags(stream:hipStream_t, flags:POINTER(Annotated[int, ctypes.c_uint32])) -> hipError_t: ...
@dll.bind
def hipStreamGetPriority(stream:hipStream_t, priority:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
def hipStreamGetDevice(stream:hipStream_t, device:POINTER(hipDevice_t)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipStreamWriteValue32(stream:hipStream_t, ptr:POINTER(None), value:uint32_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipStreamWriteValue64(stream:hipStream_t, ptr:POINTER(None), value:uint64_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipEventCreateWithFlags(event:POINTER(hipEvent_t), flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipEventCreate(event:POINTER(hipEvent_t)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipEventElapsedTime(ms:POINTER(Annotated[float, ctypes.c_float]), start:hipEvent_t, stop:hipEvent_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipPointerSetAttribute(value:POINTER(None), attribute:hipPointer_attribute, ptr:hipDeviceptr_t) -> hipError_t: ...
@dll.bind
def hipPointerGetAttributes(attributes:POINTER(hipPointerAttribute_t), ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipPointerGetAttribute(data:POINTER(None), attribute:hipPointer_attribute, ptr:hipDeviceptr_t) -> hipError_t: ...
@dll.bind
def hipDrvPointerGetAttributes(numAttributes:Annotated[int, ctypes.c_uint32], attributes:POINTER(hipPointer_attribute), data:POINTER(POINTER(None)), ptr:hipDeviceptr_t) -> hipError_t: ...
@dll.bind
def hipImportExternalSemaphore(extSem_out:POINTER(hipExternalSemaphore_t), semHandleDesc:POINTER(hipExternalSemaphoreHandleDesc)) -> hipError_t: ...
@dll.bind
def hipSignalExternalSemaphoresAsync(extSemArray:POINTER(hipExternalSemaphore_t), paramsArray:POINTER(hipExternalSemaphoreSignalParams), numExtSems:Annotated[int, ctypes.c_uint32], stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipWaitExternalSemaphoresAsync(extSemArray:POINTER(hipExternalSemaphore_t), paramsArray:POINTER(hipExternalSemaphoreWaitParams), numExtSems:Annotated[int, ctypes.c_uint32], stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipDestroyExternalSemaphore(extSem:hipExternalSemaphore_t) -> hipError_t: ...
@dll.bind
def hipImportExternalMemory(extMem_out:POINTER(hipExternalMemory_t), memHandleDesc:POINTER(hipExternalMemoryHandleDesc)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMalloc(ptr:POINTER(POINTER(None)), size:size_t) -> hipError_t: ...
@dll.bind
def hipExtMallocWithFlags(ptr:POINTER(POINTER(None)), sizeBytes:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMallocHost(ptr:POINTER(POINTER(None)), size:size_t) -> hipError_t: ...
@dll.bind
def hipMemAllocHost(ptr:POINTER(POINTER(None)), size:size_t) -> hipError_t: ...
@dll.bind
def hipHostMalloc(ptr:POINTER(POINTER(None)), size:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMallocManaged(dev_ptr:POINTER(POINTER(None)), size:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMemPrefetchAsync(dev_ptr:POINTER(None), count:size_t, device:Annotated[int, ctypes.c_int32], stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemAdvise(dev_ptr:POINTER(None), count:size_t, advice:hipMemoryAdvise, device:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipMemRangeGetAttribute(data:POINTER(None), data_size:size_t, attribute:hipMemRangeAttribute, dev_ptr:POINTER(None), count:size_t) -> hipError_t: ...
@dll.bind
def hipMemRangeGetAttributes(data:POINTER(POINTER(None)), data_sizes:POINTER(size_t), attributes:POINTER(hipMemRangeAttribute), num_attributes:size_t, dev_ptr:POINTER(None), count:size_t) -> hipError_t: ...
@dll.bind
def hipStreamAttachMemAsync(stream:hipStream_t, dev_ptr:POINTER(None), length:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMallocAsync(dev_ptr:POINTER(POINTER(None)), size:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipFreeAsync(dev_ptr:POINTER(None), stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemPoolTrimTo(mem_pool:hipMemPool_t, min_bytes_to_hold:size_t) -> hipError_t: ...
@dll.bind
def hipMemPoolSetAttribute(mem_pool:hipMemPool_t, attr:hipMemPoolAttr, value:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemPoolGetAttribute(mem_pool:hipMemPool_t, attr:hipMemPoolAttr, value:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemPoolSetAccess(mem_pool:hipMemPool_t, desc_list:POINTER(hipMemAccessDesc), count:size_t) -> hipError_t: ...
@dll.bind
def hipMemPoolGetAccess(flags:POINTER(hipMemAccessFlags), mem_pool:hipMemPool_t, location:POINTER(hipMemLocation)) -> hipError_t: ...
@dll.bind
def hipMemPoolCreate(mem_pool:POINTER(hipMemPool_t), pool_props:POINTER(hipMemPoolProps)) -> hipError_t: ...
@dll.bind
def hipMemPoolDestroy(mem_pool:hipMemPool_t) -> hipError_t: ...
@dll.bind
def hipMallocFromPoolAsync(dev_ptr:POINTER(POINTER(None)), size:size_t, mem_pool:hipMemPool_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemPoolExportToShareableHandle(shared_handle:POINTER(None), mem_pool:hipMemPool_t, handle_type:hipMemAllocationHandleType, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMemPoolImportFromShareableHandle(mem_pool:POINTER(hipMemPool_t), shared_handle:POINTER(None), handle_type:hipMemAllocationHandleType, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMemPoolExportPointer(export_data:POINTER(hipMemPoolPtrExportData), dev_ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemPoolImportPointer(dev_ptr:POINTER(POINTER(None)), mem_pool:hipMemPool_t, export_data:POINTER(hipMemPoolPtrExportData)) -> hipError_t: ...
@dll.bind
def hipHostAlloc(ptr:POINTER(POINTER(None)), size:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipHostGetDevicePointer(devPtr:POINTER(POINTER(None)), hstPtr:POINTER(None), flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipHostGetFlags(flagsPtr:POINTER(Annotated[int, ctypes.c_uint32]), hostPtr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipHostRegister(hostPtr:POINTER(None), sizeBytes:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipHostUnregister(hostPtr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMallocPitch(ptr:POINTER(POINTER(None)), pitch:POINTER(size_t), width:size_t, height:size_t) -> hipError_t: ...
@dll.bind
def hipMemAllocPitch(dptr:POINTER(hipDeviceptr_t), pitch:POINTER(size_t), widthInBytes:size_t, height:size_t, elementSizeBytes:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipFree(ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipFreeHost(ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipHostFree(ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemcpy(dst:POINTER(None), src:POINTER(None), sizeBytes:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyWithStream(dst:POINTER(None), src:POINTER(None), sizeBytes:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyHtoD(dst:hipDeviceptr_t, src:POINTER(None), sizeBytes:size_t) -> hipError_t: ...
@dll.bind
def hipMemcpyDtoH(dst:POINTER(None), src:hipDeviceptr_t, sizeBytes:size_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemcpyHtoDAsync(dst:hipDeviceptr_t, src:POINTER(None), sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyDtoHAsync(dst:POINTER(None), src:hipDeviceptr_t, sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyDtoDAsync(dst:hipDeviceptr_t, src:hipDeviceptr_t, sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyAtoHAsync(dstHost:POINTER(None), srcArray:hipArray_t, srcOffset:size_t, ByteCount:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyHtoAAsync(dstArray:hipArray_t, dstOffset:size_t, srcHost:POINTER(None), ByteCount:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipModuleGetGlobal(dptr:POINTER(hipDeviceptr_t), bytes:POINTER(size_t), hmod:hipModule_t, name:POINTER(Annotated[bytes, ctypes.c_char])) -> hipError_t: ...
@dll.bind
def hipGetSymbolAddress(devPtr:POINTER(POINTER(None)), symbol:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipGetSymbolSize(size:POINTER(size_t), symbol:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipGetProcAddress(symbol:POINTER(Annotated[bytes, ctypes.c_char]), pfn:POINTER(POINTER(None)), hipVersion:Annotated[int, ctypes.c_int32], flags:uint64_t, symbolStatus:POINTER(hipDriverProcAddressQueryResult)) -> hipError_t: ...
@dll.bind
def hipMemcpyToSymbol(symbol:POINTER(None), src:POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyToSymbolAsync(symbol:POINTER(None), src:POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyFromSymbol(dst:POINTER(None), symbol:POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyFromSymbolAsync(dst:POINTER(None), symbol:POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyAsync(dst:POINTER(None), src:POINTER(None), sizeBytes:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemset(dst:POINTER(None), value:Annotated[int, ctypes.c_int32], sizeBytes:size_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemsetAsync(dst:POINTER(None), value:Annotated[int, ctypes.c_int32], sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemsetD32Async(dst:hipDeviceptr_t, value:Annotated[int, ctypes.c_int32], count:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemset2D(dst:POINTER(None), pitch:size_t, value:Annotated[int, ctypes.c_int32], width:size_t, height:size_t) -> hipError_t: ...
@dll.bind
def hipMemset2DAsync(dst:POINTER(None), pitch:size_t, value:Annotated[int, ctypes.c_int32], width:size_t, height:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemGetInfo(free:POINTER(size_t), total:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipMemPtrGetInfo(ptr:POINTER(None), size:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipMallocArray(array:POINTER(hipArray_t), desc:POINTER(hipChannelFormatDesc), width:size_t, height:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@record
...
@dll.bind
def hipArrayCreate(pHandle:POINTER(hipArray_t), pAllocateArray:POINTER(HIP_ARRAY_DESCRIPTOR)) -> hipError_t: ...
@dll.bind
...
class HIP_ARRAY3D_DESCRIPTOR:
  ...
  Flags: Annotated[Annotated[int, ctypes.c_uint32], 32]
@dll.bind
def hipArray3DCreate(array:POINTER(hipArray_t), pAllocateArray:POINTER(HIP_ARRAY3D_DESCRIPTOR)) -> hipError_t: ...
@dll.bind
def hipMalloc3D(pitchedDevPtr:POINTER(hipPitchedPtr), extent:hipExtent) -> hipError_t: ...
@dll.bind
def hipFreeArray(array:hipArray_t) -> hipError_t: ...
@dll.bind
def hipMalloc3DArray(array:POINTER(hipArray_t), desc:POINTER(hipChannelFormatDesc), extent:hipExtent, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipArrayGetInfo(desc:POINTER(hipChannelFormatDesc), extent:POINTER(hipExtent), flags:POINTER(Annotated[int, ctypes.c_uint32]), array:hipArray_t) -> hipError_t: ...
@dll.bind
def hipArrayGetDescriptor(pArrayDescriptor:POINTER(HIP_ARRAY_DESCRIPTOR), array:hipArray_t) -> hipError_t: ...
@dll.bind
def hipArray3DGetDescriptor(pArrayDescriptor:POINTER(HIP_ARRAY3D_DESCRIPTOR), array:hipArray_t) -> hipError_t: ...
@dll.bind
def hipMemcpy2D(dst:POINTER(None), dpitch:size_t, src:POINTER(None), spitch:size_t, width:size_t, height:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@record
class hip_Memcpy2D:
  SIZE = 128
...
@dll.bind
def hipMemcpyParam2D(pCopy:POINTER(hip_Memcpy2D)) -> hipError_t: ...
@dll.bind
def hipMemcpyParam2DAsync(pCopy:POINTER(hip_Memcpy2D), stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpy2DAsync(dst:POINTER(None), dpitch:size_t, src:POINTER(None), spitch:size_t, width:size_t, height:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemcpyToArray(dst:hipArray_t, wOffset:size_t, hOffset:size_t, src:POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyFromArray(dst:POINTER(None), srcArray:hipArray_const_t, wOffset:size_t, hOffset:size_t, count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpy2DFromArray(dst:POINTER(None), dpitch:size_t, src:hipArray_const_t, wOffset:size_t, hOffset:size_t, width:size_t, height:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpy2DFromArrayAsync(dst:POINTER(None), dpitch:size_t, src:hipArray_const_t, wOffset:size_t, hOffset:size_t, width:size_t, height:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyAtoH(dst:POINTER(None), srcArray:hipArray_t, srcOffset:size_t, count:size_t) -> hipError_t: ...
@dll.bind
def hipMemcpyHtoA(dstArray:hipArray_t, dstOffset:size_t, srcHost:POINTER(None), count:size_t) -> hipError_t: ...
@dll.bind
def hipMemcpy3D(p:POINTER(hipMemcpy3DParms)) -> hipError_t: ...
@dll.bind
def hipMemcpy3DAsync(p:POINTER(hipMemcpy3DParms), stream:hipStream_t) -> hipError_t: ...
@record
class HIP_MEMCPY3D:
  SIZE = 184
  srcXInBytes: Annotated[size_t, 0]
  ...
  dstHost: Annotated[POINTER(None), 120]
...
@dll.bind
def hipDrvMemcpy3D(pCopy:POINTER(HIP_MEMCPY3D)) -> hipError_t: ...
@dll.bind
def hipDrvMemcpy3DAsync(pCopy:POINTER(HIP_MEMCPY3D), stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipDeviceCanAccessPeer(canAccessPeer:POINTER(Annotated[int, ctypes.c_int32]), deviceId:Annotated[int, ctypes.c_int32], peerDeviceId:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemGetAddressRange(pbase:POINTER(hipDeviceptr_t), psize:POINTER(size_t), dptr:hipDeviceptr_t) -> hipError_t: ...
@dll.bind
def hipMemcpyPeer(dst:POINTER(None), dstDeviceId:Annotated[int, ctypes.c_int32], src:POINTER(None), srcDeviceId:Annotated[int, ctypes.c_int32], sizeBytes:size_t) -> hipError_t: ...
@dll.bind
def hipMemcpyPeerAsync(dst:POINTER(None), dstDeviceId:Annotated[int, ctypes.c_int32], src:POINTER(None), srcDevice:Annotated[int, ctypes.c_int32], sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipCtxCreate(ctx:POINTER(hipCtx_t), flags:Annotated[int, ctypes.c_uint32], device:hipDevice_t) -> hipError_t: ...
@dll.bind
def hipCtxDestroy(ctx:hipCtx_t) -> hipError_t: ...
@dll.bind
def hipCtxPopCurrent(ctx:POINTER(hipCtx_t)) -> hipError_t: ...
@dll.bind
def hipCtxPushCurrent(ctx:hipCtx_t) -> hipError_t: ...
@dll.bind
def hipCtxSetCurrent(ctx:hipCtx_t) -> hipError_t: ...
@dll.bind
def hipCtxGetCurrent(ctx:POINTER(hipCtx_t)) -> hipError_t: ...
@dll.bind
def hipCtxGetDevice(device:POINTER(hipDevice_t)) -> hipError_t: ...
@dll.bind
def hipCtxGetApiVersion(ctx:hipCtx_t, apiVersion:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
def hipCtxGetCacheConfig(cacheConfig:POINTER(hipFuncCache_t)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipCtxGetSharedMemConfig(pConfig:POINTER(hipSharedMemConfig)) -> hipError_t: ...
@dll.bind
def hipCtxSynchronize() -> hipError_t: ...
@dll.bind
def hipCtxGetFlags(flags:POINTER(Annotated[int, ctypes.c_uint32])) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipDevicePrimaryCtxGetState(dev:hipDevice_t, flags:POINTER(Annotated[int, ctypes.c_uint32]), active:POINTER(Annotated[int, ctypes.c_int32])) -> hipError_t: ...
@dll.bind
def hipDevicePrimaryCtxRelease(dev:hipDevice_t) -> hipError_t: ...
@dll.bind
def hipDevicePrimaryCtxRetain(pctx:POINTER(hipCtx_t), dev:hipDevice_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipModuleLoad(module:POINTER(hipModule_t), fname:POINTER(Annotated[bytes, ctypes.c_char])) -> hipError_t: ...
@dll.bind
def hipModuleUnload(module:hipModule_t) -> hipError_t: ...
@dll.bind
def hipModuleGetFunction(function:POINTER(hipFunction_t), module:hipModule_t, kname:POINTER(Annotated[bytes, ctypes.c_char])) -> hipError_t: ...
@dll.bind
def hipFuncGetAttributes(attr:POINTER(hipFuncAttributes), func:POINTER(None)) -> hipError_t: ...
...
@dll.bind
def hipFuncGetAttribute(value:POINTER(Annotated[int, ctypes.c_int32]), attrib:hipFunction_attribute, hfunc:hipFunction_t) -> hipError_t: ...
@dll.bind
def hipGetFuncBySymbol(functionPtr:POINTER(hipFunction_t), symbolPtr:POINTER(None)) -> hipError_t: ...
@record
...
@dll.bind
def hipModuleLoadData(module:POINTER(hipModule_t), image:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipModuleLoadDataEx(module:POINTER(hipModule_t), image:POINTER(None), numOptions:Annotated[int, ctypes.c_uint32], options:POINTER(hipJitOption), optionValues:POINTER(POINTER(None))) -> hipError_t: ...
@dll.bind
def hipModuleLaunchKernel(f:hipFunction_t, gridDimX:Annotated[int, ctypes.c_uint32], gridDimY:Annotated[int, ctypes.c_uint32], gridDimZ:Annotated[int, ctypes.c_uint32], blockDimX:Annotated[int, ctypes.c_uint32], blockDimY:Annotated[int, ctypes.c_uint32], blockDimZ:Annotated[int, ctypes.c_uint32], sharedMemBytes:Annotated[int, ctypes.c_uint32], stream:hipStream_t, kernelParams:POINTER(POINTER(None)), extra:POINTER(POINTER(None))) -> hipError_t: ...
@dll.bind
def hipModuleLaunchCooperativeKernel(f:hipFunction_t, gridDimX:Annotated[int, ctypes.c_uint32], gridDimY:Annotated[int, ctypes.c_uint32], gridDimZ:Annotated[int, ctypes.c_uint32], blockDimX:Annotated[int, ctypes.c_uint32], blockDimY:Annotated[int, ctypes.c_uint32], blockDimZ:Annotated[int, ctypes.c_uint32], sharedMemBytes:Annotated[int, ctypes.c_uint32], stream:hipStream_t, kernelParams:POINTER(POINTER(None))) -> hipError_t: ...
@dll.bind
def hipModuleLaunchCooperativeKernelMultiDevice(launchParamsList:POINTER(hipFunctionLaunchParams), numDevices:Annotated[int, ctypes.c_uint32], flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipLaunchCooperativeKernel(f:POINTER(None), gridDim:dim3, blockDimX:dim3, kernelParams:POINTER(POINTER(None)), sharedMemBytes:Annotated[int, ctypes.c_uint32], stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipLaunchCooperativeKernelMultiDevice(launchParamsList:POINTER(hipLaunchParams), numDevices:Annotated[int, ctypes.c_int32], flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipExtLaunchMultiKernelMultiDevice(launchParamsList:POINTER(hipLaunchParams), numDevices:Annotated[int, ctypes.c_int32], flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipModuleOccupancyMaxPotentialBlockSize(gridSize:POINTER(Annotated[int, ctypes.c_int32]), blockSize:POINTER(Annotated[int, ctypes.c_int32]), f:hipFunction_t, dynSharedMemPerBlk:size_t, blockSizeLimit:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipModuleOccupancyMaxPotentialBlockSizeWithFlags(gridSize:POINTER(Annotated[int, ctypes.c_int32]), blockSize:POINTER(Annotated[int, ctypes.c_int32]), f:hipFunction_t, dynSharedMemPerBlk:size_t, blockSizeLimit:Annotated[int, ctypes.c_int32], flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipModuleOccupancyMaxActiveBlocksPerMultiprocessor(numBlocks:POINTER(Annotated[int, ctypes.c_int32]), f:hipFunction_t, blockSize:Annotated[int, ctypes.c_int32], dynSharedMemPerBlk:size_t) -> hipError_t: ...
@dll.bind
def hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(numBlocks:POINTER(Annotated[int, ctypes.c_int32]), f:hipFunction_t, blockSize:Annotated[int, ctypes.c_int32], dynSharedMemPerBlk:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipOccupancyMaxActiveBlocksPerMultiprocessor(numBlocks:POINTER(Annotated[int, ctypes.c_int32]), f:POINTER(None), blockSize:Annotated[int, ctypes.c_int32], dynSharedMemPerBlk:size_t) -> hipError_t: ...
@dll.bind
def hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(numBlocks:POINTER(Annotated[int, ctypes.c_int32]), f:POINTER(None), blockSize:Annotated[int, ctypes.c_int32], dynSharedMemPerBlk:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipOccupancyMaxPotentialBlockSize(gridSize:POINTER(Annotated[int, ctypes.c_int32]), blockSize:POINTER(Annotated[int, ctypes.c_int32]), f:POINTER(None), dynSharedMemPerBlk:size_t, blockSizeLimit:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipSetupArgument(arg:POINTER(None), size:size_t, offset:size_t) -> hipError_t: ...
@dll.bind
def hipLaunchByPtr(func:POINTER(None)) -> hipError_t: ...
@dll.bind
def __hipPushCallConfiguration(gridDim:dim3, blockDim:dim3, sharedMem:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def __hipPopCallConfiguration(gridDim:POINTER(dim3), blockDim:POINTER(dim3), sharedMem:POINTER(size_t), stream:POINTER(hipStream_t)) -> hipError_t: ...
@dll.bind
def hipLaunchKernel(function_address:POINTER(None), numBlocks:dim3, dimBlocks:dim3, args:POINTER(POINTER(None)), sharedMemBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipLaunchHostFunc(stream:hipStream_t, fn:hipHostFn_t, userData:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipDrvMemcpy2DUnaligned(pCopy:POINTER(hip_Memcpy2D)) -> hipError_t: ...
@record
...
class _anonstruct22:
  SIZE = 40
  devPtr: Annotated[POINTER(None), 0]
  desc: Annotated[hipChannelFormatDesc, 8]
...
class hipTextureDesc:
  ...
  borderColor: Annotated[Array[Annotated[float, ctypes.c_float], Literal[4]], 24]
...
@dll.bind
def hipCreateTextureObject(pTexObject:POINTER(hipTextureObject_t), pResDesc:POINTER(hipResourceDesc), pTexDesc:POINTER(hipTextureDesc), pResViewDesc:POINTER(hipResourceViewDesc)) -> hipError_t: ...
@dll.bind
def hipDestroyTextureObject(textureObject:hipTextureObject_t) -> hipError_t: ...
@dll.bind
def hipGetChannelDesc(desc:POINTER(hipChannelFormatDesc), array:hipArray_const_t) -> hipError_t: ...
@dll.bind
def hipGetTextureObjectResourceDesc(pResDesc:POINTER(hipResourceDesc), textureObject:hipTextureObject_t) -> hipError_t: ...
@dll.bind
def hipGetTextureObjectResourceViewDesc(pResViewDesc:POINTER(hipResourceViewDesc), textureObject:hipTextureObject_t) -> hipError_t: ...
@dll.bind
def hipGetTextureObjectTextureDesc(pTexDesc:POINTER(hipTextureDesc), textureObject:hipTextureObject_t) -> hipError_t: ...
@record
...
@dll.bind
def hipTexObjectGetResourceDesc(pResDesc:POINTER(HIP_RESOURCE_DESC), texObject:hipTextureObject_t) -> hipError_t: ...
@dll.bind
def hipTexObjectGetResourceViewDesc(pResViewDesc:POINTER(HIP_RESOURCE_VIEW_DESC), texObject:hipTextureObject_t) -> hipError_t: ...
@dll.bind
def hipTexObjectGetTextureDesc(pTexDesc:POINTER(HIP_TEXTURE_DESC), texObject:hipTextureObject_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMipmappedArrayCreate(pHandle:POINTER(hipMipmappedArray_t), pMipmappedArrayDesc:POINTER(HIP_ARRAY3D_DESCRIPTOR), numMipmapLevels:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMipmappedArrayDestroy(hMipmappedArray:hipMipmappedArray_t) -> hipError_t: ...
@dll.bind
def hipMipmappedArrayGetLevel(pLevelArray:POINTER(hipArray_t), hMipMappedArray:hipMipmappedArray_t, level:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipBindTextureToMipmappedArray(tex:POINTER(textureReference), mipmappedArray:hipMipmappedArray_const_t, desc:POINTER(hipChannelFormatDesc)) -> hipError_t: ...
@dll.bind
def hipGetTextureReference(texref:POINTER(POINTER(textureReference)), symbol:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipTexRefGetBorderColor(pBorderColor:POINTER(Annotated[float, ctypes.c_float]), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetArray(pArray:POINTER(hipArray_t), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefSetAddressMode(texRef:POINTER(textureReference), dim:Annotated[int, ctypes.c_int32], am:hipTextureAddressMode) -> hipError_t: ...
@dll.bind
def hipTexRefSetArray(tex:POINTER(textureReference), array:hipArray_const_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipTexRefSetFilterMode(texRef:POINTER(textureReference), fm:hipTextureFilterMode) -> hipError_t: ...
@dll.bind
def hipTexRefSetFlags(texRef:POINTER(textureReference), Flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipTexRefSetFormat(texRef:POINTER(textureReference), fmt:hipArray_Format, NumPackedComponents:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipBindTexture(offset:POINTER(size_t), tex:POINTER(textureReference), devPtr:POINTER(None), desc:POINTER(hipChannelFormatDesc), size:size_t) -> hipError_t: ...
@dll.bind
def hipBindTexture2D(offset:POINTER(size_t), tex:POINTER(textureReference), devPtr:POINTER(None), desc:POINTER(hipChannelFormatDesc), width:size_t, height:size_t, pitch:size_t) -> hipError_t: ...
@dll.bind
def hipBindTextureToArray(tex:POINTER(textureReference), array:hipArray_const_t, desc:POINTER(hipChannelFormatDesc)) -> hipError_t: ...
@dll.bind
def hipGetTextureAlignmentOffset(offset:POINTER(size_t), texref:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipUnbindTexture(tex:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetAddress(dev_ptr:POINTER(hipDeviceptr_t), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetAddressMode(pam:POINTER(hipTextureAddressMode), texRef:POINTER(textureReference), dim:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipTexRefGetFilterMode(pfm:POINTER(hipTextureFilterMode), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetFlags(pFlags:POINTER(Annotated[int, ctypes.c_uint32]), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetFormat(pFormat:POINTER(hipArray_Format), pNumChannels:POINTER(Annotated[int, ctypes.c_int32]), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetMaxAnisotropy(pmaxAnsio:POINTER(Annotated[int, ctypes.c_int32]), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetMipmapFilterMode(pfm:POINTER(hipTextureFilterMode), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetMipmapLevelBias(pbias:POINTER(Annotated[float, ctypes.c_float]), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetMipmapLevelClamp(pminMipmapLevelClamp:POINTER(Annotated[float, ctypes.c_float]), pmaxMipmapLevelClamp:POINTER(Annotated[float, ctypes.c_float]), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefGetMipMappedArray(pArray:POINTER(hipMipmappedArray_t), texRef:POINTER(textureReference)) -> hipError_t: ...
@dll.bind
def hipTexRefSetAddress(ByteOffset:POINTER(size_t), texRef:POINTER(textureReference), dptr:hipDeviceptr_t, bytes:size_t) -> hipError_t: ...
@dll.bind
def hipTexRefSetAddress2D(texRef:POINTER(textureReference), desc:POINTER(HIP_ARRAY_DESCRIPTOR), dptr:hipDeviceptr_t, Pitch:size_t) -> hipError_t: ...
@dll.bind
def hipTexRefSetMaxAnisotropy(texRef:POINTER(textureReference), maxAniso:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipTexRefSetBorderColor(texRef:POINTER(textureReference), pBorderColor:POINTER(Annotated[float, ctypes.c_float])) -> hipError_t: ...
@dll.bind
def hipTexRefSetMipmapFilterMode(texRef:POINTER(textureReference), fm:hipTextureFilterMode) -> hipError_t: ...
@dll.bind
def hipTexRefSetMipmapLevelBias(texRef:POINTER(textureReference), bias:Annotated[float, ctypes.c_float]) -> hipError_t: ...
@dll.bind
def hipTexRefSetMipmapLevelClamp(texRef:POINTER(textureReference), minMipMapLevelClamp:Annotated[float, ctypes.c_float], maxMipMapLevelClamp:Annotated[float, ctypes.c_float]) -> hipError_t: ...
@dll.bind
def hipTexRefSetMipmappedArray(texRef:POINTER(textureReference), mipmappedArray:POINTER(hipMipmappedArray), Flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipApiName(id:uint32_t) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def hipKernelNameRef(f:hipFunction_t) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
def hipKernelNameRefByPtr(hostFunction:POINTER(None), stream:hipStream_t) -> POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def hipStreamBeginCaptureToGraph(stream:hipStream_t, graph:hipGraph_t, dependencies:POINTER(hipGraphNode_t), dependencyData:POINTER(hipGraphEdgeData), numDependencies:size_t, mode:hipStreamCaptureMode) -> hipError_t: ...
@dll.bind
def hipStreamEndCapture(stream:hipStream_t, pGraph:POINTER(hipGraph_t)) -> hipError_t: ...
@dll.bind
def hipStreamGetCaptureInfo(stream:hipStream_t, pCaptureStatus:POINTER(hipStreamCaptureStatus), pId:POINTER(Annotated[int, ctypes.c_uint64])) -> hipError_t: ...
@dll.bind
def hipStreamGetCaptureInfo_v2(stream:hipStream_t, captureStatus_out:POINTER(hipStreamCaptureStatus), id_out:POINTER(Annotated[int, ctypes.c_uint64]), graph_out:POINTER(hipGraph_t), dependencies_out:POINTER(POINTER(hipGraphNode_t)), numDependencies_out:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipStreamIsCapturing(stream:hipStream_t, pCaptureStatus:POINTER(hipStreamCaptureStatus)) -> hipError_t: ...
@dll.bind
def hipStreamUpdateCaptureDependencies(stream:hipStream_t, dependencies:POINTER(hipGraphNode_t), numDependencies:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipThreadExchangeStreamCaptureMode(mode:POINTER(hipStreamCaptureMode)) -> hipError_t: ...
@dll.bind
def hipGraphCreate(pGraph:POINTER(hipGraph_t), flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipGraphDestroy(graph:hipGraph_t) -> hipError_t: ...
@dll.bind
def hipGraphAddDependencies(graph:hipGraph_t, _from:POINTER(hipGraphNode_t), to:POINTER(hipGraphNode_t), numDependencies:size_t) -> hipError_t: ...
@dll.bind
def hipGraphRemoveDependencies(graph:hipGraph_t, _from:POINTER(hipGraphNode_t), to:POINTER(hipGraphNode_t), numDependencies:size_t) -> hipError_t: ...
@dll.bind
def hipGraphGetEdges(graph:hipGraph_t, _from:POINTER(hipGraphNode_t), to:POINTER(hipGraphNode_t), numEdges:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipGraphGetNodes(graph:hipGraph_t, nodes:POINTER(hipGraphNode_t), numNodes:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipGraphGetRootNodes(graph:hipGraph_t, pRootNodes:POINTER(hipGraphNode_t), pNumRootNodes:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipGraphNodeGetDependencies(node:hipGraphNode_t, pDependencies:POINTER(hipGraphNode_t), pNumDependencies:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipGraphNodeGetDependentNodes(node:hipGraphNode_t, pDependentNodes:POINTER(hipGraphNode_t), pNumDependentNodes:POINTER(size_t)) -> hipError_t: ...
@dll.bind
def hipGraphNodeGetType(node:hipGraphNode_t, pType:POINTER(hipGraphNodeType)) -> hipError_t: ...
@dll.bind
def hipGraphDestroyNode(node:hipGraphNode_t) -> hipError_t: ...
@dll.bind
def hipGraphClone(pGraphClone:POINTER(hipGraph_t), originalGraph:hipGraph_t) -> hipError_t: ...
@dll.bind
def hipGraphNodeFindInClone(pNode:POINTER(hipGraphNode_t), originalNode:hipGraphNode_t, clonedGraph:hipGraph_t) -> hipError_t: ...
@dll.bind
def hipGraphInstantiate(pGraphExec:POINTER(hipGraphExec_t), graph:hipGraph_t, pErrorNode:POINTER(hipGraphNode_t), pLogBuffer:POINTER(Annotated[bytes, ctypes.c_char]), bufferSize:size_t) -> hipError_t: ...
@dll.bind
def hipGraphInstantiateWithFlags(pGraphExec:POINTER(hipGraphExec_t), graph:hipGraph_t, flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
def hipGraphInstantiateWithParams(pGraphExec:POINTER(hipGraphExec_t), graph:hipGraph_t, instantiateParams:POINTER(hipGraphInstantiateParams)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGraphAddNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, nodeParams:POINTER(hipGraphNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExecDestroy(graphExec:hipGraphExec_t) -> hipError_t: ...
@dll.bind
def hipGraphExecUpdate(hGraphExec:hipGraphExec_t, hGraph:hipGraph_t, hErrorNode_out:POINTER(hipGraphNode_t), updateResult_out:POINTER(hipGraphExecUpdateResult)) -> hipError_t: ...
@dll.bind
def hipGraphAddKernelNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, pNodeParams:POINTER(hipKernelNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphKernelNodeGetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipKernelNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphKernelNodeSetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipKernelNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExecKernelNodeSetParams(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, pNodeParams:POINTER(hipKernelNodeParams)) -> hipError_t: ...
@dll.bind
def hipDrvGraphAddMemcpyNode(phGraphNode:POINTER(hipGraphNode_t), hGraph:hipGraph_t, dependencies:POINTER(hipGraphNode_t), numDependencies:size_t, copyParams:POINTER(HIP_MEMCPY3D), ctx:hipCtx_t) -> hipError_t: ...
@dll.bind
def hipGraphAddMemcpyNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, pCopyParams:POINTER(hipMemcpy3DParms)) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeGetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipMemcpy3DParms)) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeSetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipMemcpy3DParms)) -> hipError_t: ...
@dll.bind
def hipGraphKernelNodeSetAttribute(hNode:hipGraphNode_t, attr:hipLaunchAttributeID, value:POINTER(hipLaunchAttributeValue)) -> hipError_t: ...
@dll.bind
def hipGraphKernelNodeGetAttribute(hNode:hipGraphNode_t, attr:hipLaunchAttributeID, value:POINTER(hipLaunchAttributeValue)) -> hipError_t: ...
@dll.bind
def hipGraphExecMemcpyNodeSetParams(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, pNodeParams:POINTER(hipMemcpy3DParms)) -> hipError_t: ...
@dll.bind
def hipGraphAddMemcpyNode1D(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, dst:POINTER(None), src:POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeSetParams1D(node:hipGraphNode_t, dst:POINTER(None), src:POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphExecMemcpyNodeSetParams1D(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, dst:POINTER(None), src:POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphAddMemcpyNodeFromSymbol(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, dst:POINTER(None), symbol:POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeSetParamsFromSymbol(node:hipGraphNode_t, dst:POINTER(None), symbol:POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphExecMemcpyNodeSetParamsFromSymbol(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, dst:POINTER(None), symbol:POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphAddMemcpyNodeToSymbol(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, symbol:POINTER(None), src:POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeSetParamsToSymbol(node:hipGraphNode_t, symbol:POINTER(None), src:POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphExecMemcpyNodeSetParamsToSymbol(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, symbol:POINTER(None), src:POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphAddMemsetNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, pMemsetParams:POINTER(hipMemsetParams)) -> hipError_t: ...
@dll.bind
def hipGraphMemsetNodeGetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipMemsetParams)) -> hipError_t: ...
@dll.bind
def hipGraphMemsetNodeSetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipMemsetParams)) -> hipError_t: ...
@dll.bind
def hipGraphExecMemsetNodeSetParams(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, pNodeParams:POINTER(hipMemsetParams)) -> hipError_t: ...
@dll.bind
def hipGraphAddHostNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, pNodeParams:POINTER(hipHostNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphHostNodeGetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipHostNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphHostNodeSetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipHostNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExecHostNodeSetParams(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, pNodeParams:POINTER(hipHostNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphAddChildGraphNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, childGraph:hipGraph_t) -> hipError_t: ...
@dll.bind
def hipGraphChildGraphNodeGetGraph(node:hipGraphNode_t, pGraph:POINTER(hipGraph_t)) -> hipError_t: ...
@dll.bind
def hipGraphExecChildGraphNodeSetParams(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, childGraph:hipGraph_t) -> hipError_t: ...
@dll.bind
def hipGraphAddEmptyNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t) -> hipError_t: ...
@dll.bind
def hipGraphAddEventRecordNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, event:hipEvent_t) -> hipError_t: ...
@dll.bind
def hipGraphEventRecordNodeGetEvent(node:hipGraphNode_t, event_out:POINTER(hipEvent_t)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGraphAddEventWaitNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, event:hipEvent_t) -> hipError_t: ...
@dll.bind
def hipGraphEventWaitNodeGetEvent(node:hipGraphNode_t, event_out:POINTER(hipEvent_t)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGraphAddMemAllocNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, pNodeParams:POINTER(hipMemAllocNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphMemAllocNodeGetParams(node:hipGraphNode_t, pNodeParams:POINTER(hipMemAllocNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphAddMemFreeNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, dev_ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipGraphMemFreeNodeGetParams(node:hipGraphNode_t, dev_ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipDeviceGetGraphMemAttribute(device:Annotated[int, ctypes.c_int32], attr:hipGraphMemAttributeType, value:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipDeviceSetGraphMemAttribute(device:Annotated[int, ctypes.c_int32], attr:hipGraphMemAttributeType, value:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipDeviceGraphMemTrim(device:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipUserObjectCreate(object_out:POINTER(hipUserObject_t), ptr:POINTER(None), destroy:hipHostFn_t, initialRefcount:Annotated[int, ctypes.c_uint32], flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGraphDebugDotPrint(graph:hipGraph_t, path:POINTER(Annotated[bytes, ctypes.c_char]), flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGraphNodeGetEnabled(hGraphExec:hipGraphExec_t, hNode:hipGraphNode_t, isEnabled:POINTER(Annotated[int, ctypes.c_uint32])) -> hipError_t: ...
@dll.bind
def hipGraphAddExternalSemaphoresWaitNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, nodeParams:POINTER(hipExternalSemaphoreWaitNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphAddExternalSemaphoresSignalNode(pGraphNode:POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:POINTER(hipGraphNode_t), numDependencies:size_t, nodeParams:POINTER(hipExternalSemaphoreSignalNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExternalSemaphoresSignalNodeSetParams(hNode:hipGraphNode_t, nodeParams:POINTER(hipExternalSemaphoreSignalNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExternalSemaphoresWaitNodeSetParams(hNode:hipGraphNode_t, nodeParams:POINTER(hipExternalSemaphoreWaitNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExternalSemaphoresSignalNodeGetParams(hNode:hipGraphNode_t, params_out:POINTER(hipExternalSemaphoreSignalNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExternalSemaphoresWaitNodeGetParams(hNode:hipGraphNode_t, params_out:POINTER(hipExternalSemaphoreWaitNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExecExternalSemaphoresSignalNodeSetParams(hGraphExec:hipGraphExec_t, hNode:hipGraphNode_t, nodeParams:POINTER(hipExternalSemaphoreSignalNodeParams)) -> hipError_t: ...
@dll.bind
def hipGraphExecExternalSemaphoresWaitNodeSetParams(hGraphExec:hipGraphExec_t, hNode:hipGraphNode_t, nodeParams:POINTER(hipExternalSemaphoreWaitNodeParams)) -> hipError_t: ...
@dll.bind
def hipDrvGraphAddMemsetNode(phGraphNode:POINTER(hipGraphNode_t), hGraph:hipGraph_t, dependencies:POINTER(hipGraphNode_t), numDependencies:size_t, memsetParams:POINTER(HIP_MEMSET_NODE_PARAMS), ctx:hipCtx_t) -> hipError_t: ...
@dll.bind
def hipMemAddressFree(devPtr:POINTER(None), size:size_t) -> hipError_t: ...
@dll.bind
def hipMemAddressReserve(ptr:POINTER(POINTER(None)), size:size_t, alignment:size_t, addr:POINTER(None), flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
def hipMemCreate(handle:POINTER(hipMemGenericAllocationHandle_t), size:size_t, prop:POINTER(hipMemAllocationProp), flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
def hipMemExportToShareableHandle(shareableHandle:POINTER(None), handle:hipMemGenericAllocationHandle_t, handleType:hipMemAllocationHandleType, flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
def hipMemGetAccess(flags:POINTER(Annotated[int, ctypes.c_uint64]), location:POINTER(hipMemLocation), ptr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemGetAllocationGranularity(granularity:POINTER(size_t), prop:POINTER(hipMemAllocationProp), option:hipMemAllocationGranularity_flags) -> hipError_t: ...
@dll.bind
def hipMemGetAllocationPropertiesFromHandle(prop:POINTER(hipMemAllocationProp), handle:hipMemGenericAllocationHandle_t) -> hipError_t: ...
@dll.bind
def hipMemImportFromShareableHandle(handle:POINTER(hipMemGenericAllocationHandle_t), osHandle:POINTER(None), shHandleType:hipMemAllocationHandleType) -> hipError_t: ...
@dll.bind
def hipMemMap(ptr:POINTER(None), size:size_t, offset:size_t, handle:hipMemGenericAllocationHandle_t, flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
def hipMemMapArrayAsync(mapInfoList:POINTER(hipArrayMapInfo), count:Annotated[int, ctypes.c_uint32], stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemRelease(handle:hipMemGenericAllocationHandle_t) -> hipError_t: ...
@dll.bind
def hipMemRetainAllocationHandle(handle:POINTER(hipMemGenericAllocationHandle_t), addr:POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemSetAccess(ptr:POINTER(None), size:size_t, desc:POINTER(hipMemAccessDesc), count:size_t) -> hipError_t: ...
@dll.bind
def hipMemUnmap(ptr:POINTER(None), size:size_t) -> hipError_t: ...
@dll.bind
def hipGraphicsMapResources(count:Annotated[int, ctypes.c_int32], resources:POINTER(hipGraphicsResource_t), stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipGraphicsSubResourceGetMappedArray(array:POINTER(hipArray_t), resource:hipGraphicsResource_t, arrayIndex:Annotated[int, ctypes.c_uint32], mipLevel:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipGraphicsResourceGetMappedPointer(devPtr:POINTER(POINTER(None)), size:POINTER(size_t), resource:hipGraphicsResource_t) -> hipError_t: ...
@dll.bind
def hipGraphicsUnmapResources(count:Annotated[int, ctypes.c_int32], resources:POINTER(hipGraphicsResource_t), stream:hipStream_t) -> hipError_t: ...
@dll.bind
