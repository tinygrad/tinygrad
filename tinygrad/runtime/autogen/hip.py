...
@dll.bind
def hipHccModuleLaunchKernel(f:hipFunction_t, globalWorkSizeX:uint32_t, globalWorkSizeY:uint32_t, globalWorkSizeZ:uint32_t, localWorkSizeX:uint32_t, localWorkSizeY:uint32_t, localWorkSizeZ:uint32_t, sharedMemBytes:size_t, hStream:hipStream_t, kernelParams:c.POINTER(c.POINTER(None)), extra:c.POINTER(c.POINTER(None)), startEvent:hipEvent_t, stopEvent:hipEvent_t) -> hipError_t: ...
@c.record
class dim3(c.Struct):
  SIZE = 12
...
@dll.bind
def hiprtcLinkCreate(num_options:Annotated[int, ctypes.c_uint32], option_ptr:c.POINTER(hiprtcJIT_option), option_vals_pptr:c.POINTER(c.POINTER(None)), hip_link_state_ptr:c.POINTER(hiprtcLinkState)) -> hiprtcResult: ...
@dll.bind
def hiprtcLinkAddFile(hip_link_state:hiprtcLinkState, input_type:hiprtcJITInputType, file_path:c.POINTER(Annotated[bytes, ctypes.c_char]), num_options:Annotated[int, ctypes.c_uint32], options_ptr:c.POINTER(hiprtcJIT_option), option_values:c.POINTER(c.POINTER(None))) -> hiprtcResult: ...
@dll.bind
def hiprtcLinkAddData(hip_link_state:hiprtcLinkState, input_type:hiprtcJITInputType, image:c.POINTER(None), image_size:size_t, name:c.POINTER(Annotated[bytes, ctypes.c_char]), num_options:Annotated[int, ctypes.c_uint32], options_ptr:c.POINTER(hiprtcJIT_option), option_values:c.POINTER(c.POINTER(None))) -> hiprtcResult: ...
@dll.bind
...
class hipPointerAttribute_t(c.Struct):
  ...
  devicePointer: Annotated[c.POINTER(None), 8]
...
class hipMemPoolProps(c.Struct):
  ...
  win32SecurityAttributes: Annotated[c.POINTER(None), 16]
...
class hipLaunchParams_t(c.Struct):
  SIZE = 56
  func: Annotated[c.POINTER(None), 0]
...
class _anonunion1(c.Struct):
  ...
  nvSciBufObject: Annotated[c.POINTER(None), 0]
@c.record
class _anonstruct2(c.Struct):
  SIZE = 16
...
class _anonunion3(c.Struct):
  ...
  NvSciSyncObj: Annotated[c.POINTER(None), 0]
@c.record
...
class hipHostNodeParams(c.Struct):
  ...
  userData: Annotated[c.POINTER(None), 8]
@c.record
class hipKernelNodeParams(c.Struct):
  SIZE = 64
  blockDim: Annotated[dim3, 0]
  extra: Annotated[c.POINTER(c.POINTER(None)), 16]
  func: Annotated[c.POINTER(None), 24]
...
class hipMemsetParams(c.Struct):
  SIZE = 48
  dst: Annotated[c.POINTER(None), 0]
...
class hipAccessPolicyWindow(c.Struct):
  SIZE = 32
  base_ptr: Annotated[c.POINTER(None), 0]
...
class hipMemAllocationProp(c.Struct):
  ...
  location: Annotated[hipMemLocation, 8]
  win32HandleMetaData: Annotated[c.POINTER(None), 16]
  allocFlags: Annotated[_anonstruct13, 24]
@c.record
class _anonstruct13(c.Struct):
  SIZE = 4
...
class hipMemFreeNodeParams(c.Struct):
  SIZE = 8
  dptr: Annotated[c.POINTER(None), 0]
@c.record
...
@dll.bind
def hipIpcGetMemHandle(handle:c.POINTER(hipIpcMemHandle_t), devPtr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipIpcOpenMemHandle(devPtr:c.POINTER(c.POINTER(None)), handle:hipIpcMemHandle_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipIpcCloseMemHandle(devPtr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipFuncSetAttribute(func:c.POINTER(None), attr:hipFuncAttribute, value:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipFuncSetCacheConfig(func:c.POINTER(None), config:hipFuncCache_t) -> hipError_t: ...
@dll.bind
def hipFuncSetSharedMemConfig(func:c.POINTER(None), config:hipSharedMemConfig) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipStreamWriteValue32(stream:hipStream_t, ptr:c.POINTER(None), value:uint32_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipStreamWriteValue64(stream:hipStream_t, ptr:c.POINTER(None), value:uint64_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipPointerGetAttributes(attributes:c.POINTER(hipPointerAttribute_t), ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipPointerGetAttribute(data:c.POINTER(None), attribute:hipPointer_attribute, ptr:hipDeviceptr_t) -> hipError_t: ...
@dll.bind
def hipDrvPointerGetAttributes(numAttributes:Annotated[int, ctypes.c_uint32], attributes:c.POINTER(hipPointer_attribute), data:c.POINTER(c.POINTER(None)), ptr:hipDeviceptr_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMalloc(ptr:c.POINTER(c.POINTER(None)), size:size_t) -> hipError_t: ...
@dll.bind
def hipExtMallocWithFlags(ptr:c.POINTER(c.POINTER(None)), sizeBytes:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMallocHost(ptr:c.POINTER(c.POINTER(None)), size:size_t) -> hipError_t: ...
@dll.bind
def hipMemAllocHost(ptr:c.POINTER(c.POINTER(None)), size:size_t) -> hipError_t: ...
@dll.bind
def hipHostMalloc(ptr:c.POINTER(c.POINTER(None)), size:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMallocManaged(dev_ptr:c.POINTER(c.POINTER(None)), size:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMemPrefetchAsync(dev_ptr:c.POINTER(None), count:size_t, device:Annotated[int, ctypes.c_int32], stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemAdvise(dev_ptr:c.POINTER(None), count:size_t, advice:hipMemoryAdvise, device:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipMemRangeGetAttribute(data:c.POINTER(None), data_size:size_t, attribute:hipMemRangeAttribute, dev_ptr:c.POINTER(None), count:size_t) -> hipError_t: ...
@dll.bind
def hipMemRangeGetAttributes(data:c.POINTER(c.POINTER(None)), data_sizes:c.POINTER(size_t), attributes:c.POINTER(hipMemRangeAttribute), num_attributes:size_t, dev_ptr:c.POINTER(None), count:size_t) -> hipError_t: ...
@dll.bind
def hipStreamAttachMemAsync(stream:hipStream_t, dev_ptr:c.POINTER(None), length:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMallocAsync(dev_ptr:c.POINTER(c.POINTER(None)), size:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipFreeAsync(dev_ptr:c.POINTER(None), stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemPoolTrimTo(mem_pool:hipMemPool_t, min_bytes_to_hold:size_t) -> hipError_t: ...
@dll.bind
def hipMemPoolSetAttribute(mem_pool:hipMemPool_t, attr:hipMemPoolAttr, value:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemPoolGetAttribute(mem_pool:hipMemPool_t, attr:hipMemPoolAttr, value:c.POINTER(None)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMallocFromPoolAsync(dev_ptr:c.POINTER(c.POINTER(None)), size:size_t, mem_pool:hipMemPool_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemPoolExportToShareableHandle(shared_handle:c.POINTER(None), mem_pool:hipMemPool_t, handle_type:hipMemAllocationHandleType, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMemPoolImportFromShareableHandle(mem_pool:c.POINTER(hipMemPool_t), shared_handle:c.POINTER(None), handle_type:hipMemAllocationHandleType, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipMemPoolExportPointer(export_data:c.POINTER(hipMemPoolPtrExportData), dev_ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemPoolImportPointer(dev_ptr:c.POINTER(c.POINTER(None)), mem_pool:hipMemPool_t, export_data:c.POINTER(hipMemPoolPtrExportData)) -> hipError_t: ...
@dll.bind
def hipHostAlloc(ptr:c.POINTER(c.POINTER(None)), size:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipHostGetDevicePointer(devPtr:c.POINTER(c.POINTER(None)), hstPtr:c.POINTER(None), flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipHostGetFlags(flagsPtr:c.POINTER(Annotated[int, ctypes.c_uint32]), hostPtr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipHostRegister(hostPtr:c.POINTER(None), sizeBytes:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipHostUnregister(hostPtr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMallocPitch(ptr:c.POINTER(c.POINTER(None)), pitch:c.POINTER(size_t), width:size_t, height:size_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipFree(ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipFreeHost(ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipHostFree(ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemcpy(dst:c.POINTER(None), src:c.POINTER(None), sizeBytes:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyWithStream(dst:c.POINTER(None), src:c.POINTER(None), sizeBytes:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyHtoD(dst:hipDeviceptr_t, src:c.POINTER(None), sizeBytes:size_t) -> hipError_t: ...
@dll.bind
def hipMemcpyDtoH(dst:c.POINTER(None), src:hipDeviceptr_t, sizeBytes:size_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemcpyHtoDAsync(dst:hipDeviceptr_t, src:c.POINTER(None), sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyDtoHAsync(dst:c.POINTER(None), src:hipDeviceptr_t, sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyDtoDAsync(dst:hipDeviceptr_t, src:hipDeviceptr_t, sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyAtoHAsync(dstHost:c.POINTER(None), srcArray:hipArray_t, srcOffset:size_t, ByteCount:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyHtoAAsync(dstArray:hipArray_t, dstOffset:size_t, srcHost:c.POINTER(None), ByteCount:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGetSymbolAddress(devPtr:c.POINTER(c.POINTER(None)), symbol:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipGetSymbolSize(size:c.POINTER(size_t), symbol:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipGetProcAddress(symbol:c.POINTER(Annotated[bytes, ctypes.c_char]), pfn:c.POINTER(c.POINTER(None)), hipVersion:Annotated[int, ctypes.c_int32], flags:uint64_t, symbolStatus:c.POINTER(hipDriverProcAddressQueryResult)) -> hipError_t: ...
@dll.bind
def hipMemcpyToSymbol(symbol:c.POINTER(None), src:c.POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyToSymbolAsync(symbol:c.POINTER(None), src:c.POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyFromSymbol(dst:c.POINTER(None), symbol:c.POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyFromSymbolAsync(dst:c.POINTER(None), symbol:c.POINTER(None), sizeBytes:size_t, offset:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyAsync(dst:c.POINTER(None), src:c.POINTER(None), sizeBytes:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemset(dst:c.POINTER(None), value:Annotated[int, ctypes.c_int32], sizeBytes:size_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemsetAsync(dst:c.POINTER(None), value:Annotated[int, ctypes.c_int32], sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemsetD32Async(dst:hipDeviceptr_t, value:Annotated[int, ctypes.c_int32], count:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemset2D(dst:c.POINTER(None), pitch:size_t, value:Annotated[int, ctypes.c_int32], width:size_t, height:size_t) -> hipError_t: ...
@dll.bind
def hipMemset2DAsync(dst:c.POINTER(None), pitch:size_t, value:Annotated[int, ctypes.c_int32], width:size_t, height:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemPtrGetInfo(ptr:c.POINTER(None), size:c.POINTER(size_t)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemcpy2D(dst:c.POINTER(None), dpitch:size_t, src:c.POINTER(None), spitch:size_t, width:size_t, height:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@c.record
class hip_Memcpy2D(c.Struct):
  ...
  srcHost: Annotated[c.POINTER(None), 24]
  ...
  dstHost: Annotated[c.POINTER(None), 80]
...
@dll.bind
def hipMemcpy2DAsync(dst:c.POINTER(None), dpitch:size_t, src:c.POINTER(None), spitch:size_t, width:size_t, height:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemcpyToArray(dst:hipArray_t, wOffset:size_t, hOffset:size_t, src:c.POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpyFromArray(dst:c.POINTER(None), srcArray:hipArray_const_t, wOffset:size_t, hOffset:size_t, count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpy2DFromArray(dst:c.POINTER(None), dpitch:size_t, src:hipArray_const_t, wOffset:size_t, hOffset:size_t, width:size_t, height:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipMemcpy2DFromArrayAsync(dst:c.POINTER(None), dpitch:size_t, src:hipArray_const_t, wOffset:size_t, hOffset:size_t, width:size_t, height:size_t, kind:hipMemcpyKind, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipMemcpyAtoH(dst:c.POINTER(None), srcArray:hipArray_t, srcOffset:size_t, count:size_t) -> hipError_t: ...
@dll.bind
def hipMemcpyHtoA(dstArray:hipArray_t, dstOffset:size_t, srcHost:c.POINTER(None), count:size_t) -> hipError_t: ...
@dll.bind
...
class HIP_MEMCPY3D(c.Struct):
  ...
  srcHost: Annotated[c.POINTER(None), 40]
  ...
  dstHost: Annotated[c.POINTER(None), 120]
...
@dll.bind
def hipMemcpyPeer(dst:c.POINTER(None), dstDeviceId:Annotated[int, ctypes.c_int32], src:c.POINTER(None), srcDeviceId:Annotated[int, ctypes.c_int32], sizeBytes:size_t) -> hipError_t: ...
@dll.bind
def hipMemcpyPeerAsync(dst:c.POINTER(None), dstDeviceId:Annotated[int, ctypes.c_int32], src:c.POINTER(None), srcDevice:Annotated[int, ctypes.c_int32], sizeBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGetFuncBySymbol(functionPtr:c.POINTER(hipFunction_t), symbolPtr:c.POINTER(None)) -> hipError_t: ...
@c.record
...
@dll.bind
def hipModuleLoadData(module:c.POINTER(hipModule_t), image:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipModuleLoadDataEx(module:c.POINTER(hipModule_t), image:c.POINTER(None), numOptions:Annotated[int, ctypes.c_uint32], options:c.POINTER(hipJitOption), optionValues:c.POINTER(c.POINTER(None))) -> hipError_t: ...
@dll.bind
def hipModuleLaunchKernel(f:hipFunction_t, gridDimX:Annotated[int, ctypes.c_uint32], gridDimY:Annotated[int, ctypes.c_uint32], gridDimZ:Annotated[int, ctypes.c_uint32], blockDimX:Annotated[int, ctypes.c_uint32], blockDimY:Annotated[int, ctypes.c_uint32], blockDimZ:Annotated[int, ctypes.c_uint32], sharedMemBytes:Annotated[int, ctypes.c_uint32], stream:hipStream_t, kernelParams:c.POINTER(c.POINTER(None)), extra:c.POINTER(c.POINTER(None))) -> hipError_t: ...
@dll.bind
def hipModuleLaunchCooperativeKernel(f:hipFunction_t, gridDimX:Annotated[int, ctypes.c_uint32], gridDimY:Annotated[int, ctypes.c_uint32], gridDimZ:Annotated[int, ctypes.c_uint32], blockDimX:Annotated[int, ctypes.c_uint32], blockDimY:Annotated[int, ctypes.c_uint32], blockDimZ:Annotated[int, ctypes.c_uint32], sharedMemBytes:Annotated[int, ctypes.c_uint32], stream:hipStream_t, kernelParams:c.POINTER(c.POINTER(None))) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipLaunchCooperativeKernel(f:c.POINTER(None), gridDim:dim3, blockDimX:dim3, kernelParams:c.POINTER(c.POINTER(None)), sharedMemBytes:Annotated[int, ctypes.c_uint32], stream:hipStream_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipOccupancyMaxActiveBlocksPerMultiprocessor(numBlocks:c.POINTER(Annotated[int, ctypes.c_int32]), f:c.POINTER(None), blockSize:Annotated[int, ctypes.c_int32], dynSharedMemPerBlk:size_t) -> hipError_t: ...
@dll.bind
def hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(numBlocks:c.POINTER(Annotated[int, ctypes.c_int32]), f:c.POINTER(None), blockSize:Annotated[int, ctypes.c_int32], dynSharedMemPerBlk:size_t, flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
def hipOccupancyMaxPotentialBlockSize(gridSize:c.POINTER(Annotated[int, ctypes.c_int32]), blockSize:c.POINTER(Annotated[int, ctypes.c_int32]), f:c.POINTER(None), dynSharedMemPerBlk:size_t, blockSizeLimit:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipSetupArgument(arg:c.POINTER(None), size:size_t, offset:size_t) -> hipError_t: ...
@dll.bind
def hipLaunchByPtr(func:c.POINTER(None)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipLaunchKernel(function_address:c.POINTER(None), numBlocks:dim3, dimBlocks:dim3, args:c.POINTER(c.POINTER(None)), sharedMemBytes:size_t, stream:hipStream_t) -> hipError_t: ...
@dll.bind
def hipLaunchHostFunc(stream:hipStream_t, fn:hipHostFn_t, userData:c.POINTER(None)) -> hipError_t: ...
@dll.bind
...
@c.record
class _anonstruct22(c.Struct):
  SIZE = 40
  devPtr: Annotated[c.POINTER(None), 0]
  desc: Annotated[hipChannelFormatDesc, 8]
  sizeInBytes: Annotated[size_t, 32]
@c.record
class _anonstruct23(c.Struct):
  SIZE = 56
  devPtr: Annotated[c.POINTER(None), 0]
  desc: Annotated[hipChannelFormatDesc, 8]
...
@dll.bind
def hipGetTextureReference(texref:c.POINTER(c.POINTER(textureReference)), symbol:c.POINTER(None)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipBindTexture(offset:c.POINTER(size_t), tex:c.POINTER(textureReference), devPtr:c.POINTER(None), desc:c.POINTER(hipChannelFormatDesc), size:size_t) -> hipError_t: ...
@dll.bind
def hipBindTexture2D(offset:c.POINTER(size_t), tex:c.POINTER(textureReference), devPtr:c.POINTER(None), desc:c.POINTER(hipChannelFormatDesc), width:size_t, height:size_t, pitch:size_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipKernelNameRefByPtr(hostFunction:c.POINTER(None), stream:hipStream_t) -> c.POINTER(Annotated[bytes, ctypes.c_char]): ...
@dll.bind
...
@dll.bind
def hipGraphAddMemcpyNode1D(pGraphNode:c.POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:c.POINTER(hipGraphNode_t), numDependencies:size_t, dst:c.POINTER(None), src:c.POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeSetParams1D(node:hipGraphNode_t, dst:c.POINTER(None), src:c.POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphExecMemcpyNodeSetParams1D(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, dst:c.POINTER(None), src:c.POINTER(None), count:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphAddMemcpyNodeFromSymbol(pGraphNode:c.POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:c.POINTER(hipGraphNode_t), numDependencies:size_t, dst:c.POINTER(None), symbol:c.POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeSetParamsFromSymbol(node:hipGraphNode_t, dst:c.POINTER(None), symbol:c.POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphExecMemcpyNodeSetParamsFromSymbol(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, dst:c.POINTER(None), symbol:c.POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphAddMemcpyNodeToSymbol(pGraphNode:c.POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:c.POINTER(hipGraphNode_t), numDependencies:size_t, symbol:c.POINTER(None), src:c.POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphMemcpyNodeSetParamsToSymbol(node:hipGraphNode_t, symbol:c.POINTER(None), src:c.POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
def hipGraphExecMemcpyNodeSetParamsToSymbol(hGraphExec:hipGraphExec_t, node:hipGraphNode_t, symbol:c.POINTER(None), src:c.POINTER(None), count:size_t, offset:size_t, kind:hipMemcpyKind) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGraphAddMemFreeNode(pGraphNode:c.POINTER(hipGraphNode_t), graph:hipGraph_t, pDependencies:c.POINTER(hipGraphNode_t), numDependencies:size_t, dev_ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipGraphMemFreeNodeGetParams(node:hipGraphNode_t, dev_ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipDeviceGetGraphMemAttribute(device:Annotated[int, ctypes.c_int32], attr:hipGraphMemAttributeType, value:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipDeviceSetGraphMemAttribute(device:Annotated[int, ctypes.c_int32], attr:hipGraphMemAttributeType, value:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipDeviceGraphMemTrim(device:Annotated[int, ctypes.c_int32]) -> hipError_t: ...
@dll.bind
def hipUserObjectCreate(object_out:c.POINTER(hipUserObject_t), ptr:c.POINTER(None), destroy:hipHostFn_t, initialRefcount:Annotated[int, ctypes.c_uint32], flags:Annotated[int, ctypes.c_uint32]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemAddressFree(devPtr:c.POINTER(None), size:size_t) -> hipError_t: ...
@dll.bind
def hipMemAddressReserve(ptr:c.POINTER(c.POINTER(None)), size:size_t, alignment:size_t, addr:c.POINTER(None), flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemExportToShareableHandle(shareableHandle:c.POINTER(None), handle:hipMemGenericAllocationHandle_t, handleType:hipMemAllocationHandleType, flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
def hipMemGetAccess(flags:c.POINTER(Annotated[int, ctypes.c_uint64]), location:c.POINTER(hipMemLocation), ptr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemImportFromShareableHandle(handle:c.POINTER(hipMemGenericAllocationHandle_t), osHandle:c.POINTER(None), shHandleType:hipMemAllocationHandleType) -> hipError_t: ...
@dll.bind
def hipMemMap(ptr:c.POINTER(None), size:size_t, offset:size_t, handle:hipMemGenericAllocationHandle_t, flags:Annotated[int, ctypes.c_uint64]) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipMemRetainAllocationHandle(handle:c.POINTER(hipMemGenericAllocationHandle_t), addr:c.POINTER(None)) -> hipError_t: ...
@dll.bind
def hipMemSetAccess(ptr:c.POINTER(None), size:size_t, desc:c.POINTER(hipMemAccessDesc), count:size_t) -> hipError_t: ...
@dll.bind
def hipMemUnmap(ptr:c.POINTER(None), size:size_t) -> hipError_t: ...
@dll.bind
...
@dll.bind
def hipGraphicsResourceGetMappedPointer(devPtr:c.POINTER(c.POINTER(None)), size:c.POINTER(size_t), resource:hipGraphicsResource_t) -> hipError_t: ...
@dll.bind
