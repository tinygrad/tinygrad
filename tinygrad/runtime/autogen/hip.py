...
_libraries["libamdhip64.so"] = ctypes.CDLL(
    os.getenv("ROCM_PATH", "/opt/rocm/") + "/lib/libamdhip64.so"
)
...
try:
    ...
    hipDeviceComputeCapability.argtypes = [
...
try:
    ...
    hipDeviceGetP2PAttribute.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        hipDeviceP2PAttr,
        ctypes.c_int32,
        ctypes.c_int32,
...
try:
    ...
    hipDeviceGetByPCIBusId.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(ctypes.c_char),
    ]
except AttributeError:
...
try:
    ...
    hipDeviceGetAttribute.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
...
try:
    ...
    hipDeviceGetDefaultMemPool.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipMemPoolHandle_t)),
        ctypes.c_int32,
    ]
except AttributeError:
    pass
...
try:
    ...
    pass
try:
    hipGetDevicePropertiesR0600 = _libraries[
        "libamdhip64.so"
...
try:
    ...
    pass
try:
    hipDeviceGetSharedMemConfig = _libraries[
        "libamdhip64.so"
...
try:
    ...
    pass
try:
    hipDeviceSetSharedMemConfig = _libraries[
        "libamdhip64.so"
...
try:
    ...
    pass
try:
    hipExtGetLinkTypeAndHopCount = _libraries[
        "libamdhip64.so"
    ].hipExtGetLinkTypeAndHopCount
    hipExtGetLinkTypeAndHopCount.restype = hipError_t
    hipExtGetLinkTypeAndHopCount.argtypes = [
        ctypes.c_int32,
        ctypes.c_int32,
        ctypes.POINTER(ctypes.c_uint32),
        ctypes.POINTER(ctypes.c_uint32),
...
try:
    ...
    hipIpcGetMemHandle.argtypes = [
        ctypes.POINTER(struct_hipIpcMemHandle_st),
        ctypes.POINTER(None),
    ]
except AttributeError:
    pass
...
try:
    ...
    hipIpcGetEventHandle.argtypes = [
        ctypes.POINTER(struct_hipIpcEventHandle_st),
        hipEvent_t,
    ]
except AttributeError:
    pass
try:
    ...
    hipIpcOpenEventHandle.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipEvent_t)),
        hipIpcEventHandle_t,
    ]
except AttributeError:
    pass
...
try:
    ...
    hipStreamCreateWithFlags.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipStream_t)),
        ctypes.c_uint32,
    ]
except AttributeError:
    pass
try:
    hipStreamCreateWithPriority = _libraries[
        "libamdhip64.so"
    ].hipStreamCreateWithPriority
    hipStreamCreateWithPriority.restype = hipError_t
    hipStreamCreateWithPriority.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipStream_t)),
        ctypes.c_uint32,
        ctypes.c_int32,
    ]
    ...
    pass
try:
    hipDeviceGetStreamPriorityRange = _libraries[
        "libamdhip64.so"
    ].hipDeviceGetStreamPriorityRange
    hipDeviceGetStreamPriorityRange.restype = hipError_t
    hipDeviceGetStreamPriorityRange.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(ctypes.c_int32),
    ]
except AttributeError:
...
try:
    hipExtStreamCreateWithCUMask = _libraries[
        "libamdhip64.so"
    ].hipExtStreamCreateWithCUMask
    hipExtStreamCreateWithCUMask.restype = hipError_t
    hipExtStreamCreateWithCUMask.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipStream_t)),
        uint32_t,
        ctypes.POINTER(ctypes.c_uint32),
    ]
...
try:
    ...
    hipExtStreamGetCUMask.argtypes = [
        hipStream_t,
        uint32_t,
        ctypes.POINTER(ctypes.c_uint32),
    ]
    ...
    pass
hipStreamCallback_t = ctypes.CFUNCTYPE(
    None, ctypes.POINTER(struct_ihipStream_t), hipError_t, ctypes.POINTER(None)
)
try:
    hipStreamAddCallback = _libraries["libamdhip64.so"].hipStreamAddCallback
    hipStreamAddCallback.restype = hipError_t
    hipStreamAddCallback.argtypes = [
        hipStream_t,
        hipStreamCallback_t,
        ctypes.POINTER(None),
        ctypes.c_uint32,
...
try:
    ...
    hipStreamWriteValue32.argtypes = [
        hipStream_t,
        ctypes.POINTER(None),
        uint32_t,
        ctypes.c_uint32,
...
try:
    ...
    hipStreamWriteValue64.argtypes = [
        hipStream_t,
        ctypes.POINTER(None),
        uint64_t,
        ctypes.c_uint32,
...
try:
    ...
    hipEventCreateWithFlags.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipEvent_t)),
        ctypes.c_uint32,
    ]
except AttributeError:
...
try:
    ...
    hipPointerSetAttribute.argtypes = [
        ctypes.POINTER(None),
...
try:
    ...
    hipPointerGetAttribute.argtypes = [
        ctypes.POINTER(None),
        hipPointer_attribute,
        hipDeviceptr_t,
    ]
...
try:
    ...
    hipDrvPointerGetAttributes.argtypes = [
        ctypes.c_uint32,
        ctypes.POINTER(hipPointer_attribute),
        ctypes.POINTER(ctypes.POINTER(None)),
        hipDeviceptr_t,
    ]
except AttributeError:
...
try:
    ...
    hipImportExternalSemaphore.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(struct_hipExternalSemaphoreHandleDesc_st),
    ]
except AttributeError:
    pass
try:
    hipSignalExternalSemaphoresAsync = _libraries[
        "libamdhip64.so"
    ].hipSignalExternalSemaphoresAsync
    hipSignalExternalSemaphoresAsync.restype = hipError_t
    hipSignalExternalSemaphoresAsync.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(struct_hipExternalSemaphoreSignalParams_st),
        ctypes.c_uint32,
        hipStream_t,
    ]
except AttributeError:
    pass
try:
    hipWaitExternalSemaphoresAsync = _libraries[
        "libamdhip64.so"
    ].hipWaitExternalSemaphoresAsync
    hipWaitExternalSemaphoresAsync.restype = hipError_t
    hipWaitExternalSemaphoresAsync.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(struct_hipExternalSemaphoreWaitParams_st),
        ctypes.c_uint32,
        hipStream_t,
    ]
except AttributeError:
    pass
try:
    hipDestroyExternalSemaphore = _libraries[
        "libamdhip64.so"
...
try:
    ...
    hipImportExternalMemory.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(struct_hipExternalMemoryHandleDesc_st),
    ]
except AttributeError:
    pass
try:
    hipExternalMemoryGetMappedBuffer = _libraries[
        "libamdhip64.so"
    ].hipExternalMemoryGetMappedBuffer
    hipExternalMemoryGetMappedBuffer.restype = hipError_t
    hipExternalMemoryGetMappedBuffer.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        hipExternalMemory_t,
        ctypes.POINTER(struct_hipExternalMemoryBufferDesc_st),
    ]
except AttributeError:
    pass
try:
    ...
    pass
try:
    hipExternalMemoryGetMappedMipmappedArray = _libraries[
        "FIXME_STUB"
    ].hipExternalMemoryGetMappedMipmappedArray
    hipExternalMemoryGetMappedMipmappedArray.restype = hipError_t
    hipExternalMemoryGetMappedMipmappedArray.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipMipmappedArray)),
        hipExternalMemory_t,
        ctypes.POINTER(struct_hipExternalMemoryMipmappedArrayDesc_st),
    ]
except AttributeError:
    pass
try:
...
try:
    ...
    hipExtMallocWithFlags.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        size_t,
        ctypes.c_uint32,
    ]
...
try:
    ...
    hipMemRangeGetAttribute.argtypes = [
        ctypes.POINTER(None),
        size_t,
...
try:
    ...
    hipMemRangeGetAttributes.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(hipMemRangeAttribute),
        size_t,
        ctypes.POINTER(None),
        size_t,
    ]
...
try:
    ...
    hipStreamAttachMemAsync.argtypes = [
        hipStream_t,
        ctypes.POINTER(None),
        size_t,
        ctypes.c_uint32,
...
try:
    ...
    hipMemPoolSetAttribute.argtypes = [
        hipMemPool_t,
        hipMemPoolAttr,
        ctypes.POINTER(None),
    ]
...
try:
    ...
    hipMemPoolGetAttribute.argtypes = [
        hipMemPool_t,
        hipMemPoolAttr,
        ctypes.POINTER(None),
    ]
...
try:
    ...
    hipMemPoolSetAccess.argtypes = [
        hipMemPool_t,
        ctypes.POINTER(struct_hipMemAccessDesc),
        size_t,
    ]
except AttributeError:
    pass
try:
    ...
    hipMemPoolGetAccess.argtypes = [
        ctypes.POINTER(hipMemAccessFlags),
        hipMemPool_t,
        ctypes.POINTER(struct_hipMemLocation),
    ]
except AttributeError:
    pass
try:
    ...
    hipMemPoolCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipMemPoolHandle_t)),
        ctypes.POINTER(struct_hipMemPoolProps),
    ]
except AttributeError:
    pass
try:
...
try:
    ...
    hipMallocFromPoolAsync.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        size_t,
        hipMemPool_t,
        hipStream_t,
    ...
    pass
try:
    hipMemPoolExportToShareableHandle = _libraries[
        "libamdhip64.so"
    ].hipMemPoolExportToShareableHandle
    hipMemPoolExportToShareableHandle.restype = hipError_t
    hipMemPoolExportToShareableHandle.argtypes = [
        ctypes.POINTER(None),
        hipMemPool_t,
    ...
    pass
try:
    hipMemPoolImportFromShareableHandle = _libraries[
        "libamdhip64.so"
    ].hipMemPoolImportFromShareableHandle
    hipMemPoolImportFromShareableHandle.restype = hipError_t
    hipMemPoolImportFromShareableHandle.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipMemPoolHandle_t)),
        ctypes.POINTER(None),
        hipMemAllocationHandleType,
        ctypes.c_uint32,
...
try:
    ...
    hipMemPoolExportPointer.argtypes = [
        ctypes.POINTER(struct_hipMemPoolPtrExportData),
        ctypes.POINTER(None),
    ]
except AttributeError:
    pass
try:
    ...
    hipMemPoolImportPointer.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        hipMemPool_t,
        ctypes.POINTER(struct_hipMemPoolPtrExportData),
    ]
...
try:
    ...
    hipHostGetDevicePointer.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(None),
        ctypes.c_uint32,
    ]
...
try:
    ...
    hipMemcpyToSymbolAsync.argtypes = [
        ctypes.POINTER(None),
        ctypes.POINTER(None),
        size_t,
        size_t,
...
try:
    ...
    hipMemcpyFromSymbolAsync.argtypes = [
        ctypes.POINTER(None),
        ctypes.POINTER(None),
        size_t,
        size_t,
...
try:
    ...
    hipMallocArray.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipArray)),
        ctypes.POINTER(struct_hipChannelFormatDesc),
        size_t,
        size_t,
        ctypes.c_uint32,
    ]
...
try:
    ...
    hipArrayCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipArray)),
        ctypes.POINTER(struct_HIP_ARRAY_DESCRIPTOR),
    ]
except AttributeError:
    pass
try:
...
try:
    ...
    hipArray3DCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipArray)),
        ctypes.POINTER(struct_HIP_ARRAY3D_DESCRIPTOR),
    ]
except AttributeError:
    pass
try:
...
try:
    ...
    hipArrayGetInfo.argtypes = [
        ctypes.POINTER(struct_hipChannelFormatDesc),
        ctypes.POINTER(struct_hipExtent),
        ctypes.POINTER(ctypes.c_uint32),
        hipArray_t,
    ]
except AttributeError:
...
try:
    ...
    hipArrayGetDescriptor.argtypes = [
        ctypes.POINTER(struct_HIP_ARRAY_DESCRIPTOR),
        hipArray_t,
    ]
except AttributeError:
...
try:
    ...
    hipArray3DGetDescriptor.argtypes = [
        ctypes.POINTER(struct_HIP_ARRAY3D_DESCRIPTOR),
        hipArray_t,
    ]
except AttributeError:
...
try:
    ...
    hipMemcpy2DToArrayAsync.argtypes = [
        hipArray_t,
        size_t,
        size_t,
        ctypes.POINTER(None),
...
try:
    ...
    hipMemcpy2DFromArrayAsync.argtypes = [
        ctypes.POINTER(None),
        size_t,
        hipArray_const_t,
        size_t,
...
try:
    ...
    hipDeviceCanAccessPeer.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.c_int32,
        ctypes.c_int32,
    ]
...
try:
    ...
    hipMemGetAddressRange.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(ctypes.c_uint64),
        hipDeviceptr_t,
    ]
...
try:
    ...
    hipCtxCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipCtx_t)),
        ctypes.c_uint32,
        hipDevice_t,
    ]
except AttributeError:
...
try:
    ...
    pass
try:
    hipDevicePrimaryCtxGetState = _libraries[
        "libamdhip64.so"
    ].hipDevicePrimaryCtxGetState
    hipDevicePrimaryCtxGetState.restype = hipError_t
    hipDevicePrimaryCtxGetState.argtypes = [
        hipDevice_t,
        ctypes.POINTER(ctypes.c_uint32),
        ctypes.POINTER(ctypes.c_int32),
    ]
...
try:
    ...
    hipDevicePrimaryCtxRetain.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipCtx_t)),
        hipDevice_t,
    ]
except AttributeError:
...
try:
    ...
    pass
try:
    hipDevicePrimaryCtxSetFlags = _libraries[
        "libamdhip64.so"
...
try:
    ...
    hipFuncGetAttributes.argtypes = [
        ctypes.POINTER(struct_hipFuncAttributes),
        ctypes.POINTER(None),
    ]
except AttributeError:
    pass
...
try:
    ...
    hipModuleGetTexRef.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_textureReference)),
        hipModule_t,
        ctypes.POINTER(ctypes.c_char),
    ]
except AttributeError:
...
try:
    ...
    pass
try:
    hipModuleLaunchCooperativeKernel = _libraries[
        "libamdhip64.so"
    ].hipModuleLaunchCooperativeKernel
    hipModuleLaunchCooperativeKernel.restype = hipError_t
    hipModuleLaunchCooperativeKernel.argtypes = [
        hipFunction_t,
        ctypes.c_uint32,
        ctypes.c_uint32,
        ctypes.c_uint32,
    ...
    pass
try:
    hipModuleLaunchCooperativeKernelMultiDevice = _libraries[
        "libamdhip64.so"
    ].hipModuleLaunchCooperativeKernelMultiDevice
    hipModuleLaunchCooperativeKernelMultiDevice.restype = hipError_t
    hipModuleLaunchCooperativeKernelMultiDevice.argtypes = [
        ctypes.POINTER(struct_hipFunctionLaunchParams_t),
        ctypes.c_uint32,
        ctypes.c_uint32,
    ]
except AttributeError:
...
try:
    ...
    hipLaunchCooperativeKernel.argtypes = [
        ctypes.POINTER(None),
        dim3,
        dim3,
        ctypes.POINTER(ctypes.POINTER(None)),
    ...
    pass
try:
    hipLaunchCooperativeKernelMultiDevice = _libraries[
        "libamdhip64.so"
    ].hipLaunchCooperativeKernelMultiDevice
    hipLaunchCooperativeKernelMultiDevice.restype = hipError_t
    hipLaunchCooperativeKernelMultiDevice.argtypes = [
        ctypes.POINTER(struct_hipLaunchParams_t),
        ctypes.c_int32,
        ctypes.c_uint32,
    ]
except AttributeError:
    pass
try:
    hipExtLaunchMultiKernelMultiDevice = _libraries[
        "libamdhip64.so"
    ].hipExtLaunchMultiKernelMultiDevice
    hipExtLaunchMultiKernelMultiDevice.restype = hipError_t
    hipExtLaunchMultiKernelMultiDevice.argtypes = [
        ctypes.POINTER(struct_hipLaunchParams_t),
        ctypes.c_int32,
        ctypes.c_uint32,
    ]
    ...
    pass
try:
    hipModuleOccupancyMaxPotentialBlockSize = _libraries[
        "libamdhip64.so"
    ].hipModuleOccupancyMaxPotentialBlockSize
    hipModuleOccupancyMaxPotentialBlockSize.restype = hipError_t
    hipModuleOccupancyMaxPotentialBlockSize.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(ctypes.c_int32),
        hipFunction_t,
        size_t,
    ...
    pass
try:
    hipModuleOccupancyMaxPotentialBlockSizeWithFlags = _libraries[
        "libamdhip64.so"
    ].hipModuleOccupancyMaxPotentialBlockSizeWithFlags
    hipModuleOccupancyMaxPotentialBlockSizeWithFlags.restype = hipError_t
    hipModuleOccupancyMaxPotentialBlockSizeWithFlags.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(ctypes.c_int32),
        hipFunction_t,
        size_t,
    ...
    pass
try:
    hipModuleOccupancyMaxActiveBlocksPerMultiprocessor = _libraries[
        "libamdhip64.so"
    ].hipModuleOccupancyMaxActiveBlocksPerMultiprocessor
    hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.restype = hipError_t
    hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        hipFunction_t,
        ctypes.c_int32,
        size_t,
    ...
    pass
try:
    hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = _libraries[
        "libamdhip64.so"
    ].hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags
    hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.restype = hipError_t
    hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        hipFunction_t,
        ctypes.c_int32,
        size_t,
    ...
    pass
try:
    hipOccupancyMaxActiveBlocksPerMultiprocessor = _libraries[
        "libamdhip64.so"
    ].hipOccupancyMaxActiveBlocksPerMultiprocessor
    hipOccupancyMaxActiveBlocksPerMultiprocessor.restype = hipError_t
    hipOccupancyMaxActiveBlocksPerMultiprocessor.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(None),
        ctypes.c_int32,
        size_t,
    ...
    pass
try:
    hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = _libraries[
        "libamdhip64.so"
    ].hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags
    hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.restype = hipError_t
    hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(None),
        ctypes.c_int32,
        size_t,
    ...
    pass
try:
    hipOccupancyMaxPotentialBlockSize = _libraries[
        "libamdhip64.so"
    ].hipOccupancyMaxPotentialBlockSize
    hipOccupancyMaxPotentialBlockSize.restype = hipError_t
    hipOccupancyMaxPotentialBlockSize.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(None),
        size_t,
...
try:
    ...
    __hipPopCallConfiguration.argtypes = [
        ctypes.POINTER(struct_dim3),
        ctypes.POINTER(struct_dim3),
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(ctypes.POINTER(struct_ihipStream_t)),
    ]
...
try:
    ...
    hipCreateTextureObject.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct___hip_texture)),
        ctypes.POINTER(struct_hipResourceDesc),
        ctypes.POINTER(struct_hipTextureDesc),
        ctypes.POINTER(struct_hipResourceViewDesc),
    ]
except AttributeError:
    pass
...
try:
    ...
    pass
try:
    hipGetTextureObjectResourceDesc = _libraries[
        "libamdhip64.so"
    ].hipGetTextureObjectResourceDesc
    hipGetTextureObjectResourceDesc.restype = hipError_t
    hipGetTextureObjectResourceDesc.argtypes = [
        ctypes.POINTER(struct_hipResourceDesc),
        hipTextureObject_t,
    ]
except AttributeError:
    pass
try:
    hipGetTextureObjectResourceViewDesc = _libraries[
        "libamdhip64.so"
    ].hipGetTextureObjectResourceViewDesc
    hipGetTextureObjectResourceViewDesc.restype = hipError_t
    hipGetTextureObjectResourceViewDesc.argtypes = [
        ctypes.POINTER(struct_hipResourceViewDesc),
        hipTextureObject_t,
    ]
except AttributeError:
    pass
try:
    hipGetTextureObjectTextureDesc = _libraries[
        "libamdhip64.so"
    ].hipGetTextureObjectTextureDesc
    hipGetTextureObjectTextureDesc.restype = hipError_t
    hipGetTextureObjectTextureDesc.argtypes = [
        ctypes.POINTER(struct_hipTextureDesc),
        hipTextureObject_t,
    ]
except AttributeError:
...
try:
    ...
    hipTexObjectCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct___hip_texture)),
        ctypes.POINTER(struct_HIP_RESOURCE_DESC_st),
        ctypes.POINTER(struct_HIP_TEXTURE_DESC_st),
        ctypes.POINTER(struct_HIP_RESOURCE_VIEW_DESC_st),
    ]
except AttributeError:
    pass
try:
    ...
    pass
try:
    hipTexObjectGetResourceDesc = _libraries[
        "libamdhip64.so"
    ].hipTexObjectGetResourceDesc
    hipTexObjectGetResourceDesc.restype = hipError_t
    hipTexObjectGetResourceDesc.argtypes = [
        ctypes.POINTER(struct_HIP_RESOURCE_DESC_st),
        hipTextureObject_t,
    ]
except AttributeError:
    pass
try:
    hipTexObjectGetResourceViewDesc = _libraries[
        "libamdhip64.so"
    ].hipTexObjectGetResourceViewDesc
    hipTexObjectGetResourceViewDesc.restype = hipError_t
    hipTexObjectGetResourceViewDesc.argtypes = [
        ctypes.POINTER(struct_HIP_RESOURCE_VIEW_DESC_st),
        hipTextureObject_t,
    ]
except AttributeError:
...
try:
    ...
    hipTexObjectGetTextureDesc.argtypes = [
        ctypes.POINTER(struct_HIP_TEXTURE_DESC_st),
        hipTextureObject_t,
    ]
except AttributeError:
...
try:
    ...
    hipMallocMipmappedArray.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipMipmappedArray)),
        ctypes.POINTER(struct_hipChannelFormatDesc),
        struct_hipExtent,
        ctypes.c_uint32,
...
try:
    ...
    hipGetMipmappedArrayLevel.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipArray)),
...
try:
    ...
    hipMipmappedArrayCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipMipmappedArray)),
        ctypes.POINTER(struct_HIP_ARRAY3D_DESCRIPTOR),
        ctypes.c_uint32,
    ]
...
try:
    ...
    hipMipmappedArrayGetLevel.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipArray)),
        hipMipmappedArray_t,
        ctypes.c_uint32,
    ]
    ...
    pass
try:
    hipBindTextureToMipmappedArray = _libraries[
        "libamdhip64.so"
    ].hipBindTextureToMipmappedArray
    hipBindTextureToMipmappedArray.restype = hipError_t
    hipBindTextureToMipmappedArray.argtypes = [
...
try:
    ...
    hipGetTextureReference.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_textureReference)),
        ctypes.POINTER(None),
    ]
except AttributeError:
...
try:
    ...
    hipTexRefSetAddressMode.argtypes = [
        ctypes.POINTER(struct_textureReference),
        ctypes.c_int32,
...
try:
    ...
    hipTexRefSetFilterMode.argtypes = [
        ctypes.POINTER(struct_textureReference),
...
try:
    ...
    hipBindTextureToArray.argtypes = [
        ctypes.POINTER(struct_textureReference),
        hipArray_const_t,
        ctypes.POINTER(struct_hipChannelFormatDesc),
    ]
    ...
    pass
try:
    hipGetTextureAlignmentOffset = _libraries[
        "libamdhip64.so"
    ].hipGetTextureAlignmentOffset
    hipGetTextureAlignmentOffset.restype = hipError_t
    hipGetTextureAlignmentOffset.argtypes = [
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(struct_textureReference),
    ]
except AttributeError:
...
try:
    ...
    hipTexRefGetAddressMode.argtypes = [
        ctypes.POINTER(hipTextureAddressMode),
        ctypes.POINTER(struct_textureReference),
        ctypes.c_int32,
    ]
except AttributeError:
...
try:
    ...
    hipTexRefGetFilterMode.argtypes = [
        ctypes.POINTER(hipTextureFilterMode),
        ctypes.POINTER(struct_textureReference),
    ]
except AttributeError:
    pass
...
try:
    ...
    hipTexRefGetFormat.argtypes = [
        ctypes.POINTER(hipArray_Format),
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(struct_textureReference),
    ]
except AttributeError:
...
try:
    ...
    hipTexRefGetMaxAnisotropy.argtypes = [
        ctypes.POINTER(ctypes.c_int32),
        ctypes.POINTER(struct_textureReference),
    ]
except AttributeError:
    pass
try:
    hipTexRefGetMipmapFilterMode = _libraries[
        "libamdhip64.so"
    ].hipTexRefGetMipmapFilterMode
    hipTexRefGetMipmapFilterMode.restype = hipError_t
    hipTexRefGetMipmapFilterMode.argtypes = [
        ctypes.POINTER(hipTextureFilterMode),
        ctypes.POINTER(struct_textureReference),
    ]
except AttributeError:
    pass
try:
    hipTexRefGetMipmapLevelBias = _libraries[
        "libamdhip64.so"
    ].hipTexRefGetMipmapLevelBias
    hipTexRefGetMipmapLevelBias.restype = hipError_t
    hipTexRefGetMipmapLevelBias.argtypes = [
        ctypes.POINTER(ctypes.c_float),
        ctypes.POINTER(struct_textureReference),
    ]
except AttributeError:
    pass
try:
    hipTexRefGetMipmapLevelClamp = _libraries[
        "libamdhip64.so"
    ].hipTexRefGetMipmapLevelClamp
    hipTexRefGetMipmapLevelClamp.restype = hipError_t
    hipTexRefGetMipmapLevelClamp.argtypes = [
        ctypes.POINTER(ctypes.c_float),
        ctypes.POINTER(ctypes.c_float),
        ctypes.POINTER(struct_textureReference),
    ]
...
try:
    ...
    hipTexRefGetMipMappedArray.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipMipmappedArray)),
        ctypes.POINTER(struct_textureReference),
    ]
except AttributeError:
...
try:
    ...
    hipTexRefSetAddress2D.argtypes = [
        ctypes.POINTER(struct_textureReference),
        ctypes.POINTER(struct_HIP_ARRAY_DESCRIPTOR),
        hipDeviceptr_t,
        size_t,
...
try:
    ...
    hipTexRefSetMaxAnisotropy.argtypes = [
        ctypes.POINTER(struct_textureReference),
        ctypes.c_uint32,
    ]
except AttributeError:
...
try:
    ...
    hipTexRefSetBorderColor.argtypes = [
        ctypes.POINTER(struct_textureReference),
        ctypes.POINTER(ctypes.c_float),
    ]
except AttributeError:
    pass
try:
    hipTexRefSetMipmapFilterMode = _libraries[
        "libamdhip64.so"
    ].hipTexRefSetMipmapFilterMode
    hipTexRefSetMipmapFilterMode.restype = hipError_t
    hipTexRefSetMipmapFilterMode.argtypes = [
        ctypes.POINTER(struct_textureReference),
        hipTextureFilterMode,
    ]
except AttributeError:
    pass
try:
    hipTexRefSetMipmapLevelBias = _libraries[
        "libamdhip64.so"
    ].hipTexRefSetMipmapLevelBias
    hipTexRefSetMipmapLevelBias.restype = hipError_t
    hipTexRefSetMipmapLevelBias.argtypes = [
        ctypes.POINTER(struct_textureReference),
        ctypes.c_float,
    ]
except AttributeError:
    pass
try:
    hipTexRefSetMipmapLevelClamp = _libraries[
        "libamdhip64.so"
    ].hipTexRefSetMipmapLevelClamp
    hipTexRefSetMipmapLevelClamp.restype = hipError_t
    hipTexRefSetMipmapLevelClamp.argtypes = [
        ctypes.POINTER(struct_textureReference),
        ctypes.c_float,
        ctypes.c_float,
    ]
...
try:
    ...
    hipTexRefSetMipmappedArray.argtypes = [
        ctypes.POINTER(struct_textureReference),
        ctypes.POINTER(struct_hipMipmappedArray),
        ctypes.c_uint32,
    ]
except AttributeError:
    pass
...
try:
    ...
    hipStreamEndCapture.argtypes = [
        hipStream_t,
        ctypes.POINTER(ctypes.POINTER(struct_ihipGraph)),
    ]
except AttributeError:
    pass
try:
    ...
    hipStreamGetCaptureInfo.argtypes = [
        hipStream_t,
        ctypes.POINTER(hipStreamCaptureStatus),
        ctypes.POINTER(ctypes.c_uint64),
    ]
except AttributeError:
    pass
try:
    ...
    hipStreamGetCaptureInfo_v2.argtypes = [
        hipStream_t,
        ctypes.POINTER(hipStreamCaptureStatus),
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(ctypes.POINTER(struct_ihipGraph)),
        ctypes.POINTER(ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode))),
        ctypes.POINTER(ctypes.c_uint64),
    ]
except AttributeError:
    pass
try:
    ...
    pass
try:
    hipStreamUpdateCaptureDependencies = _libraries[
        "libamdhip64.so"
    ].hipStreamUpdateCaptureDependencies
    hipStreamUpdateCaptureDependencies.restype = hipError_t
    hipStreamUpdateCaptureDependencies.argtypes = [
        hipStream_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
        ctypes.c_uint32,
    ]
except AttributeError:
    pass
try:
    hipThreadExchangeStreamCaptureMode = _libraries[
        "libamdhip64.so"
...
try:
    ...
    hipGraphAddDependencies.argtypes = [
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
...
try:
    ...
    hipGraphRemoveDependencies.argtypes = [
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
...
try:
    ...
    pass
try:
    hipGraphNodeGetDependencies = _libraries[
        "libamdhip64.so"
    ].hipGraphNodeGetDependencies
    hipGraphNodeGetDependencies.restype = hipError_t
    hipGraphNodeGetDependencies.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        ctypes.POINTER(ctypes.c_uint64),
    ]
    ...
    pass
try:
    hipGraphNodeGetDependentNodes = _libraries[
        "libamdhip64.so"
    ].hipGraphNodeGetDependentNodes
    hipGraphNodeGetDependentNodes.restype = hipError_t
    hipGraphNodeGetDependentNodes.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        ctypes.POINTER(ctypes.c_uint64),
    ]
...
try:
    ...
    hipGraphNodeFindInClone.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraphNode_t,
        hipGraph_t,
    ]
...
try:
    ...
    hipGraphInstantiate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphExec)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        ctypes.POINTER(ctypes.c_char),
        size_t,
    ...
    pass
try:
    hipGraphInstantiateWithFlags = _libraries[
        "libamdhip64.so"
    ].hipGraphInstantiateWithFlags
    hipGraphInstantiateWithFlags.restype = hipError_t
    hipGraphInstantiateWithFlags.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphExec)),
        hipGraph_t,
        ctypes.c_uint64,
    ]
...
try:
    ...
    hipGraphExecUpdate.argtypes = [
        hipGraphExec_t,
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        ctypes.POINTER(hipGraphExecUpdateResult),
    ]
except AttributeError:
    pass
try:
    ...
    hipGraphAddKernelNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
        ctypes.POINTER(struct_hipKernelNodeParams),
    ]
except AttributeError:
    pass
try:
    hipGraphKernelNodeGetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphKernelNodeGetParams
    hipGraphKernelNodeGetParams.restype = hipError_t
    hipGraphKernelNodeGetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipKernelNodeParams),
    ]
except AttributeError:
    pass
try:
    hipGraphKernelNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphKernelNodeSetParams
    hipGraphKernelNodeSetParams.restype = hipError_t
    hipGraphKernelNodeSetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipKernelNodeParams),
    ]
except AttributeError:
    pass
try:
    hipGraphExecKernelNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphExecKernelNodeSetParams
    hipGraphExecKernelNodeSetParams.restype = hipError_t
    hipGraphExecKernelNodeSetParams.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(struct_hipKernelNodeParams),
    ]
...
try:
    ...
    hipDrvGraphAddMemcpyNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
        ctypes.POINTER(struct_HIP_MEMCPY3D),
        hipCtx_t,
    ]
except AttributeError:
    pass
try:
    ...
    hipGraphAddMemcpyNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
        ctypes.POINTER(struct_hipMemcpy3DParms),
    ]
except AttributeError:
    pass
try:
    hipGraphMemcpyNodeGetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphMemcpyNodeGetParams
    hipGraphMemcpyNodeGetParams.restype = hipError_t
    hipGraphMemcpyNodeGetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipMemcpy3DParms),
    ]
except AttributeError:
    pass
try:
    hipGraphMemcpyNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphMemcpyNodeSetParams
    hipGraphMemcpyNodeSetParams.restype = hipError_t
    hipGraphMemcpyNodeSetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipMemcpy3DParms),
    ]
except AttributeError:
    pass
try:
    hipGraphKernelNodeSetAttribute = _libraries[
        "libamdhip64.so"
    ].hipGraphKernelNodeSetAttribute
    hipGraphKernelNodeSetAttribute.restype = hipError_t
    hipGraphKernelNodeSetAttribute.argtypes = [
        hipGraphNode_t,
        hipKernelNodeAttrID,
        ctypes.POINTER(union_hipKernelNodeAttrValue),
    ]
except AttributeError:
    pass
try:
    hipGraphKernelNodeGetAttribute = _libraries[
        "libamdhip64.so"
    ].hipGraphKernelNodeGetAttribute
    hipGraphKernelNodeGetAttribute.restype = hipError_t
    hipGraphKernelNodeGetAttribute.argtypes = [
        hipGraphNode_t,
        hipKernelNodeAttrID,
        ctypes.POINTER(union_hipKernelNodeAttrValue),
    ]
    ...
    pass
try:
    hipGraphExecMemcpyNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphExecMemcpyNodeSetParams
    hipGraphExecMemcpyNodeSetParams.restype = hipError_t
    hipGraphExecMemcpyNodeSetParams.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(struct_hipMemcpy3DParms),
    ]
...
try:
    ...
    hipGraphAddMemcpyNode1D.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
    ...
    pass
try:
    hipGraphMemcpyNodeSetParams1D = _libraries[
        "libamdhip64.so"
    ].hipGraphMemcpyNodeSetParams1D
    hipGraphMemcpyNodeSetParams1D.restype = hipError_t
    hipGraphMemcpyNodeSetParams1D.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(None),
        ctypes.POINTER(None),
        size_t,
    ...
    pass
try:
    hipGraphExecMemcpyNodeSetParams1D = _libraries[
        "libamdhip64.so"
    ].hipGraphExecMemcpyNodeSetParams1D
    hipGraphExecMemcpyNodeSetParams1D.restype = hipError_t
    hipGraphExecMemcpyNodeSetParams1D.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(None),
        ctypes.POINTER(None),
    ...
    pass
try:
    hipGraphAddMemcpyNodeFromSymbol = _libraries[
        "libamdhip64.so"
    ].hipGraphAddMemcpyNodeFromSymbol
    hipGraphAddMemcpyNodeFromSymbol.restype = hipError_t
    hipGraphAddMemcpyNodeFromSymbol.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
    ...
    pass
try:
    hipGraphMemcpyNodeSetParamsFromSymbol = _libraries[
        "libamdhip64.so"
    ].hipGraphMemcpyNodeSetParamsFromSymbol
    hipGraphMemcpyNodeSetParamsFromSymbol.restype = hipError_t
    hipGraphMemcpyNodeSetParamsFromSymbol.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(None),
        ctypes.POINTER(None),
        size_t,
    ...
    pass
try:
    hipGraphExecMemcpyNodeSetParamsFromSymbol = _libraries[
        "libamdhip64.so"
    ].hipGraphExecMemcpyNodeSetParamsFromSymbol
    hipGraphExecMemcpyNodeSetParamsFromSymbol.restype = hipError_t
    hipGraphExecMemcpyNodeSetParamsFromSymbol.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(None),
        ctypes.POINTER(None),
    ...
    pass
try:
    hipGraphAddMemcpyNodeToSymbol = _libraries[
        "libamdhip64.so"
    ].hipGraphAddMemcpyNodeToSymbol
    hipGraphAddMemcpyNodeToSymbol.restype = hipError_t
    hipGraphAddMemcpyNodeToSymbol.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
    ...
    pass
try:
    hipGraphMemcpyNodeSetParamsToSymbol = _libraries[
        "libamdhip64.so"
    ].hipGraphMemcpyNodeSetParamsToSymbol
    hipGraphMemcpyNodeSetParamsToSymbol.restype = hipError_t
    hipGraphMemcpyNodeSetParamsToSymbol.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(None),
        ctypes.POINTER(None),
        size_t,
    ...
    pass
try:
    hipGraphExecMemcpyNodeSetParamsToSymbol = _libraries[
        "libamdhip64.so"
    ].hipGraphExecMemcpyNodeSetParamsToSymbol
    hipGraphExecMemcpyNodeSetParamsToSymbol.restype = hipError_t
    hipGraphExecMemcpyNodeSetParamsToSymbol.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(None),
        ctypes.POINTER(None),
...
try:
    ...
    hipGraphAddMemsetNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
        ctypes.POINTER(struct_hipMemsetParams),
    ]
except AttributeError:
    pass
try:
    hipGraphMemsetNodeGetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphMemsetNodeGetParams
    hipGraphMemsetNodeGetParams.restype = hipError_t
    hipGraphMemsetNodeGetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipMemsetParams),
    ]
except AttributeError:
    pass
try:
    hipGraphMemsetNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphMemsetNodeSetParams
    hipGraphMemsetNodeSetParams.restype = hipError_t
    hipGraphMemsetNodeSetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipMemsetParams),
    ]
except AttributeError:
    pass
try:
    hipGraphExecMemsetNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphExecMemsetNodeSetParams
    hipGraphExecMemsetNodeSetParams.restype = hipError_t
    hipGraphExecMemsetNodeSetParams.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(struct_hipMemsetParams),
    ]
...
try:
    ...
    hipGraphAddHostNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
        ctypes.POINTER(struct_hipHostNodeParams),
    ]
except AttributeError:
    pass
try:
    ...
    hipGraphHostNodeGetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipHostNodeParams),
    ]
except AttributeError:
...
try:
    ...
    hipGraphHostNodeSetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipHostNodeParams),
    ]
except AttributeError:
    pass
try:
    hipGraphExecHostNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphExecHostNodeSetParams
    hipGraphExecHostNodeSetParams.restype = hipError_t
    hipGraphExecHostNodeSetParams.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(struct_hipHostNodeParams),
    ]
...
try:
    ...
    hipGraphAddChildGraphNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
    ...
    pass
try:
    hipGraphChildGraphNodeGetGraph = _libraries[
        "libamdhip64.so"
    ].hipGraphChildGraphNodeGetGraph
    hipGraphChildGraphNodeGetGraph.restype = hipError_t
    hipGraphChildGraphNodeGetGraph.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(ctypes.POINTER(struct_ihipGraph)),
    ]
except AttributeError:
    pass
try:
    hipGraphExecChildGraphNodeSetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphExecChildGraphNodeSetParams
    hipGraphExecChildGraphNodeSetParams.restype = hipError_t
    hipGraphExecChildGraphNodeSetParams.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        hipGraph_t,
    ]
...
try:
    ...
    hipGraphAddEventRecordNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
    ...
    pass
try:
    hipGraphEventRecordNodeGetEvent = _libraries[
        "libamdhip64.so"
    ].hipGraphEventRecordNodeGetEvent
    hipGraphEventRecordNodeGetEvent.restype = hipError_t
    hipGraphEventRecordNodeGetEvent.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(ctypes.POINTER(struct_ihipEvent_t)),
    ]
except AttributeError:
    pass
try:
    hipGraphEventRecordNodeSetEvent = _libraries[
        "libamdhip64.so"
    ...
    pass
try:
    hipGraphExecEventRecordNodeSetEvent = _libraries[
        "libamdhip64.so"
    ].hipGraphExecEventRecordNodeSetEvent
    hipGraphExecEventRecordNodeSetEvent.restype = hipError_t
    hipGraphExecEventRecordNodeSetEvent.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        hipEvent_t,
    ]
...
try:
    ...
    hipGraphAddEventWaitNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
    ...
    pass
try:
    hipGraphEventWaitNodeGetEvent = _libraries[
        "libamdhip64.so"
    ].hipGraphEventWaitNodeGetEvent
    hipGraphEventWaitNodeGetEvent.restype = hipError_t
    hipGraphEventWaitNodeGetEvent.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(ctypes.POINTER(struct_ihipEvent_t)),
    ]
except AttributeError:
    pass
try:
    hipGraphEventWaitNodeSetEvent = _libraries[
        "libamdhip64.so"
    ...
    pass
try:
    hipGraphExecEventWaitNodeSetEvent = _libraries[
        "libamdhip64.so"
    ].hipGraphExecEventWaitNodeSetEvent
    hipGraphExecEventWaitNodeSetEvent.restype = hipError_t
    hipGraphExecEventWaitNodeSetEvent.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        hipEvent_t,
    ]
...
try:
    ...
    hipGraphAddMemAllocNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
        ctypes.POINTER(struct_hipMemAllocNodeParams),
    ]
except AttributeError:
    pass
try:
    hipGraphMemAllocNodeGetParams = _libraries[
        "libamdhip64.so"
    ].hipGraphMemAllocNodeGetParams
    hipGraphMemAllocNodeGetParams.restype = hipError_t
    hipGraphMemAllocNodeGetParams.argtypes = [
        hipGraphNode_t,
        ctypes.POINTER(struct_hipMemAllocNodeParams),
    ]
except AttributeError:
...
try:
    ...
    hipGraphAddMemFreeNode.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        hipGraph_t,
        ctypes.POINTER(ctypes.POINTER(struct_hipGraphNode)),
        size_t,
    ...
    pass
try:
    hipGraphMemFreeNodeGetParams = _libraries[
        "libamdhip64.so"
    ...
    pass
try:
    hipDeviceGetGraphMemAttribute = _libraries[
        "libamdhip64.so"
    ].hipDeviceGetGraphMemAttribute
    hipDeviceGetGraphMemAttribute.restype = hipError_t
    hipDeviceGetGraphMemAttribute.argtypes = [
        ctypes.c_int32,
    ...
    pass
try:
    hipDeviceSetGraphMemAttribute = _libraries[
        "libamdhip64.so"
    ].hipDeviceSetGraphMemAttribute
    hipDeviceSetGraphMemAttribute.restype = hipError_t
    hipDeviceSetGraphMemAttribute.argtypes = [
        ctypes.c_int32,
        hipGraphMemAttributeType,
        ctypes.POINTER(None),
    ]
...
try:
    ...
    hipUserObjectCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipUserObject)),
        ctypes.POINTER(None),
        hipHostFn_t,
        ctypes.c_uint32,
        ctypes.c_uint32,
...
try:
    ...
    hipGraphRetainUserObject.argtypes = [
        hipGraph_t,
        hipUserObject_t,
        ctypes.c_uint32,
        ctypes.c_uint32,
...
try:
    ...
    pass
try:
    hipGraphKernelNodeCopyAttributes = _libraries[
        "libamdhip64.so"
...
try:
    ...
    hipGraphNodeGetEnabled.argtypes = [
        hipGraphExec_t,
        hipGraphNode_t,
        ctypes.POINTER(ctypes.c_uint32),
    ]
...
try:
    ...
    hipMemCreate.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipMemGenericAllocationHandle)),
        size_t,
        ctypes.POINTER(struct_hipMemAllocationProp),
        ctypes.c_uint64,
    ]
except AttributeError:
    pass
try:
    hipMemExportToShareableHandle = _libraries[
        "libamdhip64.so"
    ].hipMemExportToShareableHandle
    hipMemExportToShareableHandle.restype = hipError_t
    hipMemExportToShareableHandle.argtypes = [
        ctypes.POINTER(None),
...
try:
    ...
    pass
try:
    hipMemGetAllocationGranularity = _libraries[
        "libamdhip64.so"
    ].hipMemGetAllocationGranularity
    hipMemGetAllocationGranularity.restype = hipError_t
    hipMemGetAllocationGranularity.argtypes = [
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(struct_hipMemAllocationProp),
    ...
    pass
try:
    hipMemGetAllocationPropertiesFromHandle = _libraries[
        "libamdhip64.so"
    ].hipMemGetAllocationPropertiesFromHandle
    hipMemGetAllocationPropertiesFromHandle.restype = hipError_t
    hipMemGetAllocationPropertiesFromHandle.argtypes = [
        ctypes.POINTER(struct_hipMemAllocationProp),
        hipMemGenericAllocationHandle_t,
    ]
except AttributeError:
    pass
try:
    hipMemImportFromShareableHandle = _libraries[
        "libamdhip64.so"
    ].hipMemImportFromShareableHandle
    hipMemImportFromShareableHandle.restype = hipError_t
    hipMemImportFromShareableHandle.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipMemGenericAllocationHandle)),
        ctypes.POINTER(None),
        hipMemAllocationHandleType,
    ]
...
try:
    ...
    hipMemMapArrayAsync.argtypes = [
        ctypes.POINTER(struct_hipArrayMapInfo),
        ctypes.c_uint32,
        hipStream_t,
    ]
except AttributeError:
...
try:
    ...
    pass
try:
    hipMemRetainAllocationHandle = _libraries[
        "libamdhip64.so"
    ].hipMemRetainAllocationHandle
    hipMemRetainAllocationHandle.restype = hipError_t
    hipMemRetainAllocationHandle.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_ihipMemGenericAllocationHandle)),
        ctypes.POINTER(None),
    ]
except AttributeError:
...
try:
    ...
    hipGraphicsMapResources.argtypes = [
        ctypes.c_int32,
        ctypes.POINTER(ctypes.POINTER(struct__hipGraphicsResource)),
        hipStream_t,
    ]
except AttributeError:
    pass
try:
    hipGraphicsSubResourceGetMappedArray = _libraries[
        "libamdhip64.so"
    ].hipGraphicsSubResourceGetMappedArray
    hipGraphicsSubResourceGetMappedArray.restype = hipError_t
    hipGraphicsSubResourceGetMappedArray.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct_hipArray)),
    ...
    pass
try:
    hipGraphicsResourceGetMappedPointer = _libraries[
        "libamdhip64.so"
    ].hipGraphicsResourceGetMappedPointer
    hipGraphicsResourceGetMappedPointer.restype = hipError_t
    hipGraphicsResourceGetMappedPointer.argtypes = [
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(ctypes.c_uint64),
        hipGraphicsResource_t,
    ]
...
try:
    ...
    hipGraphicsUnmapResources.argtypes = [
        ctypes.c_int32,
        ctypes.POINTER(ctypes.POINTER(struct__hipGraphicsResource)),
        hipStream_t,
    ]
    ...
    pass
try:
    hipGraphicsUnregisterResource = _libraries[
        "libamdhip64.so"
...
try:
    ...
    hipCreateSurfaceObject.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct___hip_surface)),
        ctypes.POINTER(struct_hipResourceDesc),
    ]
except AttributeError:
    pass
...
try:
    ...
    hipExtModuleLaunchKernel.argtypes = [
        hipFunction_t,
        uint32_t,
        uint32_t,
        uint32_t,
...
try:
    ...
    hipHccModuleLaunchKernel.argtypes = [
        hipFunction_t,
        uint32_t,
        uint32_t,
        uint32_t,
...
try:
    ...
    hiprtcCreateProgram.argtypes = [
        ctypes.POINTER(ctypes.POINTER(struct__hiprtcProgram)),
        ctypes.POINTER(ctypes.c_char),
        ctypes.POINTER(ctypes.c_char),
        ctypes.c_int32,
        ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),
...
try:
    ...
    hiprtcLinkCreate.argtypes = [
        ctypes.c_uint32,
        ctypes.POINTER(hiprtcJIT_option),
        ctypes.POINTER(ctypes.POINTER(None)),
        ctypes.POINTER(ctypes.POINTER(struct_ihiprtcLinkState)),
    ]
except AttributeError:
    pass
try:
...
__all__ = [
    ...
    "HIPaddress_mode",
    "HIPaddress_mode__enumvalues",
    "HIPaddress_mode_enum",
    "HIPfilter_mode",
    "HIPfilter_mode__enumvalues",
    "HIPfilter_mode_enum",
    ...
    "make_hipPos",
    "size_t",
    "struct_HIP_ARRAY3D_DESCRIPTOR",
    "struct_HIP_ARRAY_DESCRIPTOR",
    "struct_HIP_MEMCPY3D",
    "struct_HIP_RESOURCE_DESC_st",
    ...
    "struct_HIP_RESOURCE_VIEW_DESC_st",
    "struct_HIP_TEXTURE_DESC_st",
    "struct___hip_surface",
    "struct___hip_texture",
    "struct__hipGraphicsResource",
    "struct__hiprtcProgram",
    "struct_c__SA_hipDeviceArch_t",
    "struct_dim3",
    "struct_hipAccessPolicyWindow",
    "struct_hipArray",
    "struct_hipArrayMapInfo",
    "struct_hipArrayMapInfo_1_miptail",
    "struct_hipArrayMapInfo_1_sparseLevel",
    "struct_hipChannelFormatDesc",
    "struct_hipDeviceProp_tR0600",
    "struct_hipExtent",
    "struct_hipExternalMemoryBufferDesc_st",
    ...
    "struct_hipFuncAttributes",
    "struct_hipFunctionLaunchParams_t",
    "struct_hipGraphExec",
    "struct_hipGraphNode",
    "struct_hipHostNodeParams",
    "struct_hipIpcEventHandle_st",
    "struct_hipIpcMemHandle_st",
    "struct_hipKernelNodeParams",
    "struct_hipLaunchParams_t",
    "struct_hipMemAccessDesc",
    "struct_hipMemAllocNodeParams",
    "struct_hipMemAllocationProp",
    "struct_hipMemAllocationProp_allocFlags",
    "struct_hipMemLocation",
    "struct_hipMemPoolProps",
    "struct_hipMemPoolPtrExportData",
    "struct_hipMemcpy3DParms",
    "struct_hipMemsetParams",
    "struct_hipMipmappedArray",
    "struct_hipPitchedPtr",
    "struct_hipPointerAttribute_t",
    "struct_hipPos",
    "struct_hipResourceDesc",
    "struct_hipResourceDesc_0_array",
    "struct_hipResourceDesc_0_linear",
    "struct_hipResourceDesc_0_mipmap",
    "struct_hipResourceDesc_0_pitch2D",
    "struct_hipResourceViewDesc",
    "struct_hipTextureDesc",
    "struct_hipUUID_t",
    "struct_hipUserObject",
    "struct_hip_Memcpy2D",
    "struct_ihipCtx_t",
    "struct_ihipEvent_t",
    "struct_ihipGraph",
    "struct_ihipMemGenericAllocationHandle",
    "struct_ihipMemPoolHandle_t",
    "struct_ihipModuleSymbol_t",
    "struct_ihipModule_t",
    "struct_ihipStream_t",
    "struct_ihiprtcLinkState",
    "struct_textureReference",
    "uint32_t",
    "uint64_t",
    "union_HIP_RESOURCE_DESC_st_res",
