...
class NVDevice(HCQCompiled[NVSignal]):
  ...
  def __init__(self, device:str=""):
    ...
    super().__init__(device, NVAllocator(self), [CUDARenderer, PTXRenderer, NVCCRenderer, NAKRenderer], functools.partial(NVProgram, self), NVSignal, NVComputeQueue, NVCopyQueue, arch=self.arch)
