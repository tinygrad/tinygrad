...
class NVSignal(HCQSignal):
  def __init__(self, value=0, timeline_for_device:NVDevice=None):
    super().__init__(NVDevice.signals_pool.pop(), value, is_timeline, timestamp_divider=1000, value_off=0, timestamp_off=8)
