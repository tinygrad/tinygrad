...
from tinygrad.helpers import getenv, mv_address, round_up, data64, data64_le, prod, OSX, to_mv, hi32, lo32, suppress_finalizing, NV_CC
...
class NVDevice(HCQCompiled[HCQSignal]):
  ...
  def __init__(self, device:str=""):
    ...
    cucc, ptxcc = (CUDACompiler, PTXCompiler) if not MOCKGPU else (NVCompiler, NVPTXCompiler)
