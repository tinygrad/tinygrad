...
class NVComputeQueue(NVCommandQueue, HWComputeQueue):   # pylint: disable=abstract-method
  def __init__(self):
...
class NVCopyQueue(NVCommandQueue, HWCopyQueue):   # pylint: disable=abstract-method
