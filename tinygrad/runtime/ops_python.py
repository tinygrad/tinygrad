...
from tinygrad.ops import TernaryOps, exec_alu, UOp, Ops, GroupOp
    ...
    for idxs in itertools.product(*[range(x) for x in global_size[::-1]]):
      ...
      while i < len(self.uops):
        ...
        if uop is Ops.DEFINE_GLOBAL:
          ...
          assert all_same([dtype] + dtp) or uop in {Ops.CMPNE, Ops.CMPLT, TernaryOps.WHERE}, f"dtype mismatch on {uop}"
