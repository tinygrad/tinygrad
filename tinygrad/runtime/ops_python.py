...
from tinygrad.ops import BinaryOps, exec_alu, Ops, UOp, GroupOp
    ...
    for idxs in itertools.product(*[range(x) for x in global_size[::-1]]):
      ...
      while i < len(self.uops):
        ...
        if uop is Ops.DEFINE_GLOBAL:
          ...
          assert all_same([dtype] + dtp) or uop in {BinaryOps.CMPNE, BinaryOps.CMPLT, Ops.WHERE}, f"dtype mismatch on {uop}"
