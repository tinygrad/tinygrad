...
class ClangJITCompiler(Compiler):
  def compile(self, src:str) -> bytes:
    args = ('clang', '-x', 'c', '-c', '-target', f'{platform.machine()}-none-unknown-elf', '-march=native', '-fPIC', '-O2', '-Wall', '-include', 'stdint.h',
            '-Wno-unused-function', '-Wno-unused-command-line-argument', '-Werror', '-fno-math-errno',
