...
import os, fcntl, ctypes, ctypes.util, functools, re, pathlib, mmap, errno, time, array, contextlib
...
kio = type("KIO", (object,), {name[11:].lower(): functools.partial(kfd_ioctl, {"IOW": 1, "IOR": 2, "IOWR": 3}[p[0]], p[1], p[2])
