...
class AMDDevice(HCQCompiled):
  ...
  def __init__(self, device:str=""):
    ...
    ctl_stack_size = round_up(12 * (self.max_cu_id + 1) * (self.max_wave_id + 1) + 8 + 40, mmap.PAGESIZE) if self.target // 10000 != 10 else (0x1000 if self.target == 100303 else 0x7000)
