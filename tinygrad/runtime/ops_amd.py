...
from tinygrad.renderer.cstyle import AMDJITRenderer, AMDCCRenderer
...
class AMDDevice(HCQCompiled):
  ...
  def __init__(self, device:str=""):
    ...
    compilers = CompilerSet([CompilerPair(functools.partial(AMDJITRenderer, self.arch), None),
                             CompilerPair(functools.partial(AMDLLVMJITRenderer, self.arch), None, AMD_LLVM),
                             CompilerPair(functools.partial(AMDCCRenderer, self.arch), None)], ctrl_var=AMD_CC)
