...
class AMDDevice(HCQCompiled):
  ...
  def __init__(self, device:str=""):
    ...
    if self.pmc_enabled:
      ...
      # validate counters: GRBM for GPU cycles, SQ for SIMD busy/instruction counts, L2 cache hits/misses
      l2, lds = ("TCC", "SQ") if self.target[0] == 9 else ("GL2C", "SQC")
      pmc_default = f"GRBM_GUI_ACTIVE,SQ_BUSY_CYCLES,{l2}_HIT,{l2}_MISS,SQ_INSTS_VALU,SQ_INSTS_SALU,{lds}_LDS_BANK_CONFLICT"
