...
class CLDevice(Compiled):
  ...
  def __init__(self, device:str=""):
    ...
    renderer = IntelRenderer() if "cl_intel_subgroup_matrix_multiply_accumulate" in self.device_exts and getenv("INTEL") else OpenCLRenderer(device_exts=self.device_exts)
