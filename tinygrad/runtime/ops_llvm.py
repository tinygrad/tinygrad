...
LLVMBuffer = Compiled(RawMallocBuffer, LinearizerOptions(supported_vector_sizes={dtypes.float: []},
                                                         supported_vector_sizes_alu={dtypes.float: []}, has_local=False), uops_to_llvm_ir, LLVMProgram)
