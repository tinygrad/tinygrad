...
from tinygrad.ops import UnaryOps, BinaryOps, MovementOps, TrinaryOps, Op, Interpreted
...
torch_fxn_for_op: Dict[Op, Callable] = {**base_fxn_for_op, **{
  ...
  TrinaryOps.MULACC: einsum_mulacc(lambda s,a,b: torch.einsum(s, a.float(), b.float()).type(torch.promote_types(a.dtype, b.dtype)), lambda x: x.stride(), lambda x,s: x.expand(s)),
  TrinaryOps.WHERE: lambda x, y, z: torch.where(x != 0, y, z),
