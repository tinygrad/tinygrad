...
def fixup_ip_version(ip:str, version:tuple[int, ...]) -> list[tuple[int, ...]]:
  ...
  elif ip in ['mp']: version = _apply_ovrd({(14,0,1): (13,0,2), (14,0,3): (14,0,2), (13,0,12): (13,0,6)})
  elif ip in ['smu']: version = _apply_ovrd({(14,0,1): (14,0,0), (14,0,3): (14,0,2), (13,0,12): (13,0,6)})
