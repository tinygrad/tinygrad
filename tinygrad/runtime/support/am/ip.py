...
class AM_SDMA(AM_IP):
  ...
  def init(self):
    # self.adev.regSDMA0_F32_CNTL.update(halt=1)
    # self.adev.reg(f"regSDMA0_QUEUE0_RB_CNTL").update(rb_enable=0)
    # self.adev.reg(f"regSDMA0_QUEUE0_IB_CNTL").update(ib_enable=0)
    # self.adev.regSDMA0_F32_CNTL.update(halt=1)
