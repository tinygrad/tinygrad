...
def _select_gsp_classes_from_chip(chip_name:str, gpu_module):
  gpfifo_class, compute_class, dma_class = gpu_module.AMPERE_CHANNEL_GPFIFO_A, gpu_module.AMPERE_COMPUTE_B, gpu_module.AMPERE_DMA_COPY_B
  match chip_name[:2]:
    case "AD":
      compute_class = gpu_module.ADA_COMPUTE_A
    case "GH":
      gpfifo_class, compute_class, dma_class = gpu_module.HOPPER_CHANNEL_GPFIFO_A, gpu_module.HOPPER_COMPUTE_A, gpu_module.HOPPER_DMA_COPY_A
    case "GB":
      gpfifo_class, compute_class, dma_class = gpu_module.BLACKWELL_CHANNEL_GPFIFO_A, gpu_module.BLACKWELL_COMPUTE_B, gpu_module.BLACKWELL_DMA_COPY_B
  return gpfifo_class, compute_class, dma_class
...
class NV_GSP(NV_IP):
  def init_sw(self):
    ...
    self.gpfifo_class, self.compute_class, self.dma_class = _select_gsp_classes_from_chip(self.nvdev.chip_name, nv_gpu)
