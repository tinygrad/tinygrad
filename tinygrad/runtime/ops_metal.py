...
class RawMetalBuffer(RawBufferMapped):
  def __init__(self, size:int, dtype:DType):
    ...
    super().__init__(size, dtype, METAL.device.newBufferWithBytesNoCopy_length_options_deallocator_(None, size*dtype.itemsize, (Metal.MTLResourceStorageModeShared | Metal.MTLResourceCPUCacheModeDefaultCache), None))
  def __del__(self):
    if self._buf:
