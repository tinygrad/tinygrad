...
class MetalProgram:
  def __init__(self, name:str, prg:str, binary:bool=False):
    if METAL_XCODE:
      ...
      # With fast math enabled, the compiler does reciprocal division optimizations (e.g. x/4 => x * 0.25). 
      # This causes inaccuracies (e.g. `Tensor(3) + 0.5)/3.5 != 0`).
      # For an example see `test_resize_upsample_sizes_nearest_cpu` in the onnx test suite
