...
class QCOMDevice(HCQCompiled):
  def __init__(self, device:str=""):
    ...
    renderers = [IR3Renderer, QCOMCLRenderer] if DEV.interface.startswith("MOCK") else [QCOMCLRenderer, IR3Renderer]
    super().__init__(device, QCOMAllocator(self), renderers, QCOMProgram, QCOMSignal, functools.partial(QCOMComputeQueue, self),
