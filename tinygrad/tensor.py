...
from tinygrad.helpers import IMAGE, WINO, Metadata, TRACEMETA, ASM_GEMM, CPU_MATVEC, ceildiv, fetch, polyN, is_numpy_ndarray, TracingKey, cpu_profile
...
class Tensor(OpMixin):
  ...
  def dot(self, w:Tensor, dtype:DTypeLike|None=None) -> Tensor:
    ...
    if CPU_MATVEC:
      from extra.matvec.cpu import can_use_cpu_matvec, cpu_matvec
      if can_use_cpu_matvec(self, w): return cpu_matvec(self, w)
