...
class Tensor:
  ...
  def log2(self): return F.Log2Approx.apply(self.cast(least_upper_float(self.dtype)))
  def exp(self): return F.Exp.apply(self.cast(least_upper_float(self.dtype)))
  def exp2(self): return F.Exp2Approx.apply(self.cast(least_upper_float(self.dtype)))
  def relu(self): return F.Relu.apply(self)
  def sigmoid(self): return F.Sigmoid.apply(self.cast(least_upper_float(self.dtype)))
  def sin(self): return F.SinApprox.apply(self.cast(least_upper_float(self.dtype)))
