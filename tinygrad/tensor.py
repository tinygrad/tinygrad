...
class Tensor(SimpleMathTrait):
  ...
  def _data(self) -> memoryview:
    ...
    contig = self.cast(self.dtype.base).contiguous()
    cpu = contig.to("CLANG").realize()
    if cpu.lazydata.base.realized is None: raise RuntimeError(f"expected realized to be realized {contig.lazydata.base}")
