...
class Tensor:
  ...
  @staticmethod
  def _tri(r:int, c:int, k:int=0, **kwargs) -> Tensor: return Tensor.arange(stop=r, **kwargs).unsqueeze(1).expand(r,c) <= Tensor.arange(start=-k, stop=c-k, **kwargs).unsqueeze(0).expand(r,c)
