...
sym = symbolic_simple+PatternMatcher([
  ...
  (UPat(Ops.CONTIGUOUS, name="root", src=(UPat((Ops.CONTIGUOUS, Ops.ASSIGN, Ops.BUFFER, Ops.COPY)),)), lambda root: root.src[0]),
  ...
  # double ASSIGN is one ASSIGN
  (UPat(Ops.ASSIGN, src=(UPat.var("b"), UPat(Ops.ASSIGN, src=(UPat.var("b"), UPat()), name="x"))), lambda x,b: x),
