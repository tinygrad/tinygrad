...
si_lowerer = PatternMatcher([
  (UPat(Ops.SINK, src=(UPat.store(UPat(), UPat(), UPat(Ops.LOAD, name="src"), name="output")),), buffer_view),
  (UPat(Ops.SINK, src=(UPat.store(UPat(), UPat(), UPat(Ops.BITCAST, src=(UPat(Ops.LOAD, name="src"),)), name="output"),)), buffer_view),
