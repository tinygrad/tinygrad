...
actions += [Opt(op=OptOps.UNROLL, axis=axis, arg=amt) for amt in [0,4,7,8] for axis in range(5)]
...
actions += [Opt(op=OptOps.GROUP, axis=axis, arg=amt) for amt in [0,4,8,16,32,64,128] for axis in range(3)]
