...
uops_colors = {UOps.ALU: "#ffffc0", UOps.LOAD: "#ffc0c0", UOps.STORE: "#e9edc9", UOps.CONST: "#e0e0e0", UOps.VCONST: "#e0e0e0",
               ...
               UOps.WMMA: "#efefc0", UOps.VIEW: "#c7f9cc", UOps.REDUCE_AXIS: "#f58488", UOps.SINK: "#90caf9"}
graph_uops_cnt = 0
