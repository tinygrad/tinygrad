...
from tinygrad.opt.kernel import Kernel, OptOps
from tinygrad.opt.heuristic import hand_coded_optimizations
from tinygrad.uop.ops import UOp
from tinygrad.helpers import NOOPT, BEAM, USE_TC, getenv
from tinygrad.renderer import Renderer

def get_optimized_ast(ast:UOp, renderer:Renderer, opts_override:list[OptOps]|None=None, name_override:str|None=None) -> UOp:
  """
  Optimize an AST based on heuristics or BEAM search or input opts.
