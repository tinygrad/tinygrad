...
# kaiming initialization is added as default
class Conv2d:
  def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True, initialization: str='kaiming_uniform'):
    ...
    self.weight = Tensor.kaiming_uniform(out_channels, in_channels//groups, self.kernel_size[0], self.kernel_size[1]) if initialization=='kaiming_uniform' else Tensor.glorot_uniform(out_channels, in_channels//groups, self.kernel_size[0], self.kernel_size[1])
