...
class Embedding:
  ...
  def __call__(self, idx:Tensor) -> Tensor:
    if not hasattr(self, 'vocab_counter'): self.vocab_counter = Tensor.arange(self.vocab_size, requires_grad=False, device=self.weight.device).reshape(1, 1, self.vocab_size) # noqa: E501
