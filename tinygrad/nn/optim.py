...
class Optimizer:
    ...
    def schedule_step(self) -> list[Tensor]:
        ...
        return (
            self.schedule_step_with_grads([unwrap(t.grad) for t in self.params])
            + self.params
            + self.buffers
        )
...
class OptimizerGroup(Optimizer):
    ...
    def __init__(self, *optimizers: Optimizer):  # pylint: disable=super-init-not-called
        ...
        self.params, self.buffers = flatten(
            [o.params for o in self.optimizers]
...
class LARS(Optimizer):
    ...
    def __init__(
        ...
        self.momentum, self.wd, self.nesterov, self.classic, self.tcoef = (
            momentum,
            weight_decay,
            nesterov,
            classic,
