...
class Metadata:
  ...
  def pretty(self): return f"Metadata('{self.name}', '{self.caller}', {self.backward})"
...
def pretty_print(x:Any, rep:Callable = lambda x: 'LazyOp({x.op}, arg={x.arg}, src=(%s))', srcfn=lambda x: x.src, cache=None, d=0)->str:
