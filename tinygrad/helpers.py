...
def colored(st, color:str|int|None, background=False): # replace the termcolor library
  if isinstance(color, int): return f"\u001b[{48 if background else 38};5;{int(color)}m{st}\u001b[0m" if color is not None else st
