...
WINO, WINO_GRAPH = ContextVar("WINO", 0), ContextVar("WINO_GRAPH", 0)
CAPTURING, TRACEMETA, NO_COLOR = ContextVar("CAPTURING", 1), ContextVar("TRACEMETA", 1), ContextVar("NO_COLOR", 0)
