...
import os
if os.getenv("CUDA")==1:
  from ..llops.cuda import GPUBuffer
  from ..llops.cuda import unary_op, binary_op, reduce_op, perm_axis, inner_slice
  from ..llops.cuda import matmul, conv, convdw, convdx
else:
