...
from tinygrad.ops import UOp, Ops, graph_rewrite, split_uop, symbolic_flat, Variable, sint, uop_given_valid, simplify_valid, symbolic
...
def views_to_indexed_uops(views: tuple[View, ...], _idxs:Optional[tuple[UOp, ...]]=None) -> tuple[UOp, UOp]:
  ...
  return upcast(graph_rewrite(idx, symbolic, {})), upcast(graph_rewrite(valid, symbolic, {}))
