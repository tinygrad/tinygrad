...
# the alt value of a gated LOAD is a data constant at the load's width, one per lane
def alt_value(l:UOp) -> UOp: return UOp.const(0, l.dtype).broadcast(l.max_numel())
