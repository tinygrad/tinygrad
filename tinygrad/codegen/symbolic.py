...
symbolic = symbolic_simple+commutative+PatternMatcher([
  ...
  (UPat.var("cond").logical_not().where(UPat.var("t"), UPat.var("f")), lambda cond, t, f: cond.where(f,t)),
...
sym = symbolic_flat+PatternMatcher([
  ...
  (acc_pat.assign((UPat.var("idx")!=UPat(Ops.RANGE, name="rng")).where(UPat.const(None, 0), index_load)+acc_pat), index_collapse),
