...
class CStyleLanguage(NamedTuple):
  ...
  def render_cast(self, x:List[str], var_dtype:DType, bitcast:bool=False) -> str:
  ...
  def render_load(self, output_dtype, buf_name, buf_dtype, idx, local=False) -> str:
    ...
    if self.uses_vload and buf_dtype == dtypes.float16 and output_dtype in [dtypes.float32, dtypes._float4, dtypes._float2]:
  ...
  def render_store(self, buf_name:str, buf_dtype:DType, var_name:str, var_dtype:DType, idx, local=False) -> str:
    ...
    if self.uses_vload and buf_dtype == dtypes.float16 and var_dtype in [dtypes.float32, dtypes._float4, dtypes._float2]:
