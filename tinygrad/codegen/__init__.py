...
from tinygrad.uop.symbolic import sym, symbolic_simple, gep_pushing, symbolic_flat
...
def _get_rewrites_for_renderer(opts:Renderer, optimize:bool, linearizer:bool, _QUANTIZE, _DEVECTORIZE, _TRANSCENDENTAL) -> list[RewriteStep]:
  ...
  ret.append(RewriteStep(symbolic_flat+pm_lower_index_dtype+load_store_indexing, lambda _: opts.device, name="lower all index dtypes"))
