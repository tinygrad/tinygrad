...
pm_linearize_cleanups = PatternMatcher([
  ...
  (UPat(Ops.STORE, name="u", src=(UPat((Ops.INDEX, Ops.BUFFER_VIEW)).or_casted(), UPat(), UPat(name="gate", dtype=dtypes.bool))),
   lambda u, gate: (u, [mif:=UOp(Ops.IF, src=(gate, u.src[0])), u.replace(src=u.src[0:2]), UOp(Ops.ENDIF, src=(mif,))]))
])
