...
def full_rewrite_to_sink(sink:UOp, ren:Renderer|None=None, optimize:bool=True) -> UOp:
  ...
  if DEVECTORIZE >= 2:
    pm_devectorize = sym+pm_expand_index+pm_fold_expanded_index+load_store_folding+load_store_indexing
  elif DEVECTORIZE:
    pm_devectorize = sym+devectorize+pm_expand_index+pm_fold_expanded_index+load_store_folding+correct_load_store+load_store_indexing
  else:
    pm_devectorize = sym+pm_expand_index+pm_fold_expanded_index+load_store_folding+correct_load_store+load_store_indexing
