...
# "newtons method": https://en.wikipedia.org/wiki/Division_algorithm#Newton–Raphson_division
def xidiv32(x:UOp, a:UOp, b:UOp) -> UOp:
  ...
  n = b.neg() * z
  if is_const_divisor: n = n & 0xFFFFFFFF # must truncate to mimic hardware
  z = z + _mulhi32(z, n)
  q = _mulhi32(a, z)
  r = a - q*b
