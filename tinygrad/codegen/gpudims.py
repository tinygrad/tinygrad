...
def add_gpudims(ctx:Renderer, s:UOp):
  ...
  ranges = sorted([x for x in s_topo if x.op is Ops.RANGE and x.arg < len(ki.axis_types) and \
  ki.axis_types[x.arg] in {AxisType.LOCAL,AxisType.GLOBAL,AxisType.GROUP_REDUCE}], key=lambda x: x.arg)
