...
constant_folder = PatternMatcher([
  ...
  (UPat(UOps.UNMUL, vin = (UPat(UOps.CONST, 0, name = "zero"), UPat())), lambda zero: zero),
  ...
  # max -2147483648
  (UPat(UOps.ALU, BinaryOps.MAX, [UPat(name = "x"), UPat(UOps.CONST, -2147483648)], dtype = dtypes.int), lambda x: x),
  # -(-x) -> x
