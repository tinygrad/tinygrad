...
float4_folding = PatternMatcher([
  ...
  (NOp(UOps.STORE, src=(_nop(name="buf"),
    NOp(UOps.EXPAND, name="ex")+_nop(name="idx")+_nop(name="idx2")+_nop(name="idx3"), _nop(name="var")), name="store_allow_any_len"),
    float4_contract_store),
  (NOp(UOps.STORE, src=(_nop(name="buf"),
    NOp(UOps.EXPAND, name="ex")+_nop(name="idx")+_nop(name="idx2"), _nop(name="var")), name="store_allow_any_len"),
    float4_contract_store),
  (NOp(UOps.STORE, src=(_nop(name="buf"),
    NOp(UOps.EXPAND, name="ex")+_nop(name="idx"), _nop(name="var")), name="store_allow_any_len"), float4_contract_store),
  (NOp(UOps.STORE, src=(_nop(name="buf"),
    NOp(UOps.EXPAND, name="ex"), _nop(name="var")), name="store_allow_any_len"), float4_contract_store),
  # image handling
  (NOp(UOps.LOAD, src=(_nop(name="buf"), NOp(UOps.VECTORIZE, dtypes.int.vec(3), (_nop(name="idx"), _nop(name="idy"),
     _nop(name="id4")))), name="ls_allow_any_len"), image_contract_load),
  (NOp(UOps.STORE, src=(_nop(name="buf"), NOp(UOps.VECTORIZE, dtypes.int.vec(3), (_nop(name="idx"), _nop(name="idy"),
     NOp(UOps.EXPAND, src=tuple(NOp.const(dtypes.int, i) for i in range(4)), name="ex"))), _nop(name="var")), name="ls_allow_any_len"),
