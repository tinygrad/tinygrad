...
from tinygrad.ops import UnaryOps, TernaryOps, UOp, Ops, UPat, PatternMatcher, symbolic_flat, symbolic_simple
...
def get_late_rewrite_patterns(ops, force_transcendental=False):
  ...
  if UnaryOps.NEG in ops:
    ...
    if Ops.SUB in ops: pat += [(UPat.var('x')+UPat.var('y').alu(UnaryOps.NEG), lambda x,y: x.alu(Ops.SUB, y))]
