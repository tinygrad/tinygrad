...
class LazyBuffer:
  ...
  def ternary_op(self:LazyBuffer, op:TernaryOps, y: LazyBuffer, z:LazyBuffer) -> LazyBuffer: return create_lazybuffer(self.device, ShapeTracker(self.shape), TernaryOps, LazyOp(op, (self, y, z,), None), y.dtype)
