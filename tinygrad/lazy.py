...
from tinygrad.helpers import GRAPH, DEBUG, prod, getenv, DType, dtypes, ImageDType, partition, all_int, dedup, merge_dicts
...
PUSH_PERMUTES = False  # we no longer have this functionality
...
class LazyBuffer:
  ...
  def realize(self:LazyBuffer) -> LazyBuffer:
    if not self.realized:
      ...
      elif self.optype is MovementOps: self.base.realize()
