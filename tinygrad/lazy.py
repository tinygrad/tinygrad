...
class LazyBuffer:
  def __init__(self, device:str, st:ShapeTracker, dtype:DType,
    ...
    if base is None:
      ...
      if (self.op is LoadOps.CONTIGUOUS or (self.op in [UnaryOps.CAST, UnaryOps.BITCAST] and self.arg[1] is True)) and srcs[0].st.consecutive and \
  ...
  def cast(self, dtype:DType, bitcast:bool=False):
    ...
    return create_lazybuffer(self.device, ShapeTracker.from_shape(new_shape), dtype, UnaryOps.BITCAST if bitcast else UnaryOps.CAST, (dtype, bitcast), (self,))
