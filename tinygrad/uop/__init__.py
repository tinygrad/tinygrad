...
class Ops(FastEnum):
  ...
  # UnaryOps
  CAST = auto(); BITCAST = auto(); EXP = auto(); EXP2 = auto() # noqa: E702
  LOG2 = auto(); SIN = auto(); SQRT = auto(); RECIP = auto(); NEG = auto(); TRUNC = auto() # noqa: E702
...
class GroupOp:
  Unary = {Ops.EXP, Ops.EXP2, Ops.LOG2, Ops.SIN, Ops.SQRT, Ops.RECIP, Ops.NEG, Ops.TRUNC}
