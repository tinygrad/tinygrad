...
_tensor_spec = PatternMatcher([
  ...
  # REDUCE has arg=(op, axis_tuple)
  (UPat(Ops.REDUCE, name="x"), lambda x: isinstance(x.arg, tuple) and len(x.arg) == 2 and x.arg[0] in {Ops.ADD, Ops.MUL, Ops.MAX}
   and isinstance(x.arg[1], tuple)),
