...
sym = symbolic_flat+PatternMatcher([
  # self STORE is just self
  (UPat(Ops.STORE, src=(UPat.var('x'), UPat.var('x'))), lambda x: x),
  ...
  (UPat(Ops.STORE, src=(UPat.cvar(),UPat.var("x"))), lambda x: x),     # an STORE to a const is a NOOP
  # x!=0 -> (bool)x
