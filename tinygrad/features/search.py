...
actions += [
  ...
  Opt(op=OptOps.GROUP, axis=0, amt=16), Opt(op=OptOps.GROUP, axis=0, amt=256),
  Opt(op=OptOps.GROUP, axis=1, amt=16), Opt(op=OptOps.GROUP, axis=1, amt=256),
  Opt(op=OptOps.GROUP, axis=2, amt=16), Opt(op=OptOps.GROUP, axis=2, amt=256),
