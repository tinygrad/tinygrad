...
class Exp(Function):
    ...
    def _pade(self, x: LazyBuffer) -> LazyBuffer:
        # Pade 4
        # PC = [0.0005952380952380792, 0.011904761904761696, 0.10714285714285621, 0.4999999999999981, 1.0]
        # QC = [0.0005952380952381069, -0.011904761904762067, 0.10714285714285804, -0.5000000000000019, 1.0]

        # Pade 5
        PC = [3.306878306875635e-05, 0.0009920634920630444, 0.013888888888885176, 0.11111111111109495, 0.49999999999996925, 1.0]
        QC = [-3.306878306879626e-05, 0.0009920634920637882, -0.013888888888891804, 0.11111111111112569, -0.5000000000000308, 1.0]
