...
class MMIOInterface:
  ...
  def cast(self, fmt): return self.view(fmt=fmt)
  def tolist(self): return self[:]
  def as_memoryview(self) -> memoryview: return self.mv
...
class Buffer:
  ...
  def as_memoryview(self, allow_zero_copy=False, force_zero_copy=False) -> memoryview:
    ...
    if force_zero_copy or allow_zero_copy:
      with contextlib.suppress(RuntimeError, AttributeError): return self.as_mmio().as_memoryview()
