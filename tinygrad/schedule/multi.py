...
replace_allreduce = PatternMatcher([
  ...
  (UPat(Ops.SHRINK, src=(UPat(Ops.MSTACK, name="ms"),), name="shrink", allow_any_len=True), mstack_early_shrink),
...
multi_pm = PatternMatcher([
  ...
  (UPat(Ops.RESHAPE, src=(UPat(Ops.MULTI, name="multi"), ), allow_any_len=True, name="root"), reshape_multi),
  (UPat(Ops.EXPAND, src=(UPat(Ops.MULTI, name="multi"), ), allow_any_len=True, name="root"), expand_multi),
  (UPat(Ops.PAD, src=(UPat(Ops.MULTI, name="multi"), ), allow_any_len=True, name="root"), pad_multi),
  (UPat(Ops.SHRINK, src=(UPat(Ops.MULTI, name="multi"), ), allow_any_len=True, name="root"), shrink_multi),
