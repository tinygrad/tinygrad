...
python_alu = {
  ...
  BinaryOps.MUL: lambda *x: math.prod(x), BinaryOps.ADD: lambda *x: sum(x),
  BinaryOps.XOR: lambda *x: functools.reduce(operator.xor, x), BinaryOps.MAX: max, BinaryOps.CMPNE: operator.ne, BinaryOps.CMPLT: operator.lt,
