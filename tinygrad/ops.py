...
UNSAFE_PAD_OPS = {BinaryOps.IDIV, UnaryOps.RECIP,  UnaryOps.LOG2, UnaryOps.EXP2}
...
python_alu = {
  ...
  UnaryOps.RECIP: lambda x: 1/x if x != 0 else math.inf,
  ...
  BinaryOps.IDIV: lambda x,y: int(x/y),
