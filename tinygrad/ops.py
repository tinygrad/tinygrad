...
class BinaryOps(Enum):
  """A + A -> A (elementwise)"""
  ADD = auto(); MUL = auto(); DIV = auto(); MAX = auto(); MOD = auto(); CMPLT = auto(); CMPEQ = auto(); XOR = auto() # noqa: E702
...
python_alu = {
  ...
  BinaryOps.MUL: operator.mul, BinaryOps.ADD: operator.add, BinaryOps.XOR: operator.xor,
