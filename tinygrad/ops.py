...
class UnaryOps(Enum):
  """A -> A (elementwise)"""
  EXP2 = auto(); LOG2 = auto(); CAST = auto(); SIN = auto(); SQRT = auto(); NEG = auto(); ANG_RED = auto()# noqa: E702
...
python_alu = {
  ...
  UnaryOps.ANG_RED: lambda x: x % (2*math.pi),
  ...
  # BinaryOps.FMOD: lambda x,y: x%y if y != 0 else x*math.inf,
