...
class GroupOp:
  ...
  Binary = {Ops.ADD, Ops.MUL, Ops.IDIV, Ops.MAX, Ops.MOD, Ops.CMPLT, Ops.CMPNE, Ops.XOR, Ops.SHL, Ops.SHR, Ops.OR, Ops.AND,
            Ops.THREEFRY, Ops.SUB, Ops.FDIV}
...
spec = PatternMatcher([
  ...
  (UPat(Ops.LOAD, src=(UPat((Ops.INDEX, Ops.CAST, Ops.DEFINE_ACC)),)), lambda: True),
