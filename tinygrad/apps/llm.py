...
class TransformerBlock:
  ...
  @function
  def _attention(self, q:Tensor, start_pos:int|UOp) -> Tensor:
    B, _, T, _ = q.shape
    # NOTE: you can't pass in Tensors with symbolic shape to functions
  ...
  def _kv(self, x:Tensor, start_pos:int|UOp) -> Tensor:
    ...
    return self._attention(q, start_pos)
