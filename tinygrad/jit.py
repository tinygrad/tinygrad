...
class TinyJit:
  ...
  def __call__(self, *args, **kwargs) -> Any:
    ...
    if self.cnt >= 2:
      ...
      except KeyError: var_vals = merge_dicts([arg.lazydata.st.var_vals for arg in args if isinstance(arg, Tensor)])
      ...
      for (j,i),(input_name, expected_st, expected_type) in self.input_replace.items():
        ...
        # TODO: this needs to compare with the non-stateful version
