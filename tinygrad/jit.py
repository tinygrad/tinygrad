...
class TinyJit:
  ...
  def __call__(self, *args, **kwargs) -> Any:
    ...
    print(f'input_rawbuffer={input_rawbuffers}')
    ...
    if self.cnt >= 2:
      ...
      print(f'Hot run={len(input_rawbuffers)}')
      print(input_rawbuffers)
      # get the inputs for replacement
      for j,(prg,args) in enumerate(self.jit_cache): 
      ...
      print(f'input_replace={set([x[0] for x in self.input_replace.values()])}')
      print(f'input={set(input_rawbuffers.keys())}')
