...
class TinyJit:
  ...
  def __call__(self, *args, **kwargs) -> Any:
    ...
    input_buffers: Dict[Union[int, str], CompiledBuffer] = {cast(Union[int, str], k):cast(CompiledBuffer, v.realize().data.realized) for k,v in itertools.chain(enumerate(args), kwargs.items()) if isinstance(v, Tensor)}
