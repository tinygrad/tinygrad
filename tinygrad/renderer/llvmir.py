...
code_for_op: Final[Dict[Op, Callable]] = {
  ...
  BinaryOps.SHR: lambda builder, x, y, dtype: builder.lshr(x, y) if is_bool_or_unsigned(dtype) else builder.ashr(x, y), BinaryOps.SHL: lambda builder, x, y, dtype: builder.shl(x, y), # noqa: E501
