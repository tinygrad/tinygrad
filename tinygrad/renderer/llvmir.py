...
code_for_op: Final[Dict[Op, Callable]] = {
  ...
  BinaryOps.XOR: lambda builder, x, y, dtype: builder.xor(x, y), BinaryOps.AND: lambda builder, x, y, dtype: builder.and_(x, y), BinaryOps.OR: lambda builder, x, y, dtype: builder.or_(x, y),
  BinaryOps.SHR: lambda builder, x, y, dtype: builder.lshr(x, y) if is_bool_or_unsigned(dtype) else builder.ashr(x, y), BinaryOps.SHL: lambda builder, x, y, dtype: builder.shl(x, y),
