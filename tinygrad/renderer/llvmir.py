...
code_for_op: Final[Dict[Op, Callable]] = {
  ...
  BinaryOps.IDIV: lambda builder, x, y, dtype: builder.udiv(x, y) if is_bool_or_unsigned(dtype) else builder.sdiv(x, y) if dtypes.is_int(dtype) else builder.call(builder.module.declare_intrinsic('llvm.floor', [x.type]), [builder.fdiv(x, y, flags=MFLAGS)], fastmath=MFLAGS),  # noqa: E501
