...
code_for_op: Final[Dict[Op, Callable]] = {
  ...
  BinaryOps.IDIV: lambda builder, x, y, dtype: builder.fptoui(builder.udiv(x, y), typ=ir.IntType) if is_bool_or_unsigned(dtype) else builder.sdiv(x, y) if dtypes.is_int(dtype) else builder.fptosi(builder.fdiv(x, y, flags=MFLAGS), typ=ir.IntType),  # noqa: E501
