...
ptx_matcher = PatternMatcher([
  ...
  (UPat(name="root", uop=UOps.ALU, arg=BinaryOps.ADD, dtype={dtypes.float16, dtypes.bfloat16, dtypes.float32, dtypes.float64},
  ...
  *[(UPat(name="x", uop=UOps.ALU, dtype=dtypes.half, arg=op),
  ...
  (UPat(name="root", uop={UOps.LOAD, UOps.STORE}, vin=(UPat(uop={UOps.DEFINE_LOCAL, UOps.DEFINE_GLOBAL}),
                               UPat(uop=UOps.ALU, arg=BinaryOps.ADD, vin=[UPat(name="alu"), UPat(name="const", uop=UOps.CONST)])), __allow_len__=[2,3,4,5]),
