...
ptx_matcher = PatternMatcher([
  ...
  # move mask to LOAD to allow for pointer arithmetic
  ...
  # remove mask from an already gated STORE
  # TODO: this is not right either
  ...
  # both of these above should somehow keep the mask in index until we render things
