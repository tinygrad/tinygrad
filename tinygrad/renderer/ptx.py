...
from tinygrad.ops import UnaryOps, TernaryOps, Ops, UOp, PatternMatcher, UPat, GroupOp
...
supports_half: List[Ops] = [UnaryOps.EXP2, Ops.ADD, Ops.MUL, Ops.MAX, Ops.CMPLT, TernaryOps.WHERE]
