...
asm_for_op: dict[Ops, Callable] = {
  ...
  Ops.CMPLT: lambda d,a,b,dt,name: f"setp.lt.{name} {d}, {a}, {b};", Ops.CMPLE: lambda d,a,b,dt,name: f"setp.le.{name} {d}, {a}, {b};",
...
string_rewrite = PatternMatcher([
  ...
  (UPat((Ops.CMPLT, Ops.CMPNE, Ops.CMPEQ, Ops.CMPLE), name="x", allow_any_len=True, src=(UPat.var("src0"),)),
