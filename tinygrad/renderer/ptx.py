...
asm_for_op: dict[Ops, Callable] = {
  ...
  Ops.MAX: lambda d,a,b,dt,name: f"max.{name} {d}, {a}, {b};", Ops.EQ: lambda d,a,b,dt,name: f"setp.eq.{name} {d}, {a}, {b};",
...
string_rewrite = PatternMatcher([
  ...
  (UPat((Ops.CMPLT, Ops.CMPNE, Ops.EQ), name="x", allow_any_len=True, src=(UPat.var("src0"),)),
