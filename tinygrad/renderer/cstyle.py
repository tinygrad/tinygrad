...
class AMDRenderer(CStyleLanguage):
  ...
  tensor_cores = [TensorCore(dtype_in=di, dtype_out=do, opts_seq=("LC", "UP"), dims=(16, 16, 16), threads=[(0, 8), (0, 2), (1, 2)],
                             expanded_shape=(2, 2, 2, 2, 2, 4), reduce_axes=[(0, 2), (1, 2), (2, 2), (3, 2)],
