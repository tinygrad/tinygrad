...
class CStyleLanguage(Renderer):
  ...
  code_for_op: Dict = {
    ...
    BinaryOps.IDIV: lambda a,b,dtype: f"({a}/{b})", BinaryOps.ADD: lambda a,b,dtype: f"({a}+{b})", BinaryOps.SUB: lambda a,b,dtype: f"({a}-{b})",
    BinaryOps.MUL: lambda a,b,dtype: f"({a}*{b})", BinaryOps.MAX: lambda a,b,dtype: f"max({a},{b})", BinaryOps.MOD: lambda a,b,dtype: f"({a}%{b})",
