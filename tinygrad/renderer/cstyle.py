...
# TODO can be removed for built-in rocm library: https://github.com/ROCm/clr/blob/docs/6.0.0/hipamd/include/hip/amd_detail/amd_hip_bf16.h
...
class HIPLanguage(CStyleLanguage):
  ...
  # TODO can be removed for built-in rocm library
