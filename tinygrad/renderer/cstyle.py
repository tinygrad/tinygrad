...
class ClangRenderer(CStyleLanguage):
  ...
  if AMX:
    ...
    tensor_cores = [TensorCore(dims=(sz,sz,sz), threads=[(0,sz),(1,sz)], dtype_in=dtype, dtype_out=dtype,
      reduce_axes=[], upcast_axes=([(1,sz)],[(0,sz)],[(1,sz),(0,sz)])) for dtype, sz in tc_types]
