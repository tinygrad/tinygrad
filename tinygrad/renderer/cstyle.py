...
class ClangRenderer(CStyleLanguage):
  ...
  if AMX:
    tensor_cores = [TensorCore(dims=(sz,sz,1), threads=(), contract_axes=([(1,sz)],[(0,sz)],[(1,sz),(0,sz)]), dtype_in=dt, dtype_out=dt)
...
class IntelRenderer(OpenCLRenderer):
  ...
  tensor_cores = [TensorCore(dims=(8,8,16),threads=((0,8),),dtype_in=di,dtype_out=do,contract_axes=([(0,16)],[(0,16)],[(1,8)]))
...
class MetalRenderer(CStyleLanguage):
  device = "METAL"
  shared_max = 32768
  tensor_cores = [TensorCore((8,8,8), dtype_in, dtype_out, contract_axes=([(3,2)],[(3,2)],[(3,2)]),st1_pattern=((6,8,3,7,4),(0,1,2,5)),
    st2_pattern=((1,5,6,2,7),(3,4,8,0)), st3_pattern=((1,8,3,2,4),(5,6,7,0))) for dtype_in, dtype_out in [(dtypes.float,dtypes.float),
...
class CUDARenderer(CStyleLanguage):
  ...
  tensor_cores = [TensorCore((8,16,16), dtype_in, dtype_out, contract_axes=([(3,2),(4,2),(5,2)],[(4,2),(5,2)],[(4,2),(5,2)]),
...
class AMDRenderer(CStyleLanguage):
  ...
  tensor_cores = [TensorCore((16,16,16), dtype_in, dtype_out, contract_axes=([(3,2),(4,2),(5,2),(6,2)],[(3,2),(4,2),(5,2),(6,2)],[(4,2),(5,2),(6,2)]),
