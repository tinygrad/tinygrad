...
class CStyleLanguage(Renderer):
  ...
  code_for_op: Dict = {
    ...
    UnaryOps.ANG_RED: lambda x,dtype: f"fmod((double){x}, (double)6.2831853071795864769252867665590057683943387987502)",
    ...
    # BinaryOps.FMOD: lambda a,b,dtype: f"fmod((){a},{b})",
    # BinaryOps.FMOD: lambda a,b,dtype: f"fmod((double){a},(double){b})",
