...
def uops_to_cstyle(lang:CStyleLanguage, function_name:str, uops:List[UOp]) -> Tuple[str, Dict]:
  ...
  runtime_args = {}
  if global_size: runtime_args['global_size'] = tuple(global_size + [1]*(3-len(global_size)))
  if local_size: runtime_args['local_size'] = tuple(local_size + [1]*(3-len(local_size)))
