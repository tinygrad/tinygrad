...
from tinygrad.helpers import prod, get_prop
...
VALIDHACKS = get_prop("VALIDHACKS", 0)    # TODO: remove the need for this
NATIVE_EXPLOG = get_prop("NATIVE_EXPLOG", 0)  # this is needed as a switch for the tests to pass

KOPT = get_prop("KOPT", 0)
PRINT_AST = get_prop("PRINT_AST", "0")
TEST_AST = get_prop("TEST_AST", 0)
