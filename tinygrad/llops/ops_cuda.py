...
class GPUBuffer:
  ...
  def __init__(self, shape:Union[ShapeTracker, Tuple[int, ...]], hostbuf:Optional[CudaBuffer]=None, backing:Optional[np.ndarray]=None):
  ...
  def cl(self):
    if self._buf is None:
      self._buf = CudaBuffer(4*prod(self._base_shape))
